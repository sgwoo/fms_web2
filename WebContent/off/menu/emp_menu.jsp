...
<%	
	...
	//소메뉴	
	AuthBean au_r [] = umd.getAuthMaMeAllOff(acar_id, m_st, m_st2);
%>
                        ...
                        <tr>
                            <td>
                                <table width=162 cellspacing=0 cellpadding=0 border=0 background=/acar/images/sub_m_img1.gif>
                                    ...
                                    <tr>
                                        <td height=31  align=center style="font-size:12pt"><font color=#ffffff><b><%=AddUtil.replace(nm_db.getMenuNm(m_st, "00", "00"),"외부-","")%></b></font></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
