...
%>
<form name='form1' action='/off/consignment/cons_oksms_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 탁송관리 > <span class=style5>탁송차량 인도/인수문자관리</span></span></td>
    ...
    <tr>
        <td colspan="2" class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    <td class=title width=10%>운행일자</td>
                    <td width=40%>&nbsp;
            		    <select name='gubun1'>
                    ...
                    <td width=40%>&nbsp;
            		    <select name='s_kd'>
						  ...
						  <option value='3' <%if(s_kd.equals("3")){%>selected<%}%>>운전자 </option>
