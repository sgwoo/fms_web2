...
if (request_url.contains("fms1") || request_url.contains("fms5")) {
	response.sendRedirect("https://fms5.amazoncar.co.kr/off_web2/index.jsp");
} else {
	response.sendRedirect("/off_web2/index.jsp");
}
%>
<%!
...
//	System.out.println(securityUtil.decodeAES("f8b2e0ce67c966e4f9394864d8ba0d1b"));
