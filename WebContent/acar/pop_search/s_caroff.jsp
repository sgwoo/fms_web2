...
<form name='form1' action='./s_car_off.jsp' method='post'>
 <input type='hidden' name='mode' value='<%=mode%>'>
  <table border="0" cellspacing="0" cellpadding="0" width=500>
    <tr> 
      <td align='left' colspan="2"><font color="#666600">- 자동차영업소 조회 -</font></td>
    </tr>
    <tr> 
      <td align='left'> <select name="gubun" onChange="javascript:cng_input();">
          <option value='1' <%if(gubun.equals("1") || gubun.equals("")){%> selected <%}%>> 자동차영업소 </option>	  
    ...
    <tr> 
      <td class='line' colspan="2"> <table border="0" cellspacing="1" cellpadding="0" width=100%>
          <tr> 
            ...
            <td class='title' width="20%">관할지점</td>
            <td class='title' width="30%">영업소명</td>
