...
<%
	...
	Vector mng_ids = cp_db.getCusPreAll_day();
    ...
    <td width="780"><table width="780" border="0" cellspacing="1" cellpadding="0">
		...
		Hashtable mng_id = (Hashtable)mng_ids.elementAt(i);
		 ...
		 if(vec != 0)	vc_rate = vc*100/(float)vec; %>
          ...
          <td width="70" rowspan="2"><table width="60" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr> 
                <td> <table width="10" border="0" cellspacing="1" cellpadding="0" height="120">
                    <tr> 
                      <td height="20" valign="bottom" align="center"></td>
                    </tr>
                    <tr> 
                      <td valign="bottom" height="100" align="center"><font size="1"><%= vac %></font><br>
                        <img src=/images/menu_back2.gif width=10 height=<%= vac %>></td>
                    </tr>
                  </table></td>
                <td> <table width="10" border="0" cellspacing="1" cellpadding="0" height="120">
                    <tr> 
                    ...
                    <tr> 
                      <td valign="bottom" height="100" align="center"><font size="1"><%= vec %></font><br>
                        <img src=/images/menu_back.gif width=10 height=<%= vec %>></td>
                    </tr>
                  </table></td>
                <td> <table width="10" border="0" cellspacing="1" cellpadding="0" height="120">
                    <tr> 
                    ...
                    <tr> 
                      <td height="100" valign="bottom" align="center"><font size="1"><%= vc %></font><br>
                        <img src=/images/result1.gif width=10 height=<%= vc %>></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
                <td colspan="3" align="center"><font color="#999900">실시율<br>
                  <%= AddUtil.parseFloatCipher(vc_rate,2) %>%</font></td>
              </tr>
            </table></td>
          <% } %>
        </tr>
          ...
          <td width="70" rowspan="2"><table width="60" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td> <table width="10" border="0" cellspacing="1" cellpadding="0" height="120">
                    ...
                    <tr> 
                      <td valign="bottom" height="100" align="center"><font size="1"><%= sac %></font><br>
                        <img src=/images/menu_back2.gif width=10 height=<%= sac %>></td>
                    </tr>
                  </table></td>
                <td> <table width="10" border="0" cellspacing="1" cellpadding="0" height="120">
                    <tr> 
                    ...
                    <tr> 
                      <td valign="bottom" height="100" align="center"><font size="1"><%= sec %></font><br>
                        <img src=/images/menu_back.gif width=10 height=<%= sec %>></td>
                    </tr>
                  </table></td>
                <td> <table width="10" border="0" cellspacing="1" cellpadding="0" height="120">
                    <tr> 
                    ...
                    <tr> 
                      <td height="100" valign="bottom" align="center"><font size="1"><%= sc %></font><br>
                        <img src=/images/result1.gif width=10 height=<%= sc %>></td>
                    </tr>
                  </table></td>
              </tr>
              <tr> 
