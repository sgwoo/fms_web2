...
response.setHeader("Content-Disposition", "inline; filename="+AddUtil.getDate(4)+"_popup_excel_money.xls");
%>
        ...
        <table width="100%" border="1" cellspacing="1" cellpadding="1">        
              ...
              <%for (int i = 0 ; i < acc_size ; i++){
                ...
                <tr> 
                    ...
                    <td align="center" width=6% height="38%"><font face="±¼¸²" size="2">&nbsp;<%=AddUtil.ChangeDate2(String.valueOf(acc.get("DT")))%></font></td>
                    <td align="right" width=10% height="38%"><font face="±¼¸²" size="2"><%=Util.parseDecimal(fee_amt)%></font></td>
