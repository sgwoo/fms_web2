                ...
                <tr>
                    ...
                    <td width=160 align=right>
                        <table width=160 border=0 cellspacing=1 bgcolor=c4c4c4>
                            ...
                            <tr>
                                <td width=60 bgcolor=f2f2f2 height=18 align=center><span class=style3>기준일</span></td>
                                <td width=97 bgcolor=ffffff align=center><span class=style3>2017-09-30</span></td>
                            </tr>
                            <tr>
                                <td bgcolor=f2f2f2 align=center height=18><span class=style3>유효기간</span></td>
                                <td bgcolor=ffffff align=center><span class=style3></span></td>
                            </tr>
                        	  <%}else{%>
                            <tr>
                                <td width=60 bgcolor=f2f2f2 height=18 align=center><span class=style3>작성일</span></td>
				            ...
				            <tr>
				              	<td width=410>
				              		<table width=410 border=0 cellspacing=0 cellpadding=0>
				                  		<tr>
				                    		<td height=30 colspan=4>&nbsp;<span class=style1></span></td>
				                  		</tr>
				                  		<tr>
	          		...
	          		<td colspan="2">
	          			<table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
	          				<tr>
	          					...
	          					<td align=center height=15 bgcolor=f2f2f2 colspan=2><span class=style3><%if(e_bean.getA_a().equals("21") || e_bean.getA_a().equals("22")){%>장기렌트<%}else{%>리스플러스<%}%></span></td>
	          					<td rowspan=2 align=center bgcolor=f2f2f2><span class=style3>비고</span></td>
	          				</tr>
	          				<tr>
	          					<td height=15 align=center bgcolor=f2f2f2 width=169><span class=style3>기본식(정비미포함)</span></td>
	          					<td align=center bgcolor=f2f2f2 width=169><span class=style3>일반식(정비포함)</span></td>
...
<%--                     <%if(AddUtil.parseInt(cm_bean.getJg_code()) > 1000000 && (AddUtil.parseInt(cm_bean.getJg_code()) > 6999999 || AddUtil.parseInt(cm_bean.getJg_code()) < 2000000)){%> --%>
	         ...
	         <!-- 월대여료 및 초기납입금 end -->  
	       	 ...
	       	 <!--적용잔가율-->
	        	<tr> 
	             	<td colspan="2"><img src=/acar/main_car_hp/images/nc_bar_04.gif></td>
	     		</tr>
                <tr> 
                    <td height=4 colspan="2"></td>
                </tr>
		            ...
		            <td colspan="2" align=center> 
		            	<table width=621 border=0 cellspacing=0 cellpadding=0>
		            		<tr> 
			                  	...
			                  	<span class=style3>제조사의 차량 상품성 개선, 연식 변경 또는 정부 정책(안전사양 의무장착, 배기가스저감, 세율조정 등) 변경 등으로<br>차량가격이 변동 될 경우 상기 견적금액은 변동 될 수 있습니다.</span>
			                  	</td>
			                </tr>
			                <tr> 
