    ...
    <tr>
        <td colspan=3>
            <table width=680 border=0 cellspacing=0 cellpadding=0>
                <tr>
                    ...
                    <td width=160 align=right>
                        <table width=160 border=0 cellspacing=1 bgcolor=c4c4c4>
                            ...
                            <tr>
                                <td width=50 bgcolor=f2f2f2 height=15 align=center><span class=style3>기준일</span></td>
                            ...
                            <tr>
                        	  ...
                        	  <%}else{%>
                            <tr>
                                <td width=50 bgcolor=f2f2f2 height=15 align=center><span class=style3>작성일</span></td>
                ...
                <tr>
                    <td height=15 colspan='3' align=right><span class=style16>* 메이커D/C 변경시 대여요금도 변경됩니다.</span></td>
                    <td width=21></td>
                </tr>
				        <%}%>
            </table>
    ...
    <td width=638> <table width=638 border=0 cellspacing=0 cellpadding=0>
          ...
          <td colspan="2">
          	<%if(e_bean.getEco_e_tag().equals("1")){ //맑은서울스티커발급 문구 조건변경(20190208)%>
           	<%	//실등록지역 세팅
	    		...
	    		if(ej_bean.getJg_b().equals("5")){//엔진구분-전기차
				...
				}else if(ej_bean.getJg_b().equals("6")){//엔진구분-수소차 
        ...
        <tr> 
          <td colspan="2"> <table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
              ...
              <tr>
              	<td height=15 align=center bgcolor=f2f2f2>연 비 </td>
                	...
                	<%if (AddUtil.parseInt(String.valueOf(exam.get("BK_216"))) > 0) {%>
                		<%if ((AddUtil.parseInt(e_bean.getRent_dt()) >= 20210101)) {// && (AddUtil.parseInt(e_bean.getRent_dt()) <= 20220705)%>
	                		<tr>
			                  	...
			                  	<td bgcolor=#FFFFFF>&nbsp;&nbsp;<span class=style3>감면 미적용 개별소비세 (개별소비세 인하한도 초과금액)<br>&nbsp;&nbsp;※ 상기 차가는 개별소비세 3.5% 기준 금액(최대 인하한도 적용전)</span></td>
			                  	<%if (e_bean.getTax_dc_amt() > 0) {%>
			                  	<td align=right bgcolor=#FFFFFF><span class=style4>-<%=AddUtil.parseDecimal(e_bean.getTax_dc_amt())%> 
			                    원</span>&nbsp;</td>
			                  	<%}%>
          ...
          <td colspan="2"> <table width=638 border=0 cellspacing=0 cellpadding=0>
              ...
              <tr> 
                <td> <table width=208 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
                    ...
                    <tr> 
                      <td height=15 align=center bgcolor=f2f2f2><span class=style3>공 급 가 </span></td>
                      <td align=right bgcolor=#FFFFFF><span class=style3><%if (e_bean.getCls_per() > 100) {%>견적불가<%} else {%><%=AddUtil.parseDecimal(e_bean.getFee_s_amt()+e_bean.getDriver_add_amt()*0.9)%> 원<%}%></span>&nbsp;&nbsp;</td>
                    </tr>
                    <tr> 
                      <td height=15 align=center bgcolor=f2f2f2><span class=style3>부 가 세 </span></td>
                      <td align=right bgcolor=#FFFFFF><span class=style3><%if (e_bean.getCls_per() > 100) {%>견적불가<%} else {%><%=AddUtil.parseDecimal(e_bean.getFee_v_amt()+e_bean.getDriver_add_amt()*0.1)%> 원<%}%></span>&nbsp;&nbsp;</td>
                    </tr>
                    
                    <tr> 
                      <td height=15 align=center bgcolor=f2f2f2><span class=style3>월대여료</span></td>
                      <td align=right bgcolor=#FFFFFF><span class=style3><%if (e_bean.getCls_per() > 100) {%>견적불가<%} else {%><%=AddUtil.parseDecimal(e_bean.getFee_s_amt()+e_bean.getFee_v_amt()+e_bean.getDriver_add_amt())%> 원<%}%></span>&nbsp;&nbsp;</td>
                    </tr>
                  </table></td>
                <td>&nbsp;</td>
                <td> 	
				  ...
				  <table width=400 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
                      ...
                      <tr> 
                        ...
                        <td align=center bgcolor=#FFFFFF><span class=style3><%if(e_bean.getIns_dj().equals("1")){%>5천만원<%}else if(e_bean.getIns_dj().equals("3")){%>5억원<%}else if(e_bean.getIns_dj().equals("4")){%>2억원<%}else if(e_bean.getIns_dj().equals("8")){%>3억원<%}else{%>1억원<%}%></span></td>
				  ...
				  <table width=400 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
                      <tr> 
                        <td width=92 height=15 align=center bgcolor=f2f2f2><span class=style3>대인배상</span></td>
                        <td width=106 align=center bgcolor=#FFFFFF><span class=style3>보험미반영</span></td>
                        <td width=92 align=center bgcolor=f2f2f2><span class=style3>무보험차상해</span></td>
                        <td width=105 align=center bgcolor=#FFFFFF><span class=style3>보험미반영</span></td>
                      </tr>
                      <tr> 
                        <td height=15 align=center bgcolor=f2f2f2><span class=style3>대물배상</span></td>
                        <td align=center bgcolor=#FFFFFF><span class=style3>보험미반영</span></td>
                        <td align=center bgcolor=f2f2f2><span class=style3>운전자연령</span></td>
                        <td align=center bgcolor=#FFFFFF><span class=style3>보험미반영</span></td>
                      </tr>
                      <tr> 
              ...
              <tr> 
					<td height=20 colspan=3 class=listnum2>&nbsp;<span class=style3>* 
                        대여료(월대여료, 선납금)가 업무용으로 손비처리 가능할경우 부가세는 <strong>매입세액공제(환급)받으실 수 있습니다.</strong></span></td>
                </tr>
				<%}%> --%>
           ...
           <td colspan="2"> 
           	<table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
           		<tr>
           			...
           			<td bgcolor=ffffff rowspan=3 align=center width=110> <span class=style3><b><%=AddUtil.parseDecimal(e_bean.getAgree_dist())%>km이하 / 1년</b></span></td>
          ...
          <td colspan="2"> <table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
              <tr> 
                ...
                <td width=93 align=right bgcolor=#FFFFFF><span class=style3><%=AddUtil.parseDecimal(e_bean.getGtr_amt())%> 
                  원</span>&nbsp;</td>
                <td width=72 align=center bgcolor=f2f2f2><span class=style3>차가의 
                  <%=Math.round(e_bean.getRg_8())%>% </span></td>
                <td width=393 bgcolor=#FFFFFF><span class=style3>보증금은 
			  	계약기간 만료 후 환불해 드립니다.[보증금 100만원을 증액하면, 월대여료 4,620원(VAT포함)이 인하됩니다.(년리 5.5% 효과)]</span></td>
				</tr>
              <tr> 
                <td height=15 align=center bgcolor=f2f2f2><span class=style3>선 
                  납 금</span></td>
                <td align=right bgcolor=#FFFFFF><span class=style3><%=AddUtil.parseDecimal(e_bean.getPp_s_amt()+e_bean.getPp_v_amt())%> 원</span>&nbsp;</td>
                <td align=center bgcolor=f2f2f2><span class=style3>VAT포함</span></td>
                <td bgcolor=#FFFFFF>&nbsp;<span class=style3>선납금은 매월 일정 금액씩 공제되어 
                  소멸되는 돈입니다. </span><br>&nbsp;<span class=style3 style="letter-spacing:-1px;">※ 세금계산서는 계약이용기간 동안 매월 균등 발행 또는 납부시 일시 발행 중 선택가능</span></td><!-- 2018.01.22 -->
              </tr>
              <tr> 
                <td height=15 align=center bgcolor=f2f2f2><span class=style3>개시대여료</span></td>
                <td align=right bgcolor=#FFFFFF><span class=style3><%=AddUtil.parseDecimal(e_bean.getIfee_s_amt()+e_bean.getIfee_v_amt())%> 원</span>&nbsp;</td>
                <td align=center bgcolor=f2f2f2><span class=style3>VAT포함</span></td>
                <td bgcolor=#FFFFFF>&nbsp;<span class=style3>개시대여료는 마지막 (<%=e_bean.getG_10()%>)개월치 
        ...
        <tr> 
          <td colspan="2"> <table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
              <tr> 
                ...
                <td width=346 bgcolor=#FFFFFF>&nbsp;<span class=style15>개시대여료를 
                    ...
                    <td colspan="2"> 
                        <table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
                            ...
                            <tr> 
                                ...
                                <td align=right bgcolor=#FFFFFF><span class=style3><%=AddUtil.parseDecimal(e_bean.getRo_13_amt())%>원</span>&nbsp;</td>
                                <td align=center bgcolor=f2f2f2><span class=style3>VAT포함</span></td>
                                <td bgcolor=#FFFFFF align=left>&nbsp;<span class=style3>본 매입옵션가격에 이용차량을 매입할 수 있는 권리를 드립니다.</span></td>
                            </tr>
                        </table>
                    </td>
                </tr>
		        ...
		        <tr> 
		         ...
		         <tr>
		         	<td colspan="2">
		                <table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
		                    <tr>
		                       	<td colspan=2 align=center bgcolor=#f2f2f2><input type="checkbox" name="rent_way" value="3" <%if(!ej_bean.getJg_k().equals("0") && !rent_way.equals("1")){%>checked<%}%> ><span class=style3 style="vertical-align:3px;"><b>기본식</b> (정비서비스 미포함 상품)</span></td>
		            ...
		            <td colspan="2"> 
		            	<table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
		            		<tr>
		            			...
		            			<td colspan=2 bgcolor=ffffff> &nbsp;<span class=style3>중도해지시에는 잔여계약기간 총 대여료의 <b><%if(e_bean.getCls_per()>0){%><%=e_bean.getCls_per()%><%//=AddUtil.parseFloatNotDot(e_bean.getCls_per())%><%}else{%>30<%}%>%</b> 의 위약금이 있음</span></td>
		            		</tr>
		            	</table>
		            </td>
				</tr>				
                ...
                <tr>
                    ...
                    <td width=621  align=left>
                        <table width=621 border=0 cellspacing=0 cellpadding=0>
                            ...
                            <tr>	
                                <td>
                                    <table width=621 border=0 cellspacing=0 cellpadding=0 align=center>
                                        <tr>
                                            <td width=115 style="font-size:11px;letter-spacing:-0.05em;" valign=top><span class=style4>1.대표이사 자필 서명시:</span></td>
                             ...
                             <tr>
                                       ...
                                       <table width=621 border=0 cellspacing=0 cellpadding=0 align=center>
                                        <tr>
                                            <td width=140 style="font-size:11px;letter-spacing:-0.05em;" valign=top><span class=style4>2.대표이사 자필 서명 불가시:</span></td>
                            ...
                            <tr>
                                <td colspan=2><img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>신용심사 참고서류 :  &nbsp;</span> <span class=style4 style="font-size:11px;">재무제표(대차대조표, 손익계산서 등) &nbsp;&nbsp;※ 필요시 연대보증인(대표이사)의 주민등록등본</span></td>
                            </tr>
                        </table>
                    </td>
                    <td width=5></td>
                ...
                <tr>
                    ...
                    <td width=608 align=left>
                        <table width=608 border=0 cellspacing=0 cellpadding=0>
                            ...
                            <tr>
                                <td width=88 valign=top style="font-size:11px;">&nbsp;<img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>제출서류 :</span></td>
                                <td width=540>
                                    <table width=540 border=0 cellspacing=0 cellpadding=0>
                                        <tr>
                            ...
                            <tr>
                                <td colspan=2 style="font-size:11px;">&nbsp;<img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>신용심사 참고서류 :</span> &nbsp;&nbsp;<span class=style4 style="font-size:11px;">재직증명서, 소득증빙자료(원천징수영수증 등)<br>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                	※ 신용 심사에 필요할 경우 주민등록등본 제출을 요청할 수 있습니다.
                                </span></td>
                            </tr>
                        </table>
                    </td>
...
factory.printing.topMargin = 7.0; //상단여백    
