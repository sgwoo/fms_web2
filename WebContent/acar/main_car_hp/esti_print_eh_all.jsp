	        ...
	        <!-- 월대여료 및 초기납입금 -->
	          	<tr>
	          		<td colspan="2">
	          			<table width=698 class="table_est">
							...
							<tr>
								<td align=center bgcolor=f2f2f2 colspan=2 height=17><span class=style3>인수/반납 유형</span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3><%if(!e_bean1.getEst_id().equals("")){if(e_bean1.getReturn_select().equals("0")){%>인수/반납 선택형<%}else if(e_bean1.getReturn_select().equals("1")){%>반납형<%}}else{%>인수/반납 선택형<%} %></span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3><%if(!e_bean2.getEst_id().equals("")){if(e_bean2.getReturn_select().equals("0")){%>인수/반납 선택형<%}else if(e_bean2.getReturn_select().equals("1")){%>반납형<%}}%></span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3><%if(!e_bean3.getEst_id().equals("")){if(e_bean3.getReturn_select().equals("0")){%>인수/반납 선택형<%}else if(e_bean3.getReturn_select().equals("1")){%>반납형<%}}%></span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3><%if(!e_bean4.getEst_id().equals("")){if(e_bean4.getReturn_select().equals("0")){%>인수/반납 선택형<%}else if(e_bean4.getReturn_select().equals("1")){%>반납형<%}}%></span></td>
							</tr>
	          				<tr>
								...
								<td style="border:0px;" bgcolor=f2f2f2>&nbsp;</td>
	          					...
	          					<td align=right bgcolor=f2f2f2 class="bd_top">
		          					...
		          					<%if(!e_bean1.getEst_id().equals("")){%>
				                    	...
				                    	견적불가
					                    <%} else {%>
			          					<%=AddUtil.parseDecimal(e_bean1.getFee_s_amt()+e_bean1.getFee_v_amt()+e_bean1.getDriver_add_amt())%> 원
					                    <%}%>
		          					<%}%>
		          					</span>&nbsp;
	          					</td>  
	          					<td align=right bgcolor=f2f2f2 class="bd_top">
		          					...
		          					<%if(!e_bean2.getEst_id().equals("")){%>
				                    	...
				                    	견적불가
					                    <%} else {%>
			          					<%=AddUtil.parseDecimal(e_bean2.getFee_s_amt()+e_bean2.getFee_v_amt()+e_bean2.getDriver_add_amt())%> 원
					                    <%}%>
		          					<%}%>
		          					</span>&nbsp;
	          					</td>
	          					<td align=right bgcolor=f2f2f2 class="bd_top">
		          					...
		          					<%if(!e_bean3.getEst_id().equals("")){%>
				                    	...
				                    	견적불가
					                    <%} else {%>
			          					<%=AddUtil.parseDecimal(e_bean3.getFee_s_amt()+e_bean3.getFee_v_amt()+e_bean3.getDriver_add_amt())%> 원
					                    <%}%>
		          					<%}%>
		          					</span>&nbsp;
	          					</td>
	          					<td align=right bgcolor=f2f2f2 class="bd_top">
		          					...
		          					<%if(!e_bean4.getEst_id().equals("")){%>
				                    	...
				                    	견적불가
					                    <%} else {%>
			          					<%=AddUtil.parseDecimal(e_bean4.getFee_s_amt()+e_bean4.getFee_v_amt()+e_bean4.getDriver_add_amt())%> 원
					                    <%}%>
		          					<%}%>
		          					</span>&nbsp;
	          					</td>
	          					...
	          					<td class="bd_bottom">
									<table class="table_fee">
										<tr>
											...
											<td align=right width=94><span class=style4><%if(!e_bean1.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean1.getGtr_amt())%> 원<%}%></span></td>  
										</tr>
									</table>
	          					<td class="bd_bottom">
									<table class="table_fee">
						...
						<table width=698 class="table_est">
								...
								<td width=142>
									<table class="table_fee">
										<tr>
											...
											<td align=right width=90><span class=style4><%if(!e_bean1.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean1.getGi_amt())%> 원<%}%></span></td>
										</tr>
									</table>
								</td>
								<td width=142>
							...
							<tr>
								...
								<td width=142>
									<table class="table_fee">
										<tr>
											<td align=center width=50 height=17><span class=style6><%if(!e_bean1.getEst_id().equals("")){%><%=e_bean1.getA_b()%>개월치<%}%></span></td>
											<%-- <td align=right width=90><span class=style4><%if(!e_bean1.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean1.getGi_fee())%> 원<%}%></span></td> --%>
								...
								<td width=142 height=17>
									<table class="table_fee">
										<tr>
											...
											<td align=right  width=90><span class=style4><%if(!e_bean1.getEst_id().equals("")){%><%if(e_bean1.getOpt_chk().equals("1")){%><%=AddUtil.parseDecimal(e_bean1.getRo_13_amt())%> 원<%}else{%>매입옵션 없음<%}%><%}%></span></td>  
										</tr>
									</table>
								</td>
	          					<td width=142>
						...
						<table width=698 class="table_est">
							<tr>
		            			...
		            			<td bgcolor=ffffff align=right width=143><span class=style7><%if(!e_bean1.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean1.getAgree_dist())%>km</span><span class=style4>이하<%}%></span>&nbsp;</td>
		            		...
		            		<tr>
		            			...
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean1.getEst_id().equals("")){%>초과 1km당 &nbsp;(<%=e_bean1.getOver_run_amt()%>)원<%}%></span>&nbsp;</td>
		            		...
		            		<tr>
		            			...
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean1.getEst_id().equals("")){%><%if(e_bean1.getOpt_chk().equals("1")){%><%if(e_bean1.getA_a().equals("12")||e_bean1.getA_a().equals("22")){%>면제<%}else{%>50%만 납부<%}%><%}else{%>매입옵션 없음<%}%><%}%></span>&nbsp;</td>
						...
						<table width=698 class="table_est">
	          				<tr>
	          					...
	          					<td width=143 align=right><span class=style6><%if(!e_bean1.getEst_id().equals("")){%>잔여기간 대여료의 <span class=style7><%if(e_bean1.getCls_per()>0){%><%=e_bean1.getCls_per()%><%}else{%>30<%}%>%</span><%}%></span>&nbsp;</td>  
                ...
                <%if(ref_reg_dt >= 2021090600){ %>
	          	<%if( !(e_bean.getCar_comp_id().equals("0056")  || e_bean.getCar_comp_id().equals("0057")
	          			|| (Integer.parseInt(cm_bean.getJg_code()) > 9017300 && Integer.parseInt(cm_bean.getJg_code()) < 9018200 )) ) { // 테슬라, 마이티/메가트럭 제외%>
						<!-- 썬팅 -->
			    ...
			    <td colspan=2>&nbsp;<span class=style3>※ 
	          	...
	          	<tr> 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;③ 개시대여료는 마지막 (<%=e_bean.getG_10()%>)개월치 대여료를 선납하는 것입니다.<!-- 2018.01.23 -->
		            ...
		            <td colspan="2" align=center> 
		            	<table width=671 border=0 cellspacing=0 cellpadding=0>
			                ...
			                <tr> 
			                  	...
			                  	<td>&nbsp;</td>
			                  	<td colspan=2 align=left class=listnum2><span class=style4>홈페이지에서 대여차량 유지관리내역 정보제공 [FMS(Fleet Management System)]</span></td>
			                </tr>
			                <tr> 
			                  	<td height=15 align=right><img src=./images/4.gif width=13 height=13 align=absmiddle></td>
			                  	<td>&nbsp;</td>
			                  	<%-- <td colspan=2 align=left class=listnum2><span class=style4>대여기간 만료시에는 인수/반납 선택형의 경우 차량반납, 연장이용<%if(!e_bean.getCar_comp_id().equals("0056") && (!cm_bean.getJg_code().equals("9133") && !cm_bean.getJg_code().equals("9237") && !cm_bean.getJg_code().equals("9015435") && !cm_bean.getJg_code().equals("9025435") && !cm_bean.getJg_code().equals("9015436") && !cm_bean.getJg_code().equals("9015437") && !cm_bean.getJg_code().equals("9025439") && !cm_bean.getJg_code().equals("9025440") )) {%>(할인요금 적용)<%}%>, 매입옵션 행사 중 선택 가능하고,</span></td> --%>
			                  	<td colspan=2 align=left class=listnum2><span class=style4>대여기간 만료시에는 인수/반납 선택형의 경우 차량반납, 연장이용<%if( !(ej_bean.getJg_g_7().equals("3") || ej_bean.getJg_g_7().equals("4")) ) {%>(할인요금 적용)<%}%>, 매입옵션 행사 중 선택 가능하고,</span></td>
			                </tr>
			                <tr> 
			                  	<td height=15 align=right></td>
			                  	<td>&nbsp;</td>
			                  	<td colspan=2 align=left class=listnum2><span class=style4>반납형의 경우 차량반납, 연장이용(할인요금 적용) 중 선택 가능.</span></td>
			                </tr>
			  			</table>
		           	</td>
	          	</tr>
                ...
                <tr>
                    <td width=698 align=left>
                        <table width=698 border=0 cellspacing=0 cellpadding=0 style="border:1px solid #d9d9d9; border-bottom:0px;">
                            ...
                            <tr>
                                <td width=55 valign=top style="font-size:11px;padding-left:20px;">&nbsp;<img src=/acar/main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>제출서류 :</span></td>
                                <td width=590>
                ...
                <tr>
                    <td width=698 align=left>
                        <table width=698 border=0 cellspacing=0 cellpadding=0 style="border:1px solid #d9d9d9; border-bottom:0px;">
                            ...
                            <tr>
                                <td colspan=2 style="font-size:11px;padding-left:20px;">&nbsp;<img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>신용심사 참고서류 :</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class=style4 style="font-size:10px;">재직증명서, 소득증빙자료(원천징수영수증 등)&nbsp;&nbsp;&nbsp;&nbsp;
