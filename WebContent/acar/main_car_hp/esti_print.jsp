...
.style15 {
	...
	font-weight: bold;
	font-size: 11px}
.notice {font-size: 10px; font-family:'dotum',"나눔고딕",sans-serif;}
        ...
        <tr> 
          <td colspan="2"> 
          	<table width=638 border=0 cellspacing=0 cellpadding=0>
			                ...
			                <tr> 
			                  	<td colspan="3" height="8"><span class="notice">&nbsp;※ 귀사에서 문의하신 장기대여에 대하여 아래와 같이 견적을 제출하오니 
			                    검토하시고 좋은 답변 부탁드립니다.</span></td>
			                </tr>
             	 		</table>
          </td>
        </tr>
                ...
                <td> 	
				  ...
				  <table width=400 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
                      ...
                      <tr> 
                        ...
                        <td align=center bgcolor=#FFFFFF><span class=style3>1억원</span></td>
                        <td align=center bgcolor=f2f2f2><span class=style3>운전자연령</span></td>
                        <td align=center bgcolor=#FFFFFF><span class=style3>만26세이상</span></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        ...
                        <td align=center bgcolor=#FFFFFF><span class=style3><%if(ej_bean.getJg_w().equals("1")){%>50만원<%}else{%>30만원<%}%></span></td>
		       	...
		       	<table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
            		...
            		<tr>
            			<td bgcolor=ffffff height=15> &nbsp;&nbsp;
            				...
            				<span class=style3>매입옵션 행사시에는 (약정이하운행시) 환급대여료가 지급되지 않고, (약정초과운행시) 초과운행대여료가 면제됩니다. (기본식)</span>
            				<%	}%>
            			</td>
            		</tr>
            	</table>
          ...
          <td colspan="2"> <table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
              <tr> 
                ...
                <td width=103 align=right bgcolor=#FFFFFF><span class=style3><%=AddUtil.parseDecimal(e_bean.getGtr_amt())%> 
                  원</span>&nbsp;</td>
                <td width=82 align=center bgcolor=f2f2f2><span class=style3>차가의 
                  <%=Math.round(e_bean.getRg_8())%>% </span></td>
                <td width=373 bgcolor=#FFFFFF>&nbsp;&nbsp;<span class=style3>보증금은 
			  	<!-- 계약기간 만료 후 환불해 드립니다.&nbsp;[보증금 100만원을 증액하면, 월대여료 5,500원(VAT포함)이 인하됩니다.&nbsp;(년리 6.6% 효과)]</span></td> -->
		 	...
		 	<td colspan="2"> 
		       	<table width=638 border=0 cellpadding=0 cellspacing=1 bgcolor=c4c4c4>
		            		<tr>
		            			...
		            			<td colspan=2 bgcolor=ffffff> &nbsp;&nbsp;<span class=style3>중도해지시에는 잔여계약기간 총 대여료의 <span class=style14><b><%if(e_bean.getCls_per()>0){%><%=e_bean.getCls_per()%><%//=AddUtil.parseFloatNotDot(e_bean.getCls_per())%><%}else{%>30<%}%>%</b></span> 의 위약금이 있음</span></td>
		            		</tr>
		            	</table>
		            </td>
				</tr>
...
<%	}else{%>
factory.printing.topMargin = 23.0; //상단여백    
factory.printing.bottomMargin = 10.0; //하단여백
<%	}%>
<%}else{%>
factory.printing.topMargin = 13.0; //상단여백    
factory.printing.bottomMargin = 10.0; //하단여백
<%}%>
