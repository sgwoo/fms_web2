    ...
    <tr>
        <td colspan=3>
            <table width=740 border=0 cellspacing=0 cellpadding=0>
                <tr>
                    <td width=21>&nbsp;</td>
                    <td width=528 align=center style="padding-left:100px;"><span class=style8>아마존카 장기대여 견적서</span></td>
	          	...
	          	<tr> 
	            	<td colspan="2"> 
	            		<table width=698 border=0 cellpadding=0 cellspacing=0 class="table_est">
			                <tr> 
			                  	<td width=125 height=16 align=center bgcolor=f2f2f2><span class=style3>제조사</span></td>
			                ...
			                <tr> 
			                  	<td height=16 align=center bgcolor=f2f2f2><span class=style3>차종(차량모델명)</span></td>
			                ...
			                <tr> 
			                  	<td height=16 align=center bgcolor=f2f2f2><span class=style3>옵 
			                    션</span></td>
			                ...
			                <tr> 
			                  	<td height=16 align=center bgcolor=f2f2f2><span class=style3>색 
			                    상 </span></td>
			                ...
			                <tr>
			                	<td height=16 align=center bgcolor=f2f2f2><span class=style3>연 
			                    비 </span></td>
			                  	<td bgcolor=#FFFFFF>&nbsp;
			                ...
			                <%}%>
			                <tr> 
			                  	<td height=16 align=center bgcolor=f2f2f2><span class=style3>기 
			                    타 </span></td>
...
<%-- 			                  		<%if( (ej_bean.getJg_g_7().equals("3") || ej_bean.getJg_g_7().equals("4")) && !e_bean.getEcar_loc_st().equals("13") ){%> --%>
			                ...
			                <!-- 개소세 감면 -->
			                <%-- <%if((ej_bean.getJg_g_7().equals("1")||ej_bean.getJg_g_7().equals("2")||ej_bean.getJg_g_7().equals("3")||ej_bean.getJg_g_7().equals("4")) && e_bean.getTax_dc_amt()>0 ){//친환경차%>
			                <tr> 
			                  	<td height=16 align=center bgcolor=f2f2f2><span class=style3>개소세 감면 </span></td>
			                  	<td bgcolor=#FFFFFF>&nbsp;<span class=style3>개별소비세 및 교육세 감면</span></td>
		                ...
		                <%}%>
			                ...
			                <tr> 
			                  	<td height=16 align=center bgcolor=f2f2f2><span class=style3>차량가격</span></td>
								...
								//수입차 이거나 하이브리드,플러그하이브리드 이거나 특정차종 문구표시
			                  	...
			                  	<%if (ref_reg_dt >= 2020083113 && ref_reg_dt <= 2020121812) {%>
			                  		<%if (AddUtil.parseInt(String.valueOf(exam.get("BK_198"))) > 0) {%>
				                   		<span class=style4>&nbsp;※ 2021년1월1일 이후 신차가 출고되어 한시적으로 인하된 자동차 개별소비세율이 환원(3.5% → 5%)될 경우 월대여료가 <%=AddUtil.parseDecimal(AddUtil.parseInt(String.valueOf(exam.get("BK_198"))))%>원(공급가) 인상됩니다.(견적1 기준)</span>
				                   	<%}%>
			                  	<%}%>
			                  	
			                  	<%if (ref_reg_dt >= 2020121813 && ref_reg_dt <= 2020123123) {%>
			                  		<%if (AddUtil.parseInt(String.valueOf(exam.get("BK_213"))) > 0) {%>
				                   		<span class=style4>&nbsp;※ 2021년1월1일이후 신차가 출고되면 개별소비세율 한시적 인하 연장에도 불구하고 개별소비세 인하 한도(100만원) 초과로 월대여료가 <%=AddUtil.parseDecimal(AddUtil.parseInt(String.valueOf(exam.get("BK_213"))))%>원(공급가) 인상됩니다.(견적1 기준)</span>
				                   	<%}%>
			                  	<%}%>
			                  	...
			                  	<%if (ref_reg_dt >= 2020083113 && ref_reg_dt <= 2020123123) {%>
			                  		...
			                  		<%if (AddUtil.parseInt(String.valueOf(exam.get("BK_206"))) > 0) {%>
										<span class=style4>&nbsp;※ 2021년1월1일 이후 신차가 출고되면 하이브리드 자동차 취득세 감면 혜택 축소에 따라 월대여료가 <%=AddUtil.parseDecimal(AddUtil.parseInt(String.valueOf(exam.get("BK_206"))))%>원(공급가) 인상됩니다.(견적1 기준)</span>
					                <%}%>
					                <%-- <%}%> --%>
			                  	<%}%>
	          	...
	          	<tr>
	          		<td colspan="2">
						<table width=698  class="table_est">
							<tr>
								<td height=17 align=center bgcolor=f2f2f2 width=125><span class=style3>대인배상</span></td>
	        ...
	        <!-- 월대여료 및 초기납입금 -->
	          	<tr>
	          		<td colspan="2">
	          			<table width=698 class="table_est">
							<tr>
								<td align=center bgcolor=f2f2f2 colspan=2 height=17><span class=style3>구분</span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3>견적1</span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3>견적2</span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3>견적3</span></td>
								<td align=center bgcolor=f2f2f2 width=142><span class=style3>견적4</span></td>
							</tr>
	          				<tr>
	          				...
	          				<tr>
								<td style="border:0px;" bgcolor=f2f2f2 width=17>&nbsp;</td>
	          					<td height=17 align=center bgcolor=f2f2f2 width=118 style="border:0px; border-left:1px solid #dcdddd;"><span class=style3>공급가</span></td>
	          					<td align=right class="bd_bottom"><span class=style4><%if (e_bean1.getCls_per() > 100) {%>견적불가<%} else {%><%=AddUtil.parseDecimal(e_bean1.getFee_s_amt()+e_bean1.getDriver_add_amt()*0.9)%> 원<%}%></span>&nbsp;</td>  
	          				...
	          				<tr>
								<td style="border:0px" bgcolor=f2f2f2>&nbsp;</td>
	          					...
	          					<td align=right class="bd_bottom bd_top"><span class=style4><%if (e_bean1.getCls_per() > 100) {%>견적불가<%} else {%><%=AddUtil.parseDecimal(e_bean1.getFee_v_amt()+e_bean1.getDriver_add_amt()*0.1)%> 원<%}%></span>&nbsp;</td>  
	          				...
	          				<tr>
								<td style="border:0px;" bgcolor=f2f2f2>&nbsp;</td>
	          					<td height=17 bgcolor=f2f2f2 style="border:0px;padding-left:28px; border-top:1px solid #dcdddd;"><span class=style3>월대여료</span></td>
	          					<td align=right bgcolor=f2f2f2 class="bd_top"><span class=style7><%if (e_bean1.getCls_per() > 100) {%>견적불가<%} else {%><%=AddUtil.parseDecimal(e_bean1.getFee_s_amt()+e_bean1.getFee_v_amt()+e_bean1.getDriver_add_amt())%> 원<%}%></span>&nbsp;</td>  
								...
								<td style="border-bottom:0px;border-right:0px;" bgcolor=f2f2f2>&nbsp;</td>
	          					...
	          					<td class="bd_bottom">
									<table class="table_fee">
										<tr>
											<td align=center width=42><span class=style4><%=Math.round(e_bean1.getRg_8())%>%</span></td>
											<td align=right width=94><span class=style4><%=AddUtil.parseDecimal(e_bean1.getGtr_amt())%> 원</span></td>  
										</tr>
									</table>
	          					<td class="bd_bottom">
									<table class="table_fee">
										<tr>
											...
											<td align=right width=94><span class=style4><%if(!e_bean2.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean2.getGtr_amt())%> 원<%}%></span></td>
										</tr>
									</table>
	          					<td class="bd_bottom">
									<table class="table_fee">
										<tr>
											...
											<td align=right width=94><span class=style4><%if(!e_bean3.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean3.getGtr_amt())%> 원<%}%></span></td>
										</tr>
									</table>
								</td>
	          					<td class="bd_bottom">
									<table class="table_fee">
										<tr>
											...
											<td align=right width=94><span class=style4><%if(!e_bean4.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean4.getGtr_amt())%> 원<%}%></span></td>
										</tr>
									</table>
								</td>
	          				</tr> 
	          				<tr>
								<td style="border:0px;" bgcolor=f2f2f2>&nbsp;</td>
	          					...
	          					<td align=right class="bd_bottom bd_top"><span class=style4><%=AddUtil.parseDecimal(e_bean1.getPp_s_amt()+e_bean1.getPp_v_amt())%> 원</span>&nbsp;</td>  
	          				...
	          				<tr>
								<td style="border:0px;" bgcolor=f2f2f2>&nbsp;</td>
	          					...
	          					<td align=right class="bd_bottom bd_top"><span class=style4><%=AddUtil.parseDecimal(e_bean1.getIfee_s_amt()+e_bean1.getIfee_v_amt())%> 원</span>&nbsp;</td>  
	          				...
	          				<tr>
								<td style="border:0px;" bgcolor=f2f2f2>&nbsp;</td>
	          					<td height=17 bgcolor=f2f2f2 style="border:0px; padding-left:12px; border-top:1px solid #dcdddd;"><span class=style3>초기납입금 합계</span></td>
	          					<td align=right bgcolor=f2f2f2 class="bd_top"><span class=style7><%=AddUtil.parseDecimal(e_bean1.getGtr_amt()+e_bean1.getPp_s_amt()+e_bean1.getPp_v_amt()+e_bean1.getIfee_s_amt()+e_bean1.getIfee_v_amt())%> 원</span>&nbsp;</td>  
						...
						<table width=698 class="table_est">
							<tr>	
								<td align=center bgcolor=f2f2f2 width=130 height=17><span class=style3>보증보험 가입금액</span></td>
								<td width=142>
									<table class="table_fee">
										<tr>
											<td align=center width=50><span class=style4><%=e_bean1.getGi_per()%>%</span></td>
											<td align=right width=90><span class=style4><%=AddUtil.parseDecimal(e_bean1.getGi_amt())%> 원</span></td>
										</tr>
									</table>
								</td>
								<td width=142>
									<table class="table_fee">
										<tr>
											...
											<td align=right width=90><span class=style4><%if(!e_bean2.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean2.getGi_amt())%> 원<%}%></span></td>
										</tr>
									</table>
								</td>
								<td width=142>
									<table class="table_fee">
										<tr>
											...
											<td align=right width=90><span class=style4><%if(!e_bean3.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean3.getGi_amt())%> 원<%}%></span></td>
										</tr>
									</table>
								</td>
								<td width=142>
									<table class="table_fee">
										<tr>
											...
											<td align=right width=90><span class=style4><%if(!e_bean4.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean4.getGi_amt())%> 원<%}%></span></td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								<td align=center bgcolor=f2f2f2>
									보증보험료
									<%-- <br>
									<span class=style3 style="font-size: 11px;">※ 신용등급 <%=e_bean1.getGi_grade()%>등급기준</span> --%>
								</td>
								<td width=142>
									<table class="table_fee">
										<tr>
											<td align=center width=50 height=17><span class=style6><%=e_bean1.getA_b()%>개월치</span></td>
											<%-- <td align=right width=90><span class=style4><%=AddUtil.parseDecimal(e_bean1.getGi_fee())%> 원</span></td> --%>
								...
								<td width=142>
									<table class="table_fee">
										<tr>
											<td align=center width=50><span class=style6><%if(!e_bean2.getEst_id().equals("")){%><%=e_bean2.getA_b()%>개월치<%}%></span></td>
											<%-- <td align=right width=90><span class=style4><%if(!e_bean2.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean2.getGi_fee())%> 원<%}%></span></td> --%>
											<td align=right width=90>
												<span class=style4>
								...
								<td width=142>
									<table class="table_fee">
										<tr>
											<td align=center width=50><span class=style6><%if(!e_bean3.getEst_id().equals("")){%><%=e_bean3.getA_b()%>개월치<%}%></span></td>
											<td align=right width=90>
												<span class=style4>
								...
								<td width=142>
									<table class="table_fee">
										<tr>
											<td align=center width=50><span class=style6><%if(!e_bean4.getEst_id().equals("")){%><%=e_bean4.getA_b()%>개월치<%}%></span></td>
											<td align=right width=90>
												<span class=style4>
						...
						<table width=698 class="table_est">
							<tr>
								<td align=center bgcolor=f2f2f2 width=130><span class=style3>매입옵션가격(VAT포함)</span></td>
								<td width=142 height=17>
									<table class="table_fee">
										<tr>
											<td align=center width=50><span class=style4><%if(e_bean1.getOpt_chk().equals("1")){%><%=e_bean1.getRo_13()%>%<%}%></span></td>
											<td align=right  width=90><span class=style4><%if(e_bean1.getOpt_chk().equals("1")){%><%=AddUtil.parseDecimal(e_bean1.getRo_13_amt())%> 원<%}else{%>매입옵션 없음<%}%></span></td>  
										</tr>
									</table>
								</td>
	          					<td width=142>
									<table class="table_fee">
										<tr>
											...
											<td align=right width=90><span class=style4><%if(!e_bean2.getEst_id().equals("")){%><%if(e_bean2.getOpt_chk().equals("1")){%><%=AddUtil.parseDecimal(e_bean2.getRo_13_amt())%> 원<%}else{%>매입옵션 없음<%}%><%}%></span></td>  
										</tr>
									</table>
								</td>
	          					<td width=142>
									<table class="table_fee">
										<tr>
											...
											<td align=right width=90><span class=style4><%if(!e_bean3.getEst_id().equals("")){%><%if(e_bean3.getOpt_chk().equals("1")){%><%=AddUtil.parseDecimal(e_bean3.getRo_13_amt())%> 원<%}else{%>매입옵션 없음<%}%><%}%></span></td>  
										</tr>
									</table>
								</td>
	          					<td width=142>
									<table class="table_fee">
										<tr>
											...
											<td align=right width=90><span class=style4><%if(!e_bean4.getEst_id().equals("")){%><%if(e_bean4.getOpt_chk().equals("1")){%><%=AddUtil.parseDecimal(e_bean4.getRo_13_amt())%> 원<%}else{%>매입옵션 없음<%}%><%}%></span></td>  
										</tr>
									</table>
								</td>
						<table>
						...
						<table width=698 class="table_est">
							<tr>
		            			<td bgcolor=f2f2f2 height=17 align=center width=126><span class=style3>연간 약정운행거리</span></td>
		            			<td bgcolor=ffffff align=right width=143><span class=style7><%=AddUtil.parseDecimal(e_bean1.getAgree_dist())%>km</span> <span class=style4>이하</span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right width=143><span class=style7><%if(!e_bean2.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean2.getAgree_dist())%>km</span><span class=style4>이하<%}%></span>&nbsp;</td>
								<td bgcolor=ffffff align=right width=143><span class=style7>      <%if(!e_bean3.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean3.getAgree_dist())%>km</span><span class=style4>이하<%}%></span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right width=143><span class=style7><%if(!e_bean4.getEst_id().equals("")){%><%=AddUtil.parseDecimal(e_bean4.getAgree_dist())%>km</span><span class=style4>이하<%}%></span>&nbsp;</td>
		            		</tr>
		            		
		            		<tr>
		            			<td bgcolor=f2f2f2 height=17 align=center><span class=style3>(약정이하운행시)<br>환급대여료(VAT별도)</span></td>
		            			<td bgcolor=ffffff align=right><span class=style4>미운행 1km당 &nbsp;(<%if(e_bean1.getRtn_run_amt_yn().equals("1")){%>미적용<%}else{ %><%=e_bean1.getRtn_run_amt()%><%} %>)원</span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean2.getEst_id().equals("")){%>미운행 1km당 &nbsp;(<%if(e_bean2.getRtn_run_amt_yn().equals("1")){%>미적용<%}else{ %><%=e_bean2.getRtn_run_amt()%><%} %>)원<%}%></span>&nbsp;</td>
								<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean3.getEst_id().equals("")){%>미운행 1km당 &nbsp;(<%if(e_bean3.getRtn_run_amt_yn().equals("1")){%>미적용<%}else{ %><%=e_bean3.getRtn_run_amt()%><%} %>)원<%}%></span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean4.getEst_id().equals("")){%>미운행 1km당 &nbsp;(<%if(e_bean4.getRtn_run_amt_yn().equals("1")){%>미적용<%}else{ %><%=e_bean4.getRtn_run_amt()%><%} %>)원<%}%></span>&nbsp;</td>
		            		</tr>
		            		<tr>
		            			<td bgcolor=f2f2f2 height=17 align=center><span class=style3>매입옵션 행사시<br>환급대여료</span></td>
		            			<td bgcolor=ffffff align=right>
		            			<span class=style4>
			            			<%if(e_bean1.getOpt_chk().equals("1")){%>
			            				<%if(e_bean1.getA_a().equals("12")||e_bean1.getA_a().equals("22")){%>
			            					미지급
			            				<%}else{%>
			            					40%만 지급
			            				<%}%>
		            			...
		            			<span class=style4>
			            			<%if(!e_bean2.getEst_id().equals("")){%>
			            				<%if(e_bean2.getOpt_chk().equals("1")){%>
			            					<%if(e_bean2.getA_a().equals("12")||e_bean2.getA_a().equals("22")){%>
			            						미지급
			            					<%}else{%>
			            						40%만 지급
			            					<%}%>
								...
								<td bgcolor=ffffff align=right>
									<span class=style4>
										<%if(!e_bean3.getEst_id().equals("")){%>
											<%if(e_bean3.getOpt_chk().equals("1")){%>
												<%if(e_bean3.getA_a().equals("12")||e_bean3.getA_a().equals("22")){%>
													미지급
												<%}else{%>
													40%만 지급
												<%}%>
		            			...
		            			<td bgcolor=ffffff align=right>
			            			<span class=style4>
			            				<%if(!e_bean4.getEst_id().equals("")){%>
			            					<%if(e_bean4.getOpt_chk().equals("1")){%>
			            						<%if(e_bean4.getA_a().equals("12")||e_bean4.getA_a().equals("22")){%>
			            							미지급
			            						<%}else{%>
			            							40%만 지급
			            						<%}%>
		            		...
		            		<tr>
		            			<td bgcolor=f2f2f2 height=17 align=center><span class=style3>(약정이하운행시)<br>환급대여료(VAT별도)</span></td>
		            			<td bgcolor=ffffff align=right><span class=style4>초과 1km당 &nbsp;(<%=e_bean1.getOver_run_amt()%>)원</span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean2.getEst_id().equals("")){%>초과 1km당 &nbsp;(<%=e_bean2.getOver_run_amt()%>)원<%}%></span>&nbsp;</td>
								<td bgcolor=ffffff align=right><span class=style4>      <%if(!e_bean3.getEst_id().equals("")){%>초과 1km당 &nbsp;(<%=e_bean3.getOver_run_amt()%>)원<%}%></span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean4.getEst_id().equals("")){%>초과 1km당 &nbsp;(<%=e_bean4.getOver_run_amt()%>)원<%}%></span>&nbsp;</td>
		            		</tr>
		            		<tr>
		            			<td bgcolor=f2f2f2 height=17 align=center><span class=style3>매입옵션 행사시<br>환급대여료</span></td>
		            			<td bgcolor=ffffff align=right><span class=style4><%if(e_bean1.getOpt_chk().equals("1")){%><%if(e_bean1.getA_a().equals("12")||e_bean1.getA_a().equals("22")){%>면제<%}else{%>50%만 납부<%}%><%}else{%>매입옵션 없음<%}%></span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean2.getEst_id().equals("")){%><%if(e_bean2.getOpt_chk().equals("1")){%><%if(e_bean2.getA_a().equals("12")||e_bean2.getA_a().equals("22")){%>면제<%}else{%>50%만 납부<%}%><%}else{%>매입옵션 없음<%}%><%}%></span>&nbsp;</td>
								      <td bgcolor=ffffff align=right><span class=style4><%if(!e_bean3.getEst_id().equals("")){%><%if(e_bean3.getOpt_chk().equals("1")){%><%if(e_bean3.getA_a().equals("12")||e_bean3.getA_a().equals("22")){%>면제<%}else{%>50%만 납부<%}%><%}else{%>매입옵션 없음<%}%><%}%></span>&nbsp;</td>
		            			<td bgcolor=ffffff align=right><span class=style4><%if(!e_bean4.getEst_id().equals("")){%><%if(e_bean4.getOpt_chk().equals("1")){%><%if(e_bean4.getA_a().equals("12")||e_bean4.getA_a().equals("22")){%>면제<%}else{%>50%만 납부<%}%><%}else{%>매입옵션 없음<%}%><%}%></span>&nbsp;</td>
		            		</tr>
						</table>
						<table width=698 class="table_est">
	          				<tr>
	          					<td height=17 align=center bgcolor=f2f2f2 width=126><span class=style3>중도해지 위약금</span></td>
	          					<td width=143 align=right><span class=style6>잔여기간 대여료의 <span class=style7><%if(e_bean1.getCls_per()>0){%><%=e_bean1.getCls_per()%><%}else{%>30<%}%>%</span></span>&nbsp;</td>  
	          					<td width=143 align=right><span class=style6><%if(!e_bean2.getEst_id().equals("")){%>잔여기간 대여료의 <span class=style7><%if(e_bean2.getCls_per()>0){%><%=e_bean2.getCls_per()%><%}else{%>30<%}%>%</span><%}%></span>&nbsp;</td>
	          					<td width=143 align=right><span class=style6><%if(!e_bean3.getEst_id().equals("")){%>잔여기간 대여료의 <span class=style7><%if(e_bean3.getCls_per()>0){%><%=e_bean3.getCls_per()%><%}else{%>30<%}%>%</span><%}%></span>&nbsp;</td>
	          					<td width=143 align=right><span class=style6><%if(!e_bean4.getEst_id().equals("")){%>잔여기간 대여료의 <span class=style7><%if(e_bean4.getCls_per()>0){%><%=e_bean4.getCls_per()%><%}else{%>30<%}%>%</span><%}%></span>&nbsp;</td>
	          				</tr>  
	          			</table>
	          		</td>
	          	</tr> 
			    ...
			    <td colspan=2>&nbsp;<span class=style3>※ 
	          	...
	          	<tr> 
                    <td colspan="2">&nbsp;<span class=style4>※ ① 보증금은 계약기간 만료 후 환불해 드립니다. [보증금 100만원을 증액하면, 월대여료 4,620원(VAT포함)이 인하(년리 5.5% 효과)]<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;② 선납금은 매월 일정 금액씩 공제되어 소멸되는 돈입니다.<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;※ 세금계산서는 계약이용기간 동안 매월 균등 발행 또는 납부시 일시 발행 중 선택가능<br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;③ 개시대여료는 마지막 (<%=e_bean.getG_10()%>)개월치 대여료를 선납하는 것입니다.<!-- ㄴ 2018.01.23 -->
	      ...
	      <!-- 차량관리 서비스-->
		      	...
		      	<tr> 
	            	...
	            	<%if(ej_bean.getJg_k().equals("2")){%>
		            	<img src=./images/bar_04_service_dc_prt.gif>
		            <%} else if(ej_bean.getJg_k().equals("0")){%>
		            	<img src=./images/bar_04_service_ndc_prt.gif>
		            <%} else if(ej_bean.getJg_k().equals("3")){%>
		            	<img src=./images/bar_04_3.gif>
		            <%} else if(ej_bean.getJg_k().equals("4")){%>
		            	<img src=./images/bar_04_4.png>
		            <%}else{%>
		            	<img src=./images/bar_04_service_prt.gif>
		            <%}%>
		            </td>
		    	</tr>
		  		<tr> 
		    	...
		    	<tr> 
		          <td colspan="2" valign=top> 
		          		<table width=698 class="table_est">
		                  	<tr> 
		                     	<td width=125 height=17 align=center bgcolor=f2f2f2><span class=style3>공통서비스</span></td>
		                    	<td width=573 colspan=2><span class=style4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%if(!e_bean.getInsurant().equals("2")){%>* 교통사고 발생시 <span class=style7>사고처리 업무 대행</span><%}%> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%if(e_bean.getIns_per().equals("2") || ej_bean.getJg_k().equals("0")){%><%}else{%>&nbsp;*<span class=style7>사고대차서비스</span>(피해사고시는 보험대차)<%}%> </span></td>
		                    </tr>
		                </table>
		          </td>
		         </tr>
		         ...
		         <tr>
		         	<td colspan="2">
		                <table width=698 class="table_est">
		                    <tr>
		                       	<td colspan=2 align=center bgcolor=#f2f2f2 height=17><span class=style3>기본식 (정비서비스 미포함 상품)</span></td>
		                     	<td align=center bgcolor=#f2f2f2 align=left>&nbsp;<span class=style3>일반식 (정비서비스 포함 상품)</span></td>
		                  	</tr>
		                  	<tr>
		                  		<td width=349 colspan=2 height=75 style="padding-left:15px;"><span class=style4>&nbsp; <span class=style7>* 아마존케어 서비스</span><br>
		                  		...
		                  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (단기 대여요금의 15~30% 수준, 탁송료 별도)</span></td>
		                   		<td width=334 align=left style="padding-left:15px;"><span class=style4>&nbsp; <span class=style7>* 일체의 정비서비스</span><br>
		                   		&nbsp;&nbsp;&nbsp;&nbsp; - 각종 내구성부품/소모품 점검, 교환, 수리<br>
		                   		&nbsp;&nbsp;&nbsp;&nbsp; - 제조사 차량 취급설명서 기준<br>
		                   		&nbsp; <span class=style7>* 정비대차서비스</span><br> 
		            ...
		            <td colspan="2" align=center> 
		            	<table width=671 border=0 cellspacing=0 cellpadding=0>
			                ...
			                <tr> 
			                  	...
			                  	<td width=8>&nbsp;</td>
			                  	<td width=635 colspan=2 align=left class=listnum2><span class=style4>등록, 자동차세 납부<%if (!e_bean.getCar_comp_id().equals("0056")) {%>, 정기검사<%}%> 
            ...
            <table width=698 border=0 cellspacing=0 cellpadding=0>
                <tr>
                    <td align=left background=../main_car_hp/images/p_up_img_prt.gif height=16>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class=style15>계약준비서류 (법인)</span>
                ...
                <tr>
                    <td width=698 >
                        <table width=698 border=0 cellspacing=0 cellpadding=0 style="border:1px solid #d9d9d9; border-bottom:0px;">
                            ...
                            <tr>
                                <td valign=top width=100 style="font-size:11px;padding-left:20px;">&nbsp;<img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>제출서류 :</span></td>	
                                <td>
									...
									<table width=598 border=0 cellspacing=0 cellpadding=0 align=center>
                                        <tr>
                                            <td width=130 style="font-size:11px;" valign=top><span class=style4>2.대표이사 자필 서명 불가시 -</span></td>
                                            <td style="font-size:11px; letter-spacing:-0.05em;">
                                            	<span class=style4>
                            ...
                            <tr>
                                <td colspan=2 style="font-size:11px;padding-left:20px;">&nbsp;<img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>신용심사 참고서류 :  </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class=style4 style="font-size:10px;">재무제표(대차대조표, 손익계산서 등) &nbsp;&nbsp;※ 필요시 연대보증인(대표이사)의 주민등록등본</span></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <table width=698 border=0 cellspacing=0 cellpadding=0 background=/acar/main_car_hp/images/p_bg_img_prt.gif>
                <tr>
                    <td align=left background=/acar/main_car_hp/images/p_up_img_prt.gif height=16>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class=style15>계약준비서류 (개인사업자)</span></td>
                    </td>
                </tr>
                <tr>
                    <td width=698 align=left>
                        <table width=698 border=0 cellspacing=0 cellpadding=0 style="border:1px solid #d9d9d9; border-bottom:0px;">
                            ...
                            <tr>
                                <td valign=top style="width: 55px; font-size:11px;padding-left:20px;">&nbsp;<img src=/acar/main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>제출서류 :</span></td>
                                <td width=590>
                            ...
                            <tr>
                                <td colspan=2 style="font-size:11px; padding-left: 20px;">
	                                ...
	                                <span class=style4 style="font-size:11px;">매출증빙자료(부가가치세과세표준증명서 등)
	                                		<br><span style='margin-left: 86px;'>※ 신용 심사에 필요할 경우 주민등록등본 제출을 요청할 수 있습니다.</span>
	                                </span>
                                </td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td width=698 align=left>
                        <table width=698 border=0 cellspacing=0 cellpadding=0 style="border:1px solid #d9d9d9; border-bottom:0px;">
                            ...
                            <tr>
                                <td width=98 valign=top style="font-size:11px;padding-left:20px;">&nbsp;<img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> <span class=style12>제출서류 :</span></td>
                                <td width=600>
                            ...
                            <tr>
                                ...
                                <img src=../main_car_hp/images/dot.gif width=3 height=3 align=absmiddle> 
                                <span class=style12>신용심사 참고서류 :</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class=style4 style="font-size:10px;">재직증명서, 소득증빙자료(원천징수영수증 등)&nbsp;&nbsp;&nbsp;&nbsp;
