...
<table width=700 border=0 cellpadding=0 cellspacing=0>
	...
	<tr>
		<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-family:'나눔고딕'; font-size:17px; font-weight:bold; color:#2d5403;">▶ Cash Flow 비교</span></td>
	</tr>
	...
	<tr>
	    <td align=center>
          ...
          <td width=68 align=center bgcolor=ffffff><font color=6c5d3b>자동차세</font></td>
                    <td width=68 align=center bgcolor=ffffff><font color=6c5d3b>사고처리<br>사고대차<br>자동차검사비</font></td>
          ...
          <td align=right bgcolor=fdf9e9><span class=style9>&nbsp;</span></td>
                ...
                <tr bgcolor=#FFFFFF>
                    <td height=30 align=center bgcolor=f0e6ca><font color=6c5d3b><%=AddUtil.parseInt(e_bean.getA_b())/12%>년평균</font></td>
                    <td align=right>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
	...
	<tr>
	    <td height=30 align=center>
	    	<table width=647 border=0 cellspacing=0 cellpadding=0>
	    		...
	    		<tr>
	    			<td height=13 align=left>&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size:14px; text-align:left; font-weight:bold; color:#2d5403;"><img src=/acar/main_car_hp/images/cashflow_dot.gif align=absmiddle> Cash Flow 차이에 따른 <%=AddUtil.parseInt(e_bean.getA_b())/12%>년간 이자절감 효과</span> (년리 <span style="font-size:14px; font-weight:bold;"><%= Math.round(AddUtil.parseFloat((String)sh_comp.get("AO70"))*10000)/100f %>%</span> 기준)</td>
	    		</tr>
	    	</table>
	    </td>
	</tr>
	                ...
	                <td bgcolor=f0f0f0>
	                    <table width=635 border=0 cellspacing=0 cellpadding=0 background=/acar/main_car_hp/images/cashflow_bg.gif>
	                        <tr>
	                            ...
	                            <td width=240><font color=585858><b><%= AddUtil.parseDecimal((long)d_tot_last_amt/(AddUtil.parseLong(e_bean.getA_b())+1)*-1) %> × <%= Math.round(AddUtil.parseFloat((String)sh_comp.get("AO70"))*10000)/100f %>% × <%=AddUtil.parseInt(e_bean.getA_b())/12%>(년) =</b></font></td>
	                            <td width=369 align=left>
	                                <table width=100 cellpadding=0 cellspacing=1 bgcolor=f13cbc>
	                                    <tr>
	                                        <td bgcolor=FFFFFF height=23 align=right><b><font color=585858><font color=f13cbc><%= AddUtil.parseDecimal(Math.round( (long)d_tot_last_amt/(AddUtil.parseLong(e_bean.getA_b())+1)*-1 * AddUtil.parseFloat((String)sh_comp.get("AO70")) * AddUtil.parseInt(e_bean.getA_b())/12 )) %> </font>원</font></b>&nbsp;</td>
	                                    </tr>
	                                </table>
	                            </td>
	                        </tr>
