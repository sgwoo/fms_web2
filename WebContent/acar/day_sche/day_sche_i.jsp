...
%>
<body>
<form action='/acar/day_sche/day_sche_i_a.jsp' name='form1' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>고객관리 > <span class=style5>일일스케쥴등록</span></span></td>
    	...
    	<td class='line'>
    		<table border=0 cellspacing=1 cellpadding=0 width=100%>
			    <tr>
			    	...
			    	<td width=80%>&nbsp;<select name='s_year'>
			    ...
			    <tr>
			    	...
			    	<td>&nbsp;<input type='text' name='title' style='IME-MODE: active' size='50' class='text' value='' maxlength='125'></td>
			    </tr>
				<tr>
			    	<td class='title'><br/><br/>내용<br/><br/></td>
			    	<td>&nbsp;<textarea rows='20' name='content' cols='55' maxlength='2000' style='IME-MODE: active' ></textarea></td>
			    </tr>    
			</table>
		</td>
	</tr>
