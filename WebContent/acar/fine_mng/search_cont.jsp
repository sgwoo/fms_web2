...
<!--
function SetCarRent(car_st, car_mng_id,rent_mng_id,rent_l_cd, rent_st)
{
...
<table border=0 cellspacing=0 cellpadding=0 width=1480>
    ...
    <tr>
        <td>차량번호 : <input type="text" name="car_no" size="10" value="<%=car_no%>" class=text style='IME-MODE: active' onKeydown="SearchFocus('car_no')">
          &nbsp;
          /
        ...
        <td class=line> 
            <table border=0 cellspacing=1 width=100%>
                ...
                <tr> 
                  ...
                  <td <%=td_color%> align="center"><a href="javascript:SetCarRent('<%=ht.get("CAR_ST")%>','<%=ht.get("CAR_MNG_ID")%>','<%=ht.get("RENT_MNG_ID")%>','<%=ht.get("RENT_L_CD")%>','<%=ht.get("RENT_ST")%>')"><%=ht.get("RENT_L_CD")%></a></td>
