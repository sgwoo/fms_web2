...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/acar/condition/rent_end_cond_frame.jsp'>  
    ...
    <tr>
		<td>
			 <table border="0" cellspacing="1" cellpadding="0" width=100%>
				<tr>
					<td><iframe src="./rent_end_cond_sc_in.jsp?auth_rw=<%=auth_rw%>&dt=<%=dt%>&ref_dt1=<%=ref_dt1%>&ref_dt2=<%=ref_dt2%>&gubun3=<%=gubun3%>&gubun4=<%=gubun4%>&height=<%=height%>" name="RentEndCondList" width="100%" height="<%=height+10%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
				</tr>
			</table>
		</td>
	</tr>
