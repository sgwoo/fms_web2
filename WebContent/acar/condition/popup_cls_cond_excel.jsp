...
response.setHeader("Content-Disposition", "inline; filename=popup_cls_cond_excel.xls");
%>
...
%>
                <tr> 
                    ...
                    <td align="left">&nbsp; <%=cc_bean.getFirm_nm()%></td>
                    <td align="left"><%=cc_bean.getClient_nm()%></td>
                    <td align="center"><%= cc_bean.getCar_no() %></td>
                    <td align="left">&nbsp;<%=cc_bean.getCar_name()%></td>
