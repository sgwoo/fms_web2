    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계출관리 > <span class=style5>미출고현황</span></span></td>
...
%>
            		...
            		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_gshm.gif align=absmiddle>&nbsp;
            			<select name="fn_id">
            				<option value="0"> 전체 </option>
            				<option value="1"> 상호 </option>
            				<option value="2"> 차종 </option>
            				<option value="3"> 제조사 </option>
							<option value="4"> 영업소 </option>
							<option value="5"> 최초영업자 </option>
            			</select>
                        <input type="text" name="find_u" width='200' value="">
                        &nbsp;<a href="javascript:SearchRegCond()"><img src=../images/center/button_search.gif border=0 align=absmiddle></a></td>
            	</tr>
            </table>
        </td>
    </tr>
