...
<table border="0" cellspacing="0" cellpadding="0" width=570>
    ...
    <tr>
        <td align="right">
		<%	String reg_id1 = nm_db.getWorkAuthUser("출고관리자");			
			String reg_id2 = "";			
			CarScheBean cs_bean = csd.getCarScheTodayBean(reg_id1);
			if(!cs_bean.getUser_id().equals("") && !cs_bean.getWork_id().equals("")){
				reg_id2 = cs_bean.getWork_id();
			}
			
			%>
		<%if(nm_db.getWorkAuthUser("출고확정확인자",ck_acar_id) || ck_acar_id.equals(reg_id1) || ck_acar_id.equals(reg_id2) || nm_db.getWorkAuthUser("전산팀",ck_acar_id)){%>		
