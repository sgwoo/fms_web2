...
function open_accident()
{
	...
	var SUBWIN = "./off_lease_accident.jsp"+url;
...
<input type="hidden" name="gubun" value="">
  <table border=0 cellspacing=0 cellpadding=0 width=800>
    <tr> 
      <td align='left' width="650"> <<기본정보>> </td>
      <td align='left' width="100"></td>
      <td align='right' width="50">
	  <a href='javascript:self.close()'>
	  <img src="/images/close.gif" width="50" height="18" align="absmiddle" border="0" alt="닫기"></a></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td align='left' colspan="3"> <<차량가격>> </td>
    </tr>
    <tr> 
      <td class=line colspan="3"><table border="0" cellspacing="1" cellpadding='0' width="800" >
          <tr> 
    ...
    <tr> 
      <td align='left' colspan="3"> <<기타정보>></td>
    </tr>
    <tr> 
      <td class='line' colspan="3">
        <table border="0" cellspacing="1" cellpadding="0">
    ...
    <tr> 
      <td align='left' colspan="2"><<상품평가>></td>
	  <td align="right">
  <%if(auth_rw.equals("4")||auth_rw.equals("6")){%>	  
    ...
    <tr> 
      <td  colspan="3"> 
        <table border="0" cellspacing="1" cellpadding="0" width="800">
          <tr> 
            <td align='center'><a href="javascript:open_car_his()">차량이력표</a>  &nbsp;&nbsp;&nbsp;
			|| &nbsp;&nbsp;&nbsp;<a href="javascript:open_car_mng()">정비기록표</a> &nbsp;&nbsp;&nbsp;
			|| &nbsp;&nbsp;&nbsp;<a href="javascript:open_accident()">사고기록표</a> &nbsp;&nbsp;&nbsp;
			</td>
          </tr>
        </table>
      </td>
