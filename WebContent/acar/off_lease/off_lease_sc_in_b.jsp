...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    <tr> 
        <td align='left'><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>기본정보</span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>
    <tr> 
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width="100%">
                ...
                <tr> 
                    <td align="center"> <%if(detail.getCar_use().equals("1")){%>렌트사업용<%}else{%>리스사업용<%}%></td>
    ...
    <tr> 
        <td align='left'><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>차량가격</span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>
            ...
            <table border="0" cellspacing="1" cellpadding='0' width="100%" >
                ...
                <tr> 
					...
					<td align="center"> <%if(auth_rw.equals("4")||auth_rw.equals("6")){
        				if(imgfile[0].equals("") && imgfile[1].equals("") && imgfile[2].equals("") && imgfile[3].equals("") && imgfile[4].equals("")){%> <a href='javascript:imgAppend();'> 
    ...
    <tr> 
        <td align='left'><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>기타정보</span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>
    ...
    <tr> 
        <td align='left'><iframe src="./off_lease_sc_in_b_apprsl.jsp?auth_rw=<%=auth_rw%>&car_mng_id=<%=car_mng_id%>" name="in_apprsl" width="100%" height="220" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
    </tr>
</table>
</form>
