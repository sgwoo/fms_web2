...
<!--
	...
	function set_zip(zip_str, addr_str){
		...
		if(str == "mgr"){
			window.opener.form1.m_zip1.value 	= zip_str;
			window.opener.form1.m_addr1.value 	= addr_str;
		}else if(str == "gua"){
			window.opener.form1.m_zip3.value 	= zip_str;
			window.opener.form1.m_addr3.value 	= addr_str;
		}else if(str == "cust"){
