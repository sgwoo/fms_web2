...
<!--
	function save()
	{
		...
		if ( fm.client_st.value == '1' || fm.client_st.value == '6' ) {		//법인
			...
			if(fm.ssn1[0].value == '' || fm.ssn2[0].value == '')	{	alert('법인번호를 입력하십시오');	return;	}
			if((!isNum(fm.ssn1[0].value)) || (!isNum(fm.ssn2[0].value)) || ((fm.ssn1[0].value.length != 6)&&(fm.ssn1[0].value.length != 0)) || ((fm.ssn2[0].value.length != 7)&&(fm.ssn2[0].value.length != 0)))	{	alert('주민등록번호(법인번호)를 확인하십시오');	return;	}
			...
			if(fm.m_tel[0].value == '')	{	alert('휴대폰번호를 확인하십시오');	return;	}
			if(!isTel(fm.m_tel[0].value))	{	alert('휴대폰번호를 확인하십시오');	return;	}
			if(fm.o_tel[0].value == '')	{	alert('회사전화번호를 확인하십시오');	return;	}
			...
			if(fm.ssn1[2].value == '' || fm.ssn2[2].value == '')	{	alert('주민번호를 입력하십시오');	return;	}
			if((!isNum(fm.ssn1[2].value)) || (!isNum(fm.ssn2[2].value)) || ((fm.ssn1[2].value.length != 6)&&(fm.ssn1[2].value.length != 0)) || ((fm.ssn2[2].value.length != 7)&&(fm.ssn2[2].value.length != 0)))	{	alert('주민등록번호(법인번호)를 확인하십시오');	return;	}
			if(fm.t_zip[5].value == '')	{	alert('자택주소를 확인하십시오');	return;	}
			if(fm.m_tel[2].value == '')	{	alert('휴대폰번호를 확인하십시오');	return;	}
			if(!isTel(fm.m_tel[2].value))	{	alert('휴대폰번호를 확인하십시오');	return;	}
			if(fm.h_tel[2].value == '')	{	alert('자택전화번호를 확인하십시오');	return;	}
			if(!isTel(fm.h_tel[2].value))	{	alert('자택전화번호를 확인하십시오');	return;	}
								
	   	} else {		
									
			if(fm.firm_nm[1].value == '')	{	alert('상호를 입력하십시오');	return;	}
			if(fm.client_nm[1].value == '')	{	alert('대표자를 입력하십시오');	return;	}
			if((!isNum(fm.ssn1[1].value)) || (!isNum(fm.ssn2[1].value)) || ((fm.ssn1[1].value.length != 6)&&(fm.ssn1[1].value.length != 0)) || ((fm.ssn2[1].value.length != 7)&&(fm.ssn2[1].value.length != 0)))	{	alert('주민등록번호(법인번호)를 확인하십시오');	return;	}
			...
			if(fm.m_tel[1].value == '')	{	alert('휴대폰번호를 확인하십시오');	return;	}
			if(!isTel(fm.m_tel[1].value))	{	alert('휴대폰번호를 확인하십시오');	return;	}
			if(fm.o_tel[1].value == '')	{	alert('회사전화번호를 확인하십시오');	return;	}
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업관리 > 고객관리 > <span class=style5>고객등록</span></span></td>
	...
	<tr>
	    <td class=line>
	        <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    <td width="15%" rowspan='3' class='title'>세금계산서<br>
                        담당자</td>
                ...
                <tr>
                    <td colspan='3'>&nbsp;<img src=/acar/images/center/arrow.gif> EMAIL:
        			  ...
        			  &nbsp;<img src=/acar/images/center/arrow.gif> 근무부서:
                ...
                <tr>
                    ...
                    <td>&nbsp;
                        <select name='print_car_st'>
                          ...
                          <option value='1'>승합/화물/9인승/경차</option>
                        </select>
                    </td>
                </tr>
                <tr>                    
