...
<!--
	...
	function cls_print(){
		...
		var SUBWIN="cls_print.jsp?m_id=<%=m_id%>&l_cd=<%=l_cd%>";
	...
	function view_settle1(m_id, l_cd){
		window.open("/acar/cls_con/cls_settle1.jsp?m_id="+m_id+"&l_cd="+l_cd, "VIEW_SETTLE2", "left=100, top=10, width=700, height=630, scrollbars=yes, status=yes");		
	}
  ...
  <table border="0" cellspacing="0" cellpadding="0" width=800>
      ...
      <td class="line"> 
        <table border="0" cellspacing="1" cellpadding="0" width=100%>
          ...
          <tr> 
            ...
            <td> 
              <select name="pp_st">
                <option value='1' <% if(cls.getPp_st().equals("1")){%>selected<%}%>>3개월치 
                대여료 선납식</option>
                <option value='2' <% if(cls.getPp_st().equals("2")){%>selected<%}%>>고객 
                선택형 선납식</option>
              </select>
            </td>
          ...
          <tr> 
            <td class='line'> 
              <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <!--
                <tr> 
                  <td colspan="2" class="title">기타(L)</td>
                  <td class='title' width='40%' align="center"> 
                ...
                <tr> 
                  ...
                  <td class='title' width='35%'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td id=td_cancel_n style='display:block' class='title'>=(대여료미납입금액-B-C)×10% 
                        </td>
                        <td id=td_cancel_y style='display:none' class='title'>=(대여료미납입금액-B-C)×10% 
                        </td>
                      </tr>
                    </table></td>
                </tr>
    ...
    <tr align="right"> 
      ...
      <% if (user_id.equals("000063") ) { %>
           ...
           <a href="javascript:view_settle1('<%=m_id%>', '<%=l_cd%>');" onMouseOver="window.status=''; return true" onfocus="this.blur()">test1</a> 
      <% } %>
       
  	  <%if(br_id.equals("S1") || br_id.equals(String.valueOf(fee_base.get("BRCH_ID")))){%>
	    <a href='javascript:<%if(auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")){%>save();<%}else{%>alert("권한이 없습니다");<%}%>' onMouseOver="window.status=''; return true" onfocus="this.blur()"><img src="/acar/images/center/button_modify.gif" aligh="absmiddle" border="0" alt="수정"></a>  <a href='javascript:window.close();' onMouseOver="window.status=''; return true" onfocus="this.blur()"><img src="/acar/images/center/button_close.gif" aligh="absmiddle" border="0" alt="닫기"></a>
	  <%}%>
	    <a href='javascript:cls_print();' onMouseOver="window.status=''; return true" onfocus="this.blur()"><img src="/acar/images/center/button_print.gif"  aligh="absmiddle" border="0" alt="닫기"></a>
		<br>
