...
<!--
	...
	function cls_display(){
		...
		alert("!!!!주행거리 초과운행대여료(M)를 클릭하여 주행거리요금을 반드시 적용하고 금액확인하세요!!!!");
	...
	function set_msg(){
		...
		fm.over_amt.value = "";
		fm.dist_msg.value = '!!! 초과운행대여료를 확인하세요 !!!';
...
<input type='hidden' name='tot_dist_cnt' > <!-- 초과운행 팝업 --> 
  ...
  <table border="0" cellspacing="0" cellpadding="0" width=630>
   ...
   <tr id=tr_opt style='display:none'> 
 	 	  ...
 	 	  <tr>
		    	...
		    	<table border="0" cellspacing="1" cellpadding="0" width=100%>
		          <tr> 		          	
		             ...
		             <td colspan=4>&nbsp;<input type='text' name='opt_amt'size='11' class='num' value="<%=AddUtil.parseDecimal(s_opt_amt)%>" onBlur='javascript:this.value=parseDecimal(this.value);'> (VAT포함)</td> 
		          </tr>	
              ...
              <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                  <td class="title" rowspan="6" width="5%"><br>
                    기<br>
                    타</td> 
                  <td class="title" colspan="2" >연체료(H)</td>
                  <td width='35%' align="center"> 
                ...
                <tr> 
                  <td class="title" colspan="2">잔존차량가격(K)</td>
                  <td class='title' width='35%' align="center"> 
                ...
                <tr> 
                  <td class="title" colspan="2">초과운행대여료(M)
                  </td>
                  <td class='title' width='35%' align="center"> 
                  ...
                  <td class='title' width='35%'>&nbsp;* 예상주행거리 <input type='text' name='tot_dist' value='<%= AddUtil.parseDecimal(today_dist) %>' size='6' class='num' onBlur='javascript:this.value=parseDecimal(this.value); set_msg();'>km
            ...
            <td class=line  colspan="2">
                <table width=100% border=0 cellspacing=1 cellpadding=0>
       		  <tr>
                    ...
                    <td width=35% class='title' align=center>&nbsp;※ 고객납입금액  + 매입옵션가 + 이전등록비용(발생한 경우)</td>
              </tr>
    ...
    <tr> 
      <td colspan="2">&nbsp;<span class=style2><input type='text' name='dist_msg' value='!!! 초과운행대여료를 확인하세요 !!!' size='30' class='whitetext' ></span></td>
    </tr>
