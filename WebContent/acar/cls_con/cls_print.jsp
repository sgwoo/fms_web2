...
<input type='hidden' name='b_lst' value='<%=b_lst%>'> 
  ...
  <table border="0" cellspacing="0" cellpadding="0" width=670>
    ...
    <!--중도해지-->
    <tr id=tr_default style='display:<%if((cls.getCls_st().equals("중도해약") || cls.getCls_st().equals("계약만료") ||  cls.getCls_st().equals("월렌트해지") ) && cls.getCls_doc_yn().equals("Y")  ) {%>block<%}else{%>none<%}%>'> 
      <td colspan="2"> 
          ...
          <tr> 
            <td class='line'> 
              <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                  <td colspan="2" class="title">부가세(M)</td>
                  <td class='title' align="center"> 
                  ...
                  <td class='title' width='35%'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td id=td_cancel_y style='display:none' class='title'>=(미납입금액-B-C)×10%
                        </td>
                      </tr>
                    </table></td>
                </tr>
	 ...
	 <tr> 
          ...
          <%if(1!=1){
			...
			if(cls_scd_size>0){%>
          <tr> 
            <td align='left' > <<중도해지정산금 스케줄 리스트>> </td>
          </tr>
          <tr> 
