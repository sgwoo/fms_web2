...
<input type='hidden' name='fee_size' value='<%=fee_size%>'> 
  ...
  <table border="0" cellspacing="0" cellpadding="0" width=800>
      ...
      <td class="line"> 
        <table border="0" cellspacing="1" cellpadding="0" width=100%>
          <tr> 
            ...
            <td width="40%"><select name="cls_st" onChange='javascript:cls_display()' disabled >
    ...
    <!--중도해지-->
    <tr id=tr_default style='display:<%if( (cls.getCls_st().equals("중도해약") && cls.getCls_doc_yn().equals("Y")) ||  (cls.getCls_st().equals("계약만료") && cls.getCls_doc_yn().equals("Y")) ) {%>block<%}else}%>none<%}%>'> 
      <td colspan="2"> 
              ...
              <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                  ...
                  <td class='title' width='35%'><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td id=td_cancel_n style='display:block' class='title'>=(미납입금액-B-C)×10% 
                        </td>
                        <td id=td_cancel_y style='display:none' class='title'>=미납입금액×10% 
                        </td>
                      </tr>
                    </table></td>
                </tr>
