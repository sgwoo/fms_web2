...
//	System.out.println("dly_c_dt =" + dly_c_dt + " |rent_end_dt=" + rent_end_dt + "| cls_dt = " + cls_dt + "| cls_st=" + cls_st +"| rent_l_cd = " + rent_l_cd );
   ...
   rec_amt = as_db.getReceiveAmt(rent_mng_id, rent_l_cd,  AddUtil.replace(cls_dt,"-",""));  //개시대여료가 없는 경우 
...
<% } %>
	...
	t_fm.nnfee_v_amt.value 	= '<%=AddUtil.parseDecimal(AddUtil.parseInt((String)base.get("NFEE_V_AMT")))%>';	
...
//	t_fm.m_mon.value		= '<%=base.get("M_MON")%>';
//	t_fm.m_day.value		= '<%=base.get("M_DAY")%>';
