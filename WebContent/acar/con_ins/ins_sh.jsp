...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > <%if(gubun.equals("cls")){%>수금관리 > <span class=style5>환급보험료관리</span> <%}else{%>영업비용관리 -> <span class=style5>자동차보험료 <%if(f_list.equals("now")){%>납부관리<%}else if(f_list.equals("renew")){%>갱신관리<%}else{%>만료관리<%}%><%}%></span></span></td>
	...
	<tr>
                ...
                <tr> 
                    ...
                    <td width='150'><img src=/acar/images/center/arrow_sbjh.gif align=absmiddle>&nbsp;
                      <select name="gubun3">
                        ...
                        <option value="2" <%if(gubun3.equals("2")){%>selected<%}%>><%if(gubun.equals("")) {%>지출 <%}else{%>수금<%}%></option>
                        <option value="3" <%if(gubun3.equals("3")){%>selected<%}%>>미<%if(gubun.equals("")) {%>지출 <%}else{%>수금<%}%></option>
        				<%}%>
                      </select>
                    </td>
                ...
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp;
                      <select name='s_kd' onChange="javascript:document.form1.t_wd.value='', cng_input()">
                        ...
                        <option value='10' <%if(s_kd.equals("10")){%> selected <%}%>>보험계약일</option>
                        <option value='11' <%if(s_kd.equals("11")){%> selected <%}%>>보험만료일</option>
        				<%if(f_list.equals("now")){%>
                        <option value='12' <%if(s_kd.equals("12")){%> selected <%}%>>납부일</option>								
                        <option value='13' <%if(s_kd.equals("13")){%> selected <%}%>>회차</option>												
        				<%}%>
        				<%//if(br_id.equals("S1")){%>
        ...
        <!--                <option value='7' <%if(s_kd.equals("7")){%> selected <%}%>>사용본거지</option>
                        ...
                        <option value='14' <%if(s_kd.equals("14")){%> selected <%}%>>영업용</option>
                        <option value='15' <%if(s_kd.equals("15")){%> selected <%}%>>업무용</option>
                      </select>
                    </td>
                    <td> 
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td><img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>&nbsp;
                      <select name='sort_gubun' onChange='javascript:search()'>
        				  <%if(f_list.equals("now")){%>			  
                          <option value='0' <%if(sort_gubun.equals("0")){%> selected <%}%>><%if(gubun.equals("")) {%>납부 <%} else{ %>입금<%}%>일</option>
        				  <%}%>
                        <option value='1' <%if(sort_gubun.equals("1")){%> selected <%}%>>상호</option>
                        <option value='2' <%if(sort_gubun.equals("2")){%> selected <%}%>>보험사</option>
                        <option value='3' <%if(sort_gubun.equals("3")){%> selected <%}%>>보험계약일</option>
                        <option value='6' <%if(sort_gubun.equals("6")){%> selected <%}%>><%if(gubun.equals(""))%>보험만료일<%else%>해지일<%%></option>
