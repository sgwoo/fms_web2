...
<%
	...
	EstimateBean [] e_r = e_db.getEstimateFmsShList(gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, s_dt, e_dt, s_kd, t_wd);
	int size = e_r.length;
%>
<html>
<head>
...
<table border=0 cellspacing=0 cellpadding=0 width=1720>
    ...
    <tr id='tr_title' style='position:relative; z-index=1'> 
        <td width=560 class='line' id='td_title' style='position:relative;'> 
    ...
    <tr> 
        <td width=560 class='line' id='td_con' style='position:relative;'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td width=100 align="center">
                    	<span title='<%=bean.getEst_nm()%>'><%=AddUtil.substringbdot(bean.getEst_nm(), 14)%></span>
                    </td>
                </tr>
				<%}%>
				<%if (size == 0) {%>
                ...
                <tr> 
                    ...
                    <td width=130>&nbsp;
                    	<span title='<%=bean.getCar_nm()+" "+ bean.getCar_name()%>'>
                    		<%=AddUtil.substringbdot(bean.getCar_nm()+" "+ bean.getCar_name(), 13)%>
                    	</span>
                    </td>
                    ...
                    <td width=80 align="right">
                        ...
                        <%} else {%>
                            <%if (bean.getFee_s_amt() == -1) {%>
                            	미운영
                            <%} else {%>
                            	<%=Util.parseDecimal(bean.getFee_s_amt()+bean.getFee_v_amt())%>원
                            <%}%>
                        <%}%>
                    </td>
                    ...
                    <td width=200 align="center"><span><%=bean.getEst_email()%></span></td>
                </tr>
                <%}%>
                <%if (size == 0) {%>
                <tr> 
                    <td align="center" height=25 colspan="12">등록된 데이타가 없습니다.</td>
                </tr>
              	<%}%>
            </table>
        </td>
