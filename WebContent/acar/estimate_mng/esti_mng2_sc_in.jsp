        ...
        <td class='line' width=1260>
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td width=95 class=title>차량가격</td>
    ...
    <tr> 
        <td width=470 class='line' id='td_con' style='position:relative;'> 
		    ...
		    <td width=40 align=center><input type="checkbox" name="ch_l_cd" value="<%=bean.getEst_id()%>"></td>
                  ...
                  <% if(size == 0) { %>
                <tr> 
                    <td width=700 align=center colspan="9">등록된 데이타가 없습니다.</td>
                </tr>
          <%}%>
            </table>
        </td>
        <td width=1260 class='line'>
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td width=95 align="right"><%=Util.parseDecimal(bean.getO_1())%>원</td>
                    ...
                    <td width=75 align="right"><%=Util.parseDecimal(bean.getPp_s_amt()+bean.getPp_v_amt())%>원</td>
                    ...
                    <td width=250 align="center">
                        ...
                        [<%=bean.getPrint_type()%>/<%=Util.parseDecimal(bean.getCtr_s_amt()+bean.getCtr_v_amt())%>원]
                        <%}%>
                        <%=bean.getEst_email()%>
                    </td>
                </tr>
