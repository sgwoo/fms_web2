...
<body>
<form action="./esti_emp_sc.jsp" name="form1" method="POST" >
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업관리 > 견적관리 > <span class=style5>업무대여견적서관리</span></span></td>
            ...
            <table border=0 cellpadding=0 cellspacing=1 width="100%">
                <tr> 
                    <td width="40%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_g_gj.gif align=absmiddle>&nbsp;
                        <select name="gubun1">
                            <option value="7" <%if(gubun1.equals("7"))%>selected<%%>>업무대여차량</option>
                        </select> 
                    </td>
                    <td width=60%>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <select name="s_kd">
                                    ...
                                    <option value="3" <%if(s_kd.equals("3"))%>selected<%%>>사원명</option> 
                                  </select> 
								  &nbsp;&nbsp;&nbsp;
