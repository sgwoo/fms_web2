...
<%@ page import="java.util.*, acar.util.*, acar.common.*, acar.car_office.*, acar.car_mst.*, acar.estimate_mng.*, acar.secondhand.* , acar.user_mng.*, acar.cont.*, acar.client.*,acar.kakao.*" %>
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
  ...
  <input type="hidden" name="gubun6" value="<%=gubun6%>">  
	...
	<input type="hidden" name="from_page" value="esti_ext_mng_u.jsp">
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업관리 > 견적관리 > <span class=style5>연장 견적내기(<%=est_id%>)</span></span> : (<%=est_id%>)</td>
...
%>                 
    ...
    <tr> 
    <%
		String url1 = "http://fms1.amazoncar.co.kr/acar/secondhand_hp/estimate_fms_ym.jsp?est_id="+e_bean.getEst_id()+"&acar_id="+user_id+"&from_page=/acar/estimate_mng/esti_mng_u.jsp&content_st=sh_fms_ym";
	%> 
        <td class=line colspan="2"> 
				...
				<tr>
					...
					<td>&nbsp;
					    <select name="s_destphone" onchange="javascript:document.form1.est_m_tel.value=this.value;">
        			  	...
        			  	&nbsp;&nbsp;
        			  	번호 : <input type='text' size='15' name='est_m_tel' value='' maxlength='100' class='text'>		
				    </td>
				</tr>			
                <%-- <% AlimTemplateBean at_bean = at_db.selectTemplate("acar0072"); %> --%>
                <tr>
                  	...
                  	<td width="90%">&nbsp;
						...
						<!-- <br><br>&nbsp; -->
                    	<%-- &nbsp;[템플릿] : <%=at_bean.getContent() %> --%>
				  	</td>
                </tr>
                <%-- <% at_bean = at_db.selectTemplate("acar0073"); %> --%>
			</table>
		</td>
	</tr>
	<tr>
    ...
    <tr>
		<td class=line colspan="2"> 
			<table border="0" cellspacing="1" width=100%>                
                <tr>
                  	<td width="10%" class=title><input type="checkbox" name="ch_mms_id" value="<%=e_bean.getEst_id()%>" checked >견적서 알림톡</td>
                  	<td width="90%">&nbsp;
                  		<%
							String s_a_a = "";
							String s_rent_way = "";
							...
							fieldList.add("[연장]"+car_no+" "+cm_bean2.getCar_nm());
					    ...
					    <input type="hidden" name="a_car_name" value="[연장]<%=car_no%> <%=cm_bean2.getCar_nm()%>">
					    ...
					    <input type="hidden" name="wap_msg_body" value="">
