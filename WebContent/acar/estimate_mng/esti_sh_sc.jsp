...
<!--
	...
	function select_sms(){
		...
		window.open("", "popup_window", "left="+popX+", top="+popY+", width=450, height=650, scrollbars=yes, status=yes");
		fm.action = "/acar/apply/select_sms_input.jsp";
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    <tr> 
      <td>	  
	   	...
	   	<a href="javascript:select_sms();" title='선택 문자발송하기'><img src=/acar/images/center/button_send_ssms.png align=absmiddle border=0></a>&nbsp;	   
	   	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
