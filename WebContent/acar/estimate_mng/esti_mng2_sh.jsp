...
<!--
	...
	function search(){
		...
		if(fm.gubun5.value == '' && fm.t_wd.value == ''){
			alert('작성자 혹은 검색어를 입력하십시오.'); 
			return;
		}
		
		fm.action = "esti_mng2_sc.jsp";
		fm.target = "c_foot";
		fm.submit();
	}
	function EnterDown(){
...
<body>
<form action="./esti_mng2_sc.jsp" name="form1" method="POST" >
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 견적시스템 > <span class=style5>신차견적서관리 (~3개월전) </span></span></td>
