...
<%
	...
	EstimateBean [] e_r = e_db.getEstimateRmList(gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, s_dt, e_dt, s_kd, t_wd, esti_m, esti_m_dt, esti_m_s_dt, esti_m_e_dt);
	int size = e_r.length;
%>
<html>
<head>
...
<form action="esti_rm_mng_u.jsp" name="form1" method="POST">
  ...
  <input type="hidden" name="from_page" value="esti_rm_sc_in.jsp">                    
...
<table border=0 cellspacing=0 cellpadding=0 width=1360>
    ...
    <tr id='tr_title' style='position:relative;z-index:1'> 
        <td width=510 class='line' id='td_title' style='position:relative;'> 
    ...
    <tr> 
        <td width=510 class='line' id='td_con' style='position:relative;'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
		    ...
		    <!--
                    ...
                    <td width=160 align=center><a href="javascript:EstiDisp('<%=bean.getEst_id()%>','<%=bean.getSet_code()%>')"><%= AddUtil.ChangeDate3(bean.getReg_dt()) %></a></td>
        ...
        <td width=850 class='line'>
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td width=130>&nbsp;<span title='<%=bean.getCar_nm()+" "+ bean.getCar_name()%>'><%=AddUtil.substringbdot(bean.getCar_nm()+" "+ bean.getCar_name(), 13)%></span></td>
