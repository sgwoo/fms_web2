...
<input type='hidden' name='go_url' value='../ins_stat/ins_s3_frame.jsp'>
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr> 
        <td><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>경과보험료관리(렌트사업용)</span></td>
        <td align="right"><!--<font color="#666666">(최종마감일:2004-08-24)</font>&nbsp;--></td>
        <td width=17>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr> 
        <td class=line colspan="2"> 
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr> 
                    <td class='title' width=17% rowspan="2">구분</td>
                    <td class='title' colspan="2">당초납입보험료(①)</td>
                    <td class='title' colspan="2">추가보험료(②)</td>
                    <td class='title' colspan="2">해지보험료(③)</td>
                    <td class='title' colspan="2">경과보험료(①+②-③)</td>
                    <td class='title' colspan="2">자차보험료적립</td>
                </tr>
                <tr> 
                    <td class='title' width=7%>건수</td>
    ...
    <tr> 
        <td colspan="3"><iframe src="ins_s3_sc3_in.jsp?auth_rw=<%=auth_rw%>&br_id=<%=br_id%>&user_id=<%=user_id%>&gubun0=<%=gubun0%>&gubun1=<%=gubun1%>&gubun2=<%=gubun2%>&gubun3=<%=gubun3%>&gubun4=<%=gubun4%>&gubun5=<%=gubun5%>&gubun6=<%=gubun6%>&gubun7=<%=gubun7%>&brch_id=<%=brch_id%>&st_dt=<%=st_dt%>&end_dt=<%=end_dt%>&s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&sort=<%=sort%>&asc=<%=asc%>&s_st=<%=s_st%>&go_url=<%=go_url%>&idx=<%=idx%>" name="i_in" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
        </iframe></td>
    </tr>
    <!--
    <tr> 
