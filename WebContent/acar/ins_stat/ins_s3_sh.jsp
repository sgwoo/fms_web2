...
%>
<form action="./ins_s1_sc3.jsp" name="form1" method="POST" target="c_foot">
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    	...
    	<td colspan=4>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고관리 > 보험현황 > <span class=style5>경과보험료현황</span></td>
    ...
    <tr align="center"> 
        <td colspan="4"> 
        <a href="javascript:sub_in(1)"><img src="/acar/images/center/button_ins_gg.gif" align="absmiddle" border="0"></a>&nbsp;&nbsp;<!-- <a href="javascript:sub_in(2)">경과보험료관리 
        그래프</a> ||--> <a href="javascript:sub_in(3)"><img src="/acar/images/center/button_ins_rent.gif" align="absmiddle" border="0"></a>&nbsp;&nbsp; <a href="javascript:sub_in(4)"><img src="/acar/images/center/button_ins_lease.gif" align="absmiddle" border="0"></a> 
        </td>
    </tr>
    <tr>
        <td class=h></td>
