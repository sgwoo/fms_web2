...
<table border="0" cellspacing="0" cellpadding="0" width=99%>
    <tr> 
        <td><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>해지현황</span>&nbsp;&nbsp;&nbsp;<font color='#999999'>(청구일자 기준)</font></td>
        <td align="right"> 
        ...
        <td class=line colspan="2"> 
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr> 
                    ...
                    <td class='title' width="7%">해지사유</td>
                    <td class='title' width="9%">발생일자</td>			
                    <td class='title' width="9%">청구일자</td>
                    <td class='title' width="9%">환급일자</td>
                    <td class='title' width=11%>환급금액</td>
                </tr>
            </table>
        </td>
        <td width=16>&nbsp;</td>
    ...
    <tr> 
        <td colspan="3"><iframe src="ins_s1_sc4_in.jsp?auth_rw=<%=auth_rw%>&br_id=<%=br_id%>&user_id=<%=user_id%>&gubun0=<%=gubun0%>&gubun1=<%=gubun1%>&gubun2=<%=gubun2%>&gubun3=<%=gubun3%>&gubun4=<%=gubun4%>&gubun5=<%=gubun5%>&gubun6=<%=gubun6%>&gubun7=<%=gubun7%>&brch_id=<%=brch_id%>&st_dt=<%=st_dt%>&end_dt=<%=end_dt%>&s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&sort=<%=sort%>&asc=<%=asc%>&go_url=<%=go_url%>&s_st=<%=s_st%>#<%=idx%>" name="i_in" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
        </iframe></td>
    </tr>
    <!--
    <tr> 
