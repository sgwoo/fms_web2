...
<!--
	...
	function list_excel(){
		...
		fm.action = "./ins_s1_sc1_excel.jsp";
		fm.submit();
	}
	function excel_list(){
		var fm = document.form1;
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr> 
        <td><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>신규등록현황</span>
		&nbsp;<a href="javascript:excel_list()"><img src="/acar/images/center/button_excel.gif"  align="absmiddle" border="0"></a> 
		</td>
        <td align="right"> 
        <img src=/acar/images/center/arrow.gif align=absmiddle><input type='text' name='total' value='' class=whitenum size="3">건</td>
        <td width=16>&nbsp; </td>
    </tr>
    <tr>
        ...
        <td class=line colspan="2"> 
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr> 
                    ...
                    <td class='title' width="7%">등록사유</td>
                    <td class='title' width="8%">보험구분</td>
                    <td class='title' width="8%">보험회사</td>
                    <td class='title' width="16%">보험기간</td>
                    <td class='title' width="11%">보험료</td>
                </tr>
            </table>
        </td>
        <td width=16>&nbsp;</td>
    ...
    <tr> 
        <td colspan="3"><iframe src="ins_s1_sc1_in.jsp?auth_rw=<%=auth_rw%>&br_id=<%=br_id%>&user_id=<%=user_id%>&gubun0=<%=gubun0%>&gubun1=<%=gubun1%>&gubun2=<%=gubun2%>&gubun3=<%=gubun3%>&gubun4=<%=gubun4%>&gubun5=<%=gubun5%>&gubun6=<%=gubun6%>&gubun7=<%=gubun7%>&brch_id=<%=brch_id%>&st_dt=<%=st_dt%>&end_dt=<%=end_dt%>&s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&sort=<%=sort%>&asc=<%=asc%>&go_url=<%=go_url%>&s_st=<%=s_st%>#<%=idx%>" name="i_in" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
        </iframe></td>
    </tr>
    <!--
    <tr> 
