        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
              <%for (int i = 0 ; i < ym_size ; i++){
    				...
    				InsStatBean ins1 = ai_db.getInsStatList3_in3_bean(String.valueOf(pym.get("PAY_DT")), "신규", br_id, gubun1, gubun2, gubun3, gubun4, brch_id, st_dt, end_dt, s_kd, t_wd, sort, asc, s_st);
    				InsStatBean ins2 = ai_db.getInsStatList3_in3_bean(String.valueOf(pym.get("PAY_DT")), "갱신", br_id, gubun1, gubun2, gubun3, gubun4, brch_id, st_dt, end_dt, s_kd, t_wd, sort, asc, s_st);
    				InsStatBean ins3 = ai_db.getInsStatList3_in3_bean(String.valueOf(pym.get("PAY_DT")), "분납", br_id, gubun1, gubun2, gubun3, gubun4, brch_id, st_dt, end_dt, s_kd, t_wd, sort, asc, s_st);
