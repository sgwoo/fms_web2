...
<%
	...
	Vector inss = ai_db.getInsStatList_in2(br_id, brch_id, st_dt, end_dt, gubun1, gubun2);
            ...
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
              ...
              <%	for (int i = 0 ; i < ins_size ; i++){
                ...
                <tr> 
                    ...
                    <td align="center" width='10%'><a href="javascript:parent.insDisp('<%=ins.get("RENT_MNG_ID")%>', '<%=ins.get("RENT_L_CD")%>', '<%=ins.get("CAR_MNG_ID")%>', '<%=ins.get("INS_ST")%>')" onMouseOver="window.status=''; return true"><%=ins.get("CAR_NO")%></a></td>
                    ...
                    <td align="center" width='7%'><%=ins.get("REG_CAU")%></td>
                    <td align="center" width='8%'><%=ins.get("INS_KD")%></td>
                    <td align="center" width='8%'><%=ins.get("INS_COM_NM")%></td>
                    <td align="center" width='16%'><%=AddUtil.ChangeDate2(String.valueOf(ins.get("INS_START_DT")))%>~<%=AddUtil.ChangeDate2(String.valueOf(ins.get("INS_EXP_DT")))%></td>
                    <td align="right" width='11%'><%=Util.parseDecimal(String.valueOf(ins.get("INS_AMT")))%>원&nbsp;</td>
                </tr>
