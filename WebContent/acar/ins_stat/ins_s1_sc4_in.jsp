...
<%
	...
	Vector inss = ai_db.getInsStatList_in4(br_id, brch_id, st_dt, end_dt, gubun1, gubun2);
            ...
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
              ...
              <%	for (int i = 0 ; i < ins_size ; i++){
                ...
                <tr> 
                    ...
                    <td align="center" width='7%'><%=ins.get("EXP_AIM")%></td>
                    <td align="center" width='9%'><%=AddUtil.ChangeDate2(String.valueOf(ins.get("EXP_DT")))%></td>			
                    <td align="center" width='9%'><%=AddUtil.ChangeDate2(String.valueOf(ins.get("REQ_DT")))%></td>
                    <td align="center" width='9%'><%=AddUtil.ChangeDate2(String.valueOf(ins.get("RTN_DT")))%></td>
                    <td align="right" width='11%'><%=Util.parseDecimal(String.valueOf(ins.get("RTN_AMT")))%>원&nbsp;</td>
                </tr>
              <%		total_amt = total_amt + Long.parseLong(String.valueOf(ins.get("RTN_AMT")));
    			  }%>
                <tr> 
                    <td class='title'>&nbsp;</td>
                    <td class='title'>&nbsp;</td>
