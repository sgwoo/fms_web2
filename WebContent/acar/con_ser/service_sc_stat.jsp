...
<!--
	...
	//현황
	function  view_stat(){
		var taxInvoice = window.open("about:blank", "Stat", "resizable=no,  scrollbars=yes, status=yes, left=50,top=20, width=850px, height=220px");
...
<%
	...
	int height = AddUtil.parseInt(s_height)-emp_top_height-sh_height-(cnt*sc_line_height)-55;//현황 라인수만큼 제한 아이프레임 사이즈
%>
...
<table border="0" cellspacing="0" cellpadding="0" width=800>
        ...
        <td colspan=2>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 영업비용관리 > 정비비 관리 > <span class=style5>정비비 현황</span></span></td>
    ...
    <tr>      		
        ...
        <%	//정비비 현황
        	Vector fines = ac_db.getServiceStat(br_id, "", "", "");
