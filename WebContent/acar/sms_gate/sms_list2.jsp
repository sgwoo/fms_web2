...
<table width="600" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="300">&lt; 발송명단 리스트 &gt;</td>
    <td width="280" align="right"><a href="javascript:parent.open_result();">발송내역보기</a></td>
    <td width="20" align="right">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3"><iframe src="./sms_list2_t.jsp" name="smsList_t" width="100%" height="22" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
  </tr>    
  <tr>
