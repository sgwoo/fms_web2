...
function cng_sh(){
	location.href = "./sms_result_sh.jsp";
	parent.c_foot.location.href = "./sms_result_sc.jsp";
}
...
<body>
<form name='form1' method='post' action='./sms_result_sc2.jsp'>
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > <span class=style5>SMS문자전송결과(Biz3)</span></span></td>
