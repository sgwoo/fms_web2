...
<frameset rows="<%=height%>,*,0" border=0 cols="*"> 
  <frame name="c_body" src="v5_sms_mng_sh.jsp<%=valus%>" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame name="c_foot" src="v5_sms_mng_sc.jsp<%=valus%>" marginwidth=10 marginheight=5 scrolling="auto" noresize>
