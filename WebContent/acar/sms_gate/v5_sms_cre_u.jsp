        ...
        <td class="line">
            <table width="700" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr>
                    ...
                    <td  colspan='3'>&nbsp;<input type="text" name="firm_nm" size="30" class="text" value="<%= ht.get("FIRM_NM") %>" onKeyDown="javasript:enter()">
                ...
                <tr>
                    ...
                    <td width=38%>&nbsp;<input type="text" name="destphone" size="15" class="text" value="<%= ht.get("DEST_PHONE") %>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="3">&nbsp;<textarea name="msg" rows="5" cols="95" class="text">기업신용도 판단목적으로 귀하의 신용정보를 조회하였습니다. NICE신용평가정보(주)에서 조회하였고, 조회기록은 남지 않으며, 신용등급에 영향을 미치지 않습니다. (주)아마존카</textarea></td>
                </tr>
            </table>
        </td>
    </tr>
