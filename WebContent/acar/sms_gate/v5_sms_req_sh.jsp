...
<body>
<form name='form1' method='post' action='./v5_sms_req_sc.jsp'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > <span class=style5>SMS예약현황(Biz5)</span></span></td>
    ...
    <tr>
      ...
      <td width="16%"><img src="/acar/images/center/arrow_dsgb.gif"  border="0" align=absmiddle>&nbsp;
        <select name='dest_gubun'>
          <option value='0'  <%if(dest_gubun.equals("0")){%>selected<%}%>>대기</option>
          <option value='1'  <%if(dest_gubun.equals("1")){%>selected<%}%>>전송중</option>		  		  
        </select></td>
    ...
    <tr>
      ...
      <td><img src="/acar/images/center/arrow_jr.gif"  border="0" align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <select name='sort'>
          ...
          <option value='4' <%if(sort.equals("4")){%>selected<%}%>>예약일시</option>
        </select></td>
