...
<body>
<form name='form1' method='post' action='v5_sms_mng_sc.jsp'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > <span class=style5>SMS관리(Biz5)</span></span></td>
    ...
    <tr>
      <td width="30%" align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/acar/images/center/arrow_dsgb.gif"  border="0" align=absmiddle>&nbsp;
        <select name='dest_gubun'>
		  ...
		  <option value='4' <%if(dest_gubun.equals("4")){%>selected<%}%>>직접</option>
		  <option value='5' <%if(dest_gubun.equals("5")){%>selected<%}%>>채권</option>		  		  
      </select></td>
    ...
    <tr>
      <td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif  align=absmiddle>&nbsp;   
        <select name="s_kd">
          ...
          <option value="1" <%if(s_kd.equals("1")){%> selected <%}%>>발신자</option>
          <option value="2" <%if(s_kd.equals("2")){%> selected <%}%>>수신자</option>
          <option value="3" <%if(s_kd.equals("3")){%> selected <%}%>>발신번호</option>		  
      ...
      <td><img src="/acar/images/center/arrow_jr.gif"  border="0" align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <select name='sort'>
          ...
          <option value='2' <%if(sort.equals("2")){%>selected<%}%>>수신자</option>
