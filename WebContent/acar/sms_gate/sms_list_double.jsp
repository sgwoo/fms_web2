...
<%
	...
	if(gubun1.equals("1") && gubun2.equals("1")){
		empList = umd.checkEmpDouble(cc_id, sido, gugun, send_gubun, commi_yn, user_id);
	}else if(gubun1.equals("1") && gubun2.equals("2")){
		empList = umd.checkEmpDouble_20090702(gubun, gu_nm, sort_gubun, sort, commi_yn, cng_rsn, st_dt, end_dt);
	}
...
function del_list(id){
	if(!confirm("해당 영업사원 데이터를 수신거부 하시겠습니까?"))		return;
	fm = document.form2;
	fm.gubun.value = "dl";
	fm.emp_id.value = id;
	fm.target = "i_no";
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
        ...
        해당 영업사원을 수신거부 합니다. 데이터베이스에는 남아있게 됩니다.</font></td>
  </tr>    
  <tr>
...
%>
		<tr>
			...
			<a href="javascript:del_source('<%= ht.get("EMP_ID") %>');"  title="원본 삭제"><img src="/acar/images/center/button_in_delete.gif"  border="0" align="absbottom"></a> | 
			<a href="javascript:del_list('<%= ht.get("EMP_ID") %>');"  title="검색리스트에서 제거"><img src="/acar/images/center/button_in_remove.gif"  border="0" align="absbottom"></a> </td>
		</tr>		
<% 		}
	}else{ %>
      <tr>
        <td colspan="8"><div align="center">중복 발송 대상자가 없습니다. </div></td>
        </tr>
<% 	} %>
      <tr>
