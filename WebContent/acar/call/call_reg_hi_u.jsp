...
<body leftmargin="15">
<form action='call_reg_hi_u_a.jsp' name="form1" method='post'>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>콜센터 > <span class=style5>콜관리</span></span></td>
                    <td class=bar align=right>
                    <%if(auth_rw.equals("3") || auth_rw.equals("4") || auth_rw.equals("6")){%>
                     <% if ( reg_id.equals(user_id)  ||  nm_db.getWorkAuthUser("전산팀",user_id)   ) {%>
                      <a href='javascript:update()' onMouseOver="window.status=''; return true" onfocus="this.blur()"><img src="../images/center/button_modify.gif" border=0></a>
                      <% }%>
                      <%}%>
        			
                      <a href='javascript:list("<%=b_lst%>")' onMouseOver="window.status=''; return true" onfocus="this.blur()"><img src=../images/center/button_list.gif border= align=absmiddle></a> 
                    </td>
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr> 
                    ...
                    <td width="160" class=b>&nbsp; 
                      <input type="text" name="t_rent_dt" value="<%=base.getRent_dt()%>" size="12" maxlength='10' class=whitetext onBlur='javascript: this.value = ChangeDate(this.value)'>
                    </td>
                ...
                <tr> 
                    ...
                    <td colspan="5" class=b>&nbsp;
                      <input type="text" name="t_rent_start_dt" value="<%=base.getRent_start_dt()%>" size="12" maxlength='10' class=whitetext onBlur='javascript:this.value=ChangeDate(this.value); set_cont_date(this);' readonly >
                    ~
                    <input type="text" name="t_rent_end_dt" value="<%=base.getRent_end_dt()%>" size="12" maxlength='10' class=whitetext onBlur='javascript:this.value=ChangeDate(this.value)' readonly ></td>
