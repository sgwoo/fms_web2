...
<%
	...
	// excel bean처리	
       ...
       ex_bean.setCell02(serv_id);
	    ...
	    ex_bean.setCell06(value4[i] ==null?"":AddUtil.replace(value4[i],"?","")); //item;
	    ex_bean.setCell07(value2[i] ==null?"":value2[i]);
	    ex_bean.setCell08(value3[i] ==null?"0": AddUtil.replace(value3[i],"?",""));// 수량
	    ex_bean.setCell09(value9[i] ==null?"0": AddUtil.replace(value9[i],"?",""));//E부품액
		 ex_bean.setCell10(value10[i] ==null?"0": AddUtil.replace(value10[i],"?",""));//F공임액	  
	    ex_bean.setCell11(value5[i] ==null?"-":AddUtil.replace(value5[i],"?","")); //wk_st
