...
<%
	...
	System.out.println("사고수리 excel 등록 2020_new2: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	function save(){
		...
		fm.action = 'excel_item_2020_new2_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="100" class="title">(M)수량</td>		
          ...
          <td width="100" class="title">(U)부품</td>		
          <td width="100" class="title">(V)</td>		             
          <td width="100" class="title">(W)</td>
          <td width="100" class="title">(X)공임</td>
