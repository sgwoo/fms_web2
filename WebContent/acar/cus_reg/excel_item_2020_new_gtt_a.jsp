...
<%
	...
	String value18[] = request.getParameterValues("value18");//S 부품액
	String value19[] = request.getParameterValues("value19");//T
	String value20[] = request.getParameterValues("value20");//U 공임액
	...
	String value25[] = request.getParameterValues("value25");//z  //부품
	...
	// excel bean처리	
       ...
       ex_bean.setCell02(serv_id);
	    ...
	    ex_bean.setCell09(value25[i] ==null?"0": AddUtil.replace(value25[i],"?",""));//E부품액
