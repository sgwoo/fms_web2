...
<%
	...
	String value0[]  = request.getParameterValues("value0");//A코드
	String value1[]  = request.getParameterValues("value1");//B작업내용
	String value2[]  = request.getParameterValues("value2");//C작업
	String value3[]  = request.getParameterValues("value3");//D수량
	String value4[]  = request.getParameterValues("value4");//E부품액
	String value5[]  = request.getParameterValues("value5");//F공임액
	String value6[]  = request.getParameterValues("value6");//G작업명
	String value7[]  = request.getParameterValues("value7");//H구분
	...
	// excel bean처리	
	   ...
	   // ex_bean.setCell05(value0[i] ==null?"":AddUtil.replace(value0[i],"?","")); //item_cd
	    ex_bean.setCell05("-"); //item_cd
	    ex_bean.setCell06(value1[i] ==null?"":AddUtil.replace(value1[i],"?","")) //item;
	    ex_bean.setCell07(value2[i] ==null?"":value2[i]);
	    ex_bean.setCell08(value3[i] ==null?"0": AddUtil.replace(value3[i],"?",""));// 수량
	    ex_bean.setCell09(value4[i] ==null?"0": AddUtil.replace(value4[i],"?",""));//E부품액
		 ex_bean.setCell10(value5[i] ==null?"0": AddUtil.replace(value5[i],"?",""));//F공임액	  
	    ex_bean.setCell11(value6[i] ==null?"":AddUtil.replace(value6[i],"?","")); //wk_st
