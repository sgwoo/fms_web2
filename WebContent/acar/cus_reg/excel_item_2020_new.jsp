...
<%
	...
	System.out.println("사고수리 excel 등록 2020_new: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	function save(){
		...
		fm.action = 'excel_item_2020_new_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
...
<table border="0" cellspacing="0" cellpadding="0" width="<%=70+(100*(sheet.getColumns()-1))+100%>">
  <tr>
    <td>&lt; 엑셀 파일 읽기 &gt; </td>
  </tr>
  <tr>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="100" class="title">(A)NO</td>		  
          <td width="100" class="title">(B)</td>		  
          <td width="100" class="title">(C)작업항목명부품번호</td>		  		  		  
          <td width="200" class="title">(D) </td>
          <td width="100" class="title">(E)</td>		  		  
          <td width="100" class="title">(F) </td>		
          <td width="100" class="title">(G) </td>		
          <td width="100" class="title">(H) </td>		
          <td width="100" class="title">(I) </td>		
          <td width="100" class="title">(J) </td>		             
          <td width="100" class="title">(K)작업 </td>		
          <td width="100" class="title">(L)</td>
          <td width="100" class="title">(M)</td>		
          <td width="100" class="title">(N)</td>		
          <td width="100" class="title">(O)</td>		
          <td width="100" class="title">(P)</td>		
          <td width="100" class="title">(Q)</td>		
          <td width="100" class="title">(R)</td>		
          <td width="100" class="title">(S)</td>		
          <td width="100" class="title">(T)</td>		
          <td width="100" class="title">(U)</td>		
          <td width="100" class="title">(V)</td>		             
          <td width="100" class="title">(W)</td>
          <td width="100" class="title">(X)</td>
          <td width="100" class="title">(Y)</td>
          <td width="100" class="title">(Z)부품가격</td>
          <td width="100" class="title">(AA)</td>
          <td width="100" class="title">(AB)</td>
          <td width="100" class="title">(AC)</td>
          <td width="100" class="title">(AD)공임</td>                
          <td width="100" class="title">(AE)</td> 
          <td width="100" class="title">(AF)</td>
          <td width="100" class="title">(AG)</td>
          <td width="100" class="title">(AH)</td>
          <td width="100" class="title">(AI)</td>             
...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
        ...
        <tr>
		  ...
		  <% for(int j = 0; j < sheet.getColumns(); j++){%>
		  <%	if(j==1){%>
    	  <td width="100" align="center"><input name="value<%=j%>" type="text" class=text style1   value="<%=content.get(Integer.toString(j))%>"size="30"></td>
		  <%	}else{%>
