...
<%
	...
	String value12[] = request.getParameterValues("value12");//M 작업
	String value13[] = request.getParameterValues("value13");//N
	String value14[] = request.getParameterValues("value14");//O
	String value15[] = request.getParameterValues("value15");//P 수량
	...
	String value20[] = request.getParameterValues("value20");//U 
	String value21[] = request.getParameterValues("value21");//v
	String value22[] = request.getParameterValues("value22");//w
	String value23[] = request.getParameterValues("value23");//x
	String value24[] = request.getParameterValues("value24");//y
	String value25[] = request.getParameterValues("value25");//z  
	String value26[] = request.getParameterValues("value26");//aa  //부품
	String value27[] = request.getParameterValues("value27");//ab
	String value28[] = request.getParameterValues("value28");//ac
	String value29[] = request.getParameterValues("value29");//ad //공임 
	...
	// excel bean처리	
       ...
       ex_bean.setCell02(serv_id);
	    ...
	    ex_bean.setCell08(value15[i] ==null?"0": AddUtil.replace(value15[i],"?",""));// 수량
	    ex_bean.setCell09(value26[i] ==null?"0": AddUtil.replace(value26[i],"?",""));//E부품액
		ex_bean.setCell10(value29[i] ==null?"0": AddUtil.replace(value29[i],"?",""));//F공임액	  
	    ex_bean.setCell11(value12[i] ==null?"-":AddUtil.replace(value12[i],"?","")); //wk_st 작업
