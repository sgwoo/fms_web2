...
<%
	...
	for(int i=start_row ; i < value_line ; i++){
		...
		siBn.setItem_id		("");
		siBn.setItem		(value1[i] ==null?"":AddUtil.replace(value1[i],"?",""));//B작업내용
		siBn.setWk_st		(value6[i] ==null?"":AddUtil.replace(value6[i],"?",""));//G작업명
		...
		siBn.setAmt			(value4[i] ==null?0: AddUtil.parseDigit(AddUtil.replace(value4[i],"?","")));//E부품액
		siBn.setLabor		(value5[i] ==null?0: AddUtil.parseDigit(AddUtil.replace(value5[i],"?","")));//F공임액
