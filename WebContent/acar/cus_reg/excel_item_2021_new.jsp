...
<%
	...
	System.out.println("사고수리 excel 등록 2021_new: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	function save(){
		...
		fm.action = 'excel_item_2021_new_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="200" class="title">(D)작업항목명부품번호 </td>
          ...
          <td width="100" class="title">(K) </td>		
          <td width="100" class="title">(L)</td>
          <td width="100" class="title">(M)작업</td>		
          <td width="100" class="title">(N)</td>		
          <td width="100" class="title">(O)</td>		
          <td width="100" class="title">(P)수량</td>		
          ...
          <td width="100" class="title">(Z)</td>
          <td width="100" class="title">(AA)부품가격</td>
