...
<%
	...
	System.out.println("사고수리 excel 등록 2016_new: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	function save(){
		...
		fm.action = 'excel_item_2016_new_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
        ...
        <tr>
		  ...
		  <%	}else{%>
    	  <td width="200" align="center"><input name="value<%=j%>" type="text" class=text style1   value="<%=content.get(Integer.toString(j))%>"size="13"></td>
		  <%	}%>		  
		  <% }%>
  		</tr>
<%		value_line++;
