...
<%
	...
	System.out.println("사고수리 excel 등록 2019_new2: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	function save(){
		...
		fm.action = 'excel_item_2019_new2_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="100" class="title">(J) 작업</td>		             
          <td width="100" class="title">(K) </td>		
          <td width="100" class="title">(L)수량</td>
          ...
          <td width="100" class="title">(W)부품</td>
          <td width="100" class="title">(X)</td>
          <td width="100" class="title">(Y)</td>
          <td width="100" class="title">(Z)공임</td>
