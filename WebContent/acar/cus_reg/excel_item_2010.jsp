...
<%
	...
	System.out.println("사고수리 excel 등록 2010: excel_file="+filename+" / car_mng_id=" + car_mng_id  + " / serv_id=" + serv_id + " / user_id=" + user_id);
...
<!--
	...
	//	fm.action = 'excel_item_2010_a.jsp';
		fm.action = 'excel_item_2010_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
        ...
        <tr>
    	  ...
    	  <td width="40" align="center"><input name="ch_start" type="checkbox" class="style1" value="<%=i%>" <%if(i == 0){//start_row > 0 && i+1==start_row%>checked<%}%>></td>	
		  <% for(int j = 0; j < sheet.getColumns(); j++){%>
		  <%	if(j==2){%>
