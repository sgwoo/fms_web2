...
<table border="0" cellspacing="0" cellpadding="0" width="<%=70+(120*(sheet.getColumns()-6))+(50*6)%>">
  <tr>
    <td>&lt; 엑셀 파일 읽기 &gt; </td>
  </tr>
  <tr>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="50" class="title">&nbsp;</td>
          <td width="50" class="title">&nbsp;</td>		  		  
          <td width="120" class="title">작업항목및교환부품</td>
          <td width="120" class="title">작업</td>
          <td width="50" class="title">&nbsp;</td>		  
          <td width="120" class="title">H,Q,%</td>
          <td width="120" class="title">부품코드</td>
          <td width="120" class="title">부품가격</td>
          <td width="120" class="title">공임</td>
...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
        ...
        <tr>
    	  ...
    	  <td width="40" align="center"><input name="ch_start" type="checkbox" class="style1" value="<%=i%>" <%if(start_row > 0 && i+1==start_row){%>checked<%}%>></td>	
		  <% for(int j = 0; j < sheet.getColumns(); j++){%>
		  <%	if(j==0 || j==1 || j==2 || j==3 || j==6 || j==11){%>
    	  <td width="50" align="center"><input name="value<%=j%>" type="text" class=text style1   value="<%=content.get(Integer.toString(j))%>"size="5"></td>
		  <%	}else{%>
