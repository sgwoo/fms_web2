...
<%
	...
	String value19[] = request.getParameterValues("value19");//T 부품액
	String value20[] = request.getParameterValues("value20");//U 
	String value21[] = request.getParameterValues("value21");//v 공임액
	...
	// excel bean처리	
       ...
       ex_bean.setCell02(serv_id);
	    ...
	    ex_bean.setCell09(value19[i] ==null?"0": AddUtil.replace(value19[i],"?",""));//E부품액
		ex_bean.setCell10(value21[i] ==null?"0": AddUtil.replace(value21[i],"?",""));//F공임액	  
