...
<%
	...
	String value9[]  = request.getParameterValues("value9"); //J  작업
	String value10[] = request.getParameterValues("value10");//K 
	String value11[] = request.getParameterValues("value11");//L 수량
	...
	String value22[] = request.getParameterValues("value22");//w 부품액
	String value23[] = request.getParameterValues("value23");//x
	String value24[] = request.getParameterValues("value24");//y 
	String value25[] = request.getParameterValues("value25");//z  공임액
	...
	// excel bean처리	
       ...
       ex_bean.setCell02(serv_id);
	    ...
	    ex_bean.setCell08(value11[i] ==null?"0": AddUtil.replace(value11[i],"?",""));// 수량
	    ex_bean.setCell09(value22[i] ==null?"0": AddUtil.replace(value22[i],"?",""));//E부품액
		ex_bean.setCell10(value25[i] ==null?"0": AddUtil.replace(value25[i],"?",""));//F공임액	  
