...
function view_car(car_mng_id,client_id){
	...
	fm.action = 'cus_reg_service.jsp?car_mng_id='+car_mng_id+'&client_id='+client_id;
	fm.target = 'c_body';
	fm.submit();
	this.close();
}
        ...
        <td class=line>            
            <table border=0 cellspacing=1 width=100%>
                <tr>
                  ...
                  <td class=title width="270">차량명</td>
                </tr>
                ...
                <% 	if(cars.size() == 0) { %>
                <tr> 
                  <td colspan=3 align=center height=25>등록된 데이타가 없습니다.</td>
                </tr>
                <%	}%>
            </table>
        </td>
