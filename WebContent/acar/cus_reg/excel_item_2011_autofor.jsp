...
<%
	...
	System.out.println("사고수리 excel 등록 2011_autofor: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	//	fm.action = 'excel_item_2011_autofor_a.jsp';
		fm.action = 'excel_item_2011_autofor_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="100" class="title">(A) </td>		  
          <td width="100" class="title">(B)</td>		  
          <td width="100" class="title">(C)NO</td>		  		  		  
          <td width="200" class="title">(D) </td>
          <td width="100" class="title">(E)작업항목명부품번호</td>		  		  
          <td width="100" class="title">(F) </td>		  
          <td width="100" class="title">(G)작업</td>
          <td width="100" class="title">(H)H,Q,%</td>		  
          <td width="100" class="title">(I)부품코드</td>
          <td width="100" class="title">(J)부품가격</td>
          <td width="100" class="title">(K)공임</td>
          <td width="100" class="title">(L)비고</td>
        </tr>
      </table></td>
  </tr>  
  <tr>
