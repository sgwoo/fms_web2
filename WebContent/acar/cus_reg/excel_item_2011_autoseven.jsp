...
<%
	...
	System.out.println("사고수리 excel 등록 2011_autoseven: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
//		fm.action = 'excel_item_2011_autoseven_a.jsp';
		fm.action = 'excel_item_2011_autoseven_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="100" class="title">(C)작업항목명및부품명</td>		  		  		  
          <td width="100" class="title">(D) </td>
          <td width="100" class="title">(E)작업</td>		  		  
          <td width="100" class="title">(F)H,Q,%</td>		  
          <td width="100" class="title">(G)부품코드</td>
          <td width="100" class="title">(H)부품가격</td>		  
          <td width="100" class="title">(I)공임</td>
          <td width="100" class="title">(J)비고</td>
...
<%		value_line++;
  ...
  <tr>  
    <td align="center"><a href='javascript:save()' onMouseOver="window.status=''; return true"><img src=../images/center/button_reg.gif border=0 align=absmiddle></a>&nbsp;<a href='javascript:window.close()' onMouseOver="window.status=''; return true"><img src=../images/center/button_close.gif border=0 align=absmiddle></a></td>
    </tr>
</table>
