...
<%
	...
	System.out.println("사고수리 excel 등록 2019_new: car_mng_id=" + car_mng_id  + ":serv_id=" + serv_id + ":user_id=" + user_id);
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	function save(){
		...
		fm.action = 'excel_item_2019_new_gtt_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="100" class="title">(T)부품가격</td>		
          <td width="100" class="title">(U)</td>		
          <td width="100" class="title">(V)공임</td>		             
