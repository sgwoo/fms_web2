...
<%
	...
	String value15[] = request.getParameterValues("value15");//P 부품코드
	...
	// excel bean처리	
       ...
       ex_bean.setCell02(serv_id);
	    ...
	    ex_bean.setCell09(value18[i] ==null?"0": AddUtil.replace(value18[i],"?",""));//E부품액
		 ex_bean.setCell10(value20[i] ==null?"0": AddUtil.replace(value20[i],"?",""));//F공임액	  
