...
<%
	...
	String gubun = request.getParameter("gubun")==null?"rent_dt":request.getParameter("gubun");
	String gubun_nm = request.getParameter("gubun_nm")==null?AddUtil.getDate(4):request.getParameter("gubun_nm");
	...
	function preSearch()
{
	...
	function loan_confirm(){
		...
		fm.target = "c_foot";
		fm.action = "accid_reg_step1_sc.jsp" ;		
		fm.submit();
		window.close();
	}			
//-->
...
<table border="0" cellspacing="0" cellpadding="0" width=960>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
					 ...
					 <!--         <option value='car_nm' <%if(gubun.equals("car_nm")){%>selected<%}%>>차명</option> -->
					          ...
					          <option value='rent_dt' <%if(gubun.equals("rent_dt")){%>selected<%}%>>계약일</option>
					        </select> </td>
    ...
    <tr> 
        <td><iframe src="./find_cont_search_in.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&gubun_nm=<%=gubun_nm%>" name="i_no" width="960" height="530" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe></td>
    </tr>
    <tr>
