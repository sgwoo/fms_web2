...
<FRAMESET rows="450, *" border=0>
	<FRAME SRC="./accid_reg_step1_sh.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>" name="c_body" frameborder=0  marginwidth="10" marginheight="10" scrolling="no" noresize>
