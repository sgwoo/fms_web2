...
<form action="./stat_bus_help_null.jsp" name="form1" method="POST">
...
<table border=0 cellspacing=0 cellpadding=0 width="550">
    	...
    	<td colspan=3>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > 사원별 영업누계현황 > <span class=style5>가중치 부여방법</span></span></td>
                    ...
                    <td align=center>
                      ...
                      <td align="center"> 
            			<%	if(auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")){%>			
                          <a href="javascript:update('<%=i%>');"><img src=../images/center/button_in_modify.gif align=absmiddle border=0></a>
            			<%	}%>			  
                      </td>
                </tr>
        <%}%>
    ...
    <tr>    	
        <td align="right"><a href="javascript:self.close();windows.close();"><img src=../images/center/button_close.gif align=absmiddle border=0></a></td>
    </tr>	
</table>
</form>
