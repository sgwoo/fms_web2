...
function imgBig(){
	...
	window.open("/acar/off_lease/off_lease_imgBig.jsp?car_mng_id=<%=car_mng_id%>&imgName="+imgName,"imgBig", "left=200, top=100, width=450, height=300, resizable=no, scorllbars=no");
}
-->
</script>
</head>
      ...
      <td class='line' colspan="2"> 
        <table border="0" cellspacing="1" cellpadding="0">
          ...
          <tr> 
            ...
            <td align="center" width='150'><%=AddUtil.parseDecimal(apprsl.getKm())%> 
              km</td>
