...
<%
	...
	//부채현황
	Vector deb1s = ad_db.getStatDebtList("stat_incom_pay");
...
<!--
	function view_stat(save_dt){
		...
		<%if(from_page.equals("/acar/account/incoming_magam.jsp") || from_page.equals("/acar/account/paying_magam.jsp")){%>
		fm.target='_parent';
		<%}else{%>
		fm.target='_blank';
		<%}%>
...
<form name='form1' action='incoming_2011.jsp' target='i_view'>
