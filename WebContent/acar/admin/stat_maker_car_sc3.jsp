		...
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td width="15%" align=right><a href="stat_maker_car_sc.jsp?maker=<%=maker%>&gubun2=<%=gubun2%>&gubun3=<%=gubun3%>&gubun4=<%=gubun4%>&st_dt=<%=st_dt%>&end_dt=<%=end_dt%>&sh_height=<%=sh_height%>"><img src=/acar/images/center/button_see_cjgbb.gif align=absmiddle border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr> 
                    <td colspan="2">
                ...
                <tr> 
                    <td colspan="2"><iframe src="stat_maker_car_sc_in3.jsp?auth_rw=<%=auth_rw%>&maker=<%=maker%>&gubun2=<%=gubun2%>&gubun3=<%=gubun3%>&gubun4=<%=gubun4%>&st_dt=<%=st_dt%>&end_dt=<%=end_dt%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
                    </iframe></td>
                </tr>
                <tr> 
                    <td colspan="2">
