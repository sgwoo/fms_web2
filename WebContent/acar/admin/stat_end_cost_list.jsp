...
<!--
	function view_stat(save_dt){
		...
		if(fm.loan_st[0].checked == true){ 				
			fm.action='/fms2/mis/man_cost1_settle.jsp';		
		            
		}else{											
			fm.action='/fms2/mis/man_cost3_settle.jsp';			 
		}				
		/*
		if(fm.loan_st[0].checked == true){ 				
			fm.action='https://fms3.amazoncar.co.kr/fms2/mis/man_cost_settle_20110105.jsp';		
		            
		}else{											
			fm.action='https://fms3.amazoncar.co.kr/fms2/mis/man_cost3_settle_20110105.jsp';			 
		}		
		*/
		fm.submit();		
	}
...
<%
	...
	Vector deb1s = ad_db.getStatDebtList("stat_bus_cost_2_cmp",gubun);
...
<table border="0" cellspacing="0" cellpadding="0" width="<%=(deb1_size*80)+180%>">
    <tr>
        <td class=line2></td>
    </tr>
    <tr>
