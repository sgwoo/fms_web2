    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > 사원별관리영업점수 > <span class=style5>사원별업체관리현황 가중치 부여방법</span></span></td>
        ...
        <td class=line>                    
            <table border="0" cellspacing="1" cellpadding="0" width="550">
                <tr> 
                    ...
                    <td width="110" class=title>관리구분</td>
                    <td width="120" class=title>관리방식</td>
