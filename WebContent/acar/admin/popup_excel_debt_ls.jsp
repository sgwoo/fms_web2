...
response.setHeader("Content-Disposition", "inline; filename=popup_excel_debt_ls.xls");
%>
...
<%
	...
	//은행 부채현황
	Vector deb1s = ad_db.getStatDebtLs(br_id, save_dt, "1", "");
	...
	//그외 기타 부채현황
	Vector deb3s = ad_db.getStatDebtLs(br_id, save_dt, "3", "");
