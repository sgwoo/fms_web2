...
<!--
	...
	//cms 보기 
	function cms_mng(rent_mng_id, rent_l_cd, client_id, rent_s_cd)
	{
		...
		fm.c_id.value = rent_mng_id;
		fm.s_cd.value = rent_s_cd;
		fm.target = "d_content";
		fm.action = "cms_mng.jsp";
		fm.submit();
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/acar/con_rent/cms_s_frame.jsp'>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="cms_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
