...
//			if(fm.t_wd.value == '' && fm.gubun1[0].checked == true && fm.gubun4.value != '9'){ alert('검색어를 입력하십시오.'); return;}
...
<form name='form1' action='/acar/con_rent/cms_sc.jsp' target='c_foot' method='post'>
