...
<!--
	...
	function cng_input1(){
		var fm = document.form1;
		if(fm.gubun3.options[fm.gubun3.selectedIndex].value == '3'){ //기간
			td_dt.style.display	 = '';
		}else{
...
%>
<form name='form1' action='res_scd_sc.jsp' target='c_body' method='post'>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>예약시스템 > 재무회계 > <span class=style5>스케줄관리</span></span></td>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width=100%>
                <tr> 
                    <td width='18%'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jhgb.gif align=absmiddle>&nbsp; 
                      <select name="gubun1">
                        <option value="1" <%if(gubun1.equals("1")){%>selected<%}%>>스케줄관리</option>
                      </select>
                    </td>
                    <td width='17%'><img src=/acar/images/center/arrow_ssjh.gif align=absmiddle>&nbsp; 
                      <select name="gubun2">
        			    <option value=""  <%if(gubun2.equals("")){ %>selected<%}%>>전체</option>
                        <option value="1" <%if(gubun2.equals("1")){%>selected<%}%>>등록</option>
                        <option value="2" <%if(gubun2.equals("2")){%>selected<%}%>>미등록</option>
                      </select>
                    </td>
                    <td width='13%'><img src=/acar/images/center/arrow_ggjh.gif align=absmiddle>&nbsp; 
                      <select name="gubun3">
        <!--                <option value="1" <%if(gubun3.equals("1")){%>selected<%}%>>당월</option>
                        <option value="2" <%if(gubun3.equals("2")){%>selected<%}%>>당일</option>
                        <option value="3" <%if(gubun3.equals("3")){%>selected<%}%>>기간</option> onChange="javascript:cng_input1()"-->
                        <option value="4" <%if(gubun3.equals("4")){%>selected<%}%>>검색</option>
                      </select>
                    </td>
                    <td align="left" width=15%> 
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td id='td_dt' <%if(gubun3.equals("3")){%>style="display:''"<%}else{%>style='display:none'<%}%>> 
                ...
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_yus.gif align=absmiddle>&nbsp;&nbsp;&nbsp; 
        	          ...
        	          <option value='S1' <%if(s_brch.equals("S1")){%>selected<%}%>>본사+강남</option>                	  
                ...
                <tr> 
                    <td colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp; 
                      ...
                      &nbsp;<input type='text' name='t_wd' size='30' class='text' value='<%=t_wd%>' onKeyDown='javascript:enter()'>
                    </td>
                    <td><img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>&nbsp;
                      <select name='sort_gubun' onChange='javascript:search()'>
                        ...
                        <option value='1' <%if(sort_gubun.equals("1")){%> selected <%}%>>반차일자</option>
                        <option value='3' <%if(sort_gubun.equals("3")){%> selected <%}%>>정산일자</option>
                      </select>
                    </td>
                    <td> 
