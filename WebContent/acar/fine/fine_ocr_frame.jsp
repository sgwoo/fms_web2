...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./fine_ocr_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  ...
  <%}else{%>
  <frame src="./fine_ocr_sc.jsp<%=valus2%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <%}%>
</frameset>
</HTML>