    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>차량관리 > 과태료관리 > <span class=style5>과태료OCR중복관리</span></span></td>
        ...
        <td colspan="2" class=line>
	        <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td class=title width=10%>삭제여부</td>
                    <td width=23%>&nbsp;
            		    <select name='del_yn'>
                          <option value='N' <%if(del_yn.equals("N")){%>selected<%}%>>미삭제 </option>
                          <option value='Y' <%if(del_yn.equals("Y")){%>selected<%}%>>삭제 </option>
                        </select>
                    </td>
<!--             			&nbsp;&nbsp;&nbsp; -->
<%--         			    <input type='text' name='t_wd' size='25' class='text' value='<%=t_wd%>' onKeyDown='javascript:enter()' style='IME-MODE: active'  <%if(nm_db.getWorkAuthUser("아마존카이외",user_id)){%>readonly<%}%>> --%>
