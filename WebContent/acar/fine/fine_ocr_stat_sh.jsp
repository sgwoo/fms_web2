...
<form name='form1' action='./fine_ocr_stat_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>차량관리 > 과태료관리 > <span class=style5>과태료OCR등록현황</span></span></td>
        ...
        <td colspan="2" class=line>
	        <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td class=title width=10%>발송완료여부</td>
                    <td width=23%>&nbsp;
            		    <select name='gubun2'>
                          <option value='N' <%if(gubun2.equals("Y")){%>selected<%}%>>발송미완료</option>
                          <option value='Y' <%if(gubun2.equals("N")){%>selected<%}%>>발송완료 </option>
                        </select>
                    </td>
<!--             			&nbsp;&nbsp;&nbsp; -->
...
<!--         		    </td> -->
    ...
    <tr align="right">
<!--     	<td><input class="button btn-submit" type="button" value="메일발송 " style="float:left; margin-top:1%"/></td> -->
        <td><a href="javascript:search();" onMouseOver="window.status=''; return true" onFocus="this.blur()"><img src="/acar/images/center/button_search.gif" align="absbottom" border="0"></a></td>
    </tr>
</table>
</form>
</body>
