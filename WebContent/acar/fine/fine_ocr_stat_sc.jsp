...
<script language='javascript'>
	function fine_reg(paid_no, car_no, gubun1, st_dt, end_dt, seq, file_name, save_folder){
		var fm = document.form1;
		fm.paid_no.value = paid_no;
		fm.car_no.value = car_no;
		fm.gubun1.value = gubun1;
		fm.seq.value = seq;
		fm.file_name.value = file_name;
		fm.save_folder.value = save_folder;
		fm.action = 'fine_ocr_reg_frame.jsp'
		fm.target = 'd_content';
		fm.submit();
	}
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/acr/fine/fine_ocr_frame.jsp'>
  <input type='hidden' name='cons_no' value=''>
  <input type='hidden' name='mode' value=''>    
  <input type='hidden' name='doc_bit' value='5'>      
  <input type='hidden' name='paid_no' value=''>      
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="./fine_ocr_stat_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
