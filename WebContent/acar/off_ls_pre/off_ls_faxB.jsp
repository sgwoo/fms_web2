...
String destphone	= "010-3370-4950";//제인학 과장
...
//Hashtable watch = c_db.getWatch_user_list("부산");
...
if(!destphone.equals("") && destphone.length() > 9){
	...
	firm_nm = "스마일TS";
	destphone	= "010-3370-4950";//제인학 과장
	...
	String cont = "안녕하십니까. 아마존카입니다. &lt;br&gt; &lt;br&gt; "+ 
	 		 ...
	 		 "★ 출품예정차량 : "+car_num_name_arr+", 이상 "+car_num_name_arr_count+"대  &lt;br&gt; &lt;br&gt; "+
	  		 ...
	  		 "(주)아마존카 (www.amazoncar.co.kr)  &lt;br&gt; &lt;br&gt; ";
		...
		<td colspan="2" class='line' width=100%>			
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
				...
				<tr>
				  ...
				  <td align="center"><input type='text' size='30' name='' value='051-851-0724' maxlength='100' class='text' style = "border : none;font:11pt 굴림"><br>
				  <input type='text' size='30' name='' value='월요일은 탁송을 자제해 주세요.' maxlength='100' class='text' style = "border : none; font:11pt 굴림; font-weight: bold;"></td>
				</tr>
				<tr>
				  <td class='title' width="15%">담당자명</td>
				  <td align="center"><!-- <input type='text' size='30' name='' value='010-2000-8018(스마일탁송)' maxlength='100' class='text' style = "border : none;font:11pt 굴림;"><br> -->
				  <input type='text' size='30' name='' value='도착 30분 전 꼭 연락요망!' maxlength='100' class='text' style = "border : none; font:11pt 굴림; font-weight: bold;"></td>
				</tr>
				<tr>
				...
				<tr>
				  <td colspan="4" rowspan="1"><img src="http://fms1.amazoncar.co.kr/acar/images/center/map_p_wellmade.jpg" align=absmiddle border=0 width=500 height=450></td>
				</tr><!-- /acar/images/center/byd.jpg 이마트 연제점 교체 2018.01.30 -->
			</table>
		</td>
	</tr>
	<tr>
