...
<%
	...
	String actn_wh = request.getParameter("actn_wh")==null?"":request.getParameter("actn_wh");
	...
	//구비서류 완료처리
	int result2 = olyD.upDocChk(car_mng_id, "Y", "");
%>
<html>
...
<%if(result >= 1){
	...
	<%}else if(gubun.equals("u")){%>
		alert("수정되었습니다.");
	<%}%>
	parent.location.href = "off_ls_pre_sc_in_b_apprsl.jsp?auth_rw=<%=auth_rw%>&car_mng_id=<%=car_mng_id%>";
<%}else{%>
