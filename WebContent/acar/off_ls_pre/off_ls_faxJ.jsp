...
String destphone	= "010-2604-1522";
...
//Hashtable watch = c_db.getWatch_user_list("광주");	
...
if(!destphone.equals("") && destphone.length() > 9){
	...
	String cont = "안녕하십니까. 아마존카입니다. &lt;br&gt; &lt;br&gt; "+ 
	 		 "다음은 "+auction_name+" 경매장에 출품예정(탁송요청) 자동차 목록입니다.\n\n"+ 
		...
		<td colspan="2" class='line' width=100%>			
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
				...
				<tr>
				  ...
				  <td align="center"><input type='text' size='30' name='' value='062-385-0133' maxlength='100' class='text' style = "border : none;font:11pt 굴림"></td>
				</tr>
				<tr>
				  <td class='title' width="15%">담당자명</td>
				  <td align="center"><input type='text' size='30' name='' value='<%=udt_mng_bean_j.getUser_nm()%> (도착 30분 전 꼭 연락요망!)' maxlength='100' class='text' style = "border : none;font:11pt 굴림"></td>
				</tr>
				<tr>
				...
				<tr>
				  <td colspan="4" rowspan="1"><img src=/acar/images/center/jyj_origin_com.jpg align=absmiddle border=0 width=500 height=450></td>
				</tr>
			</table>
		</td>
	</tr>
