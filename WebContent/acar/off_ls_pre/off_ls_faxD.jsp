...
String destphone	= "010-3381-3388";
...
//Hashtable watch = c_db.getWatch_user_list("대전");	
		...
		<td colspan="2" class='line' width=100%>			
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
				...
				<tr>
				  ...
				  <td align="center"><input type='text' size='30' name='' value='042-824-1770' maxlength='100' class='text' style = "border : none;font:11pt 굴림"></td>
				</tr>
				<tr>
				  <td class='title' width="15%">담당자명</td>  <!-- <%=udt_mng_bean_d.getUser_m_tel()%>(<%=udt_mng_bean_d.getUser_nm()%>) -->
				  <td align="center"><input type='text' size='30' name='' value='<%=udt_mng_bean_d.getUser_nm()%> (도착 30분 전 꼭 연락요망!)' maxlength='100' class='text' style = "border : none;font:11pt 굴림"></td>
				</tr>
				<tr>
				...
				<tr>
				  <td colspan="4" rowspan="1"><img src=/acar/images/center/dyd.jpg align=absmiddle border=0 width=500 height=450></td>
				</tr>
			</table>
		</td>
	</tr>
