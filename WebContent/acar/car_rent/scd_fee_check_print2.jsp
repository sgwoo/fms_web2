...
<%
	...
	int check_value_size = check_value.length;	
...
<%
for (int j = 0; j < check_value_size; j++) {
	String temp_val = check_value[j];
	...
	/* if (rent_st.equals("")) {
		...
		//fee_scd = af_db.getFeeScdEmailRentst2(rent_l_cd, rent_st, fee.getPrv_mon_yn());
...
// 		System.out.println(pageNum);
			...
			<div class="content_wrap">
				...
				<%if (stamp_yn.equals("Y")) {%>
					<div style="position: relative; text-align: center;">
				  		...
				  		<img src="/acar/images/stamp.png" style="position:absolute; z-index: 2; left:580px; bottom: -23px; width: 80px;">
				  	</div>
				<%}%>
			  	</div>
		...
		<%if (j < check_value_size-1) {%>
			<div class="dvid" style="border-top: 1px solid #CECECE; "></div>
		<%}%>
