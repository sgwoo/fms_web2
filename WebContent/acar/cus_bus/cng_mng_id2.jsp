...
<body>
<form name="form1">
 <input type='hidden' name="cng_item" 		value="mng_id2">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1><span class=style5>예비배정자 변경</span></span></td>
        ...
        <td align="right" >
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
    		    <tr>
    			    ...
    			    <td>
    			    <% if(gubun3.equals("1")) out.print("최초영업자");
     				 else if(gubun3.equals("2")) out.print("영업담당자");
    				 else if(gubun3.equals("3")) out.print("관리담당자"); %>
    				  &nbsp;&nbsp;<%=c_db.getNameById(gubun4, "USER")%> 
    ...
    <tr> 
        ...
        <% if(conts.size()>0){
                ...
                <tr> 
                    ...
                    <td width='6%' align='center'><%= c_db.getNameById(cont.getMng_id(),"USER") %></td>
        		    <td width='6%' align='center'><% if(cont.getMng_id2().equals("")){ %>
        		        미지정
        			<% }else{ %>
        				<%= c_db.getNameById(cont.getMng_id2(),"USER") %>
        			<% } %></td>		
                </tr>
                <% 		}
        		}else{ %>
