...
<body>
<form name="form1">
 <input type='hidden' name="cng_item" 		value="bus_id2">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1><span class=style5>영업담당자 변경</span></span></td>
        ...
        <% if(conts.size()>0){
                ...
                <tr> 
                    ...
                    <td width='2%' align='center'>
                     <input type="checkbox" name="ch_all" value="<%=cont.getRent_mng_id()%>^<%=cont.getRent_l_cd()%>^<%=cont.getRent_way()%>^" >
                    </td> 
