...
<%
	...
	Vector accids = as_db.getAccidStat4List(br_id, gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, brch_id, st_dt, end_dt, s_kd, t_wd, sort, asc, s_st);
      ...
      <td class='line' id='td_title' style='position:relative;'> 
        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr> 
            ...
            <td align="center" width="13%"><span title='<%=accid.get("FIRM_NM")%>'><a href="javascript:parent.AccidentDisp('<%=accid.get("FIRM_NM")%>')" onMouseOver="window.status=''; return true"><%=Util.subData(String.valueOf(accid.get("FIRM_NM")), 6)%></a></span></td>
