...
<%
	...
	Vector accids = as_db.getAccidStat3List(br_id, gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, brch_id, st_dt, end_dt, s_kd, t_wd, sort, asc, s_st);
            ...
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
              <% 		for (int i = 0 ; i < accid_size ; i++){
                ...
                <tr> 
                    ...
                    <td align="center" width="13%"><a href="javascript:parent.AccidentDisp('<%=accid.get("CAR_NO")%>')" onMouseOver="window.status=''; return true"><%=accid.get("CAR_NO")%></a></td>
