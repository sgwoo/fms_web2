...
%>
<form action="./accid_s_sc1.jsp" name="form1" method="POST" target="c_foot">
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr align="center"> 
        <td colspan="5"> 
        <a href="javascript:sub_in(1)"><img src="/acar/images/center/button_acc_jjs.gif" align="absmiddle" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:sub_in(2)"><img src="/acar/images/center/button_acc_ggb.gif" align="absmiddle" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:sub_in(3)"><img src="/acar/images/center/button_acc_hgb.gif" align="absmiddle" border="0"></a> 
        </td>
    </tr>
    <tr>
        <td class=h></td>
