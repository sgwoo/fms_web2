  ...
  <table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr>
        ...
        <td width=18%><img src=/acar/images/center/arrow_jr.gif align=absmiddle>&nbsp;  
            <select name="sort">
              <option value="1" <%if(sort.equals("1")){%> selected <%}%>>정비업체</option>
              <option value="2" <%if(sort.equals("2")){%> selected <%}%>>총정비건수</option>
              <option value="3" <%if(sort.equals("3")){%> selected <%}%>>총정비금액</option>
            </select>
            <select name="asc">
