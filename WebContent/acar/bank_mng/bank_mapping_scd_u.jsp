...
%>
<form name='form1' action='bank_mapping_scd_u_a.jsp' target='' method="POST">
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
        ...
        <td colspan="2">
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;재무관리 > 은행대출관리 > <span class=style1><span class=style5>할부금 상환 스케줄 수정</span></span></td>
       ...
       <td class='line' colspan="2"> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td width=10%>&nbsp;<%=Util.parseDecimal(debt.getStp_fee())%>원&nbsp;</td>
                </tr>
                <tr> 
                    ...
                    <td>&nbsp;
                      <input type='text' size='11' name='t_fst_pay_dt' value='<%=debt.getFst_pay_dt()%>' class='text' onBlur='javascript:set_est_dt()'>
                    </td>
    ...
    <tr> 
        <td colspan='3'> <iframe src="bank_mapping_scd_u_in.jsp?m_id=<%=m_id%>&l_cd=<%=l_cd%>&car_id=<%=car_id%>&auth_rw=<%=auth_rw%>&s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&s_rtn=<%=s_rtn%>&gubun=<%=gubun%>&lend_id=<%=lend_id%>&cont_bn=<%=cont_bn%>&lend_int=<%=lend_int%>&max_cltr_rat=<%=max_cltr_rat%>&rtn_st=<%=rtn_st%>&lend_amt_lim=<%=lend_amt_lim%>&rtn_size=<%=rtn_size%>" name="i_in" width="100%" height="400" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
        </iframe> </td>
    </tr>
    <tr> 
        <td class='line' colspan="2"> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td width='15%' align='right'>
                      ...
                      원&nbsp;</td>
                    <td width='15%' align='right'>
                      <input type='text' name='t_tot_alt_amt' size='10' value='' class='whitenum' readonly>
                      원&nbsp;</td>
                    <td colspan='3'></td>
                </tr>
            </table>
