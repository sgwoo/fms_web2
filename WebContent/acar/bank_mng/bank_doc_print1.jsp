...
<%
	...
	if (FineDocBn.getGov_id().equals("0040") || FineDocBn.getGov_id().equals("0038") || FineDocBn.getGov_id().equals("0004") || FineDocBn.getGov_id().equals("0039") || FineDocBn.getGov_id().equals("0001") || FineDocBn.getGov_id().equals("0009") || FineDocBn.getGov_id().equals("0003") || FineDocBn.getGov_id().equals("0043") || FineDocBn.getGov_id().equals("0041") || FineDocBn.getGov_id().equals("0044") || FineDocBn.getGov_id().equals("0002") || FineDocBn.getGov_id().equals("0051") || FineDocBn.getGov_id().equals("0055")  || FineDocBn.getGov_id().equals("0037") || FineDocBn.getGov_id().equals("0011") || FineDocBn.getGov_id().equals("0025")   ) {
	    tot_size=1;
	}
	int line_h = 32;
	//페이지 길이
...
<form action="" name="form1" method="POST" >
      ...
      <td colspan="2" align='center' height="10"> <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr bgcolor="#FFFFFF"> 
            <td height="40"> <table width="100%" border="0" cellspacing="0" cellpadding="5">
                <tr> 
                  <td height="20" colspan="2" style="font-size : 9pt;"><font face="바탕">07236 서울특별시 영등포구 의사당대로 8 까뮤이앤씨빌딩 802호</font></td>
 ...
 <% if ( !FineDocBn.getGov_id().equals("0037") ) { %>   
   <tr> 
    ...
    <tr> 
          <td align='center' height="30" width="13%" style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
          <td height="30"  style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
    </tr>
  <% } else { %>  
     <tr> 
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> 주십시오. 또한, 아래 구입할 차량들은 타금융기관에서 대출을 받은적이 없으며  향후 받지 않을것을
              </font></td>
    </tr>
     <tr> 
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕">  확약합니다.
              </font></td>
    </tr>
       <tr> 
          <td align='center' height="30" width="13%" style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
          <td height="30"  style="font-size : 10pt;"><font face="바탕">3.  기성 관련 자료를 첨부로 제출합니다.
              </font></td>
    </tr>
  <% }  %>      
    <tr> 
    ...
    <tr bgcolor="#000000"> 
      <td colspan="2" align='center' height="10"> <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr bgcolor="#A6FFFF" align="center"> 
            ...
            <td style="font-size : 8pt;" rowspan="2" width="15%"><font face="바탕">구입가격  <% if ( FineDocBn.getGov_id().equals("0037") ||  FineDocBn.getGov_id().equals("0029")  ) {%><br>(VAT 제외) <% } %></font></td>          
     
            <td style="font-size : 8pt;" colspan="2" width="40%"><font face="바탕">대출</font></td>         
            <td style="font-size : 8pt;" rowspan="2" width="15%"><font face="바탕">대출금리</font></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            ...
            <td style="font-size : 8pt;" width="20%" align="center" bgcolor="#A6FFFF"><font face="바탕">금액</font></td>
            <td style="font-size : 8pt;" width="20%" align="center" bgcolor="#A6FFFF"><font face="바탕">실행일자</font></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
...
<% if(FineList.size()>0){
		...
		for(int i=0; i<FineList.size(); i++){ 
			...
			for(int j=0; j<1; j++){
				...
				t_amt7[j] += AddUtil.parseLong(String.valueOf(FineDocListBn.getAmt7()));
			
				//저당권금액 저장 - 20120503	
				t_amt4[j] += AddUtil.parseLong(String.valueOf(FineDocListBn.getAmt6()));
				
			//	t_amt4[j] += AddUtil.parseLong(String.valueOf(FineDocListBn.getAmt4()));  //삼성카드인 경우 설정액 누계
		
			//	if (  FineDocBn.getGov_id().equals("0058") ) {
			//		t_amt5[j] += (1000000 *FineDocListBn.getAmt1()) ;	 //무림
			//	}
			
																		
				//산은0010 36미만은 원래개월 , 36이상은 36으로 , 외환 0040 36개월 IBK 0057은 36개월, 롯데0038은 36개월, 하나0041은 36개월, 신한은행은 36개월, 신한캐피탈(0009)은 36개월, 효성캐피탈(0039)은 36,  hk저축은행(0059)은 36,  무림(0058)은 36 , 현대캐피탈(0011)은 36
				if( AddUtil.parseInt(String.valueOf(FineDocListBn.getPaid_no())) >= 36 ||  FineDocBn.getGov_id().equals("0041") || FineDocBn.getGov_id().equals("0044") || FineDocBn.getGov_id().equals("0057")  || FineDocBn.getGov_id().equals("0005")  || FineDocBn.getGov_id().equals("0009")  ||   FineDocBn.getGov_id().equals("0003") || FineDocBn.getGov_id().equals("0038") || FineDocBn.getGov_id().equals("0055") || FineDocBn.getGov_id().equals("0018") ||  FineDocBn.getGov_id().equals("0026")  ||  FineDocBn.getGov_id().equals("0051")   ||  FineDocBn.getGov_id().equals("0039")  ||  FineDocBn.getGov_id().equals("0040")  ||  FineDocBn.getGov_id().equals("0059")  ||  FineDocBn.getGov_id().equals("0058")   ||  FineDocBn.getGov_id().equals("0060")   ||  FineDocBn.getGov_id().equals("0037")   ||  FineDocBn.getGov_id().equals("0011")    ||  FineDocBn.getGov_id().equals("0033")    ||  FineDocBn.getGov_id().equals("0029")   ||  FineDocBn.getGov_id().equals("0025")  ){	
				...
				//	s_amt4[j] += AddUtil.parseLong(String.valueOf(FineDocListBn.getAmt4()));   //삼성카드인 경우 사용
					s_amt7[j] += AddUtil.parseLong(String.valueOf(FineDocListBn.getAmt7()));  //부가세제외 구입가	
				}
				
			//	if (  FineDocBn.getGov_id().equals("0058") ) {
			//		s_amt5[j] += (1000000 *FineDocListBn.getAmt1()) ;	  //무림
			//	}				
			}
...
<% if (   (FineDocBn.getGov_id().equals("0010") && AddUtil.parseInt(String.valueOf(FineDocListBn.getPaid_no())) < 36)  
       || (FineDocBn.getGov_id().equals("0056") && AddUtil.parseInt(String.valueOf(FineDocListBn.getPaid_no())) < 36) 
       || (FineDocBn.getGov_id().equals("0040") && AddUtil.parseInt(String.valueOf(FineDocListBn.getPaid_no())) < 36)) { %>			
		<tr bgcolor="#FFFFFF" align="center">
            <td width="10%" height="<%=line_h%>" bgcolor="#FFFFFF" style="font-size : 8pt;">
            <%if(AddUtil.parseInt(String.valueOf(FineDocListBn.getPaid_no())) >= 36 ){%>
             <input type='text' name="paid_no" value='36'  size='2'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >개월 
        <%}else{%>
           <input type='text' name="paid_no" value='<%=FineDocListBn.getPaid_no()%>'  size='2'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >개월
        <%}%></td>
            ...
            <td width="20%" style="font-size : 8pt;" align=right><font face="바탕"><%=Util.parseDecimal(String.valueOf(FineDocListBn.getAmt3()))%>&nbsp;</font></td>
            <td width="20%" style="font-size : 8pt;"><font face="바탕"><%=FineDocListBn.getVio_dt()%></font></td>       
            <td width="15%" style="font-size : 8pt;"><font face="바탕"><%=FineDocListBn.getScan_file()%></font></td>
        </tr>
<% 	} %>          
<%  } %>

		
<% if ( FineDocBn.getGov_id().equals("0005") ||   FineDocBn.getGov_id().equals("0010") || FineDocBn.getGov_id().equals("0056") || FineDocBn.getGov_id().equals("0057")  || FineDocBn.getGov_id().equals("0040")  || FineDocBn.getGov_id().equals("0038") || FineDocBn.getGov_id().equals("0039") || FineDocBn.getGov_id().equals("0001") ||  FineDocBn.getGov_id().equals("0009")  ||  FineDocBn.getGov_id().equals("0003") ||  FineDocBn.getGov_id().equals("0004") ||  FineDocBn.getGov_id().equals("0043") ||  FineDocBn.getGov_id().equals("0044") || FineDocBn.getGov_id().equals("0041") || FineDocBn.getGov_id().equals("0002") || FineDocBn.getGov_id().equals("0051") || FineDocBn.getGov_id().equals("0055") || FineDocBn.getGov_id().equals("0018") ||  FineDocBn.getGov_id().equals("0026")   ||  FineDocBn.getGov_id().equals("0039")   ||  FineDocBn.getGov_id().equals("0059")    ||  FineDocBn.getGov_id().equals("0058")  ||  FineDocBn.getGov_id().equals("0060")  ||  FineDocBn.getGov_id().equals("0037")  ||  FineDocBn.getGov_id().equals("0011")   ||  FineDocBn.getGov_id().equals("0033")   ||  FineDocBn.getGov_id().equals("0029")  ||  FineDocBn.getGov_id().equals("0025")  ) { %>	
		 <tr bgcolor="#FFFFFF" align="center">
            <td width="10%" height="<%=line_h%>"  style="font-size : 8pt;">
                  <input type='text' name="paid_no" value='36'  size='2'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >개월 </td>
            <td width="10%" style="font-size : 8pt;"><font face="바탕"><%=FineDocListBn.getCar_st()%></font></td>
            <td width="10%" style="font-size : 8pt;" ><font face="바탕"><%=Util.parseDecimal(s_amt1[0])%></font></td>
            <td width="15%" >
              <% if (  FineDocBn.getGov_id().equals("0037") ||  FineDocBn.getGov_id().equals("0029")   ) {%>
            <input type='text' name="amt2" value='<%=Util.parseDecimal(s_amt7[0])%>'  size='13'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >&nbsp;
            <% } else {%>
               <input type='text' name="amt2" value='<%=Util.parseDecimal(s_amt2[0])%>'  size='13'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >&nbsp;
             <% } %>  
           </td>
            <td width="20%" style="font-size : 8pt;" align=right><input type='text' name="amt3" value='<%=Util.parseDecimal(s_amt3[0])%>'  size='13'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >&nbsp;</font></td>
            <td width="20%" style="font-size : 8pt;"><font face="바탕"><%=FineDocListBn.getVio_dt()%></font></td> 
            <td width="15%" style="font-size : 8pt;"><font face="바탕"><%=FineDocListBn.getScan_file()%></font></td>           
 ...
 <% 	} %>     
         ...
         <tr bgcolor="#FFFFFF" align="center">
            ...
            <td width="15%" style="font-size : 8pt;" align=right>
              <% if (  FineDocBn.getGov_id().equals("0037")   ||  FineDocBn.getGov_id().equals("0029")  ) {%>
            <input type='text' name="amt2" value='<%=Util.parseDecimal(t_amt7[0])%>'  size='13'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >&nbsp;
            <% } else {%>
               <input type='text' name="amt2" value='<%=Util.parseDecimal(t_amt2[0])%>'  size='13'   style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >&nbsp;
             <% } %>  
            </font></td>
            <td width="20%" style="font-size : 8pt;" align=right><input type='text' name="t_amt3" value='<%=Util.parseDecimal(t_amt3[0])%>'  size='13'  style=' text-align:right; font-size : 8pt; background-color:#ffffff; border-color:#000000; border-width:0;' >&nbsp;</font></td>
            <td width="20%" style="font-size : 8pt;"><font face="바탕"></font></td>         
