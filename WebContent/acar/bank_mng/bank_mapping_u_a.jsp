...
<%
	...
	String lend_int = request.getParameter("lend_int_m")==null?"":request.getParameter("lend_int_m");
...
//    debt.setFst_pay_amt(0);	 // 스케줄 작성시 입력
	...
	debt.setLoan_st_dt(request.getParameter("loan_st_dt")==null?"":request.getParameter("loan_st_dt"));
...
//		cltr.setCltr_st("Y");
//	}
	if(!cltr_id.equals("")) flag2 = abl_db.updateBankMapping_cltr(cltr);
	if(cltr_id.equals("")) 	flag2 = abl_db.insertBankMapping_cltr(cltr);
%>
