     ...
     <td width="100%" height="10" align='center'><table width="100%" border="0" cellspacing="1" cellpadding="0">
		...
		%>
         ...
         <tr bgcolor="#FFFFFF" align="center">
            ...
            <td  style="font-size : 8pt;" align=right><font face="바탕"><%=Util.parseDecimal(t_amt12[0])%></td>
            ...
            <td  style="font-size : 8pt;"><font face="바탕"></font></td>
            <td  style="font-size : 8pt;"><font face="바탕"></font></td>
            <td  style="font-size : 8pt;" align=right><font face="바탕"></font><%=Util.parseDecimal(t_amt14[0])%></td>
