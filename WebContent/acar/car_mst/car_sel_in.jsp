      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding="3" width="800">
          <tr> 
            ...
            <td width="430"> 
              <input type="text" name="car_s" value="" size="50" class=text>
            </td>
            <td align="right" width="100"> 
              <input type="text" name="car_s_p" value="" size="8" class=num onBlur='javascript:this.value=parseDecimal(this.value);'>
              원</td>
            <td align="center" width="90"> 
              <input type="text" name="car_s_dt" size="12" value="" class=<%=white%>text onBlur='javscript:this.value = ChangeDate(this.value);'>
            </td>
          ...
          <tr> 
            ...
            <td> 
              <input type="text" name="car_s" value='<%=cs_bean.getCar_s()%>' size="50" class=<%=white%>text>
            </td>
            <td align="right"> 
              <input type="text" name="car_s_p" value="<%=AddUtil.parseDecimal(cs_bean.getCar_s_p())%>" size="8" class=<%=white%>num>
              원</td>
            <td align="center"> 
