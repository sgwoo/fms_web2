...
<%
	...
	Vector scanList = c_db.getAcarAttachFileList("CAR_COL_CAT",content_seq+"%",-1);
	int scanListSize = scanList.size();
	if(scanListSize>0){
		content_seq += (scanListSize+1);
	}else{
		content_seq += '1';
	}
%>
...
<!--
	...
	function save(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.CAR_COL%>";
		fm.submit();
	}
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1><span class=style5>스캔등록 : 색상관리 </span></span></td>
  ...
  <tr>
	 <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>차명별 색상표 등록</span></td>
  </tr>    
    <tr>
	    <td class=line2></td>
	</tr>
