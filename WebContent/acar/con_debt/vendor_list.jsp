...
<!--
	...
	function setVendor(ven_code, ven_name){
		...
		<%if(type.equals("client_fee")){%>
			opener.parent.c_foot.location.href = "/fms2/con_fee/client_fee_c.jsp?ven_code="+ven_code+"&ven_name="+ven_name;		
			self.close();
		<%}else{%>		
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    ...
    <tr>
        <td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_glc.gif align=absmiddle>&nbsp;
            <input type='text' name='t_wd' size='30' value='<%=t_wd%>' class='text' onKeyDown='javascript:enter()'>
            <a href='javascript:document.form1.submit()'><img src=../images/center/button_search.gif align=absmiddle border=0></a> 
        </td>
    </tr>
    <tr> 
        <td class=h></td>
