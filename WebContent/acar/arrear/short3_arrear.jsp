...
<table border=0 cellspacing=0 cellpadding=0 width="100%">
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>채권관리 > 연체관리 > <span class=style5>위험연체현황</span></span></td>
    ...
    <tr> 
        ...
        <td align="right"><img src=../images/center/arrow_gj.gif align=absmiddle> :  3개월 이상 4개월미만 &nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>	
    <tr> 
        <td class=h></td>
    </tr>
    ...
    <tr> 
        <td colspan="2"><iframe src="./short3_arrear_view.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&s_yy=<%=s_yy%>&s_mm=<%=s_mm%>&brch_id=<%=brch_id%>" name="i_view" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
        </td>
    </tr>
  </table>
</form>
