...
<%
	...
	Vector buss1 = ad_db.getFeeScdSum("0001", "", "3", "3", "4");
	int bus_size1 = buss1.size();

	Vector buss2 = ad_db.getFeeScdSum("0002", "", "3", "3", "4");
	int bus_size2 = buss2.size();
	
	
	Vector buss3 = ad_db.getFeeScdSum("9999", "", "3", "3", "4");
	int bus_size3 = buss3.size();
	
	Vector buss4 = ad_db.getFeeScdSum("0007", "", "3", "3", "4");
	int bus_size4 = buss4.size();
					
	Vector buss5 = ad_db.getFeeScdSum("0008", "", "3", "3", "4");
	    ...
	    <td class='line' width='30%' id='td_con' style='position:relative;'> 
		 ...
		 <%  if  (bus_size1 > 0 ) { %>  	
          ...
          <%for (int i = 0 ; i < bus_size5 ; i++){
                ...
                <tr> 
            <%	if(i==0){%>
                    <td align="center" width="40%"  rowspan="<%=bus_size5%>">대전지점</td>
                    <%	}else{}%>
                    <td align="center" width="30%"><a href="javascript:stat_search('d','<%=ht.get("BUS_ID2")%>');" onMouseOver="window.status=''; return true"><font color="#0000FF"><%=ht.get("BUS_NM2")%></font></a></td>
                    <td align="center" width="30%"><%=AddUtil.ChangeDate2(String.valueOf(ht.get("ENTER_DT")))%> </td>
		 ...
		 <%  if  (bus_size5 > 0 ) { %>  			
            ...
            <%		
                ...
                <tr> 
                    ...
                    <td class=title_p style='text-align:right' width=17%><%=Util.parseDecimal(d_amt[0]+d_amt[1]+d_amt[2]+d_amt[3]+d_amt[4])%>원&nbsp;</td>
