...
<!--
	...
	function save(){
		...
		fm.action = 'exp_rtn_doc_rec_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
...
<table border="0" cellspacing="0" cellpadding="0" width="<%=70+(120*sheet.getColumns())%>">
  <tr>
    <td>&lt; <b>세입과오납환부청구서 접수 처리 </b> 엑셀 파일 읽기 &gt; </td>
  </tr>
  <tr>
    <td><hr></td>
  </tr>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="120" class="title">환급금액</td>
		  <td width="120" class="title">환급일자</td>
        </tr>
      </table></td>
  </tr>  
  <tr>
  ...
  <tr>
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0" width=100%>  
        <tr>
    	  <td width="100" height="30" rowspan="2" class="title">부과년도</td>    	  
    	  <td>&nbsp;
		  <input name="exp_year" type="text" class=text value=""size="12"></td>
        </tr>
	  </table>
	</td>
  </tr>     
