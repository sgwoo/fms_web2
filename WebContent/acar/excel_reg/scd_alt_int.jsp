...
<%
	...
	String car_id = file.getParameter("car_id")==null?"":file.getParameter("car_id");
	String t_fst_pay_amt = file.getParameter("t_fst_pay_amt")==null?"":file.getParameter("t_fst_pay_amt");
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<table border="0" cellspacing="0" cellpadding="0" width="<%=70+(120*sheet.getColumns())%>">
  ...
  <tr>
    <td>※ 사유 입력하고 스케줄 수정시 관련담당자 메시지 발송 <textarea rows='2' cols='90' name='update_msg'></textarea></td>
  </tr>    
  <tr>
    <td>&nbsp;</td>
  </tr>  
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="120" class="title">회차</td>
