...
<table border="0" cellspacing="0" cellpadding="0" width=580>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>인사관리 > 근태관리 > 출근관리 > <span class=style5>일정일괄등록</span></span></td>
	...
	<form action="./sch_all_i_a.jsp" name='ScheRegForm' method='post'>
	<tr>
		<td align='right'>
