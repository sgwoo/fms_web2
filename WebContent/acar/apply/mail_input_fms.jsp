...
<%
	...
	System.out.println("[견적 메일주소 입력하기] est_id = "+est_id);
%>
...
<table width=440 border=0 cellspacing=0 cellpadding=0>
    ...
    <tr>
    	<td align=center>
    		...
    		<tr>
    		    <td align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="file_add_yn2" value="Y"> 체크시 [사업자 등록증] 파일을 첨부한다.</td>
    		</tr>
    ...
    <tr>
    	<td align=center><a id="submitLink" href="javascript:send_mail();"><img src=/acar/images/center/mail_btn_send.gif border="0" alt='보내기'></a></td>
    </tr>   
</table>
