    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1> <span class=style5>출고지연 견적 조회</span></span></td>
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td <%=td_color%> align=right><a href="javascript:set_tae_amt('<%=ht.get("FEE_S_AMT")%>','<%=ht.get("FEE_V_AMT")%>','<%=ht.get("FEE_AMT")%>','<%=ht.get("TAE_RENT_FEE_CLS")%>')" onMouseOver="window.status=''; return true"><%=Util.parseDecimal(String.valueOf(ht.get("FEE_AMT")))%>원</a></td>          
                    <td <%=td_color%> align=right><%=Util.parseDecimal(String.valueOf(ht.get("TAE_RENT_FEE_CLS")))%>원</td>                             
                </tr>
                <%}%>
            </table>
        </td>
