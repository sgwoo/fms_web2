...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td colspan=2>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1><span class=style5>[<%=res.get("CAR_NO")%>] 차량예약 이력</span></span></td>
    ...
    <tr>  
        <td align="right" colspan=2><a href="javascript:this.close();"><img src=/acar/images/center/button_close.gif align=absmiddle border=0></a></td>	
    </tr>
</table>
</form>
</body>
