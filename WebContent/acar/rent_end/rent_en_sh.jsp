...
<form name='form1' method='post' action='rent_en_sc.jsp' target='c_foot'>
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>예약시스템 > 영업지원 > <span class=style5>계약관리</span></span></td>
    ...
    <tr> 
        <td align='left' colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gshm.gif align=absmiddle>&nbsp;
            <select name='s_kd'>              
              ...
              <option value='8' <%if(s_kd.equals("8")){%> selected <%}%>>대차계약번호</option>
            </select>
        ...
        <td id='td_input' align='left' style="display:''"><img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>&nbsp; 
            <select name='sort_gubun' onChange='javascript:search()'>
              ...
              <option value='a.ret_dt'  <%if(sort_gubun.equals("a.ret_dt")){%> selected <%}%>>반차일자</option>
