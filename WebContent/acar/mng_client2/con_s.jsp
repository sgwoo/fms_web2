...
%>
				<tr>
					<td align='center' width='12%'><a href="javascript:parent.view_car_mgr('<%=cont.get("RENT_MNG_ID")%>', '<%=cont.get("RENT_L_CD")%>')" onMouseOver="window.status=''; return true"><%=cont.get("RENT_L_CD")%></a></td>
					<td align='center' width='10%'><%=cont.get("RENT_DT")%></td>
					<td align='center' width='13%'><%=cont.get("CAR_NO")%></td>
					<td align='center' width='20%'><%=cont.get("CAR_NM")%></td>
					<td align='center' width='21%'><%=cont.get("RENT_START_DT")%>&nbsp;~&nbsp;<%=cont.get("RENT_END_DT")%></td>
