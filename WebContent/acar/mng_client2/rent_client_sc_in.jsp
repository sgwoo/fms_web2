...
<%
	...
	Vector cars = al_db.getClientContStat(dt, ref_dt1, ref_dt2, gubun2, gubun3, gubun4, gubun5, sort);
...
function init() {
	...
	function open_client(client_id){
		...
		window.open(SUBWIN, "MailUp", "left=100, top=100, width=850, height=700, scrollbars=yes");
	}		
//-->
</script>
<style type="text/css">
                    ...
                    <td class=line id='title_col0' style='position:relative;'> 
	  		            <table border=0 cellspacing=1 width="100%" >
                            <tr> 
                                ...
                                <td width=28% class=title>상호</td>
                                <td width=12% class=title>대표자</td>
                                <td width=13% class=title>계약건수</td>
...
%>			
                            <tr> 
                                ...
                                <td align="center" width=14%><%=car.get("CLIENT_ST")%></td>
                                <td align="center" width=28%><%=car.get("FIRM_NM")%></td>
                                <td width=12% align="center"><span title="<%=car.get("CLIENT_NM")%>"><%= Util.subData(String.valueOf(car.get("CLIENT_NM")),4) %></span></td>
                                <td width=13% align="center"><a href="javascript:open_client('<%=car.get("CLIENT_ID")%>')"><%=car.get("CONT_CNT")%>건</a></td>
                                <td width=15% align="center"><%=car.get("BUS_NM")%></td>
                                <td width=12% align="center"><%=car.get("BUS_NM2")%></td>
