    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > 거래처계약현황 > <span class=style5>계약건수</span></span></td>
...
%>
                <tr>
                    ...
                    <td align=center><%=cont.get("RENT_WAY")%><%if(String.valueOf(cont.get("RENT_WAY")).equals("")){%>기본식<%}%></td>
