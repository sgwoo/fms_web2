...
<!--
	...
	function cng_input3(){
		var fm = document.form1;
		if(fm.s_kd.options[fm.s_kd.selectedIndex].value == '7' || fm.s_kd.options[fm.s_kd.selectedIndex].value == '11'){ //관리담당자, 청구자
...
%>
<form action="./accid_s5_sc.jsp" name="form1" method="POST" target="c_foot">
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고 및 보험 > 사고관리 > <span class=style5>휴/대차료 관리</span></span></td>
    ...
    <tr> 
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif  align=absmiddle>&nbsp;  
            <select name="s_kd" onChange="javascript:cng_input3()">
              ...
              <option value="11" <%if(s_kd.equals("11")){%> selected <%}%>>청구자</option>		  			  			  	  		  		  
            </select>
        </td>
        <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
