...
<table border="0" cellspacing="0" cellpadding="0" width='1790'>
    ...
    <tr id='tr_title' style='position:relative;z-index:1'>
	    ...
	    <td class='line' width='1280'>
    	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr> 
                    <td width='140' class='title'>사고일시</td>
                    <td width='60' class='title'>당사과실</td>			
                    <td width='100' class='title'>상대보험사</td>
                    <td width='70' class='title'>보험담당자</td>			
                    <td width='60' class='title'>청구구분</td>
                    <td width='170' class='title'>사용기간</td>
	...
	<td class='line' width='1280'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr> 
            ...
            <td <%if(accid.get("USE_YN").equals("N")){%>class='is'<%}%> width='80' align='center'><%=AddUtil.ChangeDate2(String.valueOf(accid.get("REQ_DT")))%><%if(gubun3.equals("4")){//미청구%><%if(accid.get("RENT_CONT_YN").equals("Y")){%>대차<%}%><%}%></td>			
