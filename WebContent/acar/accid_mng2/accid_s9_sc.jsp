...
<input type='hidden' name='go_url' 	value='/acar/accid_mng2/accid_s9_frame.jsp'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	  <tr>
		<td><iframe src="accid_s9_sc_in.jsp<%=valus%>&go_url=<%=go_url%>#<%=idx%>" name="i_no" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe></td>
	  </tr>
	  <tr>
		<td width=100%>
			※ 일부수금은 최종 수금일자, 전액미수일때는 청구일자를 기준으로 하여 년리 5%의 연체이자를 부과합니다.
		</td>
	  </tr>	  
</table>
</form>
