...
<form action="./accid_s9_2_sc.jsp" name="form1" method="POST" target="c_foot">
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고관리 > 보상금관리 > <span class=style5>대차료미납완료현황</span></span></td>
