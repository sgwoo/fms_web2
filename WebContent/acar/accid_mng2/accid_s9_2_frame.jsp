...
<FRAMESET rows="<%=height%>, *" border=0>
	<FRAME SRC="./accid_s9_2_sh.jsp<%=valus%>&go_url=<%=go_url%>&idx=<%=idx%>" name="c_body" frameborder=0 marginwidth="10" marginheight="10" scrolling="no" noresize>
	<FRAME SRC="./accid_s9_2_sc.jsp<%=valus%>&go_url=<%=go_url%>&idx=<%=idx%>" name="c_foot" frameborder=0 marginwidth="10" topmargin=0 scrolling="no" noresize>
</FRAMESET>
<NOFRAMES>
<BODY>
