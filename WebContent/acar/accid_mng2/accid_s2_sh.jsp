...
%>
<form action="./accid_s2_sc.jsp" name="form1" method="POST" target="c_foot">
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고 및 보험 > 사고관리 > <span class=style5>인사사고관리</span></span></td>
    ...
    <tr> 
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/acar/images/center/arrow_gsjg.gif" align=absmiddle>&nbsp;
            <select name="s_kd" onChange="javascript:cng_input3()">
              ...
              <option value="8" <%if(s_kd.equals("8")){%> selected <%}%>>피해자</option>		  
            </select>
        </td>
        <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
