...
%>
<form action="./accid_s3_sc.jsp" name="form1" method="POST" target="c_foot">
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고 및 보험 > 사고관리 > <span class=style5>대물사고관리</span></span></td>
    ...
    <tr>      
        ...
        <td><a href="javascript:Search(1)"><img src="/acar/images/center/button_search.gif"  align="absmiddle" border="0"></a></td>
    </tr>
    <tr> 
        ...
        <td><img src=/acar/images/center/arrow_g_ph.gif  align=absmiddle>&nbsp;
            <select name="gubun5">
        ...
        <td><img src=/acar/images/center/arrow_bsci.gif  align=absmiddle>&nbsp;
            <select name="gubun6">
              ...
              <option value="1" <%if(gubun6.equals("1")){%>selected<%}%>>피해자</option>
              <option value="2" <%if(gubun6.equals("2")){%>selected<%}%>>가해자</option>
              <option value="3" <%if(gubun6.equals("3")){%>selected<%}%>>쌍방</option>
              <option value="5" <%if(gubun6.equals("5")){%>selected<%}%>>단독</option>
              <option value="4" <%if(gubun6.equals("4")){%>selected<%}%>>운행자차</option>
            </select>
        </td>
        <td>&nbsp;</td>
        <td><a href="javascript:Search(2)"><img src="/acar/images/center/button_search.gif"  align="absmiddle" border="0"></a></td>
    </tr>
    <tr> 
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif  align=absmiddle>&nbsp;  
            <select name="s_kd" onChange="javascript:cng_input3()">
              ...
              <option value="9" <%if(s_kd.equals("9")){%> selected <%}%>>정비일자</option>
              <option value="10" <%if(s_kd.equals("10")){%> selected <%}%>>입고일자</option>
              <option value="11" <%if(s_kd.equals("11")){%> selected <%}%>>출고일자</option>
              <option value="12" <%if(s_kd.equals("12")){%> selected <%}%>>견적번호</option>
            </select>
        </td>
        <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td colspan="2"><img src=/acar/images/center/arrow_jr.gif  align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
            <select name="sort">
              ...
              <option value="5" <%if(sort.equals("5")){%> selected <%}%>>정비업체</option>
              <option value="6" <%if(sort.equals("6")){%> selected <%}%>>정비일자</option>
              <option value="7" <%if(sort.equals("7")){%> selected <%}%>>입고일자</option>
              <option value="8" <%if(sort.equals("8")){%> selected <%}%>>출고일자</option>
            </select>
