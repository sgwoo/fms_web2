...
%>
<form action="./accid_s4_sc.jsp" name="form1" method="POST" target="c_foot">
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고 및 보험 > 사고관리 > <span class=style5>면책금관리</span></span></td>
    ...
    <tr> 
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_g_ig.gif  align=absmiddle>&nbsp;
            <select name="gubun3">
              ...
              <option value="3" <%if(gubun3.equals("3")){%>selected<%}%>>연체</option>		  
              <option value="0" <%if(gubun3.equals("0")){%>selected<%}%>>미수금</option>
              <option value="1" <%if(gubun3.equals("1")){%>selected<%}%>>수금</option>
              <option value="2" <%if(gubun3.equals("2")){%>selected<%}%>>손비(면제)</option>		  
    ...
    <tr> 
        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif  align=absmiddle>&nbsp;  
            <select name="s_kd" onChange="javascript:cng_input3()">
              ...
              <option value="8" <%if(s_kd.equals("8")){%> selected <%}%>>청구일자</option>		  
              <option value="9" <%if(s_kd.equals("9")){%> selected <%}%>>입금일자</option>		  		  
			  <option value="7" <%if(s_kd.equals("7")){%> selected <%}%>>접수자</option>
			  <option value="11" <%if(s_kd.equals("11")){%> selected <%}%>>비용담당자</option>
            </select>
        </td>
        <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td colspan="2"><img src=/acar/images/center/arrow_jr.gif  align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
            <select name="sort">
              ...
              <option value="5" <%if(sort.equals("5")){%> selected <%}%>>청구일자</option>
              <option value="6" <%if(sort.equals("6")){%> selected <%}%>>입금일자</option>
            </select>
            ...
            내림차순 </td>
        <td><a href="javascript:Search(3)"><img src="/acar/images/center/button_search.gif" align="absmiddle" border="0"></a></td>
    </tr>
</table>
</form>
</body>
