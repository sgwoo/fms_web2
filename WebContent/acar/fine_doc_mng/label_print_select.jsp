...
<%
	...
	for(int i=0;i < vid_size;i+=2){
		...
		Hashtable ht1 = FineDocDb.getFineGovList(doc_id);
%>
<table width=100% border=0 cellspacing=0 cellpadding=0>   
  <tr>
        ...
        <tr valign="bottom">
          <td height="50" colspan="3" align="center" class="style14"><%=ht1.get("ADDR")%></td>
        </tr>
        <tr valign="middle">
          <td height="40" colspan="3" align="center" class="style14"><%=ht1.get("GOV_NM")%>&nbsp;<%=ht1.get("MNG_DEPT")%></td>
        </tr>
        <tr valign="middle">
          <td width="80%"  height="50" colspan="2" align="right" valign="top" class="style14"><%=ht1.get("ZIP")%>&nbsp;</td>
          <td width="" >&nbsp;</td>																	
			  </tr>
      </table>
    </td>
<%	//2번칸
		if(i+1 < vid_size){
			vid_num 	= vid[i+1];
			doc_id 		= vid2[AddUtil.parseInt(vid_num)];
			Hashtable ht2 = FineDocDb.getFineGovList(doc_id);
%>    
		<td width="30%" align="center" valign="top">
		  <table width="100%" height="" border=0 cellpadding=0 cellspacing=1 >
				<tr valign="bottom">
          <td height="50" colspan="3" align="center" class="style14"><%=ht2.get("ADDR")%></td>
        </tr>
        <tr valign="middle">
          <td height="40" colspan="3" align="center" class="style14"><%=ht2.get("GOV_NM")%>&nbsp;<%=ht2.get("MNG_DEPT")%></td>
        </tr>
        <tr valign="middle">
          <td width="80%"  height="50" colspan="2" align="right" valign="top" class="style14"><%=ht2.get("ZIP")%>&nbsp;</td>
          <td width="" >&nbsp;</td>
		    </tr>
      </table>
    </td>
