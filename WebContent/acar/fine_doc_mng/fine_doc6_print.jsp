...
<form action="" name="form1" method="POST" >
  <table width='670' height="<%=table1_h%>" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="125" colspan="2" align='center'> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td height="25" style="font-size : 10pt;"><font face="바탕">:</font></td>
            <td height="25" style="font-size : 10pt;"><font face="바탕">정기검사기간경과 부과 처분에 대한 의견 제출 (과태료 납부의무자 변경 요청) 
			  <%-- <%if(exp.equals("Y")){%>
	...
	<tr> 
      ...
      <td height="30" style="font-size : 10pt;"><font face="바탕">2. 당사에 부과(부과예정)한 자동차검사지연과태료 처분에 대하여 아래와 같이 
        </font></td>
    </tr>
    <tr> 
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> &nbsp;&nbsp;&nbsp;&nbsp;의견을 진술하오니 (관련근거 도로교통법 제 160 조 4 항 2.3.4 조) 
        </font></td>
    </tr>
    <tr> 
    	<td align='center' height="30" style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕">
		3. 납부의무자를 당사에서 임차인으로 변경 처분하여 주시거나, 질서위반행위규제법 제 16 조
        </font></td>
    </tr>
    <tr> 
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕">
		&nbsp;&nbsp;&nbsp;&nbsp;제 2 항 및 제 3 항에 근거하여 관할법원에 이 사실을 통보하여 정당한 처분을 받도록 처리하여 주십시오.
        </font></td>
    </tr>
    <tr> 
