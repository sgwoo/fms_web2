...
<form action="" name="form1" method="POST" >
  <table width='670' height="<%=table1_h%>" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="125" colspan="2" align='center'> <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td height="25" style="font-size : 10pt;"><font face="바탕">:</font></td>
            <td height="25" style="font-size : 10pt;"><font face="바탕">도로교통법위반 과태료 부과 처분에 대한 
			  <%if(exp.equals("Y")){%>
	...
	<%if(FineDocBn.getMng_dept().equals("장애인담당")){%>
    <tr> 
      <td align='center' height="30" style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
      <td height="30" style="font-size : 10pt;"><font face="바탕">2. 당사에 부과(부과예정)한 편의증진보장위반 범칙금 또는 과태료 처분에 대하여 아래와 같이
        </font></td>
    </tr>
    <tr> 
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> &nbsp;&nbsp;&nbsp;의견을 진술하오니 (장애인, 노인, 임산부 등의 에 관한 법률 제 17조 제3항 (장애인전용주차구역등)위반)
        </font></td>
    </tr>
    <tr> 
    	<td align='center' height="30" style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> 
	    3. 납부의무자를 당사에서 임차인으로 변경 처분하여 주십시오.
        </font></td>
    </tr>
    <tr> 
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> 
...
<%}else{%>    
	<tr> 
      <td align='center' height="30" style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
      <td height="30" style="font-size : 10pt;"><font face="바탕">2. 당사에 부과(부과예정)한 도로교통법위반 범칙금 또는 과태료 처분에 대하여 아래와 같이 
        </font></td>
    </tr>
    <tr> 
      <!-- <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> 의견을 진술하오니 (관련근거 도로교통법 제160조 3항 및 4항, 제161조 2항)</font></td> -->
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕">&nbsp;&nbsp;&nbsp;&nbsp;의견을 진술하오니 (관련근거 도로교통법 제160조 4항)</font></td>
    </tr>
    <tr> 
    	<td align='center' height="30" style="font-size : 10pt;"><font face="바탕">&nbsp;</font></td>
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> 
		...
		<%}else{%>
		3. 납부의무자를 당사에서 임차인으로 변경 처분하여 주시거나, 질서위반행위규제법 제16조 
		<%}%>
        </font></td>
    </tr>
    <tr> 
      <td height="30" colspan="2" style="font-size : 10pt;"><font face="바탕"> 
	   ...
	   &nbsp;&nbsp;&nbsp;&nbsp;처리하여 주십시오.
		<%}else{%>
		&nbsp;&nbsp;&nbsp;&nbsp;제2항에 근거하여 관할법원에 이 사실을 통보하여 정당한 처분을 받도록 처리하여 주십시오.
		<%}%>
        </font></td>
    </tr>
<%}%>
