...
<%
	...
	String vid4[] = request.getParameterValues("ch_gov_nm");	
	String list_size = "";
	String vid_num="";
	String img_url = "";
	String gov_nm = "";
	...
	for(int j=0;j < vid_size;j++){
		if(find_type.equals("popOne")){
			...
			gov_nm = request.getParameter("ch_gov_nm")==null?"":request.getParameter("ch_gov_nm");
		}else{
			vid_num 	= vid[j];
			doc_id 		= vid2[AddUtil.parseInt(vid_num)];
			gov_nm 	= vid4[AddUtil.parseInt(vid_num)];
		}
		img_url		= doc_id;
