...
<%
	...
	if(content_code.equals("fine")){
		Hashtable ff = FineDocDb.getFind_file6(doc_id, rent_mng_id, rent_l_cd, client_id, vio_dt, car_mng_id, AddUtil.parseInt(seq_no));
%>
<!--과태료 청구서 스캔파일-->
...
<table>
	<tr valign="top">
		<td>
			<%if(ff.get("SAVE_FOLDER").equals("")){%>
			<img src="https://fms3.amazoncar.co.kr/data/fine/<%=ff.get("FILE_NAME")%>.jpg" width=<%=img_width%> height=<%=img_height%>><br style="page-break-before:always;">
			<%}else{%>
...
<!--계약서외 스캔파일-->
<%
	}else if(content_code.equals("lc_scan")){
				int size = 0;
				String content_seq = "";
				String save_file1 ="";
				String save_file2 ="";
			...
			<%if(mode.equals("fine")){ %>
				<%if(!save_file1.equals("")){ %>
					<div style="position: relative;">
						...
						<img src="/images/stamp_c.png" style="position:absolute; z-index: 2; left:50px; top: 950px; width: 170px;">
					</div>	
