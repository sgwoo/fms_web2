...
<!--
	...
	function save(){
		...
		fm.target= '_parent';
		<%if(gubun1.equals("2")){%>
		fm.action = 'excel_aj_a.jsp';
		<%}else if(gubun1.equals("3")){%>
		fm.action = 'excel_gb_a.jsp';
		<%}else  if(gubun1.equals("1")){%>
		fm.action = 'excel_lo_a.jsp';
		<%}%>
		fm.submit();
	}
//-->
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
		  ...
		  <td width="120" class="title">경매장명</td>
          <td width="120" class="title">경매일자</td>
		  <td width="120" class="title">입금일자</td>
          <td width="120" class="title">경매회차</td>		  
          <td width="120" class="title">출품번호</td>
          <td width="120" class="title">차량번호</td>
		  <td width="120" class="title">사업자번호</td>
		  <td width="120" class="title">낙찰가</td>
		  <td width="120" class="title">낙찰수수료</td>
		  <td width="120" class="title">출품수수료</td>
