                    ...
                    <td class='line' id='td_title' style='position:relative;' width='100%'> 
                        <table border="0" cellspacing="1" cellpadding="0" width=100%>
                            <tr>                                 
                                ...
                                <td width='75'  class='title' rowspan="2">차량번호</td>				  
                                <td width='185' class='title' rowspan="2">차명</td>
                                <td width='100' class='title' rowspan="2">경매장</td>				  								
				<td width='70'  class='title' rowspan="2">경매일자</td>
                                <td width='70'  class='title' rowspan="2">최초등록일</td>				  
