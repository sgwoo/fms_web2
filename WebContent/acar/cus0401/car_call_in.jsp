...
<!--
	function save(){
		...
		if(fm.in_st[0].checked != true && fm.in_st[1].checked != true && fm.in_st[2].checked != true){	alert('회수구분을 선택하십시오'); 		fm.in_st[0].focus(); 	return; }
		<%}else{%>
		<%		if(!seq.equals("")){//수정%>
		...
		<%		}%>		
		if(fm.in_st.checked != true){	alert('회수구분을 선택하십시오'); 		fm.in_st.focus(); 	return; }
		<%}%>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	        ...
	        <%}%>
                <tr>
                    ...
                    <td>&nbsp;
                      ...
                      해지반납
					  <%}else{%>
					  <input type="radio" name="in_st" value="3" <%if(in_st.equals("3"))%>checked<%%> > 
                      해지반납
					  <%}%>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>&nbsp;
					  <input type='text' name='in_dt' value='<%=AddUtil.ChangeDate2(in_dt)%>' maxlength='12' size='12' class='text' onBlur='javscript:this.value = ChangeDate(this.value);'></td>
                </tr>
                <tr>
                ...
                <tr id=tr_out style="display:<%if(in_st.equals("")){%>none<%}else{%>''<%}%>">
                    ...
                    <td>&nbsp;
                    <input type='text' name='out_dt' value='<%=AddUtil.ChangeDate2(out_dt)%>' maxlength='12' size='12' class='text' onBlur='javscript:this.value = ChangeDate(this.value);'>
			        </td>
                </tr>		  
                <tr>
    ...
    <tr>
	    <td>* 계약담당자는 해지반납만 처리할 수 있으며, 해지반납 등록시 예약시스템에서 보유차로 운행이 됩니다.</td>
    </tr>	
    <tr>
