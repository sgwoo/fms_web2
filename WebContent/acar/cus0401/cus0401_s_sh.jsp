...
function carSearch(){
	...
	theForm.action = "cus0401_s_sc.jsp";
	theForm.submit();
}
function list_move(){
	...
	function search(){
		...
		if(fm.s_kd.options[fm.s_kd.selectedIndex].value == '8'||
			fm.s_kd.options[fm.s_kd.selectedIndex].value == '10'||
			fm.s_kd.options[fm.s_kd.selectedIndex].value == '11'){ //관리담당자
...
<body>
<form name='form1' method='post' action='cus0401_s_sc.jsp' target='c_body'>
                ...
                <tr> 
                    <td width=19%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jhgb.gif  align=absmiddle>&nbsp; 
                      <select name="gubun1" onChange="javascript:list_move()">
                        <option value="22" <%if(gubun1.equals("22")){%>selected<%}%>>거래처관리</option>
                    ...
                    <td width=14%><img src=/acar/images/center/arrow_sbjh.gif  align=absmiddle>&nbsp; 
                      <select name="gubun3">
        				...
        				<option value="Y" <%if(gubun3.equals("Y")){%>selected<%}%>>정비</option>
        				<option value="N" <%if(gubun3.equals("N")){%>selected<%}%>>미정비</option>              
                      </select></td>
                    ...
                    <td><img src=/acar/images/center/arrow_g_gy.gif align=absmiddle>&nbsp;
                      <select name="gubun4">
        				<option value=""  <%if(gubun4.equals("")){%>selected<%}%>>선택</option>
        				<option value="5" <%if(gubun4.equals("5")){%>selected<%}%>>--진행--</option>
        				<option value="1" <%if(gubun4.equals("1")){%>selected<%}%>>렌트</option>
        				<option value="2" <%if(gubun4.equals("2")){%>selected<%}%>>리스</option>
        				<option value="3" <%if(gubun4.equals("3")){%>selected<%}%>>일반식</option>
        				<option value="4" <%if(gubun4.equals("4")){%>selected<%}%>>기본식</option>
        				<option value="6" <%if(gubun4.equals("6")){%>selected<%}%>>--해지--</option>
                      </select></td>
                </tr>
                <tr> 
                    ...
                    <td><img src=/acar/images/center/arrow_jrjg.gif  align=absmiddle>&nbsp;  
        			  ...
        			  <option value='1' <%if(sort_gubun.equals("")||sort_gubun.equals("1")){%> selected <%}%>>상호</option>
        			  <option value='0' <%if(sort_gubun.equals("0")){%> selected <%}%>>계약번호</option>
        			  <option value='2' <%if(sort_gubun.equals("2")){%> selected <%}%>>차량번호</option>
        			  <option value='3' <%if(sort_gubun.equals("3")){%> selected <%}%>>차명</option>
        			  <option value='4' <%if(sort_gubun.equals("4")){%> selected <%}%>>정비일자</option>
        			  <option value='5' <%if(sort_gubun.equals("5")){%> selected <%}%>>정비예정일자</option>
                      <option value='6' <%if(sort_gubun.equals("6")){%> selected <%}%>>최초등록일</option>
                      </select> </td>
