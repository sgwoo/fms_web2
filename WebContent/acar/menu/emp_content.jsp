							...
							<tr>
						    	<td style="font-size:15px;">
								  ...
								  <%if(a_bean.getRead_yn().equals("Y")){%>
							  		...
							  		<span style="font-size:15px; background-color:rgba(0, 51, 255, 0.81);border-radius:2px; color:white; vertical-align:top;">
								  		<span class="blink" style="font-size:11px;vertical-align:top; font-weight: bold; ">&nbsp;New&nbsp;</span>
								  	</span> 
							  		<%}else{%>
								  		<%if(a_bean.getBbs_id() == 5589){%> <!-- 조경숙 추가//2016년 회계감사 데이터 1/2일까지 NEW 유지. 1/3일에 삭제할 소스 -->
								  		<span style="font-size:15px; background-color:rgba(0, 51, 255, 0.81);border-radius:2px; color:white; vertical-align:top;">
									  		<span class="blink" style="font-size:11px;vertical-align:top; font-weight: bold; ">&nbsp;New&nbsp;</span>
									  	</span> 
								  		<%} 
   	...
   	<tr>
    	<td style="font-size:15px;">
		  ...
		  <%if(a_bean.getRead_yn().equals("Y")){//필독 처리%>
   		...
   		<%if(i==count_pan-1){%>
   		<!--<tr>
   				<td><a href="/fms2/menu/emp_content2.jsp">dddd</a>
   				</td>
   			</tr>-->
   		<%}else{%>
   				<tr>
...
<%	}%>
    	...
    	<span class="grayDate"> <%=a_bean.getReg_dt()%>&nbsp;&nbsp;</span>
		  ...
		  <%if(a_bean.getRead_yn().equals("Y")){//필독 처리%>
		  	<span style="font-size:15px; background-color:rgba(238, 34, 0, 0.81);border-radius:2px; color:white; vertical-align:middle;">
								  		<span style="font-size:11px;vertical-align:top;">&nbsp;필독&nbsp;</span></span>
		  	<!--<img src="/images/n_icon.gif" border=0 align=middle>&nbsp;--><%}%>		
			</span>
			<!-- New 처리 -->
							  		<%if(a_bean.getReg_dt().equals(AddUtil.getDate())){ %>
							  		<span style="font-size:15px; background-color:rgba(0, 51, 255, 0.81);border-radius:2px; color:white; vertical-align:top;">
...
<%			
		...
		</div><span style="color:#545454; font:12Px Nanum Gothic;font-weight:bold;">(<%=hp_var[0].getA_j()%> 기준) &nbsp;</span>
