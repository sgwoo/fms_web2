...
<body leftmargin="15">
<form name='form1' method='post' action='member_sc.jsp' target='c_foot'>
		...
		<td colspan=2>
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>고객FMS > <span class=style5>아이디관리</span></span></td>
