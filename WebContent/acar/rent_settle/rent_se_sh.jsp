...
<form name='form1' method='post' action='rent_se_sc.jsp' target='c_foot'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>예약시스템 > 재무회계 > <span class=style5>정산관리</span></span></td>
    ...
    <!--      <option value='7' <%if(gubun1.equals("7")){%>selected<%}%>>요금관리</option>-->
        ...
        <td id='td_input' align='left' style="display:''" width=15%><img src=/acar/images/center/arrow_ssjh.gif align=absmiddle>&nbsp;
            <select name='gubun2'>
        ...
        <td id='td_input' align='left' style="display:''" width=22%><img src=/acar/images/center/arrow_day_banc.gif align=absmiddle>&nbsp; 
    ...
    <tr> 
        <td align='left' colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gshm.gif align=absmiddle>&nbsp;
            <select name='s_kd'>
              ...
              <option value='5' <%if(s_kd.equals("5")){%> selected <%}%>>관리담당자</option>		  		  
            </select>
