...
<!--
	...
	function cng_input1(){
		var fm = document.form1;
		if(fm.gubun2.options[fm.gubun2.selectedIndex].value == '4' || fm.gubun2.options[fm.gubun2.selectedIndex].value == '7' || fm.gubun2.options[fm.gubun2.selectedIndex].value == '8'){ //기간
			td_dt.style.display	 = '';
		}else{
...
%>
<form name='form1' action='tax_scd_sc.jsp' target='c_body' method='post'>
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1>재무회계 > 구매자금관리 > <span class=style5>개별소비세납부확인</span></span></td>
	...
	<tr>
		<td>			
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    <td width='19%'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_jhgb.gif align=absmiddle>&nbsp;
                    ...
                    <td width='16%'><img src=../images/center/arrow_ssjh.gif align=absmiddle>&nbsp;
        ...
        <!--                <option value="1" <%if(gubun2.equals("1")){%>selected<%}%>>당월</option>
                        ...
                        <option value="4" <%if(gubun2.equals("4")){%>selected<%}%>>출고일</option>
                        <!--<option value="7" <%if(gubun2.equals("7")){%>selected<%}%>>대여개시일</option>-->
                        <option value="8" <%if(gubun2.equals("8")){%>selected<%}%>>해지일</option>				
                        <option value="5" <%if(gubun2.equals("5")){%>selected<%}%>>검색</option>
                      </select>
                    </td>
                    <td width='14%'><img src=../images/center/arrow_sbjh.gif align=absmiddle>&nbsp;
                      <select name="gubun3">
        ...
        <!--                <option value='10' <%if(s_kd.equals("10")){%> selected <%}%>>매각차량</option>				-->
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td id='td_input' <%if(s_kd.equals("8") || s_kd.equals("6")){%> style='display:none'<%}%>> 
                            <input type='text' name='t_wd' size='22' class='text' value='<%=t_wd%>' onKeyDown='javascript:enter()'>
                          </td>
                    ...
                    <td><img src=../images/center/arrow_jrjg.gif align=absmiddle>&nbsp; 
                      <select name='sort_gubun' onChange='javascript:search()'>
                        <option value='0' <%if(sort_gubun.equals("0")){%> selected <%}%>>출고일자</option>
                        <option value='2' <%if(sort_gubun.equals("2")){%> selected <%}%>>배기량</option>				
                        <!--<option value='3' <%if(sort_gubun.equals("3")){%> selected <%}%>>대여개시일</option>-->
