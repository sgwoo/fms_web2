...
<table border="1" cellspacing="0" cellpadding="0" width=1000>
  <tr> 
    <td align="center" colspan="14"><font face="돋움" size="5" ><b>용도변경에 따른 개별소비세 납부건</b> </font></td>
  </tr>
  <tr align="center"> 
    <td width='90' height="50">등록일자</td>
    <td width='90' height="50">변경일자</td>
  ...
  <%Vector taxs1 = t_db.getTaxExcelList1(br_id, gubun1, gubun2, gubun3, "3", gubun5, st_dt, end_dt, s_kd, t_wd, sort_gubun, asc, "1");
  ...
  <%}%>
  <%Vector taxs2 = t_db.getTaxExcelList1(br_id, gubun1, gubun2, gubun3, "3", gubun5, st_dt, end_dt, s_kd, t_wd, sort_gubun, asc, "2");
  ...
  <%}%>
  <%Vector taxs3 = t_db.getTaxExcelList1(br_id, gubun1, gubun2, gubun3, "3", gubun5, st_dt, end_dt, s_kd, t_wd, sort_gubun, asc, "3");
