...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr> 
        <td><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>대여료</span>
...
%>				  
                <tr> 
                    ...
                    <td align="center"><a href="javascript:parent.move_scd('0','<%=fee_list.get("RENT_MNG_ID")%>','<%=fee_list.get("RENT_L_CD")%>','','','');" title="대여료 스케줄로 이동"><%=fee_list.get("RENT_L_CD")%></a></td>
                    <td align="center"><%=fee_list.get("TM")%>회차</td>
