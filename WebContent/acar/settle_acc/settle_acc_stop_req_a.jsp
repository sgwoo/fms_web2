...
<%
	...
	String sub_id = nm_db.getWorkAuthUser("운행정지명령담당자");
	String chk_firm_nm = "";
...
//	out.println("선택건수="+vid_size+"<br><br>");
	...
	for(int i=0;i < vid_size;i++){
		...
		String title 	= "[운행정지명령신청요청]"+vid1[i]+" "+vid2[i];
		...
		//	at_db.sendMessageReserve("acar0080", fieldList, s_destphone,  sender_bean.getUser_m_tel(), null , vid1[i],  ck_acar_id);
	...
	if(vid_size>0){
		...
		String sub 		= "운행정지명령신청요청 업무협조 등록";
		String cont 	= "["+sender_bean.getUser_nm()+"]님이 운행정지명령신청요청 업무협조를 요청하셨습니다. 확인바랍니다.";
		
		String url 		= "/fms2/cooperation/cooperation_n4_frame.jsp";
