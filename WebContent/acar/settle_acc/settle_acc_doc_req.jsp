...
<!--
	function save()
	{
		...
		if(fm.title_st.value == '')		{	alert('최고장종류를 입력하십시오');	return;	}
		if(fm.doc_end_dt.value == '')	{	alert('유예기간을 입력하십시오');	fm.doc_end_dt.focus(); return;	}
		
		
		if(confirm('등록하시겠습니까?')){
			fm.action = "settle_acc_doc_req_a.jsp";	
			fm.target='i_no';
			fm.submit();
		}
	}
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1> 미수금정산관리 > <span class=style5>내용증명발송요청</span></span></td>
