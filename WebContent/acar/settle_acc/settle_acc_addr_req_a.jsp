...
<%
	...
	String target_id = nm_db.getWorkAuthUser("채무자주소조회담당자");
...
//	out.println("선택건수="+vid_size+"<br><br>");
	...
	for(int i=0;i < vid_size;i++){
		...
		String title 	= "[채무자주소조회요청]"+vid1[i]+" "+vid2[i];
	...
	if(vid_size>0){
		...
		String sub 		= "채무자주소조회요청 업무협조 등록";
		String cont 	= "["+sender_bean.getUser_nm()+"]님이 채무자주소조회요청 업무협조를 요청하셨습니다. 확인바랍니다.";
		
		String url 		= "/fms2/cooperation/cooperation_n3_frame.jsp";
