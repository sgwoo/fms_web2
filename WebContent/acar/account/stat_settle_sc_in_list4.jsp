...
<%
	...
	String per_0001 = request.getParameter("per_0001")==null?"0":request.getParameter("per_0001");
	String per_0002 = request.getParameter("per_0002")==null?"0":request.getParameter("per_0002");
...
<!--
	function view_stat_debt(save_dt){
		...
		<%if(from_page.equals("/acar/account/stat_settle_201103_sc2.jsp") || from_page.equals("/acar/account/stat_settle_201103_sc3.jsp") || from_page.equals("/acar/account/stat_settle_201503_sc4.jsp")){%>
		...
		fm.target='i_view_g';
		fm.action='stat_settle_sc_in_view_g2.jsp';		
		fm.submit();		
		
		fm.target='i_view_l';
		fm.action='stat_settle_sc_in_view_l2.jsp';		
		fm.submit();				
		<%}%>
...
<input type='hidden' name='per_0001' value='<%=per_0001%>'>
<input type='hidden' name='per_0002' value='<%=per_0002%>'>
