...
<%
	...
	if(var_cd.equals("dly2_bus3")||var_cd.equals("dly2_bus6")||var_cd.equals("dly2_bus12"))		var_sik = AddUtil.ChangeString(var_sik);
	if(var_cd.equals("dly2_bus4")||var_cd.equals("dly2_bus7")) 					var_sik = AddUtil.parseDigit3(var_sik);
...
<body>
<form name='form1' action='stat_settle_201103_sc3.jsp' method="POST" target='d_content'>
<input type="hidden" name="auth_rw" value="<%=auth_rw%>">
<input type="hidden" name="user_id" value="<%=user_id%>">
<input type="hidden" name="br_id" value="<%=br_id%>">
<input type="hidden" name="save_dt" value="<%=save_dt%>">
<input type="hidden" name="mode" value="cmp_amt_reg2_only">
</form>
