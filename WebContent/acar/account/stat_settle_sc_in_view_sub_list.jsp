...
<%
	...
	Vector vt = s_db.getStatSettleSubList(bus_id2);
	int vt_size = vt.size();
	...
	Vector vt2 = s_db.getStatSettleSubHCList(bus_id2, var1_3, var1_6);
        ...
        <td  class='line'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td width=7% class='title'>예비담당자</td>
...
%>				  
                <tr> 
                    ...
                    <td align="center" <%if(!String.valueOf(ht.get("USE_YN")).equals("Y"))%>class='is'<%%>><%=c_db.getNameById(ht.get("MNG_ID2")+"","USER")%></td>
					...
					<%if(String.valueOf(ht.get("CAR_ST")).equals("4")){%><span style="color:red;"
						>(월)</span><%}%><%if(String.valueOf(ht.get("GUBUN1")).equals("대여료")||String.valueOf(ht.get("GUBUN1")).equals("연체이자")){%><a href="javascript:view_scd('<%=ht.get("RENT_MNG_ID")%>','<%=ht.get("RENT_L_CD")%>')"
						><%=ht.get("GUBUN1")%></a>
					<%}else if(String.valueOf(ht.get("GUBUN1")).equals("과태료")){%><a href="javascript:view_fine_doc('<%=ht.get("CLIENT_ID")%>')"
						><%=ht.get("GUBUN1")%></a><%}else{%><%=ht.get("GUBUN1")%><%}%>
					</td>
                    <td align="center" <%if(!String.valueOf(ht.get("USE_YN")).equals("Y"))%>class='is'<%%>><%=ht.get("GUBUN2")%></td>
...
<%	} %>		 
    ...
    <tr>
		...
		<!--
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 휴/대차료 - 청구시:청구일부터 5일간 경감반영, 입금시:입금일부터 10일간 경감반영<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 휴/대차료 - 청구후 미입금시:청구일부터 2개월후 1개월까지 청구금액의 10% 연체반영<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 경락손해 - 입금시:입금일부터 10일간 경감반영<br>
		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 휴/대차료 - 청구시:청구일부터 1개월간 청구금액의 1군10%/2군5% 경감반영<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 휴/대차료 - 청구후 미입금시:청구일부터 2개월후 1달간 청구금액의 1군10%/2군5% 연체반영<br>	
		-->
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 휴/대차료 - 입금시:입금일부터 1개월간 입금금액의 1군50%/2군25% 경감반영<br>
	<!--	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 휴/대차료 - 청구후 미입금시:청구일부터 2개월후 1달간 청구금액의 1군10%/2군5% 연체반영<br>	-->	
			
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 해지정산금 - 보증보험청구분 경감, 100만원이하 100%, 100만원초과시 100만원+초과20% 반영<br>			
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 대여료 미청구분 - 계약만료일 3일 경과부터 반영
		</td>
    </tr>	
    <!--
    <tr>
        <td>※ 휴/대차료, 경락손해는 캠페인 마감일에는 평균연체율에만 적용</td>
    </tr>	
    -->
	<%if(vt_size2>0){%>	
    <tr>
        ...
        <td  class='line'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td width=9% class='title'>경감금액</td>
					<td width=4% class='title'>통화</td>
...
<%				for (int i = 0 ; i < vt_size2 ; i++){
                ...
                <tr> 
                    ...
                    <td align="center"><a href="javascript:view_client('<%=ht.get("RENT_MNG_ID")%>','<%=ht.get("RENT_L_CD")%>');" title=""><%=ht.get("RENT_L_CD")%></a></td>
                    ...
                    <td align="right" ><%=Util.parseDecimal(String.valueOf(ht.get("DLY_AMT")))%>                        
                    </td>
                    <td align="right" ></td>		
		    <td align="right" ></td>	
                </tr>			
