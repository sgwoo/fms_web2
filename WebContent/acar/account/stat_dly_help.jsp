...
<%
	...
	EstiSikVarBean [] ea_r = e_db.getEstiSikVarList("dly1_bus");
...
<form action="./stat_dly_help_null.jsp" name="form1" method="POST">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 캠페인관리 > 채권관리캠페인(1군) > <span class=style5>사원별연체현황 채권관리보너스 계산식 변수</span></span></td>
    ...
    <tr>
        <td class=line>                    
		  ...
		  for(int i=0; i<size; i++){
			...
			if(bean.getVar_cd().equals("dly1_bus3")||bean.getVar_cd().equals("dly1_bus6")||bean.getVar_cd().equals("dly1_bus12")||bean.getVar_cd().equals("dly1_bus13")) 	var_sik = AddUtil.ChangeDate2(var_sik);
			if(bean.getVar_cd().equals("dly1_bus4")||bean.getVar_cd().equals("dly1_bus7")||bean.getVar_cd().equals("dly1_bus14"))						var_sik = AddUtil.parseDecimal2(var_sik);
			cnt++;
			%>
                <tr> 
