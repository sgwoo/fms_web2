...
%>
<form name='form1' action='forfeit_sc.jsp' target='c_foot' method='post'>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp; <span class=style1><span class=style5>과태료</span></span></td>
                ...
                <tr> 
                    ...
                    <td width=410> 
                          <select name="gubun4">
                            ...
                            <option value="9" <%if(gubun4.equals("9")){%>selected<%}%>>외부업체과실</option>
                ...
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp;
                          <select name='s_kd' onChange="javascript:document.form1.t_wd.value='', cng_input()">
							...
							<option value='16' <%if(s_kd.equals("16")){%> selected <%}%>>업무과실자</option>
							<option value='17' <%if(s_kd.equals("17")){%> selected <%}%>>대납일자</option>
                          </select>
                    </td>
                    <td> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
