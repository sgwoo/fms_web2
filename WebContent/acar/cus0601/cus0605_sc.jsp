...
function view_detail(off_id, off_nm){
	<%if(from_page.equals("/fms2/tint/tint_reg_step1.jsp")){%>
	...
	<%}else{%>
		...
		parent.location.href = "cus0605_d_frame.jsp"+url+"&off_id="+off_id;
	<%}%>
}
...
<form name="form1" action="" method="post">
    <tr> 
      <td><iframe src="cus0605_sc_in.jsp?auth_rw=<%=auth_rw%>&s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&sort_gubun=<%=sort_gubun%>&sort=<%=sort%>&from_page=<%=from_page%>" name="serv_offList" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
    </tr>
