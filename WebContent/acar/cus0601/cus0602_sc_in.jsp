...
<%if(c61_soBns.length !=0 ){%>
              ...
              <% for(int i=0; i< c61_soBns.length; i++){
					...
					if(from_page.equals("/fms2/consignment_new/cons_i_c.jsp") && (c61_soBn.getOff_nm().equals("코리아탁송")))	continue;
					
					if(from_page.equals("/fms2/car_pur/reg_cons.jsp") || from_page.equals("/fms2/car_pur/pur_doc_i.jsp")){
						if(!c61_soBn.getOff_st().equals("9")) 	continue;
					}
	...
	%>
                <tr>
                    <td width='10%' align='center' ><%=AddUtil.ChangeEnt_no(c61_soBn.getEnt_no())%></td>
                    <td width='10%' align='center'><span title="<%= c61_soBn.getOff_sta() %>"><%=AddUtil.subData(c61_soBn.getOff_sta(),5)%></span></td>
