...
<input type='hidden' name='sh_height' value='<%=sh_height%>'> 
  <tr>
      <td><img src=../images/center/icon_arrow.gif align=absmiddle> <span class=style2>납품 내역</span></td>
  </tr>
  <tr> 
      <td><table border="0" cellspacing="1" cellpadding="0" width=100%>
          <tr> 
            <td width="150">&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_gsjg.gif align=absmiddle>
              <select name='s_kd'>
                <option value="0" selected>전체</option>
                <option value="2">납품구분</option>
            ...
            <td width="150">&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_jrjg.gif align=absmiddle>
            ...
            <td width="165"> <input type='radio' name='sort' value='asc' checked onClick='javascript:search()'>
              ...
              내림차순 </td>
            <td width="200"><img src=../images/center/arrow_gjnw.gif align=absmiddle> 
              <select name='year'>
