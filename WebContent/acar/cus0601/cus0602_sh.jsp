...
function serv_off_reg(){
	var SUBWIN="cus0602_d_cont_i.jsp?auth_rw=<%= auth_rw %>&from_page=<%= from_page %>&off_type=2";
...
<body>
<form name='form1' method='post' action='cus0602_sc.jsp' target='c_body'>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 업체정보관리 > <span class=style5>탁송업체관리</span></span></td>
            ...
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    <td width="100%">&nbsp;
                    	...
                    	<img src=../images/center/arrow_jrjg.gif align=absmiddle>
                    	...
                    	<input type='radio' name='sort' value='asc' <% if(sort.equals("asc")||sort.equals("")){ %>checked<% } %> onClick='javascript:search()'>
                      	오름차순 
