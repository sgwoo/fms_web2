...
function serv_off_reg(){
	var SUBWIN="cus0605_d_cont_i.jsp?auth_rw=<%= auth_rw %>?from_page=<%= from_page %>?off_type=5";
...
<body>
<form name='form1' method='post' action='cus0605_sc.jsp' target='c_body'>
    ...
    <tr> 
        <td>
            <table border="0" cellspacing="1" cellpadding="0" width=1200>
                <tr> 
                    <td width="180">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_gsjg.gif align=absmiddle>
                      &nbsp;<select name='s_kd'>
                    ...
                    <td width="180">&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_jrjg.gif align=absmiddle>
                    ...
                    <td width="165"> <input type='radio' name='sort' value='asc' <% if(sort.equals("asc")||sort.equals("")){ %>checked<% } %> onClick='javascript:search()'>
                      ...
                      내림차순 </td>
                    <%-- <td width="160" align='left'><img src=../images/center/arrow_yus.gif align=absmiddle>
        			<select name='br_id'>
        			...
        			<td>
        				<a href='javascript:search()' onMouseOver="window.status=''; return true"><img src=../images/center/button_search.gif align=absmiddle border=0></a>
        			</td>
                    <td align='right'>                    	
                    	<a href='javascript:serv_off_reg()' onMouseOver="window.status=''; return true"><img src=../images/center/button_reg.gif align=absmiddle border=0></a>
                    </td>
                </tr>
            </table>
        </td>
