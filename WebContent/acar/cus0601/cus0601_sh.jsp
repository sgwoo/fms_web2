...
function serv_off_reg(){
	var SUBWIN="cus0601_d_cont_i.jsp?auth_rw=<%= auth_rw %>";
...
<body>
<form name='form1' method='post' action='cus0601_sc.jsp' target='c_body'>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 업체정보관리 > <span class=style5>정비업체관리</span></span></td>
    ...
    <tr> 
        <td>
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
			    <tr>
				    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;지정업체 : 
					  <select name="gubun1" >
                            ...
                            <option value='0041'>스피드메이트</option>
							<option value='0043'>애니카랜드</option>
                      </select>
				    </td>
                    <td align='left'><img src=../images/center/arrow_yus.gif align=absmiddle>
            			&nbsp;<select name='br_id'>
            				<option value=''>전체</option>
            				<%	if(brch_size > 0){
                ...
                <tr> 
                    <td width=16%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_gsjg.gif align=absmiddle>&nbsp;
                      <select name='s_kd'>
                        <option value="1" <% if(s_kd.equals("1")){ %>selected<% } %>>상호</option>
                  <!--      <option value="2" <% if(s_kd.equals("2")){ %>selected<% } %>>지정업체</option> -->
                        <option value="3" <% if(s_kd.equals("3")){ %>selected<% } %>>등급</option>
                        ...
                        <option value="9" <% if(s_kd.equals("9")){ %>selected<% } %>>사무실전화</option>
                        <option value="10" <% if(s_kd.equals("10")){ %>selected<% } %>>팩스</option>
                      </select></td>
                    ...
                    <td width=14%><img src=../images/center/arrow_jrjg.gif align=absmiddle>&nbsp;
                      <select name='sort_gubun'>
                        ...
                        <option value="4" <% if(sort_gubun.equals("4")){ %>selected<% } %>>거래개시일</option>
                        <option value="5" <% if(sort_gubun.equals("5")){ %>selected<% } %>>정비건수</option>
                      </select> </td>
                    <td width=16%><input type='radio' name='sort' value='asc' <% if(sort.equals("asc")||sort.equals("")){ %>checked<% } %> onClick='javascript:search()'>
                      오름차순 
