...
<%
	...
	String save_file = request.getParameter("save_file")==null?"":request.getParameter("save_file");
...
<!--
	...
	function search_dc(){
		var fm = document.form1;
		window.open("/fms2/lc_rent/search_dc.jsp?rent_mng_id="+fm.rent_mng_id.value+"&rent_l_cd="+fm.rent_l_cd.value, "COMP_DC", "left=100, top=100, height=200, width=800, scrollbars=yes, status=yes");
	}
...
<form action="register_pur_id_tax_a.jsp" name="form1" method="POST" >
  ...
  <input type='hidden' name="save_folder"	value="<%=save_folder%>">

<table border=0 cellspacing=0 cellpadding=0 width=100%>
    <tr>
        <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>자동차출고 매입세금계산서 점검처리</span></td>
    </tr>
    <tR>
        <td class=line2></td>
    </tr>
        ...
        <td class=line>
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    ...
                    <td colspan="4">&nbsp;<input type="text" name="dlv_dt" value="<%=AddUtil.ChangeDate2(base.getDlv_dt())%>" size="11" maxlength='10' class=whitetext onBlur='javascript:this.value=ChangeDate(this.value);'>
        			(계출번호 : <%=pur.getRpt_no()%>)
        			</td>
                </tr>
                <tr>
...
<%	if(!cmd.equals("ud") && !auth_rw.equals("1")){//보기%>
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    <tr>
...
<%	}%>
<table width='690.0' border="0" cellpadding="0" cellspacing="0" class="a4">
	<tr valign="top">
		<td>
					<img src="https://fms3.amazoncar.co.kr<%=save_folder%><%=save_file%>" width=690.0 height=1009.0><br style="page-break-before:always;">
		</td>
	</tr>
</table>			
</form>
