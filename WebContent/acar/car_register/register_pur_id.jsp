...
<%
	...
	String contentSeq = "" + rent_mng_id + rent_l_cd + "%";
        ...
        <td class=line>
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    ...
                    <td colspan="4">&nbsp;<input type="text" name="dlv_dt" value="<%=AddUtil.ChangeDate2(base.getDlv_dt())%>" size="11" maxlength='10' class=<%if(cmd.equals("ud")){%>white<%}%>text onBlur='javascript:this.value=ChangeDate(this.value);'>
        			(계출번호 : <%=pur.getRpt_no()%>)
        			</td>
                </tr>
                <tr>
...
<table width='690.0' border="0" cellpadding="0" cellspacing="0" class="a4">
	<tr valign="top">
		<td>
					<img src="https://fms3.amazoncar.co.kr<%=ht2.get("SAVE_FOLDER")%><%=ht2.get("SAVE_FILE")%>" width=690.0 height=1009.0><br style="page-break-before:always;">
		</td>
	</tr>
</table>	                            
