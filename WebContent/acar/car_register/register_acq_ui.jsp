...
<%
	...
	String acq_amt_card = request.getParameter("acq_amt_card")==null?"N":request.getParameter("acq_amt_card");
	
//	System.out.println("jsp acq_amt_card=" +  acq_amt_card);
	...
	if(cmd.equals("u")){
		...
		//System.out.println("> acq_acq : " + acq_acq);
		...
		cr_bean.setAcq_amt_card	(acq_amt_card);	//취득세카드결재여부
...
<form action="./register_main_i.jsp" name="form2" method="post">
