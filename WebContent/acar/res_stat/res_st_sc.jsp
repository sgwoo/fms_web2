...
<!--
	...
	function reserve_action(mode, s_cd, c_id, car_no, firm_nm, client_nm){
		...
		if(mode == 'N'){
			...
			window.open("/acar/rent_mng/res_action.jsp?auth_rw="+fm.auth_rw.value+"&user_id="+fm.user_id.value+"&br_id="+fm.br_id.value+"&mode="+mode+"&s_cd="+s_cd+"&c_id="+c_id, "ACTION", "left=100, top=100, width=900, height=550, status=no");
		}else{
			window.open("res_action.jsp?auth_rw="+fm.auth_rw.value+"&user_id="+fm.user_id.value+"&br_id="+fm.br_id.value+"&mode="+mode+"&s_cd="+s_cd+"&c_id="+c_id, "ACTION", "left=100, top=100, width=900, height=850, status=no");
		}
	}	
//-->
</script>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
	  <td><font color='green'>* 배차예정일시로 부터 <b>24시간이 경과</b>되는 시점에 자동취소되니 업무에 참고하십시오. 재리스/월렌트 계약상담인 장기대기는 <b>상담유효기간 경과</b>후 자동취소됩니다.</font></td>
	</tr>
</table>
</form>
