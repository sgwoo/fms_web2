...
<%
	...
	int result_cnt = request.getParameter("result_cnt")==null?0:AddUtil.parseInt(request.getParameter("result_cnt"));//실제데이타있는행수
	
	if(String.valueOf(request.getParameterValues("result")).equals("") || String.valueOf(request.getParameterValues("result")).equals("null")){
		out.println("처리건이 없습니다.");
		return;
	}	
...
<%	if(result.length>0){
        ...
        <tr>
          ...
          <td align="center"><%=car_mng_id[i] ==null?"":car_mng_id[i]%></td>
