...
<%
	...
	from_page = "/acar/stat_month/campaign2014_5_sc1.jsp";
	...
	if(o_cs_dt.equals(cs_dt) && o_ce_dt.equals(ce_dt)){
		...
		result 	= cmp_db.updateCampaignVar_20140501(year, tm, "1_1", cs_dt, ce_dt, bs_dt, be_dt, up_per, down_per, amt_per, car_amt, max_dalsung, ga, new_ga, ns_dt1, ns_dt2, ns_dt3, ns_dt4, ne_dt1, ne_dt2, ne_dt3, ne_dt4, n_cnt1, n_cnt2, n_cnt3, n_cnt4, cnt_per, cost_per, base_end_dt1, base_end_dt2, min_dalsung);
	...
	//등록	
		...
		result 	= cmp_db.insertCampaignVar_20140501(year, tm, "1_1", cs_dt, ce_dt, bs_dt, be_dt, up_per, down_per, amt_per, car_amt, max_dalsung, ga, new_ga, ns_dt1, ns_dt2, ns_dt3, ns_dt4, ne_dt1, ne_dt2, ne_dt3, ne_dt4, n_cnt1, n_cnt2, n_cnt3, n_cnt4, cnt_per, cost_per, base_end_dt1, base_end_dt2, min_dalsung);
