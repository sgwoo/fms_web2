...
<!--
	...
	function Search(){
		...
		if(fm.gubun.value == '6')		i_fm.action='stat_bus_sc_in_view5.jsp';										
		i_fm.submit();				
	}
...
<table border=0 cellspacing=0 cellpadding=0 width="100%">
    	...
    	<td >
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > <span class=style5>사원별영업구분 계약현황</span></span></td>
    ...
    <tr> 
        <td><iframe src="./stat_bus_sc_in_view5.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&s_yy=<%=s_yy%>&s_mm=<%=s_mm%>&brch_id=<%=brch_id%>" name="i_view" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
        </td>
    </tr>
</table>
</form>
