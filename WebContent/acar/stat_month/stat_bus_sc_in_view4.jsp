...
<%
	...
	Vector buss = sb_db.getStatBusSearch_20140101(gubun, gubun2, brch_id, s_yy, s_mm, "all");
...
<table border="0" cellspacing="0" cellpadding="0" width=1886>
    <tr>
        <td class=line2 colspan=2></td>
    </tr>
    <tr id='tr_title' style='position:relative;z-index:1'>
	    <td class=line width='336' id='td_title' style='position:relative;'> 
	        <table width='336' border="0" cellspacing="1" cellpadding="0">
                <tr> 
                    <td width="110" class=title>부서</td>
	    ...
	    <td class=line>
	        <table width='1550' border="0" cellspacing="1" cellpadding="0">
                <tr> 
                    ...
                    <td colspan="6" class=title>합계(영업사원有)</td>					
                ...
                <tr> 
                    <td width="50" class=title>신규</td>
                    <td width="50" class=title>대차</td>
                    <td width="50" class=title>증차</td>
                    <td width="50" class=title>연장</td>
                    <td width="50" class=title>보유차</td>
    ...
    <tr>
	    <td class='line' width='336' id='td_con' style='position:relative;'> 
	        <table border="0" cellspacing="1" cellpadding="0" width='336'>
  		...
  		<%		    if (!b_nm2.equals( ht.get("NM1"))) {           	%> 			
  				<tr> 
  		   			<td class=is align="center" width="110" height="20" rowspan='2'><%=b_nm2%></td>		
  		...
  		<%		    if (!b_nm.equals( ht.get("NM"))) {           	%> 			
			...
			<% 
   			...
   			%>  
                ...
                <tr> 
                    <td align="center" width="110" height="20"><%=ht.get("NM1")%></td>
                    <td align="center" width="32" height="20"><%=i+1%></td>
                    <td align="center" width="67" height="20"><a href="javascript:stat_search('d','<%=ht.get("USER_NM")%>');" onMouseOver="window.status=''; return true"><font color="#0000FF"><%=ht.get("USER_NM")%></font></a></td>
	    ...
	    <td class='line' width='1550'>
          ...
          <%		tot_cnt[0] = 0;
  			...
  			<%	    if (!b_nm2.equals( ht.get("NM1"))) {
  		       	%> 
           		   <tr> 
                    <td class=is align="center" height="20" width="50"><%=cnt01[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt02[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt03[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt04[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt05[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=tot_cnt[6]%></td>		
                    <td class=is align="center" height="20" width="50"><%=e_cnt01[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=e_cnt02[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=e_cnt03[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=e_cnt04[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=e_cnt05[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=e_tot_cnt[6]%></td>		
                    <td class=is align="center" height="20" width="50"><%=cnt11[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt12[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt13[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt14[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt15[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt10[6]%></td>		
                    <!-- 
                    <td class=title align="center" height="20" width="50"><%//=cnt21[6]%>+</td>
                    <td class=title align="center" height="20" width="50"><%//=cnt22[6]%>+</td>
                    <td class=title align="center" height="20" width="50"><%//=cnt23[6]%>+</td>
                    <td class=title align="center" height="20" width="50"><%//=cnt24[6]%>+</td>
                    <td class=title align="center" height="20" width="50"><%//=cnt25[6]%>+</td>
                    <td class=title align="center" height="20" width="50"><%//=cnt20[6]%>+</td>		
                    -->
                    <td class=is align="center" height="20" width="50"><%=cnt31[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt32[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt33[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt34[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt35[6]%></td>
                    <td class=is align="center" height="20" width="50"><%=cnt30[6]%></td>		
                    <td class=is align="center" height="20" width="50"><%=c_cnt[6]%></td>																																				
                </tr>                
                    ...
                    <td class=is align="center" height="20" width="50"><%if(cnt04[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt04[6]))/b_cnt2,1)%><%}else{%><%=cnt04[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(cnt05[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt05[6]))/b_cnt2,1)%><%}else{%><%=cnt05[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(tot_cnt[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(tot_cnt[6]))/b_cnt2,1)%><%}else{%><%=tot_cnt[6]%><%}%></td>		
                    <td class=is align="center" height="20" width="50"><%if(e_cnt01[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt01[6]))/b_cnt2,1)%><%}else{%><%=e_cnt01[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(e_cnt02[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt02[6]))/b_cnt2,1)%><%}else{%><%=e_cnt02[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(e_cnt03[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt03[6]))/b_cnt2,1)%><%}else{%><%=e_cnt03[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(e_cnt04[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt04[6]))/b_cnt2,1)%><%}else{%><%=e_cnt04[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(e_cnt05[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt05[6]))/b_cnt2,1)%><%}else{%><%=e_cnt05[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(e_tot_cnt[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_tot_cnt[6]))/b_cnt2,1)%><%}else{%><%=e_tot_cnt[6]%><%}%></td>		
                    ...
                    <td class=is align="center" height="20" width="50"><%if(cnt14[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt14[6]))/b_cnt2,1)%><%}else{%><%=cnt14[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(cnt15[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt15[6]))/b_cnt2,1)%><%}else{%><%=cnt15[6]%><%}%></td>
                    ...
                    <td class=is align="center" height="20" width="50"><%if(cnt34[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt34[6]))/b_cnt2,1)%><%}else{%><%=cnt34[6]%><%}%></td>
                    <td class=is align="center" height="20" width="50"><%if(cnt35[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt35[6]))/b_cnt2,1)%><%}else{%><%=cnt35[6]%><%}%></td>
			...
			<% 
  			...
  			<%	    if (!b_nm.equals( ht.get("NM"))) {
                    ...
                    <td class=title align="center" height="20" width="50"><%=cnt04[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=cnt05[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=tot_cnt[0]%></td>		
                    <td class=title align="center" height="20" width="50"><%=e_cnt01[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=e_cnt02[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=e_cnt03[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=e_cnt04[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=e_cnt05[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=e_tot_cnt[0]%></td>		
                    ...
                    <td class=title align="center" height="20" width="50"><%=cnt14[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=cnt15[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=cnt10[0]%></td>		
                    <!-- <td class=title align="center" height="20" width="50"><%=cnt21[0]%>+</td>
                    <td class=title align="center" height="20" width="50"><%=cnt22[0]%>+</td>
                    <td class=title align="center" height="20" width="50"><%=cnt23[0]%>+</td>
                    <td class=title align="center" height="20" width="50"><%=cnt24[0]%>+</td>
                    <td class=title align="center" height="20" width="50"><%=cnt25[0]%>+</td>
                    <td class=title align="center" height="20" width="50"><%=cnt20[0]%>+</td>		-->
                    ...
                    <td class=title align="center" height="20" width="50"><%=cnt34[0]%></td>
                    <td class=title align="center" height="20" width="50"><%=cnt35[0]%></td>
			...
			<% 
   			...
   			%>     			
                ...
                <tr> 
                    ...
                    <td  align="center" height="20" width="50"><%=ht.get("CNT04")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT05")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("TOT_CNT")%></td>		
                    <td  align="center" height="20" width="50"><%=ht.get("E_CNT01")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("E_CNT02")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("E_CNT03")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("E_CNT04")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("E_CNT05")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("E_TOT_CNT")%></td>		
                    ...
                    <td  align="center" height="20" width="50"><%=ht.get("CNT14")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT15")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT10")%></td>																		
                    <!-- <td  align="center" height="20" width="50"><%=ht.get("CNT21")%>@</td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT22")%>@</td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT23")%>@</td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT24")%>@</td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT25")%>@</td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT20")%>@</td> -->
                    ...
                    <td  align="center" height="20" width="50"><%=ht.get("CNT34")%></td>
                    <td  align="center" height="20" width="50"><%=ht.get("CNT35")%></td>
        ...
        <% } %> 
              ...
              <%    if (b_nm.equals("에이전트")) {     %>     
                  <tr> 
                    <td class=title align="center" height="20" width="50"><%if(cnt01[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt01[6]))/b_cnt2,1)%><%}else{%><%=cnt01[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt02[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt02[6]))/b_cnt2,1)%><%}else{%><%=cnt02[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt03[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt03[6]))/b_cnt2,1)%><%}else{%><%=cnt03[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt04[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt04[6]))/b_cnt2,1)%><%}else{%><%=cnt04[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt05[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt05[6]))/b_cnt2,1)%><%}else{%><%=cnt05[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(tot_cnt[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(tot_cnt[6]))/b_cnt2,1)%><%}else{%><%=tot_cnt[6]%><%}%></td>		
                    <td class=title align="center" height="20" width="50"><%if(e_cnt01[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt01[6]))/b_cnt2,1)%><%}else{%><%=e_cnt01[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(e_cnt02[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt02[6]))/b_cnt2,1)%><%}else{%><%=e_cnt02[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(e_cnt03[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt03[6]))/b_cnt2,1)%><%}else{%><%=e_cnt03[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(e_cnt04[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt04[6]))/b_cnt2,1)%><%}else{%><%=e_cnt04[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(e_cnt05[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_cnt05[6]))/b_cnt2,1)%><%}else{%><%=e_cnt05[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(e_tot_cnt[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(e_tot_cnt[6]))/b_cnt2,1)%><%}else{%><%=e_tot_cnt[6]%><%}%></td>		
                    <td class=title align="center" height="20" width="50"><%if(cnt11[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt11[6]))/b_cnt2,1)%><%}else{%><%=cnt11[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt12[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt12[6]))/b_cnt2,1)%><%}else{%><%=cnt12[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt13[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt13[6]))/b_cnt2,1)%><%}else{%><%=cnt13[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt14[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt14[6]))/b_cnt2,1)%><%}else{%><%=cnt14[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt15[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt15[6]))/b_cnt2,1)%><%}else{%><%=cnt15[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt10[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt10[6]))/b_cnt2,1)%><%}else{%><%=cnt10[6]%><%}%></td>		
                    <td class=title align="center" height="20" width="50"><%if(cnt31[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt31[6]))/b_cnt2,1)%><%}else{%><%=cnt31[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt32[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt32[6]))/b_cnt2,1)%><%}else{%><%=cnt32[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt33[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt33[6]))/b_cnt2,1)%><%}else{%><%=cnt33[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt34[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt34[6]))/b_cnt2,1)%><%}else{%><%=cnt34[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt35[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt35[6]))/b_cnt2,1)%><%}else{%><%=cnt35[6]%><%}%></td>
                    <td class=title align="center" height="20" width="50"><%if(cnt30[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(cnt30[6]))/b_cnt2,1)%><%}else{%><%=cnt30[6]%><%}%></td>		
                    <td class=title align="center" height="20" width="50"><%if(c_cnt[6]>0 && b_cnt2>0){%><%=AddUtil.parseFloatCipher(AddUtil.parseFloat(String.valueOf(c_cnt[6]))/b_cnt2,1)%><%}else{%><%=c_cnt[6]%><%}%></td>																																				
                </tr>
                ...
                <tr> 
                    ...
                    <td class=title_p align="center" height="20" width="50"><%=cnt04[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt05[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=tot_cnt[1]%></td>		
                    <td class=title_p align="center" height="20" width="50"><%=e_cnt01[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=e_cnt02[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=e_cnt03[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=e_cnt04[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=e_cnt05[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=e_tot_cnt[1]%></td>		
                    ...
                    <td class=title_p align="center" height="20" width="50"><%=cnt14[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt15[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt10[1]%></td>		
                    <!-- <td class=title_p align="center" height="20" width="50"><%=cnt21[1]%>*</td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt22[1]%>*</td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt23[1]%>*</td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt24[1]%>*</td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt25[1]%>*</td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt20[1]%>*</td>		-->
                    ...
                    <td class=title_p align="center" height="20" width="50"><%=cnt34[1]%></td>
                    <td class=title_p align="center" height="20" width="50"><%=cnt35[1]%></td>
