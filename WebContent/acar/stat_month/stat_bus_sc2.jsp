...
<table border=0 cellspacing=0 cellpadding=0 width="100%">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > <span class=style5>사원별당월영업현황</span></span></td>
    ...
    <tr> 
      <td>     
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_dygsi.gif align=absmiddle>
        ...
        <input type="text" name="s_mm" size="11" value="<%=AddUtil.ChangeDate2(s_mm)%>" class=text onBlur='javascript:this.value=ChangeDate(this.value)'>
            &nbsp;
             <select name='gubun2'>
                    ...
                    <option value='0' <%if(gubun2.equals("0")){%> selected <%}%>>재리스</option>                    
                  </select>
    ...
    <tr> 
      <td><iframe src="./stat_bus_sc_in_view4.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&s_yy=<%=s_yy%>&s_mm=<%=s_mm%>&brch_id=<%=brch_id%>&gubun2=<%=gubun2%>" name="i_view" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
      </td>
    </tr>
  </table>
</form>
