...
<%
	...
	Vector vt = cmp_db.getStatBusCmpBaseBusList_2019_05(bus_id, "c", bs_dt, be_dt, cs_dt, ce_dt);
  ...
  <tr> 
    <td width="100%" class="line">
      <table width="100%" border="0" cellspacing="1" cellpadding="0">
        <tr> 
          ...
          <td width="150" class="title">영업사원</td>		  		  
	...
	%>
        <tr> 
          ...
          <td align="center"><%//= ht.get("BUS_EMP_ID_YN") %>
          	<%if(String.valueOf(ht.get("BUS_EMP_ID_YN")).equals("있음")){%>
	...
	%>
        ...
        <%	}else{	 %>
        <tr> 
          <td colspan="17"><div align="center">해당 데이터가 없습니다.</div></td>
        </tr>
        <% 	} %>				
            </table>
    </td>
...
<p>
  ...
  ♣ 유효실적
  <br> 
  &nbsp;&nbsp;&nbsp;- 신차 : 영업사원이 있으면 1대, 자체영업 2대, 전기 +1대, 수소 +1대, 신규는 +0.5대(신규 다수시 1대만 증가), 인수거절차량 +2대 <!-- 20220330 플러그하이브리드 +1대 제외,  전기 +2대->+1대 변경, 수소 +1대 추가  -->
  <br> 
  ...
  <br> 
  &nbsp;&nbsp;&nbsp;※ 한 명의 영업사원(타사 에이전트 포함)을 통해서 한 캠페인동안 6대 이상 대여개시할 경우 6대째부터 최종 적용대수의 최대값은 1.5대
  <br>
  </font>    
</p>
</body>
