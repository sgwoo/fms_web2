...
<%
	...
	if(!as_db.insertClsAllot(cls))	flag += 1;
	
	//할부스케줄 생성 및 정리
	if(!as_db.updateScdAllot(cls, alt_tm))	flag += 1;
		
	//할부스케줄 잔액 재계산 20210721
	String  d_flag1 =  as_db.call_sp_bank_scd_rest(car_id, "0", alt_tm);
%>
