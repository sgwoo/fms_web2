...
<!--
	...
	function SMenuReg(){
		...
		theForm.cmd.value = "i";
		theForm.action="s_menu_null_ui.jsp";
		theForm.target="i_no";
		theForm.submit();
	}
...
function CheckField()
{
	...
	function set_user_auth(m_cd){
		...
		fm.action = 's_menu_user_auth.jsp?m_st='+fm.m_st.value+'&m_st2='+fm.m_st2.value+'&m_cd='+m_cd;
		fm.target = '_blank';
		fm.submit();
	}
	...
	function set_user_auth_agent(m_cd){
		var fm = document.SMenuForm;
		fm.action = 's_menu_user_auth_agent.jsp?m_st='+fm.m_st.value+'&m_st2='+fm.m_st2.value+'&m_cd='+m_cd;
		fm.target = '_blank';
		fm.submit();
	}
	...
	function set_user_auth_out(m_cd){
		var fm = document.SMenuForm;
		fm.action = 's_menu_user_auth_out.jsp?m_st='+fm.m_st.value+'&m_st2='+fm.m_st2.value+'&m_cd='+m_cd;
		fm.target = '_blank';
		fm.submit();
	}
        ...
        <td class=line>
            <table border="0" cellspacing="1" cellpadding="0" width="100%">
                <tr>
                    ...
                    <td width="15%" class=title>소메뉴</td>
                    <td width="25%" class=title>URL</td>
