...
<%
	...
	UsersBean user_r [] = umd.getUserAuthAll("", "agent", "",m_st,m_st2,m_cd);
	
	MaMenuBean m_bean = nm_db.getMenuCase(m_st,m_st2,m_cd);
%>
<html>
<head>
...
<form action="./s_menu_user_auth_a.jsp" name="AuthForm" method="POST" >
