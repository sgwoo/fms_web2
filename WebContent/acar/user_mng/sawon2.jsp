...
<%
	...
	String dept_id[] = new String[16];
	
	dept_id[0] = "0004";	//임원
	dept_id[1] = "0001";	//영업팀
	dept_id[2] = "0002";	//고객지원팀
	dept_id[3] = "0003";	//총무팀
	dept_id[4] = "0009";	//강남지점	
	dept_id[5] = "0012";	//인천지점
	dept_id[6] = "0013";	//수원지점
	...
	dept_id[8] = "0008";	//대전지점	
	dept_id[9] = "0010";	//광주지점
	dept_id[10] = "0011";	//대구지점
	dept_id[11] = "0014";	//강서지점
	dept_id[12] = "0015";	//구로지점
	dept_id[13] = "0016";	//울산지점
	dept_id[14] = "0017";	//광화문지점
	dept_id[15] = "0018";	//송파지점
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1><span class=style5>아마존카 직원 연락망</span></span></td>
                                        ...
                                        <tr>
                                            <td width=103 align=center>
                                                <table width=87  border=0 cellpadding=0 cellspacing=1 bgcolor=cfcfcf>
                                                    <tr>
                                                        <td bgcolor=#FFFFFF><img src="https://fms3.amazoncar.co.kr/images/charge/<%=ht1.get("FILENAME")%>.gif" width=85 height=105></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td>
                                    ...
                                    <table width=100%  border=0 cellpadding=0 cellspacing=0>
                                        <tr>
                                            <td width=103 align=center>
                                                <table width=87  border=0 cellpadding=0 cellspacing=1 bgcolor=cfcfcf>
                                                    <tr>
                                                        <td bgcolor=#FFFFFF><img src="https://fms3.amazoncar.co.kr/images/charge/<%=ht2.get("FILENAME")%>.gif" width=85 height=105></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td>
