...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Master > <span class=style5>사용자관리</span></span></td>
	...
	<form action="./user_mng_sc.jsp" name="UserSearchForm" method="POST" >
    <tr>
        <td>
