...
<DIV id=Layer1 style="Z-INDEX: 1; LEFT: 540px; WIDTH: 68px; POSITION: absolute; TOP: <%=table1_h+table2_h+table3_h+height-200%>px; HEIGHT: 68px"><IMG src="../../images/gikin.gif" width="110" height="110"></DIV>  
</body>
</html>
