...
//	String s_year = request.getParameter("s_year")==null?"":request.getParameter("s_year");
	...
	//Hashtable ht = rs_db.getStatCar3(br_id, brch_id, gubun2);
...
<!--
	...
	function off_ls_action(mode){
		...
		fm.submit();
		<%}else{%>
		alert("귀하는 매각결정처리를 하실 권한이 없습니다. 매각결정처리 권한은  고개지원팀장님만 있습니다.");
		return;
		<%}%>
	}	
//-->
    ...
    <tr> 
        <td class='line' colspan="2"> 
            <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                ...
                <tr align="center"> 
                    <td class='title'>상태</td>                
                    <td><input type='text' name='m_rent_1' size='5' class='whitenum' value="0" readonly><!--월렌트--></td>
                    <td><input type='text' name='d_rent_1' size='5' class='whitenum' value="0" readonly><!--단기대여--></td>
                    <td><input type='text' name='b_rent_1' size='5' class='whitenum' value="0" readonly><!--보험대차--></td>
                    <td><input type='text' name='g_rent_1' size='5' class='whitenum' value="0" readonly><!--지연대차--></td>
                    <td><input type='text' name='j_rent_1' size='5' class='whitenum' value="0" readonly><!--정비대차--></td>
                    <td><input type='text' name='s_rent_1' size='5' class='whitenum' value="0" readonly><!--사고대차--></td>
                    <td><input type='text' name='u_rent_1' size='5' class='whitenum' value="0" readonly><!--업무대여--></td>
                    <td><input type='text' name='wei_1' size='5' class='whitenum' value="0" readonly><!--대기--></td>
                    <td><input type='text' name='rev_1' size='5' class='whitenum' value="0" readonly><!--예약--></td>					
                    <td><input type='text' name='car_j_1' size='5' class='whitenum' value="0" readonly><!--차량정비--></td>
                    <td><input type='text' name='car_s_1' size='5' class='whitenum' value="0" readonly><!--사고수리--></td>
                    
                    <td><input type='text' name='status_total_1' size='5' class='whitenum' value="0" readonly><!--예비차량 소계--></td>
                    <td><input type='text' name='m_wei_1' size='5' class='whitenum' value="0" readonly><!--매각예정--></td>
                    <td><input type='text' name='total_sum_1' size='5' class='whitenum' value="0" readonly><!--전체 합계--></td>
                </tr>
                <tr align="center"> 
                    <td class='title'>계약확정/상담</td>                
                    <td><input type='text' name='m_rent_2' size='7' class='whitenum' value="0/0" readonly><!--월렌트--></td>
                    <td><input type='text' name='d_rent_2' size='7' class='whitenum' value="0/0" readonly><!--단기대여--></td>
                    <td><input type='text' name='b_rent_2' size='7' class='whitenum' value="0/0" readonly><!--보험대차--></td>
                    <td><input type='text' name='g_rent_2' size='7' class='whitenum' value="0/0" readonly><!--지연대차--></td>
                    <td><input type='text' name='j_rent_2' size='7' class='whitenum' value="0/0" readonly><!--정비대차--></td>
                    <td><input type='text' name='s_rent_2' size='7' class='whitenum' value="0/0" readonly><!--사고대차--></td>
                    <td><input type='text' name='u_rent_2' size='7' class='whitenum' value="0/0" readonly><!--업무대여--></td>
                    <td><input type='text' name='wei_2' size='7' class='whitenum' value="0/0" readonly><!--대기--></td>
                    <td><input type='text' name='rev_2' size='7' class='whitenum' value="0/0" readonly><!--예약--></td>					
                    <td><input type='text' name='car_j_2' size='7' class='whitenum' value="0/0" readonly><!--차량정비--></td>
                    <td><input type='text' name='car_s_2' size='7' class='whitenum' value="0/0" readonly><!--사고수리--></td>
                    
                    <td><input type='text' name='status_total_2' size='7' class='whitenum' value="0/0" readonly><!--예비차량 소계--></td>
                    <td><input type='text' name='m_wei_2' size='7' class='whitenum' value="0/0" readonly><!--매각예정--></td>
                    <td><input type='text' name='total_sum_2' size='7' class='whitenum' value="0/0" readonly><!--전체 합계--></td>
                </tr>
            </table>
        </td>
        <td width=17>&nbsp;</td>
