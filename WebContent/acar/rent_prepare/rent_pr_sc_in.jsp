					...
					<div style="width: 651px;">
						<table class="inner_top_table left_fix" style="height: 60px;">
							<tr>	        		    
			                    ...
			                    <td style="width: 90px;"  class='title title_border'>차명</td>
					...
					<div>
						<table class="inner_top_table table_layout" style="height: 60px;">
							<tr>								
			        		    ...
			        		    <td style="width: 60px;" class='title title_border'>연료</td>
			        		    <td style="width: 80px;" class='title title_border'>칼라</td>		  
			        		    ...
			        		    <td style="width: 45px;" class='title title_border'>경과일</td>		  
			        		    <td style="width: 45px;" class='title title_border'>가동율</td>     
			        		    ...
			        		    <td style="width: 70px;" class='title title_border'>단기대비</td>
						   		<td style="width: 70px;" class='title title_border'>해지반납일</td>					   
			       	  ...
			       	  <!--현위치,운행내용-->	  
			                 ...
			                 <td style="width: 120px;"  class='center content_border'>
			                   	<a href="javascript:parent.car_reserve('<%=reserv.get("RENT_S_CD")%>', '<%=reserv.get("CAR_MNG_ID")%>')" onMouseOver="window.status=''; return true">
			                     	...
			                     	<%	if(!String.valueOf(reserv.get("SORT_CODE")).equals("") || !String.valueOf(reserv.get("EX_N_H")).equals("")){//매각검토차량%>
					                      			<%	if(!String.valueOf(reserv.get("EX_N_H")).equals("")){//수출효과%>
					                      			<font color="#006600"><b><span title='수출효과금액 <%=reserv.get("EX_N_H")%>'><%=reserv.get("CAR_NO")%></span></b></font> 
					                      			<%	}else{//매각검토차량%>
			       			...
			       			&nbsp;
			                       ...
			                       <a class=index1 href="javascript:MM_openBrWindow('/acar/secondhand_hp/bigimg.jsp?c_id=<%=reserv.get("CAR_MNG_ID")%>','popwin0','scrollbars=no,status=no,resizable=yes,width=800,height=650,left=50, top=50')" title='등록일:<%=reserv.get("PIC_REG_DT")%>' ><img src="http://fms1.amazoncar.co.kr/images/photo_s.gif" width="17" height="15" border="0"></a>
						...
						//	if(ex_count > 0) continue;				
			                ...
			                <tr>
			                    ...
			                    <td style="width: 70px;"  class='center content_border'><%=reserv.get("SSS")%></td>											
					   			<td style="width: 45px;"  class='right content_border'><%=reserv.get("DAY")%>일</td>											
