...
<script type="text/javascript">
	...
	myGrid.setHeader("연번,차량번호,보험회사,증권번호,시작날짜,종료날짜,변경날짜,변경항목,변경전,변경후-보험,변경후-계약,변동보험료,총보험료");  
	myGrid.setInitWidths("45,80,100,110,90,90,90,80,120,100,105,100,90");
	//myGrid.setColSorting("int,str,str,str,str,str,str,str,str,str,str,str,str,str,str,str");
	myGrid.setColTypes("ron,link,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
  ...
  myGrid.setColAlign("center,center,center,center,center,center,center,center,center,center,center,right,right");
    ...
    gridQString = "ins_b_xml.jsp?dt=<%=dt%>&st_dt=<%=st_dt%>&end_dt=<%=end_dt%>";
