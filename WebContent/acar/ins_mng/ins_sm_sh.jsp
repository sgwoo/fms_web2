...
%>
<form action="./ins_sm_sc.jsp" name="form1" method="POST" target="c_foot">
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 수금관리 > 환급보험료 > <span class=style5>자동차조회</span></span></td>
