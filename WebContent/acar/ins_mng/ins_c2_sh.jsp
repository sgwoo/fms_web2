...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고관리 > 보험관리 > <span class=style5>보험변경예정조회II</span></span></td>
  ...
  <tr> 
     <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/acar/images/center/arrow_ggjh.gif" >&nbsp;
			  ...
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/acar/images/center/arrow_jhst.gif" >&nbsp;
			  <select name="gubun1">
	        <option value="">전체</option>
	        <option value="Y" <%if(gubun1.equals("Y"))%>selected<%%>>처리</option>
	        <option value="N" <%if(gubun1.equals("N"))%>selected<%%>>미처리</option>
        </select>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/acar/images/center/arrow_jggs.gif" >&nbsp;
			  <select name="gubun2">
			   	<option value="">선택</option>
          <option value="1" <%if(gubun2.equals("1"))%>selected<%%>>차량번호</option>
          <option value="2" <%if(gubun2.equals("2"))%>selected<%%>>보험사</option>
          <option value="3" <%if(gubun2.equals("3"))%>selected<%%>>증권번호</option>
          <option value="4" <%if(gubun2.equals("4"))%>selected<%%>>구분</option>
          <option value="5" <%if(gubun2.equals("5"))%>selected<%%>>배서항목명</option>
          <option value="6" <%if(gubun2.equals("6"))%>selected<%%>>차명</option>
        </select>
        <input type="text" name="t_wd" size="18" value="<%=t_wd%>" class="text">
