...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
	    <td colspan='2'>
		    <iframe src="./search_ext_car_in.jsp?s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&mode=<%=mode%>&car_st=<%=car_st%>&car_cd=<%=car_cd%>&car_gu=<%=car_gu%>&from_page=<%=from_page%>" name="inner" width="780" height="455" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
	    </td>
	</tr>
</table>
</form>
