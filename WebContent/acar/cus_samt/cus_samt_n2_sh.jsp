...
function carSearch(){
	...
	theForm.action = "cus_samt_n2_sc.jsp";
	theForm.submit();
}
...
<body>
<form name='form1' method='post' action='cus_samt_n2_sc.jsp' >
   ...
   <tr>
    	<td colspan=3>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 업체정보관리 > <span class=style5>정비비 청구현황</span></span></td>
    ...
    <tr> 
      <td colspan=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jhgb.gif align=absmiddle>&nbsp;
        <select name="gubun1" >
          <option value="4" <%if(gubun1.equals("4")){%> selected <%}%>>청구일&nbsp;</option>
        </select>
        <select name="s_year">
    	...
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	<select name='acct'>        
    				  <option value=''       <%if(acct.equals(""))		{%>selected<%}%>>전체</option>   
    ...
    <tr> 
      <td width="40%"><table width="100%" cellspacing=0 border="0" cellpadding="0">
        <tr>
          <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp;
            ...
            <!--     <option value="4" <%if(s_kd.equals("4")){%> selected <%}%>>정비년월</option> -->
      ...
      <td width="31%"><img src=/acar/images/center/arrow_jr.gif align=absmiddle>&nbsp;</font>
        <select name="sort">
          ...
          <option value="6" <%if(sort.equals("6")){%> selected <%}%>>구분</option>
        </select>
