...
<%
	...
	String t_wd = request.getParameter("t_wd")==null?"":request.getParameter("t_wd");  //회차
...
/*
	if ( acct.equals("000620") ) {
			doc_cont =  "MJ모터스"  + " "  + s_year + "년" + s_mon + "월" + t_wd + "회차 차량정비비"; //적요
			...
			doc_cont = " 상무1급자동차공업사 " + s_year + "년" + s_mon + "월" + t_wd + "회차 차량정비비"; //적요	
	} else if (acct.equals("009290") ) {
			doc_cont = " 우리자동차공업 " + s_year + "년" + s_mon + "월" + t_wd + "회차 차량정비비"; //적요	
...
*/	
	...
	doc_cont = firm_name  + " "  + s_year + "년" + s_mon + "월" + t_wd + "회차 차량정비비"; //적요
	...
	//전표생성일 추가
	if(!cs_db.updateServiceAutoDocuDt(s_year, s_mon, t_wd, acct, acct_dt, user_id)) flag += 1;
