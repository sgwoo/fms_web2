...
function carSearch(){
	...
	theForm.action = "cus_samt_s1_sc.jsp";
	theForm.submit();
}
...
<body>
<form name='form1' method='post' action='cus_samt_s1_sc.jsp' >
   ...
   <tr>
    ...
    <tr> 
      <td colspan=3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jhgb.gif align=absmiddle>&nbsp;
        <select name="gubun1" >
          <option value="1" <%if(gubun1.equals("1")){%> selected <%}%>>정산일&nbsp;</option>
        </select>
        <select name="s_year">
