	...
	<td class='line' width='73%'>
	  <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		...
		<tr>		  
		  ...
		  <td align="center"	width='5%'><%=Util.subData(String.valueOf(ht.get("연료")),5)%></td>
		  <td align="center"	width='10%'>
		  <span title='<%=ht.get("고객")%>'><%=Util.subData(String.valueOf(ht.get("고객")),7)%></span></td>
		  <td align="center"	width='10%'><%=Util.subData(String.valueOf(ht.get("검사소")),7)%></td>
		  ...
		  <td align="center"	width='10%'><%=ht.get("등록일자")%></td>	 		
		  <td align="center"	width='18%'><%=ht.get("대여기간")%></td>
