...
function pop_excel(s_year, s_mon, s_kd, t_wd){
	...
	var SUBWIN="popup_excel_service.jsp?acct="+fm.acct.value+"&s_year=" + s_year+ "&s_mon=" + s_mon+ "&s_kd=" + s_kd+ "&t_wd=" + t_wd;	
...
%>
   <tr> 
     ...
     <td width='70' class=star align='right' style="font-size : 9pt;"><%=Util.parseDecimal(amt[12] )%></font></td>
      <td width='100' align='right' style="font-size : 9pt;">&nbsp;&nbsp;vat:&nbsp;<%=Util.parseDecimal(vat2)%></font></td>
  </tr>
<%
	header = true;		
...
<table class="" border="0" cellspacing="0" cellpadding="0" width=1462  id='tbl<%=ii%>'>
  ...
  <tr> 
   ...
   &nbsp;
   <a href="javascript:pop_excel('<%=s_yy%>', '<%=s_mm%>', '3', '<%=s_jung_st%>');"><img src=../images/center/button_excel.gif align=absmiddle border=0></a>
    &nbsp; 
   </th>      
  </tr>   
   <tr>
