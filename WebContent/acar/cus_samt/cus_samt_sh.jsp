...
<body>
<form name='form1' action='cus_samt_sc.jsp' target='c_body' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>고객지원 > 거래처관리 > <span class=style5>거래처별정비비관리</span></span></td>
            ...
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    <td width=18%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jhgb.gif  align=absmiddle>&nbsp; 
                        <select name="gubun1" onChange="javascript:list_move()" disabled>
                    ...
                    <td width=13%><img src=/acar/images/center/arrow_sbjh.gif  align=absmiddle>&nbsp; 
                        <select name="gubun3">
