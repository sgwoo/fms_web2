...
function view_jungsan(m1_no, rent_l_cd, gubun)
{
		...
		window.open("/off/ssmoters/car_maint_jungsan_popup.jsp?user_id="+fm.user_id.value+"&auth_rw="+fm.auth_rw.value+"&m1_no="+m1_no+"&rent_l_cd="+rent_l_cd+"&gubun="+gubun, "jungsan", "left=150, top=150, width=450, height=500");
}
    ...
    <tr>
		<td>
			 <table border="0" cellspacing="1" cellpadding="0" width=100%>
				<tr>				
			        <td align='left'><a href="javascript:select_cons();"><img src=/acar/images/center/button_chg.gif align=absmiddle border=0></a>
