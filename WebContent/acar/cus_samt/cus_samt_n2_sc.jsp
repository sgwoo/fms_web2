...
//		fm.target = "i_no";
	...
	function set_jung(){
		...
		if(fm.pre_set_dt.value == ''){ 	alert('계산서발행일자를 입력하십시오'); 	return;	}
	
		if(!isDate(fm.pre_set_dt.value)){ fm.pre_set_dt.focus(); return;	}	
		...
		if (!confirm('계산서발행일로  정산 마감하시겠습니까?')){	return;	}
		
//		fm.target = "i_no";
		fm.target = "d_content";
		fm.action = "cus_set_dt_conf_a.jsp?chk=pre&auth_rw="+document.form1.auth_rw.value + "&pre_set_dt="+document.form1.pre_set_dt.value;
		fm.submit();	
	...
	<tr>
			 <td align='left'>
			  <%if(auth_rw.equals("4")||auth_rw.equals("6")){%>   
				<img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>계산서발행일자</span>&nbsp;<input type='text' name="pre_set_dt"  size='11' class='text' onBlur='javascript: this.value = ChangeDate(this.value); '> &nbsp;&nbsp;&nbsp;
				
				<a href="javascript:set_jung();"><img src=/acar/images/center/button_js.gif align=absmiddle border=0></a>&nbsp;				 
