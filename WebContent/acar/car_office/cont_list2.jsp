...
<%
	...
	CommiBean cm_r [] = cod.getCommiAll(emp_id, emp_ssn);
        ...
        <td class="line">
            <table border=0 cellspacing=1 width=100%>
                <tr>
                    ...
                    <td width=8% class=title>영업담당자</td>
                    <td width=8% class=title>영업사원</td>
                    <td width=8% class=title>실수령인</td>
                </tr>
        <%
...
%>
                <tr>
                    ...
                    <td align=center><%= cm_bean.getEmp_nm() %></td>
                    <td align=center><%= cm_bean.getEmp_acc_nm() %></td>
                </tr>
        <%}%>
        <% if(cm_r.length == 0) { %>
                <tr> 
