...
<!--
	...
	function save(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.BANK_ACC%>";		
		fm.submit();
	}
//-->
</script>
	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    ...
                    <td >&nbsp;
                        ...
                        <input type="hidden" name="<%=Webconst.Common.contentSeqName%>" value='emp_id<%=emp_id%><%=acc_seq%><%=file_st%>'>
