    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=../images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 대손채권 관리 > <span class=style5>대손채권 관리</span></span></td>
        ...
        <!--            <option value="4" <%if(gubun3.equals("4")){%>selected<%}%>>선수금</option>-->
                    ...
                    <td>
                        <select name="gubun4">
                            ...
                            <option value="2" <%if(gubun4.equals("2")){%>selected<%}%>>정산금</option>
                      <!--      <option value="3" <%if(gubun4.equals("3")){%>selected<%}%>>대여료</option> -->
                        </select>			
                    </td>
                </tr>
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_gsjg.gif align=absmiddle>
                      &nbsp;<select name='s_kd' onChange="javascript:document.form1.t_wd.value='', cng_input()">
                        ...
                        <option value='10' <%if(s_kd.equals("10")){%> selected <%}%>>채권구분</option>				
                      </select>
                    </td>
                    <td> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td><img src=../images/center/arrow_jrjg.gif align=absmiddle>
                        <select name='sort_gubun' onChange='javascript:search()'>
                            ...
                            <option value='2' <%if(sort_gubun.equals("2")){%> selected <%}%>>해지일자</option>
