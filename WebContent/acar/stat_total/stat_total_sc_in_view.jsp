...
<%
	...
	totals = st_db.getStatTotal(brch_id, save_dt, "all", gubun_dt, d1, d2, m1);
	total_size = totals.size();
		
	float htot_ga[] 	= new float[6];
	float hm_ga[] 	= new float[6];
	float hd_ga[] 	= new float[6];
	float hb_ga[] 	= new float[6];
	float hd_per[] 	= new float[6];
