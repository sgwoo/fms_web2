...
function ServOffReg()
{
	...
	theForm.action = "/acar/serv_off/serv_off_i_null_ui.jsp";
	theForm.cmd.value = "i";
	theForm.target = "i_no";
	theForm.submit();
...
function ServOffUp()
{
	...
	theForm.action = "./serv_off_i_null_ui.jsp";
	theForm.cmd.value = "u";
...
<table border=0 cellspacing=0 cellpadding=0 width="800">
    ...
    <tr>
        <td align="right">
           ...
           <a href="javascript:ServOffReg()">등록</a>&nbsp;&nbsp;&nbsp;<a href="javascript:WinClose()">닫기</a>


        </td>
    </tr>
    <form action="./serv_off_i_null_ui.jsp" name="ServOffRegForm" method="POST" >
    <tr>
        <td class=line>
