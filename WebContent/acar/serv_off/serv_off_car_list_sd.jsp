    ...
    <tr>
		<td>
			 <table border="0" cellspacing="1" cellpadding="0" width=820>
				<tr>
					<td colspan=2><iframe src="./serv_off_car_list_sd_in.jsp?auth_rw=<%=auth_rw%>&off_id=<%=off_id%>" name="CustServList" width="818" height="200" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
				</tr>							
