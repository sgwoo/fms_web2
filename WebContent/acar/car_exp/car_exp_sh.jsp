        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 수금관리 > <span class=style5>환급자동차세</span></span></td>
                ...
                <tr> 
                    <td width='205'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jhgb.gif align=absmiddle>&nbsp;
                      <select name="gubun1" onChange="javascript:list_move()">
                        ...
                        <option value="14" <%if(gubun1.equals("14")){%>selected<%}%>>환급보험료</option>
                        <option value="15" <%if(gubun1.equals("15")){%>selected<%}%>>환급자동차세</option>
                ...
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp;
                        <select name='s_kd'>
                            ...
                            <option value='5' <%if(s_kd.equals("5")){%> selected <%}%>>지역</option>				
                        </select>
                    </td>
                    <td> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td><img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>&nbsp;
                        <select name='sort_gubun' onChange='javascript:search()'>
                            <option value='1' <%if(sort_gubun.equals("1")){%> selected <%}%>>환급사유발생일자</option>
                            <option value='2' <%if(sort_gubun.equals("2")){%> selected <%}%>>환급일자</option>
                            <option value='3' <%if(sort_gubun.equals("3")){%> selected <%}%>>차량번호</option>
                            <option value='4' <%if(sort_gubun.equals("4")){%> selected <%}%>>환급사유</option>
                            <option value='5' <%if(sort_gubun.equals("5")){%> selected <%}%>>환급금액</option>
                            <option value='6' <%if(sort_gubun.equals("6")){%> selected <%}%>>환급예정금액</option>							
                        </select>
                    </td>
                    <td> 
