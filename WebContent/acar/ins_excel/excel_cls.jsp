    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="70" class="title">시작행</td>
          ...
          <td width="150" class="title">⑤용도변경내용</td>
          <td width="150" class="title">⑥용도변경목적</td>
          <td width="150" class="title">⑦청구/승계일자</td>
          <td width="150" class="title">⑧환급금</td>
        </tr>
      </table></td>
  </tr>  
  <tr>
