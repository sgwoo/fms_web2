...
function checkNaN(num)
{
	...
	function save(){
		...
		if(fm.est_dt.value == ''){ 	alert('예정일자를 입력하십시오.'); return; }
		
		if(!confirm("등록하시겠습니까?"))	return;
		fm.action = 'excel_pay_20090310_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="150" class="title">A-0 미결구분</td>
          <td width="150" class="title">B-1 연번</td>
          <td width="150" class="title">C-2 관련번호</td>
          <td width="150" class="title">D-3 금액</td>
          <td width="150" class="title">E-4 마감일자</td>
          <td width="150" class="title">F-5 적용개시일자</td>
          <td width="150" class="title">G-6 계약번호<br>(증권번호)</td>
          <td width="150" class="title">H-7 입력일자</td>
          <td width="150" class="title">I-8 비고</td>		  
        </tr>
      </table></td>
  </tr>  
  <tr>
  ...
  <tr>
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0" width=100%>  
        <tr>
    	  <td width="70" rowspan="2" class="title">공통</td>
    	  <td width="150" height="30" class="title">납부일자
		  </td>
    	  <td>&nbsp;
		  <input name="pay_dt" type="text" class=text value=""size="18"></td>
        </tr>
		<tr>
		  <td width="150" height="30" class="title">예정일자</td>
    	  <td>&nbsp;
		  <input name="est_dt" type="text" class=text value=""size="18"></td>
		</tr>
	  </table>
	</td>
  </tr>  
...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
		...
		if(String.valueOf(content.get("0")).equals("") && String.valueOf(content.get("1")).equals("") && String.valueOf(content.get("2")).equals("") && String.valueOf(content.get("3")).equals(""))  continue;%>  
        <tr>
