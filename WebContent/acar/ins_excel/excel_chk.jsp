    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="150" class="title">B-1 증권번호</td>
          <td width="150" class="title">C-2 고객명</td>
          <td width="150" class="title">D-3 차량번호</td>
          <td width="150" class="title">E-4 금액</td>
          <td width="150" class="title">F-5 수납일</td>
        </tr>
      </table></td>
  </tr>  
  <tr>
