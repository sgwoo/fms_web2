...
function checkNaN(num)
{
	...
	function save(){
		...
		if(b_size > r_size || b_size < r_size){
		...
		if(row_size > 800){			alert('800행을 초과합니다. 사이즈 조절을 하셔야 합니다.'); return; }
  ...
  <tr>
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0" width=100%>  
        <tr>
    	  <td width="70" rowspan="5" class="title">공통</td>
    	  <td width="150" height="30" class="title">보험가입일
		  </td>
    	  <td>&nbsp;
		  <input name="ins_rent_dt" type="text" class=text value="<%=AddUtil.getDate(1)+"0210"%>"size="18" style1></td>
        </tr>
        <tr>
    	  <td width="150" height="30" class="title">보험시작일
		  </td>
    	  <td>&nbsp;
		  <input name="ins_start_dt" type="text" class=text value="<%=AddUtil.getDate2(1)+"0210"%>"size="18" style1></td>
        </tr>
        <tr>
    	  <td width="150" height="30" class="title">보험만료일
		  </td>
    	  <td>&nbsp;
		  <input name="ins_end_dt" type="text" class=text value="<%=AddUtil.getDate2(1)+1+"0210"%>"size="18" style1></td>
        </tr>
        <tr>
    	  <td width="150" height="30" class="title">보험납입일
		  </td>
    	  <td>&nbsp;
		  <input name="t_pay_est_dt" type="text" class=text value="<%=AddUtil.getDate2(1)+"0310"%>"size="18" style1></td>
        </tr>		
        <tr>
    	  <td width="150" height="30" class="title">보험사코드
		  </td>
    	  <td>&nbsp;
		  <input name="ins_com_id" type="text" class=text value=""size="18" style1></td>
        </tr>		        
	  </table>
	</td>
  </tr>  
