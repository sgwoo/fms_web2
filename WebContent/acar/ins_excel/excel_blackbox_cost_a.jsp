...
<%
	...
	String value25[] 	= request.getParameterValues("value25");    //설계번호                        
	String value26[] 	= request.getParameterValues("value26");    //블랙박스 할인보험료                  
...
<%
	for(int i=start_row ; i < value_line ; i++){
		...
		if(!ins.getCar_mng_id().equals("")){
			...
			int ch_amt = Integer.parseInt(value26[i].replaceAll(",",""));
			...
			ins_chg.setCh_item			("17");
			ins_chg.setCh_before		("미가입");
			ins_chg.setCh_after			("가입");
...
%>
	 <tr>
    	  ...
    	  <td align="center"><input name="value25"	type="text" 	class="text"   		value="<%=value25[i]%>"> </td>    <!-- 설계번호 -->            
    	  <td align="center"><input name="value26"	type="text" 	class="text"   		value="<%=value26[i]%>"> </td>    <!-- 블랙박스 할인보험료  -->      
  		</tr>       
<%} %>
</table>
</body>
