    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="150" class="title">1.차량번호</td>
          <td width="150" class="title">2.차명</td>
          <td width="120" class="title">3.상호명</td>
          <td width="120" class="title">4.사업자번호</td>
          <td width="120" class="title">5.대여개시일</td>
          <td width="120" class="title">6.대여만료일</td>
          <td width="120" class="title">7.변경전보험</td>
          <td width="120" class="title">8.보험회사</td>
          <td width="120" class="title">9.보험시작일</td>
          <td width="120" class="title">10.보험만료일</td>
          <td width="120" class="title">11.변경후보험</td> 
          <td width="120" class="title">12.영업자</td> 
          <td width="150" class="title">13.미가입승인</td>
          <td width="150" class="title">14.변경항목</td>
          <td width="120" class="title">15.변경전</td>
          <td width="120" class="title">16.변경후</td>
          <td width="120" class="title">17.배서기준일</td>
          <td width="120" class="title">18.추징보험료</td>
          <td width="120" class="title">19.증권번호</td>
          <td width="120" class="title">20.대인배상Ⅰ</td>
          <td width="120" class="title">21.대인배상Ⅱ</td>
          <td width="120" class="title">22.대물배상</td>
          <td width="120" class="title">23.자기신체사고</td> 
          <td width="120" class="title">24.무보험차상해</td>
          <td width="120" class="title">25.분담금할증한정</td> 
          <td width="120" class="title">26.자기차량손해</td> 
          <td width="120" class="title">27.애니카</td> 
          <td width="120" class="title">28.총보험료</td> 
