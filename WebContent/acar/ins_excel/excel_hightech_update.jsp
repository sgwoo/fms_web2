...
function checkNaN(num)
{
	...
	function save(){
		...
		fm.action = 'excel_hightech_update_a.jsp';									
		fm.submit();
	}
//-->
</SCRIPT>
...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
        ...
        <tr>
    	  ...
    	  <td width="150" align="center"><input name="car_no" type="text" class=text style1   value="<%=content.get("0")%>"size="17"></td>
    	  <td width="150" align="center"><input name="reg_dt" type="text" class=text style1   value="<%=date%>"size="17"></td>
