...
<%
	...
	for(int i=start_row ; i < value_line ; i++){
		...
		ins_con_no 		= value1[i] ==null?"":AddUtil.replace(AddUtil.replace(AddUtil.replace(value1[i],"-",""),"_ ","")," ","");		
		...
		*/
		...
		//최근보험 조회-------------------------------------------------
		InsurBean ins = ai_db.getInsConNoExcelCase(o_ins_con_no, car_no);
