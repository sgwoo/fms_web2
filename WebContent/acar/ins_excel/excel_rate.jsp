...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
        ...
        <tr>
    	  ...
    	  <td align="center"><input name="value25"	type="text" 	class="text"   		value="<%=content.get("25")%>"></td>    <!-- 차액보험료 -->            
    	  <td align="center"><input name="value26"	type="text" 	class="text"   		value="<%=content.get("26")%>"></td>    <!-- 요율정정 후 보험료 -->      
  		</tr>       
  	<%		value_line++;
		}
	}
