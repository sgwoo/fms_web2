...
function checkNaN(num)
{
	...
	function save(){
		...
		fm.action = 'excel_renew_conid2_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="150" class="title">①설계번호</td>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0" width=100%>  
        <tr>
    	  ...
    	  <td>&nbsp;
		  <input name="ins_start_dt" type="text" class=text value="<%=AddUtil.getDate(1)+"0210"%>"size="18" style1></td>
        </tr>
        <tr>
