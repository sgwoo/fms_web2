        ...
        <td class="line" >
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr>
                    ...
                    <td width='20%' class='title'>신규계약</td>
                    <td width='20%' class='title'>수익반영</td>
                    <td width='20%' class='title'>환불(해지)</td>
				...
				<tr>
                    ...
                    <td align="right"><%=AddUtil.parseDecimalLong(AddUtil.parseLong(String.valueOf(ht.get("AMT1")))-AddUtil.parseLong(String.valueOf(ht.get("AMT2")))-AddUtil.parseLong(String.valueOf(ht.get("AMT3"))))%></td>                    
                </tr>	
                <%			}%>	      
				<tr>
                    ...
                    <td align="right"><%=AddUtil.parseDecimalLong(total_amt1-total_amt2-total_amt3)%></td>                    
                </tr>	
                <%	}%>
            </table>
	    </td>
