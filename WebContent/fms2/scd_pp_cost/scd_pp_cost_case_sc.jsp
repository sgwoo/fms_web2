...
<input type='hidden' name='go_url' value='<%=go_url%>'>
  <table border="0" cellspacing="0" cellpadding="0" width=1350>
      <tr>
	    <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>개별원장(선수대여료)</span></td>
	  </tr>
    <tr>
    ...
    <tr>
        <td class="line" >
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr>
                    <td width='10%' rowspan='2' class='title'>계약번호<br>(<%=base.get("RENT_MNG_ID")%>)</td>                    
                ...
                <tr>
                    ...
                    <td colspan='4'>&nbsp;대여료 일괄납입분</td>                
                    <td class='title'>해지</td>
    ...
    <tr>
        <td class="line" >
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                ...
                <tr>
                    <td align="center">개시대여료(<%=fee.getPere_r_mth()%>개월)</td>
        ...
        <td class="line" >
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                ...
                <tr>
                    ...
                    <td align="center"><%if(String.valueOf(ht.get("TM")).equals("99")){%><%=ht.get("GUBUN")%><%}else{%><%if(!String.valueOf(ht.get("RC_DT")).equals("")){%>수익<%}%><%}%></td>
                    ...
                    <%	if(fee.getPp_chk().equals("0")){ //매월균등발행스케줄
                    ...
                    <%	}else{
                    		String tm_tax_dt = "";
                    		int tm_tax_amt = 0;
                    		if(String.valueOf(ht.get("GUBUN")).equals("환불(해지)") && !r_gubun2.equals("3")){
