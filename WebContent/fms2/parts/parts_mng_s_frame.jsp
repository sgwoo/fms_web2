...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
  <frame src="./parts_mng_s_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./parts_mng_s_sc.jsp<%=valus%>" name="c_foot" frameborder=0 scrolling="auto" topmargin=0 marginwidth="10">
</frameset>
</HTML>