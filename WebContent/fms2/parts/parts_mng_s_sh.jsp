...
<form name='form1' action='/fms2/parts/parts_mng_s_sc.jsp' target='c_foot' method='post'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 업체정보관리 > <span class=style5>구매비용 지원현황</span></span></td>
    ...
    <tr>
        <td class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td>&nbsp;
        			  <select name='gubun3'>
                        <option value='1' <%if(gubun3.equals("1")){%>selected<%}%>>구매일자</option>                       								
        <!--                <option value='4' <%if(gubun3.equals("4")){%>selected<%}%>>등록일자</option> -->
                    ...
                    <td>&nbsp;
                	  <select name='s_kd'>
                        <option value='1' <%if(s_kd.equals("1")){%>selected<%}%>>업체 </option>                       
                      </select>
                	  &nbsp;&nbsp;&nbsp;
