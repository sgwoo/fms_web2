...
<%
	...
	int result_cnt = request.getParameter("result_cnt")==null?0:AddUtil.parseInt(request.getParameter("result_cnt"));//실패수
	
	String result[]  	= request.getParameterValues("result");
	String c0[] 	= request.getParameterValues("c0");
...
<%
       if ( result_cnt > 0 ) {
        ...
        <tr>
          ...
          <td align="center"><%=c0[i] ==null?"":c0[i]%></td>
