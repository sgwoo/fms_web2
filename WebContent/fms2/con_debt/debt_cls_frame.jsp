...
<frameset rows="<%=height%>,*" border=1>
    <frame src="/fms2/con_debt/debt_cls_sh.jsp<%=valus%>" name="c_head" marginwidth=10 marginheight=10 scrolling="no" noresize>
    <!--<frame src="/fms2/con_debt/debt_cls_sc.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling="auto">-->
