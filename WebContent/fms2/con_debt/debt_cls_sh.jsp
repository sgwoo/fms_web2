...
<form name='form1' action='debt_cls_sc.jsp' target='c_body' method='post'>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;재무회계 > 구매자금관리 > <span class=style1><span class=style5>할부금중도상환현황</span></span></td>
		...
		<td>			
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
					...
					<select name="gubun1">
                <option value="1" <%if(gubun1.equals("1"))%>selected<%%>>중도상환일자</option>
              </select>
			  <select name="gubun2" >
                <% for(int i=AddUtil.getDate2(1)-1; i<=AddUtil.getDate2(1)+4; i++){%>
              ...
              <select name="gubun3">
                ...
                <%}%>
                    ...
                    <td width='40%'><img src=/acar/images/center/arrow_sbjh.gif align=absmiddle>&nbsp;
                      <select name="gubun4">			  
