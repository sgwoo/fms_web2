...
<%
	...
	Vector debts = ad_db.getDebtSettleEstList(gubun1, gubun2, gubun3, gubun4, s_kd, t_wd, sort_gubun, asc);
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp; <span class=style1><span class=style5><%=gubun2%>년 이후 상환예정 유동성부채현황 (원금)</span></span></td>
