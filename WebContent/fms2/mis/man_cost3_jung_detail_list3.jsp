...
<%	Vector vts2 = ac_db.getDlyCostStatMList3(save_dt, mng_id, amt1, amt2, amt1_per, amt2_per, amt3_per, bus_cost_per, mng_cost_per, gg, mng_br_id);
	...
	<td class='line' width='56%'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr> 
            ...
            <td width='8%' align="right"><%=Util.parseDecimal(String.valueOf(ht.get("PER")))%></td>
