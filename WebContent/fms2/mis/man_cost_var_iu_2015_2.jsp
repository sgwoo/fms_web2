...
//	System.out.println("man_cost update gubun =  " + gubun);
...
//	System.out.println("man_cost update cam_per =  " + cam_per);
//	System.out.println("man_cost update a_cam_per =  " + a_cam_per);
...
//수정
	...
	//  	System.out.println("man_cost update");
	...
	//	System.out.println("man_cost insert");
	}
...
//	    	var site = "http://211.174.180.197/acar/admin/man_cost_j_campaign_null.jsp?gubun=3";    
 //		var style ="dialogWidth:5px;dialogHeight:5px"; // 사이즈등 style을 선언
  //		var vReturn = window.showModalDialog(site, objectName ,style ); // modal 실행 window.showModalDialog 포인트!!
 		...
 		var site = "http://cms.amazoncar.co.kr:8080/acar/admin/man_cost_j_campaign_null.jsp?gubun="+fm.gubun.value;    			
