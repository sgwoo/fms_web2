...
//계산식보기
function view_sik(){
	window.open("man_cost3_jung.jsp?popup=Y","sik","left=50,top=50,width=1300,height=750,scrollbars=yes");
}
...
function updateVarS(){
	...
	fm.action = "campaign2019_magam_i.jsp?gubun=2";
	fm.target = 'i_no';	
//	fm.target = '_blank';	
	fm.submit();
}
...
<!--  	<tr> 
      <td colspan=2><font color="#FF00FF">♣ 대상자</font>       : 입사  40개월이상   
        &nbsp;&nbsp;</td>
   	</tr>  -->
  	<tr> 
    ...
    <tr> 
      <td colspan=2><font color="#FF00FF">♣ 포상금액</font>     : (개인별대당평균관리비용계/인원수 - 본인1대당평균관리비용)* 관리대수 (최소금액:100,000원)</td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td>: 
		...
		피해사고수리비 적용금액: 100만원 미만 - 10만원 적용, 100만원 초과 - 초과분의 5% 적용  (폐차 제외) 
