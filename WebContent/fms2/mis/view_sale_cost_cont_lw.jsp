	...
	long bc_s_c = 0;
       	...
       	float f_fee_s_amt= 0;
					...
					for(int j=0; j<1; j++){
						...
						t_amt29[j] 		+= AddUtil.parseLong(String.valueOf(ht.get("AMT29")));  //기타
						...
						t_amt40[j] 		+= AddUtil.parseLong(String.valueOf(ht.get("AMT40")));  //카드결제cashback견적반영분
						...
						t_amt45[j] 		+= AddUtil.parseLong(String.valueOf(ht.get("AMT45")));  //용품월대여료
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1><span class=style5>영업효율보기</span></span></td>
    ...
    <tr> 
  	    <td class=line>
      	    <table border="0" cellspacing="1" cellpadding="0" width='100%' >
                ...
                <tr>
                    <td colspan="2" align="center"><%=ht.get("CAR_NM")%>
					<%	Hashtable car_ht = a_db.getCaridCarseq(String.valueOf(ht.get("CAR_ID")), String.valueOf(ht.get("CAR_SEQ")));
						if(String.valueOf(ht.get("CAR_NM")).equals("null") || String.valueOf(ht.get("CAR_NM")).equals("")){%>
							<%=car_ht.get("CAR_NM")%>
					<%	}%>
					&nbsp;<%=car_ht.get("CAR_NAME")%></td>
                ...
                <tr>
                    <td align="center"><%=ht.get("CAR_GU_NM")%></td>
                    <td align="center"><%=ht.get("RENT_ST_NM")%></td>
                    <td align="center"><%=ht.get("CAR_ST_NM")%></td>
                    <td align="center"><%=ht.get("RENT_WAY_NM")%></td>
                </tr>
                <tr>
                    <td class='title'>계약기간</td>
                    <td class='title'>대여개시일</td>
                    <td class='title'>적용등급</td>
                    <td class='title'>자체출고여부</td>
                </tr>
                <tr>
                    <td align="center"><%=ht.get("CON_MON")%></td>
                    <td align="center"><%=ht.get("RENT_START_DT")%></td>
                    <td align="center"><%=ht.get("SPR_KD_NM")%></td>
                    <td align="center"><%=ht.get("COMMI2_NM")%></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td class=line>
            <table border="0" cellspacing="1" cellpadding="0" width='100%' >
                ...
                <tr>
                  <td rowspan="15" class=title width=25%>견적관리비+기대마진+기타수익</td>
        ...
        -->           
                ...
                <tr>
                  <td rowspan="15" class=title>비용항목</td>
                ...
                <tr>
                  <td rowspan="3" class=title width=25%>비용합계</td>
                  <td class=title width=20%>실비용</td>
                  <td align="right">&nbsp;<%=Util.parseDecimal(String.valueOf(ht.get("AMT20")))%>&nbsp;</td>
                </tr>
                <tr>
        		    ...
        		    <td class=line width="100%">
        			    <table border="0" cellspacing="1" cellpadding='0' width=100%>
            		        ...
            		        <tr>
            				  ...
            				  <td>기타수익</td>
            				  <td align="center"><input type='text' size='12' name='bc_b_g' maxlength='10' class='num' value='<%=fee_etc.getBc_b_g()%>' onBlur='javascript:this.value=parseDecimal(this.value);'>&nbsp;내용: <input type='text' size='40' name='bc_b_g_cont' maxlength='50' class=text value='<%=fee_etc.getBc_b_g_cont()%>'>
            				  </td>
            				</tr>
            		        <tr>
            				  ...
            				  <td>기타비용</td>
            				  <td align="center"><input type='text' size='12' name='bc_b_u' maxlength='10' class='num' value='<%=fee_etc.getBc_b_u()%>' onBlur='javascript:this.value=parseDecimal(this.value);'>&nbsp;내용: <input type='text' size='40' name='bc_b_u_cont' maxlength='50' class=text value='<%=fee_etc.getBc_b_u_cont()%>'>
            				  </td>
            				</tr>
            		        <tr>
            				  ...
            				  <td>기타 영업효율반영값</td>
            				  <td align="center"><input type='text' size='12' name='bc_b_ac' maxlength='10' class='num' value='<%=fee_etc.getBc_b_ac()%>' onBlur='javascript:this.value=parseDecimal(this.value);'>&nbsp;내용: <input type='text' size='40' name='bc_b_ac_cont' maxlength='50' class=text value='<%=fee_etc.getBc_b_ac_cont()%>'></td>
            				</tr>
            		        <tr>
            				  <td align="center"></td>
            				  <td align="center">bc_etc</td>				  
            				  <td>기타 유의사항</td>
            				  <td align="center"><textarea rows='10' cols='68' name='bc_etc'><%=fee_etc.getBc_etc()%></textarea>&nbsp;</td>
            				</tr>
            		        <tr>
            				  <td align="center">T</td>
            				  <td align="center">bc_b_t</td>				  
            				  <td>용품사양</td>
            				  <td align="center"><input type='text' size='12' name='bc_b_t' maxlength='10' class='num' value='<%=fee_etc.getBc_b_t()%>' onBlur='javascript:this.value=parseDecimal(this.value);'>&nbsp;</td>
            				</tr>
