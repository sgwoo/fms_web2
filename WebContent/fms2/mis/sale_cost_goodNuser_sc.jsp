...
<form action="" name="form1" method="POST">
  ...
  <input type='hidden' name='from_page' value='/fms2/mis/sale_cost_goodNuser_frame.jsp'>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
  ...
  <tr>
    <td><iframe src="sale_cost_goodNuser_sc_in.jsp<%=valus%>" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
                    </iframe></td>
  </tr>
</table>
