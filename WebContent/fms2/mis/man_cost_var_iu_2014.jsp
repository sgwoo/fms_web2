...
<%
	...
	int result = 0;
//	result = ac_db.updateVar(year, tm, gubun, cs_dt, ce_dt, amt1, amt2, amt3, amt4, rent_way_1_per, rent_way_2_per, max_day, second_per, maker_dc_a, commi_per, cam_per, cc1, cc2, cc3, cc4, da_amt1, da_amt2, da_amt3, amt1_per, amt2_per , bus_cost_per, mng_cost_per, car_cnt, sale_cnt, base_cnt);
...
//수정
	...
	//등록	
		...
		result = ac_db.insertVar(year, tm, gubun, cs_dt, ce_dt, amt1, amt2, amt3, amt4, rent_way_1_per, rent_way_2_per, max_day, second_per, maker_dc_a, commi_per, cam_per, cc1, cc2, cc3, cc4, da_amt1, da_amt2, da_amt3, amt1_per, amt2_per , bus_cost_per, mng_cost_per, car_cnt, sale_cnt, base_cnt);
...
<body>
<form name='form1' action='https://fms3.amazoncar.co.kr/fms2/mis/man_cost_campaign_null.jsp' method="POST">
...
//	fm.action = 'https://fms3.amazoncar.co.kr/fms2/mis/man_cost_campaign_null.jsp';
	fm.action = './man_cost_campaign_null.jsp';
	fm.target = 'i_no';
	fm.submit();		
<%}else{%>
