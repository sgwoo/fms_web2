...
<body>
<form name='form1' action='sale_bus_mng_sc.jsp' target='c_body' method='post'>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계약관리 > <span class=style5>영업실적관리</span></span></td>
    ...
    <tr>
	    ...
	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
			    ...
			    <option value='4' <%if(gubun1.equals("4")){%>selected<%}%>>캠페인마감기준일</option>
                        </select>
			&nbsp;
			<select name='gubun2'>
