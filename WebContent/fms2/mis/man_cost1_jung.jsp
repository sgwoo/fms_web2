...
<input type="hidden" name="from_page" value="/fms2/mis/man_cost1_jung.jsp"> 
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr> 
        <td colspan="4"><iframe src="./man_cost1_jung_view.jsp?auth_rw=<%=auth_rw%>&user_id=<%=s_user%>" name="i_view" width="100%" height="550" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
        </td>
    </tr>
</table>    
