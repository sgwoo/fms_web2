...
<%	Vector vts2 = ac_db.getDlyCostStatMList3(dt, ref_dt1, ref_dt2, mng_id, amt1, amt2, amt1_per, amt2_per, amt3_per, bus_cost_per, mng_cost_per, gg, mng_br_id);
	...
	<td class='line' width='56%'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
         <tr>
            ...
            <td width="14%"  class="title">대여방식</td>
	...
	<td class='line' width='56%'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr> 
            ...
            <td width='14%' align="center"><%=Util.subData(String.valueOf(ht.get("RENT_WAY")), 8)%> </td>
            <td width='18%' align="center"><%=ht.get("GUBUN")%></td>
