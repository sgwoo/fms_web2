		                    ...
		                    <td width='7%' align='center'>
								...
								<% } else { %>
									<%    if (ht.get("LOAN_ST").equals("2")){ %>
										<%=dept_nm%>&nbsp;<% if ( dept_nm.equals("부산지점") || dept_nm.equals("대전지점")  || dept_nm.equals("대구지점")   || dept_nm.equals("수원지점")  || dept_nm.equals("광주지점")    || dept_nm.equals("인천지점")  ) { %> <%}%>                            
									<%}else if( ht.get("LOAN_ST").equals("4")){%>
										<%=dept_nm%>&nbsp;<% if ( dept_nm.equals("부산지점") || dept_nm.equals("대전지점")   || dept_nm.equals("대구지점")   || dept_nm.equals("수원지점")   || dept_nm.equals("광주지점")   || dept_nm.equals("인천지점")  ) { %> <%}%>   
									<%}else if( ht.get("LOAN_ST").equals("5")){%>
										<%=dept_nm%>
									<%}%>
								<% } %>     
		                    </td>
		                    <td width='5%' align='center'><%=ht.get("USER_NM")%><%=loan_chk%></td>
...
<!-- 평가기준 -->
  <table width="1000" border="0" cellspacing="0" cellpadding="0">
  	<tr> 
      <td colspan=2><font color="#FF00FF">♣ 적용대수</font>       : (일반식 *3) + 기본식  
        &nbsp;&nbsp;</td>
   	</tr>
   </table>	 
