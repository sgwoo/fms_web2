...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
 	<FRAME SRC="./sale_cost_goodNuser_sh.jsp<%=valus%>" name="c_head" frameborder=0 marginwidth="10" marginheight="10" scrolling="no" noresize>	
	<FRAME SRC="./sale_cost_goodNuser_sc.jsp<%=valus%>" name="c_body" frameborder=0 marginwidth="10" topmargin=0 scrolling="auto" noresize>	
</FRAMESET>
<NOFRAMES>
<BODY>
