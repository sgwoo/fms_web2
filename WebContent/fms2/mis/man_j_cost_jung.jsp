...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 비용관리 > <span class=style5>월평균관리비용현황(1군 - 정비)</span></span></td>
    ...
    <tr> 
        <td colspan="4"><iframe src="./man_j_cost_jung_view.jsp?auth_rw=<%=auth_rw%>&user_id=<%=s_user%>" name="i_view" width="100%" height="550" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
        </td>
    </tr>
</table>    
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr> 
  	...
  	<tr> 
       ...
       <tr> 
        <td colspan=2><font color="#FF00FF">♣ 예비차 정비</font> :   기본식 ->지점별 평균비용(지점별 예비차 전체비용/지점인원수 )/캠페인전체대수 * 기본식전체대수 ,  일반식 -> 지점별 평균비용(지점별 예비차 전체비용/지점인원수 )/캠페인전체대수 *일반식전체대수 로 반영</td>
    </tr>
