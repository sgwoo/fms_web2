...
function updateVar(){
	...
	fm.action = "/fms2/mis/man_cost_var_iu.jsp";
	fm.target = 'i_no';
	fm.submit();
}
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 비용관리 > <span class=style5>월평균관리비용현황(1군)</span></span></td>
    ...
    <tr> 
        <td colspan="4"><iframe src="./man_cost_jung_view.jsp?auth_rw=<%=auth_rw%>&user_id=<%=s_user%>" name="i_view" width="100%" height="550" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
        </td>
    </tr>
</table>    
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
	<tr> 
  	...
  	<tr> 
        <td colspan=2><font color="#FF00FF">♣ 관리비용</font> : ((기본식평균/전체기본식평균)*(기본식비용/비용(본인))+(일반식평균/전체일반식평균)*(일반식비용/비용(본인)))*1대당평균관리비용(전체비용/전체대수)  </td> 
