...
<body>
<form name='form1' action='sale_cost_good_sc.jsp' target='c_body' method='post'>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > <span class=style5>상품별영업효율현황</span></span></td>
    ...
    <tr>
	    ...
	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
			...
			&nbsp;
                        ...
                        ~
                        <input type="text" name="end_dt" size="11" value="<%= AddUtil.ChangeDate2(end_dt) %>" class=text onBlur='javascript:this.value=ChangeDate(this.value)'>
                    </td>
                </tr>
            </table>
	</td>
