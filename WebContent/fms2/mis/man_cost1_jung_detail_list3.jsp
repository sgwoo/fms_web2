...
//	int bus_cost_per 	=100;
//	int mng_cost_per 	= 100;
	...
	String mng_br_nm = c_db. getNameById(mng_id, "USER_BR");
	if ( mng_br_nm.equals("본사") ) {
		mng_br_id = "S1";
	}  else if ( mng_br_nm.equals("부산") ) {
		mng_br_id = "B1";
	}  else if ( mng_br_nm.equals("대전") ) {
		mng_br_id = "D1";
	}
...
<%	Vector vts2 = ac_db.getDlyCostStatMList1(save_dt, mng_id, amt1, amt2, amt1_per, amt2_per, amt3_per, bus_cost_per, mng_cost_per, gg, mng_br_id);
	...
	<td class='line' width='56%'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
         <tr>
            ...
            <% if ( gg.equals("01") ||    gg.equals("04")  ) {%>        
             <td width="12%"  class="title">등록일</td>
             <% }  else   {%>
              <td width="12%"  class="title">거래일</td>
              <% } %> 
            <td width="8%"  class="title">과실<br>비율</td>
            <td width="14%"  class="title">적용금액</td>
	...
	<td class='line' width='56%'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr> 
            ...
            <td width='12%' align="center"><%=String.valueOf(ht.get("RENT_WAY"))%> </td>
            <td width='20%' align="center"><%=Util.subData(String.valueOf(ht.get("ETC")), 8)%></td>
            <td width='12%' align="center"><%=ht.get("J_DT")%></td>
            <td width='8%' align="right"><%=Util.parseDecimal(String.valueOf(ht.get("PER")))%>
            <% if(gg.equals("04")) { %>(<%=Util.parseDecimal(String.valueOf(ht.get("AVE_PER")))%>)
            
            <% } %>
            </td>
            <td width='14%' align="right"><%=Util.parseDecimal(l_a_amt)%></td>
