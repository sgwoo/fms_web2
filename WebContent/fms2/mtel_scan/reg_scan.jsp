...
//		fm.target = "i_no";
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.STAT_CMP%>";
		fm.submit();
	}
//-->
</script>
...
<form name='form1' action='' method='post' enctype="multipart/form-data">
  ...
  <input type='hidden' name="c_mm" 			value="<%=c_mm%>">
        ...
        <td align="right" class="line">
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
					...
					<input type='hidden' name="<%=Webconst.Common.contentSeqName %>" size='' class='text' value='<%=save_dt%><%=seq%><%=c_yy%><%=c_mm%><%=gubun%>' />
