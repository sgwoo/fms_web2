...
function save()
{
	...
	fm2.st_year.value = fm.st_year.value;
	fm2.st_mon.value = fm.st_mon.value; 
	fm.<%=Webconst.Common.contentSeqName%>.value = '<%=AddUtil.ChangeString(AddUtil.getDate())+seq%>'+fm2.st_year.value+fm2.st_mon.value+'8';
			...
			<select name="st_mon">
                ...
                <tr> 
                    ...
                    <td colspan="2" >&nbsp; 
                      ...
                      <input type='hidden' name="<%=Webconst.Common.contentSeqName %>" size='' class='text' value='' />
