...
<!--
	function search()
	{
		...
		fm.target = "c_foot";
		fm.action = "/fms2/con_fee/scd_cng_sc.jsp";	
		fm.submit();
	}
...
<form name='form1' action='/fms2/con_fee/scd_cng_sc.jsp' target='c_foot' method='post'>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계출관리 > <span class=style5>대여료스케줄변경이력</span></span></td>
                ...
                <tr>
                    ...
                    <td width=90%>&nbsp;
            		    <select name='s_kd'>
						  ...
						  <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>변경등록자</option>
						  <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>변경항목</option>						  
						  <option value='7' <%if(s_kd.equals("7")){%>selected<%}%>>변경사유</option>						  						  
                        </select>
            			&nbsp;&nbsp;&nbsp;
