...
<%
	...
	Vector vt = af_db.getFeeScdListAll(br_id, gubun1, gubun2, gubun3, gubun4, st_dt, end_dt, s_kd, t_wd, sort_gubun, asc);
	int vt_size = vt.size();
%>
...
<%		for(int i = 0 ; i < vt_size ; i++){
			...
			//계약승계 미이관분 제외
			if(String.valueOf(ht.get("RENT_L_CD")).equals("B106HRTR00152") && String.valueOf(ht.get("RENT_ST")).equals("2") ) continue;
			if(String.valueOf(ht.get("RENT_L_CD")).equals("S107HB4L00081") && String.valueOf(ht.get("RENT_ST")).equals("2") ) continue;
			if(String.valueOf(ht.get("RENT_L_CD")).equals("S107HB4L00081") && String.valueOf(ht.get("RENT_ST")).equals("3") ) continue;
			if(String.valueOf(ht.get("RENT_L_CD")).equals("S107HTGR00142") && String.valueOf(ht.get("RENT_ST")).equals("1") ) continue;
			if(String.valueOf(ht.get("RENT_L_CD")).equals("S107HTGR00142") && String.valueOf(ht.get("RENT_ST")).equals("2") ) continue;
...
<%		for(int i = 0 ; i < vt_size ; i++){
			...
			%>
		        <tr>
        			...
        			<td <%if(end_yn.equals("종료"))%>class=is<%%> align='center' width='70'><%=ht.get("CON_MON")%>개월</td>					
