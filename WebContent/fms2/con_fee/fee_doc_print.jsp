      ...
      <td width="100%" align='center'>
	    <table width="100%" border="0" cellspacing="1" cellpadding="0">
          ...
          for(int i=0;i < vid_size;i++){
					...
					int opt_cng = 0;
					if(d_bean.getO_opt_amt()-d_bean.getN_opt_amt()>0 || d_bean.getO_opt_amt()-d_bean.getN_opt_amt()<0) opt_cng++;
					int cls_cng = 0;
					if(d_bean.getO_cls_per()-d_bean.getN_cls_per()>0 || d_bean.getO_cls_per()-d_bean.getN_cls_per()<0) cls_cng++;
					%>
          <tr bgcolor="#FFFFFF" align="center"  height="50">
            ...
            <td style="font-size : 10pt;" width="20%"><font face="굴림"><%=cha.getCh_before()%></font></td>
            <td style="font-size : 10pt;" width="20%"><font face="굴림"><%=cha.getCh_after()%></font></td>			
			<%		}%>
          </tr>
           <%		if(ins_cha_size>1){%>
