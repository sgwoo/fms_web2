...
<%
	...
	String tae_tm_cng 	= request.getParameter("tae_tm_cng")==null?"":request.getParameter("tae_tm_cng");
	String tae_cng_fee_tm 	= request.getParameter("tae_cng_fee_tm")==null?"":request.getParameter("tae_cng_fee_tm");
	...
	/*
	out.println("fee_scd.getTm_st2()="+fee_scd.getTm_st2());
	out.println("tae_tm_cng="+tae_tm_cng);
	out.println("fee_scd.getFee_tm()="+fee_scd.getFee_tm());
	out.println("tae_cng_fee_tm="+tae_cng_fee_tm);
	*/
	
	//0회차로 변경
	if(tae_tm_cng.equals("1")){
		if(!af_db.updateScdFeeTaeTmCng1(l_cd, fee_scd.getFee_tm(), "0")) flag += 1;
	}
	
	//1회차로 변경 (다음스케줄 회차 전체 밀림)
	if(tae_tm_cng.equals("2")){
		if(!af_db.updateScdFeeTaeTmCng2(l_cd, fee_scd.getFee_tm(), tae_cng_fee_tm)) flag += 1;
	}
