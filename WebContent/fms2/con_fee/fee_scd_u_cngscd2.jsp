...
<!--
	...
	function cng_schedule()
	{
		...
		if(fm.f_use_start_dt.value 	== '')			{	alert('사용기간을 입력하십시오'); 		fm.f_use_start_dt.focus(); 	return; }
		if(fm.f_use_end_dt.value 	== '')			{	alert('사용기간을 입력하십시오'); 		fm.f_use_end_dt.focus(); 	return; }		
		if(fm.cng_cau.value 	== '')				{	alert('변경사유를 입력하십시오'); 		fm.cng_cau.focus(); 		return; }				
		...
		a_dt 	= fm.f_use_start_dt.value;
		b_dt 	= fm.f_use_end_dt.value;			
		a_dt_nm = '사용기간이';
		...
		{							
			fm.action = './fee_scd_u_cngscd2_a.jsp';
			fm.target = '_self';
			fm.submit();
		}
	}		
	...
	<tr>
	    <td align='right' class="line">
            ...
            <%		for(int i = 0 ; i < 1 ; i++){
                ...
                <tr> 
                    <td width=100 class='title'>사용기간</td>
                    <td>&nbsp;<input type='text' name='f_use_start_dt' value='<%=AddUtil.ChangeDate2(fee_scd.getUse_s_dt())%>' maxlength='10' size='11' class='text' onBlur='javscript:this.value = ChangeDate4(this, this.value);'>
                    ~ 
                    <input type='text' name='f_use_end_dt' value='<%=AddUtil.ChangeDate2(fee_scd.getUse_e_dt())%>' maxlength='10' size='11' class='text' onBlur='javscript:this.value = ChangeDate4(this, this.value);'> 
                    </td>
                </tr>
                <tr>
                    <td class='title'>변경일자</td>
                    <td>&nbsp;<input type="checkbox" name="maxday_yn" value="Y"> 말일
                        <font color=red>&nbsp;(기간 종료일자가 말일일때 선택하세요.)</font></td>
                </tr>
                <tr>
                    <td class='title'>변경사유</td>
                    <td>&nbsp;<textarea name="cng_cau" cols="82" rows="2" class=default>수정</textarea></td>
                </tr>
            </table>
	    </td>
    </tr>
