...
<% 
	...
	d_bean.setMsgflag     		(0);	
	d_bean.setContent			("http://fms1.amazoncar.co.kr/mailing/ins/fee_doc_task_docs.jsp?rent_mng_id="+rent_mng_id+"&rent_l_cd="+rent_l_cd+"&ins_doc_no="+ins_doc_no+"&doc_no="+doc_no);
	d_bean.setEncoding			(0); 
	d_bean.setAtc_set			(1);
