...
<body>
<form name='form1' action='label_fee_scd_sc.jsp' target='c_body' method='post'>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계출관리 > <span class=style5>계약봉투 라벨 스티커 출력 </span></span></td>
                ...
                <tr> 
                    <td width='17%'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_dygb.gif align=absmiddle>&nbsp;
                        <select name="gubun4">
							...
							<option value="2" <%if(gubun4.equals("2")){%>selected<%}%>>신규</option>
                        </select>			
        		    </td>
                    ...
                    <td width=16%>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td id='td_dt' <%if(gubun2.equals("3")){%>style="display:''"<%}else{%>style='display:none'<%}%>><input type='text' size='11' name='st_dt' class='text' value='<%=st_dt%>'>
                      			~
