...
<%	if(vt_size > 0){%>
         		<tr>            		
		                    ...
		                    <tr class=line> 
        		                ...
        		                <td align="center" width=25%>
        		                 ...
        		                 <% } %>
        				           ...
        				           <%} else { %> 
        				                   <td align="center" width=50%><a href="javascript:parent.view_cont('<%=ht.get("RENT_MNG_ID")%>','<%=ht.get("RENT_L_CD")%>','<%=ht.get("CAR_MNG_ID")%>','<%=ht.get("SERV_ID")%>', '<%=ht.get("P_GUBUN")%>')">&nbsp;<%=ht.get("RENT_L_CD")%></a></td>   
        				           <% } %>  
		                    </tr>
		             <%}%> 
		                </table>
            		...
            		<td class=line>
            			<table border=0 cellspacing=1 width=1180>
                          <% for (int i = 0 ; i < vt_size ; i++){
            					Hashtable ht = (Hashtable)vt.elementAt(i);%>
                          <tr> 
...
<%	if(vt_size == 0){%>
	            <tr>            		
                    ...
                    <td class=line>
                        <table border=0 cellspacing=1 width=1160>
            				<tr>
            					<td> &nbsp;등록된 데이타가 없습니다.</td>
            			    </tr>
            			</table>
