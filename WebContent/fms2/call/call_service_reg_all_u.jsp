...
//	String p_gubun 	= request.getParameter("p_gubun")==null?"":request.getParameter("p_gubun");
	...
	//service_call정보
 	Vector vt		= p_db.getServicePollAll(m_id, l_cd, c_id, s_id);
 	int vt_size = vt.size();

 	//live_poll정보
 	Vector vt_live		= p_db.getPollTypeAll("2");  //서비스정보
...
<% } %>	  	 	  	
		...
		if(confirm('수정하시겠습니까?')){
			fm.target='c_foot';
			fm.action='call_service_reg_all_u_a.jsp';
			fm.submit();
		}
	}
...
<table border='0' cellspacing='0' cellpadding='0' width='100%'>
    ...
    <tr> 
        <td align='left'>  
        <img src=/acar/images/center/icon_arrow.gif align=absmiddle>&nbsp;<a name="car"><b>정비내역</b></a></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width=100%>
                <tr> 
                    <td class='line'>
                        <table border="0" cellspacing="1" cellpadding="0" width=100%>                   
                            <tr> 
                               	<td class='title' width='110'> 정비일 </td>
                                <td >&nbsp; <input type='text' name='serv_dt' value='<%=serv_dt%>' class='whitetext' readonly size="13" > 
                                </td>
                               	<td class='title' width='110'> 결재 </td>
                                <td >&nbsp; <input type='text' name='p_gubun' value='<%=p_gubun%>' class='whitetext' readonly size="13" > 
                                </td>
                                <td class='title' width='110'> Call 대상자 </td>
                                <td >&nbsp; <input type='text' name='call_t_nm' value='<%=call_t_nm%>' class='whitetext' readonly size="13" > 
                                </td>
                                <td class='title' width="110">연락처</td>
                                <td >&nbsp; <input type='text' name='call_t_tel' value='<%=call_t_tel%>' class='whitetext' readonly size="13" > 
                                </td>                              
                            </tr>     
                     
               		 <tr> 
                                <td class='title' width='110'> 정비내용 </td>
                                <td colspan=3>&nbsp;<textarea rows='2' cols='75'  name='serv_item_nm' ><%=serv_item_nm%></textarea>
                                </td>
                                 <td class='title' width="110">정비업체</td>
                                <td >&nbsp; <input type='text' name='off_nm' value='<%=off_nm%>' class='whitetext' readonly size="20" > 
                                </td>      
                                <td class='title' width='110'> 금액 </td>
                                 <td >&nbsp; <input type='num' name='buy_amt' value='<%=Util.parseDecimal(buy_amt)%>' class='whitenum' readonly size="13" >&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            </tr>             
