...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0 background=/acar/images/center/menu_bar_bg.gif>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>콜센터 > 순회정비 > <span class=style5>정비현황</span></span></td>
	...
	<form action="./car_service_sc.jsp" name="RentCondSearchForm" method="POST" target="c_foot">
    <tr>
        <td>
            <table border=0 cellspacing=1 width=100%>
                <tr> 
                    ...
                    <td>&nbsp;</td>
                <!--    <td align=right width=47><a href='javascript:nocall()' onMouseOver="window.status=''; return true" onfocus="this.blur()"><img src=/acar/images/center/button_bd.gif border=0 align=absmiddle></a></td> -->
                    <%}%>          
                </tr>
            </table>
        </td>
