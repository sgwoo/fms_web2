...
<%
	...
	Vector vt = ai_db.getInsureStatSearchList("scar");
	int vt_size = vt.size();
%>
...
<table border="0" cellspacing="0" cellpadding="0" width='2260'>
    <tr>
		...
		<td class='line' width='1890'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				<tr>
				  ...
				  <td style="font-size:8pt" width='60' rowspan="2" class='title'>담당자</td>				  
...
%>			
				<tr>
					...
					<td style="font-size:8pt"  width='60' align='center'><%=ht.get("담당자")%></td>					
