...
<!--
	...
	function SearchopenBrWindow() { 
		...
		var fm = document.form1;
		fm.action = "/acar/ins_cls/search.jsp";		
		fm.target = "SEARCH";
		fm.submit();		
	}
//-->
...
<form action='' name="form1" method='post'>
  ...
  <input type="hidden" name="go_url" value="/fms2/insure/ins_doc_reg_c.jsp">      
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > 문서기안 > <span class=style5>보험변경문서등록</span></span></td>
