    		...
    		<div id="container" style="background-color:white;"> <!-- 전체 비율 중 중앙비율  -->
    			<div id="con1">
    				...
    				<table width="610" height="30" align="center" >
		                ...
		                <tr bgcolor="#FFFFFF" align="center"  height="30">	
						    ...
						    <td style="font-size : 10pt;" width="20%">
						    	<%=AddUtil.parseDecimal(d_bean.getO_fee_amt())%><%if(d_bean.getO_fee_amt()>0){%><br>(vat 포함)<%}%>
						    </td>
						    <td style="font-size : 10pt;" width="20%">
						    	<%=AddUtil.parseDecimal(d_bean.getN_fee_amt())%><%if(d_bean.getN_fee_amt()>0){%><br>(vat 포함)<%}%>
						    </td>
						    <%
    			...
    			<div id="con2">
		            ...
		            <!--     
						...
						-->
						<tr bgcolor="#FFFFFF" align="center" > 
		  					<td  rowspan="2" style="font-size : 11pt;" width="140" height="20">개시일</td>
		                    <td  colspan="2" style="font-size : 11pt;" height="20">종료예정일</td>
		                    <td  rowspan="2" style="font-size : 11pt;" width="140" height="20">“미정” 선택 시 <br/> 주의 사항</td>		
		                </tr>
		                 <tr bgcolor="#FFFFFF" align="center"> 
		                    <td style="font-size : 11pt;" width="110" height="20">확정일자</td>
		                    <td style="font-size : 11pt;" width="110" height="20">미정</td>		
		               	</tr>
			            <tr bgcolor="#FFFFFF" align="center"  height="100">
					    	<td style="font-size : 11pt;" rowspan=''>20&nbsp;&nbsp;&nbsp;년&nbsp;&nbsp;&nbsp;&nbsp;월&nbsp; &nbsp;&nbsp;&nbsp;일 <br/><br/>24시(부터)</td>
					    	<td style="font-size : 11pt;" rowspan=''>20&nbsp;&nbsp;&nbsp;년&nbsp;&nbsp;&nbsp;&nbsp;월 &nbsp;&nbsp;&nbsp;&nbsp;일 <br/><br/>24시(까지)</td>
							...
							【 <input type="checkbox" > 】
						   		 ...
						   		 <td style="font-size : 10pt; padding-left:10px;" align='left' >
						    		가)미정에 선택(√) 체크<br/><br/>
						    		나)종료일이 확정되면&nbsp;&nbsp;&nbsp;<br/>확정일을 명시한 요청서를 <br/>재차 접수해야 합니다<br/>
						   		 </td>
						    <%	}%>
						</tr>
...
<%--     			<div><%=item%> <%=amt_comp%> <%=before%> <%=after %> </div> --%>
    			<%if( item.equals("연령변경")  && before.equals("26세이상") && after.equals("21세이상")){%>
    				<div id="con3">
    				<div id="con3Title">
    				...
    				<table width="610" height="60" align="center" >
						<tr bgcolor="#FFFFFF" align="center"> 
							<td style="font-size : 11pt;" width="20%">운전자(최저연령)</td>
		                    <td style="font-size : 11pt;" width="20%">생년월일</td>
		                    <td style="font-size : 11pt;" width="20%">나이</td>
		                    <td style="font-size : 11pt;" width="20%">면허취득연도</td>
		                    <td style="font-size : 11pt;" width="20%">계약자와의 관계</td>		
		                </tr>
		                </tr>     	
							<td style="font-size : 10pt;" width="20%">&nbsp;</td>
							<td style="font-size : 10pt;" width="20%">&nbsp;</td>		
							<td style="font-size : 10pt;" width="20%">&nbsp;(만 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;세)</td>
							<td style="font-size : 10pt;" width="20%">&nbsp;</td>	
							<td style="font-size : 10pt;" width="20%">&nbsp;</td>				
						</tr>						
			       	</table>
	   		...
	   		<!-- 	<p style="margin:0px;font-size:11pt;padding:3px;font-family:궁서;">당일 신청 건은 오후 4시전까지 회신부탁드립니다.</p>
	   			...
	   			<p style="margin:0px;font-size:10pt;padding:3px;">※ 변경보험의 효력개시</p>
	   			<p style="margin:0px;font-size:10pt;padding:3px;">&nbsp;&nbsp;▷ <span style="color: red;font-weight: bold;text-decoration: underline;">신청일16시 이전 접수 완료【접수한 당일 24시부터 유효】</span></p>
	   			<p style="margin:0px;font-size:10pt;padding:3px;">&nbsp;&nbsp;▷ <span style="color: red;font-weight: bold;text-decoration: underline;">신청일16시 이후 접수 완료【접수한 다음 날 24시부터 유효】</span></p>
	   			<p style="margin:0px;font-size:10pt;padding:3px;">※ 자동차보험 계약사항 변경에 따라 대여료가 변경될 예정입니다.</p>
	   			
	   			<% if(r_fee_est_dt != ""){ %>
					<p style="margin:0px;font-size:10pt;padding:3px;">&nbsp;&nbsp;(다음 결제예정일 : <%=year%>년 <%=mon%>월 <%=day%>일부터)</p>
				<%} %>	
				<!-- <p style="margin:0px;font-size:10pt;padding:3px;">1. 변경에 따른 대여료 조정이 있습니다.</p> -->
					<p style="margin:0px;font-size:10pt;padding:3px;">※ 본 문서 계약자란에 명판과 직인을 날인하고 아래 FAX로 회신해 주십시오.</p> 
