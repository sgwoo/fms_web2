...
<%
	...
	for(int i=0; i < file_seq.length; i++){
		ht = ic_db.getInsComFilereqSelect(file_seq[i]);
		vt.add(ht);
	}
...
<body topmargin=0 leftmargin=0>
 <table width=700 border=0 cellspacing=0 cellpadding=0 align=center>
    ...
    <tr>
        <td><img src=http://fms1.amazoncar.co.kr/mailing/ins/images/layout_top_ins_file2.png></td>
    </tr>
    <tr>
    ...
    <tr>
        <td align=center background=http://fms1.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=676 border=0 cellspacing=0 cellpadding=0 background=http://fms1.amazoncar.co.kr/mailing/rent/images/e_bg_fine1.gif>
                <tr>
                    <td width=20>&nbsp;</td>
                    <td width=435 height=35 align="left" style="font-family:nanumgothic;font-size:12px;"><b><%=ht.get("FIRM_NM") %> </b>님</td>
                    <td width=221 align="left" style="font-family:nanumgothic;font-size:12px;"><img src=http://fms1.amazoncar.co.kr/mailing/rent/images/e_ddj.gif align=absmiddle>&nbsp;&nbsp;<%=ht.get("REG_NM")%>&nbsp;&nbsp;(&nbsp;<%=ht.get("TEL")%>&nbsp;)</td>
                </tr>
            </table>
        </td>
    </tr>
    <tr>
        <td align=center background=http://fms1.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=676 border=0 cellspacing=0 cellpadding=0 background=http://fms1.amazoncar.co.kr/mailing/rent/images/e_bg_fine2.gif>
                <tr>
                    <td height=10></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan=3><img src=http://fms1.amazoncar.co.kr/mailing/rent/images/e_bg_fine_dw.gif></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td height=30 align=center background=http://fms1.amazoncar.co.kr/mailing/images/layout_bg.gif></td>
    </tr>
    <tr>
        <td align=center background=http://fms1.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=656 border=0 cellspacing=0 cellpadding=0>
                ...
                <tr>
                    <td align="left">&nbsp;&nbsp;&nbsp;<img src=http://fms1.amazoncar.co.kr/mailing/ins/images/e_bar_est_file.gif></td>
                </tr>
                <tr>
                    <td height=5></td>
                </tr>
							...
							for(int k=0;k<vt.size();k++){
 							...
 							%>
        						 <tr bgcolor=#ffffff>
									...
									<td align=center style="font-family:nanumgothic;font-size:12px;"><a href="javascript:openPopP('<%=ht2.get("FILE_TYPE")%>','<%=ht2.get("FILE_SEQ")%>');" title='보기' ><%=ht2.get("INS_CON_NO")%></a></td>
								 </tr>
						<% }%>                            
                        </table>
                    </td>
    ...
    <tr>
        <td background=http://fms1.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=700 border=0 cellspacing=0 cellpadding=0>
                <tr>
                    <td width=35>&nbsp;</td>
                    <td width=85><img src=http://fms1.amazoncar.co.kr/mailing/images/bottom_logo.gif></td>
                    <td width=28>&nbsp;</td>
