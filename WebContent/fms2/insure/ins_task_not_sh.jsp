    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>사고 및 보험 > 보험관리 > <span class=style5>업무보험미가입현황</span></span></td>
                ...
                <tr>
                    ...
                    <td width=8%>&nbsp;
                        <select name="gubun5" >
                            ...
                            <option value="0038" <%if(gubun1.equals("0038")){%>selected<%}%>>렌터카공제조합</option>
                            <option value="0008" <%if(gubun1.equals("0008")){%>selected<%}%>>동부화재</option>
                    ...
                    <td class=title width=8%>보험만료일</td>
                    <td width=10%>&nbsp;
        	    	 ...
        	    	 <td class=title width=8%>가입여부(계약)</td>
                    <td width=8%>&nbsp;
                        <select name="gubun4">
                       		<option value="" <%if(gubun4.equals("")){%>selected<%}%>>전체</option>
                            <option value="N" <%if(gubun4.equals("N")){%>selected<%}%>>미가입</option>
                            <option value="Y" <%if(gubun4.equals("Y")){%>selected<%}%>>가입</option>
                            <option value="S" <%if(gubun4.equals("S")){%>selected<%}%>>선택</option>
                        </select>
        	    	</td>			  		  
                    <td class=title width=8%>가입여부(보험)</td>
                    <td width=8%>&nbsp;
                        <select name="gubun2">
	        	    ...
	        	    <td class=title width=9%>정렬조건</td>
                    <td width=25%>&nbsp;
                        <select name="gubun3">
                            <option value="" <%if(gubun3.equals("")){%>selected<%}%>>상호명</option>
                       		<option value="3" <%if(gubun3.equals("3")){%>selected<%}%>>보험시작일</option>
