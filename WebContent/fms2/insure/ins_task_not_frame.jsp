...
<%
	...
	String valus = 	"?auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+
			"&s_kd="+s_kd+"&t_wd="+t_wd+"&gubun1="+gubun1+"&gubun2="+gubun2+
		   	"&sh_height="+height+"&gubun3="+gubun3+"&gubun4="+gubun4+"";
%>
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./ins_task_not_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./ins_task_not_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>