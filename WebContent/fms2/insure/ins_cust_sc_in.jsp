...
<%
	...
	Vector vt = ai_db.getInsureStatSearchList("cust");
	int vt_size = vt.size();
%>
...
<table border="0" cellspacing="0" cellpadding="0" width='2420'>
    <tr>
	...
	<tr id='tr_title' style='position:relative;z-index:1'>
		<td class='line' width='440' id='td_title' style='position:relative;'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
			  <tr>
				...
				<td colspan="3" class='title'>차량사항</td>
				<td width='70' rowspan="2" class='title'>매매일자</td>				
			  </tr>    
			  <tr>
		...
		<td class='line' width='1980'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				<tr>
				  <td style="font-size:8pt" width='80' rowspan="2" class='title'>보험사</td>
				  <td style="font-size:8pt" width='80' rowspan="2" class='title'>에어백</td>
				  <td style="font-size:8pt" width='150' rowspan="2" class='title'>피보험자</td>
				  <td style="font-size:8pt" width='150' rowspan="2" class='title'>계약자</td>
				  <td style="font-size:8pt" colspan="7" class='title'>보험가입사항</td>
				  <td style="font-size:8pt" colspan="2" class='title'>보험기간</td>
			      <td style="font-size:8pt" colspan="10" class='title'>보험료</td>
		      </tr>
				<tr>
			      ...
			      <td style="font-size:7pt" width='80' class='title'>블래박스할인</td>
...
%>
				<tr>
					...
					<td style="font-size:8pt"  width='70' align='center'><%=ht.get("매매일자")%></td>										
				</tr>
<%
		}
%>
...
%>			
				<tr>
					<td style="font-size:8pt"  width='80' align='center'><span title='<%=ht.get("보험사")%>'><%=Util.subData(String.valueOf(ht.get("보험사")), 5)%></span></td>
					...
					<td style="font-size:8pt"  width='150' align='center'><span title='<%=ht.get("계약자")%>'><%=Util.subData(String.valueOf(ht.get("계약자")), 10)%></span></td>
				    ...
				    <td style="font-size:8pt"  width='80' align='right'><%=ht.get("블랙박스할인")%></td>
