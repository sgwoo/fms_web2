...
/* 		System.out.println("ch_val[0]:"+ch_val[0]); */
		ht = ic_db.getInsComFileSelect(ch_val[0]);
		...
		if (!client_id.equals(compare_id) ||  i == list.size()-1) {
			...
			<%
				...
				if (overchk == 0) {
					...
					d_bean.setMsgflag     		(0);
					d_bean.setContent			("http://fms1.amazoncar.co.kr/mailing/ins/ins_file_docs2.jsp?"+file_seq);
