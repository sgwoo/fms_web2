...
%>
<form name='form1' action='cls_sc2.jsp' target='c_body' method='post'>
<input type='hidden' name='auth_rw' value='<%=auth_rw%>'>
<input type='hidden' name='user_id' value='<%=user_id%>'>
<input type='hidden' name='br_id' value='<%=br_id%>'>
<input type='hidden' name='sh_height' value='<%=sh_height%>'>
<input type='hidden' name='gubun1' value='6'>
<input type='hidden' name='gubun2' value='6'>
	...
	<tr >
		<td colspan=7 style="height: 30px">
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class="navigation">&nbsp;<span class=style1>재무회계 > 수금관리 > <span class=style5>해지 정산금 (계약별)</span></span></td>
				</tr>
			</table>
		</td>
	</tr>
            ...
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <input type="button" class="button" value="검색" onclick="javascript:search();">  
                     <input type="button" class="button" value="건별" onclick="javascript:search2();">              
                    </td>
                </tr>
            </table>
        </td>
