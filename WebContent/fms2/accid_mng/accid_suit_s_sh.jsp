...
%>
<form action="./accid_suit_s_sc.jsp" name="form1" method="POST" target="c_foot">
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr> 
      ...
      <td width=21%><img src=/acar/images/center/arrow_sgcr.gif  align=absmiddle>&nbsp;
        <select name="gubun3">
    ...
    <tr> 
      ...
      <td colspan="2"><img src=/acar/images/center/arrow_jr.gif  align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
        <select name="sort">
          ...
          <option value="5" <%if(sort.equals("5")){%> selected <%}%>>접수일</option>
        </select>
