...
<%@ page import="acar.util.*, java.text.*, acar.coolmsg.*"%>
...
<%
	...
	if(!cp_bean.getOut_content().equals("발송")){
		...
		if(count > 0){
			...
			String title = "채무자주소조회요청 반려";
	    	String sender_id = suser.getId();
	    	String sender_nm = suser.getUser_nm();
			
	    	String content= cp_bean.getTitle()+ "[반려]고객의 \n"+ 
	    				"채무자주소조회요청이 반려처리되었습니다. 확인부탁드립니다.";
