...
<!--
	...
	function save(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/acar/upload/coop_reg_scan_a.jsp";
//		fm.target = "i_no";
		fm.submit();
	}
...
//		fm.target = "i_no";
	...
	function file_save(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.COOPERATION%>";
		fm.submit();
	}
//-->
</script>
