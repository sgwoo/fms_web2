...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "01", "09", "01");
...
<frameset rows="<%=height%>, *" border=1 name=ex>
        <frame src="/fms2/cooperation/cooperation_sh.jsp<%=valus%>" name="c_head" marginwidth=10 marginheight=10 scrolling="no" noresize>
		<frame src="/fms2/cooperation/cooperation_sc.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling="auto">
</frameset>
</HTML>
