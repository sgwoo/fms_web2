...
<script language="JavaScript">
	function search()
	{
		...
		fm.action = 'cooperation_n3_sc.jsp';
		fm.target = 'inner';
		fm.submit();
...
<body>
<form name='form1' action='' method='post' target='c_body'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>채권관리 > <span class=style5>채권자주소조회요청</span></span></td>
              ...
              <tr>
                ...
                <td width="40%">&nbsp;
                  <select name='gubun2'>
                    ...
                    <option value="3" <%if(gubun2.equals("3"))%>selected<%%>>반려</option>
                  </select></td>
              </tr>
              <tr>
