    	...
    	<td colspan="2">
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>채권관리 > <span class=style1>채무자주소조회요청 ><span class=style5>스캔관리</span></span></td>
...
//						ContCarBean fee_etcs = a_db.getContFeeEtc(m_id, l_cd, Integer.toString(i));%>
	...
	<table border="0" cellspacing="1" cellpadding="0" width=100%>
	  ...
	  <% if(attach_vt_size > 0){
			...
			if(!contentNm.equals("")){
				if(contentNm.contains("계약서") || contentNm.contains("사업자등록증") || contentNm.contains("인감증명서")){
	%>                
		<tr>
		    <td align="center"><%= count+1 %></td>
     		<td width='30' align='center'>
