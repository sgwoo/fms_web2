...
<frameset rows="<%=height%>, *" border=1 name=ex>
        <frame src="/fms2/cooperation/cooperation_p_sh.jsp<%=valus%>" name="c_head" marginwidth=10 marginheight=10 scrolling="no" noresize>
		<frame src="/fms2/cooperation/cooperation_p_sc.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling="auto">
</frameset>
</HTML>
