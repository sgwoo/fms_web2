...
<!--
	function search()
	{
		...
		fm.action = 'cooperation_it_sc.jsp';
		fm.target='c_body';
		fm.submit();
	}
	function enter(){
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 업무협조 > <span class=style5>IT마케팅팀 업무협조 </span></span></td>
              ...
              <tr>
                ...
                <td>&nbsp;
                  <select name='s_kd'>
                    ...
                    <option value='4' <%if(s_kd.equals("5")){%>selected<%}%>>요청자+처리자+등록자</option>
                  </select>
					&nbsp;&nbsp;&nbsp;
