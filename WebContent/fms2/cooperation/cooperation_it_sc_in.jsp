...
<%
	...
	Vector vt = cp_db.CooperationITList(s_year, s_mon, "", s_kd, t_wd, gubun1, gubun2, gubun3, gubun4);
	int vt_size = vt.size();
        ...
        <td class='line'>
            <table border=0 cellspacing=1 cellpadding=0 width='100%'>
				<tr>
					...
					<td width='10%' class='title'> 협조부서</td>
				...
				<tr>
					...
					<td width='10%' align='center'><%=ht.get("COM_NM")%></td>
					...
					<td width='10%' align='center'>IT마케팅팀</td>
					<td width='10%' align='center'><%=ht.get("SUB_NM")%></td>
					<td width='15%' align='center'><%if(ht.get("OUT_DT").equals("")){%>미처리<%}else{%><%=ht.get("OUT_DT")%><%}%></td>
				</tr>
				<%		}
					}else{%>
				<tr>
