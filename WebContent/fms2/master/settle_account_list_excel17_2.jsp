...
response.setHeader("Content-Disposition", "inline; filename=settle_account_list_excel17_2.xls");
%>
...
<%
	...
	Vector vt = ad_db.getSettleAccount_list17_2(settle_year);
	int vt_size = vt.size();
...
<form name='form1' action='' method='post'>
  ...
  <table border="0" cellspacing="1" cellpadding="0" width=<%=table_width%>>
	<tr>
	  <td align="center"><%=AddUtil.parseInt(settle_year)+1%>년  2월 대여료청구리스트 사용기간 년도별금액</td>
	</tr>		
	<tr>
	  <td>&nbsp;</td>	  
    </tr>		
