...
<%
	...
	if(c_id !=null ){
		...
		String file_name = "FMS 경매낙찰차량리스트 "+fm_start_dt+" ~ "+fm_end_dt;
		
	
		
		for(String car_mng_id : c_ids){
			Hashtable ht = ad_db.getInsideReq11_2(car_mng_id);
			...
			auc.setActn_num     (Integer.parseInt(String.valueOf(ht.get("ACTN_NUM")))   );
			...
			auc.setSt_pr        (Integer.parseInt(String.valueOf(ht.get("ST_PR")))      );
			...
			auc.setHp_pr        (Integer.parseInt(String.valueOf(ht.get("HP_PR")))      );
			auc.setFile_seq      (file_seq);
			auc.setD_gubun		("fms_nak");
