...
response.setHeader("Content-Disposition", "inline; filename=car_reg_cng_excel_list5_3.xls");
%>
...
<form name='form1' action='' method='post'>
  ...
  <table border="1" cellspacing="0" cellpadding="0" width=1100>
	<tr>
	  <td colspan="8" align="center"><%=c_db.getNameByIdCode("0032", "", car_ext)%> <%if(!car_ext.equals("")){%>지역번호<%}%> 차량 리스트 <%if(car_cnt>0){%>(<%=car_cnt%>대)<%}%></td>
	</tr>		
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	...
	<tr>
	  <td width="45" class="title">연번</td>
	  <td width="80" class="title">차량번호</td>
	  <td width="200" class="title">차명</td>
	  <td width="75" class="title">최초등록일</td>				  
	  <td width="50" class="title">등록지</td>	  
	  <td width="200" class="title">대여업체명</td>				  
	  <td width="75" class="title">대여개시일</td>
	  <td width="75" class="title">대여만료일</td>
	  <td width="200" class="title">임차인주소</td>
	  <td width="100" class="title">임차인연락처</td>
	</tr>
