...
<!--
	...
	function save(){
		...
		fm.action = 'car_tax_excel_reg_a.jsp';
		fm.target = '_blank';
		fm.submit();
	}
//-->
...
<table border="0" cellspacing="0" cellpadding="0" width="<%=30+(200*sheet.getColumns())%>">
  <tr>
    <td>&lt; 엑셀 파일 읽기 &gt; </td>
  </tr>
  <tr>
...
<%
	...
	for (int i = 0 ; i < vt_size ; i++){
        ...
        <tr>
		  ...
		  <% for(int j = 0; j < sheet.getColumns(); j++){%>
    	  <td width="200" align="center"><input name="value<%=j%>" type="text" class=text style1   value="<%=content.get(Integer.toString(j))%>" size="25"></td>
		  <%	}%>
  		</tr>
<%	}%>
	  </table>
