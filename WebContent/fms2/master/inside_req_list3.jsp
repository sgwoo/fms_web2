...
<table style="width:100%;">
 	<tr>
		<td style="text-align:center;"> <신차구입차량리스트> </td>
 	</tr>
 	<tr>
...
<script type="text/javascript">
	...
	myGrid.setImagePath("/fms2/lib/dhtmlx/skins/web/imgs/");//총0-25열(26개)
    ...
    gridQString = "inside_list3_xml.jsp?start_dt=<%=start_dt%>&end_dt=<%=end_dt%>";
