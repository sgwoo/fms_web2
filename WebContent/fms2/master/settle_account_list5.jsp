		...
		<td class=line>
			<table border=0 cellspacing=1 width=100%>
			    <tr>
				  ...
				  <td width="190" rowspan="2" class="title">차입처</td>
				  <td width="80" rowspan="2" class="title">용도</td>
				  <td colspan="3" class="title">전기</td>
				  <td colspan="4" class="title">당기</td>
				  <td width="80" rowspan="2" class="title">상환방법</td>
			    </tr>
			    <tr>
