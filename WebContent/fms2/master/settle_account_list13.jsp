...
<form name='form1' action='' method='post'>
  ...
  <table border="0" cellspacing="1" cellpadding="0" width=<%=table_width%>>
	<tr>
	  <td align="center"><%=AddUtil.parseInt(settle_year)%>년 계약 개시대여료 년도별 금액 (선수대여료스케줄)</td>
	</tr>		
	<tr>
	  <td>&nbsp;</td>	  
    </tr>		
		...
		<td class=line>
			<table border=0 cellspacing=1 width=100%>
			    <tr>
				  ...
				  <td colspan='3' class="title">약정개시대여료</td>
				  <td colspan='6' class="title">년도별 개시대여료(공급가)</td>
			    </tr>
			    <tr>
