...
response.setHeader("Content-Disposition", "inline; filename=settle_account_list_excel10_client.xls");
%>
...
<%
	...
	Vector vt = ad_db.getSettleAccount_list10(settle_year, "client");
	int vt_size = vt.size();
		...
		<td class=line>
			<table border=0 cellspacing=1 width=100%>
			    <tr>
				  ...
				  <td width="120" class="title">부가세포함</td>
