...
<!--
	...
	function save(){
		...
		fm.action = 'card_excel_all_upd_20120719_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
...
<table border="0" cellspacing="0" cellpadding="0" width="<%=30+(300*sheet.getColumns())%>">
  ...
  <tr>
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0" width=100%>  
        ...
        <tr>
    	  <td width="100" height="30" class="title">변경거래처</td>
    	  <td>&nbsp;
		  <input type='text' name='V_CD_PARTNER2' size='10' value='900142' class='text'>
		  (900142 삼성카드사)
        </tr>		
	  </table>
	</td>
  ...
  <tr>
    <td>※ 칼럼순 : [A]연번 [B]거래처코드 [C]거래처명 [D]금액 </td>
  </tr>        
  <tr>
    <td>&nbsp;</td>
  </tr>    
