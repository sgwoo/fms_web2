...
<%
	...
	Vector vt = ad_db.getSelectStatEndCont13ListDB(save_dt);
	int vt_size = vt.size();
...
<body>
<table border="1" cellspacing="0" cellpadding="0" width=1490>
	<tr>
	  <td colspan="14" align="center">○ 신규영업 중단하고 대여사업 계속시 현재가치</td>
	</tr>		
	<tr>
	  <td colspan="14" align="right">단위:원, 기준일자(<%=save_dt%>)</td>
	</tr>			
	<tr>
	...
	<tr>
	  ...
	  <td width="110" class="title">보증금<br>현재가치</td>	  
	  <td width="110" class="title">합계</td>
	  <td width="110" class="title">만기시잔가<br>현재가치</td>
	  <td width="110" class="title">대여료<br>현재가치</td>
	  <td width="110" class="title">비용<br>현재가치</td>
	  <td width="110" class="title">합계</td>	  
	</tr>
	<%	int etc_count = 0;
			for(int i = 0 ; i < vt_size ; i++){
