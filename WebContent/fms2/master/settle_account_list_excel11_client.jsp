...
response.setHeader("Content-Disposition", "inline; filename=settle_account_list_excel11_client.xls");
%>
...
<%
	...
	Vector vt = ad_db.getSettleAccount_list11(settle_year, "client");
	int vt_size = vt.size();
