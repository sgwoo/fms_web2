...
<%
	...
	String sms_ok 	= file.getParameter("sms_ok")==null?"":file.getParameter("sms_ok");
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<!--
	...
	function save(){
		...
		fm.action = 'conv_busidmngid_excel_reg_a.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
...
<input type='hidden' name='sms_ok' value='<%=sms_ok%>'>
