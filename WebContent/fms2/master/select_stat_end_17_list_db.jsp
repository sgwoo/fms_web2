...
<%
	//신규영업 중단하고 대여사업 계속시(현재가치) 차량별세부리스트 - 점검용
...
response.setHeader("Content-Disposition", "inline; filename="+save_dt+"_select_stat_end_17_list_db.xls");
%>
...
<body>
<table border="1" cellspacing="0" cellpadding="0" width=6150>
	<tr>
	  ...
	  <td rowspan='2' width="100" align="center">친환경차구분</td>
	  <td rowspan='2' width="100" align="center">차종소분류코드</td>
	  ...
	  <td colspan='12' align="center">차량현재가치 경매장예상낙찰가 견적</td>	  
	</tr>
	<tr>
	  ...
	  <td width="100" align="center">견적등록일</td>
	  <td width="100" align="center">견적일자</td>
	  <td width="100" align="center">차량가격</td>
	  <td width="100" align="center">옵션가격</td>
	  <td width="100" align="center">색상가격</td>
	  <td width="100" align="center">개소세감면액</td>
	  <td width="100" align="center">차종코드</td>
	  <td width="100" align="center">신차등록일</td>
	  <td width="100" align="center">주행거리</td>
	  <td width="100" align="center">1위사고수리비</td>
	  <td width="100" align="center">2위사고수리비</td>
	  <td width="100" align="center">색상및사양잔가반영</td>
	</tr>
	<%	int etc_count = 0;
	...
	<tr>	
	  ...
	  <td align="center"><%=ht.get("JG_G_7")%></td>
	  <td align="center"><%=ht.get("JG_A")%></td>
	  ...
	  <td align="right"><%=AddUtil.parseDecimalLong(String.valueOf(ht.get("OPT_AMT")))%></td>
	  <td align="right"><%=AddUtil.parseDecimalLong(String.valueOf(ht.get("COL_AMT")))%></td>
	  <td align="right"><%=AddUtil.parseDecimalLong(String.valueOf(ht.get("TAX_DC_AMT")))%></td>
	  <td align="center"><%=ht.get("SH_CODE")%></td>
	  <td align="center"><%=ht.get("INIT_REG_DT")%></td>
	  <td align="right"><%=AddUtil.parseDecimalLong(String.valueOf(ht.get("TODAY_DIST")))%></td>
	  <td align="right"><%=AddUtil.parseDecimalLong(String.valueOf(ht.get("ACCID_SERV_AMT1")))%></td>
	  <td align="right"><%=AddUtil.parseDecimalLong(String.valueOf(ht.get("ACCID_SERV_AMT2")))%></td>
	  <td align="center">&nbsp;<%=ht.get("JG_OPT_ST")%>&nbsp;<%=ht.get("JG_COL_ST")%>&nbsp;</td>
	</tr>
	<%			
	...
	%>
	<tr>
	  <td colspan="18" align="center">합계</td>	  
