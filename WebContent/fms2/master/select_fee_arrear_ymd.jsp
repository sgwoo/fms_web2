...
//	AdminDatabase ad_db = AdminDatabase.getInstance();
	...
	String min_mon = ad_db.getSelectFeeArrearYmdMinMon();
	
	if(min_mon.equals("")) return;
	
	Vector vt = ad_db.getSelectFeeArrearYmdList(min_mon);
	int vt_size = vt.size();
...
<form name='form1' action='' method='post'>
  <table border="1" cellspacing="0" cellpadding="0" width=900>
	<tr>
	  <td colspan="<%=fee_size+5%>" align="center">(주)대한의사복지공제회 대여료 연체리스트</td>
	</tr>		
	<tr>
	  <td>&nbsp;</td>	  
	  <td>&nbsp;</td>
