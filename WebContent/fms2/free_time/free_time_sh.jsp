...
<body>
<form action="./free_time_sc.jsp" name="from1" method="POST" target="c_foot">
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
		...
		<td colspan=4>
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle border=0>&nbsp;<span class=style1> 인사관리 > 근태관리 > <span class=style5>휴가등록</span></span></td>
	...
	<tr>
	  ...
	  <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_ggjh.gif align=absmiddle>&nbsp;
        ...
        <td width="23%">
			...
			<select name="gubun2">
				...
				<option value="user_nm">휴가자</option>
			</select>
			<input type="text" class="text" name="gubun2_word" value="">
		</td>
        <td width="21%"><img src=/acar/images/center/arrow_g_va.gif align=absmiddle>
			<select name="gubun3">
			   <option value="" selected >전체</option>	
				...
				<option value="5" >포상휴가</option>
				<option value="6" >출산휴가</option>
