...
<!--
	...
	function file_save(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.FREE_TIME%>";
		fm.submit();
	}
//-->
</script>
        ...
        <td align="right" class="line">
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
					...
					<input type='hidden' name="<%=Webconst.Common.contentSeqName %>" size='' class='text' value='<%=doc_no%>' />
					<input type="hidden" name="<%=Webconst.Common.contentCodeName %>" value='<%=UploadInfoEnum.FREE_TIME%>' />
                    </td>
                </tr>
            </table>
        </td>
