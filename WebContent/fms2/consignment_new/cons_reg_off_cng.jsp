...
<!--
	function save(){
		...
		if(fm.off_id.value == "")	{ 	alert("탁송업체를 조회하여 입력하십시오."); 		return;	}		
		
		fm.mode.value = 'offid_cng';
	...
	{
		var fm = document.form1;	
		window.open("/acar/cus0601/cus0602_frame.jsp?from_page=/fms2/consignment_new/cons_i_c.jsp&t_wd=<%//=b_cons.getOff_nm()%>", "SERV_OFF", "left=10, top=10, width=900, height=600, scrollbars=yes, status=yes, resizable=yes");
	}		
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 탁송관리 > <span class=style5>탁송업체 변경</span></span></td>
      ...
      <td class='line'> 
        <table border="0" cellspacing="1" cellpadding="0" width=100%>
		  ...
		  <tr>
            ...
            <td>&nbsp;
			  <input type='text' name="off_nm" value='' size='20' class='text'>
