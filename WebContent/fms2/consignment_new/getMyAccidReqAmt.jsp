...
<%
	...
	String rent_mng_id	= request.getParameter("ac_rent_mng_id")==null?"":request.getParameter("ac_rent_mng_id");
	String rent_l_cd	= request.getParameter("ac_rent_l_cd")==null?"":request.getParameter("ac_rent_l_cd");
	String user_id 		= request.getParameter("user_id")==null?"":request.getParameter("user_id");	
	
	String ins_req_gu 	= request.getParameter("ac_ins_req_gu")==null?"":request.getParameter("ac_ins_req_gu");//1-휴차료, 2-대차료
//	String vat_yn 		= request.getParameter("ac_vat_yn")==null?"":request.getParameter("ac_vat_yn");//부가세포함여부
	...
	String ot_fault_per = request.getParameter("ac_ot_fault_per")==null?"100":request.getParameter("ac_ot_fault_per");
	String st 			= request.getParameter("st")==null?"":request.getParameter("st");
	String c_id 		= request.getParameter("ac_car_mng_id")==null?"":request.getParameter("ac_car_mng_id");//자동차관리번호
	String accid_id 	= request.getParameter("ac_accid_id")==null?"":request.getParameter("ac_accid_id");//사고관리번호
	...
	if(ck_acar_id.equals("000029")){
		...
		out.println("rent_l_cd="+rent_l_cd+"<br><br>");
...
<table border=0 cellspacing=0 cellpadding=0 width=700>
	...
	<%if(ins_req_gu.equals("2")){	
		...
		if(bean2.getReg_dt().equals("20190709"))  file_name = "아마존카_단기대여_요금표_20190709.jpg";		//20190708
