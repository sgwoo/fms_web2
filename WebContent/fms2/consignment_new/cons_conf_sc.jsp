...
//일괄결재작성
	function conf_tot_sign(){
		...
		if(cnt == 0){
		 	alert("일괄결재할 탁송을 선택하세요.");
			return;
		}	
		
		if(!confirm('담당자 일괄확인을 하시겠습니까?')){	return; }
		fm.target = "d_content";
		fm.action = "cons_conf_check.jsp";
		fm.submit();	
	}
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/consignment_new/cons_conf_frame.jsp'>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr>
	  ...
	  &nbsp;
	   <%if((nm_db.getWorkAuthUser("전산팀",user_id)) || (user_id.equals("000144")||user_id.equals("000128")||user_id.equals("000052"))){%>   
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="cons_conf_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
