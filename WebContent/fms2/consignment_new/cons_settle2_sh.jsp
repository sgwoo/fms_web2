...
<form name='form1' action='/fms2/consignment_new/cons_settle2_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 탁송관리 > <span class=style5>수신/기사등록현황</span></span></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;
                	  <select name='s_kd'>
                        ...
                        <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>운전자</option>				
                      </select>
                	  &nbsp;&nbsp;&nbsp;
                    ...
                    <td>&nbsp;
                	  <select name='sort'>
                        ...
                        <!--<option value='5' <%if(sort.equals("5")){%>selected<%}%>>예정일자 </option>-->
                      </select>
                	</td>
                </tr>
            </table>
