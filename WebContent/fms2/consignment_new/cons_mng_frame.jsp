...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./cons_mng_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  ...
  <%}else{%>
  <frame src="./cons_mng_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <%}%>
</frameset>
</HTML>