...
<form name='form1' action='/fms2/consignment_new/cons_reg_off_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 탁송관리 > <span class=style5>사전전화요청</span></span></td>
        ...
        <td colspan="2" class=line>
	        <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td>&nbsp;
        			  <select name='gubun3'>
                        <option value='1' <%if(gubun3.equals("1")){%>selected<%}%>>등록일자</option>				
                      </select>
                	  <select name='gubun2'>
                    ...
                    <td class=title width=10%>등록여부</td>
                    <td width=40%>&nbsp;
        		      <select name='gubun1'>
        			    <option value='' >전체</option>
                        <option value='Y' <%if(gubun1.equals("Y")){%>selected<%}%>>등록</option>
                        <option value='N' <%if(gubun1.equals("N")){%>selected<%}%>>미등록</option>
                      </select>
                	</td>
                </tr>	  
                <tr>
                    ...
                    <td>&nbsp;
                	  <select name='s_kd'>
                        <option value='1' <%if(s_kd.equals("1")){%>selected<%}%>>등록자</option>
                        <option value='3' <%if(s_kd.equals("3")){%>selected<%}%>>의뢰자</option>						
                        <option value='2' <%if(s_kd.equals("2")){%>selected<%}%>>의뢰내용</option>						
                      </select>
                	  &nbsp;&nbsp;&nbsp;
                    ...
                    <td>&nbsp;
                	  <select name='sort'>
                        <option value='1' <%if(sort.equals("1")){%>selected<%}%>>의뢰자</option>
                        <option value='2' <%if(sort.equals("2")){%>selected<%}%>>등록일자 </option>
                      </select>
                	</td>
                </tr>
            </table>
