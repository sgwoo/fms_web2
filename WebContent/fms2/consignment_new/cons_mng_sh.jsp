...
<form name='form1' action='/fms2/consignment_new/cons_mng_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 탁송관리 > <span class=style5>탁송현황</span></span></td>
                ...
                <tr>
                    ...
                    <td width=40%>&nbsp;
            		    <select name='s_kd' <%=disabled%>>
						  ...
						  <option value='8' <%if(s_kd.equals("8")){%>selected<%}%>>탁송번호</option>			  
                        </select>
            			&nbsp;&nbsp;&nbsp;
