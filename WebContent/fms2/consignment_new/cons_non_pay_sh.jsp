...
%>
<form name='form1' action='/fms2/consignment_new/cons_non_pay_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>탁송관리 ><span class=style5>탁송료미지급현황</span></span></td>
