...
<html>
<head><title>아마존카 - 채권 양도 통지서 및 위임장</title>
...
<div class="a4">
	<table width=628 border=0 cellspacing=0 cellpadding=0>
			...
			<td>
				<table width=100% border=1 cellspacing=0 cellpadding=0>
					<tr>
						...
						<td align="center" style="font-size : 10pt;"><font face="바탕"><%=btdoc.get("INS_COM_NM") %>&nbsp; 귀하</font></td>
					</tr>
				</table>
			</td>	
		</tr>
				...
				<table width=100% border=1 cellspacing=0 cellpadding=0>
					<tr>
					   ...
					   <td height="40" style="font-size : 10pt;" align="center">
					   		<font face="바탕">&nbsp;&nbsp;<%=btdoc.get("FIRM_NM")%>&nbsp;(
					...
					<tr>
					   ...
					   <td height="40" style="font-size : 10pt;">
					   		<font face="바탕">&nbsp;&nbsp;(<%=btdoc.get("ZIP")%>) <%=btdoc.get("ADDR")%>&nbsp;대표이사 :&nbsp;<%=btdoc.get("CLIENT_NM")%></font>
					   </td>
					</tr>
				</table>
			</td>
			...
			<td>
				<table width=100% border=1 cellspacing=0 cellpadding=0>
					...
					<tr>
					   ...
					   <td height="40" style="font-size : 10pt;" align="center"><font face="바탕"><%=AddUtil.parseDecimalHan((String)btdoc.get("INS_REQ_AMT"))%>원&nbsp;(\<%=AddUtil.parseDecimal(btdoc.get("INS_REQ_AMT")) %>)</font></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width=100% border=1 cellspacing=0 cellpadding=0>
					<tr>
					   ...
					   <td height="40" style="font-size : 10pt;" align="center" width="15%"><font face="바탕"><%=btdoc.get("CAR_NO")%></font></td>
					   <td height="40" width="10%" style="font-size : 10pt;" align="center"><font face="바탕">사고일자</font></td>
					   <td height="40" style="font-size : 10pt;" align="center" width="55%"><font face="바탕"><%=AddUtil.ChangeDate2((String)btdoc.get("ACCID_DT"))%></font></td>
					</tr>
					<tr>
					   <td height="40" width="10%" style="font-size : 10pt;" align="center"><font face="바탕">차명</font></td>
					   <td height="40" style="font-size : 10pt;" align="center" width="15%"><font face="바탕"><%=btdoc.get("CAR_NM")%></font></td>
					   <td height="40" width="10%" style="font-size : 10pt;" align="center"><font face="바탕">수리기간</font></td>
						<td height="40" style="font-size : 10pt;" align="center" width="55%"><font face="바탕"><%=AddUtil.ChangeDate3(String.valueOf(btdoc.get("INS_USE_ST")))%> ~ <%=AddUtil.ChangeDate3(String.valueOf(btdoc.get("INS_USE_ET")))%></font></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td>
				<table width=100% border=1 cellspacing=0 cellpadding=0>
					...
					<tr>
					   <td height="40" width="10%" style="font-size : 10pt;" align="center"><font face="바탕">금액</font></td>
					   <td height="40" style="font-size : 10pt;" align="center"><font face="바탕">일금&nbsp;&nbsp;<%=AddUtil.parseDecimalHan((String)btdoc.get("INS_REQ_AMT"))%>&nbsp;&nbsp;원정&nbsp;(\&nbsp;<%=AddUtil.parseDecimal(btdoc.get("INS_REQ_AMT")) %>)</font></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width=100% border=1 cellspacing=0 cellpadding=0>
					<tr>
					   ...
					   <%=btdoc.get("FIRM_NM")%> <%if(String.valueOf(btdoc.get("CLIENT_ST")).equals("1")){ %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>대표이사:&nbsp;<%} %>
					   <%}%>
					   <%=btdoc.get("CLIENT_NM")%>&nbsp;(인)&nbsp;</font></td>
					   <td height="40" width="20%" style="font-size : 10pt;" align="center"><font face="바탕"><%if(String.valueOf(btdoc.get("CLIENT_ST")).equals("2")){%>생년월일<%}else{%>사업자등록번호<%}%></font></td>
					   <td height="40" width="20%"style="font-size : 10pt;" align="center"><font face="바탕"><%if(String.valueOf(btdoc.get("CLIENT_ST")).equals("2")){%><%=btdoc.get("BIRTH")%><%}else{%><%=AddUtil.ChangeEnt_no(String.valueOf(btdoc.get("ENP_NO")))%><%}%></font></td>
					</tr>
					<tr>
					   <td height="40" width="10%" style="font-size : 10pt;" align="center"><font face="바탕">주소</font></td>
					   <td height="40" style="font-size : 10pt;" align="center" colspan="3">
					   		<font face="바탕">(<%=btdoc.get("ZIP")%>) <%=btdoc.get("ADDR")%></font>
					   </td>
					</tr>
				</table>
			</td>
		...
		<tr>
		   <td height="30" style="font-size : 10pt; line-height:2;"><font face="바탕">※ 보험사와의 과실비용협의를 위함이고, 고객비용부담은 없는 사항입니다.</font></td>
		</tr>		
		<tr>
			<td height=10></td>
		</tr>
