...
//		fm.target = "i_no";
	...
	function conf_sms_tint(){
		var fm = document.form1;			
		if(!confirm('청구확인 문자를 발송하시겠습니까?')){	return; }		
		fm.target = "i_no";
		//fm.target = "_blank";
...
<form name='form1' method='post'>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr>
	  ...
	  <%}%>
	  <%if((nm_db.getWorkAuthUser("전산팀",user_id)) || (user_id.equals("000144")||user_id.equals("000128")||user_id.equals("000003")||user_id.equals("000212"))){%>   
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="cons_req_sc_in3.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
