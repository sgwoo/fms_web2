    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 탁송관리 > <span class=style5>미완료현황/반려현황</span></span></td>
                ...
                <tr>
                    ...
                    <td width=40%>&nbsp;
            		    <select name='gubun2'>
                          ...
                          <option value='000223' <%if(gubun1.equals("000223")){%>selected<%}%>>주식회사 아마존탁송</option>						  
            			  <%}else if(user_id.equals("000109")){%>			  
                          <option value='000095' <%if(gubun2.equals("000109")){%>selected<%}%>>포엠티엠씨</option>			  
        			      <%}else if(user_id.equals("000139")){%>			  
                          <option value='000139'  <%if(gubun2.equals("000139")){%>selected<%}%>>하이카콤</option>		
				  <%}else if(user_id.equals("000147")){%>			  
                          <option value='000147'  <%if(gubun2.equals("000147")){%>selected<%}%>>대전케리어</option>								
				  <%}else if(user_id.equals("000187")||user_id.equals("000192")){%>			  
                          <option value='000187'  <%if(gubun2.equals("000187")){%>selected<%}%>>(주)삼진특수</option>								
				  <%}else if(user_id.equals("000196")){%>			  
                          <option value='000196'  <%if(gubun2.equals("000196")){%>selected<%}%>>에프앤티코리아</option>
				  <%}else if(user_id.equals("000222")){%>			  
			  			  <option value='000222'  <%if(gubun2.equals("000222")){%>selected<%}%>>(주)영원물류</option>
				  <%}else if(user_id.equals("000308")){%>			  
			  			  <option value='000308'  <%if(gubun2.equals("000308")){%>selected<%}%>>상원물류(주)</option>
				  <%}else if(user_id.equals("000263")){%>			  
			  			<option value='000263'  <%if(gubun2.equals("000263")){%>selected<%}%>>스마일TS</option>
			  	  <%}else if(user_id.equals("000328")){%>			  
			  			<option value='000328'  <%if(gubun2.equals("000328")){%>selected<%}%>>퍼스트드라이브</option>   
           		  <%}else{%>
						  ...
						  <option value='000196' <%if(gubun2.equals("000196")){%>selected<%}%>>에프앤티코리아</option>		
						  <option value='000147' <%if(gubun2.equals("000147")){%>selected<%}%>>대전케리어</option>								
                          <option value='000109' <%if(gubun2.equals("000109")){%>selected<%}%>>포엠티엠씨</option>						  
						  <option value='000187' <%if(gubun2.equals("000187")){%>selected<%}%>>(주)삼진특수</option>		
						  <option value='000222' <%if(gubun2.equals("000222")){%>selected<%}%>>(주)영원물류</option>		
						  <option value='000308' <%if(gubun2.equals("000308")){%>selected<%}%>>상원물류(주)</option>		
				    	  <option value='000263'  <%if(gubun2.equals("000263")){%>selected<%}%>>스마일TS</option>  				  
