...
%>
<form name='form1' action='/fms2/consignment_new/cons_oil_doc_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > <span class=style5>예비차유류대경감관리</span></span></td>
    ...
    <tr>
        <td colspan="2" class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    <td class=title width=10%>기안일자</td>
                    <td width=40%>&nbsp;
            		    <select name='gubun1'>
                ...
                <tr>					
                  <td class=title width=10%>검색조건</td>
                    <td colspan='3'>&nbsp;
            		    <select name='s_kd'>
                          <option value='1' <%if(s_kd.equals("1")){%>selected<%}%>>담당자</option>			
                          <option value='2' <%if(s_kd.equals("2")){%>selected<%}%>>거래처명</option>
