...
<%
	...
	System.out.println("탁송관리자 결재 취소<br>");
...
//탁송료 청구현황 관리자확인 일괄처리
	for(int i=0;i < vid_size;i++){
		...
		//=====[doc_settle] update=====
	//	System.out.println("관리자확인 일괄승인"+doc_bit);
	//	System.out.println("관리자확인 일괄승인");
		flag1 = d_db.updateDocSettle(doc.getDoc_no(), user_id, doc_bit, doc_step);
