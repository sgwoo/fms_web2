...
<body>
<form name='form1' action='/fms2/cons_pur/consp_stat_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 배달탁송관리 > <span class=style5>배달탁송현황</span></span></td>
                ...
                <tr>
                    ...
                    <td width=40%>&nbsp;
            		    <select name='gubun1'>                                                    
                          ...
                          <option value='6' <%if(gubun1.equals("6")){%>selected<%}%>>전해</option>			
