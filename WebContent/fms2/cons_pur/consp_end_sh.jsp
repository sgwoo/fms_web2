...
<form name='form1' action='/fms2/cons_pur/consp_end_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 배달탁송관리 > <span class=style5>인수미확인현황</span></span></td>
        ...
        <td colspan="2" class=line>
	        <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>		
                    ...
                    <td width=40%>&nbsp;
                          <select name='gubun6'>
                          <option value='3' <%if(gubun6.equals("3")){%>selected<%}%>>출고일자</option>
                        </select>
                        &nbsp;
            		    <select name='gubun1'>
