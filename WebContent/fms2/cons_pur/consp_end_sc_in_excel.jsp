...
response.setHeader("Content-Disposition", "inline; filename=consp_end_sc_in_excel.xls");
%>
...
<table border="1" cellspacing="0" cellpadding="0" width='1380'>
                <tr> 
                    ...
                    <td width="100" align='center' style="font-size : 8pt;">출고일자</td>        	    
                ...
                <tr> 
                    ...
                    <td align='center' style="font-size : 8pt;"><%=AddUtil.ChangeDate3(String.valueOf(ht.get("DLV_DT")))%></td>        	    
