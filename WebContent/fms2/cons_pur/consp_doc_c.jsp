...
<table border="0" cellspacing="0" cellpadding="0" width=620>
	...
	<td class=line>
		...
		<tr valign="middle" align="center"> 
		    ...
		    <td width='100' align='center' >계출번호</td>		    
		    <td width='100' align='center'>출고사무소</td>
		    <td width='100' align='center'>탁송지점</td>
...
%>
		    ...
		    <td align='center'><a href="javascript:view_cons('<%=ht.get("CONS_NO")%>', '<%=ht.get("RENT_MNG_ID")%>', '<%=ht.get("RENT_L_CD")%>');"><%=ht.get("RPT_NO")%></a></td>
