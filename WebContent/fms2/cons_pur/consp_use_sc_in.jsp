...
<%
	...
	Vector vt = cs_db.getConsignmentPurUseList(s_kd, t_wd, gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, st_dt, end_dt);
	int vt_size = vt.size();
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/cons_pur/consp_mng_frame.jsp'>
...
<table border="0" cellspacing="0" cellpadding="0" width='1720'>
	...
	<td class='line' width='1340'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		<tr>
		    <td colspan="6" class='title'>배달탁송</td>	    
		    <td colspan="3" class='title'>판매지점</td>	    		    
		    <td width="70" rowspan="2" class='title'>출고대리인</td>
		    <td width="70" rowspan="2" class='title'>탁송기사</td>
		    <td width="140" rowspan="2" class='title'>도착예정일시</td>
		    <td width="140" rowspan="2" class='title'>등록일시</td>
		</tr>
		<tr>
...
%>
		<tr>				
		    ...
		    <td  width='70' align='center'><%=ht.get("DRIVER_NM2")%></td>										
		    <td  width='140' align='center'><%=AddUtil.ChangeDate3(String.valueOf(ht.get("TO_EST_DT")))%></td>
		    <td  width='140' align='center'><%=ht.get("REG_DT")%></td>												    
		</tr>
