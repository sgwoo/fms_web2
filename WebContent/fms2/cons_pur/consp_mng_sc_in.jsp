...
<table border="0" cellspacing="0" cellpadding="0" width='1650'>
	...
	<td class='line' width='460' id='td_title' style='position:relative;'>
		...
		<tr>
		    ...
		    <td width='80' class='title'>차량등록일</td>
		</tr>
	    </table>
	</td>
	<td class='line' width='1190'>
		...
		<tr>
		    ...
		    <td width="70" rowspan="2" class='title'>확정여부</td>    
		    <td width="70" rowspan="2" class='title'>출고대리인</td>
		    <td width="160" rowspan="2" class='title'>등록일시</td>
		</tr>
		<tr>
...
%>
		<tr>
		    ...
		    <td  width='80' align='center'><%if(String.valueOf(ht.get("INIT_REG_DT")).equals("")){%><%}else{%><%=AddUtil.ChangeDate2(String.valueOf(ht.get("INIT_REG_DT")))%><%}%></td>
		</tr>
<%		}%>
		<tr>
...
%>
		<tr>				
		    ...
		    <td  width='70' align='center'><%=ht.get("SETTLE_ST")%></td>
		    <td  width='70' align='center'><%=ht.get("DRIVER_NM")%></td>												    
		    <td  width='160' align='center'><%=ht.get("REG_DT")%></td>												    
		</tr>
