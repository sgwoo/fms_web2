...
response.setHeader("Content-Disposition", "inline; filename=consp_cancel_sc_in_excel.xls");
%>
...
<%
	...
	Vector vt = cs_db.getConsignmentPurCancelList(s_kd, t_wd, gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, st_dt, end_dt);
	int vt_size = vt.size();
...
<table border="1" cellspacing="0" cellpadding="0" width='1230'>
                <tr> 
                    ...
                    <td width="100" align='center' style="font-size : 8pt;">출고예정일</td>        	    
        	    ...
        	    <td width='100' align='center' style="font-size : 8pt;">취소일시</td>
        	    ...
        	    <td align='center' style="font-size : 8pt;"><%=ht.get("CANCEL_DT")%></td>
