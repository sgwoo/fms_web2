...
<!--
	...
	function select_cons(){
		...
		fm.udt_dt.value = document.form1.udt_dt.value;
		
//		fm.target = "i_no";
		fm.target = "d_content";
		fm.action = "consp_udt_a.jsp";
		fm.submit();	
	}	
	...
	function execl(){
		var fm = document.form1;
		fm.target ='_blank';
		fm.action = 'consp_end_sc_in_excel.jsp';
		fm.submit();
	}			
//-->
</script>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr>
	    <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>총 <input type='text' name='size' value='' size='4' class=whitenum> 건</span>
	        ...
	        &nbsp;&nbsp;&nbsp;
	        <img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>인수일자</span>&nbsp;
	        <input type='text' name="udt_dt" value='<%=AddUtil.getDate()%>' size='11' class='text'>&nbsp;&nbsp;&nbsp;
	        <a href="javascript:select_cons();"><img src=/acar/images/center/button_insu.gif align=absmiddle border=0></a>
	        <%}%>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="consp_end_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
