...
<table width=595 border=0 cellspacing=0 cellpadding=0>
                    ...
                    <td bgcolor=#FFFFFF>
                        <table width=591 border=0 cellpadding=0 cellspacing=0>
                            <tr>
                                ...
                                <td width=217 bgcolor=#FFFFFF>&nbsp;&nbsp;<b><%=s_com_nm%></b></td>
                                <td width=1 bgcolor=#000000></td>
                                <td width=78 align=center bgcolor=dadada><span class=style1>발&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;신</span></td>
                                <td width=217 bgcolor=#FFFFFF>&nbsp;&nbsp;<b><%=b_com_nm%></b></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td bgcolor=#FFFFFF>&nbsp;&nbsp;<b><%=s_agnt_nm%></b></td>
                                <td width=1 bgcolor=#000000></td>
                                <td align=center bgcolor=dadada><span class=style1>담&nbsp;당&nbsp;자</span></td>
                                <td bgcolor=#FFFFFF>&nbsp;&nbsp;<b><%=b_agnt_nm%></b></td>
                            </tr>
                            <tr>
                                <td colspan=5 height=1 bgcolor=#000000></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan=5 bgcolor=#FFFFFF>&nbsp;&nbsp;<b><%=cnt%>매 (표지포함)</b></td>
                            </tr>
                            <tr>
                                <td colspan=5 height=1 bgcolor=#000000></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan=5 bgcolor=#FFFFFF>&nbsp;&nbsp;<b><%=dt%></b></td>
                            </tr>
                            <tr>
                                <td colspan=5 height=1 bgcolor=#000000></td>
                            </tr>
                            <tr>
                                ...
                                <td colspan=5 bgcolor=#FFFFFF>&nbsp;&nbsp;<b><%=title%></b></td>
                            </tr>
                        </table>
                    </td>
                    </td>
    ...
    <tr>
        <td height=379 valign=top background=/fms2/off_doc/images/fax_bg.gif>
            <table width=595 border=0 cellspacing=0 cellpadding=0>
                <tr>
                ...
                <tr>
                    <td><img src=/fms2/off_doc/images/fax_dw.gif></td>
                </tr>
            </table>
        </td>
    </tr>
