...
<table width=640 border=0 cellspacing=0 cellpadding=0>
        ...
        <td align=right>
            <table width=640 border=0 cellspacing=0 cellpadding=0>
                ...
                <tr>
                    ...
                    <td><img src=/fms2/off_doc/images/fax01_3.gif align=absmiddle></td>
                    <td style='font-size:12px;'><b><%=cnt%>매 (표지포함)</b></td>
                    <td>&nbsp;</td>
                    <td align=center><span class=style1>팩스번호</span></td>
                    <td><img src=/fms2/off_doc/images/fax01_3.gif align=absmiddle></td>
                    <td style='font-size:12px;'><b><%=b_fax%></b></td>
                </tr>
                <tr>
                    <td height=13></td>
                </tr>
                ...
                <tr>
                    <td colspan=7 height=40 align=absmiddle style='font-size:14px'>&nbsp;&nbsp;<img src=/fms2/off_doc/images/fax01_4.gif>&nbsp;&nbsp;<b><%=title%></b></td>
                </tr>
                <tr>
                    <td colspan=7 height=2 bgcolor=#000000></td>
                </tr>
    ...
    <tr>
        <td valign=top align=center height=379>
            <table width=600 border=0 cellspacing=0 cellpadding=0>
			    <tr>
			        <td height=500 style='font-size:14px;' valign=top>
			        <b><%=cont%></b>
			        </td>
			    </tr>
                <tr>
