    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>자료실 > <span class=style5>총무팀업무서식</span></span></td>
	  ...
	  <td class='line'>
       ...
       %>
		  <!--
			...
			<td>&nbsp;자동이체신청서</td>
			<td align="center"><a href="javascript:MM_openBrWindow('2015자동이체변경신청서.pdf','popwin_in1','scrollbars=no,status=yes,resizable=yes,menubar=yes,toolbar=yes,width=820,height=600,left=50, top=50')"><img src=/acar/images/center/icon_pdf.gif align=absmiddle border="0"></a>&nbsp;
			<a href="javascript:MM_openBrWindow('20151005CMS 출금이체 신청서.doc','popwin_in1','scrollbars=no,status=yes,resizable=yes,menubar=yes,toolbar=yes,width=820,height=600,left=50, top=50')"><img src=/acar/images/center/icon_doc.gif align=absmiddle border="0"></a>
			</td>
		  </tr>	
		  <tr>
			<td align="center">2</td>
			<td>&nbsp;포상금지출결의서</td>
			<td align="center"><a href="javascript:MM_openBrWindow('doc_prize.xlsx','popwin_in1','scrollbars=no,status=yes,resizable=yes,menubar=yes,toolbar=yes,width=820,height=600,left=50, top=50')"><img src=/acar/images/center/icon_excel.gif align=absmiddle border="0"></a></td>
		  </tr>			  
		  <tr>
			<td align="center">3</td>
			<td>&nbsp;문서처리전</td>
			<td align="center"><a href="javascript:MM_openBrWindow('문서처리전.xls','popwin_in1','scrollbars=no,status=yes,resizable=yes,menubar=yes,toolbar=yes,width=820,height=600,left=50, top=50')"><img src=/acar/images/center/icon_excel.gif align=absmiddle border="0"></a></td>
		  </tr>-->
		</table>
	  </td>
	</tr>
