...
function PopFax(cmd)
{
	...
	fm.cmd.value = cmd;	
	fm.target = 'FaxCover';
 	fm.action="fax_cover_view_01.jsp";	
	fm.submit();
}
...
function PopFax1(cmd)
{
	...
	fm.cmd.value = cmd;	
	fm.target = 'FaxCover';
 	fm.action="fax_cover_view_01_s.jsp";	
	fm.submit();
}
...
<table width=640 border=0 cellspacing=0 cellpadding=0>
                ...
                <tr>
                    <td bgcolor=#FFFFFF colspan=2>
                        <table width=640 border=0 cellpadding=0 cellspacing=0>
                            ...
                            <tr>
                                <td height=30 align=center><b>상용문구</b></td>
                                <td><img src=/fms2/off_doc/images/fax01_3.gif align=absmiddle></td>
                                <td colspan=5>&nbsp;&nbsp;<select name='content' onchange="javascript:msgDisp();">
						    ...
						    <tr>
                        		<td align=center colspan=7>
                            		<table width=640 border=0 cellpadding=0 cellspacing=1 bgcolor=dadada>
                               	        <tr>
                                       		  <td height=30 width=202>&nbsp;<input type="checkbox" name="all_pr" value="Y" onclick='javascript:AllSelect(this.form.gubi1)'> <b>법인 구비서류</b></td>
                                       		  <td height=30 width=185>&nbsp;<input type="checkbox" name="all_pr" value="Y" onclick='javascript:AllSelect(this.form.gubi2)'> <b>개인사업자 구비서류</b></td>
                                       		  <td height=30 width=200>&nbsp;<input type="checkbox" name="all_pr" value="Y" onclick='javascript:AllSelect(this.form.gubi3)'> <b>개인 구비서류</b></td>
                                        </tr>
                                        <tr>
            							...
            							<tr>
            								  <td height=30 align=center><input type="button" onClick="ok1();" value="법인사업자서류삽입"></td>
            								  <td height=30 align=center><input type="button" onClick="ok2();" value="개인사업자서류삽입"></td>
            								  <td height=30 align=center><input type="button" onClick="ok3();" value="개인서류삽입"></td>
            						  	</tr>                            
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><img src=/fms2/off_doc/images/fax01_3.gif align=absmiddle></td>
                                <td colspan=5>&nbsp;&nbsp;<input name=title type=text size=85></td>
                            </tr>
                            <tr>
    ...
    <tr>
        <td valign=top>
            <table width=640 border=0 cellspacing=0 cellpadding=0>
                <tr>
                    <td align=center valign=top><textarea name=memo cols=90 rows=19 onKeyUp="javascript:check_mygreet();"></textarea></td>
                </tr>
                <tr>
