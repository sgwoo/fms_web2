...
<body>
<form action="./actn_scan_sc.jsp" name="from1" method="POST" target="c_foot">
		...
		<td colspan=4>
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle border=0>&nbsp;<span class=style1> 오프리스 > 경매관리 > <span class=style5>낙찰스캔관리</span></span></td>
