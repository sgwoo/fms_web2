...
<%
	...
	String go_url = "/fms2/accid_doc/accid_mydoc_reg_sc.jsp";
...
<FRAMESET rows="400, *" border=0>
	<FRAME SRC="./accid_mydoc_reg_sh.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&go_url=<%=go_url%>" name="c_body" frameborder=0  marginwidth="10" marginheight="10" scrolling="no" noresize>
