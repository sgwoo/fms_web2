...
<form name='form1' action='/fms2/car_tint/tint_m_sc.jsp' target='c_foot' method='post'>
        ...
        <td class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
        		...
        		<select name='gubun3'>
                            ...
                            <option value='3' <%if(gubun3.equals("3")){%>selected<%}%>>마감일시</option>
                            <option value='4' <%if(gubun3.equals("4")){%>selected<%}%>>청구일자</option>
                            <option value='5' <%if(gubun3.equals("5")){%>selected<%}%>>지급일자</option>
                        </select>
                	<select name='gubun2'>
        		...
        		<select name='gubun1'>
                            ...
                            <option value='아시아나상사' 	<%if(gubun1.equals("아시아나상사")){%>selected<%}%>>	아시아나상사</option>
                            <option value='용용이자동차용품점'<%if(gubun1.equals("용용이자동차용품점")){%>selected<%}%>>용용이자동차용품점</option>
                            <option value='젤존코리아' 		<%if(gubun1.equals("젤존코리아")){%>selected<%}%>>젤존코리아</option>
                            <option value='파워큐브코리아' 	<%if(gubun1.equals("파워큐브코리아")){%>selected<%}%>>파워큐브코리아</option>
                            <%}%>
                      </select>
                	</td>
                </tr>	  
                <tr>
                    ...
                    <td>&nbsp;
                	  <select name='s_kd'>
                        ...
                        <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>블랙박스장착</option>
                      </select>
                	  &nbsp;&nbsp;&nbsp;
