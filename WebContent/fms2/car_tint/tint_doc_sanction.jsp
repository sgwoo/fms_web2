...
<%
	...
	if(doc_no.equals("") && doc_bit.equals("1")){
		...
		if(doc.getDoc_step().equals("3")){
			...
			sub 		= "용품비용 결재 완결";
			cont 		= "[용품업체: "+off_nm+", 청구일자: "+req_dt+"]  &lt;br&gt; &lt;br&gt; 용품비용 지출을 결재 완결하니 출금 집행하세요";
	...
	if(!doc_no.equals("") && doc_bit.equals("2")){
		...
		String cont 		= "[용품업체: "+off_nm+", 청구일자: "+req_dt+"]  &lt;br&gt; &lt;br&gt; 용품비용 지출을 결재 완결하니 출금 집행하세요";
		String target_id 	= "";
	...
	if(msg_send_bit.equals("2")){
		...
		String sub 		= "용품비용 청구";
		String cont 		= "[용품업체: "+off_nm+", 청구일자: "+req_dt+"]  &lt;br&gt; &lt;br&gt; 용품비용청구 결재를 요청합니다.";
		String target_id 	= "";
