	...
	<td align='right' class="line">
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td class='title'>설치비용</td>
                    <td>&nbsp;
                        <input type='text' size='10' maxlength='10' name='tint_amt' class='whitenum' value='<%=AddUtil.parseDecimal(tint3.getTint_amt())%>'  onBlur='javascript:this.value=parseDecimal(this.value);'>원
                        <%if(tint3.getTint_amt() > 0 && tint3.getR_tint_amt() > 0 && tint3.getTint_amt() > tint3.getR_tint_amt()){%>
                        (정산금액 <%=tint3.getR_tint_amt()%>원)
                        <%}%>                        
                    </td>
                </tr>            
                <tr> 
	...
	<td align='right' class="line">
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td class='title'>설치비용</td>
                    <td>&nbsp;
                        <input type='text' size='10' maxlength='10' name='tint_amt' class='whitenum' value='<%=AddUtil.parseDecimal(tint4.getTint_amt())%>'  onBlur='javascript:this.value=parseDecimal(this.value);'>원
                        <%if(tint4.getTint_amt() > 0 && tint4.getR_tint_amt() > 0 && tint4.getTint_amt() < tint4.getR_tint_amt()){%>
                        (정산금액 <%=tint4.getR_tint_amt()%>원)
                        <%}%>                        
                    </td>
                </tr>            
                <tr> 
	...
	<td align='right' class="line">
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td class='title'>설치비용</td>
                    <td>&nbsp;
                        <input type='text' size='10' maxlength='10' name='tint_amt' class='whitenum' value='<%=AddUtil.parseDecimal(tint5.getTint_amt())%>'  onBlur='javascript:this.value=parseDecimal(this.value);'>원
                        <%if(tint5.getTint_amt() > 0 && tint5.getR_tint_amt() > 0 && tint5.getTint_amt() < tint5.getR_tint_amt()){%>
                        (정산금액 <%=tint5.getR_tint_amt()%>원)
                        <%}%>
                    </td>
                </tr> 
                <tr> 
	...
	<td align='right' class="line">
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td class='title'>설치비용</td>
                    <td>&nbsp;
                        <input type='text' size='10' maxlength='10' name='tint_amt' class='whitenum' value='<%=AddUtil.parseDecimal(tint6.getTint_amt())%>'  onBlur='javascript:this.value=parseDecimal(this.value);'>원
                        <%if(tint6.getTint_amt() > 0 && tint6.getR_tint_amt() > 0 && tint6.getTint_amt() < tint6.getR_tint_amt()){%>
                        (정산금액 <%=tint6.getR_tint_amt()%>원)
                        <%}%>                        
                    </td>
                </tr>            
                <tr> 
                    <td class='title'>일련번호</td>
                    <td>&nbsp;
                        <input type='text' name='serial_no' size='40' value='<%=tint6.getSerial_no()%>' class='whitetext' ></td>
                    <td class='title'>첨부파일</td>
                    <td>&nbsp;
                    <%		
    ...
    <tr>
	  ...
	  <tr>
	    ...
	    <td >&nbsp;<%=tint.getOff_nm()%></td>
          ...
          <tr>
            <td class=title>상품명</td>
            <td>&nbsp;<input type='text' name='com_nm' size='70' value='<%=tint.getCom_nm()%>' class='whitetext' ></td>
	  </tr>
          <tr>
            <td class=title>모델명</td>
            <td>&nbsp;<input type='text' name='model_nm' size='105' value='<%=tint.getModel_nm()%>' class='whitetext' ></td>
          </tr>					  
          <tr>
            <td class=title>수량</td>
            <td>&nbsp;<input type='text' name='tint_su' size='3' value='<%=tint.getTint_su()%>' class='whitenum' >개</td>
	  </tr>
          <tr>
            <td class=title>비고</td>
          ...
          <tr>
            <td class=title>설치일자</td>
            <td colspan="3">&nbsp;<input type='text' size='12' name='sup_dt' maxlength='12' class='whitetext' <%if(tint.getSup_dt().length()==10){%>value='<%=AddUtil.ChangeDate2(tint.getSup_dt().substring(0,8))%>'<%}%> onBlur='javscript:this.value = ChangeDate(this.value);'>
              <input type='text' size='2' name='sup_h' class='whitetext' value=<%if(tint.getSup_dt().length()==10){%>'<%=tint.getSup_dt().substring(8)%>'<%}%>>
              시	
	    </td>
          </tr>		
          <tr>
            <td class=title>설치비용</td>
            <td>&nbsp;<input type='text' size='10' maxlength='10' name='tint_amt' class='whitenum' value='<%=AddUtil.parseDecimal(tint.getTint_amt())%>'  onBlur='javascript:this.value=parseDecimal(this.value);'>원
            </td>
          </tr>		          
...
<td class=title width=10%>실등록자</td>
    ...
    <tr> 
      <td class='line'> 		
	    ...
	    <td align="center"><font color="#999999"><%=c_db.getNameById(doc.getUser_id1(),"USER_PO")%><br><%=doc.getUser_dt5()%><%if(!doc.getUser_dt4().equals("") && doc.getUser_dt5().equals("") && (nm_db.getWorkAuthUser("전산팀",user_id) || doc.getUser_id1().equals(user_id))){%><a href="javascript:doc_sanction('5');" onMouseOver="window.status=''; return true" onFocus="this.blur()"><img src="/acar/images/center/button_in_gj.gif" align="absbottom" border="0"></a><%}%></font></td>
	    <td align="center"><font color="#999999"><%=c_db.getNameById(doc.getUser_id6(),"USER_PO")%><br><%=doc.getUser_dt6()%><%if(!doc.getUser_dt4().equals("") && doc.getUser_dt6().equals("") && (nm_db.getWorkAuthUser("전산팀",user_id) || nm_db.getWorkAuthUser("용품관리자",user_id))){%><a href="javascript:doc_sanction('6');" onMouseOver="window.status=''; return true" onFocus="this.blur()"><img src="/acar/images/center/button_in_gj.gif" align="absbottom" border="0"></a><%}%></font></td>
          </tr>
        </table>
	  </td>
    </tr>
