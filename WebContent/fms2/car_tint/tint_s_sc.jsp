...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='tint_s_frame.jsp'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
  <tr>
	  ...
	  <%if((auth_rw.equals("4")||auth_rw.equals("6")) || (nm_db.getWorkAuthUser("전산팀",user_id)) || (nm_db.getWorkAuthUser("용품관리자",user_id)) || user_id.equals("000144") || user_id.equals("000054")){%>   
	  &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="tint_s_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
