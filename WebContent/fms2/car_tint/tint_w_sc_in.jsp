...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/car_tint/tint_w_frame.jsp'>
...
<table border="0" cellspacing="0" cellpadding="0" width='1990'>
	...
	<td class='line' width='1640'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		<tr>
		    <td colspan="4" class='title' style='height:24'>기초사항</td>
		    <td colspan="8" class='title'>용품요청</td>				  
		...
		<tr>
		    ...
		    <td width='160' class='title'>차대번호</td>
	...
	<td class='line' width='350' id='td_con' style='position:relative;'>
		...
		<tr>
		    ...
		    <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='30' align='center'><input type="checkbox" name="ch_cd" value="<%=ht.get("TINT_NO")%>/<%=ht.get("OFF_ID")%>"></td>
		    <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='130' align='center'><span title='<%=ht.get("OFF_NM")%>'><%=ht.get("OFF_NM")%></span></td>
	...
	<td class='line' width='1640'>
		...
		<tr>
		    ...
		    <%}else{%>
		        ...
		        <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='110' align='center'><%=ht.get("RPT_NO")%></td>
		        <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='150' align='center'><%=ht.get("CAR_NUM2")%></td>
		    ...
		    <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='80' align='center'><%if(String.valueOf(ht.get("S1_YN")).equals("Y")){%>시공&nbsp;<%=ht.get("S1_SUN_PER")%>%<%}%></td>
		    <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='80' align='center'><%if(String.valueOf(ht.get("S2_YN")).equals("Y")){%>시공&nbsp;<%=ht.get("S2_SUN_PER")%>%<%}%></td>
		    ...
		    <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='80' align='center'><%if(String.valueOf(ht.get("N_YN")).equals("Y")){%>설치<%}%></td>
		    ...
		    <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='90' align='center'><%if(String.valueOf(ht.get("EV_YN")).equals("Y")){%>설치<%}%></td>					
		    <td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='300' align='center'><span title='<%=ht.get("FIRM_NM")%>'><%=ht.get("FIRM_NM")%></span></td>					
