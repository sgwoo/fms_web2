...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="tint_i_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
  ...
  <tr>
	  <td>※ 의뢰자가 오렌지색인 것은 에이젼트 계약입니다. 즉시 처리 해주세요.</td>
	</tr>	
</table>
</form>
</body>
