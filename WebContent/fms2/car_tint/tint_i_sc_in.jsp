...
<%
	...
	Vector vt = t_db.getCarTintIList(s_kd, t_wd, gubun1, gubun2, gubun3, st_dt, end_dt, sort);
	int vt_size = vt.size();
%>
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/car_tint/tint_i_frame.jsp'>
	...
	<td class='line' width='1420'>
		...
		<tr>
		    ...
		    <%}else{%>
		        ...
		        <td width='110' align='center'><%=ht.get("RPT_NO")%></td>
		        <td width='130' align='center'><%=ht.get("CAR_NUM2")%></td>
		    ...
		    <td width='100' align='center'><%=ht.get("COM_TINT_NM")%> <%=ht.get("COM_FILM_ST_NM")%></td>							
		    <td width='80' align='center'><%if(String.valueOf(ht.get("S1_YN")).equals("Y")){%>시공&nbsp;<%=ht.get("S1_SUN_PER")%>%<%}%></td>
		    <td width='80' align='center'><%if(String.valueOf(ht.get("S2_YN")).equals("Y")){%>시공&nbsp;<%=ht.get("S2_SUN_PER")%>%<%}%></td>
		    <td width='70' align='center'><%if(String.valueOf(ht.get("B_YN")).equals("Y")){%>설치<%}%></td>
		    <td width='80' align='center'><%if(String.valueOf(ht.get("N_YN")).equals("Y")){%>설치<%}%></td>
		    <td width='70' align='center'><%if(String.valueOf(ht.get("E_YN")).equals("Y")){%>있음<%}%></td>
		    <td width='90' align='center'><%if(String.valueOf(ht.get("EV_YN")).equals("Y")){%>설치<%}%></td>							
