...
<%
	...
	Vector vt = t_db.getCarTintRList(s_kd, t_wd, gubun1, gubun2, gubun3, st_dt, end_dt, sort);
	int vt_size = vt.size();
...
<table border="0" cellspacing="0" cellpadding="0" width='1790'>
	...
	<td class='line' width='470' id='td_title' style='position:relative;'>
		...
		<tr>
		    ...
		    <td width='60' class='title' >담당자<br>확인</td>
		    <td width='60' class='title' >관리자<br>확인</td>
	...
	<td class='line' width='1320'>
		...
		<tr>
		    ...
		    <td width='110' class='title'>설치일자</td>				  				  		    
		    ...
		    <td width='90' class='title'>이동용충전기</td>							
	...
	<td class='line' width='470' id='td_con' style='position:relative;'>
		...
		<tr>
		    ...
		    <td width='30' align='center'><input type="checkbox" name="ch_cd" value="<%=ht.get("TINT_NO")%>/<%=ht.get("OFF_ID")%>/<%=i%>"></td>
		    <td width='60' align='center'><%=ht.get("CONF_ST_NM")%><input type="hidden" name="cont_st1" value="<%=ht.get("CONF_ST_NM")%>"></td>
		    <td width='60' align='center'><%=ht.get("CONF_ST_NM2")%><input type="hidden" name="cont_st2" value="<%=ht.get("CONF_ST_NM2")%>"></td>				    
	...
	<td class='line' width='1320'>
		...
		<tr>
		    ...
		    <%}%>
		    <td width='110' align='center'><a href="javascript:parent.tint_action('<%=ht.get("DOC_NO")%>', '<%=ht.get("TINT_NO")%>', '<%=ht.get("OFF_ID")%>');"><font color=red><%=AddUtil.ChangeDate3(String.valueOf(ht.get("SUP_DT")))%></font></a></td>
