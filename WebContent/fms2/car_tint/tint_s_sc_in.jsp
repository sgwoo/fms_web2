...
<%
	...
	Vector vt = t_db.getCarTintSList(s_kd, t_wd, gubun1, gubun2, gubun3, st_dt, end_dt, sort);
	int vt_size = vt.size();
...
<table border="0" cellspacing="0" cellpadding="0" width='1670'>
	...
	<td class='line' width='350' id='td_con' style='position:relative;'>
		...
		<tr>
		    ...
		    <td width='30' align='center'><input type="checkbox" name="ch_cd" value="<%=ht.get("TINT_NO")%>/<%=ht.get("OFF_ID")%>"></td>
