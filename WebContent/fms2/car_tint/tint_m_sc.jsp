...
<!--
	//용품보기
	function tint_action(doc_no, doc_bit, tint_no, off_id){
		var fm = document.form1;
		fm.doc_no.value = doc_no;
		fm.tint_no.value = tint_no;
		fm.off_id.value = off_id;
		
		if(doc_bit == '1' || doc_bit == '')	fm.action = 'tint_reg_step2.jsp';
		else if(doc_bit == '2')			fm.action = 'tint_reg_step3.jsp';
		else if(doc_bit == '3')			fm.action = 'tint_reg_step4.jsp';
		else					fm.action = 'tint_reg_step4.jsp';
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="tint_m_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
