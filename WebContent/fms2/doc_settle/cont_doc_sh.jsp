...
<form name='form1' action='/fms2/doc_settle/cont_doc_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > <span class=style5>계약변경문서관리</span></span></td>
