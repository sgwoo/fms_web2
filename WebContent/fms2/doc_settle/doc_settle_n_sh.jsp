...
%>
<form name='form1' action='/fms2/doc_settle/doc_settle_n_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > <span class=style5><%if(gubun2.equals("1")){%>미결함<%}else{%>기결함<%}%></span></span></td>
        ...
        <tr>
          ...
          <td width=40%>&nbsp;
		    <select name='s_kd'>
              ...
              <option value='4' <%if(s_kd.equals("4")){%>selected<%}%>>지점</option>			  
              <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>결재자</option>			  
              <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>기안자</option>			  			  
            </select>
			&nbsp;&nbsp;&nbsp;
