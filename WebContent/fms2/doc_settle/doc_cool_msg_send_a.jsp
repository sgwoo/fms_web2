...
<%
	...
	String dest_id	= request.getParameter("dest_id")==null?"":request.getParameter("dest_id");
	...
	if(doc.getDoc_st().equals("1")){					//영업수당
		...
		m_url = "/fms2/consignment_new/cons_rec_frame.jsp";
	 	...
	 	m_url = "/fms2/car_pur/pur_doc_frame.jsp";
	...
	UsersBean target_bean 	= umd.getUsersBean(dest_id);
	...
	System.out.println("쿨메신저_전자결재_메시지재전송("+sub+")"+doc.getDoc_no()+" : "+sender_bean.getUser_nm()+" -> "+target_bean.getUser_nm());
%>
