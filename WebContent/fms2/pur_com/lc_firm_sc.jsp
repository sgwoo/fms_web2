...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/pur_com/lc_firm_frame.jsp'>  
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<td>
    		...
    		<tr>
        	    <td>
        		<iframe src="lc_firm_sc_in.jsp<%=vlaus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
        	    </td>
    		</tr>
    	    </table>
	</td>
