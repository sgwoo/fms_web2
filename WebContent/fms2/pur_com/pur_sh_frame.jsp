...
<%
	...
	if(s_kd.equals("") && t_wd.equals("") && gubun1.equals("") && gubun2.equals("") && gubun3.equals("") && gubun4.equals("") && gubun5.equals("") && gubun6.equals("") && gubun7.equals("") && gubun8.equals("") && gubun9.equals("") && gubun10.equals("")){
		sort  	= "1";
		gubun1	= "1";
		gubun2	= "4";
		gubun3	= "";
...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=0 name=ex>
  <frame src="./pur_sh_sh.jsp<%=vlaus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./pur_sh_sc.jsp<%=vlaus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>
