...
<table border="0" cellspacing="0" cellpadding="0" width='1480'>
    ...
    <tr id='tr_title' style='position:relative;z-index:1'>		
	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
       		<tr>
        	    ...
        	    <td width='90' class='title'>결재금액</td>
	...
	<td class='line' width='995'>
        ...
        <%	for(int i = 0 ; i < vt_size ; i++){
        	    ...
        	    <td width='100' align='center'><%=ht.get("CARD_KIND1")%><%if(!String.valueOf(ht.get("CARD_DT4")).equals("월 년")){%>외<%}%></td>					
        	    <td width='150' align='center'><%=ht.get("CARDNO1")%></td>
        	    <td width='80' align='center'><%=ht.get("CARD_DT")%></td>
        	    <td width='90' align='right'><%=AddUtil.parseDecimal(String.valueOf(ht.get("TRF_AMT1")))%></td>
