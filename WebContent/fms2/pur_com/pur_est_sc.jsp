...
<!--
	...
	function execl(){
		var fm = document.form1;
		fm.target ='_blank';
		fm.action = 'pur_est_sc_in_excel.jsp';
		fm.submit();
	}		
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/pur_com/pur_est_frame.jsp'>  
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<td>
    		...
    		<tr>
        	    <td>
        		<iframe src="pur_est_sc_in.jsp<%=vlaus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
        	    </td>
    		</tr>
    	    </table>
	</td>
