        ...
        <td class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
                    ...
                    <td width=33%>&nbsp;
            		<select name='gubun1'>
                            <option value='1' <%if(gubun1.equals("1")){%>selected<%}%>> 해지등록일 </option>
                            <option value='2' <%if(gubun1.equals("2")){%>selected<%}%>> 해지반영일 </option>                            
                        </select>
                        &nbsp;
                        <select name='gubun2'>                          
                  ...
                  <td >&nbsp;
        	      <select name='sort'>
                          <option value='1' <%if(sort.equals("1")){ %>selected<%}%>> 해지등록일 </option>
                          <option value='2' <%if(sort.equals("2")){%>selected<%}%>> 해지반영일 </option>
                      </select>
        	  </td>						
                </tr>                
    	    </table>
