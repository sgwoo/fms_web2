    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>계출관리 > <span class=style5>주문차계약</span></span></td>
        ...
        <td class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
    	        ...
    	        <tr>
                    ...
                    <td width=40%>&nbsp;
            		<select name='gubun1'>
                            <option value='1' <%if(gubun1.equals("1")){%>selected<%}%>> 고객확인일 </option>
                            <option value='2' <%if(gubun1.equals("2")){%>selected<%}%>> 주문차확인일 </option>                            
                        </select>
                        &nbsp;
                        <select name='gubun2'>                          
                ...
                <tr>
                    <td class=title width=10%>확인여부</td>
                    <td width=40%>&nbsp;
                  ...
                  <td width=40%>&nbsp;
        	      <select name='sort'>
                          <option value='1' <%if(sort.equals("1")){ %>selected<%}%>> 고객확인일 </option>
                          <option value='2' <%if(sort.equals("2")){%>selected<%}%>> 주문차확인일 </option>
                      </select>
        	  </td>						
                </tr>                
    	    </table>
