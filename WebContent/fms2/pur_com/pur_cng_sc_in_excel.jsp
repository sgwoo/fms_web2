...
response.setHeader("Content-Disposition", "inline; filename=pur_cng_sc_in_excel.xls");
%>
...
<%
	...
	Vector vt = umd.getPurComCngList(s_kd, t_wd, sort, gubun1, gubun2, gubun3, gubun4, st_dt, end_dt);
	int vt_size = vt.size();
%>
...
<table border="1" cellspacing="0" cellpadding="0" width='1320'>
                <tr> 
