	...
	<td class='line' width='1010'>
        ...
        <%	for(int i = 0 ; i < vt_size ; i++){
                ...
                <tr>
                    ...
                    <td width='150' align='center'><%=ht.get("ORDER_CHK_DT")%><%if(String.valueOf(ht.get("ORDER_CHK_DT")).equals("")){%><font color=red>미확인</font><%}%></td>
