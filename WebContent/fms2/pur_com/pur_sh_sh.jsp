    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>계출관리 > <span class=style5>해지현황</span></span></td>
    	    ...
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
            		...
            		<select name='gubun4'>
                            ...
                            <option value='02176' <%if(gubun4.equals("02176")){%>selected<%}%>> 지엠 강서구청점 </option>
                        </select>
        	  </td>			
            		...
            		<select name='gubun5'>
                            ...
                            <option value='D' <%if(gubun5.equals("D")){%>selected<%}%>> 신차취소 </option>
                            <option value='D1' <%if(gubun5.equals("D1")){%>selected<%}%>> 신차취소-대기 </option>
                            <option value='D2' <%if(gubun5.equals("D2")){%>selected<%}%>> 신차취소-예약 </option>
                            <option value='Y' <%if(gubun5.equals("Y")){%>selected<%}%>> 계약연동 </option>
                            <option value='N' <%if(gubun5.equals("N")){%>selected<%}%>> 납품해지 </option>
                ...
                <tr>
                    ...
                    <td width=22%>&nbsp;
            		<select name='s_kd'>
                            <option value='1' <%if(s_kd.equals("1")){%>selected<%}%>> 특판계약번호 </option>                            
                            <option value='2' <%if(s_kd.equals("2")){%>selected<%}%>> 색상 </option>                            
                            <option value='3' <%if(s_kd.equals("3")){%>selected<%}%>> 예약자 </option>
                        </select>
                        &nbsp;
                    ...
                    <td width=33%>&nbsp;
            		<select name='gubun1'>
                            <option value='1' <%if(gubun1.equals("1")){%>selected<%}%>> 배정예정일 </option>
                        </select>
                        &nbsp;
                        <select name='gubun2'>                          
                  ...
                  <td >&nbsp;
        	      <select name='sort'>
                          <option value='1' <%if(sort.equals("1")){ %>selected<%}%>> 배정예정일 </option>
                      </select>
        	  </td>						
                </tr>                
    	    </table>
