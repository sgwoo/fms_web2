...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "17", "14", "02");
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>계출관리 > <span class=style5>예정현황</span></span></td>
    	    ...
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
            		...
            		<select name='gubun1'>
                            ...
                            <option value='5' <%if(gubun1.equals("5")){%>selected<%}%>> 등록일자 </option>
                            <option value='2' <%if(gubun1.equals("2")){%>selected<%}%>> 배정예정일 </option>
                            <option value='3' <%if(gubun1.equals("3")){%>selected<%}%>> 변경등록일 </option>
                            <option value='4' <%if(gubun1.equals("4")){%>selected<%}%>> 해지등록일 </option>
                        </select>
                        &nbsp;
                        <select name='gubun2'>                          
        	      ...
        	      <select name='sort'>
                          ...
                          <option value='2' <%if(sort.equals("2")){%>selected<%}%>> 배정예정일 </option>
                      </select>
        	  </td>						
                </tr>
    	    </table>
