    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>계출관리 > <span class=style5>출고요청관리</span></span></td>
    	    ...
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
            		...
            		<select name='s_kd'>
                            ...
                            <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>> 소비자가 </option>
                        </select>
                        &nbsp;
            		...
            		<select name='gubun1'>
                            ...
                            <option value='2' <%if(gubun1.equals("2")){%>selected<%}%>> 출고요청일 </option>
                        </select>
                        &nbsp;
                        <select name='gubun2'>                          
        	      ...
        	      <select name='sort'>
                          ...
                          <option value='2' <%if(sort.equals("2")){%>selected<%}%>> 출고요청일 </option>
                          <option value='3' <%if(sort.equals("3")){%>selected<%}%>> 차종 </option>
                      </select>
        	  </td>						
                </tr>
    	    </table>
