...
response.setHeader("Content-Disposition", "inline; filename=pur_sh_sc_in_excel.xls");
%>
...
<%
	...
	Vector vt = umd.getPurComShList(s_kd, t_wd, sort, gubun1, gubun2, gubun3, gubun4, gubun5, st_dt, end_dt);
	int vt_size = vt.size();
%>
