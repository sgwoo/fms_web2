	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
       		<tr>
        	    ...
        	    <td width="100" class='title'>변경구분</td>
                    <td width='75' class='title'>변경등록일</td>
                    <td width='75' class='title'>변경반영일</td>                    
        	    <td width="150" class='title'>선택사양</td>
        	    <td width="100" class='title'>색상</td>		  
        	    <td width='110' class='title'>소비자가</td>
	...
	<td class='line' width='1200'>
        ...
        <%	for(int i = 0 ; i < vt_size ; i++){
                ...
                <tr>
                    ...
                    <td width='80' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("COM_REG_DT")))%></td>                
                    ...
                    <td width='75' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("CNG_REG_DT")))%></td>
                    <td width='75' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("CNG_APP_DT")))%>
        	    ...
        	    <td width='150' align='center'><span title='<%=ht.get("R_OPT")%>'><%=AddUtil.subData(String.valueOf(ht.get("R_OPT")),10)%></span></td>					
        	    ...
        	    <td width='100' align='center'><span title='<%=ht.get("PUR_COM_FIRM")%>'><%=AddUtil.subData(String.valueOf(ht.get("PUR_COM_FIRM")), 6)%></span></font></td>
