...
<table border="0" cellspacing="0" cellpadding="0" width='1540'>
    ...
    <tr id='tr_title' style='position:relative;z-index:1'>		
	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
       		<tr>
        	    ...
        	    <td width='150' class='title'>계약진행담당자</td>
        	    <td width='70' class='title'>취소여부</td>
        	</tr>
	    </table>
	</td>
    </tr>
	...
	<td class='line' width='1010'>
        ...
        <%	for(int i = 0 ; i < vt_size ; i++){
        	    ...
        	    <%if(!String.valueOf(ht.get("AGENT_EMP_ID")).equals("")){ 
        	    		CarOffEmpBean a_coe_bean = umd.getCarOffEmpBean(String.valueOf(ht.get("AGENT_EMP_ID")));        	    	
        	    %>
        	    <%=a_coe_bean.getEmp_nm()%>&nbsp;<%=a_coe_bean.getEmp_m_tel()%>
        	    <%} %>
        	    </td>	        		    
        	    <td width='70' align='center'><%=ht.get("CLS_YN")%></td>
                </tr>
<%		}	%>
	    </table>
	</td>
...
<%	}	%>
    <tr>
        <td colspan=2 align='right' >* 취소이력이 있으면 출고희망일(계약관리-출고요청일)이 있을 때만 신차계약 배정등록이 가능합니다.</td>
    </tr>
</table>
<script language='javascript'>
<!--
