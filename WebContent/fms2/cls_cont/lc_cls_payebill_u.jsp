...
<%@ page import="java.util.*, acar.util.*, acar.common.*, acar.cont.*, acar.bill_mng.*, acar.client.*, acar.credit.*, tax.*"%>
...
<!--
	function save()
	{
		...
		if(fm.ebill.checked == true){
			...
			{		
				fm.target = 'i_no';
				fm.action = 'lc_cls_payebill_u_a.jsp'
				fm.submit();
			}
		}	
	}
			 		...
			 		<td class='line'>
			 			<table border="0" cellspacing="1" cellpadding="0" width=100%>
							...
							<tr>
							  ...
							  <td>
						      &nbsp;<input type='text' name='pay_dt'  size='10' value='<%=cls.getCls_dt()%>' class='text' onBlur='javascript:this.value=ChangeDate(this.value);'></td>
