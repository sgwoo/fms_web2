...
<!--
	...
	function SearchopenBrWindow() { //v2.0
		...
		if(fm.auth_rw.value != '4'){ alert('권한이 없습니다.'); return; }		
...
<form  name="form1" method='post'>
  ...
  <input type="hidden" name="go_url" value="/fms2/cls_cont/lc_cls_c.jsp">      
  ...
  <table border='0' cellspacing='0' cellpadding='0' width='100%'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 해지관리 > <span class=style5>해지정산등록</span></span></td>
    ...
    <!--
    <tr>
    <td>&nbsp;<font color="#FF0000">***</font> 해지정산프로그램이 변경되었으니, 혹시 금액이 이상한경우 알려주시길 바랍니다.!! (미납금액 조회해보세요)</td>    
    <tr> -->
  </table>
</form>
</body>
