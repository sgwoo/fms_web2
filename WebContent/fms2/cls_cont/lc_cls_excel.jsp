...
<table border="0" cellspacing="0" cellpadding="0" width='800'>
    <tr>
        <td height="40" align="center" style="font-size : 20pt;"><b>장기임차인 변경, 해지 리스트</b></td>
    </tr>
    <tr>
					...
					Hashtable car = (Hashtable)vt.elementAt(i); %>
                            <tr  > 
	                            ...
	                            <td width='100' align='left'>&nbsp;
	                            	<%if(!(car.get("FIRM_NM2")+"").equals("") && !(car.get("FIRM_NM2")+"").equals(car.get("FIRM_NM")+"") ){%><font color="red">확인필요</font>
	                            	<%}else{%>미가입<%}%></td>
                            </tr>
                <%}%>
                            <tr> 
