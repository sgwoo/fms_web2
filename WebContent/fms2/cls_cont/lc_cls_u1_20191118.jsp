...
<% if ( vt_size8 > 0) {%>   
		 if ( fm.tax_r_chk3.checked == true  ||   toInt(parseDigit(fm.tax_rr_supply[3].value)) > 0     ) {
		//		 	alert("중도매입옵션건은 대여료 계산서금액을 기발행분제외해서 발행하셔야 합니다..!!");
	//				return;	 
		 }				
<% } %>		
...
//		fm.over_amt_2_v.value = parseDecimal( toInt(parseDigit(fm.over_amt_2.value)) * 0.1 );
	...
	function set_cls_amt4(){
		...
		if(toInt(parseDigit(fm.over_amt_1.value)) <   toInt(parseDigit(fm.over_amt_2.value))   ){ //
			alert("초과운행추가대여료 확정금액내에서 상계할수 있습니다.!!");
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp; <span class=style1>영업지원 > 해지관리 ><span class=style5>해지정산품의</span></span></td>
...
<% } else { %> 		    
            ...
            <td  width=12%>&nbsp;
				  <select name='sb_saction_id'>
	                <option value="">--선택--</option>
	                <option value="000052" <% if(cls.getSb_saction_id().equals("000052")){%>selected<%}%>>박영규</option> 
	                <option value="000053" <% if(cls.getSb_saction_id().equals("000053")){%>selected<%}%>>제인학</option> 
	                <option value="000054" <% if(cls.getSb_saction_id().equals("000054")){%>selected<%}%>>윤영탁</option> 
	                <option value="000118" <% if(cls.getSb_saction_id().equals("000118")){%>selected<%}%>>이수재</option> 
	              </select>	        
   ...
   <%} %>  
	 ...
	 <tr id=tr_opt style="display:<%if( cls.getCls_st().equals("매입옵션") ){%>''<%}else{%>none<%}%>"> 
	        <td class=line>
			  ...
			  <td class=title width=10%>수취인</td>
    ...
    <tr id=tr_opt style="display:<%if( cls.getCls_st().equals("매입옵션") ){%>''<%}else{%>none<%}%>"> 
 	  ...
 	  <td> 
    	<table border="0" cellspacing="0" cellpadding="0" width=100%>
          <tr> 
 	 		 <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>매입옵션&nbsp;<a href="javascript:update('cls_asset')"><img src=/acar/images/center/button_modify_ss.gif align=absmiddle border=0></a></span></td>
 	 	  </tr>
 	 	  <tr>
      		 <td class=line2></td>
   		  </tr>
 	 	  <tr>
		    	...
		    	<table border="0" cellspacing="1" cellpadding="0" width=100%>
		          <tr> 		          	
		             ...
		             <td colspan=2 width=22% >&nbsp;<input type="radio" name="sui_st" value="Y" <%if(cls.getSui_st().equals("Y")){%>checked<%}%> >포함
                         <input type="radio" name="sui_st" value="N" <%if(cls.getSui_st().equals("N")){%>checked<%}%>>미포함</td>
                  </tr>	
		          ...
		          <tr> 
		             ...
		             <td colspan=2  >&nbsp;<input type='text' name='sui_d_amt' readonly  value='<%=AddUtil.parseDecimal(cls.getSui_d_amt())%>' size='15' class='num' onBlur='javascript:this.value=parseDecimal(this.value);'> 원&nbsp;&nbsp; *천원절사</td> 
		          </tr>  
		       </table>
		      </td>        
         </tr>   
    ...
    <tr> 
	  ...
	  <tr> 
            ...
            <%}%></td>                               
               ...
               <tr> 
              <td class="title" colspan="2">초과운행추가대여료(M)</td>
              <td align="center" class="title"> 
            ...
            <tr> 
             ...
             <tr> 
              <td align="center" class="title" colspan=2>초과운행추가대여료</td>
              <td align="center" class="title"> 
              </td>
              <td align="center" class="title"> 
               </td>  
        ...
        <td class=line>
            <table width=100% border=0 cellspacing=1 cellpadding=0>
       		  <tr>
                	...
                	<td>&nbsp;※ 미납금액계 - 환불금액계</td>    
	                <td colspan=4 width=30%>&nbsp;<input type='checkbox' name='cms_after' value='Y' <%if(clsm.getCms_after().equals("Y")){%>checked<%}%> ><font color="red">CMS 확인후 익일처리</font></td> 
             		<% } %>                     
              </tr>
    ...
    <tr>
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>
        		...
        		<input type="checkbox" name="rt" value="Y" >즉시&nbsp;<a href="javascript:doc_sanction('3')"><img src="/acar/images/center/button_in_gj.gif" align="absmiddle" border="0"></a>
        			  <%	}%>
        			    <br>&nbsp;
        			  <%}%>
        			 	  	  <!--결재자 변경 -->
...
//		if(toInt(parseDigit(fm.over_amt_1.value)) > 0){
				...
				fm.tax_r_g[8].value       = "해지 초과운행추가대여료";
