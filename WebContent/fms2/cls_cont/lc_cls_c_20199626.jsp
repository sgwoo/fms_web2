...
<!--	
	...
	function save(){
		...
		//만기매칭인경우는???  - 대여료관련해서 해지정산서에서 처리안함. (도래가아닌 미납은 표시!!!)  -20180619
	//	if ( fm.match.value == 'Y') {
	//	     fm.dft_amt.value = '0';
...
//			fm.target='ii_no';
	...
	function set_cls_amt2(obj){
	   ...
	   if ( fm.cls_st.value == '7'  ||  fm.cls_st.value == '10' ) {  //출고전해지. 개시전해지 - 계산시 부가세 틀린경우가 있음 	       
		...
		//각각 부가세 계산하여 더한다.	
		no_v_amt = toInt(parseDigit(fm.ex_di_v_amt_1.value)) + ( toInt(parseDigit(fm.nfee_amt_1.value)) * 0.1)   + ( toInt(parseDigit(fm.over_amt_1.value)) * 0.1)      -  c_pp_s_amt  -  c_rfee_s_amt ;
        ...
        <table border="0" cellspacing="1" cellpadding="0" width=100%>
          ...
          <tr> 
            ...
            <td colspan="5">&nbsp;
     	    ...
     	    <td>&nbsp; 
		  <select name="match" onchange="javascript:cng_input();">
                <option value="">--선택--</option>
    ...
    <tr>    
           <td colspan="2" class='line'> 
	              ...
	              <tr> 
	               ...
	               <tr> 			          
			            <td colspan=8 >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=red><b>유보할 사유 구체적 내용: </b></font> <input type="text" name="delay_desc"  size='120' class='text'>
	                  </td>
	               </tr>     
