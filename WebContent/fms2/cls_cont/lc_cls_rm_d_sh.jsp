...
%>
<form name='form1' action='/fms2/cls_cont/lc_cls_rm_d_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 해지관리 > <span class=style5>월렌트해지정산문서처리</span></span></td>
                  ...
                  <!--  	  <option value='9' <%if(s_kd.equals("9")){%>selected<%}%>>결재일자</option>  -->
                    ...
                    <td width=15%>&nbsp;
            		  <select name='andor'>
                          ...
                          <option value='14' <%if(andor.equals("14")){%>selected<%}%>>월렌트해지</option>
