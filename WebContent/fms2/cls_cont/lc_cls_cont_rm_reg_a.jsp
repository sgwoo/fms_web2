...
//	System.out.println(" 해지 처리 flag 6=" + flag);
	...
	if ( reco_st.equals("N")  ) {
		...
		sub 		= "미회수차량해지 통보";
		cont 	= " 미회수차량이 해지 되었습니다. 계약번호 : "+rent_l_cd +" , 해지일 :   "+ cls_dt + " 업무에 참고 바랍니다.!!!";
...
//		System.out.println(" 재리스 처리 flag7=" + flag);		
	...
	if ( cls_st.equals("14")  ) {
		...
		String msgGubun = "계약해지";
			...
			String target_id = nm_db.getWorkAuthUser("대전보험담당");  //보험 관리자		000070->000193	
...
//			System.out.println("쿨메신저(보험관리)"+car_no+"---------------------"+target_bean.getUser_nm());	
//		}
	}	
