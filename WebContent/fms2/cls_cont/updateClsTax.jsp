		       ...
		       <tr> 
		        <td colspan="2" class='line'> 
		          <table border="0" cellspacing="1" cellpadding="0" width=100%>
		            ...
		            <tr> 
		              <td class="title" rowspan="20" width="4%">미<br>
		                납<br>
		                입<br>
		                금<br>
		                액</td>
		             ...
		             <tr>
		              ...
		              <td class='' align="center"> 
		                <input type='text' name='ex_di_amt'  readonly value='<%=AddUtil.parseDecimal(cls.getEx_di_amt())%>'  size='15' class='num' onBlur='javascript:this.value=parseDecimal(this.value); set_cls_amt2(this);'> 원</td> 
		            ...
		            <tr> 
		              ...
		              <td align="center"> 
		                <input type='text' size='15' name='nfee_amt' readonly  value='<%=AddUtil.parseDecimal(cls.getNfee_amt())%>' class='num' onBlur='javascript:this.value=parseDecimal(this.value); set_cls_amt2(this);'> 원</td>  
		              <td align="center"> 
		             ...
		             <tr> 
		              <td class="title" colspan="2">대여료미납</td>
		              ...
		              <td class='title' align="center" class="title"> 
		                <input type='text' name='dly_amt' readonly value='<%=AddUtil.parseDecimal(cls.getDly_amt())%>' size='15' class='num' onBlur='javascript:this.value=parseDecimal(this.value); set_cls_amt2(this);'> 원</td>
		              <td class='title' align="center" class="title"> 
		        ...
		        <td class=line>
		            <table width=100% border=0 cellspacing=1 cellpadding=0>
		       		  <tr>
		                    ...
		                    <td width=12% >&nbsp;<input type='text' name='fdft_amt2' value='<%=AddUtil.parseDecimal(cls.getFdft_amt2())%>' size='15' class='num' readonly  > 원</td>
		                    <input type='hidden' name='est_amt' value='<%=AddUtil.parseDecimal(cls.getEst_amt())%>' size='15' class='num' readonly  >
		                    <td colspan=6>&nbsp;※ 미납금액계 - 환불금액계 - 추가입금액</td>
		              </tr>
