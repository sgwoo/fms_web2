	...
	function reg()
	{
	  //추후 데이타 많아지면
	   var fm = document.form1;	   	  
	 	...
	 	fm.action='lc_cls_est_reg_frame.jsp';	
...
%>
<form name='form1' action='/fms2/cls_cont/lc_cls_est_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 해지관리 > <span class=style5>사전 정산서</span></span></td>
                ...
                <tr>
                    ...
                    <td width=15%>&nbsp;
            		  <select name='andor'>
                          ...
                          <option value='8' <%if(andor.equals("8")){%>selected<%}%>>매입옵션</option>                        
