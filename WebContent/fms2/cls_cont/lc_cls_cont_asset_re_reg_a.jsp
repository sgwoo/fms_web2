...
//	if (tax_branch.equals("")) tax_branch = "S1";
...
// 부가세관련
	...
	if(m_ven_type.equals("1")){  //개인인 경우 
		ht4.put("NO_COMPANY",   "8888888888"); //개인인 경우 사업자등록번호 888888888
	} else {
  ...
  //국가보조금이 있는 경우 - 친환경차에대해서
	...
	//		 현재는 렌트밖에 없어서 계정이 하나 - 20170112 
		if ( car_use.equals("2") ) { //렌트이면
			...
			ht6_1.put("CD_ACCT",  	"22010");  //리스사업차량 국가보조금 
		}	
