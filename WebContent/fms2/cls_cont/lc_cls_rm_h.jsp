...
<!--
	...
	function SearchopenBrWindow() { //v2.0
		...
		if(fm.auth_rw.value != '2' && fm.auth_rw.value != '4' && fm.auth_rw.value != '6'){ alert('권한이 없습니다.'); return; }		
...
<form  name="form1" method='post'>
  ...
  <input type="hidden" name="go_url" value="/fms2/cls_cont/lc_cls_rm_c.jsp">      
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 해지관리 > <span class=style5>월렌트해지정산등록</span></span></td>
