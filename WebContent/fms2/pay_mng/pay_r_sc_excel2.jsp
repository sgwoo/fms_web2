...
response.setHeader("Content-Disposition", "inline; filename=pay_r_sc_excel2.xls");
%>
...
<%
	...
	Vector vt =  pm_db.getPayRCheckList2(s_kd, t_wd, st_dt, end_dt, gubun1, gubun2, gubun3, gubun4);
	int vt_size = vt.size();
...
<table border="0" cellspacing="0" cellpadding="0" width='1010'>
    <tr>
	  <td colspan='<%=col_cnt%>' align='center' style="font-size : 20pt;" height="50">출금송금결과 현황 (<%=st_dt%>~<%=end_dt%>)</td>
	</tr>
    <tr>
...
<table border="1" cellspacing="0" cellpadding="0" width='1010'>
    		...
    		<%	if(String.valueOf(ht.get("ACTSEQ")).equals("999999999999999")){%>
                <tr>                     
                    <td align='center'>&nbsp;</td>                    
                    <td align='center'>&nbsp;</td>
                    <td align='center'>&nbsp;</td>        	            	    
