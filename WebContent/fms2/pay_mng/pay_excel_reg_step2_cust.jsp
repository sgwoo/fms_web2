...
<%
	...
	String value01[] = request.getParameterValues("value1");//거래처코드
	...
	String value08[] = request.getParameterValues("value8");//은행명
	String value09[] = request.getParameterValues("value9");//계좌번호
	String value10[] = request.getParameterValues("value10");//비용담당자
	String value11[] = request.getParameterValues("value11");//공급가
	String value12[] = request.getParameterValues("value12");//부가세
	String value13[] = request.getParameterValues("value13");//합계
	String value14[] = request.getParameterValues("value14");//계정과목코드
	String value15[] = request.getParameterValues("value15");//비용구분
	String value16[] = request.getParameterValues("value16");//상세구분1
	String value17[] = request.getParameterValues("value17");//상세구분2
	String value18[] = request.getParameterValues("value18");//적요
	String value19[] = request.getParameterValues("value19");//참가인원수
	
	String user_nm0[] = request.getParameterValues("value20");//사용자
	String user_pl0[] = request.getParameterValues("value21");//금액
	String user_nm1[] = request.getParameterValues("value22");//사용자
	String user_pl1[] = request.getParameterValues("value23");//금액
	String user_nm2[] = request.getParameterValues("value24");//사용자
	String user_pl2[] = request.getParameterValues("value25");//금액
	String user_nm3[] = request.getParameterValues("value26");//사용자
	String user_pl3[] = request.getParameterValues("value27");//금액
	String user_nm4[] = request.getParameterValues("value28");//사용자
	String user_pl4[] = request.getParameterValues("value29");//금액
	String user_nm5[] = request.getParameterValues("value30");//사용자
	String user_pl5[] = request.getParameterValues("value31");//금액
	String user_nm6[] = request.getParameterValues("value32");//사용자
	String user_pl6[] = request.getParameterValues("value33");//금액
	String user_nm7[] = request.getParameterValues("value34");//사용자
	String user_pl7[] = request.getParameterValues("value35");//금액
	String user_nm8[] = request.getParameterValues("value36");//사용자
	String user_pl8[] = request.getParameterValues("value37");//금액
	String user_nm9[] = request.getParameterValues("value38");//사용자
	String user_pl9[] = request.getParameterValues("value39");//금액
	...
	for(int i=start_row ; i <= value_line ; i++){
		...
		String buy_user_nm = value10[i]==null?"":value10[i];
		UsersBean buyer_bean = umd.getUserNmBean(buy_user_nm);
		bean.setBuy_user_id	(buyer_bean.getUser_id());//사용자
		
		bean.setI_s_amt			(value11[i]==null?0:AddUtil.parseDigit4(value11[i]));
		bean.setI_v_amt			(value12[i]==null?0:AddUtil.parseDigit4(value12[i]));
		bean.setI_amt				(value13[i]==null?0:AddUtil.parseDigit4(value13[i]));
		
		bean.setAcct_code		(value14[i]==null?"":value14[i]);
		bean.setCost_gubun	(value15[i]==null?"":value15[i]);
		bean.setAcct_code_g	(value16[i]==null?"":value16[i]);
		bean.setAcct_code_g2(value17[i]==null?"":value17[i]);
		bean.setP_cont			(value18[i]==null?"":value18[i]);
		bean.setUser_su			(value19[i]==null?"":value19[i]);
...
<input type='hidden' name='from_page' value='/fms2/pay_mng/pay_excel_reg_step2_cust.jsp'>
