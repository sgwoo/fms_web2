...
<%
	...
	if(gubun1.equals("") && gubun4.equals("") && gubun5.equals("") && s_kd.equals("")){
		gubun1 = "1";
		gubun4 = "2";
		gubun5 = "1";
	}
...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
  <frame src="./pay_a_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./pay_a_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>
