      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
              <tr>
                ...
                <td width="40%">&nbsp;
				  <select name='gubun4'>
                    <option value="1" <%if(gubun4.equals("1"))%>selected<%%>>청구일자</option>
                  </select>			
				  &nbsp;	
				  <select name='gubun1'>
                ...
                <td width="10%" class="title">출금항목</td>
                <td width="40%">&nbsp;
					<select name='gubun3'>
			  ...
			  <tr>
                ...
                <td>&nbsp;
                  <select name='s_kd'>
                    ...
                    <option value='3' <%if(s_kd.equals("3")){%>selected<%}%>>등록지점 </option>															
                    <option value='2' <%if(s_kd.equals("2")){%>selected<%}%>>기안자 </option>
                    <option value='4' <%if(s_kd.equals("4")){%>selected<%}%>>문서번호 </option>
                  </select>
					&nbsp;&nbsp;&nbsp;
