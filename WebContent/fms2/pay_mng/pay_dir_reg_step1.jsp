...
<!--
	...
	function doc_search(){
		var fm = document.form1;	
		if(fm.p_est_dt.value == ''){		alert('거래일자를 입력하십시오.'); 				fm.p_est_dt.focus(); 	return;}
		if(fm.ven_code.value == ''){		alert('네오엠 거래처 코드를 입력하십시오.'); 	fm.ven_code.focus(); 	return;}		
	...
	function save()
	{
		...
		if(fm.off_st.value != 'other' && fm.off_id.value == '')		{	alert('지출처를 선택하십시오.'); 		fm.off_id.focus(); 	return; }
		if(fm.off_st.value == 'off_id' && (fm.ven_name.value == '' || fm.ven_name.value == 'null'))	{	alert('네오엠거래처를 선택 혹은 등록하십시오.'); 		fm.ven_name.focus();	return; }
		if(fm.off_st.value == 'other' && fm.ven_name.value == '')	{	alert('네오엠거래처를 선택하십시오.'); 		fm.ven_name.focus();	return; }
      ...
      <td class=line> 
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
          ...
          <tr>
            ...
            <td>&nbsp;
              <select name='off_st' class='default'>
                ...
                <!--<option value="cpt_cd" >할부금융사</option>-->
                <!--<option value="ins_com_id" >보험사</option>-->
                <!--<option value="car_off_id" >자동차영업소</option>-->
                <!--<option value="emp_id" >영업사원</option>-->
                <option value="off_id" >협력업체</option>
                <option value="gov_id" >관공서</option>
                <option value="com_code" >카드사</option>
				<!--<option value="client_id" >거래처</option>-->
				<option value="br_id" >아마존카</option>
          ...
          <tr>
            ...
            <td>&nbsp;
			    <input type='radio' name="tax_yn" value='Y' >있다
				<input type='radio' name="tax_yn" value='N' >없다
				<input type='radio' name="tax_yn" value='C' >현금영수증(승인번호 : <input type='text' name='cash_acc_no' size='9' maxlength='9' value='' class='default' >)
			    <!--<input type="checkbox" name="tax_yn" value="Y">-->
                <!--<font color="red">(과세매입- 세금계산서가 발행되고, 네오엠에 미지급이 안잡힌 경우에 체크, <b>네오엠 자동전표 미지급금 발행</b>)</font>-->
				<!--<a href="javascript:doc_search()" onMouseOver="window.status=''; return true">[미지급금전표확인]</a>-->
			</td>
          </tr>		
          <tr>
            <td class=title>미지급금발행여부</td>
            <td >&nbsp;
			    <input type='radio' name="acct_code_st" value='1'>모른다.				
				<input type='radio' name="acct_code_st" value='4'>미지급금 처리하지 않는다.
				<input type='radio' name="acct_code_st" value='2'>기발행한 미지급금 전표가 있다.
          ...
          <tr>
            <td rowspan="5" class=title>증빙서류</td>
            <td>&nbsp;
