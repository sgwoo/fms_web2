...
<%
	...
	Vector vt = pm_db.getPayDoc31LastList();
	int vt_size = vt.size();
        ...
        <td class='line'>
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
				...
				<%	for(int i = 0 ; i < vt_size ; i++){
						...
						Vector l_vt = pm_db.getPayDocList(String.valueOf(ht.get("DOC_ID")), "", "", "", String.valueOf(ht.get("DOC_NO")));
		        ...
		        <tr>
					...
					<td align="center" class='line3' colspan='7'>
					  <table border="0" cellspacing="0" cellpadding="0" width='100%'>
						...
						<%	if(l_vt_size==0){%>
					    <tr>
						  <td align="center">세부 리스트가 없습니다. (<%=ht.get("DOC_NO")%> <a href="javascript:doc_del('<%=ht.get("DOC_NO")%>');">[취소]</a>)</td>
						</tr>												
						<%	}%>
					  </table>
					</td>					
        ...
        <td class='line'>
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
				...
				<%	for(int i = 0 ; i < vt_size ; i++){
						...
						Vector l_vt = pm_db.getPayActDocBankCodeList(String.valueOf(ht.get("DOC_ID")), String.valueOf(ht.get("DOC_NO")));
						int l_vt_size = l_vt.size();
