      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
              <tr>
                ...
                <td width="40%">&nbsp;
				  <select name='gubun4'>
                    <option value="1" <%if(gubun4.equals("1"))%>selected<%%>>출금일자</option>
                    <option value="2" <%if(gubun4.equals("2"))%>selected<%%>>거래일자</option>
                    <option value="3" <%if(gubun4.equals("3"))%>selected<%%>>등록일자</option>										
                  </select>			
				  &nbsp;	
				  <select name='gubun1'>
                ...
                <td width="40%">&nbsp;
                  <select name='gubun2'>
                    ...
                    <option value="1" <%if(gubun2.equals("1"))%>selected<%%>>현금</option>
					<option value="5" <%if(gubun2.equals("5"))%>selected<%%>>계좌이체</option>					
              ...
              <tr>
                ...
                <td>&nbsp;
                  <select name='s_kd'>
                    ...
                    <option value='2' <%if(s_kd.equals("2")){%>selected<%}%>>금융사</option>
                    <option value='3' <%if(s_kd.equals("3")){%>selected<%}%>>카드/계좌번호</option>
                    <option value='4' <%if(s_kd.equals("4")){%>selected<%}%>>적요</option>
                    <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>등록자</option>
                    <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>문서기안자</option>
                    <option value='7' <%if(s_kd.equals("7")){%>selected<%}%>>송금요청자</option>
                    <option value='8' <%if(s_kd.equals("8")){%>selected<%}%>>원장번호</option>
					<option value='9' <%if(s_kd.equals("9")){%>selected<%}%>>사업자번호</option>
					<option value='10' <%if(s_kd.equals("10")){%>selected<%}%>>수신예금주</option>					
					<option value='11' <%if(s_kd.equals("11")){%>selected<%}%>>자동전표번호</option>					
					<option value='12' <%if(s_kd.equals("12")){%>selected<%}%>>비용담당자</option>					
                  </select>
					&nbsp;&nbsp;&nbsp;
                ...
                <td>&nbsp;
                    <select name='gubun3'>
		        		...
		        		<%}%>	
						<option value="02vat" <%if(gubun3.equals("02vat"))%>selected<%%>>영업수당(vat)</option>
			  ...
			  <tr>
			    <td width="10%" class="title">결재방식</td>
				<td colspan="3">&nbsp;
