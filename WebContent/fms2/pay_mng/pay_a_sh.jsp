    ...
    <tr>
      <td class=line>
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
              <tr>
                ...
                <td width="40%">&nbsp;
				  <select name='gubun4'>
                    ...
                    <option value="2" <%if(gubun4.equals("2"))%>selected<%%>>예정일자</option>					
                  </select>			
				  &nbsp;	
				  <select name='gubun1'>
              ...
              <tr>
                ...
                <td>&nbsp;
                  <select name='s_kd'>
                    ...
                    <option value='8' <%if(s_kd.equals("8")){%>selected<%}%>>등록지점</option>					
			  ...
			  <tr>
			    <td width="10%" class="title">결재구분</td>
				<td colspan="3">&nbsp;
