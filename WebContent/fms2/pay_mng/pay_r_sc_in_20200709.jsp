    ...
    <td class='line' width='500' id='td_con' style='position:relative;'> 
	  <table border="0" cellspacing="1" cellpadding="0" width='500'>
        ...
        <tr> 
		  ...
		  <a href="javascript:parent.view_pay_act('<%=ht.get("ACTSEQ")%>')" onMouseOver="window.status=''; return true" title="클릭하세요"><span title='<%=ht.get("OFF_NM")%>'><%=Util.subData(String.valueOf(ht.get("OFF_NM")), 10)%></span></a>
		  <%}else{%>
