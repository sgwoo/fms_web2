...
<%
	...
	bean.setP_est_dt2		(request.getParameter("p_est_dt2")==null?"":request.getParameter("p_est_dt2"));
	...
	bean.setAcct_code_st	(request.getParameter("acct_code_st")==null?"":request.getParameter("acct_code_st"));
	...
	bean.setAct_union_yn    (request.getParameter("act_union_yn")==null?"":request.getParameter("act_union_yn"));//송금통합여부
	
	//계좌이체(지출처) 은행코드-code
	if(!bean.getBank_nm().equals("") && bean.getBank_cms_bk().equals("") && bean.getP_way().equals("5")){
	...
	//계좌이체(지출처) 은행코드-네오엠
	if(!bean.getBank_nm().equals("") && bean.getBank_id().equals("") && bean.getP_way().equals("5")){
