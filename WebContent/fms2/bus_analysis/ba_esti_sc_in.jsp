	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
    		...
    		%>
                <tr> 
                    ...
                    <td <%=td_color%> width='150' align='center'><a href="javascript:parent.EstiDisp('<%=ht.get("EST_TYPE")%>','<%=ht.get("EST_ID")%>','<%=ht.get("SET_CODE")%>')" onMouseOver="window.status=''; return true" title='계약상세내역'><%=AddUtil.ChangeDate3(String.valueOf(ht.get("REG_DT")))%></a></td>                    
