...
<%
	...
	int height = 80; //검색 라인수(제목하고 데이터 사이에 보여주는 여백 간격)
%>
...
<%
	...
	String valus = 	"?auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+
					...
					"&s_dt="+s_dt+"&e_dt="+e_dt+"&sort_gubun="+sort_gubun+"&asc="+asc+
				   	"&sh_height="+height+"";
%>
<HTML>
<HEAD>
...
<FRAMESET rows="<%=height%>, *" >
	<FRAME SRC="./park_io_sh.jsp<%=valus%>" name="c_body" frameborder=0  marginwidth="10" marginheight="10" scrolling="no" >
	<FRAME SRC="./park_io_sc.jsp<%=valus%>" name="c_foot" frameborder=0 scrolling="no"  marginwidth="10" topmargin=10 noresize>
</FRAMESET>
