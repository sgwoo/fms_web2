...
<%	
	...
	String wash_pay = request.getParameter("wash_pay")==null?"14000":request.getParameter("wash_pay");
        ...
        <td class=line>
			<table width=100% height="" border="0" cellpadding='0' cellspacing="1">
				<tr>
					...
					<td width=20% style="padding-left: 5px;">
						<% if (park_seq == 0) { %>
							<input type="text" name="car_nm" value="<%=car_nm%>" size="30" maxlength='50' class='text' disabled>
						<% } else { %>
								<%=car_nm%>
				...
				<tr>					
					...
					<td class=title width=10%>세차일시</td>
					<td width=20% style="padding-left: 5px;">
						<% if (park_seq == 0) { %>
							<input type="text" name="wash_dt" value="<%=AddUtil.ChangeDate2(String.valueOf(AddUtil.getDate(4)))%>" size="30" maxlength='10' class='text' onBlur='javascript:this.value=ChangeDate4(this, this.value);'>
						<% } else { %>
							<input type="text" name="wash_dt" value="<%=AddUtil.ChangeDate2(String.valueOf(wash_dt))%>" size="30" maxlength='10' class='text' onBlur='javascript:this.value=ChangeDate4(this, this.value);'>
						<% } %>
					</td>
