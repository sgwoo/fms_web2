	...
	function search_ok(gov_id, gov_nm, mng_dept, gov_st_nm, mng_nm, mng_pos){
		...
		if ( fm1.gubun.value == '1') {
			...
			fm.mng_pos.value = mng_pos;				
                 } else if ( fm1.gubun.value == '2') {
			fm.vio_id.value = gov_id;
			fm.vio_pla.value = gov_nm;				
		}	
		window.close();
	}
//-->
    ...
    <tr>
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                    <td width="275">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/center/arrow_ssc.gif align=absmiddle> : 
                    <input type="text" name="t_wd" size="30" class="text" value='<%=t_wd%>' onKeyDown='javascript:enter()' style='IME-MODE: active'>
                    </td>
                    <td width="160"><a href='javascript:search()'><img src=../images/center/button_search.gif align=absmiddle border=0></a></td>
                    <td>&nbsp;</td>
                </tr>
            </table>
        </td>
