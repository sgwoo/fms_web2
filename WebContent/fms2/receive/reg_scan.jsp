...
<!--
	...
	function save(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.RECEIVE%>";		
		fm.submit();		
	}
		    ...
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
                    ...
                    <td >&nbsp;
                        ...
                        <input type='hidden' name='<%=Webconst.Common.contentCodeName%>' value='<%=UploadInfoEnum.RECEIVE%>'>                         
                    </td>
                </tr>
            </table>
        </td>
