...
<form name='form1' action='/fms2/receive/receive_s_sc.jsp' target='c_foot' method='post'>
...
<div>
	<table width=100% border=0 cellpadding=0 cellspacing=0 class="search-area">
		<tr>
		 <td style="height: 30px" class="navigation">&nbsp;<span class=style1>채권관리 > 추심관리 > <span class=style5>추심현황</span></span></td>	
		</tr>
	</table>
</div>
