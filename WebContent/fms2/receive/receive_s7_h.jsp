...
<form  name="form1" method='post'>
  ...
  <input type="hidden" name="go_url" value="/fms2/receive/receive_s7_c.jsp">      
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>채권관리 > 채권추심관리 > <span class=style5>추심의뢰등록</span></span></td>
