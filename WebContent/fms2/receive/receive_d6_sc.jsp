...
<!--
	//금액확정 : term_yn = 2
	function action( mode, rent_mng_id, rent_l_cd, doc_no){
	...
	function action_u(rent_mng_id, rent_l_cd){
		var fm = document.form1;		
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/receive/receive_d6_frame.jsp'>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="receive_d6_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
