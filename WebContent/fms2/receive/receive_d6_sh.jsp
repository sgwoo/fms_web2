...
%>
<form name='form1' action='/fms2/receive/receive_d6_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>채권관리 > 채권추심관리 > <span class=style5> 소송 관리</span></span></td>
                ...
                <tr>
                    ...
                    <td width=30%>&nbsp;
            		    <select name='s_kd'>
                          ...
                          <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>소송일자 </option>
                        </select>
        			    &nbsp;&nbsp;&nbsp;
