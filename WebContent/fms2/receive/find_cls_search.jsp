	...
	function preSearch()
{
	...
	function loan_confirm(){
		...
		fm.target = "c_foot";
		fm.action = "receive_reg_step1_off_sc.jsp" ;		
		fm.submit();
		window.close();
	}			
//-->
...
<body>
<form name='form1' action='find_cls_search_in.jsp' method='post' target='i_no'>
<input type='hidden' name='auth_rw' value='<%=auth_rw%>'>
<input type='hidden' name='user_id' value='<%=user_id%>'>
<input type='hidden' name='br_id' value='<%=br_id%>'>
<input type='hidden' name='r_ven_code' value='<%=n_ven_code%>'>
<table border="0" cellspacing="0" cellpadding="0" width=1030>
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1><span class=style5>해지차량조회</span></span></td>
    ...
    <tr> 
        <td><iframe src="./find_cls_search_in.jsp?r_ven_code=<%=n_ven_code%>&auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&gubun_nm=<%=gubun_nm%>" name="i_no" width="1020" height="530" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe></td>
    </tr>
    <tr>
