...
<form name='form1' action='/fms2/receive/gua_d_sc.jsp' target='c_foot' method='post'>
...
<div>
	<table width=100% border=0 cellpadding=0 cellspacing=0 class="search-area">
		<tr>
		 <td style="height: 30px" class="navigation">&nbsp;<span class=style1>채권관리 > 보증보험관리 > <span class=style5>진행현황</span></span></td>	
		</tr>
	</table>
</div>
	...
	<div style="float:left;">
		<label><i class="fa fa-check-circle"></i> 기간조회 </label>		
		 <select name='gubun0' class="select" >
                 ...
                 <option value="2" <%if(gubun0.equals("2"))%>selected<%%>>입금일자</option>
        </select>	
        &nbsp;	  		
