...
<form  name="form1" method='post'>
  ...
  <input type="hidden" name="go_url" value="/fms2/receive/reco_c.jsp">      
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>채권관리 > 미회수자동차관리 > <span class=style5>미회수자동차위임등록</span></span></td>
