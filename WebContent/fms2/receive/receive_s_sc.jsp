...
<%
	...
	from_page = "/fms2/receive/receive_s_frame.jsp"; 
	
	String valus = 	"?from_page="+from_page+"&st_dt="+st_dt+"&end_dt="+end_dt+"&gubun0="+gubun0+"&auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+
...
<form name='form1' action='' method='post' target='d_content'>
  ...
  <input type='hidden' name='from_page' value='/fms2/receive/receive_s_frame.jsp'>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="receive_s_sc_in.jsp<%=valus%>" name="i_no" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
