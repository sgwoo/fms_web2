...
<%
	...
	Vector vt = re_db.getClsCarRecoList(s_kd, t_wd, gubun1, andor, "1");
	int vt_size = vt.size();
%>
...
<table border="0" cellspacing="0" cellpadding="0" width='100%'>
	...
	<tr id='tr_title' style='position:relative;z-index:1'>
		<td class='line' width='36%' id='td_title' style='position:relative;'>
...
%>
	<tr>
		<td class='line' width='36%' id='td_con' style='position:relative;'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
<%
...
%>			
				<tr>
					...
					<td  <%=td_color%> width='9%' align='center'>
					  ...
					  <%}%></td>
					 <td  <%=td_color%> width='20%' align='left'>
					 <% if ( String.valueOf(ht.get("IP_DT")).equals("null") || String.valueOf(ht.get("IP_DT")).equals("") ) {%>					 
					&nbsp;
					 <% } else { %>
					 * <%=AddUtil.ChangeDate2(String.valueOf(ht.get("IP_DT")))%> 회수	
					 <% } %>	
				     </td> 		  				
				</tr>
<%
