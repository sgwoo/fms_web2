...
<%
	...
	ClsBandBean cls = re_db.getClsBandInfo(rent_mng_id, rent_l_cd);
	
	from_page = "/fms2/receive/receive_d7_frame.jsp";	
			
	cls.setRent_mng_id(rent_mng_id);
	cls.setRent_l_cd(rent_l_cd);
	cls.setSettle_dt(request.getParameter("settle_dt")==null?"":	request.getParameter("settle_dt"));// 종결일자
	...
	cls.setRemarks(request.getParameter("remarks")==null?"":				request.getParameter("remarks"));           //특이사항
	
	if(!re_db.updateClsBand(cls))	flag += 1;
