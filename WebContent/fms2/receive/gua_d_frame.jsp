...
<%
	...
	String valus = 	"?st_dt="+st_dt+"&end_dt="+end_dt+"&gubun0="+gubun0+"&auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+
					"&s_kd="+s_kd+"&t_wd="+t_wd+"&andor="+andor+"&gubun2="+gubun2+"&sort_gubun="+sort_gubun+"&asc="+asc+
				   	"&sh_height="+height+"";
%>
<frameset rows="<%=height%>, *" border=1> 
  <frame src="./gua_d_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./gua_d_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no'>
</frameset>
</HTML>