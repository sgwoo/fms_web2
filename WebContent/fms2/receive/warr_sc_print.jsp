...
<body leftmargin="" topmargin="1" onLoad="javascript:pagesetPrint()" >
			...
			<div style="margin-top:4px;">
				...
				<table border="0" cellspacing="0" cellpadding='0' width='100%' align="center" class="contents" style="table-layout:;">
					...
					<tr style="">	
						...
						<td style="text-align:left;">&nbsp;&nbsp;<input type="text" style="font-size:11pt;width:90px;" value=<%=AddUtil.ChangeDate(gi_start_dt,"YYYY-MM-DD")%>>~
						&nbsp;&nbsp;<input type="text" style="font-size:11pt;width:90px;" value=<%=AddUtil.ChangeDate(gi_end_dt,"YYYY-MM-DD")%>></td>
			...
			<div style="margin-top:0px;">
				<table border="0" cellspacing="0" cellpadding='0' width='100%' align="center" class="contents" style="table-layout:;">
					...
					<tr>
						...
						<td style="text-align:left;">&nbsp;&nbsp;<input type="text" style="font-size:11pt;width:90px;" value=<%=AddUtil.ChangeDate(rent_start_dt,"YYYY-MM-DD")%>>~
						&nbsp;&nbsp;<input type="text" style="font-size:11pt;width:90px;" value=<%=AddUtil.ChangeDate(rent_end_dt,"YYYY-MM-DD")%>></td>
					</tr>
				</table>
			</div>			
			<br>
