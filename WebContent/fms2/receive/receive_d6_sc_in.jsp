...
<%
	...
	//Vector vt = re_db.getClsSuitDocList(s_kd, t_wd, gubun1, andor, "1");
	Vector vt = re_db.getClsSuitDocList2(s_kd, t_wd, gubun1, andor, "1");
	int vt_size = vt.size();
%>
		...
		<td class='line' width='66%'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				<tr>
				    ...
				    <td rowspan="2" class='title'  width='8%'>소송일 </td>		
...
%>			
				<tr>
					...
					<td  <%=td_color%> width='8%' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("SUIT_DT")))%></td> <!-- 소송일 -->
