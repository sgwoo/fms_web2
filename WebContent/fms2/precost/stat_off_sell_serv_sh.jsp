...
<%
	...
	Vector vt = ad_db.getStatDebtList("stat_off_sell");
	int vt_size = vt.size();	
%>
...
<!--
	function Search(){
		...
		fm.action="stat_off_sell_serv_sc.jsp";
		if(fm.s_yy.value == '') fm.action = 'stat_off_sell_serv_sc_y.jsp';
		fm.target="c_foot";		
		fm.submit();
	}
	function enter() {
...
<form action="./stat_off_sell_serv_sc.jsp" name="form1" method="POST" target="c_foot">
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr> 
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gjij.gif align=absmiddle>
			  ...
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<select name="gubun1">
					<option value="1" <%if(gubun1.equals("1")){%>selected<%}%>>공임</option>
					<option value="2" <%if(gubun1.equals("2")){%>selected<%}%>>부품</option>
					<option value="3" <%if(gubun1.equals("3")){%>selected<%}%>>합계</option>
				</select>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
