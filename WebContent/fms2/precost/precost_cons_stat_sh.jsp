...
<!--
	function Search(){
		...
		fm.action="precost_cons_stat_sc.jsp";
		fm.target="c_foot";		
		fm.submit();
	}
	function enter() {
...
<%
	...
	//보험선급비용 미정산건리스트
	Vector vts4 = ai_db.getInsurPrecostNoSettleList();
...
<input type='hidden' name='work_st' value=''>
  <table border=0 cellspacing=0 cellpadding=0 width=100%>
	  ...
	  <td colspan=5>
    	<table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 재무분석 > <span class=style5>탁송료현황</span></span></td>
    ...
    <tr> 
      <td width="145">
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_yd.gif align=absmiddle>
        &nbsp;
		<select name="gubun1">
      ...
      <td width="135">
		...
		<select name='brch_id'>
		  ...
		  <option value='K3'  <%if(brch_id.equals("K2")){%>selected<%}%>>수원지점</option>
