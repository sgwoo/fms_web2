...
<%
	...
	//자동차세 리스트
	vts = ai_db.getExpRtnScdReqList_a(car_ext);
	vt_size = vts.size();
%>
<form name='form1' method='post'>
  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    ...
    <tr>
      <td><%if(car_ext.equals("1")){%>영등포구청(김미리:02-2670-3283, 환급신청-김현웅:02-2670-3216, email:kimida82@ydp.go.kr )<%}else if(car_ext.equals("2")){%>파주시청(:031-940-4231, fax:031-940-4239)<%}else if(car_ext.equals("6")){%>포천시청(신경숙: 031-538-2191, fax:031-538-2755, email:maiden1004@pcs21.go.kr)<%}else if(car_ext.equals("3")){%>부산<%}else if(car_ext.equals("4")){%>김해<%}else if(car_ext.equals("5")){%>대전<%}else if(car_ext.equals("9")){%>광주<%}else if(car_ext.equals("7")){%>인천(tel: 032-450-5253~4, fax:032-450-5189)<%}%></td>
    </tr>  		
	<tr>
	  <td class=line>
