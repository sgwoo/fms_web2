...
<%
	...
	//자동차세 리스트
	vts = ai_db.getExpRtnScdReqList_s(car_ext);
	vt_size = vts.size();
%>
<form name='form1' method='post'>
  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    ...
    <tr>
      <td><%if(car_ext.equals("1")){%>영등포구청(홍주영:02-2670-3838, 환급신청:02-2670-3216, email:beads@ydp.go.kr)<%}else if(car_ext.equals("2")){%>파주시청(한명석:031-940-4231, fax:031-940-4219)<%}else if(car_ext.equals("6")){%>포천시청(신경숙: 031-538-2191, fax:031-538-2755)<%}else if(car_ext.equals("3")){%>부산<%}else if(car_ext.equals("4")){%>김해<%}else if(car_ext.equals("5")){%>대전<%}else if(car_ext.equals("6")){%>인천<%}else if(car_ext.equals("9")){%>광주<%}%></td>
    </tr>  		
	<tr>
	  <td class=line>
