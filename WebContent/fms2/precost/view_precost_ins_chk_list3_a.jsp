	...
	if(cost_st.equals("2")){
		...
		for(int i = 0 ; i < vt_size ; i++){
			...
			if(!String.valueOf(ht.get("CHK_AMT2")).equals("0")){
				...
				cost.setCost_day	(AddUtil.parseInt(String.valueOf(ht.get("COST_DAY"))));
				cost.setCost_amt	(cost_amt);
				cost.setRest_day	(AddUtil.parseInt(String.valueOf(ht.get("REST_DAY"))));
				cost.setRest_amt	(AddUtil.parseInt(String.valueOf(ht.get("REST_AMT"))));
