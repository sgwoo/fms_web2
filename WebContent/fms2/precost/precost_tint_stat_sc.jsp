...
<%
	...
	//업체별 용품요청 현황
	Vector scds1 = t_db.getTintOffStat(gubun1);
	int scd_size1 = scds1.size();
	
	//업체별 용품요청 현황
	Vector scds2 = t_db.getTintBrStat(gubun1);
	int scd_size2 = scds2.size();

	//사원별 용품요청 현황
	Vector scds3 = t_db.getTintUserStat(gubun1);
...
<input type='hidden' name='go_url' value='../ins_stat/ins_s4_frame.jsp'>
  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr> 
      <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>용품업체별 지출현황</span></td>
    </tr>
    <tr>
		<td class=line2 ></td>
	</tr>
      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          <tr>
            ...
            <td colspan="2" class='title'>다옴방</td>
            <td colspan="2" class='title'>유림카랜드</td>
            <td colspan="2" class='title'>웰스킨천연가죽</td>
            <td colspan="2" class='title'>아시아나상사</td>
          </tr>
          <tr>
...
<%			
          ...
          <tr> 
            <td align="center" class=title>계</td>
