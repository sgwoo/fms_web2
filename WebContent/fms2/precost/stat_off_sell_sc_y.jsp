...
<%
	...
	for(int i = 0 ; i < vt_size ; i++){
		...
		if(String.valueOf(ht.get("BR_NM")).equals("영남")){
			if(!String.valueOf(ht.get("ST")).equals("탁송") && !String.valueOf(ht.get("ST")).equals("소계")){
				for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){
					t_cnt1[j-14] = t_cnt1[j-14] + AddUtil.parseInt((String)ht.get("CNT"+(j)));
					t_amt1[j-14] = t_amt1[j-14] + AddUtil.parseInt((String)ht.get("AMT"+(j)));
				}
			}
			s1_row++;
		}
		if(String.valueOf(ht.get("BR_NM")).equals("대전")){
			if(!String.valueOf(ht.get("ST")).equals("탁송") && !String.valueOf(ht.get("ST")).equals("소계")){
				for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){
					t_cnt2[j-14] = t_cnt2[j-14] + AddUtil.parseInt((String)ht.get("CNT"+(j)));
					t_amt2[j-14] = t_amt2[j-14] + AddUtil.parseInt((String)ht.get("AMT"+(j)));
				}
			}
			d1_row++;
		}
		if(String.valueOf(ht.get("BR_NM")).equals("광주")){ 
			if(!String.valueOf(ht.get("ST")).equals("탁송") && !String.valueOf(ht.get("ST")).equals("소계")){
				for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){
					t_cnt3[j-14] = t_cnt3[j-14] + AddUtil.parseInt((String)ht.get("CNT"+(j)));
					t_amt3[j-14] = t_amt3[j-14] + AddUtil.parseInt((String)ht.get("AMT"+(j)));
				}
			}
			j1_row++;
		}
		if(String.valueOf(ht.get("BR_NM")).equals("대구")){ 
			if(!String.valueOf(ht.get("ST")).equals("탁송") && !String.valueOf(ht.get("ST")).equals("소계")){
				for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){
					t_cnt4[j-14] = t_cnt4[j-14] + AddUtil.parseInt((String)ht.get("CNT"+(j)));
					t_amt4[j-14] = t_amt4[j-14] + AddUtil.parseInt((String)ht.get("AMT"+(j)));
				}
			}
			g1_row++;
		}
		if(String.valueOf(ht.get("BR_NM")).equals("부산")){ 
			if(!String.valueOf(ht.get("ST")).equals("탁송") && !String.valueOf(ht.get("ST")).equals("소계")){
				for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){
					t_cnt5[j-14] = t_cnt5[j-14] + AddUtil.parseInt((String)ht.get("CNT"+(j)));
					t_amt5[j-14] = t_amt5[j-14] + AddUtil.parseInt((String)ht.get("AMT"+(j)));
				}
			}
			b1_row++;
		}
      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr>
            ...
            <%	for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){%>
            <td align="right"><%=AddUtil.parseDecimal(t_cnt1[j-14])%></td>
            <td align="right"><%=AddUtil.parseDecimal(t_amt1[j-14])%></td>
					  <%	}%>
          </tr>
          <%}%>
          ...
          <tr>
          	<td align="center">용품 소계</td>
            <%	for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){%>
            <td align="right"><%=AddUtil.parseDecimal(t_cnt2[j-14])%></td>
            <td align="right"><%=AddUtil.parseDecimal(t_amt2[j-14])%></td>
					  <%	}%>
          </tr>
          <%}%>
          ...
          <tr>
          	<td align="center">용품 소계</td>
            <%	for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){%>
            <td align="right"><%=AddUtil.parseDecimal(t_cnt3[j-14])%></td>
            <td align="right"><%=AddUtil.parseDecimal(t_amt3[j-14])%></td>
					  <%	}%>
          </tr>
          <%}%>
          ...
          <tr>
          	<td align="center">용품 소계</td>
            <%	for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){%>
            <td align="right"><%=AddUtil.parseDecimal(t_cnt4[j-14])%></td>
            <td align="right"><%=AddUtil.parseDecimal(t_amt4[j-14])%></td>
					  <%	}%>
          </tr>
          <%}%>
          ...
          <tr>
          	<td align="center">용품 소계</td>
            <%	for (int j = (f_year-2000-1) ; j <= (AddUtil.getDate2(1)-2000) ; j++){%>
            <td align="right"><%=AddUtil.parseDecimal(t_cnt5[j-14])%></td>
            <td align="right"><%=AddUtil.parseDecimal(t_amt5[j-14])%></td>
					  <%	}%>
          </tr>
          <%}%>
