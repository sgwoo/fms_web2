...
<!--
	function Search(){
		...
		fm.action="precost_sale_stat_sc.jsp";
		fm.target="c_foot";		
		fm.submit();
	}
	function enter() {
		...
		<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 재무분석 > <span class=style5>매출변동분석</span></span></td>
    ...
    <tr> 
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_yd.gif align=absmiddle>
              &nbsp;<select name="gubun1">
				...
				<select name="gubun2">
                <%for(int i=1; i<=12; i++){%>
                <option value="<%=AddUtil.addZero2(i)%>" <%if(gubun2.equals(AddUtil.addZero2(i))){%>selected<%}%>><%=i%>월</option>
                <%}%>
              </select>			  
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
