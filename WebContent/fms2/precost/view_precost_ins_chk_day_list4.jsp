...
<!--
	...
	function view_ins_scd_list(cost_ym, car_use, com_id, pay_dt, pay_st){
		window.open('view_precost_ins_chk_day_list_sub4.jsp?cost_ym='+cost_ym+'&car_use='+car_use+'&com_id='+com_id+'&pay_dt='+pay_dt+'&pay_st='+pay_st, "PRECOST_SUB_LIST", "left=0, top=0, width=800, height=768, scrollbars=yes, status=yes, resize");
	}
	
	function view_ins_chk_day5(cost_ym, car_use, com_id){
		window.open('view_precost_ins_chk_day_list5.jsp?cost_ym='+cost_ym+'&car_use='+car_use+'&com_id='+com_id, "PRECOST_LIST_"+cost_ym+car_use+com_id, "left=0, top=0, width=950, height=768, scrollbars=yes, status=yes, resize");
	}
...
<%
	...
	Vector vts = ai_db.getInsurPrecostYmChkDayList4(cost_ym, car_use, com_id);
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr>
        <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>발생보험료 점검 리스트 (보험시작일 기준)</span>
        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        	<a href="javascript:view_ins_chk_day5('<%=cost_ym%>','<%=car_use%>','<%=com_id%>')"> -> [보험가입일 기준]</a></td>
    </tr>  
    <%if(com_id.equals("")){%>
    <tr>
        <td class=line2></td>
