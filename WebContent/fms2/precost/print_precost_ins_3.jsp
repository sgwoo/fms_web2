...
<%
	...
	//발생보험료
	Vector scds4 = ai_db.getInsurScdReqAmtStat("", cost_ym);
...
%>
  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr> 
      <td align="center"><span class=style2><%=cost_ym%> 년 자동차 보험료 발생현황</span></td>
    </tr>
    <tr>
		<td class=line2 ></td>
	</tr>
      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr>
            ...
            <td width='8%' class='title'>지급</td>
            <td class='title' width="4%">건수</td>
            <td class='title' width="8%">지급</td>
            <td class='title' width="7%">환급</td>
            ...
            <td class='title' width="8%">소계</td>
            <td class='title' width="4%">건수</td>
            <td class='title' width="7%">지급</td>
            <td class='title' width="6%">환급</td>
            <td class='title' width="7%">소계</td>
          </tr>
