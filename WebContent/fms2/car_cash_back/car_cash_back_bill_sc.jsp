...
<body>
<form name='form1' action='car_cash_back_pay_sc.jsp' method='post' target='t_content'>
        ...
        <td class="line" >
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr>
                    ...
                    <td width='15%' class='title'>대리점명</td>
