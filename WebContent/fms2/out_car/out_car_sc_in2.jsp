...
<table border=0 cellspacing=0 cellpadding='0' width='1080'>
	...
	<tr>
		<td class=line >
			<table border=0 cellspacing=1 cellpadding=0 width='1080'>
				<tr>
            		...
            		<td class='title' width='100'>계약일</td>
...
%>            	
           		<tr>
           			...
           			<td align='center' width='80'>&nbsp;<span title='<%=stat.get("RPT_NO")%>'><%=Util.subData(String.valueOf(stat.get("RPT_NO")), 7)%></span></td>
            		...
            		<td align='center' width='100'>&nbsp;<span title='<%=stat.get("CAR_NM")%>'><%=Util.subData(String.valueOf(stat.get("CAR_NM")), 6)%></span></td>
           			...
           			<td align='center' width='100'><%=stat.get("RENT_DT")%></td>
            ...
            <!-- 
    				<td align='right' width='100'>
						<%if(AddUtil.parseInt(AddUtil.getReplace_dt(String.valueOf(stat.get("DLV_DT")))) < 20160901 ){%>
							<%=AddUtil.parseDecimal(String.valueOf(stat.get("BC_S_F_2")))%>&nbsp;
						<%}%>	
					</td>-->
