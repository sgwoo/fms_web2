...
<frameset rows="<%=height%>, *" border=1>
        <frame src="/fms2/out_car/out_car_sh.jsp?auth_rw=<%=auth_rw%>&sh_height=<%=height%>&user_id=<%=user_id%>&idx_gubun=<%=idx_gubun%>" name="c_head" marginwidth=10 marginheight=10 scrolling="no" noresize>
