        ...
        <td align="right" class="line">
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
                    ...
                    <td>&nbsp;
				    <input type="radio" name="gubun1" value="1" checked>정일현대 
				    &nbsp;
				    <input type="radio" name="gubun1" value="2" >협신자동차 
				      &nbsp;
				     <input type="radio" name="gubun1" value="3" >성서현대정비 
				       &nbsp;
				     <input type="radio" name="gubun1" value="4" >영등포자동차검사소 
			        <td align="center"><a href="https://fms3.amazoncar.co.kr/data/sample/jungil_sample.xls">엑셀등록샘플</a></td>
                </tr>
            </table>
		</td>
    </tr>
