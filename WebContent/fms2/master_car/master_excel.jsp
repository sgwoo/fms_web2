        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;사고관리 > 마스타자동차 > <span class=style1><span class=style5>엑셀파일을 이용한 서비스내역 등록</span></span></td>
        ...
        <td align="right" class="line">
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
                    ...
                    <td>&nbsp;
				    <input type="radio" name="gubun1" value="1" checked>마스타자동차 등록처리
					&nbsp;&nbsp;
					<input type="radio" name="gubun1" value="5" checked>삼성애니카랜드 등록처리
					&nbsp;&nbsp;
					<input type="radio" name="gubun1" value="7" checked>스피드메이트 등록처리
			        </td>
			        <td align="center"><a href="https://fms3.amazoncar.co.kr/data/sample/master_sample.xls">엑셀등록샘플</a></td>
                </tr>
            </table>
		</td>
    </tr>
