...
//			ch_after 	= vins_spe_yn;
	...
	if(ins_cha_size >0){
		...
		String user_id2 = nm_db.getWorkAuthUser("부산보험담당");
		//String user_id3 = nm_db.getWorkAuthUser("본사영업팀장"); //20140415 영업팀장 결재 빠짐
		//String user_id3 = "XXXXXX";
		String user_id3 = nm_db.getWorkAuthUser("세금계산서담당자"); //20151112 스케줄담당자 추가
		
		//if(sender_bean.getBr_id().equals("B1")) user_id2 = nm_db.getWorkAuthUser("부산보험담당"); -> 20130628 대전보험담당자가 신규,변경 모두 처리, 부산은 갱신만 -->대전담당자없어 부산담당자가 처리
		...
		doc.setEtc	(cng_etc);
		doc.setUser_nm1	("기안자");
		doc.setUser_nm2	("보험담당자");
		//doc.setUser_nm3("영업팀장");
		doc.setUser_nm3	("스케줄담당자");
		doc.setUser_nm4	("");
		doc.setUser_nm5	("");
