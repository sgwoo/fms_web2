               ...
               <!--         <option value='0' <%if(s_kd.equals("0")){%> selected <%}%>>전체</option> -->
								          ...
								          <tr> 
								           <td>
									           <select name='card_cd'>
								                      ...
								                      <option value='11' >나이스</option>	   
	       											  <option value='13' >이노페이</option>		   
	       											  <option value='12' >페이엣</option>		   						                    
								               </select>   
                ...
                <tr> 
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <select name='s_kd2'>
                      <option value='' <%if(s_kd2.equals("")){%>selected<%}%>>--선택-- </option>
                      <option value='1' <%if(s_kd2.equals("1")){%>selected<%}%>>상호 </option>
                      <option value='2' <%if(s_kd2.equals("2")){%>selected<%}%>>계약번호 </option>
                      <option value='3' <%if(s_kd2.equals("3")){%>selected<%}%>>차량번호 </option>
                      </select>
                    </td>                
                    <td width=30%><input type='text' name='t_wd2' size='30' class='text' value='<%=t_wd2%>' style='IME-MODE: active'>
        		  </td>                
                </tr>
            </table>
        </td>
