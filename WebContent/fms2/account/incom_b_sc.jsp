...
<!--
 	//계약서 내용 보기
	function view_incom_b(gubun, incom_dt, seq){
		var fm = document.form1;
		fm.gubun.value = gubun;
		fm.incom_dt.value = incom_dt;
		fm.incom_seq.value = seq;
		fm.target ='d_content';
		if(gubun == '1'){
			fm.action = 'incom_b_s.jsp'; //조회
		}else{
			fm.action = 'incom_reg_step2.jsp'; //수정
		}
		fm.submit();
	}
//-->
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/account/incom_b_frame.jsp'>  
	...
	<tr>
	    <td>
    		<table border="0" cellspacing="0" cellpadding="0" width=100%>
    		  <tr>
    			<td>
    			  <iframe src="incom_b_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
    			</td>
    		  </tr>
    		</table>
	    </td>
