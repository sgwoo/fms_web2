...
<%
	...
	Vector vt = af_db.getACmsDateList(adate, incom_dt);
	int vt_size = vt.size();
%>
...
<%			total_amt1 = total_amt1 + Long.parseLong(String.valueOf(ht.get("AAMT")));
		...
		<tr>
		  ...
		  <td style="text-align:right" class=title><%=Util.parseDecimal(total_amt3)%></td>
		  <td style="text-align:right" class=title><%=Util.parseDecimal(total_amt4)%></td>
		</tr>	
	  </table>
	</td>
  </tr>  
