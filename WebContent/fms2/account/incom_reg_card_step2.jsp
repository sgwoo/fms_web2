...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "05", "12", "21");
	...
	String vlaus = 	"?s_cnt="+s_cnt+"&auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+"&incom_dt="+incom_dt+"&incom_seq="+incom_seq+"&incom_amt="+incom_amt+
...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
  <frame src="./incom_reg_card_step2_sh.jsp<%=vlaus%>" name="c_body" marginwidth=10 marginheight=10  noresize scrolling="no">
  <frame src="./incom_reg_card_step2_sc.jsp<%=vlaus%>" name="c_foot" marginwidth=10 marginheight=10  noresize scrolling="yes">
</frameset>
</HTML>
