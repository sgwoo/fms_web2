...
<%
	...
	hidden_value = "?height="+height+"&auth_rw="+auth_rw+"&s_width="+s_width+"&s_height="+s_height+"&dt="+dt+"&ref_dt1="+ref_dt1+"&ref_dt2="+ref_dt2+"&asc="+asc;	
%> 
...
<form name='form1' method='post' action='shinhan_erp_ib_bulk.jsp'>
	...
	<tr>
		<td colspan=6 style="height: 30px">
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td class="navigation">&nbsp;<span class=style1>경영정보 > 재무회계 > <span class=style5>송금결과관리</span></span></td>
				</tr>
			</table>
		</td>
	</tr>
    ...
    <tr>
		<td colspan=6>
			 <table border="0" cellspacing="1" cellpadding="0" width=100%>
				<tr>
					<td><iframe src="./shinhan_erp_ib_bulk_s.jsp<%=hidden_value%>" name="ii_no" width="100%" height="<%=height+10%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
				</tr>								
			</table>
		</td>
	</tr>
