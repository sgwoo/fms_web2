...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
  <frame src="./incom_reg_step2_sh.jsp<%=vlaus%>" name="c_body" marginwidth=10 marginheight=10  noresize scrolling="no">
  <frame src="./incom_reg_step2_sc.jsp<%=vlaus%>" name="c_foot" marginwidth=10 marginheight=10  noresize scrolling="yes">
</frameset>
</HTML>
