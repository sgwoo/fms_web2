...
<!--
 	//계약서 내용 보기
	function view_incom_b(gubun, incom_dt, incom_seq, incom_amt){
	...
	<tr>
	  <td>
		<table border="0" cellspacing="0" cellpadding="0" width=100%>
		  <tr>
			<td>
			  <iframe src="c_incom_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
			</td>
		  </tr>
		  <tr>
			<td><font color=red>*</font>&nbsp;카드로 결재한 경우에 한해서 처리가능합니다.</td>
		 <tr>
		</table>
	  </td>
	</tr>
