...
<%
	...
	String vlaus = 	"?auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+"&bank_nm="+bank_nm+"&bank_no="+bank_no+
					"&dt="+dt+"&ref_dt1="+ref_dt1+"&ref_dt2="+ref_dt2+"&s_kd="+s_kd+"&t_wd="+t_wd+"&s_kd2="+s_kd2+"&t_wd2="+t_wd2+"&andor="+andor+"&gubun1="+gubun1+"&gubun2="+gubun2+"&from_page="+from_page+
				   	"&sh_height="+height+"";
%>
...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
  <frame src="./incom_d_sh.jsp<%=vlaus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./incom_d_sc.jsp<%=vlaus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>
