    ...
    <tr id='tr_title' style='position:relative;z-index:1'>
  	<tr><td class=line2 colspan="2"></td></tr>		
	    ...
	    <td class='line' width='60%'>
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		        <tr>
            	    <td width="10%" class='title'>처리내역</td>
            	    <td width="7%" class='title'>확인</td>            
            	    <td width="55%" class='title'>적요</td>
        	        <td width="14%" class='title'>입금액</td>   
        	        <td width="14%" class='title'>지점</td>   
		        </tr>
	        </table>
	    </td>
    </tr>
    ...
    <tr>		
	    ...
	    <td class='line' width='60%'>
            ...
            <%	for(int i = 0 ; i < incom_size ; i++){
    				Hashtable ht = (Hashtable)vt.elementAt(i);%>
    		    <tr>
    				<td width='10%' align='center'><a href="javascript:parent.view_incom_b('<%=ht.get("JUNG_TYPE")%>', '<%=ht.get("INCOM_DT")%>', '<%=ht.get("INCOM_SEQ")%>', '<%=ht.get("INCOM_AMT")%>', '<%=ht.get("P_GUBUN")%>')" onMouseOver="window.status=''; return true" title="클릭하세요"><%=ht.get("JUNG_ST_NM")%></a></td>
