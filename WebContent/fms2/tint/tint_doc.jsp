	  ...
	  <td class=line>
		...
		<tr><td class=line2></td></tr>
		  <tr valign="middle" align="center"> 
		    ...
		    <td style="font-size:8pt" width='130' rowspan="2" align='center'>상호</td>
		    <td style="font-size:8pt" width='85' rowspan="2" align='center' >차량번호</td>
		    <td style="font-size:8pt" width='110' rowspan="2" align='center'>차명</td>
		    <td style="font-size:8pt" width='50' rowspan="2" align='center'>영업구분</td>
		    <td style="font-size:8pt" width='100' rowspan="2" align='center'>용품일자</td>
		    <td style="font-size:8pt" colspan="6" align='center'>청구금액</td>
		    <!--
		    <td style="font-size:8pt" width="60" rowspan="2" align='center'>아마존카</td>
		    <td style="font-size:8pt" colspan="2" align='center'>영업사원</td>
		    <td style="font-size:8pt" colspan="2" align='center'>고객</td>
		    -->
		    <td style="font-size:8pt" width="50" rowspan="2" align='center'>의뢰자</td>					    
	      </tr>
		  <tr valign="middle" align="center">
		    <td style="font-size:8pt" width='60' align='center'>썬팅비</td>
		    <td style="font-size:8pt" width='60' align='center'>청소용품비</td>
		    <td style="font-size:8pt" width='60' align='center'>네비게이션</td>
		    <td style="font-size:8pt" width='60' align='center'>블랙박스</td>
		    <td style="font-size:8pt" width='60' align='center'>기타금액</td>
		    <td style="font-size:8pt" width='60' align='center'>합계</td>
		    <!--
		    <td style="font-size:8pt" width='60' align='center'>세전가감</td>
		    <td style="font-size:8pt" width='60' align='center'>세후가감</td>
		    <td style="font-size:8pt" width='60' align='center'>현금</td>
		    <td style="font-size:8pt" width='60' align='center'>대여료합산</td>												
		    -->
		  </tr>
