...
<form name='form1' action='/fms2/tint/tint_p_sc.jsp' target='c_foot' method='post'>
      ...
      <td>
    	<table width=100% border=0 cellpadding=0 cellspacing=0 >
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 용품관리 > <span class=style5>용품비용지급현황</span></span></td>
          ...
          <tr>
            ...
            <td>&nbsp;
        	  <select name='sort'>
                ...
                <option value='10' <%if(sort.equals("10")){%>selected<%}%>>지급일자 </option>
              </select>
        	</td>
          </tr>
        </table>
