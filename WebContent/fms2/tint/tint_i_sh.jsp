...
<form name='form1' action='/fms2/tint/tint_i_sc.jsp' target='c_foot' method='post'>
      ...
      <td>
    	<table width=100% border=0 cellpadding=0 cellspacing=0 >
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 용품관리 > <span class=style5>용품미정산현황</span></span></td>
          ...
          <tr>
            ...
            <td>&nbsp;
			  <select name='gubun3'>
                ...
                <option value='3' <%if(gubun3.equals("3")){%>selected<%}%>>용품수신일</option>				
                <option value='4' <%if(gubun3.equals("4")){%>selected<%}%>>차량등록일</option>				
              </select>
        	  <select name='gubun2'>
          ...
          <tr>
            ...
            <td>&nbsp;
        	  <select name='sort'>
                ...
                <option value='8' <%if(sort.equals("8")){%>selected<%}%>>용품수신일 </option>
                <option value='9' <%if(sort.equals("9")){%>selected<%}%>>차량등록일 </option>
              </select>
        	</td>
          </tr>
        </table>
