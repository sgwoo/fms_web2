...
<form name='form1' action='/fms2/tint/tint_s_sc.jsp' target='c_foot' method='post'>
        ...
        <td class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td>&nbsp;
        			  <select name='gubun3'>
                        <option value='1' <%if(gubun3.equals("1")){%>selected<%}%>>용품일자</option>
                        <option value='2' <%if(gubun3.equals("2")){%>selected<%}%>>정산일자</option>				
                      </select>
                	  <select name='gubun2'>
