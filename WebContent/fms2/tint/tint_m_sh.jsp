...
<form name='form1' action='/fms2/tint/tint_m_sc.jsp' target='c_foot' method='post'>
      ...
      <td>
    	<table width=100% border=0 cellpadding=0 cellspacing=0 >
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 용품관리 > <span class=style5>용품현황</span></span></td>
          ...
          <tr>
            ...
            <td>&nbsp;
			  <select name='gubun3'>
                ...
                <option value='3' <%if(gubun3.equals("3")){%>selected<%}%>>용품일자</option>
                <option value='4' <%if(gubun3.equals("4")){%>selected<%}%>>정산일자</option>
                <option value='5' <%if(gubun3.equals("5")){%>selected<%}%>>청구일자</option>
                <option value='6' <%if(gubun3.equals("6")){%>selected<%}%>>지급일자</option>
              </select>
        	  <select name='gubun2'>
          ...
          <tr>
            ...
            <td>&nbsp;
        	  <select name='s_kd'>
                ...
                <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>용품관리번호 </option>				
                <option value='7' <%if(s_kd.equals("7")){%>selected<%}%>>계약번호</option>
                <option value='8' <%if(s_kd.equals("8")){%>selected<%}%>>차량번호</option>
                <option value='9' <%if(s_kd.equals("9")){%>selected<%}%>>블랙박스장착</option>
              </select>
        	  &nbsp;&nbsp;&nbsp;
            ...
            <td>&nbsp;
        	  <select name='sort'>
                ...
                <option value='8' <%if(sort.equals("8")){%>selected<%}%>>용품일자 </option>
                <option value='9' <%if(sort.equals("9")){%>selected<%}%>>정산일자 </option>
                <option value='10' <%if(sort.equals("10")){%>selected<%}%>>청구일자 </option>
                <option value='11' <%if(sort.equals("11")){%>selected<%}%>>지급일자 </option>				
              </select>
        	</td>
          </tr>
        </table>
