...
<%
	...
	Vector vt = t_db.getTintPayList(s_kd, t_wd, gubun1, gubun2, gubun3, st_dt, end_dt, sort);
	int vt_size = vt.size();
...
<%		for(int i = 0 ; i < vt_size ; i++){
			Hashtable ht = (Hashtable)vt.elementAt(i);%>			
				<tr>											
					...
					<td  width='80' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("PAY_DT")))%></td>					
