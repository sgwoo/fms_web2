      ...
      <td>
    	<table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계약관리 > <span class=style5>용품요청내역</span></span></td>
    ...
    <tr>
      <td class=line> 
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
          ...
          <tr>
            <td class=title>작업마감<br>요청일시</td>
            <td>&nbsp;
            ...
            <td>&nbsp;
			  <select name='sup_off_id' class='default'>
				  ...
				  <option value="007888우일칼라스틸" <%if(tint.getOff_id().equals("007888"))%>selected<%%>>우일칼라스틸</option>
                </select></td>
          </tr>	
          <tr>
