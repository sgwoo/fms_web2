...
<%
	...
	Vector vt = t_db.getTintSettleList(s_kd, t_wd, gubun1, gubun2, gubun3, st_dt, end_dt, sort);
	int vt_size = vt.size();
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/tint/tint_s_frame.jsp'>
	...
	<tr id='tr_title' style='position:relative;z-index:1'>
	  <td class='line' width='350' id='td_title' style='position:relative;'>
		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
		  <tr>
        	...
        	<td width='100' class='title'>요청등록일</td>
		    <td width="70" class='title'>의뢰자</td>					
		  </tr>
		</table>
	  </td>
	  <td class='line' width='75%'>
		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
		  ...
		  <tr>
			<td width='13%' class='title' style='height:24'>차명</td>				  
...
%>
				<tr>
					...
					<td  width='40' align='center'><input type="checkbox" name="ch_cd" value="<%=ht.get("TINT_NO")%>"></td>
					<td  width='100' align='center'><span title='<%=ht.get("OFF_NM")%>'><%=Util.subData(String.valueOf(ht.get("OFF_NM")), 5)%></span></td>										
					<td  width='100' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("REG_DT")))%></td>
...
<%
			...
			total_amt6 	= total_amt6 + Long.parseLong(String.valueOf(ht.get("BLACKBOX_AMT")));
		}
%>
				<tr>
				  <td class='title'>&nbsp;</td>
