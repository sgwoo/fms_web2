...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
  <tr>
	  ...
	  <!--  
	  &nbsp;&nbsp;&nbsp;&nbsp;
	  <a href="javascript:select_tint();" onMouseOver="window.status=''; return true" onfocus="this.blur()"><img src="/acar/images/center/button_tsrcg.gif" align="absmiddle" border="0"></a>
	  &nbsp;
	  -->
	  <%}%>	  
	  </td>
