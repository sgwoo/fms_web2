...
<body>
<form name='form1' action='car_exp_mng_sc.jsp' target='c_foot' method='post'>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 수금관리 > 자동차세환급공문발송 ><span class=style5>이의신청공문발행대장</span></span></td>
