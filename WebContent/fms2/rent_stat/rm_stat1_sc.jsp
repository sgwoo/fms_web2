...
<!--
	...
	function view_stat1(st, st_nm, s_dt){
		window.open('rm_stat1_list.jsp?mode=<%=mode%>&s_br=<%=s_br%>&st='+st+'&st_nm='+st_nm+'&s_dt='+s_dt, "STAT1_LIST", "left=0, top=0, width=900, height=768, scrollbars=yes, status=yes, resize");
	}
//-->
</script>
</head>
        ...
        <td class=line> 
            <table width=100% border="0" cellspacing="1" cellpadding="0">
                ...
                <%	
                		...
                		ht = rs_db.getRmRentStat1(mode, s_dt, s_br);
