...
<%
	...
	Vector vt = rs_db.getRentStat2SubList(gubun4, start_dt, end_dt, s_br, car_kd, st);
	int vt_size = vt.size();
%>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>예약시스템 > 영업지원 > <span class=style5>신규영업현황 세부리스트 [<%=s_br_nm%> <%=car_kd_nm%> <%=st_nm%>]</span></span></td>
