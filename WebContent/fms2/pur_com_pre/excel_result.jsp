...
<%
	...
	String com_con_no[] = request.getParameterValues("com_con_no");
%>
<HTML>
<HEAD>
<TITLE>FMS</TITLE>
...
<%	if(ment_cnt >0){
        ...
        <tr>
          ...
          <td align="center"><%=car_off_nm[i] ==null?"":car_off_nm[i]%></td>
          <td align="center"><%=com_con_no[i] ==null?"":com_con_no[i]%></td>
