              ...
              <tr>
                ...
                <td width="20%">&nbsp;
                  <select name='gubun5'>
					...
					<option value="1" <%if(gubun5.equals("1"))%>selected<%%>>연장계약서</option>
					<option value="2" <%if(gubun5.equals("2"))%>selected<%%>>연장계약서답변</option>
                  </select></td>
				  <%//}%>
              </tr>
              <tr>
