...
<%
	...
	Vector vt =  ie_db.getFmsInfoMailEstiSendList(s_kd, t_wd, st_dt, end_dt, gubun1, gubun2, gubun3, gubun4, gubun5);
	int vt_size = vt.size();
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/im_dmail/esti_send_sc_in.jsp'>  
	...
	<td class='line' width='1100'>
	  <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		<tr>
		  ...
		  <td width="300" class='title'>회신자</td>
		  </tr>
	  </table>
	</td>
  </tr>
	  ...
	  <table border="0" cellspacing="1" cellpadding="0" width='100%'>
        ...
        <tr> 
          ...
          <td width='80' align='center'><%=ht.get("OCNT_NM")%></td>
  		  <td width='230' align='center'><a href="javascript:parent.view_im_dmail('<%=ht.get("ST")%>','<%=ht.get("DMIDX")%>')" onMouseOver="window.status=''; return true" title="클릭하세요"><%=ht.get("EMAIL")%></a>
	  ...
	  <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		...
		<tr>
		  ...
		  <td width='160' align='center'><%=AddUtil.ChangeDate3(String.valueOf(ht.get("OTIME")))%></td>
          	  <td width='480'>&nbsp;<span title='<%=ht.get("SUBJECT")%>'><%=ht.get("SUBJECT2")%></span>&nbsp;<%=ht.get("R_ST")%></td>         				  
          	  <td width='300' align='center'><%=ht.get("REPLYTO")%></td>
		  </tr>	
<%		}	%>
				<tr>		
				    <td class='title'>&nbsp;</td>
