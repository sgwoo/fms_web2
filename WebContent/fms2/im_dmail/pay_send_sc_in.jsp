	...
	<td class='line' width='850'>
	  <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		<tr>
		  ...
		  <td width="530" class='title'>제목</td>
		  </tr>
	  </table>
	</td>
  </tr>
	...
	<td class='line' width='850'>
	  <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		...
		<tr>
          ...
          <td width='530'>&nbsp;<span title='<%=ht.get("SUBJECT")%>'><%=ht.get("SUBJECT2")%></span>&nbsp;<%=ht.get("R_ST")%><a href="javascript:parent.view_im_dmail_hlist('<%=ht.get("SUBJECT")%>')" onMouseOver="window.status=''; return true" title="과거이력보기"><img src="/images/esti_detail.gif"  width="14" height="15" align="absmiddle" border="0"></a></td>         				  
		  </tr>	
<%		}	%>
				<tr>		
				    <td class='title'>&nbsp;</td>
