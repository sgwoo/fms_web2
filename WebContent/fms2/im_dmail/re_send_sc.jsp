...
<!--
	//보기
	function view_im_dmail(dmidx, dm_st){
		var fm = document.form1;	
		fm.dmidx.value = dmidx;
		fm.dm_st.value = dm_st;
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/im_dmail/re_send_frame.jsp'>  
  <input type='hidden' name='dmidx'     value=''>    
  <input type='hidden' name='dm_st'     value=''>      
  ...
  <tr>
	...
	<tr>
	  <td>
		<table border="0" cellspacing="0" cellpadding="0" width=100%>
		  <tr>
			<td>
			  <iframe src="re_send_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
			</td>
		  </tr>
		</table>
	  </td>
	...
	<tr>
	  <td>* hanmail 계정인 경우 가급적 다른 메일주소를 받아 보내도록 하십시오.
	  </td>
	</tr>
  </table>
</form>
