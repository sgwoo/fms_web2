...
<%
	...
	Vector vt =  ie_db.getFmsInfoMailDocSendList(s_kd, t_wd, st_dt, end_dt, gubun1, gubun2, gubun3, gubun4, gubun5);
	int vt_size = vt.size();
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/im_dmail/doc_send_sc_in.jsp'>  
	...
	<td class='line' width='800'>
	  <table border="0" cellspacing="1" cellpadding="0" width='100%'>
		...
		<tr>
          ...
          <td width='480'>&nbsp;<span title='<%=ht.get("SUBJECT")%>'><%=ht.get("SUBJECT2")%></span>&nbsp;<%=ht.get("R_ST")%><a href="javascript:parent.view_im_dmail_hlist('<%=ht.get("SUBJECT")%>')" onMouseOver="window.status=''; return true" title="과거이력보기"><img src="/images/esti_detail.gif"  width="14" height="15" align="absmiddle" border="0"></a></td>         				  
		  </tr>	
<%		}	%>
				<tr>		
				    <td class='title'>&nbsp;</td>
