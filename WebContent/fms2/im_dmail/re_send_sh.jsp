      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
              <tr>
                ...
                <td width="10%" class="title">메일종류</td>
                <td width="40%">&nbsp;
                  <select name='gubun2'>
                    <option value="">선택</option>
                    <option value="1" <%if(gubun2.equals("1"))%>selected<%%>>청구서</option>
                    <option value="2" <%if(gubun2.equals("2"))%>selected<%%>>견적서</option>
                    <option value="3" <%if(gubun2.equals("3"))%>selected<%%>>안내문</option>					
                  </select></td>
              </tr>
              <tr>
