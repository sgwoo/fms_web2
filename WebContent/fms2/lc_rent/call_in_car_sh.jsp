...
%>
<form name='form1' action='/fms2/lc_rent/call_in_car_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>해지관리 > <span class=style5>해지차량반납현황</span></span></td>
                ...
                <tr>
                    ...
                    <td width=40%>&nbsp;
            		    <select name='s_kd'>
						  ...
						  <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>반납일자</option>
						  <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>해지일자</option>						  						  
                        </select>
        			    &nbsp;&nbsp;&nbsp;
