...
<!--
	...
	function view_eval(rent_mng_id, rent_l_cd){
		...
		window.open("/fms2/lc_rent/view_eval.jsp?client_id="+fm.client_id.value+"&rent_mng_id="+rent_mng_id+"&rent_l_cd="+rent_l_cd, "VIEW_EVAL", "left=50, top=50, width=850, height=600");
	}
