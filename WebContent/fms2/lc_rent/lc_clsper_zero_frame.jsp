...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./lc_clsper_zero_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./lc_clsper_zero_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>
