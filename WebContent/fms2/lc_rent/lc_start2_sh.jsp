...
<body <%if(acar_de.equals("1000")){%><%}else{%>onload="javascript:document.form1.t_wd.focus();"<%}%> leftmargin=15>

<form name='form1' action='/fms2/lc_rent/lc_start2_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > <span class=style5>대여개시미등록현황</span></span></td>
