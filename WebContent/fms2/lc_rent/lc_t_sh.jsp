    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계출관리 > <span class=style5>출고지연대차현황</span></span></td>
                ...
                <tr>
                    ...
                    <td width=20%>&nbsp;
            			...
            			<select name='gubun3'>
						  ...
						  <option value='6' <%if(gubun3.equals("6")){%>selected<%}%>>만기매칭대차</option>			  
						  <option value='7' <%if(gubun3.equals("7")){%>selected<%}%>>만기매칭대차제외</option>
                        </select>
        			</td>		  		  
