...
<form name='form1' action='/fms2/lc_rent/lc_start4_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > <span class=style5>대여료스케줄미등록현황</span></span></td>
	    ...
	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
            		...
            		<select name='gubun2'>
                          ...
                          <option value='1' <%if(gubun2.equals("1")){%>selected<%}%>>지연 </option>
                          <option value='2' <%if(gubun2.equals("2")){%>selected<%}%>>신차 </option>
                ...
                <tr>
            		...
            		<select name='s_kd'>
                          ...
                          <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>대여개시기안자</option>
                          <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>대여개시스케줄담당</option>
                        </select>
        		&nbsp;&nbsp;&nbsp;
