...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "01", "06", "09");
...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./cms_rm_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <%if(sc_in_chk.equals("no")){%>
  <FRAME SRC="about:blank" name="c_foot" frameborder=0 marginwidth="10" topmargin=0 scrolling="auto" noresize>	
  <%}else{%>
  <frame src="./cms_rm_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <%}%>
</frameset>
</HTML>