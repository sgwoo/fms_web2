  ...
  <table border="0" cellspacing="0" cellpadding="0" width='1050'>
	...
	<tr id='tr_title' style='position:relative;z-index:1'>
		...
		<td class='line' width='650'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				<tr>
		          <td width='170' rowspan="2" class='title'>차명</td>
				...
				<tr>
				  ...
				  <td width='70' class='title'>관리팀장</td>
			      <!--<td width='70' class='title'>회계담당</td>-->
				  <td width='80' class='title'>추가회차</td>				  		  				  
				  <td width='180' class='title'>대여기간</td>			  
			  </tr>
			</table>
		</td>
	</tr>
...
%>			
				<tr>
					...
					<td  width='70' align='center'>-->
					  ...
					  <%}%></td>									
					  -->
					<td  width='80' align='center'><%=ht.get("ADD_TM")%>회차</td>					
