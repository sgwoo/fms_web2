...
<!--
	...
	function update(){
		...
		if(confirm('수정하시겠습니까?')){	
			fm.action='lc_c_u_tint2_add_a.jsp';		
			fm.target='i_no';
			fm.submit();
		}									
	}			
...
<body leftmargin="15">
<form action='lc_c_u_tint2_add_a.jsp' name="form1" method='post'>
...
<table border='0' cellspacing='0' cellpadding='0' width='100%'>
    ...
    <tr>
        <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle><span class=style2><%if(tint_st.equals("3")){%>블랙박스 <%}else if(tint_st.equals("4")){%>내비게이션 <%}else if(tint_st.equals("5")){%>기타용품<%}else if(tint_st.equals("6")){%>이동형 충전기<%}%> 추가 등록</span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>
	...
	<td align='right' class="line">
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td width='37%' >&nbsp;             
                        <input type='radio' name="tint_yn" value='Y' onClick="javascript:cng_input()" checked>설치
                        <input type='radio' name="tint_yn" value='N' onClick="javascript:cng_input()">설치하지않음
                    </td>
                    ...
                    <td width='37%'>&nbsp;
                        <select name='off_id' id="off_id" class='default' onchange="javascript:check_b_box();">
                            ...
                            <option value="010255스마일TS"     <%if(tint.getOff_id().equals("010255"))%>selected<%%>>스마일TS	</option>
                            <option value="002850유림카랜드"     <%if(tint.getOff_id().equals("002850"))%>selected<%%>>유림카랜드	</option>
                            <option value="010937주식회사미성테크" <%if(tint.getOff_id().equals("010937"))%>selected<%%>>주식회사미성테크</option>
                ...
                <tr> 
                    ...
                    <td>&nbsp;
                        <input type='text' name='serial_no' id="serialNo" size='40' value='<%=tint.getSerial_no()%>' class='<%if(tint.getOff_id().equals("002849")){%>whitetext<%}else{%>default<%}%>' ></td>
    ...
    <tr>
	    ...
	    <%	if( auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")) {%>
	  	<a href='javascript:update();' onMouseOver="window.status=''; return true"><img src="/acar/images/center/button_reg.gif" align="absmiddle" border="0"></a> 
	  	&nbsp;
	    <%	}%>
	    <%}%>
