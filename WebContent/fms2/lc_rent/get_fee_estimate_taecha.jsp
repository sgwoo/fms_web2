...
<%@ page import="java.util.*, java.io.*, acar.util.*, acar.estimate_mng.*, acar.car_mst.*, acar.con_ins.*,acar.cont.*,acar.client.*, acar.car_register.*" %>
...
<%
	...
	String rent_way = fees.getRent_way();
	...
	if(driving_age.equals("5"))			ins_age = 5;//5  :30세		->30세 5
	if(driving_age.equals("6"))			ins_age = 6;//6  :35세		->35세 6
	if(driving_age.equals("7"))			ins_age = 7;//7  :43세		->43세 7
	if(driving_age.equals("8"))			ins_age = 8;//8  :48세		->48세 8
	if(driving_age.equals("9"))			ins_age = 9;//9  :22세		->22세 9
	if(driving_age.equals("10"))		ins_age = 10;//10 :24세		->28세 10
	if(driving_age.equals("11"))		ins_age = 11;//11 :35세~49세		->35세~49세 11
