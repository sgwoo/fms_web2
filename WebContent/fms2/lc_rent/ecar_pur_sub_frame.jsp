...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./ecar_pur_sub_sh.jsp<%=vlaus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./ecar_pur_sub_sc.jsp<%=vlaus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</script>
</HTML>
