        ...
        <td class='line' width='400' id='td_title' style='position:relative;'> 
    	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr> 
                  ...
                  <td width='90' class='title'>출고일자</td>
	    ...
	    <td class='line' width='1140'>
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
        	    <tr>
        		        ...
        		        <td width="100" class='title'>차량구매가격</td>
        	          ...
        	          <td width='90' class='title'>구매보조금</td>
        	          <td width='90' class='title'>청구일자</td>
        	          <td width='90' class='title'>입금일자</td>
        	          <td width='60' class='title'>등록증</td>
        	    </tr>
	        </table>
	    </td>
    </tr>
	        ...
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
        		...
        		<tr>        		  
        		  ...
        		  <td <%=td_color%> width='60' align='center'>
        		    ...
        		    <a href="javascript:openPopP('image/jpeg','<%=ht.get("ATTACH_SEQ")%>');" title='보기'><img src=/acar/images/center/button_in_see.gif align=absmiddle border=0></a>        		  	
        		  	<%}%>
        		  </td>
        		</tr>
						<%	}	%>
