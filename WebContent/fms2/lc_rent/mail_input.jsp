...
<table width=440 border=0 cellspacing=0 cellpadding=0>
    ...
    <tr>
		<td>
			<span class=style2>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='radio' name="send_st" value='1' checked > 메일(PC)</span>            							
			<span class=style2>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='radio' name="send_st" value='2' > 알림톡(모바일)</span>
		</td>
	</tr>
	<%} %>    
    <tr>
    	<td align=center>
        	...
        	<tr>
        		<td>
    			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    			이메일주소 &nbsp;<input type="text" name="mail_addr" size="30" value='<%=rent_mgr.getMgr_email()%>' style='IME-MODE: inactive'>
    			<br><br>
    			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    			휴대폰번호 &nbsp;<input type="text" name="tel_number" size="30" value='<%=rent_mgr.getMgr_m_tel()%>'>
    			</span>    			
    		    </td>
    		</tr>
    		<tr>
    		...
    		<tr>
		    <td align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  	<!--<span class=style2>&nbsp;&nbsp;<input type='radio' name="replyto_st" value='1'> 회사메일</span>-->
			...
			<input type="text" name="replyto" size="25" value=''>
		    </td>
		</tr>
    		<tr>
    		    <td height=7></td>
