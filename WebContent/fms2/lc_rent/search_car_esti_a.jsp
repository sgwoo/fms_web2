...
*/
	bean.setA_a			(request.getParameter("s_a_a")==null?"":request.getParameter("s_a_a"));
	...
	//자차면책금
	bean.setCar_ja		(request.getParameter("s_car_ja")==null?0:AddUtil.parseDigit(request.getParameter("s_car_ja")));
...
*/	
	bean.setSpr_yn		(request.getParameter("s_spr_kd")==null?"":request.getParameter("s_spr_kd"));
...
<form action="" name="form1" method="POST">
  ...
  <input type="hidden" name="from_page" value="car_esti">
