...
//			fm.rent_start_dt.value = ChangeDate(fm.rent_start_dt.value);
	...
	function estimate(st){
		...
		fm.action='search_car_esti_t_a.jsp';		
...
<form action='/acar/secondhand/getSecondhandBaseSet.jsp' name="sh_form" method='post'>
  ...
  <input type='hidden' name="rent_st"			value="1"><!--연장견적-->      
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    ...
                    <td width="15%">&nbsp;<b><font color='#990000'><%=ins.getCon_f_nm()%></font></b></td>
            ...
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
                    ...
                    <td align="center">기준일자<span class="contents1_1">
                      <input type='text' size='11' name='bas_dt' maxlength='10' class="fix" value='' onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </span></td>
                    <td align='center'>&nbsp;
