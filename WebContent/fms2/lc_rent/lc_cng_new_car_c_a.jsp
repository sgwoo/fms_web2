...
<%@ page import="java.util.*, acar.util.*, acar.cont.*, acar.cls.*,  acar.fee.*, acar.car_office.*, cust.member.*, acar.ext.*"%>
<%@ page import="acar.user_mng.*, acar.car_mst.*, acar.estimate_mng.*"%>
...
<%
	...
	//신차 차량 변경시
		...
		// 첨단안전장치 설정(트림에 포함된 경우와 옵션에 장착된 경우 모두 Y)		2017.11.26		start
