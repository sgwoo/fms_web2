...
<!--
	...
	function reg_pay_dt(m_id, l_cd){
		window.open("reg_cashback_paydt2.jsp<%=valus%>&m_id="+m_id+"&l_cd="+l_cd, "REG_CB_DT", "left=100, top=100, width=620, height=300, resizable=yes, scrollbars=yes, status=yes");					
	}
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/lc_rent/lc_cb3_frame.jsp'>
	...
	<tr>
	    <td>
    		<table border="0" cellspacing="0" cellpadding="0" width=100%>
    		    <tr>
        			<td>
        			  <iframe src="lc_cb3_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
        			</td>
    		    </tr>
    		</table>
	    </td>
