...
<%
	...
	bean.setBank_cd		(request.getParameter("cms_bank_cd")	==null?"":request.getParameter("cms_bank_cd"));
		
	if(!bean.getBank_cd().equals("")){
		bean.setCms_bank		(c_db.getNameById(bean.getBank_cd(), "BANK"));
	}
