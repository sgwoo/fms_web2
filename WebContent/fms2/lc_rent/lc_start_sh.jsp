...
<!--
	function search()
	{
		var fm = document.form1;	   	 
	   	if (fm.gubun1[0].checked == true || fm.gubun2[1].checked == true) {
...
%>
<form name='form1' action='/fms2/lc_rent/lc_start_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > <span class=style5>대여료스케줄변경결재함</span></span></td>
	    ...
	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
            		...
            		<select name='s_kd'>
                          ...
                          <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>스케줄담당</option>
                          <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>영업소</option>
                        </select>
        		&nbsp;&nbsp;&nbsp;
