...
<!--
	...
	function save_daum(){
		window.open("zip_daum.jsp", "daum_ZIP", "left=500, top=100, height=720, width=463, scrollbars=yes");
	}
			...
			<table border="0" cellspacing="1" cellpadding="0" width=100%>
				...
				<tr>
					...
					<td>
						...
						&nbsp;&nbsp;&nbsp;
						<a href='javascript:save_daum()' onMouseOver="window.status=''; return true">다음API</a>
						<%}%>
					</td>
				</tr>
