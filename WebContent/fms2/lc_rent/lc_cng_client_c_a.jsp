...
<%
	...
	if(!busid_bean.getDept_id().equals("1000")){
		base.setAgent_emp_id("");
	}
	...
	if(!con_f_nm.equals("아마존카") || insur_per.equals("2") || !conr_nm.equals("아마존카") || insurant.equals("2") || !i_com_emp_yn.equals(com_emp_yn)){
			...
			String cont 	= "[ "+rent_l_cd+" "+firm_nm+" ] 계약승계  &lt;br&gt; &lt;br&gt; ";
	...
	if(vt_size1 > 0 ){
		...
		String cont  = "고객피보험자차량이 계약승계로 고객이 변경되었습니다.  &lt;br&gt; &lt;br&gt; 보험 관련사항 확인바랍니다.  &lt;br&gt; &lt;br&gt; "
	                     + car_no + " "+client_old.getFirm_nm()+"에서 "+firm_nm+"로 변경";
	...
	//if(client_new.getClient_st().equals("1") && !client_new.getFirm_type().equals("10") && AddUtil.parseInt(cm_bean.getS_st())>101 && AddUtil.parseInt(cm_bean.getS_st()) < 600){
			...
			sub = "계약승계 등록";
			cont 	= "[ "+rent_l_cd+" "+client_old.getFirm_nm()+" -> "+new_rent_l_cd+" "+client_new.getFirm_nm()+" "+cr_bean.getCar_no()+" ] 계약승계  &lt;br&gt; &lt;br&gt; ";
