...
<form action='lc_b_s_a.jsp' name="form1" method='post'>
  ...
  <input type='hidden' name='from_page2'	 	value='/fms2/lc_rent/lc_b_s_16.jsp'>
...
<table border='0' cellspacing='0' cellpadding='0' width='100%'>
	...
	<tr>
	    <td align="right"><%if(!san_st.equals("요청") ||   auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")) {%><a href="javascript:update('16')"><img src=/acar/images/center/button_modify.gif align=absmiddle border=0></a><%}%>
