...
%>
<form name='form1' action='/fms2/lc_rent/commi_pay_sc.jsp' target='c_foot' method='post'>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 영업비용관리 ><span class=style5>영업수당관리</span></span></td>
                ...
                <tr>
                    ...
                    <td  colspan="3">&nbsp;
            	        <select name='s_kd'>
                          ...
                          <option value='4' <%if(s_kd.equals("4")){%>selected<%}%>>청구자</option>
