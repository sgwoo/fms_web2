	...
	<tr>
		<td colspan="2" class="doc">
			...
			<table class="center" style="font-size: 10px;">
				<tr>
					<td width="15%" rowspan="4">차량관리 서비스<br>제공범위<br>(체크된 □칸의 서비스가 제공됩니다)</td>
				...
				<tr>
					...
					<%} %>
					<br>&nbsp;* 사고발생시 임차인의 임의적인 사고수리는 인정되지 않습니다.<br>&nbsp;&nbsp; - 사고로 인한 차량수리가 필요한 경우에는 (주)아마존카의 확인 및 선조치 사항이 있어야 (주)아마존카에서<br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 수리비가 지불됩니다.</td>
				</tr>	
			</table>
		</td>
