...
<table border='0' cellspacing='0' cellpadding='0' width='100%'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > <span class=style5>임의연장현황</span></span></td>
	...
	<tr>
	    <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>정상계약 <%if(fee_size>1){%>이력<%}%></span></td>	
	</tr>		
	<tr>
        <td class=line2></td>
    </tr>
	...
	<%if(im_vt_size>1){%>
	<tr>
	    <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>임의연장 이력</span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>			
	...
	<tr>
	    <td align='right' class="line">
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    <td width="13%" class='title'>연장회차</td>
                    <td>
