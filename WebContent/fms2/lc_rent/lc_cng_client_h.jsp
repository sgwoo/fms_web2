...
//		if(fm.auth_rw.value != '6'){ alert('권한이 없습니다.'); return; }				
		...
		fm.action = "/tax/pop_search/s_cont_client_cng.jsp";		
...
<form action='lc_renew_c.jsp' name="form1" method='post'>
  ...
  <input type="hidden" name="go_url" value="/fms2/lc_rent/lc_cng_client_c.jsp">      
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계약관리 > <span class=style5>계약승계등록</span></span></td>
