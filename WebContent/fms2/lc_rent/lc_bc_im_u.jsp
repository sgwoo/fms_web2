...
<%
	...
	if(String.valueOf(fee_add.get("RENT_L_CD")).equals("null")){
		//추가연장대여정보 추정치
		Hashtable fee_add2 = a_db.getContBcImCase(rent_mng_id, rent_l_cd, rent_st);
		fee_add.put("RENT_MNG_ID", 		rent_mng_id);
		fee_add.put("RENT_L_CD",   		rent_l_cd);
		fee_add.put("RENT_ST",     		add_rent_st);
		...
		fee_add = a_db.getContFeeAdd(rent_mng_id, rent_l_cd, add_rent_st);
	}
	...
	String valus = 	"?auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+
					...
					"&rent_mng_id="+rent_mng_id+"&rent_l_cd="+rent_l_cd+"&rent_st="+rent_st+"&add_rent_st="+add_rent_st+"&from_page="+from_page;
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 임의연장영업효율등록현황 > <span class=style5>추가연장영업효율등록</span></span></td>
