...
<!--
	...
	function set_car_st(){
		...
		if(fm.con_cd5.value == 'S'){ 			//예비
			...
			tr_base1.style.display = '';				// display = 'block'; 대신 교체 사용(크롬에서 깨지는 현상 수정) 2017. 11. 17 심병호(개발자)
...
<form name='form1' action='' method='post'>
  ...
  <input type="hidden" name="jg_tuix_st" value=""><!-- search_esti_sub_list.jsp 파일에서 스크립트 오류가 발생하는 것을 방지하기 위해 추가 START -->
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>예약시스템 > 영업지원 > <span class=style5>월렌트계약등록</span></span></td>
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0">
                            <tr>
								...
								(가니쉬: <input type='text' name="garnish_col" size='20' class='text'> )
