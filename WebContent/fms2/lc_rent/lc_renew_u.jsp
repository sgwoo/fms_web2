      ...
      <td class=line> 			  
        <table border="0" cellspacing="1" cellpadding="0" width=100%>
          <tr>
            ...
            <td width="20%">&nbsp;
				  	<input type='text' name='sh_car_amt' value='<%=AddUtil.parseDecimal(fee_etc.getSh_car_amt())%>'size='10' class='num' readonly>
          ...
          <tr>
            ...
            <td>&nbsp;
                      <input type='text' name='sh_amt' value='<%= AddUtil.parseDecimal(fee_etc.getSh_amt()) %>'size='10' class='num' readonly>
					  원
            ...
            <td>&nbsp;
				  ...
				  <input type='text' name='sh_ja' value='<%=fee_etc.getSh_ja()%>'size='4' class='num' readonly>
			%</td>
      ...
      <td class='line'> 
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
          ...
          <tr>
            ...
            <td width="20%">&nbsp;
              <input type="text" name="rent_start_dt" value="<%=AddUtil.ChangeDate2(ext_fee.getRent_start_dt())%>" size="11" maxlength='10' class=text onBlur='javascript:this.value=ChangeDate(this.value); set_cont_date(this);'></td>
            <td width="10%" align="center" class=title>대여만료일</td>
            <td>&nbsp;
              <input type="text" name="rent_end_dt" value="<%=AddUtil.ChangeDate2(ext_fee.getRent_end_dt())%>" size="11" maxlength='10' class=text onBlur='javascript:this.value=ChangeDate(this.value);'></td>
          </tr>
          <tr>
        ...
        <table border="0" cellspacing="1" cellpadding="0" width=100%>
          ...
          <tr>
            ...
            <td align="center">입금예정일 :
                  <input type='text' size='11' name='pp_est_dt' maxlength='10' class="text" value='<%=AddUtil.ChangeDate2(ext_fee.getPp_est_dt())%>' onBlur='javscript:this.value = ChangeDate(this.value);'>
            </td>
            <td align='center'>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="center">기준일자<span class="contents1_1">
              <input type='text' size='11' name='bas_dt' maxlength='10' class="text" value='<%=AddUtil.ChangeDate2(ext_fee.getBas_dt())%>' onBlur='javscript:this.value = ChangeDate(this.value);'>
            </span></td>
            <td align='center'>&nbsp;
