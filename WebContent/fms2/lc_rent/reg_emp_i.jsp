...
function CheckField(){
	...
	<%if(!car_off_id.equals("") && from_page.equals("car_agent_c.jsp")){%>
	<%}else{%>
	...
	{
		window.open("zip_s.jsp?idx="+idx, "ZIP", "left=100, top=100, height=500, width=400, scrollbars=yes");
	}	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr> 
                                            ...
                                            <td width="240">&nbsp; 
                    				          ...
                    				          <option value='<%=user2.get("USER_ID")%>' <%if(user_id.equals(user2.get("USER_ID"))) out.println("selected");%>><%=user2.get("USER_NM")%></option>
                    				          <%	}
                    							}%>
                                              </select> </td>
								...
								oncomplete: function(data) {
									...
									document.getElementById('t_addr1').value = data.address;
                                        ...
                                        <tr> 
                                            ...
                                            <td colspan="4">&nbsp;
						<input type="text" name='t_zip' id="t_zip1" value="" size="7" maxlength='7'>
						<input type="button" onclick="openDaumPostcode1()" value="우편번호 찾기"><br>
						&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr1" value="" size="70">                                            
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="line">
                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr> 
                                            ...
                                            <td>&nbsp; 
                                            	<%if(!car_off_id.equals("") && from_page.equals("car_agent_c.jsp")){%>
                                            	<%=co_bean.getCar_comp_nm()%>
                                            	<input type="hidden" name="car_comp_id" value="<%=co_bean.getCar_comp_id()%>"> 
                                            	<%}else{%>
                                        ...
                                        <tr> 
                                            ...
                                            <td width="240">&nbsp; 
                                            	<%if(!car_off_id.equals("") && from_page.equals("car_agent_c.jsp")){%>
                                            	<%=co_bean.getCar_off_nm()%>
                                            	<input type="hidden" name="car_off_nm" value="<%=co_bean.getCar_off_nm()%>"> 
                                            	<%}else{%>
                                            	<input type="text" name="car_off_nm" value="<%= c_db.getNameById(coe_bean.getCar_off_id(),"CAR_OFF") %>" size="20" class="text"> 
                                            ...
                                            <td width="50" rowspan="2" class="title">연락처</td>
                                            <td width="100" class="title">전화</td>
                                            <td>&nbsp; <input type="text" name="car_off_tel" value="<%=co_bean.getCar_off_tel()%>" size="21" class="text"></td>
                                        </tr>
                                        <tr> 
                                            <td class="title">구분</td>
                                            <td>&nbsp;<input type="radio" name="car_off_st" value="1" <% if(co_bean.getCar_off_st().equals("1")) out.println("checked"); %>>
                                              지점 
                                              <input type="radio" name="car_off_st" value="2" <% if(co_bean.getCar_off_st().equals("2")) out.println("checked"); %>>
                                              대리점</td>
                                            <td class="title">FAX</td>
                                            <td>&nbsp; <input type="text" name="car_off_fax" value="<%=co_bean.getCar_off_fax()%>" size="21" class="text"></td>
                                        </tr>
					<script>
								...
								oncomplete: function(data) {
									...
									document.getElementById('t_addr2').value = data.address;
                                        ...
                                        <tr> 
                                            ...
                                            <td colspan="4">&nbsp;
						<input type="text" name='t_zip' id="t_zip2" value="<%=co_bean.getCar_off_post()%>" size="7" maxlength='7'>
						<input type="button" onclick="openDaumPostcode2()" value="우편번호 찾기"><br>
						&nbsp;&nbsp;
						<input type="text" name='t_addr' id="t_addr2" value="<%=co_bean.getCar_off_addr()%>" size="70">                                            
                                            </td>
                                        </tr>
                                    </table>
                                </td>
    ...
    <tr> 
        <td align="right">
	      ...
	      <a href="javascript:CarOffEmpReg()" onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_reg.gif align=absmiddle border=0></a>&nbsp;	
	    <%}%>  
