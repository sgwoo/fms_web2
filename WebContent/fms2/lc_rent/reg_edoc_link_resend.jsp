...
<% 
	...
	String mgr_nm 		= request.getParameter("n_mgr_nm")==null?"":request.getParameter("n_mgr_nm");
	String mgr_email 	= request.getParameter("n_mgr_email")==null?"":request.getParameter("n_mgr_email");
	String mgr_m_tel 	= request.getParameter("n_mgr_m_tel")==null?"":request.getParameter("n_mgr_m_tel");	
	
	String suc_mgr_nm 	= request.getParameter("n_suc_mgr_nm")==null?"":request.getParameter("n_suc_mgr_nm");
	String suc_mgr_email 	= request.getParameter("n_suc_mgr_email")==null?"":request.getParameter("n_suc_mgr_email");
	String suc_mgr_m_tel 	= request.getParameter("n_suc_mgr_m_tel")==null?"":request.getParameter("n_suc_mgr_m_tel");
	...
	if(link_table.equals("rm_rent_link_m")){
		...
		flag1 = ln_db.updateAlinkDocyn(doc_code, link_table, "U", cms_type);
		...
		flag1 = ln_db.updateAlinkDocyn(doc_code, link_table, "U");
		
		flag1 = ln_db.updateAlinkMgrNm(doc_code, link_table, mgr_nm, mgr_email, mgr_m_tel, suc_mgr_nm, suc_mgr_email, suc_mgr_m_tel);
...
<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
	...
	function webMethodCall(webServiceUrl,methodName,arg,returnFunction) {
        ...
        var param = {
            url: "/AmazonCar.asmx",
            method: methodName,
            body: encodeURIComponent(sendXML)
        };
        $.ajax({
...
<!--	   window.open("temp.jsp?arg="+ arg, "_blank", "left=200, top=100, width=820, height=800, scrollbars=yes");		-->
