...
<!--
	function search(){
		...
		if(fm.s_kd.options[fm.s_kd.selectedIndex].value == '8' || fm.s_kd.options[fm.s_kd.selectedIndex].value == '13'){ //영업담당자
...
<form name='form1' action='ins_h_sc.jsp' target='c_body' method='post'>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 수금관리 > <span class=style5>휴/대차료 관리</span></span></td>
                ...
                <tr> 
                    <td width='190'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jhgb.gif align=absmiddle>&nbsp;
                      <select name="gubun1"><!-- onChange="javascript:list_move()"-->
                        ...
                        <option value="2" <%if(gubun1.equals("2")){%>selected<%}%>>대차료</option>
                        <option value="1" <%if(gubun1.equals("1")){%>selected<%}%>>휴차료</option>
                        <!--
                ...
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp;
                      <select name='s_kd' onChange="javascript:document.form1.t_wd.value='', cng_input()">
                        ...
                        <option value='10' <%if(s_kd.equals("10")){%> selected <%}%>>사고일자</option>
                        <option value='11' <%if(s_kd.equals("11")){%> selected <%}%>>보험회사</option>					
                 ...
                 <!--       <option value='12' <%if(s_kd.equals("12")){%> selected <%}%>>영업담당자</option> -->
                        <option value='8' <%if(s_kd.equals("8")){%> selected <%}%>>관리담당자</option>  
						<option value='13' <%if(s_kd.equals("13")){%> selected <%}%>>청구자</option>  
                      </select>
                    </td>
                    <td> 
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                          <td id='td_input' <%if(s_kd.equals("8") || s_kd.equals("6") || s_kd.equals("12")){%> style='display:none'<%}%>> 
                    ...
                    <td><img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>&nbsp;
                      <select name='sort_gubun' onChange='javascript:search()'>
                        <option value='0' <%if(sort_gubun.equals("0")){%> selected <%}%>>청구일자</option>
