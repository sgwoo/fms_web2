...
<%	if(vt_size > 0){%>
              ...
              <% for (int i = 0 ; i < vt_size ; i++){
		        ...
		        <%}%>                                                 
                            ...
                            <td align="center" width=50%><a href="javascript:parent.view_cont('<%=ht.get("RENT_MNG_ID")%>','<%=ht.get("RENT_L_CD")%>','<%=ht.get("CAR_MNG_ID")%>','<%=ht.get("SERV_ID")%>','<%=AddUtil.ChangeDate2(String.valueOf(ht.get("RENT_DT")))%>')"><%=ht.get("RENT_L_CD")%></a></td>
                          </tr>
              <%}%>
                        </table>
                   </td>            		            		
