...
<frameset rows="90%, *" border=1>
		<frame src="survey_tot_old_sh.jsp?auth_rw=<%=auth_rw%>&br_id=<%=br_id%>&user_id=<%=user_id%>&sh_height=<%=height%>" name="c_body" marginwidth=10 marginheight=10 scrolling='auto' >
