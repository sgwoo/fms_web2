...
function ChangeDT(arg)
{
	...
	function cng_input(){
		...
		if(fm.gubun2.options[fm.gubun2.selectedIndex].value == '2'){
			fm.st_nm.style.display 	= '';
		}else{
			fm.st_nm.style.display 	= 'none';
		}
	}
...
<div class="navigation">
	<span class=style1>콜센터 ></span><span class=style5>정비현황</span>
</div>
...
<select name="gubun2" onChange="javascript:cng_input()" class="select" style="width:150px;">          
...
&nbsp;&nbsp;<input type='text' size='20' name='st_nm' class='text' value='' style='display:none'>
