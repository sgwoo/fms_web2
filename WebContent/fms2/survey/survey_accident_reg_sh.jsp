...
//			fm.target='parent.c_foot';
	...
	function list(b_lst)
	{
		...
		if ( type1 == '1' ) {
			parent.location='survey_accident_frame.jsp?auth_rw='+auth+'&s_kd='+s_kd+'&brch_id='+brch_id+'&s_bank='+s_bank+'&t_wd='+t_wd+'&cont_st='+cont_st;
		} else { 
...
<div class="navigation">
	<span class=style1>콜센터 ></span><span class=style5>사고상세현황</span>
</div>
</body>
</html>