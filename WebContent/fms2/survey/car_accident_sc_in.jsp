		                    ...
		                    <tr class=line> 
        		                ...
        		                <td align="center" width=25%>
        		  			   ...
        		  			   <%  if (String.valueOf(ht.get("GUBUN")).equals("9") ) {  %>           
        				           ...
        				           <%} else { %> 
        				                   <td align="center" width=51%><a href="javascript:parent.AccidentDisp('<%=ht.get("RENT_MNG_ID")%>','<%=ht.get("RENT_L_CD")%>','<%=ht.get("CAR_MNG_ID")%>','<%=ht.get("ACCID_ID")%>', '<%=ht.get("ACCID_ST")%>','<%=AddUtil.ChangeDate2(String.valueOf(ht.get("ACCID_DT")))%>')">&nbsp;<%=ht.get("RENT_L_CD")%></a></td>   
        				           <% } %>  
		                    </tr>
		             <%}%> 
		                </table>
