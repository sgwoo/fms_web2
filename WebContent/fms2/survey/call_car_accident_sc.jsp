...
function view_cont(m_id, l_cd, c_id, s_id)
	{
		var fm = document.form1;
		fm.m_id.value = m_id;
		fm.l_cd.value = l_cd;
...
<body>
<form name='form1' method='post' target='d_content' action='/fms2/survey/survey_accident_reg_frame.jsp'>
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
  ...
  <tr>
    <td><iframe src="./call_car_accident_sc_in.jsp?auth_rw=<%=auth_rw%>&dt=<%=dt%>&ref_dt1=<%=ref_dt1%>&ref_dt2=<%=ref_dt2%>&gubun2=<%= gubun2 %>&sort=<%=sort%>&s_kd=<%=s_kd%>&t_wd=<%=t_wd%>" name="RegCondList" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>		
  </tr>
