...
<%	if(vt_size > 0){%>
              ...
              <% for (int i = 0 ; i < vt_size ; i++){
		        ...
		        <%}%>                                                 
                            ...
                            <td align="center" width=50%><a href="javascript:parent.AccidentDisp('<%=ht.get("RENT_MNG_ID")%>','<%=ht.get("RENT_L_CD")%>','<%=ht.get("CAR_MNG_ID")%>','<%=ht.get("ACCID_ID")%>', '<%=ht.get("ACCID_ST")%>','<%=AddUtil.ChangeDate2(String.valueOf(ht.get("ACCID_DT")))%>')">&nbsp;<%=ht.get("RENT_L_CD")%></a></td>
                          </tr>
              <%}%>
                        </table>
                   </td>            		            		
