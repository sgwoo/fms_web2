...
<%
	...
	if(poll_type.equals("계약")){
		table_nm = "CONT_CALL";
	}else if(poll_type.equals("순회정비")){
		table_nm = "SERVICE_CALL";
	}else if(poll_type.equals("사고처리")){
...
<div align="center">
 ...
 <table class="table table-bordered" style="width:95%;">
	...
	<%
		...
		<tr>
			<th class="info" style="text-align: center;"><%if(po_ht.get("A_SEQ").equals("0")){%>질문<%}else{%>답변<%}%></th>
...
<table class="table table-bordered" style="width:95%;">
	<thead>
		<tr >
	       <th class="info" style="text-align: center;" width="6%">연번</th>
			<th class="info" style="text-align: center;" width="18%">상호</th>
			<th class="info" style="text-align: center;" width="17%">차종</th>
			<th class="info" style="text-align: center;" width="9%">영업구분</th>
			<th class="info" style="text-align: center;" width="11%">계약일자</th>
			<th class="info" style="text-align: center;" width="11%">답변일자</th>
			<th class="info" style="text-align: center;" width="*">별도설명</th>
		</tr>
	</thead>
