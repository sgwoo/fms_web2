...
<%
	...
	String answer_rem_arr[] = request.getParameterValues("answer_rem"); 
	
	String answerQ1_arr[] = request.getParameterValues("answerQ1");
	
	for(int i=0; i<answerQ1_arr.length; i++){
		out.println(answerQ1_arr[i]);
