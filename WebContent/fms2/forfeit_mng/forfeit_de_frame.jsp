...
<%
	...
	String gubun4 	= request.getParameter("gubun4")==null?"8":request.getParameter("gubun4");  //납부자변경제외
...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./forfeit_de_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./forfeit_de_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>
