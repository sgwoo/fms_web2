		...
		<td colspan=10>
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp; <span class=style1>과태료청구서등록</span></td>
        ...
        <table border="0" cellspacing="1" cellpadding='0' width=100%>
              ...
              <!--      <option value='4' <%if(s_kd.equals("4")){%>selected<%}%>>지점</option> -->
					...
					<input type='text' name='t_wd' size='25' class='text' value='<%=t_wd%>' onKeyDown='javascript:enter()' style='IME-MODE: active'>
           			&nbsp;&nbsp;&nbsp;
           			<input type="checkbox" name="coll_yn" value="Y"  >수금포함&nbsp;<input type="checkbox" name="coll_yes" value="Y"  >수금현황보기</td>	 	
              </tr>
            </table></td>
    </tr>
    <tr align="right">
