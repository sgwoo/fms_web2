        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp; <span class=style1><span class=style5>일일납입스케쥴등록 I</span></span></td>
                ...
                <tr> 
                    ...
                    <td width=400> 
						  ...
						  <select name="gubun5">
                            ...
                            <option value="2" <%if(gubun5.equals("2")){%>selected<%}%>>지로</option>
                            <option value="3" <%if(gubun5.equals("3")){%>selected<%}%>>송금</option>
            			  </select>
                    </td>
                </tr>
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>&nbsp;
                     ...
                     <!--       <option value='7' <%if(s_kd.equals("7")){%> selected <%}%>>사용본거지</option>
                            <option value='8' <%if(s_kd.equals("8")){%> selected <%}%>>담당자</option> -->
                              ...
                              <option value='21' <%if(s_kd.equals("21")){%> selected <%}%>>특이사항</option>							  
                          </select>
                    </td>
                    <td> 
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td><img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>&nbsp;
                          <select name='sort_gubun' onChange='javascript:search()'>
                            ...
                            <option value='6' <%if(sort_gubun.equals("6")){%> selected <%}%>>청구기관</option>
                             <option value='6' <%if(sort_gubun.equals("7")){%> selected <%}%>>등록일자</option>
                          </select>
                    </td>
                    <td> 
