...
//System.out.println("seq_no: "+seq_no);
	...
	if(!email.equals("") && !email.equals("null")){
			...
			d_bean.setContent		("http://fms1.amazoncar.co.kr/mailing/rent/email_fine_bill_nbc.jsp?m_id="+m_id+"&l_cd="+l_cd+"&c_id="+c_id+"&dem_dt="+dem_dt+"&e_dem_dt="+dem_dt+"&seq_no="+Util.parseInt(seq_no));
...
//System.out.println("http://fms2.amazoncar.co.kr/mailing/rent/email_fine_bill_nbc.jsp?m_id="+m_id+"&l_cd="+l_cd+"&c_id="+c_id+"&dem_dt="+dem_dt+"&e_dem_dt="+dem_dt+"&seq_no="+Util.parseInt(seq_no));
