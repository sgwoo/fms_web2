...
//sender
	...
	//	ot_bean.setJb_time(jb_time5);
		...
		if(sender_bean.getDept_id().equals("0001")  ) {  //영업, 강남, 인천, 수원
			target_id1 = "000028";
		}else if(sender_bean.getDept_id().equals("0020")) {  //영업기획
			target_id1 = "000005";	
		}else if(sender_bean.getDept_id().equals("0002")) { //고객지원
			target_id1 = "000026";
		}else if( sender_bean.getDept_id().equals("0003")) {  //총무
			target_id1 = "000004";				
		}else if(sender_bean.getDept_id().equals("0005")) {//IT팀
			target_id1 = "000237";
		}else if(sender_bean.getDept_id().equals("0007") || sender_bean.getDept_id().equals("0016") ) {
			target_id1 = "000053";
		}else if(sender_bean.getDept_id().equals("0008")) { // 대전
			target_id1 = "000052";
		}else if(sender_bean.getDept_id().equals("0010") ) { //광주
			target_id1 = "000219";	
		}else if(sender_bean.getDept_id().equals("0009") ) { 
			target_id1 = "000073";	
		}else if(sender_bean.getDept_id().equals("0011") ) {  //대구
			target_id1 = "000054";
		}else if(sender_bean.getDept_id().equals("0012") ) { 
			target_id1 = "000050";		
		}else if(sender_bean.getDept_id().equals("0013") ) { 
			target_id1 = "000079";			
		}else if(sender_bean.getDept_id().equals("0014") ) { 
			target_id1 = "000011";		
		}else if(sender_bean.getDept_id().equals("0015") ) { 
			target_id1 = "000010";	
		}else if(sender_bean.getDept_id().equals("0017") ) { 
			target_id1 = "000049";	
		}else if(sender_bean.getDept_id().equals("0018") ) { 
			target_id1 = "000051";				
		}
...
//		DocSettleBean doc = new DocSettleBean();
	...
	//2. 쿨메신저 알람 등록----------------------------------------------------------------------------------------
		...
		target_id = doc.getUser_id2();  //담당부서장 		
