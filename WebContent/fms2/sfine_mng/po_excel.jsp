...
function save(){
	...
	if (fm.filename.value.indexOf('xls') == -1 && fm.filename.value.indexOf('xlsx') == -1) {
		alert('엑셀파일이 아닙니다.');

		return;
	}

	fm.action = 'po_excel_reg.jsp';
...
<center>
  <form name='form1' action='' method='post' enctype="multipart/form-data">
        ...
        <td align="right" class="line">
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
                    ...
                    <td>&nbsp;
				    <input type="radio" name="gubun1" value="2" checked>과태료 등록처리
			        </td>
					<td align="center"></td>
                </tr>
            </table>
    ...
    <tr>
        <td align=right>* 파일확장자 <b>*.xls와 *.xlsx</b> 인 파일만 가능합니다.</td>
    </tr>	  
    <tr>
        <td class=h>&nbsp;</td>
    </tr>
