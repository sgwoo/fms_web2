...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1><span class=style5>출고일자 확인</span></span></td>
        ...
        <td class='line'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td colspan='3'>&nbsp;<%=est.get("CAR_NM")%> <%=est.get("CAR_NAME")%></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr> 
        <td class='line'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    <td class='title' width='20%'>출고일자</td>
                    <td>&nbsp;<%=AddUtil.ChangeDate2(String.valueOf(est.get("DLV_DT")))%></td>
                </tr>
                <tr> 
                    <td class='title'>출고예정일자</td>
                    <td>&nbsp;<%=AddUtil.ChangeDate2(pur.getDlv_est_dt())%></td>
                </tr>        
                <tr> 
                    <td class='title'>계산서일자</td>
                    <td>&nbsp;<input type='text' size='12' name='car_tax_dt' maxlength='12' class='default' value='<%=AddUtil.ChangeDate2(car.getCar_tax_dt())%>' onBlur='javscript:this.value = ChangeDate(this.value);'></td>
                </tr>   
                                                        <tr> 
                    <td class='title'>금액확인일자</td>
                    <td>&nbsp;<input type='text' size='12' name='car_amt_dt' maxlength='12' class='default' value='<%=AddUtil.ChangeDate2(car.getCar_amt_dt())%>' onBlur='javscript:this.value = ChangeDate(this.value);'></td>
                </tr>   
            </table>
        </td>
    </tr>
