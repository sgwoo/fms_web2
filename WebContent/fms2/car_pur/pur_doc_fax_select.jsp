...
<%
	...
	for(int i=0;i < vt_size;i++){
		...
		num = vid_num.substring(19);
		
		//System.out.println("l_cd: "+rent_l_cd);	
		//System.out.println("m_id: "+rent_mng_id);
	...
	if(count == 0){//중복이 없으면 등록
		...
		flag = FineDocDb.insertFineDoc(FineDocBn);   //fine_doc 에 등록
	}
	...
	flag = FineDocDb.insertFineDocList(FineDocListBn, FineDocBn.getDoc_dt());  //fine_doc_list 에 등록
...
<input type='hidden' name='auth_rw' 		value='<%=auth_rw%>'>
  ...
  <div class="a4">
<table width='708' height="<%//=table1_h%>"  border="0" cellpadding="0" cellspacing="0" class="">
	<tr> 
		...
		<td height="100" colspan="2" align='center'>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					...
					<td height="25" width="87%" style="font-size : 12pt;"><font face="바탕">총무<%=AddUtil.getDate(4)%>-<%=num%></font></td>
				</tr>
				<tr> 
    ...
    <tr>
        <td align=center>
            <table width=100% border=0 cellspacing=0 cellpadding=0>
                <tr>
                    <td width="100%" height="20" style="font-size : 12pt;"><p><font face="바탕">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. 귀 지점의 무궁한 발전을 기원합니다.</font></p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
					<td class='line'>
						<table width="100%" height="<%if(!c_bean.getCard_edate().equals("")){%>250<%}else{%>100<%}%>" border=0 cellspacing=1 cellpadding=0 >
                            <tr>
                                <td colspan="2"  align='center' style="font-size : 12pt;"><font face="굴림">구&nbsp;분</font></td>
                            ...
                            <tr>
								<td colspan="2"  style="font-size : 12pt; text-align: center;"><font face="굴림">계출번호</font></td>
							...
							<tr>
                                <td colspan="2"  style="font-size : 12pt; text-align: center;"><font face="굴림">차종</font></td>
							...
							<tr>
							 ...
							 <tr>
                                <td height="" style="font-size : 12pt; text-align: center;"><font face="굴림">신용카드<br>소유자</font></td>
                                <td width="50%" style="font-size : 12pt; text-align: center; font-weight:bold;"><font face="굴림">(주)아마존카</font></td>
                                <td width="25%" style="font-size : 12pt; text-align: center;"><font face="굴림"></font></td>
							</tr>
							<tr>
                                <td height="" style="font-size : 12pt; text-align: center;"><font face="굴림">카드번호</font></td>
                                <td width="50%" style="font-size : 12pt; text-align: center; font-weight:bold;"><font face="굴림"><b><%=pur.getCardno1()%></b></font></td>
                                <td width="25%" style="font-size : 12pt; text-align: center;"><font face="굴림"><%if(card_no.equals(pur.getCardno1())){%>기명식카드<%}%><%if(!jcard_no.equals("null")){%>( 조성희 )<%}else if(!hcard_no.equals("null")){%>( 허선숙 )<%}%></font></td>
							</tr>
							<tr>
                                <td height="" style="font-size : 12pt; text-align: center;"><font face="굴림">유효기간<br>(월/년)</font></td>
							...
							<tr>
                                <td height="" style="font-size : 12pt; text-align: center;"><font face="굴림">카드<br>결제금액</font></td>
					...
					<td class='line'>			
						<table width="100%" height="250" border=0 cellspacing=1 cellpadding=0 >
							...
							<tr>
                                ...
                                <td width="25%" style="font-size : 12pt; text-align: center;"><font face="굴림"><%if(card_no2.equals(pur.getCardno2())){%>기명식카드<%}%><%if(!jcard_no2.equals("null")){%>( 조성희 )<%}else if(!hcard_no2.equals("null")){%>( 허선숙 )<%}%></font></td>
							</tr>
							<tr>
                                <td height="" style="font-size : 12pt; text-align: center;"><font face="굴림">유효기간<br>(월/년)</font></td>
				...
				<tr>
					<td class='line'>			
						<table width="100%" height="" border=0 cellspacing=1 cellpadding=0 >
							<tr>
                                ...
                                <td width="50%" style="font-size : 12pt; text-align: center; font-weight:bold;"><font face="굴림"><b><%=AddUtil.parseDecimal(pur.getTrf_amt2())%></b> 원</font></td>
                                <td width="25%" style="font-size : 12pt; text-align: center;"><font face="굴림"><%if(pur.getTrf_st2().equals("1")){%>계좌이체<%}else if(pur.getTrf_st2().equals("2")){%>선불카드<%}else if(pur.getTrf_st2().equals("3")){%>후불카드<%}else if(pur.getTrf_st2().equals("4")){%>대출<%}else if(pur.getTrf_st2().equals("5")){%><%}else if(pur.getTrf_st2().equals("7")){%>카드할부<%}%></font></td>
							</tr>
					...
					<td class='line'>			
						<table width="100%" height="" border=0 cellspacing=1 cellpadding=0 >
							<tr>
                                ...
                                <td width="50%" style="font-size : 12pt; text-align: center; font-weight:bold;"><font face="굴림"><b><%=AddUtil.parseDecimal(pur.getTrf_amt3())%></b> 원</font></td>
                                <td width="25%" style="font-size : 12pt; text-align: center;"><font face="굴림"><%if(pur.getTrf_st3().equals("1")){%>계좌이체<%}else if(pur.getTrf_st3().equals("2")){%>선불카드<%}else if(pur.getTrf_st3().equals("3")){%>후부카드<%}else if(pur.getTrf_st3().equals("4")){%>대출<%}else if(pur.getTrf_st3().equals("5")){%><%}else if(pur.getTrf_st3().equals("7")){%>카드할부<%}%></font></td>
							</tr>
						</table>
					</td>
                </tr>
					...
					<td class='line'>			
						<table width="100%" height="" border=0 cellspacing=1 cellpadding=0 >
							<tr>
                                ...
                                <td width="25%" style="font-size : 12pt; text-align: center;"><font face="굴림"><%if(pur.getTrf_st4().equals("1")){%>계좌이체<%}else if(pur.getTrf_st4().equals("2")){%>선불카드<%}else if(pur.getTrf_st4().equals("3")){%>후부카드<%}else if(pur.getTrf_st4().equals("4")){%>대출<%}else if(pur.getTrf_st4().equals("5")){%><%}else if(pur.getTrf_st4().equals("7")){%>카드할부<%}%></font></td>
							</tr>
						</table>
					</td>
                </tr>
				...
				<%if(!ht.get("CAR_OFF_NM").equals("B2B사업운영팀")&&!ht.get("CAR_OFF_NM").equals("법인판촉팀")&&!ht.get("CAR_OFF_NM").equals("법인판매팀")&&!ht.get("CAR_OFF_NM").equals("특판팀")){%>
				<tr>
                    <td height=10></td>
                </tr>
                <tr>
                	<td height="25" style="font-size : 12pt;">
                   		<font face="바탕">
...
<%}%>
	...
	<!-- <tr> 
		<td width="708" colspan="2"><font face="굴림">&nbsp;</font></td>
	</tr> -->
	<tr align="center"> 
