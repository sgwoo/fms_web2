...
//		fm.target = "d_content";
	...
	function reg_Dkey(m_id, l_cd){
		window.open("digital_key_reg.jsp?m_id="+m_id+"&l_cd="+l_cd, "REG_DKEY", "left=100, top=10, width=720, height=650, resizable=yes, scrollbars=yes, status=yes");				
	}	
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr>
	      ...
	      <img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>총 <input type='text' name='size' value='' size='4' class=whitenum> 건</span>  
	        ...
	        <%}%>
	        &nbsp;&nbsp;&nbsp;
	        <font color=red>※ 디지털키가 있는 차명(트림), 옵션이 있는 경우에 신청 등록하십시오.</font>
	      	</td>
	  </tr>
	  <tr>
	      <td>
    		    <table border="0" cellspacing="0" cellpadding="0" width=100%>
    		        <tr>
        			      <td>
        			          <iframe src="digital_key_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
        			      </td>
    		        </tr>
    		    </table>
	      </td>
