...
<%@ page import="java.util.*, acar.util.*, acar.cont.*, acar.user_mng.*, acar.car_sche.*,acar.common.*, acar.car_office.*, acar.car_mst.*, acar.consignment.*,acar.client.*, acar.tint.*"%>
...
<!--
	...
	function search_off()
	{
		...
		window.open("/acar/cus0601/cus0602_frame.jsp?from_page=/fms2/car_pur/reg_cons.jsp&t_wd="+fm.off_nm.value, "SERV_OFF", "left=10, top=10, width=900, height=600, scrollbars=yes, status=yes, resizable=yes");
	}		
	...
	function cng_input1(value){
		...
		if(value == '영등포 영남주차장'){		
			...
			fm.udt_mng_nm.value 	= '<%=udt_mng_bean_b2.getDept_nm()%> <%=udt_mng_bean_b2.getUser_nm()%> <%=udt_mng_bean_b2.getUser_pos()%>';
...
<table border="0" cellspacing="0" cellpadding="0" width=670>
        ...
        <td class='line'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td width='29%'>&nbsp;<%=l_cd%>&nbsp;<%if(ck_acar_id.equals("000029")){ %>(<%=base.getUse_yn()%>)<%} %></td>
    ...
    <tr>
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>			
                <tr> 
                    <td width=6% rowspan="2" class=title>출<br>
                  고</td>
                    <td width=14% class=title>출고지</td>
                    <td width=30%>&nbsp;<select name='dlv_ext' class='default' onchange="javascript:setOff();cons_man_list();">
        		...
        		<%}%>
                    ...
                    <td width=6% rowspan="3" class=title>탁<br>
                  송</td>
                ...
                <tr>                    
                    ...
                    <td>&nbsp;<select name="udt_st" class='default' onChange="javascript:setOff();">
                        <option value="">==선택==</option>
    ...
    <%if(!cons.getCons_no().equals("") && !coe_bean.getCar_off_nm().equals("B2B사업운영팀") && !coe_bean.getCar_off_nm().equals("특판팀") && !coe_bean.getCar_off_nm().equals("법인판촉팀") && !coe_bean.getCar_off_nm().equals("법인판매팀")){%>   
            ...
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td>&nbsp;<%=coe_bean.getCar_off_nm()%> <input type='text' name='destname' maxlength='15' value='<%=coe_bean.getEmp_nm()%> <%=coe_bean.getEmp_pos()%>' class='default' size='15'>
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <%if(!auth_rw.equals("1")){%><a href="javascript:cons_man_sms();" title='문자보내기'><img src=/acar/images/center/button_send_smsgo.gif align=absmiddle border=0></a><%}%>        
                    </td>
                </tr>                
            </table>
        </td>
