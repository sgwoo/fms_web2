...
<%
	...
	String rent_mng_id 	= request.getParameter("c_rent_mng_id")==null?"":request.getParameter("c_rent_mng_id");
	String rent_l_cd 	= request.getParameter("c_rent_l_cd")==null?"":request.getParameter("c_rent_l_cd");
	...
	boolean flag5 = true;
		...
		//출고처리분 취소
		boolean flag3 = a_db.updateAllDlvDt( "", rent_mng_id, rent_l_cd);
		boolean flag4 = a_db.updateAllCartax( "", "", rent_mng_id, rent_l_cd);
