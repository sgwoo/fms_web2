...
function CarOffCopy(){
	var theForm = document.CarOffForm;
	opener.document.form1.con_bank.value 	= theForm.bank.value;
	opener.document.form1.con_acc_no.value 	= theForm.acc_no.value;
	opener.document.form1.con_acc_nm.value 	= theForm.acc_nm.value;
	window.close();
}
...
function BankAccMng(){
	...
	var SUBWIN="/acar/car_office/car_office_bank.jsp?car_off_id="+car_off_id+"&car_off_nm="+car_off_nm+"&car_comp_id="+car_comp_id+"&car_comp_nm="+car_comp_nm;	
...
<body leftmargin="15">
<form action="/acar/car_office/car_off_null_ui.jsp" name="CarOffForm" method="POST" >
...
<%}%> 					</select>
						<script>
						document.CarOffForm.bank.value = '<%= bank %>';
						</script> 					
					</td>
               		<td class=title>계좌번호</td>
               		<td>&nbsp;
					  <input type="text" name="acc_no" value="<%= acc_no %>" size="20" class=text></td>
               		<td class=title>예금주</td>
               		<td>&nbsp;
					  <input type="text" name="acc_nm" value="<%= acc_nm %>" size="30" class=text></td>
                </tr>
				-->
            </table>
        </td>
	...
	<tr>
		<td align="right">
		  <a href="javascript:CarOffCopy()">[출고영업소 계좌정보를 기안문서 계좌정보에 적용]</a>&nbsp;
		  <a href="javascript:BankAccMng()" onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_acc_yus.gif  align="absmiddle" border="0"></a>&nbsp;
		  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
		  <a href="javascript:CarOffUp()"><img src=/acar/images/center/button_modify.gif align=absmiddle border=0></a>&nbsp;
