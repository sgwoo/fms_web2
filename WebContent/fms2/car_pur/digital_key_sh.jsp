        ...
        <td>
    	      <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업관리 > 계출관리 > <span class=style5>디지털키등록관리</span></span></td>
    	      ...
    	      <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td width=40%>&nbsp;
                            ...
                            <option value='3' <%if(gubun1.equals("3")){%>selected<%}%>>미등록</option>
                            <option value='2' <%if(gubun1.equals("2")){%>selected<%}%>>신청</option>
                            <option value='4' <%if(gubun1.equals("4")){%>selected<%}%>>등록</option>
                        </select>
        			      </td>
                </tr>
            </table>
