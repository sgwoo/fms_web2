...
<%@ page import="acar.cont.*, acar.user_mng.*, acar.tint.*, acar.doc_settle.*, acar.coolmsg.*, acar.car_sche.*, acar.consignment.*, acar.client.*, acar.car_office.*, acar.car_mst.*, acar.estimate_mng.*"%>
  ...
  String udt_mng_nm 	= "";
	...
	if(base.getCar_gu().equals("1") && ej_bean.getJg_g_7().equals("3")){
					...
					xml_data2 =  "<COOLMSG>"+
			  					...
			  					"    <CONT>전기차 차량대금지급요청 문서가 등록되었습니다. &lt;br&gt; &lt;br&gt;  "+cm_bean.getCar_comp_nm()+" "+cm_bean.getCar_nm()+" "+cm_bean.getCar_name()+" "+rent_l_cd+" </CONT>"+
 								"    <URL></URL>";
					xml_data2 += "    <TARGET>"+target_bean2.getId()+"</TARGET>";
					xml_data2 += "    <SENDER>"+umd.getSenderId(ck_acar_id)+"</SENDER>"+
  								"    <MSGICON>10</MSGICON>"+
	...
	if(base.getCar_gu().equals("1") && ej_bean.getJg_g_7().equals("4")){
					...
					xml_data2 =  "<COOLMSG>"+
			  					...
			  					"    <CONT>수소차 차량대금지급요청 문서가 등록되었습니다. &lt;br&gt; &lt;br&gt;  "+cm_bean.getCar_comp_nm()+" "+cm_bean.getCar_nm()+" "+cm_bean.getCar_name()+" "+rent_l_cd+" </CONT>"+
 								"    <URL></URL>";
					xml_data2 += "    <TARGET>"+target_bean2.getId()+"</TARGET>";
					xml_data2 += "    <SENDER>"+umd.getSenderId(ck_acar_id)+"</SENDER>"+
  								"    <MSGICON>10</MSGICON>"+
