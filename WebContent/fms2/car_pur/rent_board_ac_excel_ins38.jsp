...
response.setHeader("Content-Disposition", "inline; filename=rent_board_ac_excel_ins38.xls");
%>
...
<%
	...
	Vector vt = ec_db.getRentBoardInsAcList("99", "렌트", gubun1, gubun2, st_dt, end_dt, mod_st);
	int vt_size = vt.size();
%>
