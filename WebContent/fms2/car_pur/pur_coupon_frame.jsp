...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "01", "06", "24");
	...
	if(s_kd.equals("") && t_wd.equals("") && gubun1.equals("")){
		...
		gubun3 = "";
		gubun2 = "2";
		st_dt  = c_db.addMonth(AddUtil.getDate(), -1);
...
<frameset rows="<%=height%>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
  <frame src="./pur_coupon_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./pur_coupon_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>