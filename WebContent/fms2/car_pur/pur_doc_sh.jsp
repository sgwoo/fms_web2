    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > <span class=style5>차량대금지급요청</span></span></td>
                ...
                <tr>
                    ...
                    <td width=40%>&nbsp;
            		    <select name='s_kd'>
                          ...
                          <option value='11' <%if(s_kd.equals("11")){%>selected<%}%>>영업소</option>						  
						  ...
						  <option value='13' <%if(s_kd.equals("13")){%>selected<%}%>>제조사</option>						  						  
						  <option value='14' <%if(s_kd.equals("14")){%>selected<%}%>>지급일자</option>						  						  
						  <option value='15' <%if(s_kd.equals("15")){%>selected<%}%>>지급요청일</option>
                        </select>			  						                          
        			    &nbsp;&nbsp;&nbsp;
