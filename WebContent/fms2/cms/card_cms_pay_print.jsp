...
<!--
	...
	function search(){
		...
		fm.action = 'card_cms_pay_print.jsp';
		fm.target='_self';
		fm.submit();
	}
...
<%
	...
	long total_amt7 = 0;
		...
		//card jip_cms 테이블에서 입금반영된 출금의뢰일 조회하기
	Vector vt2 = ai_db.getACardJipCmsDate();
	int vt_size2 = vt2.size();	
	
	//jip_cms 테이블 조회하기
	Vector vt = ai_db.getCardJipCmsDateList(adate, s_kd, t_wd);
	int vt_size = vt.size();
...
<%		}%>
		  ...
		  <td width='300' >&nbsp;
            ...
            <!--  <option value='4' <%if(s_kd.equals("4"))%>selected<%%>>기관코드</option>  -->
              </select>	
	...
	<td class='line'>
	  <table border="0" cellspacing="1" cellpadding="0" width=100%>
		<tr>
		  ...
		  <td width='80' class='title'>월렌트</td>
...
<%		for(int i = 0 ; i < vt_size ; i++){
		...
		<tr>
		  ...
		  <td align="center" >
		  <% if ( String.valueOf(ht.get("CANCEL")).equals("C") ) {%>취소 <% }%></td>
		</tr>
