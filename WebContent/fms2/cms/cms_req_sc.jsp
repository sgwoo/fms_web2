...
<!--
	...
	function  view_action( rent_mng_id, rent_l_cd, req_dt )
	{
		window.open("cms_req_u.jsp<%=valus%>&req_dt="+req_dt+"&rent_mng_id="+rent_mng_id+"&rent_l_cd="+rent_l_cd, "CMS_CNG", "left=150, top=50, width=700, height=650, scrollbars=yes");
	}	
	
	
	function reg_sch()
	{
		window.open("cms_cng_reg_frame.jsp", "CMS_CNG", "left=150, top=50, width=700, height=650, scrollbars=yes");
	}
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/cms/cms_req_frame.jsp'>
	...
	<tr>
	  <td colspan="2">
		<table border="0" cellspacing="0" cellpadding="0" width=100%>
		  <tr>
			<td>
			  <iframe src="cms_req_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
			</td>
		  </tr>
		</table>
	  </td>
