...
<input type="hidden" name="from_page" value="/fms2/cms/file21_cms_reg.jsp"> 
  ...
  <tr>
	<td class='line'>
	  <table border="0" cellspacing="1" cellpadding="0" width=100%>
		...
		<tr>
		  <td width='13%' class='title'>출금의뢰일자</td>		  
		  <td width='87%' >&nbsp;
  ...
  <tr>
	<td class='line'>
	  <table border="0" cellspacing="1" cellpadding="0" width=100%> 
		  <tr>
			<td>
			  <iframe src="file21_cms_print.jsp?adate=<%=AddUtil.getDate()%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
			</td>
		  </tr>
		</table>
	  </td>
