        ...
        <td class=line colspan="2">
            <table border=0 cellspacing=1 width=100%>
                <tr>
                    ...
                    <td width="37%">&nbsp;<input type="text" name="notice_dt" value="<%if(seq_no.equals("") && f_bean.getNotice_dt().equals("")){%><%=AddUtil.getDate()%><%}else{%><%=AddUtil.ChangeDate2(f_bean.getNotice_dt())%><%}%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>&nbsp;<input type="text" name="vio_ymd" value="<%=AddUtil.ChangeDate2(f_bean.getVio_dt().substring(0,8))%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                ...
                <tr>
                    ...
                    <td>&nbsp;<input name="gov_nm" type="text" class=whitetext value="<%if(FineGovBn.getGov_nm().equals("")){%><%=f_bean.getPol_sta()%><%}else{%><%=FineGovBn.getGov_nm()%><%}%>" size="30" maxlength="50" style='IME-MODE: active' onKeyDown='javascript:enter()'>
                        ...
                        <!--<a href="javascript:fine_gov_search();" onMouseOver="window.status=''; return true">검색</a>--> </td>
                    <td class=title>의견진술기한</td>
                    <td>&nbsp;<input type="text" name="obj_end_dt" value="<%=AddUtil.ChangeDate2(f_bean.getObj_end_dt())%>" size="11" maxlength=10 class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    까지 </td>
                </tr>
                  <%if(!FineDocListBn.getDoc_id().equals("")){%>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">&nbsp;1차:
                        <input type="text" name="obj_dt1" value="<%=f_bean.getObj_dt1()%>" size="11" maxlength=10 class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    2차:
                    <input type="text" name="obj_dt2" value="<%=f_bean.getObj_dt2()%>" size="11" maxlength=10 class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    3차:
                    <input type="text" name="obj_dt3" value="<%=f_bean.getObj_dt3()%>" size="11" maxlength=10 class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </td>
                </tr>
          <%}%>
            </table>
        ...
        <td colspan="2" class="line">
            <table border=0 cellspacing=1 width=100%>
                ...
                <tr>
                    ...
                    <td>&nbsp;<input type="text" name="rec_dt" value="<%=AddUtil.ChangeDate2(f_bean.getRec_dt())%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </td>
                    <td class=title>납부기한</td>
                    <td>&nbsp;<input type="text" name="paid_end_dt" value="<%=AddUtil.ChangeDate2(f_bean.getPaid_end_dt())%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    까지</td>
                </tr>
                <tr>
                    ...
                    <td>&nbsp;<input type="text" name="proxy_dt" value="<%=AddUtil.ChangeDate2(f_bean.getProxy_dt())%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </td>
                </tr>
                <tr>
        ...
        <td colspan="2" class="line">
            <table border=0 cellspacing=1 width=100%>
                <tr>
                    ...
                    <td width="32%">&nbsp;<input type="text" name="dem_dt" value="<%=AddUtil.ChangeDate2(f_bean.getDem_dt())%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </td>
                    <td class=title width="16%">최초청구일</td>
                    <td width="11%">&nbsp;<input type="text" name="f_dem_dt" value="<%=AddUtil.ChangeDate2(f_bean.getF_dem_dt())%>" size="11" class=whitetext readonly>
                    </td>
                    <td class=title width="15%">최종청구일</td>
                    <td width="11%">&nbsp;<input type="text" name="e_dem_dt" value="<%=AddUtil.ChangeDate2(f_bean.getE_dem_dt())%>" size="11" class=whitetext readonly>
                    </td>
                </tr>
                <tr>
                    <td class=title colspan="2">입금예정일</td>
                    <td>&nbsp;<input type="text" name="rec_plan_dt" value="<%=AddUtil.ChangeDate2(f_bean.getRec_plan_dt())%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </td>
                    <td class=title>수금일자</td>
                    <td colspan="3">&nbsp;<input type="text" name="coll_dt" value="<%=AddUtil.ChangeDate2(f_bean.getColl_dt())%>" size="11" class=whitetext onBlur='javscript:this.value = ChangeDate(this.value);'>
                    </td>
                </tr>
                <tr>
