...
%>
<form name='form1' action='/fms2/settle_acc/bad_complaint_doc_sc.jsp' target='c_foot' method='post'>
...
<div class="navigation" style="margin-bottom:0px !important" >
	<span class="style1">FMS운영관리 > 전자문서관리 > <span class=style5>고소장접수요청</span></span>
</div>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>전자문서 > <span class=style5>고소장접수요청</span></span></td>
