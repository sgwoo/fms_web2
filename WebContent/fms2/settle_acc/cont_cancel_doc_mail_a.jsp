...
//	gov_nm = "최진형";	
	if(!email.equals("")){
		   ...
		   if ( doc_title.equals("계약해지 및 납부최고") ) {	
				d_bean.setContent		("http://fms1.amazoncar.co.kr/mailing/pay/cont_cancel_3.jsp?doc_id="+URLEncoder.encode(doc_id,"EUC-KR"));
		   } else if ( doc_title.equals("계약해지 및 차량반납 통보")) {
				d_bean.setContent		("http://fms1.amazoncar.co.kr/mailing/pay/cont_cancel_re2.jsp?doc_id="+URLEncoder.encode(doc_id,"EUC-KR"));
		   }else if ( doc_title.equals("해지통보 및 해지정산금 납입고지")) {
				d_bean.setContent		("http://fms1.amazoncar.co.kr/mailing/pay/cont_cancel_4.jsp?doc_id="+URLEncoder.encode(doc_id,"EUC-KR"));
