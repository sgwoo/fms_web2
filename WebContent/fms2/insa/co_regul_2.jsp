...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    ...
    <tr>
        <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>현재</span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>
        ...
        <td class=line>
            <table width=100%  border=0 cellspacing=1 cellpadding=0>
                ...
                <tr>
                    ...
                    <td align=center>10일</td>
                    <td align=center>없음</td>
                    <td align=center>휴가 청구기한 : 출산일로부터 90일 이내 <br>(1회에 한하여 분할 사용 가능)</td>
                </tr>
                <tr>
                    <td class=title>돌</td>
                    <td>&nbsp;&nbsp;&nbsp;자녀</td>
    ...
    <tr>
     ...
     -->
	<tr>
		<td> &nbsp;&nbsp;<b>Ο 사외(협력업체) 경조사 규정 (2012-06-05 현재)</b>
		</td>
	</tr>      
	<tr>
		<td> 
		&nbsp;&nbsp;&nbsp;&nbsp;1) 화환/조화 : 회사가 대표로 지급 (사내직원과 같은 품질)
		</td>
	</tr>   
	<tr>
		<td> 
		&nbsp;&nbsp;&nbsp;&nbsp;2) 경조금 : 회사는 지급하지 않고, 개인적 친분 관계에 따른 부조는 통제하지 않음.
		</td>
	</tr> 	 	
</table>
</body>
