...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>인사관리 > 사규관리 > <span class=style5>부조금관리</span></span></td>
    ...
    <tr>
        <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>2010년 2월 26일 이전</span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>
    <tr>
        <td class=line>
            <table width=100%  border=0 cellspacing=1 cellpadding=0>
                ...
                <tr>
                    <td rowspan=5 class=title>사망</td>
                    <td>&nbsp;&nbsp;&nbsp;부모</td>
                    <td align=center>5일</td>
                    <td align=center>20만원/30만원</td>
                    <td rowspan=5 align=center>조화지급(3단)</td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;배우자부모</td>
                    <td align=center>5일</td>
    ...
    <tr>
        <td style='height:22'>&nbsp;&nbsp;※ 직계존비속/친형제를 제외한 부모의 형제, 방계혈족 등은 유급휴가 및 회사에서 지급하는 부조금이 없습니다.</td>
    </tr>
    <tr>
        <td style='height:22'> &nbsp;&nbsp;<font color=red>※ 유급휴가 기간내 주휴일, 국경일 등이 포함된 경우 유급휴가기간은 이를 모두 포함하여 산정합니다.</font></td>
    </tr>   
</table>
</body>
</html>