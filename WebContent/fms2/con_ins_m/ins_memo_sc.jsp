...
<form name='form1' method='post' action='/fms2/con_ins_m/ins_memo_i_a.jsp'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	    ...
	    <td class='line'>			
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
        		...
        		<tr>
        		    ...
        		    <td colspan='3'>&nbsp;
                      <textarea name='content' rows='3' cols='70' style='IME-MODE: active'></textarea>
                    </td>
        		</tr>
	        </table>
	    </td>
    ...
    <tr>
	    <td align='right'><a href="javascript:save()"><img src=/acar/images/center/button_reg.gif align=absmiddle border=0></a>&nbsp;&nbsp;<a href="javascript:pop_close()"><img src=/acar/images/center/button_close.gif align=absmiddle border=0></a></td>
    </tr>
</table>
</form>
