...
<%
	...
	String ref_dt1 	= request.getParameter("ref_dt1")==null?"2012-12-31":request.getParameter("ref_dt1");
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>	
	<tr>
		<td>			
            <table border="0" cellspacing="0" cellpadding="0" width=100%>
                <tr> 
                    <td> <iframe src="/fms2/off_demand/off_mc_car_sc_in.jsp?auth_rw=<%=auth_rw%>&brch_id=<%=brch_id%>&dt=<%=dt%>&ref_dt1=<%=ref_dt1%>&ref_dt2=<%=ref_dt2%>&gubun=<%=gubun%>&gubun_nm=<%=gubun_nm%>&s_au=<%=s_au%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe></td>
                </tr>
            </table>
		</td>
	</tr>
