...
<!--
	...
	function select_ins_com(st){
		...
		if(st == '4'){
			...
			act_ment="반영";
			fm.action = "ins_com_act_cls_a.jsp";
		}
		if(st == '5'){
	...
	function excel_download(){
		...
		else if(search_gubun == '4') search_gubun ="regnm";
		...
		location.href = "https://fms.amazoncar.co.kr/off_web/ins_com/insuCancExcel2.do?"+
...
// 		location.href = "http://localhost:8077/off_web/ins_com/insuCancExcel2.do?"+
// 				"page=1&rows=1000&sidx=req_dt&sord=asc"+
// 				"&period="+period+"&startDate="+startDate+"&endDate="+endDate+"&gubun="+ encodeURI(gubun,"UTF-8")+"&search_text="+encodeURI(search_text,"UTF-8")+"&search_gubun="+search_gubun+"&userId="+user_id+" ";
	}
	...
	function submitBtn(){
	 ...
	 function template_conf_com(){
		 var fm = inner.document.form1;	
			fm.action = "/fms2/ins_com/ins_com_cls_conf_print.jsp";
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
  <tr>
	  ...
	  <input type="button" class="button btn-submit" value="취소하기" onclick="select_ins_com(3)"/>
	   &nbsp;&nbsp;&nbsp;
	  <input type="button" class="button" value="피보험자변경요청서" onclick="select_ins_com(6)"/>
	  &nbsp;
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="ins_com_cls_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
...
<%-- 엑셀 전송용 폼 --%>
 <form name='form2' id="excel-upload" action="https://fms.amazoncar.co.kr/off_web/ins_com/insuCancExcel2.do" method="post" enctype="multipart/form-data"> 
