...
<div class="navigation">
	<span class=style1>보험관리 ></span><span class=style5>변경현황</span>
</div>
<div class="search-area">
  ...
  <input type="text" name="end_dt" size="10" value="<%=end_dt%>" class="text" >
	...
	<select id="s_kd" name="s_kd" class="select" style="width:100px;">
		...
		<option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>배서항목</option>
		<option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>비고</option>
	</select>
	&nbsp;
