...
<!--
	function search(){
		...
		if(fm.gubun3.value == '기간' && fm.st_dt.value == '' && fm.t_wd.value == ''){
			alert('기간이나 검색어로 조회하세요.'); return;	
		}
		fm.action = 'ins_com_file2_sc.jsp';
		fm.target = 'c_foot';
		fm.submit();
	}
...
<div class="navigation">
	<span class=style1>보험관리 ></span><span class=style5>기타증명서</span>
</div>
<div class="search-area">
	...
	<select id="gubun1" name="gubun1"  class="select" style="width:130px;">
		...
		<option value='0007' <%if(gubun1.equals("0008")){%>selected<%}%>>삼성화재</option>
	</select>
	&nbsp;&nbsp;
  ...
  <input type="text" name="end_dt" size="10" value="<%=end_dt%>" class="text" >
	...
	<select id="s_kd" name="s_kd" class="select" style="width:100px;">
		<option value='1' <%if(s_kd.equals("1")){%>selected<%}%>>파일명</option>
