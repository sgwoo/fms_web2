...
<table border=0 cellspacing=0 cellpadding=0 width='100%'>
    <tr>
    	<td><iframe src="/fms2/condition/auc_dlv_sc_in.jsp?s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&dt=<%=dt%>&t_st_dt=<%=t_st_dt%>&t_end_dt=<%=t_end_dt%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0></iframe></td>
    </tr>
	<tr>
