...
<%	
	...
	int est_amt		= request.getParameter("est_amt")	==null?0:Util.parseDigit(request.getParameter("est_amt"));
	...
	pay_grt.setExt_dt(ext_dt);
	pay_grt.setUpdate_id(user_id);
	if(p_st.equals("5") && pay_grt.getExt_pay_dt().equals("")){
		pay_grt.setExt_s_amt(s_amt);
		pay_grt.setExt_v_amt(v_amt);		
	}
	if(p_st.equals("8") && pay_grt.getExt_pay_dt().equals("")){
		pay_grt.setExt_s_amt(s_amt);
		pay_grt.setExt_v_amt(v_amt);		
	}
%>
