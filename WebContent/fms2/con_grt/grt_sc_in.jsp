...
<%
	...
	Vector exts = ae_db.getGrtList2(br_id, gubun1, gubun2, gubun3, gubun4, st_dt, end_dt, s_kd, t_wd, sort_gubun, asc);
          ...
          <%	if(grt_size > 0){
			for(int i = 0 ; i < grt_size ; i++){
              ...
              <%}%>
                    ...
                    <td align='center'><a href="javascript:parent.view_memo('<%=ext.get("RENT_MNG_ID")%>', '<%=ext.get("RENT_L_CD")%>', '<%=ext.get("RENT_ST")%>', '<%=ext.get("EXT_TM")%>', '<%=ext.get("EXT_ST")%>')" onMouseOver="window.status=''; return true" title="<%=af_db.getMaxMemo(String.valueOf(ext.get("RENT_MNG_ID")), String.valueOf(ext.get("RENT_L_CD")), tm_st1)%>"><%=ext.get("GUBUN")%><%=ext.get("RENT_ST_NM")%></a></td>
                    ...
                    <td align='center'><%=ext.get("CON_MON")%></td>
                    <td align='center'><%=ext.get("RENT_START_DT")%></td>
                    <td align='center'><%=ext.get("EXT_EST_DT")%></td>
                    <td align='right'><%=Util.parseDecimal(String.valueOf(ext.get("EXT_AMT")))%></td>
                    <td align='center'><%=ext.get("EXT_PAY_DT")%></td>
                    <td align='center'><%=ext.get("CLS_DT")%></td>
