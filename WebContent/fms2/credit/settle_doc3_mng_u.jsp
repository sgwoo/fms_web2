...
<%
	...
	//미수채권 리스트
	Vector FineList = FineDocDb.getMyAccidDocLists(doc_id);
%>
...
<!--
	...
	function fine_update(){
		...
		fm.target = "i_no";
		fm.action = "settle_doc3_mng_u_a.jsp";
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    ...
    <tr> 
	  ...
	  <a href="javascript:window.close();" onMouseOver="window.status=''; return true"><img src="/acar/images/center/button_list.gif" align="absmiddle" border="0"></a></td>
      </tr>
      <tr>
        <td class=line2></td>
     </tr>
