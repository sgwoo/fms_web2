...
<%
	...
	String go_url = "/fms2/credit/settle_doc3_reg_sc.jsp";
...
<FRAMESET rows="300, *" border=0>
	<FRAME SRC="./settle_doc3_reg_sh.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&go_url=<%=go_url%>" name="c_body" frameborder=0  marginwidth="10" marginheight="10" scrolling="no" noresize>
