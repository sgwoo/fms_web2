...
<% 
 ...
 //20201211 CONTENT_CODE 필수 
	String content_code = request.getParameter("CONTENT_CODE");	  //APPRSL , CAR_CHANGE ,etc
   ...
   List<AttachedFile> files = null;
	...
	System.out.println("file multi zipFile=" + zipFile);
		
	String vid[] 	= request.getParameterValues("SEQ");
   ...
   try {               	
	   	for(int ii=0;ii < vid_size;ii++){
				...
				attachedSeq = vid[ii]; //car_mng_id
		//	   System.out.println("attachedSeq=" + attachedSeq);
