...
<%
	...
	Vector vt = mc_db.getCarMaintReqDocList(s_kd, t_wd, gubun1, st_dt, end_dt);
	int vt_size = vt.size();
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/ssmoters/car_maint_reg_doc_frame.jsp'>
		...
		<td class='line' width='70%'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				...
				<tr>
			      ...
			      <td width='12%' class='title'>검사비</td>			
...
<%		for(int i = 0 ; i < vt_size ; i++){
			Hashtable ht = (Hashtable)vt.elementAt(i);%>
				<tr>
					...
					<td  width='25%' align='center'><%=ht.get("OFF_NM")%></td>										
				</tr>
<%		}%>
				<tr>
				  <td class='title'>&nbsp;</td>
