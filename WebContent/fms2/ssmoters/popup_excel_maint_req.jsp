    ...
    <td class='line' width='26%' id='td_title' style='position:relative;'> 
	  <table border="1" cellspacing="1" cellpadding="0" width='100%' >       
          <tr> 
			...
			<td class="title" width='25%'>업체</td>	  	  
			<td class="title" width='20%'>차량번호</td>
			<td class="title" width='31%'>차종</td>
          </tr>
      </table>
	</td>
	<td class='line' width='74%'>
	  <table border="1" cellspacing="1" cellpadding="0" width='100%' >    
		<tr>
		  ...
		  <td class="title" width='7%'>대여기간</td>			
		  <td class="title" width='3%'>최초등록일</td>		
		  <td class="title" width='3%'>등록지역</td>		
		  <td class="title" width='3%'>대여방식</td>			
		  <td class="title" width='2%'>관리담당자</td>			  			  
	  ...
	  <table border="1" cellspacing="1" cellpadding="0" width='100%'>
        ...
        <tr > 
		  ...
		  <td align="center" width='14%'><%=ht.get("검사일")%></td>	  	
		   <td align="center" width='25%'><%=Util.subData(String.valueOf(ht.get("업체")),7)%></td>	  	  
	...
	<td class='line' width='74%'>
	  <table border="1" cellspacing="1" cellpadding="0" width='100%'>
		...
		<tr>		  
		  ...
		  <span title='<%=ht.get("고객")%>'><%=Util.subData(String.valueOf(ht.get("고객")),9)%></span></td>
		  <td align="center"	width='6%'><%=ht.get("검사소")%></td>
		  ...
		  <td align="center"	width='7%'><%=ht.get("대여기간")%></td>
