...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 긴급출동/검사 관리 > <span class=style5>자동차검사미청구</span></span></td>
	...
	<form action="./car_d_list_sc.jsp" name="CarRegSearchForm" method="POST" target="c_foot">
