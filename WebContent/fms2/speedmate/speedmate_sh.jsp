...
%>
<form name='form1' action='customer_sc_in.jsp' target='i_no' method='post'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
		...
		<td colspan="2"> 스피드메이트 정비내역 엑셀로 등록 :
            		...
            		<a href="javascript:var win=window.open('excel.jsp?user_id=<%=user_id%>','popup','left=10, top=10, width=600, height=200, status=no, scrollbars=no, resizable=no');"><img src=/acar/images/center/button_reg_excel.gif align=absmiddle border=0></a>&nbsp;
...
<!--    		
	<tr>
		...
		<td colspan="2"> Service 에 넣기 :   

            		<a href="javascript:var win=window.open('excel2.jsp?user_id=<%=user_id%>','popup','left=10, top=10, width=600, height=200, status=no, scrollbars=no, resizable=no');"><img src=/acar/images/center/button_reg_excel.gif align=absmiddle border=0></a>&nbsp;
