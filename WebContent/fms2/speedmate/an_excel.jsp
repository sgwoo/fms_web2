...
<!--
	...
	function save(){
		...
		fm.action = 'an_excel_reg.jsp?user_id=<%=user_id%>';		
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;협력업체 > 거래처별 출금원장 > <span class=style1><span class=style5>엑셀파일 등록</span></span></td>
        ...
        <td align="right" class="line">
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
                    ...
                    <td>&nbsp;
				    <input type="radio" name="gubun1" value="2" checked>삼성애니카 등록처리 
			        </td>
			        <td align="center"><a href="https://fms3.amazoncar.co.kr/data/sample/s_sample.xls">삼성애니카_엑셀등록샘플</a></td>
                </tr>
            </table>
		</td>
    </tr>
