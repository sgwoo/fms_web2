...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='basic_price_frame.jsp'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
  <tr>
	  ...
	  &nbsp;&nbsp;&nbsp;<font color='red'>※ 데이터는 계속 추가될 예정입니다.</font>
	  </td>
	  <td align='right'><font color='red'>※ 모든 금액은 부가세(V.A.T)별도금액임</font></td>
	</tr>
	<tr>
		<td colspan="2">
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="basic_price_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
