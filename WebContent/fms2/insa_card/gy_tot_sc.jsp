...
<%
	...
	//직군별 현황 - 외근직
	Vector vt1 = ic_db.gyTolist_yeardate("1");
	int vt1_size = vt1.size();
	
	//직군별 현황 - 내근직
	Vector vt2 = ic_db.gyTolist_yeardate("2");
	int vt2_size = vt2.size();
	
	//부서별 현황 - 본점
	Vector vt3 = ic_db.gyTolist_yeardate("3");
	int vt3_size = vt3.size();
	
	//부서별 현황 - 지점
	Vector vt4 = ic_db.gyTolist_yeardate("4");
	int vt4_size = vt4.size();
	
	int f_year 	= AddUtil.getDate2(1);	
	int l_year = AddUtil.getDate2(1)-3;
	int year_cnt = 4*2; //4년치
		        ...
		        <TR id='tr_title'>
		        	<td class='line2' id='td_title'>
		        		<table border="0" cellspacing="1" cellpadding="0" width=100%>
		        			...
		        			<tr>
					          <%for (int j = f_year ; j >= l_year ; j--){%>
                              <td width="<%=td_width%>" class=title>충원</td>
                              <td width="<%=td_width%>" class=title>퇴사</td>
					          <%}%>
		        			</TR>		        			
		        			<!-- 직군별현황 - 외근직 -->
