...
<object id=factory style="display:none" classid="clsid:1663ed61-23eb-11d2-b92f-008048fdd814" codebase="/smsx.cab#Version=7,6,0,10">
</object>
<body onLoad="javascript:onprint();">
<div id="Layer1" style="position:absolute; left:435px; top:780px; width:109px; height:108px; z-index:1"><img src="/images/square.png" width="109" height="108"></div>
			        ...
			        <td>
			        	<table width="700" border="0" cellspacing="0" cellpadding="0">
				            <TR>
								...
								<TD class=style2 align=center>&nbsp;&nbsp<%=ht.get("SSN1")%><input type='text' name="h_ssn2" size='7' style='text-align:left; font-size : 12pt; background-color:#ffffff; border-color:#000000; border-width:0;' >
								<!---<%=ht.get("SSN2")%>--></TD>
				            </TR>
							<TR>
