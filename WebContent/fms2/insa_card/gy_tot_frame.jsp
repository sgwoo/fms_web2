...
<FRAMESET rows="<%=height%>, *" >
	<FRAME SRC="./gy_tot_sh.jsp<%=valus%>" name="c_body" frameborder=0  marginwidth="10" marginheight="10" scrolling="no" noresize>
	<FRAME SRC="./gy_tot_sc.jsp<%=valus%>" name="c_foot" frameborder=0 scrolling="auto"  marginwidth="10" marginheight="10">
</FRAMESET>
