...
<body leftmargin="15">
<form name='form1' method='post' action='mrent_bbs_sc.jsp' target='c_foot'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
        ...
        <td colspan=2>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>고객FMS > <span class=style5> 고객제안함 
        			</span></span>
        			</td>
    ...
    <tr> 
        <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/icon_arrow.gif align=absmiddle> 
    ...
    <tr> 
        <td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jsi.gif align=absmiddle>&nbsp; 
            <select name='s_yy'>
        ...
        <td align='right' width="100">
	  	    <a href='javascript:Reg();' onMouseOver="window.status=''; return true" onFocus="this.blur()"><img src=/acar/images/center/button_reg.gif border=0 align=absmiddle></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>
</form>  
</body>
