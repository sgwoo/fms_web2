...
<%
	...
	MrentBean bean = MB_db.getM_bbs_view(bbs_id);
%>
...
<body leftmargin="15">
<form action="mrent_bbs_a.jsp" name="form1" method="post" enctype="">
	...
	<tr> 
		<td align="right">
			<%if(auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")){%>
				<a href='javascript:update();' onMouseOver="window.status=''; return true" onFocus="this.blur()"><img src="/acar/images/center/button_modify.gif"  aligh="absmiddle" border="0"></a>
			<%}%>
	...
	<tr>
	  <td class="line">
		  <table border="0" cellspacing="1" cellpadding="0" width=100%>
			<tr>
			    <td align="center">
				<textarea name="reply_content" cols="80" rows="5" class="default"></textarea></td>
