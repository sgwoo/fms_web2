...
<table border=0 cellspacing=0 cellpadding=0 width="600">
	    	...
	    	<table border="0" cellspacing="1" cellpadding="0" width="100%">
				...
				<tr>
					...
					//System.out.println("vid_num="+vid_num);
						...
						if(gubun1.equals("ddj")){
							off_nm = token1.nextToken().trim();	 //이름
							email = token1.nextToken().trim();	  //메일
						}else{
							off_nm = token1.nextToken().trim();	 //메일
							off_id = token1.nextToken().trim();	  //이름
						}
	...
	<tr>
		<td align="right" height=25><a href="javascript:Mail_send()" class="ml-btn-4" style="text-decoration: none;">보내기</a>&nbsp;<a href="javascript:window.close()" class="ml-btn-4" style="text-decoration: none;">닫기</a></td>
    </tr>
</table>
