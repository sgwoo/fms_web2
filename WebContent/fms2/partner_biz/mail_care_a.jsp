	...
	//	System.out.println("mail=" + email[i]  );
	 // 	email[i] = "dev@amazoncar.co.kr";
		...
		if(!email[i].equals("")){
			...
			d_bean.setContent		("http://fms1.amazoncar.co.kr/mailing/rent/care_service.jsp?e_mail="+email[i] );
