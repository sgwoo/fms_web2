				...
				<tr>
					...
					//System.out.println("vid_num="+vid_num);
						...
						while(token1.hasMoreTokens()) {
							...
							user_mail = token1.nextToken().trim();	 //메일
							user_nm = token1.nextToken().trim();	  //이름
							user_agent = token1.nextToken().trim();	  //직급

						}		
					
					%>
					<input type='hidden' name='user_mail<%=i%>' value='<%=user_mail%>'>					
