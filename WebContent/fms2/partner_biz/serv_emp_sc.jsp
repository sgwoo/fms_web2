...
<input type="hidden" name="sort" value="<%= sort %>">
    ...
    <tr> 
      <td><iframe src="serv_emp_sc_in.jsp?auth_rw=<%=auth_rw%>&s_kd=<%=s_kd%>&t_wd=<%=t_wd%>&sort_gubun=<%=sort_gubun%>&sort=<%=sort%>&gubun1=<%=gubun1%>&gubun2=<%=gubun2%>&br_id=<%=br_id%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
    </tr>
