  ...
  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr>
	  <td><img src="/acar/images/center/icon_arrow.gif" align=absmiddle> <span class=style2>총 <input type='text' name='size' value='' size='4' class=whitenum> 건</span>
            ...
            <a href="javascript:ConsCostYn()" onMouseOver="window.status=''; return true" title='사용여부처리'><img src=/acar/images/center/button_reg.gif border=0 align=absmiddle></a>&nbsp;
	  </td>
	</tr>  
	<tr>
		<td>
