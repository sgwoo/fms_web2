...
<!--
	...
	//	var SUBWIN="./prop_i.jsp?ck_acar_id=<%=ck_acar_id%>";	
	//	window.open(SUBWIN, "AncReg", "left=100, top=100, width=1150, height=700, scrollbars=yes");
    ...
    <tr>
	  ...
	  <td align="right">
	    <%if(auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")){%>
		  ...
		  <a href='javascript:prop_print()' title='프린트하기'><img src=/acar/images/center/button_print.gif align=absmiddle border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;
		  <%	}%>
		<%}%>  
	  </td>
    </tr>  
