...
function SearchBbs()
{
	...
	theForm.action = 'off_sc.jsp?gubun_nm='+g_nm;
		...
		<td colspan=2>
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle border=0>&nbsp;<span class=style1>Master > <span class=style5>협력업체 공지사항</span></span></td>
		...
		<td class=line>
			<table border="0" cellspacing="1" cellpadding='0' width=100%>
				<tr >
					...
					<td width=42%>&nbsp;
						<INPUT TYPE="radio" NAME="gubun1" value='9'  <%if(gubun1.equals("9")){%>checked<%}%>>협력업체&nbsp;
