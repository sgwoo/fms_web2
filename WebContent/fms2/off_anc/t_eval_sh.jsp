...
<table border="0" cellspacing="0" cellpadding="0" width='500'>
	    ...
	    <td class='line'>			 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>					
        		    ...
        		    <td width='30%' class='title'>평가점수</td>		
        		    <td width='38%' class='title'>평가액</td>				
		        </tr>
	        </table>
	    </td>
	    <td width='17'>&nbsp;</td>
    ...
    <tr>
	    <td colspan='2'>
	    <iframe src="t_eval_sh_in.jsp?ck_acar_id=<%=ck_acar_id%>&s_width=<%=s_width%>&s_height=<%=s_height%>&prop_id=<%=prop_id%>&use_id=<%=user_id%>" name="i_no" width="100%" height="250" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=no, marginwidth=0, marginheight=0 >
	    </iframe>
	    </td>
    </tr>
</table>
