...
<!--
	function AncReg(){
		var SUBWIN="./anc_se_i.jsp?ck_acar_id=<%=ck_acar_id%>&from_page=/fms2/off_anc/agent_frame.jsp";	
		window.open(SUBWIN, "AncReg", "left=10, top=10, width=1024, height=750, scrollbars=no");
	}

	function AncDisp(bbs_id){
		var SUBWIN="./anc_se_c.jsp?ck_acar_id=<%=ck_acar_id%>&from_page=/fms2/off_anc/agent_frame.jsp&bbs_id=" + bbs_id;	
  ...
  <tr>
		<td colspan="2">
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="agent_sc_in.jsp<%=valus%>&ck_acar_id=<%=ck_acar_id%>&s_width=<%=s_width%>&s_height=<%=s_height%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
