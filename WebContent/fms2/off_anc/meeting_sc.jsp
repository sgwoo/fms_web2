...
<%
	...
	BulBean a_r [] = obd.getBulAll(gubun, gubun_nm, acar_id, "M");
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr>
        <td colspan=2>
<iframe src="./meeting_sc_in.jsp?ck_acar_id=<%=ck_acar_id%>&s_width=<%=s_width%>&s_height=<%=s_height%>&auth_rw=<%=auth_rw%>&gubun=<%=gubun%>&gubun_nm=<%=gubun_nm%>" name="i_in" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
</tr>
</form>
</body>
</html>