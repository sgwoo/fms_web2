...
function AncReg()
{
	...
	//var bbs_st = theForm.bbs_st.value;
	//var bbs_st = $('input[name="bbs_st"]:checked').val();
	var bbs_st = "";
...
<body onLoad="javascript:self.focus()"> <!-- onLoad="javascript:self.focus()" -->
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
			...
			<table border="0" cellspacing="1" cellpadding="0" width="100%">				
				<tbody>
					...
					<tr id="est_st3_3" style="display:none">
						...
						<!-- 
						&nbsp;2. 사외(회사와 거래관계, 하청관계) 경조사 규정 (2012-06-05 현재)<br>
						&nbsp;&nbsp;&nbsp;1) 화환 : 회사가 대표로 지급(사내직원과 동일한 품질)<br>
						&nbsp;&nbsp;&nbsp;2) 축의금 : 회사는 지급하지 않고, 개인적 친분 관계에 따른 부조는 통제하지 않음.<br>
						 -->
						</td>
					</tr>
				</tbody>
	...
	<tr>
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">				
				<tr>
					<td class="title" width=15%>첨부파일1</td>
					<td colspan="3">&nbsp;&nbsp;<input type='file' name="att_file1" size='60' class='text' value=''></td>
				</tr>
				<tr>
					<td class="title" width=15%>첨부파일2</td>
					<td colspan="3">&nbsp;&nbsp;<input type='file' name="att_file2" size='60' class='text' value=''></td>
				</tr>
				<tr>
					<td class="title" width=15%>첨부파일3</td>
					<td colspan="3">&nbsp;&nbsp;<input type='file' name="att_file3" size='60' class='text' value=''></td>
				</tr>
				<tr>
					<td class="title" width=15%>첨부파일4</td>
					<td colspan="3">&nbsp;&nbsp;<input type='file' name="att_file4" size='60' class='text' value=''></td>
				</tr>
				<tr>
					<td class="title" width=15%>첨부파일5</td>
					<td colspan="3">&nbsp;&nbsp;<input type='file' name="att_file5" size='60' class='text' value=''></td>
				</tr>
			</table>
		</td>
	</tr>
...
<input type="hidden" name="att_file1" value="<%=att_file1%>">
<input type="hidden" name="att_file2" value="<%=att_file2%>">
<input type="hidden" name="att_file3" value="<%=att_file3%>">
<input type="hidden" name="att_file4" value="<%=att_file4%>">
<input type="hidden" name="att_file5" value="<%=att_file5%>">
