...
<%@ page import="java.net.*, java.util.*, acar.util.*, acar.off_anc.*" %>
...
<%
	...
	gubun_nm = URLDecoder.decode(gubun_nm, "UTF-8");
...
<!--
	function AncReg(){
		...
		window.open(SUBWIN, "AncReg", "left=100, top=100, width=650, height=600, scrollbars=no");
	}

	function AncDisp(bbs_id){
		var SUBWIN="/acar/off_anc/anc_c.jsp?bbs_id=" + bbs_id;	
		window.open(SUBWIN, "AncDisp", "left=100, top=100, width=650, height=600, scrollbars=yes");
	}
//-->
</script>
</head>
