...
//	else if(fm.content1.value == '')				{	alert('문제점1을 입력하십시오');			fm.content1.focus(); 	return;	}
...
//	else if(fm.content3.value == '')				{	alert('기대효과를 입력하십시오');		fm.content3.focus(); 	return;	}
	...
	if (  CKEDITOR.instances.content1.getData() == ''  ) {
      	alert('문제점을 입력하십시오');	theForm.content1.focus();	
		return;	
   }
   
   	if (  CKEDITOR.instances.content2.getData() == ''  ) {
      	alert('개선안을 입력하십시오');	theForm.content2.focus();	
		return;	
   }
   
   	if (  CKEDITOR.instances.content3.getData() == ''  ) {
      	alert('기대효과를 입력하십시오');	theForm.content3.focus();	
		return;	
   }
	  ...
	  <td class='line'>
		<table border="0" cellspacing="1" cellpadding="0"  width=100%>			
		  ...
		  <tr>
			...
			<td colspan="3" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="p_after" value="[사후제안]"  >사후제안
			&nbsp;&nbsp;&nbsp;<input type='text' name="title" id="title" size='160' class='text' style='IME-MODE: active'></td>
		  </tr>
		  <tr>
			<td width="70" class="title">문제점</td>
		    <td colspan="3" align="center"><textarea name="content1" id="content1" ></textarea></td>
		    <script>
		  ...
		  <tr>
		    ...
		    <td colspan="3" align="center"><textarea name="content2" id="content2" ></textarea></td>
		      <script>
		  ...
		  <tr>
			...
			<td colspan="3" align="center"><textarea name="content3" id="content3" ></textarea></td>
			 <script>
