...
<%
	...
	PropCommentBean pc_r [] = p_db.getPropCommentAllList(prop_id, seq);
%>
<html>
...
function AncUp()
{
	...
	fm.cmd.value = "i";
	fm.target="i_no";
	fm.action = "./prop_re_comment_a.jsp";
	fm.submit();
}
...
<form action="./prop_re_comment_a.jsp" name="form1" method="post">
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>	  
	  <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>댓글</span></td>
	</tr>	
	<tr>
		<td class=line2 ></td>
	</tr>
	<tr>	  
	  <td class=line>
	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
        <tr>
          <td class="title" width=15%>연번</td>
          <td class="title" width="55%">내용</td>
          <td class="title" width="15%">등록자</td>
          <td class="title" width="15%">등록일자</td>
        </tr>
		<%	for(int i=1; i<pc_r.length; i++){
	        	pc_bean = pc_r[i];
				String cont = AddUtil.replace(pc_bean.getContent(),"\\","&#92;&#92;");
				cont = AddUtil.replace(cont,"\"","&#34;");
				cont = Util.htmlBR(cont);
        ...
        <tr>
          ...
          <td><%=cont%></td>
          <td align="center"><%=pc_bean.getUser_nm()%></td>
	...
	<input type="hidden" name="re_seq" 	value="<%=pc_r.length%>">
	<tr>
	  <td class='line'>
		<table border="0" cellspacing="1" cellpadding="0" width=100%>					  						
		  <tr>
