...
<!--
	...
	function pop_excel(){
		...
		fm.action = "popup_asset_excel_s7.jsp";
		fm.submit();
	}		
//-->
</script>
...
<%
	...
	hidden_value = "?auth_rw="+auth_rw+"&s_width="+s_width+"&s_height="+s_height+"&chk1="+chk1+"&s_kd="+s_kd+"&t_wd="+t_wd+"&gubun1="+gubun1+"&st_dt="+st_dt+"&end_dt="+end_dt+"&s_year="+s_year+"&f_month="+f_month+"&t_month="+t_month+"&sort="+sort+"&asc="+asc;
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
     <tr>
	   <td align='right'><a href="javascript:pop_excel();"><img src="/acar/images/center/button_excel.gif" align="absmiddle" border="0"></a>
	  </td>
	</tr>
    ...
    <tr>
		<td>
			 <table border="0" cellspacing="1" cellpadding="0" width=100%>
				<tr>
					<td><iframe src="./asset_s7_sc_in1.jsp<%=hidden_value%>" name="RegList" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
				</tr>								
			</table>
		</td>
	</tr>
