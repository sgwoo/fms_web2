...
//	String node_code = String.valueOf(per.get("NODE_CODE"));
	...
	//	System.out.println("자산매각(경매장)등록" + s_flag);
	    ...
	    if ( client_id2.equals(su_bean.getClient_id()) ) { //매매상 다시 확인 
		    ...
		    sup_amt =  AddUtil.parseInt(String.valueOf(h_asset.get("SUP_AMT")))  ;   //공급가
	...
	///  sup_amt= su_bean.getSup_amt();  //공급가	 	 
	  	 ...
	  	 vat_amt = su_bean.getSale_amt() -  sup_amt;	//부가세	
	   	 ...
	   	 remain_amt =  su_bean.getSale_amt() -  su_bean.getGet_amt() -  vat_amt + su_bean.getAdep_amt() + su_bean.getGdep_amt() ;  //사용안함 
