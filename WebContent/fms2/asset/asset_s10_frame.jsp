...
<frameset rows="<%=height-40 %>, <%=AddUtil.parseInt(s_height)-height%>" border=1 name=ex>
  <frame src="./asset_s10_sh.jsp<%=valus%>" name="c_body" marginwidth=3 marginheight=10 scrolling='no' noresize>
  <frame src="./asset_s10_sc.jsp<%=valus%>" name="c_foot" marginwidth=3 marginheight=10 scrolling='auto' noresize>
</frameset>
</HTML>
