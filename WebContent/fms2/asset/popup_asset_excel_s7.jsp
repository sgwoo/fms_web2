...
response.setHeader("Content-Disposition", "inline; filename=popup_asset_excel_s7.xls");
%>
...
%>
<table border="1" cellspacing="0" cellpadding="0" width=2100>
  <tr> 
    <td colspan="25" align="left"><font face="돋움" size="4" > 
      <b>구분: <%=st_nm%> (<%=s_year%> / <%=t_month%> )</b> </font></td>
  </tr>
  <tr align="center"> 
 ...
 <!--     <td width='3%' align='center'><%=AddUtil.parseFloatCipher2(AddUtil.parseFloat(String.valueOf(ht.get("LIFE_EXIST"))), 1) %></td>
    ...
    <% if ( ht.get("DEPRF_YN").equals("5") || ht.get("DEPRF_YN").equals("6") ) {
         ass_dt = as_db.getMove_dt(String.valueOf(ht.get("ASSET_CODE")));
     }  %>    
    <%=ass_dt%>       
    </td>
