...
<!--
	...
	function Search2(){
		var fm = document.form1;
		fm.action = "./stat_asset_in_view1.jsp";			
		fm.target='i_view';
...
<table border=0 cellspacing=0 cellpadding=0 width="100%">
    ...
    <tr>       
    	<td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2 style="margin-right:15px;" ><%=s_yy%></span>
    	<a href="javascript:go_list()"><img src=/acar/images/center/button_list.gif align="middle"></a></td>    
    </tr>	
     <tr>
    		<td>
    ...
    <tr> 
      <td><iframe src="./stat_asset_in_view1.jsp?height=<%=height%>&auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&s_yy=<%=s_yy%>" name="i_view" width="100%" height="<%=height+10%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
      </td>
    </tr>
  </table>
</form>
