...
<div class="tb_wrap">
	...
	<div class="tb_box">
				     ...
				     <%  if(vt_size > 0)	{  %>				
							...
							%>			
							 ...
							 <tr style="height: 25px;"> 				
								...
								<td  width='55' class='center content_border'>
								<%  if ( String.valueOf(ht.get("CAR_ST")).equals("5") ) { %>업무대여 <% } else {%><%=ht.get("RENT_WAY_NM")%><% } %></td>																
							</tr>
			         	<%      } %>
			      	  		<tr>
		...
		<%  if(vt_size > 0)	{  %>
						...
						for(int i = 0 ; i < vt_size ; i++)
						{
							Hashtable ht = (Hashtable)vt.elementAt(i);		%>				
							 ...
							 <%	}%>
								...
								<td  width='120' class='center content_border '><%=ht.get("RENT_L_CD")%></td>	
								...
								<td  width='90' class='center content_border'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("TOT_DT")))%></td>		
								<td  width='60' class='center content_border'><%=ht.get("JG_CODE")%></td>	
				...
				<%} else  {%>  
				        	<tr>
						        <td  colspan="36" class='center content_border'>&nbsp;</td>
						   </tr>	              
			    <%}	%>
		            </table>
		         </div>
