...
<%
	...
	String car_st = request.getParameter("car_st")==null?"":request.getParameter("car_st");  //popup 요청한 페이지
...
function view_badcust()
{
	...
	function save()
	{
			...
			if ( fm.client_st.value == '1' || fm.client_st.value == '6' ) {		//법인
				...
				if ( fm.firm_type.value == '6' || fm.firm_type.value == '7' || fm.firm_type.value == '8' || fm.firm_type.value == '9' || fm.firm_type.value == '10' || fm.firm_type.value == '11' ) {	//국가,지방자치,정부투자기관,정부연구기관,비영리
					...
					if(fm.ssn1[0].value == '')				{	alert('법인번호를 입력하십시오');		return;	}
					if(fm.ssn2[0].value == '')				{	alert('법인번호를 입력하십시오');		return;	}						
					if((!isNum(fm.ssn1[0].value)) || (!isNum(fm.ssn2[0].value)) || ((fm.ssn1[0].value.length != 6)&&(fm.ssn1[0].value.length != 0)))	{	alert('법인번호를 확인하십시오');	return;	} 
				}
			...
			if(fm.dly_yn.value == ''){
				alert('연체이자 청구여부를 입력하십시오.'); return;
			}	
	...
	function go_to_list()
	{
		...
		location='/fms2/client/client_s_frame.jsp?auth_rw='+auth_rw+'&s_kd='+s_kd+'&t_wd='+t_wd+'&asc='+asc+'&from_page='+from_page;
	}	
...
<body>
<form name='form1' method='post' action='/fms2/client/client_i_a.jsp'>
	...
	<tr>
	    <td class='line'>
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    <td class='title' width='15%'><b>고객구분</b></td>
                    <td>&nbsp;
    		    ...
    		    <tr>
    			    <td class=line>
    			        <table border="0" cellspacing="1" cellpadding="0" width=100%>
            		        ...
            		        <tr>
            		            <td width='5%' rowspan="5" class='title'>사<br>
                					업<br>
                					자<br>
                					등<br>
                					록<br>
            		            ...
            		            <td class='title' width=15%><b>대표자</b></td>
            		            <td width="35%">&nbsp;
            		        ...
            		        <tr>
            					...
            					-
            					<input type='text' name='ssn2' maxlength='7' size='7' class='text' value='' OnBlur="Biz_ck();><!--OnBlur="Biz_ck(); -->
            					</td>
            		        </tr>
							...
							<tr>
							  ...
							  <td colspan=3>&nbsp;
								...
								&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr" size="60" OnBlur="checkSpecial();" readonly>
							...
							<tr>
							  ...
							  <td colspan=3>&nbsp;<input type='checkbox' name='c_ho' onClick='javascript:set_o_addr()'>
            			              상동
								<input type="text" name='t_zip' id="t_zip1" size="7" maxlength='7' readonly>
								<input type="button" onclick="openDaumPostcode1()" value="우편번호 찾기"><br>
								&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr1" size="100" OnBlur="checkSpecial();">
							  </td>
							</tr>
							...
							<tr>
							  ...
							  <td colspan=3>&nbsp;
								<input type="text" name='t_zip' id="t_zip2" size="7" maxlength='7' readonly>
								<input type="button" onclick="openDaumPostcode2()" value="우편번호 찾기"><br>
								&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr2" size="100" OnBlur="checkSpecial();">
							  </td>
							</tr>
    			    ...
    			    <td class=line>
    			        <table border="0" cellspacing="1" cellpadding="0" width=100%>
							...
							<tr>
							  ...
							  <td colspan=3>&nbsp;
								<input type="text" name='t_zip' id="t_zip3" size="7" maxlength='7' readonly>
								<input type="button" onclick="openDaumPostcode3()" value="우편번호 찾기"><br>
								&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr3" size="60" readonly>
								&nbsp;상세주소 : <input type="text" name='t_addr_sub' size="40" >
							  </td>
							</tr>
							...
							<tr>		
							  <td class=title>주소</td>
							  <td colspan=3>&nbsp;
								<input type="text" name='t_zip' id="t_zip4" size="7" maxlength='7' readonly>
								<input type="button" onclick="openDaumPostcode4()" value="우편번호 찾기"><br>
								&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr4" size="100">
							  </td>
    			...
    			<tr>
    			    <td class=line>
    			        <table border="0" cellspacing="1" cellpadding="0" width=100%>
							...
							<tr>
							  <td class=title colspan="2">자택주소</td>
							  <td colspan=3>&nbsp;
								<input type="text" name='t_zip' id="t_zip5" size="7" maxlength='7' readonly>
								<input type="button" onclick="openDaumPostcode5()" value="우편번호 찾기"><br>
								&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr5" size="60" readonly>
								&nbsp;상세주소 : <input type="text" name='t_addr_sub' size="40" >
							  </td>
							</tr>
            		        ...
            		        <tr>
            		            <td width="5%" rowspan="6" class='title'>소<br>
                		            득<br>정<br>
                		            보</td>
            		            ...
            		            <td width="15%" class='title'>소득구분</td>
            		            <td width="35%">&nbsp; <select name='pay_st'>
                		            <option value="">선택</option>
            		        ...
            		        <tr>
            		            ...
            		            <td>&nbsp;
            		                <input type='text' size='30' name='o_tel' maxlength='20' class='text'></td>
							...
							<tr>
							  ...
							  <td colspan=3>&nbsp;
								<input type="text" name='t_zip' id="t_zip6" size="7" maxlength='7' readonly>
								<input type="button" onclick="openDaumPostcode6()" value="우편번호 찾기"><br>
								&nbsp;&nbsp;<input type="text" name='t_addr' id="t_addr6" size="100">
							  </td>
							</tr>
	...
	<tr>
	    <td class=line>
	        <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
                    <td width="15%" class='title'> 거래명세서메일<br>수신 여부 </td>
                    <td width="35%">&nbsp;
                    ...
                    <td width="15%" class='title'> 세금계산서메일<br>수신 여부 </td>
                    <td width="35%">&nbsp;
                ...
                <tr>
                    ...
                    <td>&nbsp;
                        <select name='print_st' onClick='javascript:set_print();'>
                            <%if(car_st.equals("4")){%>
                            <option value='1' selected>계약건별</option>
                            <%}else{%>
                            <option value=''>선택</option>
                ...
                <tr>	    
                    <td class='title'> 면책금 CMS<br>청구 여부 </td>
                    <td>&nbsp;
                        <select name='etc_cms'>
                        ...
                        &nbsp;&nbsp;* CMS 거래고객에 한함.
                    <td class='title'> 선납과태료<br>청구 여부 </td>
                    <td>&nbsp;
                        <select name='fine_yn'>
                          <option value='' selected>--선택--</option>
                          <option value='Y'>승락</option>
                  ...
                  <tr>	   
                    <td class='title'> 연체이자 CMS<br>청구 여부 </td>
                    <td>&nbsp;
                        <select name='dly_yn'>
                          <option value='' selected>--선택--</option>
                          <option value='Y'>승락</option>
