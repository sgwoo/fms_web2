    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 거래처 관리 > <span class=style5>지점/현장 <%if(site_id.equals("")){%>등록<%}else{%>수정<%}%></span></span> : 지점/현장 <%if(site_id.equals("")){%>등록<%}else{%>수정<%}%></td>
