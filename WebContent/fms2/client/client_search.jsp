...
<input type='hidden' name='from_page' value='/fms2/client/client_search.jsp'>
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
	  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_scontent.gif align=absmiddle>&nbsp;
	    ...
	    <a href="javascript:Search()"><img src=/acar/images/center/button_search.gif border=0 align=absmiddle></a> (상호,계약자,담당자,관계자,통화자)</td>
	</tr>
	<tr>
	  <td>&nbsp;&nbsp;</td>
    </tr>
