...
<table border=0 cellspacing=0 cellpadding=0 width='700'>
  <tr>
    <td><font color="navy">영업지원  -> </font><font color="navy">거래처 관리</font>-> <font color="red">거래처 자산 등록 </font></td>
  </tr>
  <tr>
    <td class='line'>             
    	  <table border="0" cellspacing="1" cellpadding="0" width=700>
				...
				<tr>
		          ...
		          <tr>
		            ...
		            <td align="center">&nbsp;
		                <input type='text' name='c_ass1_type' size='13' maxlength='20' class='text'>
		            </td>
		            <td>&nbsp;
		      	        <input type="text" name='t_zip' id="t_zip" size="7" maxlength='7'>
						<input type="button" onclick="openDaumPostcode()" value="우편번호 찾기"><br>
		            ...
		            <td align="center">&nbsp;
		                <input type='text' name='c_ass2_type' size='13' maxlength='20' class='text' >
		            </td>
					<script>
		            ...
		            <td>&nbsp;
						...
						&nbsp;&nbsp;<input type="text" name='t_addr1' id="t_addr" size="100">
		            </td>
		          </tr>
		          ...
		          <tr>
		            ...
		            <td align="center">&nbsp;
		                <input type='text' name='r_ass1_type' size='13' maxlength='20' class='text' >
		            </td>
		            <script>
		            ...
		            <td>&nbsp;
						...
						&nbsp;&nbsp;<input type="text" name='t_addr2' id="t_addr" size="100">
		            </td>
		            <td align="center">&nbsp;
		                <input type='text' name='r_ass2_type' size='13' maxlength='20' class='text' >
		            </td>
		            <script>
		            ...
		            <td>&nbsp;
						...
						&nbsp;&nbsp;<input type="text" name='t_addr3' id="t_addr" size="100">
		            </td>
		          </tr>
		        </table>
	</td>
