...
<%
	...
	Vector vt = ac_db.Year_jungsan_List(dt, gubun1, gubun2);
	int vt_size = vt.size();
...
<!--
	...
	function yend_dt(c_yy, sa_no){
		...
		fm.c_yy.value = c_yy;
		fm.sa_no.value = sa_no;
		fm.cmd.value = '';
		if(confirm('완료처리 하시겠습니까?')){	
			fm.action="year_end_dt_a.jsp";
			fm.target='i_no';
			fm.submit();
		}
	}
...
<input type="hidden" name="form" value="/fms2/year_jungsan/year_jungsan_sc_in.jsp">
...
<input type='hidden' name='c_yy' value=''> 
