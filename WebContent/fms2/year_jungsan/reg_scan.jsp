...
<!--
	...
	function remove2(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.YEAR_JUNGSAN%>";
		fm.submit();
	}
//-->
</script>
...
<form name='form1' action='' method='post' enctype="multipart/form-data">
	...
	<input type='hidden' name="c_yy" 	value="<%=c_yy%>">
	<input type='hidden' name="sa_no" 	value="<%=sa_no%>">
        ...
        <td align="right" class="line">
		    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr>
					...
					<input type='hidden' name="<%=Webconst.Common.contentSeqName %>" size='' class='text' value='<%=c_yy%><%=sa_no%><%=idx%>' />
					<input type="hidden" name="<%=Webconst.Common.contentCodeName %>" value='<%=UploadInfoEnum.YEAR_JUNGSAN%>' />
                    </td>
                </tr>
            </table>
        </td>
