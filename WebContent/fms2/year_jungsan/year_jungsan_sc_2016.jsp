...
<!--
	function jungsan_reg()	{
		var SUBWIN="./year_scan_i.jsp?s_year=2016&ck_acar_id=<%=ck_acar_id%>&s_width=<%=s_width%>&s_height=<%=s_height%>&gubun1=<%=gubun1%>&gubun2=<%=gubun2%>";	
    ...
    <tr>
		<td>
            <table border="0" cellspacing="0" cellpadding="0" width=100%>
                <tr>
                    <td>
                        <iframe src="year_jungsan_sc_in_2016.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 ></iframe>
					</td>
				</tr>
			</table>
		</td>
