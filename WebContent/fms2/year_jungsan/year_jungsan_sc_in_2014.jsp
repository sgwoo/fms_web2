...
<%
	...
	Vector vt = ac_db.Year_jungsan_List("2014");
	int vt_size = vt.size();
...
//	    document.all.td_con.style.pixelLeft	= document.body.scrollLeft ;   	    
	...
	function yend_dt(c_yy, sa_no){
		...
		if(confirm('완료처리 하시겠습니까? 완료처리후 수정하실 수 없습니다.')){	
...
<input type="hidden" name="form" value="/fms2/year_jungsan/yaer_jungsan_sc_in_2014.jsp">
	...
	<tr id='tr_title' style='position:relative;z-index:1'> 
		<td class='line' width='100%' id='td_title' style='position:relative;'>
			...
			<tbody>
				...
				<tr>
				  <td width="7%" colspan="1" rowspan="2" align="center" class="title">국세청(PDF)파일</td>
...
%>             	
				<tr>
					...
					<td width='10%' align="center"><%if(ht.get("END_DT").equals("")){%><a href="javascript:yend_dt('<%=ht.get("C_YY")%>','<%=ht.get("SA_NO")%>')"><img src=/acar/images/center/button_in_dec.gif border=0 align=absmiddle></a><%}else{%><%=AddUtil.ChangeDate2((String)ht.get("END_DT"))%><%}%></td>
            		<td width='9%' align="center"><%=dept_nm%></td>
					<td width='7%' align="center"><%=ht.get("SA_NO")%></td>
					<td width='7%' align="center"><%=user_nm%></td>
					<td width='7%' align="center">
					<%if(user_id.equals(ht.get("REG_ID"))||user_id.equals("000004")||user_id.equals("000096")){%>
        			...
        			</a><%}%><%}%><%if(ht.get("FILE3_YN").equals("Y")){%>없음<%}%>
					</td>
					<td width='7%' align="center">
        			...
        			</a><%}%><%}%><%if(ht.get("FILE4_YN").equals("Y")){%>없음<%}%>
					</td>
					<td width='7%' align="center">
        			...
        			</a><%}%><%}%><%if(ht.get("FILE5_YN").equals("Y")){%>없음<%}%>
					</td>
					<td width='7%' align="center">
        			...
        			</a><%}%><%}%><%if(ht.get("FILE6_YN").equals("Y")){%>없음<%}%>
					</td>
					<td width='7%' align="center">
        			...
        			</a><%}%><%}%><%if(ht.get("FILE7_YN").equals("Y")){%>없음<%}%>
					</td>
					<td width='7%' align="center">
        			...
        			</a><%}%><%}%><%if(ht.get("FILE8_YN").equals("Y")){%>없음<%}%>
