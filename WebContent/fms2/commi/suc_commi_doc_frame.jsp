...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getXmlAuthRw(user_id, "11", "01", "17");
...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="./suc_commi_doc_sh.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="./suc_commi_doc_sc.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='no' noresize>
</frameset>
</HTML>