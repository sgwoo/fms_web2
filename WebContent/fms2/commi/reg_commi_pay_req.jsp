...
<%@ page import="acar.cont.*,acar.client.*, acar.car_mst.*, acar.car_register.*, acar.car_office.*, acar.user_mng.*, acar.car_office.*"%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  <td align='center'>
	      ...
	      <input type="button" name="b_selete" value="등록" onClick="javascript:update();">&nbsp;
	      <%}%>
	      <input type="button" name="b_selete" value="닫기" onClick="javascript:window.close();">	      
	      </td>
	</tr>	
  </table>
</form>
