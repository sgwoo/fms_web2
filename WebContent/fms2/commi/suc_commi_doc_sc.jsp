...
<!--
	...
	function commi_action(mode, rent_mng_id, rent_l_cd, doc_no){
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/commi/suc_commi_doc_frame.jsp'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="suc_commi_doc_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
    ...
    <tr>
	    <td>※ 승계업무수당지급요청 미결리스트에 안나오는 계약은 승계수수료감면사유가 에이전트승계수당과 상계가 아니고, 대여료스케줄이관이 완료되고, 승계수수료가 입금완료이고, 영업대리인이 없어야 합니다.</td>
	</tr>			
</table>
</form>
</body>
