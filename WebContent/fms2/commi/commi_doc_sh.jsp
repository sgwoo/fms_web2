...
%>
<form name='form1' action='/fms2/commi/commi_doc_sc.jsp' target='c_foot' method='post'>
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 계출관리 > <span class=style5>영업사원수당지급요청</span></span></td>
                ...
                <tr>
                    ...
                    <td width=40%>&nbsp;
            		    <select name='s_kd'>
                          ...
                          <option value='5' <%if(s_kd.equals("5")){%>selected<%}%>>영업사원</option>
						  <option value='6' <%if(s_kd.equals("6")){%>selected<%}%>>실수령인</option>
						  <option value='7' <%if(s_kd.equals("7")){%>selected<%}%>>기안일자</option>
						  <option value='8' <%if(s_kd.equals("8")){%>selected<%}%>>완료일자</option>						  
                        </select>
        			    &nbsp;&nbsp;&nbsp;
