...
<%
	...
	if(doc_bit.equals("8")){
		...
		sub 	= "지급수수료 결재 완결";
		cont 	= "기안자["+user_bean.getUser_nm()+" : "+firm_nm+" ] - 지급수수료 지출을 결재 완결하니 출금 집행하세요";
		url 	= "/fms2/lc_rent/commi_pay_s_frame.jsp";
		m_url = "/fms2/lc_rent/commi_pay_s_frame.jsp";
	}
	...
	//if(doc_bit.equals("7") && !user_bean.getBr_nm().equals("본사")){
	//}else{
		flag2 = cm_db.insertCoolMsg(msg);
		System.out.println("쿨메신저(영업수당결재)"+firm_nm+":"+sender_bean.getUser_nm()+"----------------------->"+target_bean.getUser_nm());
	//}
