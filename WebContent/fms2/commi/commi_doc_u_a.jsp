...
<%
	if(mode.equals("guar")){
		...
		if(nm_db.getWorkAuthUser("영업수당변경",user_id)){
		...
		if(!agent_doc_st.equals("2")){
			...
			if(coe_bean.getEmp_nm().equals(emp1.getEmp_acc_nm())){
		
				if(!coe_bean.getEmp_email().equals(emp_email)) result = cod.updateCarOffEmpMail(emp1.getEmp_id(), emp_email);
				if(!coe_bean.getEmp_m_tel().equals(emp_m_tel)) result = cod.updateCarOffEmp(emp1.getEmp_id(), emp_m_tel);
								
				//if(!coe_bean.getFile_name1().equals("") && emp1.getFile_name1().equals("")) 	emp1.setFile_name1(coe_bean.getFile_name1());
				//if(!coe_bean.getFile_name2().equals("") && emp1.getFile_name2().equals("")) 	emp1.setFile_name2(coe_bean.getFile_name2());
				//if(coe_bean.getFile_name1().equals("") && !emp1.getFile_name1().equals("")) 	result = cod.updateCarOffEmp(emp1.getEmp_id(), "1", emp1.getFile_name1(), emp1.getFile_gubun1());
				//if(coe_bean.getFile_name2().equals("") && !emp1.getFile_name2().equals("")) 	result = cod.updateCarOffEmp(emp1.getEmp_id(), "2", emp1.getFile_name2(), emp1.getFile_gubun1());
				if(coe_bean.getEmp_ssn1().equals("") && !emp1.getRec_ssn().equals("")) 		result = cod.updateCarOffEmp(emp1.getEmp_id(), "3", emp1.getRec_ssn(), "");
				if(coe_bean.getEmp_addr().equals("") && !emp1.getRec_addr().equals("")) 	result = cod.updateCarOffEmp(emp1.getEmp_id(), "4", emp1.getRec_zip(), emp1.getRec_addr());
				if(coe_bean.getCust_st().equals("") && !emp1.getRec_incom_st().equals("")) 	result = cod.updateCarOffEmp(emp1.getEmp_id(), "5", emp1.getRec_incom_st(), "");
		...
		//출고보전수당이 새로 생겼다면 영업팀장님 결재가 추가되어야 한다.		
