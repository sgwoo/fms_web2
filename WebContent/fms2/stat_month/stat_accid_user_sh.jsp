    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>현황 및 통계 > 사고 및 보험 > <span class=style5>사원별피해차량현황</span></span></td>
                ...
                <tr> 
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gjij.gif align=absmiddle>
						...
						<select name="s_mode">
							...
							<option value="3" <%if(s_mode.equals("3")){%>selected<%}%>>쌍방</option>
							<option value="8" <%if(s_mode.equals("8")){%>selected<%}%>>단독</option>
							<option value="1" <%if(s_mode.equals("1")){%>selected<%}%>>피해</option>
						</select>
