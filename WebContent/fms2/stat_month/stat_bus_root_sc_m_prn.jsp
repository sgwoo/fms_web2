...
response.setHeader("Content-Disposition", "inline; filename=stat_bus_root_sc_m_prn.xls");
%>
<%@ page language="java" %> 
...
<%
	...
	int cnt3[]	 = new int[mons+1];
	int cnt4[]	 = new int[mons+1];
	int cnt5[]	 = new int[mons+1];
	int cnt6[]	 = new int[mons+1];	
	
	
	int h_cnt[]	= new int[mons+1];
	int h_cnt1[] 	= new int[mons+1];
	int h_cnt2[] 	= new int[mons+1];
	int h_cnt3[]	= new int[mons+1];
	int t_cnt[]	= new int[mons+1];
	int tt_cnt[]	= new int[mons+1];
...
<table border=0 cellspacing=0 cellpadding=0 width=<%=50+40+110+60+(60*mons)%>>
    <tr>
      <td>2. 월별 계약현황</td>
    </tr>					
    <tr> 
