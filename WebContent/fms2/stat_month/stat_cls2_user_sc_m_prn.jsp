...
response.setHeader("Content-Disposition", "inline; filename=stat_cls2_user_sc_m_prn.xls");
%>
...
<table border=0 cellspacing=0 cellpadding=0 width=<%=50+40+110+60+(60*mons*3)%>>
    <tr>
      <td>1. 월별 현황 (대여종료대수 = 만기반납+만기매입옵션+중도반납+중도매입옵션 (폐차대여종료도 포함됨), 매입옵션=만기매입옵션+중도매입옵션)</td>
    </tr>
    <tr>
        <td> 
