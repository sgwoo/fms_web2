...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "09", "04", "03");
...
<!--
	...
	function Search(){
		...
		if(fm.gubun.value == '5')		i_fm.action='stat_cls_in_view.jsp';		
		if(fm.gubun.value == '6')		i_fm.action='stat_cls_in_view1.jsp';																				
		i_fm.submit();				
	}
...
<table border=0 cellspacing=0 cellpadding=0 width="100%">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > <span class=style5>사원별 대여해지 대차계약현황</span></span></td>
    ...
    <tr> 
      <td>
	   ...
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_hji.gif align=absmiddle>
       &nbsp;<input type="text" name="s_yy" size="11" value="<%=AddUtil.ChangeDate2(s_yy)%>" class=text onBlur='javascript:this.value=ChangeDate(this.value)'>
        ...
        &nbsp; &nbsp;&nbsp;			
		 <input type="radio" name="bm" value="1" <%if(bm.equals("1"))%>checked<%%>>최초영업자
		  &nbsp;&nbsp;
		 <input type="radio" name="bm" value="2" <%if(bm.equals("2"))%>checked<%%>>관리담당자
		  &nbsp; &nbsp;&nbsp;   	
    ...
    <tr> 
      <td><iframe src="./stat_cls_in_view1.jsp?bm=<%=bm%>&auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&s_yy=<%=s_yy%>&s_mm=<%=s_mm%>&brch_id=<%=brch_id%>" name="i_view" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
      </td>
    </tr>
  </table>
</form>
