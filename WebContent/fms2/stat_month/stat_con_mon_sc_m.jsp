...
<%
	...
	int cnt7[]	 		= new int[mons+1];	
	int cnt8[]	 		= new int[mons+1];	
	...
	int t_cnt6[]	 		= new int[mons+1];
	int t_cnt7[]	 		= new int[mons+1];	
	int t_cnt8[]	 		= new int[mons+1];	
	
	int th_cnt[]	 		= new int[mons+1];
...
<table border=0 cellspacing=0 cellpadding=0 width=<%=50+80+100+(100*mons)%> style="padding-right: 30px;">
    <tr>
      <td>2. 월별 계약현황</td>
    </tr>					
    <tr> 
        <td class=line> 
            <table width=100% border="0" cellspacing="1" cellpadding="0">
                <tr align="center"> 
                    ...
                    <td colspan='2' class=title><%=j+1%>월</td>
					<%}%>
                </tr>
                <tr align="center"> 
