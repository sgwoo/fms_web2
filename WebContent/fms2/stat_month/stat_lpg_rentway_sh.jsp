...
<!--
	...
	function Search()
	{
		...
		fm.target = "c_foot";		
		fm.action = 'stat_lpg_rentway_sc_d.jsp';
		
		if(fm.s_yy.value == '' && fm.s_mm.value == '') fm.action = 'stat_lpg_rentway_sc_y.jsp';
		if(fm.s_yy.value != '' && fm.s_mm.value == '') fm.action = 'stat_lpg_rentway_sc_m.jsp';		
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>경영정보 > 영업현황 > <span class=style5>LPG차량일반식현황</span></span></td>
