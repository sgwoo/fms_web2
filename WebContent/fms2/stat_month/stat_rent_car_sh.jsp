...
<!--
	...
	function Search()
	{
		...
		fm.target = "c_foot";		
		fm.action = 'stat_rent_car_sc_d.jsp';
		
		if(fm.s_yy.value == '' && fm.s_mm.value == '') fm.action = 'stat_rent_car_sc_y.jsp';
		if(fm.s_yy.value != '' && fm.s_mm.value == '') fm.action = 'stat_rent_car_sc_m.jsp';		
	...
	function save()
	{
		...
		fm.action = 'stat_rent_car_sc_d_prn.jsp';
		
		if(fm.s_yy.value == '' && fm.s_mm.value == '') fm.action = 'stat_rent_car_sc_y_prn.jsp';
		
		if(fm.s_yy.value != '' && fm.s_mm.value == '') fm.action = 'stat_rent_car_sc_m_prn.jsp';		
