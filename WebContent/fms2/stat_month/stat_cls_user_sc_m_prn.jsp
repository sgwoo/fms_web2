...
response.setHeader("Content-Disposition", "inline; filename=stat_cls_user_sc_m_prn.xls");
%>
...
<%
	...
	Vector vt = sb_db.getStatClsUserList(s_mode, s_yy, s_mm, days, f_year);
	int vt_size = vt.size();
...
<table border=0 cellspacing=0 cellpadding=0 width=<%=50+40+110+60+(60*mons*3)%>>
    <tr>
      <td>1. 월별 현황</td>
    </tr>
    <tr>
        <td> 
            <table width=100% border="1" cellspacing="1" cellpadding="0">
                ...
                <tr align="center">                     
                    ...
                    <td width=60 class=title>평균<br>관리대수</td>
                    <td width=60 class=title>행사건수</td>
                    <td width=60 class=title>행사비율</td>
                    <%}%>
                </tr>
                <%	int count1 = 0;
                		int count2 = 0;
