							...
							<colgroup>		       		
							  ...
							  <col  width='90'>
				       		...
				       		<tr>
							    ...
							    <td  rowspan=2 class='title title_border'  width="90">취득가액<br>(취득일,<br>임차기간)</td>
							    <td  rowspan=2 class='title title_border'  width="60">해당연도<br>보유또는<br>임차월수</td>	
	...
	<div class="tb_box">
		<table class="tb" >
			...
			%>   
			    	...
			    	<%      } %>
			         	  	<tr>              
			        			<td class="center title content_border" colspan=7 style='height:50'>합계</td>                    
			                </tr>			
			    <%} else  {%>  
				           	<tr>
				 ...
				 <%}	%>
				   ...
				   %>
				    		 <tr>    
				                <td rowspan="2" width='60' class ='right content_border'  >
				  <%          
				            //2018년부터는 실사용개월수로 계산 
				            
				                cal_start = String.valueOf(ht.get("RENT_START_DT"));
								   cal_end = String.valueOf(ht.get("RENT_END_DT"));	
								   		   
								   if ( !cal_start.substring(0,4).equals(st_year)  )  {
								       cal_start= st_year  + "0101";
								   } 
								   
								    if ( !cal_end.substring(0,4).equals(st_year)  )  {
								       cal_end= st_year  + "1231";				 	   
								   }        	
						   
						         cnt_mon =  Integer.toString( Integer.parseInt(cal_end.substring(0,6)) -   Integer.parseInt(cal_start.substring(0,6))  + 1 );
						              				 
							     //1년이상 사용은 비용인정한도금액 10000000 
							     
							      if ( cnt_mon.equals("12")  )  {
							          cost_amt = 15000000;
							          asset_amt = 8000000;
							      }  else {
							          cost_amt = 15000000 *Integer.parseInt(cnt_mon) / 12 ;
							          asset_amt = 8000000 *Integer.parseInt(cnt_mon) / 12 ;
							      }  				   				   
				...
				%>			
					   		    ...
					   		    <td rowspan="2" width='90' class='center content_border' ><%=cal_start%>~<br><%=cal_end%></td>
						        <td rowspan="2" width='60' class='center content_border' ><%=cnt_mon%></td>
