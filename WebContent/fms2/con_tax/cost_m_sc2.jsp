		...
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
			 <tr>
		 	 ...
		 	 <tr>
					<td  colspan=2>
						 <iframe src="cost_m_sc2_in.jsp?sh_height=<%=sh_height%>&height=<%=height%>&auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun1=<%=gubun1%>&st_year=<%=st_year%>" name="ii_no" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
			 </tr>
			</table>
