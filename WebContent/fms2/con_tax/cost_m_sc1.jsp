...
<!-- 2017년 이전 업무용 승용차 명세서 - 사용월이 적용안된 양식 --> 
<html>
	...
	<tr>
		<td>
			...
			<!--		 <a href='javascript:reg()'><img src=/acar/images/center/button_reg.gif border=0 align=absmiddle></a> -->
		 	 ...
		 	 <tr>
					<td  colspan=2>
						 <iframe src="cost_m_sc1_in.jsp?sh_height=<%=sh_height%>&height=<%=height%>&auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun1=<%=gubun1%>&st_year=<%=st_year%>" name="i_no" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
			 </tr>
			</table>
