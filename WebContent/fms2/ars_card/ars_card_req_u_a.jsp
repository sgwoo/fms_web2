...
<%
	...
	String moid	 		= request.getParameter("moid")==null?"":request.getParameter("moid");
	...
	//완료처리
		...
		flag1 = ar_db.updateArsCardApp(ars_code, ck_acar_id);
	...
	//결재완료후 취소처리
	}else if(cng_item.equals("cancel")){
			
		flag1 = ar_db.updateArsCardCancel(ars_code);
