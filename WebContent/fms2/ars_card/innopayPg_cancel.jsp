		...
		<form id="frm" name="frm">
			<table id="payTable">
				...
				<tr>
					<td>거래 아이디</td>
					<td>
						<input name="tid" value="" readonly style="background-color: rgb(235, 235, 228);"> <!-- 필수: 거래고유번호 -->
					</td>
				</tr>
				<tr>
					<td>서비스구분</td>
					<td>
						<input name="svcCd" value="01" readonly style="background-color: rgb(235, 235, 228);"> <!-- 필수: 01 고정 -->
					</td>
				</tr>
				<tr>
					<td>취소금액</td>
					<td>
						<input name="cancelAmt" value="<%=AddUtil.parseDecimal(ars.getGood_mny())%>"> <!-- 필수: 취소금액(숫자) -->
					</td>
				</tr>
				<tr>
					<td>취소사유</td>
				...
				<tr>
					<td>취소비밀번호</td>
					<td>
						<input name="cancelPwd" value="123456" readonly style="background-color: rgb(235, 235, 228);"> --><!-- 필수: 취소비밀번호 -->
					<!--</td>
				</tr>
				 -->
			</table>
