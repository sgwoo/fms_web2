...
<form name='form1' action='/fms2/service/serv_c2_sc.jsp' target='c_foot' method='post'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 정비관리 > <span class=style5>담당자미확인현황</span></span></td>
        ...
        <td class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td width=40%>&nbsp;
					  <!--<input type='text' name='gubun1' size='25' class='whitetext' value='<%=gubun1%>' style='IME-MODE: active'>-->					  
        		      <select name='gubun1'>        			    
        		      <option value='' <%if(gubun1.equals("")){%>selected<%}%>>전체</option>        			    
                        <option value='스피드메이트' <%if(gubun1.equals("스피드메이트")){%>selected<%}%>>스피드메이트</option>        			    
                        <option value='애니카' <%if(gubun1.equals("애니카")){%>selected<%}%>>애니카</option>			          			    
                      </select>
                	</td>
                </tr>	
                <tr>
