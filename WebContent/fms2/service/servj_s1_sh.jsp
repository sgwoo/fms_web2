...
<table border="0" cellspacing="0" cellpadding="0" width=800>
    ...
    <tr>
        <td class=line>
		  ...
		  <select name="off_id"  >
					<option value="000620"  <%if(off_id.equals("000620")){%>selected<%}%>>MJ모터스</option>
					<option value="009290"  <%if(off_id.equals("009290")){%>selected<%}%>> 우리자동차</option>
					<option value="006858"  <%if(off_id.equals("006858")){%>selected<%}%>>오토크린</option>
					<option value="000286"  <%if(off_id.equals("000286")){%>selected<%}%>>정일공업사</option>
					<option value="002105"  <%if(off_id.equals("002105")){%>selected<%}%>>부경공업사</option>
					<option value="002734"  <%if(off_id.equals("002734")){%>selected<%}%>>현대카독크</option>
					<option value="007603"  <%if(off_id.equals("007603")){%>selected<%}%>>노블레스</option>
					<option value="001816"  <%if(off_id.equals("001816")){%>selected<%}%>> 삼일정비</option>
					<option value="007897"  <%if(off_id.equals("007897")){%>selected<%}%>> 1급금호자동차</option>
					<option value="008462"  <%if(off_id.equals("008462")){%>selected<%}%>> 성서현대(대구)</option>
					<option value="008507"  <%if(off_id.equals("008507")){%>selected<%}%>> 상무현대(광주)</option>
					<option value="006490"  <%if(off_id.equals("006490")){%>selected<%}%>> 상무1급(광주)</option>
					<option value="010424"  <%if(off_id.equals("010424")){%>selected<%}%>> 강서현대</option>
