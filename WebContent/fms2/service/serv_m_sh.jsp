...
<form name='form1' action='/fms2/service/serv_m_sc.jsp' target='c_foot' method='post'>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0 >
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 정비관리 > <span class=style5>정비현황</span></span></td>
                ...
                <tr>
                    ...
                    <td>&nbsp;
                	  <select name='s_kd'>
                        ...
                        <option value='13' <%if(s_kd.equals("13")){%>selected<%}%>>사업자번호</option>                   
                        <option value='7' <%if(s_kd.equals("7")){%>selected<%}%>>스피드메이트</option> 
					<!--  	<option value='9' <%if(s_kd.equals("9")){%>selected<%}%>>애니카랜드</option> -->
                        <option value='8' <%if(s_kd.equals("8")){%>selected<%}%>>두께비카센타</option> 
						<option value='10' <%if(s_kd.equals("10")){%>selected<%}%>>타이어휠타운</option> 
						<option value='11' <%if(s_kd.equals("11")){%>selected<%}%>>본동자동차</option> 			
						<option value='14' <%if(s_kd.equals("14")){%>selected<%}%>>영남제일자동차</option> 				
						<option value='15' <%if(s_kd.equals("15")){%>selected<%}%>>바로차유리</option> 							
                      </select>
                	  &nbsp;&nbsp;&nbsp;
    ...
    <tr align="right">
        ...
        &nbsp;      
        <a href="javascript:var win=window.open('excel.jsp?user_id=<%=user_id%>','popup','left=10, top=10, width=600, height=200, status=no, scrollbars=no, resizable=yes');"><img src=/acar/images/center/button_excel_dr.gif align=absmiddle border=0></a>
