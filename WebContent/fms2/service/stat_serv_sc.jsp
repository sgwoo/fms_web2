...
<!--
	...
	function Search(){
		...
		i_fm.target='i_view';	
		i_fm.action='stat_serv_sc_in_view.jsp';								
...
<table border=0 cellspacing=0 cellpadding=0 width="100%">
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>협력업체 > 정비관리 > <span class=style5>사원별 정비거래현황</span></span></td>
    ...
    <tr> 
        <td>
    	   ...
    	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_day_jb.gif align=absmiddle>
    ...
    <tr> 
      <td><iframe src="./stat_serv_sc_in_view.jsp?auth_rw=<%=auth_rw%>&user_id=<%=user_id%>&br_id=<%=br_id%>&gubun=<%=gubun%>&s_yy=<%=s_yy%>&s_mm=<%=s_mm%>&brch_id=<%=brch_id%>" name="i_view" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe> 
      </td>
    </tr>
  </table>
</form>
