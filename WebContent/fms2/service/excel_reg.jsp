...
<%
	...
	try {
		fi = new FileInputStream(new File(path+""+filename+".xls"));
...
//	System.out.println("정비 excel 69 스피드메이트 등록 : user_id=" + user_id);  순번	일     자	차    량    번    호	차 량 명	비          고	금액	결제예정일
...
<!--
	...
	function save(){
		...
		fm.action = 'excel_item_2010_s.jsp';
		fm.submit();
	}
//-->
</SCRIPT>
    ...
    <td class="line">
	  <table border="0" cellspacing="1" cellpadding="0">
        <tr>
          ...
          <td width="120" class="title">순번</td>
          <td width="120" class="title">정비일</td>
		  ...
		  <td width="120" class="title">금액</td>
      	  <td width="120" class="title">결제일</td>
        </tr>
      </table></td>
  </tr>  
  <tr>
