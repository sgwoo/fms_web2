...
<%
	...
	Vector vt = cr_db.getServConfList("4", s_kd, t_wd, gubun1, gubun2, gubun3, gubun4, gubun5, st_dt, end_dt, sort);
	int vt_size = vt.size();
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/service/serv_c4_frame.jsp'>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width='1740'>
	...
	<tr id='tr_title' style='position:relative;z-index:1'>
	  <td class='line' width='370' id='td_title' style='position:relative;'>
		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
		  <tr>
        	...
        	<td width='80' class='title'>정비일자</td>
	  ...
	  <td class='line' width='1370'>
		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
		  <tr>
			<td colspan="4" class='title'>문서결재</td>					  
		  ...
		  <tr>
			...
			<td width='80' class='title'>실주행거리</td>	
			<td width='70' class='title'>정비분류</td>	
			<td width='90' class='title'>공임</td>					  
			<td width='90' class='title'>부품</td>					  
...
%>
				<tr>
					...
					<td  width='40' align='center'><input type="checkbox" name="ch_cd" value="<%=ht.get("CAR_MNG_ID")%><%=ht.get("SERV_ID")%>"></td>
