...
<%		if(!dept_id.equals("8888")){%>	
		var SUBWIN="/acar/cus_reg/serv_reg.jsp?car_mng_id=" + car_mng_id + "&serv_id=" + serv_id+"&accid_id="+accid_id+"&from_page=/fms2/service/serv_c2_frame.jsp"; 
<%		}else{%>	
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
  <tr>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="serv_c2_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
	...
	<tr>
	  <td><font color=green>* 스피드메이트/애니카  등록 정비만 조회가능합니다.</font></td>
	</tr>
</table>
</form>
</body>
