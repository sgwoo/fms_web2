...
<!--
	...
	function MM_openBrWindow(theURL,winName,features) {
		...
		//유류대현황 리스트 이동
	function list_move(off_id)
	{
		var fm = document.form1;
		var url = "";
		
					
		url = "/fms2/service/servj_s1_frame.jsp?off_id=" + off_id;
		fm.action = url;		
		fm.target = 'd_content';	
		fm.submit();						
	}
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="servj_s_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
