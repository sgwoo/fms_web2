...
<%
	...
	Vector vt = ln_db.getAlinkEndList(s_kd, t_wd, andor, gubun1, gubun2, gubun3, gubun4, gubun5, st_dt, end_dt);	
	int vt_size = vt.size();
%>
	...
	<td class='line' width='1020'>
		...
		%>
       		<tr>
        	    ...
        	    <td <%=td_color%> width='80' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("REG_DATE")))%></td>
