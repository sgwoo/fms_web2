...
<!--
	...
	//전자문서 전송하기
	function go_edoc(m_id, l_cd, link_table, link_type, link_rent_st, link_im_seq){
		var fm = document.form1;
		fm.rent_mng_id.value 	= m_id;
		fm.rent_l_cd.value 	= l_cd;
		...
		window.open('about:blank', "EDOC_LINK", "left=0, top=0, width=900, height=600, scrollbars=yes, status=yes, resizable=yes");				
		fm.target = "EDOC_LINK";
		fm.action = "/fms2/lc_rent/reg_edoc_link.jsp";
		fm.submit();		
	}		
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/fms2/alink/alink_m_frame.jsp'>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width=100%>
				<tr>
					<td>
						<iframe src="alink_m_sc_in.jsp<%=valus%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
						</iframe>
					</td>
				</tr>
			</table>
