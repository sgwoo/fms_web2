    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 전자계약관리 > <span class=style5>폐기전자계약서</span></span></td>
    ...
    <tr>
	    ...
	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td width="40%">&nbsp;
			<select name='gubun4'>
                            <option value="1" <%if(gubun4.equals("1"))%>selected<%%>>폐기일자</option>
                        </select>			
			&nbsp;	
			<select name='gubun5'>			    
			...
			<input type="text" name="end_dt" size="10" value="<%=end_dt%>" class="text">
        		...
        		<select name='gubun1'>
                            ...
                            <option value='4' <%if(gubun1.equals("4")){%>selected<%}%>>월렌트계약서 </option>	                      				  		            
			    <option value='5' <%if(gubun1.equals("5")){%>selected<%}%>>CMS출금이체신청서 </option>
			    <!--<option value='6' <%if(gubun1.equals("6")){%>selected<%}%>>개인(신용)정보 수집·이용·제공·조회동의서 </option>-->
                        </select>&nbsp;
        	    </td>		  		  		    					                
                </tr>		    
                <tr>		    
