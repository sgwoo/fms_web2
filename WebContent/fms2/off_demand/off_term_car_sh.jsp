...
function Search()
{
	...
	theForm.action='/fms2/off_demand/off_term_car_sc.jsp';
        ...
        <td colspan=6>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>ADMIN > 외부요청자료 > <span class=style5>계약기간별현황</span></span></td>
    ...
    <tr> 
     ...
     <tr>        	
          ...
          %>
        	...
        	<input type="text" name="ref_dt1" size="11" value="<%=sDate.substring(0,4)%>-01-01" class="text" onBlur="javascript:ChangeDT('ref_dt1')">
          ~ 
