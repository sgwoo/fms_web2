...
<jsp:useBean id="olyD" class="acar.offls_actn.Offls_actnDatabase" scope="page"/>
...
<%
	...
	int tg[][]  = olyD.getTg(brch_id);
	
	String dt		= request.getParameter("dt")==null?"4":request.getParameter("dt");
	String ref_dt1 	= request.getParameter("ref_dt1")==null?"2011-01-01":request.getParameter("ref_dt1");
