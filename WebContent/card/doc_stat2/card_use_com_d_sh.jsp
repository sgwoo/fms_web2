...
<!--
	function Search(){
		...
		fm.action="card_use_com_d_sc.jsp";
		fm.target="cd_foot";		
		fm.submit();
	}
	function enter() {
  ...
  <table border=0 cellspacing=0 cellpadding=0 width=100%>
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1>재무회계 > 법인전표관리 > <span class=style5>카드사별현황 - 일간</span></span></td>
    ...
    <tr>
	  ...
	  <%		}
		...
		&nbsp;&nbsp<a href="javascript:Search();"><img src=/acar/images/center/button_search.gif border=0 align=absmiddle></a></td>
      <td align="right">&nbsp;</td>
    </tr>
  </table>
</form>
