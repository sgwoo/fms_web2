...
<FRAMESET rows="<%=sh_height%>, *" border=0>
 	<FRAME SRC="./card_use_com_m_sh.jsp<%=hidden_value%>" name="cd_body" frameborder=0 marginwidth="10" marginheight="10" scrolling="no" noresize>	
	<FRAME SRC="./card_use_com_m_sc.jsp<%=hidden_value%>" name="cd_foot" frameborder=0 marginwidth="10" topmargin=0 scrolling="auto" noresize>	
</FRAMESET>
<NOFRAMES>
<BODY>
