  ...
  <table border="0" cellspacing="0" cellpadding="0" width=1050>
    ...
    <tr>
        <td class="line" >
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr>
                    <td rowspan='3' width='4%' class='title'>연번</td>
                    <td rowspan='3' class='title'>기준일</td>
                    <td colspan='4' class='title'>예정현황</td>
                    <td colspan='2' class='title'>실행현황</td>
                    <td rowspan='3' width='12%' class='title'>잔액</td>
                </tr>
                <tr>
                    <td rowspan='2' width='12%' class='title'>정기상환</td>
                    <td colspan='2' width='12%' class='title'>조기상환</td>
                    <td rowspan='2' width='12%' class='title'>합계</td>
                    <td rowspan='2' width='12%' class='title'>실행일자</td>
                    <td rowspan='2' width='12%' class='title'>금액</td>
                    
                </tr>
                <tr>
                    <td width='12%' class='title'>예정일자</td>
