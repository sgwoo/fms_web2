...
<%
	Vector vts = CardDb.getCardUseAcctUStat(s_br, chk1, chk2, chk3, chk4, gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, st_dt, end_dt, s_kd, t_wd1, t_wd2, sort, asc);
...
<!--
	...
	//카드내용보기
	function CardUseList(cardno){
		var fm = document.form1;
		fm.gubun5.value = cardno;
		fm.action = "card_use_card_us_frame.jsp";
		fm.target = "d_content";
		fm.submit();
	}
//-->
	    ...
	    <td class='line' width='480' id='td_title' style='position:relative;'> 
    	    <table border="0" cellspacing="1" cellpadding="0" width='480'>
              <tr> 
                ...
                <td width='80' rowspan="2" class='title'>부서</td>
                <td width='210' rowspan="2" class='title'>카드번호</td>
	    ...
	    <td class='line' width='<%=130*acct_su%>'>
    	    <table border="0" cellspacing="1" cellpadding="0" width='<%=130*acct_su%>'>
              <tr> 
                ...
                <td colspan="2" class='title'>교육훈련비</td>
                <td colspan="2" class='title'>세금과공과</td>				
                <td colspan="2" class='title'>대여사업차량</td>				
                <td colspan="2" class='title'>리스사업차량</td>												
              </tr>
              <tr>
	    ...
	    <td class='line' width='480' id='td_con' style='position:relative;'> 
    	    <table border="0" cellspacing="1" cellpadding="0" width='480'>
              ...
              <tr> 
                ...
                <td width='80' align="center"><%=ht.get("DEPT_NM")%></td>
                <td width='210' align="center"><a href="javascript:CardUseList('<%=ht.get("CARDNO")%>')"><%=ht.get("CARDNO")%>&nbsp;<%=ht.get("USER_NM")%></a></td>
