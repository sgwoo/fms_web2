...
<!--
	function Search(){
		...
		if(fm.chk2[0].checked == true)		fm.action="card_use_card_us_sc_list.jsp";
		else 								fm.action="card_use_card_us_sc.jsp";
		fm.target="cd_foot";		
		fm.submit();
	}
	function enter() {
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1>재무회계 > 법인전표관리 > <span class=style5>카드별현황 (계정과목)</span></span></td>
...
<a href="javascript:Search();"><img src=/acar/images/center/button_search.gif border=0 align=absmiddle></a></td>
      <td align="right"><a href="javascript:list_print();"><img src=/acar/images/center/button_list.gif border=0 align=absmiddle></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    </tr>
  </table>
</form>
