...
<%
	...
	int height = AddUtil.parseInt(s_height)-emp_top_height-sh_height-(h_cnt*25)-320;//현황 라인수만큼 제한 아이프레임 사이즈
%>
...
<!--
	...
	function CardUseList(acct_code_nm, acct_code){
		...
		fm.action = "card_use_card_d_sc_in.jsp";
		fm.target = "inner";
		fm.submit();
	}
//-->
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>	
    ...
    <tr> 
        <td height="<%=height%>" colspan="2"><iframe src="card_use_card_d_sc_in.jsp<%=hidden_value%>&acct_code=<%=acct_code%>&acct_code_nm=<%=acct_code_nm%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
