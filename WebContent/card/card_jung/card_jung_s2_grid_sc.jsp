...
<%
	...
	int height = AddUtil.parseInt(s_height)-emp_top_height-sh_height-(cnt*sc_line_height)-85;//현황 라인수만큼 제한 아이프레임 사이즈
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
     <td><font color=red>***</font>&nbsp;정산차액은 <font color=red>중식대포함</font>하여 본인이 사용가능한 한도내 잔액입니다.  회식비기준액은 유류대정산분을 반영한 금액입니다. 항상 예산범위를 지켜서 정산액이 (-)가 나오지 않도록 주의하세요. </td>
	<tr>
	 <tr>
     <td><font color=red>***</font>&nbsp;회식비기준액중  특별은 근속포상,코로나 방역비 입니다. </td>
	<tr>
	</tr>
    <tr>
        <td><iframe src="card_jung_s2_grid_sc_in.jsp?auth_rw=<%=auth_rw%>&dt=<%=dt%>&ref_dt1=<%=ref_dt1%>&ref_dt2=<%=ref_dt2%>&dept_id=<%=dept_id%>&br_id=<%=br_id%>&user_nm=<%=user_nm%>" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
                    </iframe></td>
     </tr>
    <tr>
        <td class=h></td>
