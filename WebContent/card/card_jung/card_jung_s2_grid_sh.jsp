...
function Search(){
		...
		fm.action="card_jung_s2_grid_sc.jsp";
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1>재무회계 > 법인전표관리 > <span class=style5>복리후생비정산</span></span></td>
    ...
    <tr> 
      ...
      <td align=right>  <%if(auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")){%>
            <a href='javascript:Jungsan()' onMouseOver="window.status=''; return true"><img src="/acar/images/center/button_jungs.gif" align="absmiddle" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
             <%}%> 
      </td>
    </tr>  
    <tr>
