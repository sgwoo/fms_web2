...
<table border="0" cellspacing="0" cellpadding="0" width='1850'>
    ...
    <tr id='tr_title' style='position:relative;z-index:1'>
	    <td class='line' width='38%' id='td_title' style='position:relative;'> 
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr> 
                    ...
                    <td width='*' class='title'>카드번호</td>
                    <td width='9%' class='title'>소유자</td>
                    <td width='9%' class='title'>사용자</td>
	    ...
	    <td class='line' width='62%'>
         ...
         <!-- 0           <td width='5%' class='title'>부서장</td> -->
                    <td width='*' class='title'>적요</td>
                </tr>
            </table>
	    </td>
    </tr>
