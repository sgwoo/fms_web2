...
<!--
	...
	function Save()
	{
		...
		if(confirm('등록하시겠습니까?')){					
			fm.action='card_change_many_a.jsp';		
			//fm.target='i_no';
			fm.submit();
		}
	}
...
<%	
	for(int i=0;i < vid_size;i++){
		vid_num = vid[i];
		cardno 		= vid_num.substring(0,19);
		buy_id 		= vid_num.substring(19);
		%>
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1>재무회계 > 법인전표승인 > <span class=style5>카드일괄변경</span></span></td>
