...
<%
	String o_cardno 	= request.getParameter("o_cardno")==null?"":request.getParameter("o_cardno"); //old
	String o_buy_id 	= request.getParameter("o_buy_id")==null?"":request.getParameter("o_buy_id"); //old
