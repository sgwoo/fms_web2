...
<%
	...
	for (int i = 0 ; i < cdi_size ; i++){
        ...
        if ( user_id.equals("000005" ) ) {
            gubun6 = "000058";
        } else if ( user_id.equals("000026") ) {
            gubun6 = "000130";
        } else if ( user_id.equals("000052") ) {
           gubun6 = "000193";
        } else if ( user_id.equals("000053") ) {
           gubun6 = "000056";
        } else if ( user_id.equals("000048") || user_id.equals("000004") ) {
          gubun6 = "000128";
        }		
...
<FRAMESET rows="<%=sh_height%>, *" border=0>
 	<FRAME SRC="./doc_mng_sh3.jsp<%=hidden_value%>" name="c_body" frameborder=0 marginwidth="10" marginheight="10" scrolling="no" noresize>	
	<FRAME SRC="./doc_mng_sc3.jsp<%=hidden_value%>" name="c_foot" frameborder=0 marginwidth="10" topmargin=0 scrolling="auto" noresize>	
</FRAMESET>
<NOFRAMES>
<BODY>
