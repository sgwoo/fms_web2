...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "05", "10", "10");
	
	if(chk1.equals("")) chk1 = "2";
	if(chk2.equals("")) chk2 = "";
	if(chk3.equals("")) chk3 = "";
	if(chk4.equals("")) chk4 = "";
...
<FRAMESET rows="<%=sh_height%>, *" border=0>
 	<FRAME SRC="./card_use_acct_m_sh.jsp<%=hidden_value%>" name="cd_body" frameborder=0 marginwidth="10" marginheight="10" scrolling="no" noresize>	
	<FRAME SRC="./card_use_acct_m_sc.jsp<%=hidden_value%>" name="cd_foot" frameborder=0 marginwidth="10" topmargin=0 scrolling="auto" noresize>	
</FRAMESET>
<NOFRAMES>
<BODY>
