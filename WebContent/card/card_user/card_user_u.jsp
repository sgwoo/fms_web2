...
<!--
	...
	function Save(){
		...
		if(fm.user_nm[3].value == '' || fm.card_user_id.value == ''){		alert('변경후 사용자를 선택하십시오.'); 							return; }
				
		if(fm.use_s_dt[1].value == '')		{								alert('변경후 사용자에게 카드지급한 날을 입력하십시오.'); 			return; }		
		if(fm.use_e_dt[0].value == '')		{								alert('변경전 사용자에게서 카드 회수한 날을 입력하십시오.'); 		return; }
		if(fm.r_use_e_dt[1].value == '')	{								alert('변경후 사용자가 카드를 실제사용할 시작일을 입력하십시오.'); 	return; }		
		
		if(confirm('변경하시겠습니까?')){					
			fm.action='card_user_u_a.jsp';		
			fm.target='i_no';
			fm.submit();
		}
	}
...
<body topmargin="10" onload="javascript:document.form1.user_nm[3].focus();">
   ...
   <tr>
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1>재무회계 > 법인카드관리 > <span class=style5>사용자 변경</span></span></td>
	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr>
            ...
            <td align="center">&nbsp;
                ...
                <input type='hidden' name='o_card_user_id' value='<%=cu_bean.getUser_id()%>'>
            </td>
            <td align="center">&nbsp;
                <input name="user_nm" type="text" class="text" value="" size="10" style='IME-MODE: active' onKeyDown="javasript:enter('card_user_id', 3)">
                <input type='hidden' name='card_user_id' value=''>
                <a href="javascript:User_search('card_user_id', 3);"><img src=/acar/images/center/button_in_search1.gif border=0 align=absmiddle></a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="center">&nbsp;
                <input name="use_e_dt" type="text" class="whitetext" value="" onBlur='javascript:this.value=ChangeDate(this.value)' size="12" redeonly>
				&nbsp;<input name="use_e_dt_h" type="text" class="whitetext" value="" size="2" redeonly>
				</td>
          </tr>
          <tr>
            <td class='title'>사용시작일</td>
            <td align="center">&nbsp;
                <input name="r_use_e_dt" type="text" class="text" value="<%=AddUtil.ChangeDate2(cu_bean.getR_use_s_dt())%>" onBlur='javascript:this.value=ChangeDate(this.value)' size="11">
				</td>
            <td align="center">&nbsp;
                <input name="r_use_e_dt" type="text" class="text" value="" onBlur='javascript:this.value=ChangeDate(this.value)' size="11">				
				</td>
          </tr>		  
        </table></td>
  </tr>
    <tr> 
      <td align="right">
          ...
          <a href="javascript:Save();"><img src=/acar/images/center/button_modify_b.gif border=0 align=absmiddle></a>&nbsp;
          <%}%>
