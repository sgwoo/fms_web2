...
<%
	...
	if(t_wd1.equals("") && gubun1.equals("") && gubun2.equals("") && gubun3.equals("") && gubun4.equals("") && gubun5.equals("") && chk1.equals("")){
		
		if(chk1.equals("")) 	chk1 	= "Y";
		if(chk2.equals("")) 	chk2 	= "";
		if(chk3.equals("")) 	chk3 	= "";
		if(chk4.equals("")) 	chk4 	= "";
...
<FRAMESET rows="<%=sh_height%>, *" border=0>
 	<FRAME SRC="./card_mng_sh.jsp<%=hidden_value%>" name="c_body" frameborder=0 marginwidth="10" marginheight="10" scrolling="no" noresize>	
	<FRAME SRC="./card_mng_sc.jsp<%=hidden_value%>" name="c_foot" frameborder=0 marginwidth="10" topmargin=0 scrolling="auto" noresize>	
</FRAMESET>
<NOFRAMES>
<BODY>
