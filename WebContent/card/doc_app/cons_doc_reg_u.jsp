...
<%
	...
	String gubun 	= request.getParameter("gubun")==null?"o":request.getParameter("gubun");
	...
	//전표정보
	CardDocBean cd_bean = CardDb.getCardDocCons(car_no, cons_no, seq, gubun);
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          ...
          <tr>
			  ...
			  <table width="100%" border="0">
			    <tr>
			      <td width="90">
			      <input type="radio" name="acct_code" value="00004" onClick="javascript:cng_input()" <%if(cd_bean.getAcct_code().equals("00004"))%>checked<%%>>
				  차량유류대
				  <input type="radio" name="acct_code" value="00005" onClick="javascript:cng_input()" <%if(cd_bean.getAcct_code().equals("00005"))%>checked<%%>>
				  정비비 
				  </td>
			    </tr>
    ...
    <tr id=tr_acct3_1 style='display:<%if(cd_bean.getAcct_code().equals("00004") || cd_bean.getAcct_code().equals("00006") || cd_bean.getAcct_code().equals("00018") || cd_bean.getAcct_code().equals("00019") ||  cd_bean.getAcct_code().equals("00005")  ){%>""<%}else{%>none<%}%>'>
    ...
    <tr id=tr_acct98 style='display:""'>
      <td colspan="2" class="line"><table border="0" cellspacing="1" cellpadding="0" width='100%'>
        <tr>
          <td width="15%" class='title'>영수증 스캔파일</td>
          <td width="85%">&nbsp;
		    <%
			
			//	out.println(content_code);		
			//	out.println(content_seq);		
			//	out.println(attach_vt_size);		
