	...
	//	if(parseInt(fm.buy_dt.value.substring(0,4)) == '2012'){ alert('월요일부터 입력 가능합니다.'); return;}		
		...
		*/
		...
		if(fm.acct_code[0].checked == true  && fm.acct_code_g[3].checked ==true) {
		   if ( fm.buy_user_id.value == "000003" || fm.buy_user_id.value == "000004" || fm.buy_user_id.value == "000005" || fm.buy_user_id.value == "000026"  || fm.buy_user_id.value == "000237" ) {
		   } else {
		...
		if(fm.acct_code[4].checked == true 	&& fm.acct_code_g[7].checked ==  true) {	
       ...
       if(fm.acct_code[0].checked == true   ){
		...
		//정비비, 기타인 경우
		if (fm.acct_code[4].checked == true && fm.acct_code_g[12].checked == true ){		   
		   // 일단 총무팀 승인, 추후 계속 추가
		  if (fm.user_id.value == '000058' || fm.user_id.value == '000070' || fm.user_id.value == '000026'  || fm.user_id.value == '000063' ||   fm.user_id.value == '000029' ||   fm.user_id.value == '000130'  ||   fm.user_id.value == '000128' ||   fm.user_id.value == '000153'||   fm.user_id.value == '000096') {
...
//추가추가
	...
	function cng_input(){
		...
		if(fm.acct_code[0].checked == true){ 		//복리후생비
			...
			fm.user_Rdio[0].checked 	= true; //1/n
			
			fm.buy_amt.disabled = false;
			<%for(int i=1;i<19 ;i++){%>
				tr_acct3_<%=i%>_1.style.display	= 'none';
				tr_acct3_<%=i%>_3.style.display	= 'none';
				tr_acct3_<%=i%>_98.style.display= 'none';
			...
			<%}%>		
		}else if(fm.acct_code[15].checked == true || fm.acct_code[16].checked == true){ 	//대여사업차량/리스사업차량
			tr_acct1.style.display		= 'none';
			tr_acct2.style.display		= 'none';
			tr_acct3.style.display		= 'none';
			tr_acct4.style.display		= 'none';
			...
			<%}%>
		}else if(fm.acct_code[17].checked == true || fm.acct_code[18].checked == true){ 	//운반비, 주차요금
			tr_acct1.style.display		= 'none';
			tr_acct2.style.display		= 'none';
			tr_acct3.style.display		= 'none';
			tr_acct4.style.display		= 'none';			
...
//		if(inCnt > 90){	alert('1/n 입력은 최대 90인까지 입니다.'); return;}
	...
	{
		var fm = document.form1;
		if(fm.acct_code_s[0].checked == true){ //나혼자
			fm.user_su.value = 1;
		...
		if(fm.acct_code_s[1].checked == true){ //파트너
		//	fm.user_su.value = "";
			tr_acct101.style.display 	= '';
			var idx = "1";
			var nm = "user_case_id";
		...
		if(fm.acct_code_s[2].checked == true){ //선택
			fm.user_su.value = "";
			tr_acct101.style.display 	= '';
		}
	}
			...
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;
						<span class=style1>재무회계 > 법인전표관리 > <span class=style5>카드전표등록</span></span></td>
	    	...
	    	<table border="0" cellspacing="1" cellpadding="0" width='100%'>
          		<tr>
            		<td colspan="2" class='title'>거래일자</td>
          			<td colspan="3">&nbsp;
						...
						&nbsp;&nbsp;&nbsp;<input type="button" value="일자증가" onclick="javascrrp:getAddDay(1);">&nbsp;<input type="button" value="일자감소" onclick="javascrrp:getAddDay(-1);">
						<%//}%>
		  	  		</td>
          		</tr>
          		<tr>
          		...
          		<tr>
          			...
          			<td colspan="3" >&nbsp;
						...
						&nbsp;&nbsp;<font color="red">※ 카드전표는 모두 부가세 환급대상입니다.(접대비, 업무용차량 유류대 제외)</font>
            		</td>
            	</tr>          
          		<tr>
          			...
          			<td  colspan="3" >
			  			<table width="100%" border="0">
			    			<tr>
			      				...
			      				<td width="90">
			      					<input type="radio" name="acct_code" value="00001" onClick="javascript:cng_input()" checked>복리후생비
			      				</td>
			      				
			      				<td width="90">
			      					<input type="radio" name="acct_code" value="00002" onClick="javascript:cng_input()">접대비
			      				</td>
			      				
			      				<td width="90">
			      					<input type="radio" name="acct_code" value="00003" onClick="javascript:cng_input()">여비교통비
			      				</td>
			      
			      				<td width="90">
			      					<input type="radio" name="acct_code" value="00004" onClick="javascript:cng_input(); cng_input3();">차량유류대
			      				</td>
			      				
			      				<td width="90">
			      					<input type="radio" name="acct_code" value="00005" onClick="javascript:cng_input()">차량정비비
			      				</td>
			      				
			      				<td width="90">
			      					<input type="radio" name="acct_code" value="00006"  onClick="javascript:cng_input()">사고수리비
			      				</td>
			      
			      				<td width="90">
			      					<input type="radio" name="acct_code" value="00007" onClick="javascript:cng_input()">사무용품비 
			      				</td>
			      				
			      				<td width="90">
							    	<input type="radio" name="acct_code" value="00009" onClick="javascript:cng_input()">통신비
							    </td>
			    			...
			    			<tr>
			      				...
			      				<td>
			      					<input type="radio" name="acct_code" value="00008" onClick="javascript:cng_input()">소모품비
			      				</td>
			    
							    <td>
							    	<input type="radio" name="acct_code" value="00010" onClick="javascript:cng_input()">도서인쇄비
							    </td>
							    
							    <td>
							    	<input type="radio" name="acct_code" value="00011" onClick="javascript:cng_input()">지급수수료
							    </td>
							    
							    <td>
							    	<input type="radio" name="acct_code" value="00012" onClick="javascript:cng_input()">비품
							    </td>
							    
							    <td>
							    	<input type="radio" name="acct_code" value="00013" onClick="javascript:cng_input()">선급금
							    </td>
							    
							    <td>
							    	<input type="radio" name="acct_code" value="00014" onClick="javascript:cng_input()">교육훈련비
							    </td>
							    
							    <td>
							    	<input type="radio" name="acct_code" value="00015" onClick="javascript:cng_input()">세금과공과
							    </td>
			    			...
			    			<tr>
			      				...
			      				<td>
			      					<input type="radio" name="acct_code" value="00016" onClick="javascript:cng_input()">대여사업차량
			      				</td>
			    
							    <td>
							    	<input type="radio" name="acct_code" value="00017" onClick="javascript:cng_input()">리스사업차량
							    </td>
							    
							    <td>
							    	<input type="radio" name="acct_code" value="00018" onClick="javascript:cng_input()">운반비
							    </td>
							    
							    <td>
							    	<input type="radio" name="acct_code" value="00019" onClick="javascript:cng_input()">주차요금
							    </td>
							        <!--
							        	acct_code=00020' 자동차대금미지급금 있음. 출금에서 전표처리함. 20111213 정현미
							        -->
							    <td>
							    	&nbsp;
							    </td>
    	...
    	<td colspan="2" class="line">
    		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
        		<tr>
          			...
          			<td width="90%">&nbsp;
		      			<input type="radio" name="acct_code_g" value="1" checked onClick="javascript:cng_input2()">식대
              			<input type="radio" name="acct_code_g" value="2" onClick="javascript:cng_input2()">복지비
			  			<input type="radio" name="acct_code_g" value="15" onClick="javascript:cng_input2()">경조사
			  			<input type="radio" name="acct_code_g" value="3" onClick="javascript:cng_input2()">기타
			  			<input type="radio" name="acct_code_g" value="30" disabled  onClick="javascript:cng_input2()">포상휴가
          			...
          			<td>
          				<table width="90%"  border="0" cellpadding="0" cellspacing="0">
              				...
              				<tr id=tr_acct1_2 style='display:none'>
                				<td>&nbsp;
                  					<input type="radio" name="acct_code_g2" value="4" onClick="javascript:cng_input22();">회사전체모임
				  					<input type="radio" name="acct_code_g2" value="5" onClick="javascript:cng_input22();">부서별 정기모임
				  					<input type="radio" name="acct_code_g2" value="6" onClick="javascript:cng_input22();">부서별 부정기회식
				  					<input type="radio" name="acct_code_g2" value="15" onClick="javascript:cng_input22();">동호회 
				  					
				  				</td>
              				</tr>
              				<!--
              				<tr id=tr_acct1_3 style='display:none'>
                				<td>&nbsp;
                  					<input type="radio" name="acct_code_g2" value="7">커피
									<input type="radio" name="acct_code_g2" value="8">음료
									<input type="radio" name="acct_code_g2" value="9">약품
									<input type="radio" name="acct_code_g2" value="10">그외
								</td>
							</tr>-->
           				</table>
           			</td>
    	...
    	<td colspan="2" class="line">
      		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				...
				<tr>
					...
					<td width="90%">&nbsp;
						<input type="radio" name="acct_code_g2" value="11" onClick="javascript:cng_input3()">업무
						<input type="radio" name="acct_code_g2" value="12" onClick="javascript:cng_input3()">예비차 보충
						<input type="radio" name="acct_code_g2" value="13" onClick="javascript:cng_input3()">고객차량
					</td>
				</tr>
			</table>
      	</td>
    	...
    	<td colspan="2" class="line">
    		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
	        	<tr>
	          		...
	          		<td>&nbsp;
	          			<input type="radio" name="acct_code_g" value="6"  onClick="javascript:cng_input4();">일반정비
						<input type="radio" name="acct_code_g" value="7"  onclick="javascript:cng_input4();">자동차검사
				<!--	<input type="radio" name="acct_code_g" value="8"  onclick="javascript:cng_input4();">점검기록부  -->
						<input type="radio" name="acct_code_g" value="18" onclick="javascript:cng_input4();">번호판대금	
						<input type="radio" name="acct_code_g" value="21" onclick="javascript:cng_input4();">재리스정비	
						<input type="radio" name="acct_code_g" value="22" onclick="javascript:cng_input4();">기타						
					</td>
	        	</tr>
      		</table>
      	</td>
    	...
    	<td colspan="2" class="line">
    		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
        		<tr>
          			<td width="10%" class='title'>구분</td>
          			<td>&nbsp;
            			<input type="radio" name="acct_code_g" value="11" onclick="javascript:tr_acct98.style.display='';">식대
						<input type="radio" name="acct_code_g" value="12" onclick="javascript:tr_acct98.style.display='';">경조사
						<input type="radio" name="acct_code_g" value="14" onclick="javascript:tr_acct98.style.display='';">기타
					</td>
        		</tr>
      		</table>
      	</td>
    	...
    	<td colspan="2" class="line">
    		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
        		<tr>
          			<td width="10%" class='title'>구분</td>
          			<td>&nbsp;
            			<input type="radio" name="acct_code_g" value="16" onClick="javascript:cng_input7();">개별
						<input type="radio" name="acct_code_g" value="17" onClick="javascript:cng_input7();">공통
					</td>
        		</tr>
      		</table>
      	</td>
...
<% } %>
    <tr id=tr_acct99 style="display:''">
    	<td colspan="2" class="line">
      		<table border="0" cellspacing="1" cellpadding="0" width='100%'>
        		...
        		<tr>
          			<td width="10%" class='title'>인원</td>                                                                                                                                                                                                          
          			<td width="25%" align='center'>&nbsp;
						<input type='radio' name="acct_code_s" value='1' onClick="javascript:cng_input5()" >혼자&nbsp;&nbsp;&nbsp;
						<input type='radio' name="acct_code_s" value='2' onClick="javascript:cng_input5()" >파트너&nbsp;&nbsp;&nbsp;
						<input type='radio' name="acct_code_s" value='3' onClick="javascript:cng_input5()" >선택&nbsp;&nbsp;&nbsp;
            			<input name="user_su" type="text" class="text" value ="<%=user_su%>" size="3" onBlur="javascript:cng_input1();">명       		  
    ...
    <tr>
  	...
  	<tr>
		...
		<!--	
		<td id=tr_acct102 style="display:''"><거래처 입력>
			<table width="300" border="0" cellspacing="1" cellpadding="0" bgcolor=000000>
            	<tr>
                	<td width="128" class='title'>거래처명</td>
					<td width="78" class='title'>성명</td>
				</tr>
                 <%for(int j = 0 ; j <61 ; j++){%>       
                <tr>
                	<td>&nbsp;<input name="client_nm" class="text" value="" size="20"></td>
                    <td>&nbsp;<input name="mgr_nm" class="text" value="" size="15"></td>
               	</tr>
				<%}%>
			</table>
		</td>
