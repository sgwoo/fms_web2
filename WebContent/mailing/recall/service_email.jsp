                ...
                <tr>
                	<td align="center" style="padding-top:50px;padding-bottom:50px;background:linear-gradient(#ffe4b5, #ffe4b5 30%, #68d168);border-radius: 15px;">
                		<table width=585 border=0 cellspacing=0  style="border: 10px solid #ebc680; border-radius: 10px;background-color: white;">
                			<tr>
			                    <td style="padding-top:30px;padding-bottom:30px;font-size: 30px;font-family: Nanumgothic, AppleMyungjo;font-weight: bold; padding-left:30px;"><div>서비스 캠페인 안내문</div></td>
			                </tr>
			                <tr>
			                ...
			                <tr>
			                	<td style="font-size: 14px;font-family:Nanumgothic; font-weight:bold; padding-left:30px; padding-right:30px;">
			                		...
			                		<div>현재 이용중인 자동차의 제조사로부터 수령한 <span style="color: #c90909">무상수리통지</span>(무상수리 고객통지문) 내용을 <span style="color: #c90909">파일로 첨부</span>하여 보내드립니다.</div><br>
			                		<div>고객님께서 첨부 파일을 열어서 무상수리통지 내용을 확인하시고 안내문의 내용대로 자동차의 결함사항에 대해 무상수리를 받으시기 바랍니다.</div>
			                		<div>보다 자세한 사항은 해당 자동차 제조사의 고객센터로 문의해 주시기 바랍니다.</div>
			                		<div>감사합니다.</div>
			                		<br><br>
