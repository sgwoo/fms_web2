...
<title>아마존카 회원가입을 위한 인증 메일</title>
<style type="text/css">
<!--
.style1 {color: #373737}
.style2 {color: #63676a}
            ...
            <table width=656 border=0 cellspacing=0 cellpadding=0>
                <tr>
                    <td height=20 style="padding:20px;line-height:25px;text-align:center;">
                    	<span style="font-size:15px;font-weight:500;">아마존카 회원가입을 위한 본인 확인 메일입니다.<br/>아래 버튼을 클릭하시면 이메일 인증이 완료됩니다</span><Br/><br/>
                    	<a href="https://www.amazoncar.co.kr/userAuthEmail?token=<%=token%>"><img src=https://fms5.amazoncar.co.kr/mailing/images/auth_btn.png></a><br/>
                    </td>
                </tr>              
            </table>
        </td>
