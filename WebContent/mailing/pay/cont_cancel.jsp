                            ...
                            <tr>
                                <td width=187 bgcolor=594e8a>
                                    <table width=187 border=0 cellspacing=0 cellpadding=0>
                                        ...
                                        <tr>
                                            <td align=left height=17>&nbsp;&nbsp;&nbsp;<span class=style3><strong>권용식</strong></span> </td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td align=center>
                                    <table width=648 border=0 cellspacing=0 cellpadding=0>
                                        <tr>
                                            <td height=45>&nbsp;&nbsp;1. 당사는 귀사(귀하)와 원만한 거래관계가 지속되도록 최선의 노력을 다해왔으나, 이 건 계약해지  
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;및 납부최고를 보내게 되었음을 유감스럽게 생각합니다.</td>
                                        </tr>
                                        <tr>
...
<% 		}
                                        ...
                                        <tr>
                                            <td height=60>&nbsp;&nbsp;5. 귀사(귀하)는 당사의 수차례 안내에도 불구하고 아직까지 상기 미납금액을 납부하지 않고 있으며, 
                                           	<br>&nbsp;&nbsp;&nbsp;&nbsp;당사는 이 건 때문에 업무상 상당한 지장을 받고 있습니다. 이에 당사는 상기 납부기한 일까지 
                                           	<br>&nbsp;&nbsp;&nbsp;&nbsp;미납금액 전부를 납부할 것을 최고 하는바이며, 만일 납부하지 않은 경우 상기 자동차대여계약은 
                                           	<br>&nbsp;&nbsp;&nbsp;&nbsp;별도의 해지통보없이 자동으로 해지될 것입니다.</td>
                                        </tr>
                                        <tr>
                                            <td height=10></td>
                                        </tR>
                                        <tr>
                                            <td height=50>&nbsp;&nbsp;6. 위 일시까지 미납금액 전부를 납부하지 않은 경우 당사는 귀사(귀하)와 연대보증인을 상대로 
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;민·형사상&nbsp; 법적구제절차및 자구행위를 진행하고, 이에 따르는 제비용&nbsp;(가압류, 임의경매 등의 
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;소송관련 제비용, &nbsp;차량회수 등&nbsp; 업무위탁에 따른 제비용 등 포함)을별도 청구할 예정이며,경우에 
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;따라 보증보험청구 및 신용조사기관에 채권 추심의뢰와 채무불이행 정보를 등록할 것이며, 채무 
                                           	<br>&nbsp;&nbsp;&nbsp;&nbsp;불이행 정보 등록 시 개인 신용 평점 또는 기업신용등급이 하락하고 금리가 상승하는 등의 불이익
                                           	<br>&nbsp;&nbsp;&nbsp;&nbsp;이 발생 할 수 있음을 알려드립니다.</td>
