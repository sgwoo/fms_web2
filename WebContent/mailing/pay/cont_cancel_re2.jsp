                            ...
                            <tr>
                                <td align=center>
                                    <table width=648 border=0 cellspacing=0 cellpadding=0>
                                        ...
                                        <tr>
                                            <td height=40>&nbsp;&nbsp;2. 주지하다시피 아래와 같이 귀사(귀하)와 당사와의 사이에 자동차 대여이용계약을 체결하였습니다.</td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td height=40>&nbsp;&nbsp;3. 그런데, 귀사(귀하)가 대여료를 (<span class=style15><%=de_day%></span>)일 이상 미납 및  (주)아마존카의 차량 반납 요청에도 불구하고
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;차량을 반납하고 있지 않아 당사는 귀사(귀하)와 더 이상 계약관계를 유지할 수 없으며  
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;상기 중도해지 규정을 적용하여 중도해지 및 고소장이 접수 되었음을  알려드립니다.<br>
                                           </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td height=50>&nbsp;&nbsp;5. 아래 일시까지 차량을 반납할 것을 통보하며, 반납 하지 않을 경우 귀사(귀하)에게 
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class=style15>모든 법적책임(횡령죄로 형사 고소등)</span>을 물을 것입니다.</td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td height=60>&nbsp;&nbsp;6. 위 일시까지 차량반납이 안될시 당사는 귀사(귀하)와 연대보증인을 상대로 민·형사상 법적구제절차
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;및 자구행위를 진행하고, 이에 따르는 제비용(가압류, 임의경매 등의 소송관련 제비용, 차량회수 등
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;업무위탁에 따른 제비용 등 포함)을 별도 청구할 예정이며, 경우에 따라 보증보험금청구 및
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;신용정보기관에 채권추심의뢰와 채무불이행 정보를 등록 할 것임을 통보드립니다. -끝-
                                            	</td>
                                        </tr>
                                        <tr>
