                           ...
                           <tr>
                                <td align=center>
                                    <table width=648 border=0 cellspacing=0 cellpadding=0>
                                        <tr>
                                            <td width="708" height="25" ><p>&nbsp;&nbsp;1. 당사는 귀사(귀하)와 원만한 거래관계가 지속되도록 최선의 노력을 다해왔으나, 
                                            		<br>&nbsp;&nbsp;&nbsp;&nbsp;이 건 <b>해지통보 및 해지 정산금 납입고지</b>를 보내게 되었음을 유감스럽게 생각합니다.</p>
                    </td>
                                        </tr>
                                        <tr>
...
<% 		}
                                ...
                                <td style="font-size : 9pt;" align=center bgcolor=ffffff colspan=2 width=157>&nbsp;<span class=style12><font face="바탕"><b><%=Util.parseDecimal(amt_5)%>원</b></font></span></td>
                                        ...
                                        <tr>
                                            <td height=50>&nbsp;&nbsp;5. 아래 일시까지 중도해지정산금을 납부하지 않을 경우 귀하에게 채권회수에 따른 법적인 모든 책임을 물을 것입니다.<br>
											</td>
                                        </tr>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
						                	<td height="25" >&nbsp;&nbsp;6. 또한 위 일시까지 &nbsp;중도해지정산금 일체를 납입하지 아니할 경우, &nbsp;당사는 귀사(귀하)와 
				                     		<br>&nbsp;&nbsp;&nbsp;&nbsp;연대보증인을 상대로 연체채권(중도해지위약금포함) 회수 과정에서 발생할 수 있는 모든 비용	
				                     		<br>&nbsp;&nbsp;&nbsp;&nbsp;(가압류 및 임의경매등의 소송관련 제비용, 기타 법적인 조치, &nbsp;업무위탁에따른 제비용 등을 포함) 
				                     		<br>&nbsp;&nbsp;&nbsp;&nbsp;을 별도 청구할 예정이며, 경우에 따라 보증보험청구 및 신용정보기관에 채권 추심의뢰와 채무불
				                     		<br>&nbsp;&nbsp;&nbsp;&nbsp;이행 정보를 등록할 것이며, 채무불이행 정보 등록 시 개인 신용 평점 또는 기업신용등급이 &nbsp;하락 
				                     		<br>&nbsp;&nbsp;&nbsp;&nbsp;하고 금리가 상승하는 등의 불이익이  발생 할 수 있음을 알려드립니다. </td>
