                            ...
                            <tr>
                                <td align=center>
                                    <table width=648 border=0 cellspacing=0 cellpadding=0>
                                        <tr>
                                            <td height=45>&nbsp;&nbsp;1. 당사는 귀사(귀하)와 원만한 거래관계가 지속되도록 최선의 노력을 다해왔으나, 이 건 계약해지 및 
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;납부최고를 보내게 되었음을 유감스럽게 생각합니다.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;당사는 이 건 때문에 업무상 상당한 지장을 받고 있습니다. 
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;이에 당사는 상기 납부기한 일까지 미납금액 전부를 납부할 것을 최고 하는 바이며, 
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;만일 납부하지 않은 경우 상기 자동차대여계약은 별도의 해지통보없이 자동으로 해지될 것입니다.
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td height=10></td>
                                        ...
                                        <tr>
                                            <td height=50>&nbsp;&nbsp;6. 위 일시까지 미납금액 전부를 납부하지 않은 경우 당사는 귀사(귀하)와 연대보증인을 상대로 
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;민·형사상 법적구제절차 및 자구행위를 진행하고, 이에 따르는 제비용 (가압류, 임의경매 등의 
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;소송관련 제비용, 차량회수 등 업무위탁에 따른 제비용 등 포함)을 별도 청구할 예정이며,
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;경우에 따라 보증보험금 청구 및 신용조사기관 등에 채무불이행 사실을 통보 및 등재할 예정이므로
                                            	<br>&nbsp;&nbsp;&nbsp;&nbsp;신용상 큰 불이익이 있을 수 있음을 알려드립니다.
                                            </td>
                                        </tr>
                                        <tr>
