...
<%
	...
	if(rent_st.equals("")){
		...
		fee_scd = af_db.getFeeScdEmailRentst2(l_cd, rent_st, "", true);// 선납금 2018.04.13
		fee_scd_size = fee_scd.size();
...
<table width=800 cellpadding=0 cellspacing=0 style="border-style: solid; border-width: thin;">
	<tr bgcolor=#f2f2f2>
		...
		<td width=15% align=center class=title style="border-style: solid; border-width: thin;">세금계산서일자</td>
		...
		<td colspan=6>
			<table width=680 border=0 cellspacing=0 cellpadding=0>
                ...
                <%=scd.getFee_tm()%>
                    ...
                    <td width=117 align=center><span class=style11><%=AddUtil.ChangeDate2(scd.getTax_out_dt())%></span></td>
