...
<!--         <td><img src=https://fms5.amazoncar.co.kr/mailing/ins/images/layout_top_ins_file4.gif style="width:100%;"></td> -->
        <td style="font-family:nanumgothic;font-size:17px;">&nbsp;&nbsp;&nbsp;<b>자동차보험 계약사항 변경요청서</b></td>
                    ...
                    <td width=670 align=center>
                        <table width=100% border=0 cellspacing=0 cellpadding=0>
                            ...
                            <tr>
                            	...
                            	<p>해당 차량에 대한 자동차보험 계약사항 변경이 있어 요청드립니다.</p>
                            </tr>
                            <tr>
                                <td height=15></td>
                            </tr>
            ...
            <table width=656 border=0 cellspacing=0 cellpadding=0>
              ...
              <%  if(attach_vt_size > 0){
				...
				%>
				 <tr height="50">
                	<td align=center>
                		<a href=<%=add_content%> target="_blank" style="text-decoration: none;">
