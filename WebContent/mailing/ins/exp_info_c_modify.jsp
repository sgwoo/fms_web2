...
.style2 {color: #333333}
.style3 {color: #333333; font-weight: bold; font-size:14px;}
...
<table width=700 border=0 cellspacing=0 cellpadding=0 align=center>
    ...
    <tr>
        <td background=https://fms5.amazoncar.co.kr/mailing/images/layout_bg.gif height=10>
    </tr>
    <tr>
    ...
    <tr>
        <td align=center background=https://fms5.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=677 border=0 cellpadding=0 cellspacing=0 background=https://fms5.amazoncar.co.kr/mailing/ins/images/ser_bg.gif>
                ...
                <tr>
                    <td align=center><img src=https://fms5.amazoncar.co.kr/mailing/ins/images/exp_c_img_all.gif></td>
                </tr>
                <tr>
                	<td height=50></td>
                </tr>
                <tr>
                	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
                	<span class=style3>○ 이용 차량별 기존 보험 만료일</span></td>
                </tr>
                <tr>
                	<td height=10></td>
                </tr>
                <tr>
                	<td align=center  >
                		<table width=570 border=0 cellpadding=0 cellspacing=1 bgcolor=#ccccc;>
                			<tr bgcolor=#ececec>
                				<th height=35 width=15%><span class=style1>기존 보험<br>만료일</span></td>
                				<th width=35%><span class=style1>차종</span></td>
                				<th width=25%><span class=style1>차량번호</span></td>
                				<th width=25%><span class=style1>임직원 전용보험<br>가입대상여부</span></td>
                			</tr>                			
                			<%														
 					...
 					%>
        						 <tr bgcolor=#ffffff>
        						 		<td height=30 align=center><span class=style2><%=AddUtil.ChangeDate2(String.valueOf(ht.get("INS_EXP_DT")))%></td>
										<td align=center><span class=style2><%=ht.get("CAR_NM")%>&nbsp;<%=ht.get("CAR_NAME")%></td>
												<td align=center><span class=style2><%=ht.get("CAR_NO")%></td>
												<td align=center><span class=style2><%=ht.get("COM_EMP_YN")%></td>
										 </tr>
										<% }%>
                		</table>
                	</td>
                ...
                <tr>
                	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class=style2>* 임직원 전용보험 가입대상여부가 X인 경우는 경차 또는 9인승이상 차량 또는 화물에 해당되기 때문에<br>
                	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 가입할 필요가 없습니다.</span></td>
                </tr>
                <tr>
                	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class=style2>* 비영리법인 등의 경우에는 임직원 전용 자동차 보험가입 필요여부를 각 법인의 상황을 고려하여 판단하여<br>
                	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 주시기 바랍니다.</span></td>
                </tr>
                <tr>
                    <td height=50></td>
