							...
							for(int k=0;k<vt.size();k++){
 							...
 							%>
        						 <tr bgcolor=#ffffff>
									...
									<td align=center style="font-family:nanumgothic;font-size:12px;"><a href="https://fms3.amazoncar.co.kr/fms2/attach/download2.jsp?SEQ=<%=ht2.get("FILE_SEQ")%>&SIZE=<%=ht2.get("FILE_SIZE") %>" title='보기' ><%=ht2.get("INS_CON_NO")%></a></td>
								 </tr>
						<% }%>                            
                        </table>
                    </td>
