    ...
    <tr>
        <td align=center background=https://fms5.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=677 border=0 cellpadding=0 cellspacing=0 background=https://fms5.amazoncar.co.kr/mailing/ins/images/ser_bg.gif>
                ...
                <tr>
                    <td align=center>
                        <table width=608 border=0 cellspacing=0 cellpadding=0 background=https://fms5.amazoncar.co.kr/mailing/ins/images/sos_c_1.gif>
                            <tr>
                                <td height=110></td>
                            </tr>
                            <tr>
                                <td align=center>                
                                    <table width=510 border=0 cellspacing=0 cellpadding=0>
                                        ...
                                        <tr>
                                            <td height=18 class=style2>당사의 긴급출동서비스가 <b>마스타자동차관리(1588-6688)와</b></td>
                                        </tr>
                                        <tr>
                                            <td height=18 class=style2><span class=style10><b>애니카랜드(02-2119-3117)</b></span>로 제휴되었음을 알려드립니다.<td>
                                        <tr>
                ...
                <tr>
                    <td align=center><img src=https://fms5.amazoncar.co.kr/mailing/ins/images/sos_c.gif></td>
                </tr>
                </tr>
                <tr>
                    <td height=30></td>
