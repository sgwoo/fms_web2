            ...
            <table width=700 border=0 cellspacing=0 cellpadding=0>
              ...
              <%}%>
	                                   ...
	                                   <tr>
				                		        ...
				                		        <td bgcolor=f2f2f2 align=center style="font-family:nanumgothic;font-size:12px;">약정마일리지(월)</td>
                          ...
                          <!-- 선납금액 정산 -->
                            ...
                            <tr>
				 		    ...
				 		    <%if( cct.getJung_st().equals("2")   ) {%>                                    
	            			  ...
	            			  <%} else if( cct.getJung_st().equals("3")   ) {%>
								     		<tr> 
								     			  <td bgcolor=f2f2f2 align='center' height=27 style="font-family:nanumgothic;font-size:12px;"><span style="color:#e60011;">*</span> 카드 취소금액</td> 
								                  <td width="30%" bgcolor=fffdcb align=right style="font-family:nanumgothic;font-size:12px;"> 
								                   <%=AddUtil.parseDecimal(cct.getH5_amt())%> 원 </td>
								                  <td width="37%" bgcolor=fffdcb style="font-family:nanumgothic;font-size:12px;">&nbsp;</td>								                 
								                </tr>
								               	<tr> 
		   						               	  <td bgcolor=f2f2f2 align='center' height=27 style="font-family:nanumgothic;font-size:12px;"><span style="color:#e60011;">*</span> 카드 재결재금액</td> 
								          		  <td width="30%" bgcolor=fffdcb align=right style="font-family:nanumgothic;font-size:12px;"> 
								                 <%=AddUtil.parseDecimal(cct.getH7_amt())%> 원 </td>
								                    <td width="37%" bgcolor=fffdcb style="font-family:nanumgothic;font-size:12px;">&nbsp;</td>	
								                </tr>                 
                            ...
                            <!-- 초과운행부담금이 있는 경우-->
							    ...
							    <%if ( co.getR_over_amt() >  0) {%>      
							       ...
							       <tr> 
							 	 		 <td  style="font-family:nanumgothic;font-size:12px;"><img src=https://fms5.amazoncar.co.kr/acar/images/center/icon_arrow.gif align=absmiddle> 초과운행대여료</td>
							 	 	 </tr>
							      ...
							      <tr>           	
							 	   <td> 
							    	 <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor=cacaca>
							           ...
							           <tr>							            
            			                  	<td bgcolor=f2f2f2 colspan="3" align="center" height=27 style="font-family:nanumgothic;font-size:12px;">항목</td>
							            ...
							            <tr> 
							              <td  width=5%   bgcolor=ecf9fb rowspan="6" align=center style="font-family:nanumgothic;font-size:12px;">계<br>약<br>사<br>항</td>   
							              <td bgcolor=ecf9fb rowspan="3"  width=5%  align=center style="font-family:nanumgothic;font-size:12px;"> 계<br>약<br>내<br>용</td>
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">계약기간</td>
							              ...
							              <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">약정거리 (가)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(car1.getAgree_dist() )%> km</td>
							               <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;
							                  <%if( cls.getCls_st().equals("월렌트해지") ){%>월간<%}else{%>년간<%}%></td>
							             </tr>      
							              <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"> 단가(부담금) (a)</td>
							              ...
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;=1km</td>
							             </tr>           
							            <tr> 
							              <td bgcolor=ecf9fb rowspan="3" align=center style="font-family:nanumgothic;font-size:12px;">정<br>산<br>기<br>준</td>
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"> 대여기간</td>
							              ...
							              <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">대여일수(나)</td>
							             ...
							             <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">약정거리(한도)(c)</td>
							             ...
							             <td bgcolor=ecf9fb rowspan="3" align=center style="font-family:nanumgothic;font-size:12px;">운<br>행<br>거<br>리</td>
							             <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">최초주행거리계(d)</td>
							             <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(co.getFirst_dist() )%> km</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;신차(고객 인도시점 주행거리) , <br> 보유차 (계약서에 명시된 주행거리)</td>
							             </tr>   
							             <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">최종주행거리계(e)</td>
							             ...
							             <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">실운행거리(f)</td>
							              ...
							              <tr> 
							              <td bgcolor=ecf9fb rowspan="3" align=center style="font-family:nanumgothic;font-size:12px;">정<br>산<br>기<br>준</td>
							             <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">초과운행거리(g)</td>
							              ...
							              <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">서비스마일리지</td>
							               <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(co.getAdd_dist() )%> km</td>
							               <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;</td>
							             </tr>      
							              <tr> 
							             <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">정산기준(b)</td>
							             ...
							             <td bgcolor=ecf9fb rowspan="3" align=center style="font-family:nanumgothic;font-size:12px;">정<br>산</td>
							               <td bgcolor=ecf9fb colspan="2" height=24 align=center style="font-family:nanumgothic;font-size:12px;">산출금액(h)</td>
							              ...
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;=(a)x(b)</td>
							             </tr>
							              <tr> 
							              <td bgcolor=ecf9fb align='center'  colspan=2  height=24 style="font-family:nanumgothic;font-size:12px;">감액(i)</td>
							             ...
							             <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;"> </td>
							              ...
							              <tr> 
							             <td  bgcolor=fffdcb align='center'  colspan=2  height=24 style="font-family:nanumgothic;font-size:12px;">정산(납부)금액</td>
							              ...
							              <td bgcolor=fffdcb  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;=(h)-(i)</td>
							             </tr>  						         
