...
<%@ page import="java.util.*, acar.cont.*, acar.fee.*, acar.util.*, acar.credit.*,  acar.cls.*, acar.user_mng.*"%>
...
<%
	...
	String h_user_tel = h_user.getHot_tel();
	String h_user_nm = h_user.getUser_nm();
	...
	Hashtable cls_tax = ac_db.getClsGetTaxYN(m_id, l_cd);
		...
		// 선수금정산정보	
	ClsContEtcBean cct = ac_db.getClsContEtc(m_id, l_cd);
...
//	System.out.println("hash size="+cls_tax.size() );
	...
	ContCarBean  car1 = a_db.getContFeeEtc(m_id, l_cd, Integer.toString(fee_size));
 	...
 	ClsEtcOverBean co = ac_db.getClsEtcOver(m_id, l_cd);
...
<title>아마존카 장기대여 해지정산 안내문</title>
<style type="text/css">
<!--
.style1 {color: #88b228}
.style2 {color: #747474}
                    ...
                    <td width=187 valign=top>
            			<table width=187 border=0 cellpadding=0 cellspacing=0>
                            <tr>
                              ...
                              <!-- 담당자 전화번호 -->
                                        <tr>
                                            <td align=left height=17 style="font-family:nanumgothic;font-size:13px;color:#FFFFFF;font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<%=h_user_nm%><!--[$user_h_tel$]--> </td>
                                        </tr>
                                        <tr>
                                            <td align=left height=17 style="font-family:nanumgothic;font-size:13px;color:#FFFFFF;font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<%=h_user_tel%><!--[$user_h_tel$]--></td>
                                        </tr>
                                        <tr>
                                            <td height=8></td>
                                        </tr>
                ...
                <tr>
                    ...
                    <td width=648>
                        <table width=648 border=0 cellspacing=0 cellpadding=0>
                            ...
                            <tr>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;<img src=https://fms5.amazoncar.co.kr/mailing/cls/images/subbar_5.gif>&nbsp;&nbsp;<a href=http://fms1.amazoncar.co.kr/fms2/cls_cont/lc_cls_print.jsp?rent_mng_id=<%=m_id%>&rent_l_cd=<%=l_cd%> target=_blank onFocus=this.blur();>[정산서출력]</td>
                            </tr>
                            <tr>
                                <td height=3></td>
                            </tr>
              ...
              <%}%>
			      ...
			      <% if (  !cls_st.equals("8") ) {%>                                 
			 		    ...
			 		    <%if( cct.getJung_st().equals("2")   ) {%>                                    
            			                <tr> 
            			                  <td bgcolor=f2f2f2 align='center' height=27 style="font-family:nanumgothic;font-size:12px;"><span style="color:#e60011;">*</span> 고객환불금액</td>            			                    			                
            			                  <td width="30%" bgcolor=fffdcb align=right style="font-family:nanumgothic;font-size:12px;"> 
            			                    <%=AddUtil.parseDecimal(cct.getH5_amt())%>  원</td>
            			                  <td width="37%" bgcolor=fffdcb style="font-family:nanumgothic;font-size:12px;">&nbsp;</td>
            			                 </tr>  
            			                  <tr> 
            			                  <td bgcolor=f2f2f2 align='center' height=27 style="font-family:nanumgothic;font-size:12px;"><span style="color:#e60011;">*</span> 고객청구금액</td>            			                    			                
            			                  <td width="30%" bgcolor=fffdcb align=right style="font-family:nanumgothic;font-size:12px;"> 
            			                   <%=AddUtil.parseDecimal(cct.getH7_amt())%>  원</td>
            			                  <td width="37%" bgcolor=fffdcb style="font-family:nanumgothic;font-size:12px;">&nbsp;= 미납입금액</td>
            			                 </tr>  
     					 <% } else { %>           			                 
            			                  <tr> 
                     ...
                     <% } %> 
                            ...
                            <!-- 초과운행부담금이 있는 경우-->
							 ...
							 <%if ( co.getR_over_amt() !=  0) {%>      
						         ...
						         <tr> 
						 	 		 <td  style="font-family:nanumgothic;font-size:12px;"><img src=https://fms5.amazoncar.co.kr/acar/images/center/icon_arrow.gif align=absmiddle>환급/초과운행 대여료</td>
						 	 	 </tr>
							      ...
							      <tr>           	
							 	   <td> 
							    	 <table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor=cacaca>
							           ...
							           <tr>							            
            			                  	<td bgcolor=f2f2f2 colspan="5" align="center" height=27 style="font-family:nanumgothic;font-size:12px;">항목</td>
            			                  	<td bgcolor=f2f2f2 width='24%' align="center" style="font-family:nanumgothic;font-size:12px;">내용</td>
            			                  	<td bgcolor=f2f2f2 width='42%' align="center" style="font-family:nanumgothic;font-size:12px;">비고</td>
            			                </tr>
            			                 <tr> 
							              <td bgcolor=ecf9fb rowspan="7" align=center style="font-family:nanumgothic;font-size:12px;">계<br>약<br>사<br>항</td>   
							              <td bgcolor=ecf9fb rowspan=4 align=center style="font-family:nanumgothic;font-size:12px;">기<br>준</td>
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  colspan=3>계약기간</td>
							              <td bgcolor=ffffff align='center'  style="font-family:nanumgothic;font-size:12px;" >&nbsp;<%=AddUtil.ChangeDate2((String) base.get("RENT_START_DT"))%>~<%=AddUtil.ChangeDate2((String) base.get("RENT_END_DT"))%> </td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;당초계약기간</td>
							             </tr>
							             <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;" rowspan=3>운행<br>거리<br>약정</td>
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  colspan=2>연간약정거리 (가)</td>
							              <td bgcolor=ffffff  align="right" style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(car1.getAgree_dist() )%> km</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;</td>
							             </tr>  
							             <tr> 
							              <td  bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  rowspan=2>단가<br>(1km) </td>
							              <td  bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  >환급대여료 (a1)</td>
							              <td  bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(car1.getRtn_run_amt() )%>원</td>
							              <td  bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;약정거리 이하운행</td>
							             </tr>            
							             <tr> 
							              <td  bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  >초과운행대여료(a2)</td>
							              <td  bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(car1.getOver_run_amt() )%>원</td>
							              <td  bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;약정거리 초과운행</td>
							            </tr> 
							             <tr> 
							              <td bgcolor=ecf9fb rowspan=3 align=center style="font-family:nanumgothic;font-size:12px;">정<br>산</td>
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  rowspan=2>이용<br>기간</td>  
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;" colspan=2 >실이용기간	</td>     
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;">&nbsp;<%=AddUtil.ChangeDate2(fee.getRent_start_dt())%>~<%=AddUtil.ChangeDate2(cls.getCls_dt())%></td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;실제대여기간</td>
							            </tr>   
	                 					
	                 				    <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  colspan=2 >실이용일수	(나)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;"><%=AddUtil.parseDecimal(co.getRent_days() )%> 일 </td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;"  >&nbsp;</td>
							             </tr>
							             <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;" colspan=3 >약정거리(한도)(c)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;"><%=AddUtil.parseDecimal(co.getCal_dist() )%> km</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;"  >&nbsp;=(가)x(나) / 365</td>
							             </tr>
							             <tr> 
							              <td bgcolor=ecf9fb rowspan="6" align=center style="font-family:nanumgothic;font-size:12px;" >운<br>행<br>거<br>리</td>      
							              <td bgcolor=ecf9fb rowspan="3" align=center style="font-family:nanumgothic;font-size:12px;">기<br>준</td>
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"colspan=3 >최초주행거리계(d)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(co.getFirst_dist() )%> km</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;신차(고객 인도시점 주행거리) , 보유차 (계약서에 명시된 주행거리)</td>
							             </tr>   
							             <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  colspan=3>최종주행거리계(e)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(co.getLast_dist() )%> km</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;</td>
							             </tr>     
	             						 <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  colspan=3 >실운행거리(f)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;"  ><%=AddUtil.parseDecimal(co.getReal_dist() )%> km</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;=(e)-(d) </td>
							             </tr>                          
							             <tr> 
							              <td bgcolor=ecf9fb align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  rowspan=3>정<br>산</td>
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"   colspan=3 >정산기준운행거리	(g)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(co.getOver_dist() )%> km</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;=(f)-(c) </td>
							             </tr>
							              <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"  colspan=3 >기본공제거리</td>
							              <% if (  AddUtil.parseInt(c_base.getRent_dt()) > 20220414 ) { %>             
							               <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;">&nbsp;±1,000 km</td>
							            <% } else { %>
							               <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;">&nbsp;1,000 km</td>
							            <% }  %>  
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;<input type='hidden' name='add_dist'  value='<%=AddUtil.parseDecimal(co.getAdd_dist() )%>'   readonly> </td>
							             </tr>      
							             <tr> 
							              <td bgcolor=ffffff align='center'  height=24 style="font-family:nanumgothic;font-size:12px;"   colspan=3 >대여료정산기준운행거리	(b)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(co.getJung_dist() )%> km</td>
							                <% if (  AddUtil.parseInt(c_base.getRent_dt()) > 20220414 ) { %>             
							               <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;(g)가 ±1,000km 이내이면 미정산(0km) , <br>&nbsp;(g)가  ±1,000km가 아니면 (g)±기본공제거리 </td>
							            <% } else { %>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;</td>
							            <% }  %>  
							             ...
							             <tr> 
							              <td bgcolor=ecf9fb  rowspan=3 align=center style="font-family:nanumgothic;font-size:12px;">대<br>여<br>료</td>
							              <td  bgcolor=ecf9fb rowspan=2 height=24 align=center style="font-family:nanumgothic;font-size:12px;">조<br>정</td>
							              <td  bgcolor=ecf9fb colspan=3 align=center style="font-family:nanumgothic;font-size:12px;">산출금액(h)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;"><%=AddUtil.parseDecimal(co.getR_over_amt() )%> 원</td>
							              <td  bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;">&nbsp;(b)가  0km 미만이면 (a1)*(b),<br>&nbsp;(b)가 1km이상이면 (a2)*(b)</td>
							             </tr>
	             	             	
		             	             	 <tr> 
							              <td bgcolor=ecf9fb align='center'   colspan=3  height=24 style="font-family:nanumgothic;font-size:12px;">가감액(i)</td>
							              <td bgcolor=ffffff align='right'  height=24 style="font-family:nanumgothic;font-size:12px;" ><%=AddUtil.parseDecimal(co.getM_over_amt() )%> 원</td>
							              <td bgcolor=ffffff  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;</td>
							             </tr>      
							             <tr> 
							              <td bgcolor=fffdcb align='center'  colspan=4  height=24 style="font-family:nanumgothic;font-size:12px;">정산(부과/환급예정)금액</td>
							              <td bgcolor=fffdcb align='right'  height=24 style="font-family:nanumgothic;font-size:12px;"  ><%=AddUtil.parseDecimal(co.getJ_over_amt() )%> 원</td>
							              <td bgcolor=fffdcb  align="left" style="font-family:nanumgothic;font-size:12px;" >&nbsp;=(h)-(i), 환급(-)</td>
							             </tr>   
