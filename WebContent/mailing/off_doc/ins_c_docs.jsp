...
<table width=700 border=0 cellspacing=0 cellpadding=0 align=center>
    ...
    <tr>
        <td><img src=http://fms1.amazoncar.co.kr/mailing/ins/images/layout_top_ins_file.gif></td>
    </tr>
    <tr>
                            ...
                            <tr>
                                ...
                                <td bgcolor=f2f2f2 align=center><span class=style1>형식</span></td>
                                	 ...
                                	 for(int i=0;i<send_seq_result.length;i++){
                                	 	Vector attach_vt = c_db.getAcarAttachFileList(Integer.parseInt(send_seq_result[i]));	
						if(attach_vt.size() >0){						
