...
<%@ page import="java.util.*, java.io.*, acar.util.*, acar.common.*, acar.user_mng.*, acar.im_email.*"%>
...
<%
	...
	String n_seqidx = request.getParameter("n_seqidx")==null?"":request.getParameter("n_seqidx");	
	String memo = request.getParameter("memo")==null?"":request.getParameter("memo");	
	
	
	out.println("미사용페이지입니다.");
	
	//Vector vt = ImEmailDb.getSearch_files("4", n_seqidx);
                    ...
                    <td align=center>
                        <table width=648 border=0 cellspacing=1 cellpadding=0 bgcolor=d6d6d6>
                            <tr>
								...
								%>
							<tr>
								<td bgcolor=ffffff height=30 align="left">&nbsp;<span class=style2><%=ht.get("FILEINFO")%></span></td>
		                        <td bgcolor=ffffff align=center>&nbsp;
                               		<span class=style2>
									<a href="<%=ht.get("CONTENT")%>" target='_blank'>[다운로드]</a></span>
                               	</td>
                           	</tr>
															  <%  } %>
                        </table>
