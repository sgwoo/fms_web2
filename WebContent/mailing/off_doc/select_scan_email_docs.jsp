...
<%@ page import="java.util.*, java.io.*, acar.util.*, acar.common.*, acar.user_mng.*, acar.estimate_mng.*, acar.cont.*"%>
...
<%
	...
	//System.out.println("send_seq"+ send_seq);
    ...
    <tr>
        <td align=center background=https://fms5.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=676 border=0 cellspacing=0 cellpadding=0 background=https://fms5.amazoncar.co.kr/mailing/rent/images/e_bg_fine1.gif>
                <tr>
                    <td width=20>&nbsp;</td>
                    <td width=435 height=35 align="left"><span class=style2><span class=style1><b><%=base.get("FIRM_NM")%> </b>님</span></span></td>
                                ...
                                <td bgcolor=f2f2f2 align=center><span class=style1>형식</span></td>
                                 ...
                                 <%
                                		for(int i=0;i<send_seq_result.length;i++){
							        		 ...
							        		 %>
																<tr>
																		<td bgcolor=ffffff height=30 align="left">&nbsp;<span class=style2><%=base.get("CAR_NO")%> 자동차등록증<%//=sfile_name%></span></td>
		                                <td bgcolor=ffffff align=center>&nbsp;
                               		  <span class=style2>
                               		  	<a href="https://fms3.amazoncar.co.kr/fms2/attach/download2.jsp?SEQ=<%=ht.get("SEQ")%>&SIZE=<%=sfile_size%>" target='_blank'>[다운로드]<!-- <img src="http://fms1.amazoncar.co.kr/acar/images/center/icon_<%=sfile_type%>.gif" align=absmiddle border="0">--></a></span>
                               		  </td>
                            		</tr>
															  <%  	} %>
															  <%  } %>
