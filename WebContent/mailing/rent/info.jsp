...
<%
	...
	UsersBean h_user = u_db.getUsersBean(nm_db.getWorkAuthUser("스케줄생성자"));
	...
	String acc_no1 = "";
	String acc_no2 = "";
	if(acc_len > 0 && cms.getCms_acc_no().lastIndexOf("-") >0){
                            ...
                            <tr>
                                <td width=187 bgcolor=594e8a>
                                    <table width=187 border=0 cellspacing=0 cellpadding=0>
                                        <tr>
                                            <td height=16 background=http://fms1.amazoncar.co.kr/mailing/rent/images/sup_up_bg.gif></td>
                                        </tr>
                                        <tr>
                          ...
                          <!-- 계약사항 -->
                                    <table width=648 border=0 cellpadding=0 cellspacing=1 bgcolor=cacaca>
                                        ...
                                        <tr align=center>
                                            ...
                                            <td bgcolor=f2f2f2><span class=style4>장기대여보증금</span></td>
                                            <td bgcolor=f2f2f2><span class=style4>개시대여료(VAT별도)</span></td>
                                        </tr>
                                            ...
                                            <td colspan=6>
        										...
        										<% 	if(fee_scd_size>0){
                                                    ...
                                                    <tr <%if(i%2 != 0){%>bgcolor=f7fae5<%}%>>
                                                        <td width=36 height=18 align=center><span class=style10><%= i+1 %></span></td>
