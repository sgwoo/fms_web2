...
<%
	...
	//건별 대여료 스케줄 리스트
	Vector fee_scd = af_db.getFeeScdNew3(m_id, l_cd, b_dt, mode, bill_yn, rst, false);	// 연장 구분		2018.04.24
...
<table width=800 cellpadding=0 cellspacing=0 style="border-style: solid; border-width: thin;">
	<tr align=center>
		<td width=100% class=title bgcolor=#f2f2f2 colspan=11 style="border-style: solid; border-width: thin;">대여차종</td>
	</tr>
	<tr>
    ...
    <tr align=center>
        <td width=25% class=title bgcolor=#f2f2f2 colspan=4 style="border-style: solid; border-width: thin;">월대여료(VAT별도)</td>
        <td width=25% class=title bgcolor=#f2f2f2 colspan=2 style="border-style: solid; border-width: thin;">장기대여보증금</td>
        <td width=25% class=title bgcolor=#f2f2f2 colspan=2 style="border-style: solid; border-width: thin;">선납금(VAT별도)</td>
        <td width=25% class=title bgcolor=#f2f2f2 colspan=3 style="border-style: solid; border-width: thin;">개시대여료(VAT별도)</td>
    </tr>
    <tr>
...
<table width=648 cellpadding=0 cellspacing=0 style="border-style: solid; border-width: thin;">
	<tr bgcolor=#f2f2f2>
        ...
        <td width=70 align=center style="border-style: solid; border-width: thin;"><span style="color:#707166;font-family:nanumgothic;font-size:12px;">입금예정<br>일자</span></td>
