...
<% //고객위반 과태료 납부자 변경내역-고객FMS 이용방법만 표시
	...
	UsersBean b_user = u_db.getUsersBean("000153");
...
//	System.out.println("email_fine_bill m_id=" +m_id + "|l_cd=" + l_cd + "|dem_dt=" + dem_dt+"|e_dem_dt="+e_dem_dt);
	...
	Vector fines = afm_db.getFinePreDemList2_2( m_id, l_cd, dem_dt, e_dem_dt, sort, asc);
...
<table width=700 border=0 cellspacing=0 cellpadding=0 align=center>
    ...
    <tr>
        <td background=https://fms5.amazoncar.co.kr/mailing/images/layout_top_e2.gif height=60>&nbsp;</td>
    </tr>
    <tr>
        ...
        <td align=center background=https://fms5.amazoncar.co.kr/mailing/images/layout_bg.gif>
            <table width=676 border=0 cellspacing=0 cellpadding=0 background=https://fms5.amazoncar.co.kr/mailing/rent/images/e_bg_fine1.gif>
                <tr>
                    ...
                    <td width=221><span class=style2><img src=https://fms5.amazoncar.co.kr/mailing/rent/images/e_ddj.gif align=absmiddle>&nbsp;&nbsp;<%=b_user.getUser_nm()%>&nbsp;&nbsp;<%=b_user.getHot_tel()%></span></td>
                </tr>
            </table>
        </td>
    </tr>
                ...
                <tr>
                    ...
                    <td width=636>
                        <table width=100% border=0 cellspacing=0 cellpadding=0>
							...
							<tr>
                                <td height=18><span class=style2>고객님께서 차량이용중 발생한 과태료가 있어서 안내해 드립니다. </span></td>
                            </tr>
                            <tr>
                                <td height=18><span class=style2>고객FMS 로그인 후 과태료 메뉴를 선택하시면 부과된 과태료를 확인하실 수 있습니다.  </span></td>
                            </tr>
                            <tr>
                                <td height=18><span class=style2>아마존카를 이용해 주셔서 진심으로 감사드리며, 궁금하신 사항이 있으시면 과태료 담당자에게 전화주시기 바랍니다.</span></td>
                            </tr>
							<tr>
