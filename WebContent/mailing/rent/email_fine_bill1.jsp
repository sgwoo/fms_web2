...
<% //아마존카 과태료청구서-결재금액 및 과태료상세정보 보여줌.
...
<table width=700 border=0 cellspacing=0 cellpadding=0 align=center>
    ...
    <tr>
        <td background=https://fms5.amazoncar.co.kr/mailing/images/layout_top_e1.gif height=60 style='font-size:14px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class=style1><b></b></span></td>
    </tr>
    <tr>
                ...
                <tr>
                    ...
                    <td width=636>
                        <table width=100% border=0 cellspacing=0 cellpadding=0>
                            ...
                            <tr>
                                <td height=18><span class=style2>고객FMS 로그인 후 과태료 메뉴를 선택하시면 선납영수증을 확인/출력하실 수 있습니다.</span></td>
                            </tr>
