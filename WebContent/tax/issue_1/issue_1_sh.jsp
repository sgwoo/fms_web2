		...
		<td colspan=10>
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 세금계산서발행 > 대여료개별정기발행 > <span class=style5>
						개별작성</span></span></td>
    ...
    <tr> 
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="/acar/images/center/arrow_gggub.gif" align=absmiddle>&nbsp; 
        <select name="gubun1" >
          ...
          <option value="2" <%if(gubun1.equals("2")){%> selected <%}%>>입금예정일</option>
        </select>	
    ...
    <tr> 
      ...
      <td width="45%"><img src="/acar/images/center/arrow_jr.gif" align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp; 
        <select name="sort">
          ...
          <option value="4" <%if(sort.equals("4")){%> selected <%}%>>입금예정일</option>		  
        </select>
