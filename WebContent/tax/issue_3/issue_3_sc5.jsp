...
<%@ page import="java.util.*, acar.util.*, acar.cont.*, acar.fee.*, acar.common.*, tax.*, acar.bill_mng.*, acar.client.*, acar.accid.*, acar.res_search.*, acar.user_mng.*"%>
...
<%
	...
	if(rc_bean2.getCust_st().equals("1") && !rc_bean2.getCust_id().equals("")){
	...
	UsersBean cust_bean 	= umd.getUsersBean(rc_bean2.getCust_id());
	
	if(!a_bean.getRent_s_cd().equals("") && rc_bean2.getCust_st().equals("4")){
		...
		client_id 	= rc_bean2.getCust_id();
		site_id		= "";
		rent_s_cd   = a_bean.getRent_s_cd();
		cust_st   	= rc_bean2.getCust_st();
	}
%>
      ...
      <td colspan="2" class="line">
        ...
        <tr>
          ...
          <td height="22" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid; border-right: #000000 1px solid"><span class="ledger_contC">
            <input type="text" name="item_amt" size="10" value="<%=AddUtil.parseDecimal(ma_bean.getMc_s_amt()+ma_bean.getMc_v_amt())%>" class="whitenum" readonly>
			</span></td>
        </tr>
        <tr>
          ...
          <td height="22" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid; border-right: #000000 1px solid"><span class="ledger_contC">
            <input type="text" name="t_item_amt" size="10" value="<%=AddUtil.parseDecimal(ma_bean.getMc_s_amt()+ma_bean.getMc_v_amt())%>" class="whitenum" readonly>
			</span></td>
        </tr>
      </table></td>
    </tr>
    ...
    <tr>
      <td colspan="2" class="line"><table border="0" cellspacing="1" cellpadding="0" width='100%'>
        ...
        <tr>
          ...
          <td colspan='3'>&nbsp;
              <input type='text' size='40' name='con_agnt_email' value='<%=client.getCon_agnt_email()%>' maxlength='30' class='text'></td>
