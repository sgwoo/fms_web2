...
<%
	...
	//휴차료 스케줄
	Vector grts = ScdMngDb.getMyAccidRScdList(s_br, "", "N");
...
<%@ include file="/include/search_hidden.jsp" %>
  ...
  <table width=100% border=0 cellpadding=0 cellspacing=0> 
    <tr> 
      <td colspan="2"><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>휴차료 청구서 미발행리스트</span></td>
    </tr> 
      ...
      <td colspan="2" class="line">
        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
            <tr>
              ...
              <td width="9%" class='title'>사고구분</td>
