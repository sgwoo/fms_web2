...
<FRAMESET rows="<%=sh_height%>, *" border=0>
	...
	<FRAME SRC="./issue_3_est2.jsp<%=hidden_value%>&client_id=<%=client_id%>&site_id=<%=site_id%>" name="c_foot" frameborder=0 marginwidth="10" topmargin=0 scrolling="auto" noresize>	
</FRAMESET>
<NOFRAMES>
<BODY>
