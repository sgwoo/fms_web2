...
<%@ page import="java.util.*, acar.util.*, acar.cont.*, acar.con_ins.*, cust.rent.*, acar.accid.*, tax.*, acar.user_mng.*"%>
                ...
                <tr> 
                  <td style="border: #000000 2px solid" align="center" valign="middle"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" height="95%">
                      ...
                      <tr> 
                        <td width="210">&nbsp;</td>
                        <td align="center" width="180" style="border-bottom: #000000 1px solid" height="30"><font size="3">거 
                          래 명 세 서</font></td>
                        <td width="210">&nbsp;</td>
                      </tr>
                      <tr> 
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              ...
                              <td rowspan="2" align=right> 
                                <img src=/acar/images/center/doc_stamp.gif>
                              </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td> 
                            ...
                            <tr> 
                              ...
                              <td colspan="7" height="22" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid">
							  	<font size="1">
									...
									<%}%>
									<%if(ti.getGubun().equals("11")){%>과실<%=Math.abs(a_bean.getOur_fault_per()-100)%>%, 대차:<%=ma_bean.getIns_car_no()%><%}%>
