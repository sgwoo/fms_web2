                        ...
                        <td colspan="3"> 
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr> 
                              ...
                              <td colspan="5" height="22" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid"><font size="1"><%//=AddUtil.parseDecimal(ma_bean.getIns_day_amt())%>원(일)*<%//=ma_bean.getIns_use_day()%>일*<%if(ti.getGubun().equals("11")){%>과실<%=Math.abs(a_bean.getOur_fault_per()-100)%>%, 대차:<%//=ma_bean.getIns_car_no()%><%}%></font></td>
