...
<body>
<form action="./issue_2_sc.jsp" name="form1" method="POST">
  ...
  <table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr> 
      ...
      <td width="45%"><img src="/acar/images/center/arrow_jr.gif" align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        내림차순 </td>
      <td width="10%" align="right"><a href="javascript:Search()"><img src="/acar/images/center/button_search.gif" align="absmiddle" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      </td>
    </tr>
  </table>
</form>
