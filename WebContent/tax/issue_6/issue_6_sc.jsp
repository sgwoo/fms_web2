...
<table width=100% border=0 cellpadding=0 cellspacing=0>
                    ...
                    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                        ...
                        <tr>
            			  ...
            			  <input type="hidden" name="i_site_id" value="<%//=site_id%>">
            				...
            				<%}%>  
            		          <option value='00,<%=client.getFirm_nm()%>,<%=client.getClient_nm()%>,<%=client.getO_addr()%>,<%=client.getBus_cdt()%>,<%=client.getBus_itm()%>' selected><%=client.getEnp_no1()%>-<%=client.getEnp_no2()%>-<%=client.getEnp_no3()%> 본사</option>				  
            					<%	for(int i = 0 ; i < c_site_size ; i++){
            							ClientSiteBean site = (ClientSiteBean)c_sites.elementAt(i);%>	  		
            
            			      <option value='<%=site.getSeq()%>,<%=site.getR_site()%>,<%=site.getSite_jang()%>,<%=site.getAddr()%>,<%=site.getBus_itm()%>,<%=site.getBus_cdt()%>'><%=AddUtil.ChangeSsn(AddUtil.ChangeEnp(site.getEnp_no()))%> <%=Util.subData(site.getR_site(), 15)%></option>
                      			<%	}%>
            		        </select>			 			    
            			    </td>
                          </tr>
                        <tr>
                          ...
                          <td colspan="3">&nbsp;<input type="text" name="i_firm_nm" size="50" value="<%=client.getFirm_nm()%>" class="whitetext" readonly></td>
                          </tr>
                        <tr>
                          <td class='title'>성명</td>
                          <td colspan="3">&nbsp;<input type="text" name="i_client_nm" size="50" value="<%=client.getClient_nm()%>" class="whitetext" readonly></td>
                          </tr>
                        <tr>
                          <td class='title'>사업장주소</td>
                          <td colspan="3">&nbsp;<input type="text" name="i_addr" size="50" value="<%=client.getO_addr()%>" class="whitetext" readonly></td>
                        </tr>
                        <tr>
                          <td class='title'>업태</td>
                          <td width="30%">&nbsp;<input type="text" name="i_sta" size="16" value="<%=client.getBus_cdt()%>" class="whitetext" readonly></td>
                          <td width="15%" class='title'>종목</td>
                          <td width="35%">&nbsp;<input type="text" name="i_item" size="20" value="<%=client.getBus_itm()%>" class="whitetext" readonly></td>
                        </tr>
                </table>
           </td>
          <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2" class="line">
        ...
        <tr align="center" bgcolor="#CCCCCC">
          ...
          <td width="10%" rowspan="2" bgcolor="#CCCCCC" style="border-top: #000000 1px solid; border-left: #000000 1px solid; border-bottom: #000000 1px solid">차명</td>
          ...
          <td rowspan="2" width="15%" style="border-top: #000000 1px solid; border-left: #000000 1px solid; border-bottom: #000000 1px solid; border-right: #000000 1px solid;">비고</td>
        </tr>
        <tr>
          <td height="10" width="10%" bgcolor="#CCCCCC" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid">~부터</td>
          <td height="10" width="10%" bgcolor="#CCCCCC" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid">~까지</td>
        </tr>
		<%for(int i =0; i<15; i++){%>
        ...
        <tr>
          ...
          <td height="22" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid"><span class="ledger_contC">
            <input type="text" name="item_car_nm" size="12" value="" class="taxtext">
          </span></td>
          <td height="22" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid"><span class="ledger_contC">
          ...
          <td height="22" align="center" style="border-left: #000000 1px solid; border-bottom: #000000 1px solid; border-right: #000000 1px solid"><span class="ledger_contC">
            <input type="text" name="item_etc" size="20" value="" class="taxtext">
			</span></td>
        </tr>
		<%}%>	
        <tr>
    ...
    <tr>
      <td colspan="2" class="line"><table border="0" cellspacing="1" cellpadding="0" width='100%'>
        ...
        <tr>
          <td width='10%' class='title'>계산서품목표시구분</td>
          <td width='90%'>&nbsp;
		      <input type="radio" name="etax_item_st" value="1" checked>
              한줄만 표시 &nbsp;
              <input type="radio" name="etax_item_st" value="2" >
              모두 표시 (거래명세서에 있는 품목이 계산서에 모두 표시됩니다.)&nbsp;
			  </td>
          </tr>
      </table></td>
    </tr>				
