...
<body>
<form action="./tax_mng_sc.jsp" name="form1" method="POST">
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr> 
      ...
      <td width="35%"><img src="/acar/images/center/arrow_jr.gif" align=absmiddle>&nbsp; 
        ...
        내림차순 </td>
      <td width="25%"><a href="javascript:Search()"><img src="/acar/images/center/button_search.gif" align="absmiddle" border="0"></a></td>
    </tr>
  </table>
</form>
</body>
