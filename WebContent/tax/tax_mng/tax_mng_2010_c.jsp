		...
		<td colspan=10>
			<table width=100% border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>재무회계 > 세금계산서관리 > 세금계산서보관함5년전 > <span class=style5>
						세금계산서</span></span></td>
      ...
      <td colspan="2">
        ...
        <table style="BORDER-COLLAPSE: collapse" cellspacing=0 bordercolordark=white cellpadding=0 width=100% bordercolorlight=#0166a9>
          <tbody>
			...
			<%if(ti_bean.getEtax_item_st().equals("2")){//항목 모두 표시%>
