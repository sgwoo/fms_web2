...
%>
<form name='form1' action='tax_mng_2010_c.jsp' method='post' target='d_content'>
...
<input type='hidden' name="from_page" value="/tax/tax_mng/tax_mng_2010_sc.jsp">

  <table border="0" cellspacing="0" cellpadding="0" width=100%>
    <tr> 
      <td height="<%=height%>"><iframe src="tax_mng_2010_sc_in.jsp<%=hidden_value%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 > 
