...
<!--
	...
	function select(client_id){		
		...
		<%}else if(go_url.equals("/fms2/prosecution_doc_reg/prosecution_doc_reg_sc.jsp")){%>
			opener.parent.c_foot.location.href = "<%=go_url%>&client_id="+client_id+"&firm_nm=<%=t_wd%>";
		<%}else{%>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
    ...
    <tr> 
      <td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <% if(go_url.equals("/fms2/credit/settle_doc_reg_sc.jsp")){ %> 
