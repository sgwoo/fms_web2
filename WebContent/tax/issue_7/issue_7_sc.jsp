...
<%@ page import="java.util.*, acar.util.*, acar.fee.*, acar.common.*, tax.*, acar.bill_mng.*, acar.car_office.*"%>
...
<%
	...
	//세금계산서 수신자 - 지점장
	CarOffEmpBean coe_bean = cod.getCarOffEmpBean(car_off_id, co_bean.getManager());
%>
...
<%@ include file="/include/search_hidden.jsp" %>
  ...
  <input type="hidden" name="doc_st" value="1">
...
<table width=100% border=0 cellpadding=0 cellspacing=0>
                ...
                <td class="line">
                    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                        ...
                        <tr>
            			  ...
            			  <select name='i_enp_no'>
            		              <option value='<%=ven.get("S_IDNO")%>' selected><%=ven.get("S_IDNO")%></option>				  
            		          </select>			 			    
            		  </td>
                        </tr>
                        <tr>
                          <td class='title'>상호(법인명)</td>
                          <td colspan="3">&nbsp;<input type="text" name="i_firm_nm" size="50" value="<%=ven.get("CUST_NAME")%>" class="whitetext" readonly></td>
                          </tr>
                        <tr>
                          <td class='title'>성명</td>
                          <td colspan="3">&nbsp;<input type="text" name="i_client_nm" size="50" value="<%=ven.get("DNAME")%>" class="whitetext" readonly></td>
                          </tr>
                        <tr>
                          <td class='title'>사업장주소</td>
                          <td colspan="3">&nbsp;<input type="text" name="i_addr" size="50" value="<%=ven.get("S_ADDRESS")%>" class="whitetext" readonly></td>
                        </tr>
                        <tr>
    ...
    <tr>
      <td colspan="2" class="line">
        ...
        <tr>
          ...
          <td width='20%'>&nbsp;<input type='text' size='15' name='con_agnt_nm' value='<%//=co_bean.getAgnt_nm()%><%=coe_bean.getEmp_nm()%>' maxlength='20' class='text'></td>
          <td width="10%" class='title'>근무부서</td>
          <td width="20%">&nbsp;
              <input type='text' size='15' name='con_agnt_dept' value='' maxlength='15' class='text'></td>
          <td width="10%" class='title'>직위</td>
          <td width="30%">&nbsp;
              <input type='text' size='15' name='con_agnt_title' value='' maxlength='10' class='text'></td>
          </tr>
        <tr>
          <td class='title'>EMAIL</td>
          <td colspan='3'>&nbsp;<input type='text' size='40' name='con_agnt_email' value='<%=co_bean.getAgnt_email()%><%//=coe_bean.getEmp_email()%>' maxlength='30' class='text' style='IME-MODE: inactive'></td>
          <td class='title'>이동전화</td>
          <td>&nbsp;
              <input type='text' size='15' name='con_agnt_m_tel' value='<%//=co_bean.getAgnt_m_tel()%><%=coe_bean.getEmp_m_tel()%>' maxlength='15' class='text'></td>
          </tr>
      </table></td>
    </tr>	
    <tr>
    ...
    <input type="hidden" name="car_use" value="4">
    <!--
    <tr>
