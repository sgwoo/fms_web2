...
<%
	...
	out.println("세금계산서 캐쉬백수익 발행하기 1단계"+"<br><br>");
	...
	for(int i=0;i < vid_size;i++){
		...
		if(til_bean.getItem_supply() >0 || til_bean.getItem_supply() <0){
			...
			//gubun = 1 대여료, 2 보증금, 3 선납금, 4 개시대여료, 5 위약금, 6 차량매각대금, 7 정비비, 8 과태료, 9 self, 10 보험대차, 11 대차료, 12 휴차료, 13 업무대여, 14 승계수수료, 15 해지관련, 16 월렌트, 17 정비대차, 18 캐쉬백수익 , null=직접발행
		}
	}
