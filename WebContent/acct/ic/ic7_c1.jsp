...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ic7_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ic7_c1'>
  <input type='hidden' name='value_size' value='4'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제마감 > 전산관리Cycle > <span class=style5>사용자권한부여요청서</span></span></td>
		...
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
					<tr>
					  ...
					  <td class="title" colspan="2" rowspan="1">계정등록/권한부여 요청서</td>
					  <td class="title" colspan="2" rowspan="1">계정등록/권한부여 요청서</td>
					</tr>
					<tr>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='50' name='value3' class='text' value=""></td>
					  <td align='center'><input type='text' size='50' name='value4' class='text' value=""></td>
					</tr>
					<%}%>
					<%}%>
					<%if( vt.size() > 0){%>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='50' name='value3' class='text' value="<%=ht.get("VALUE3")%>"></td>
					  <td align='center'><input type='text' size='50' name='value4' class='text' value="<%=ht.get("VALUE4")%>"></td>
					</tr>
					<%}%>
					<%}%>
			</table>
