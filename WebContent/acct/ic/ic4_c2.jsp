...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ic4_c2");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
	...
	<input type='hidden' name='acct_st' 	value='ic4_c2'>
	<input type='hidden' name='value_size' value='7'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제마감 > 전산관리Cycle > <span class=style5>백업매체접근통제</span></span></td>
		...
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
					<tr>
					  ...
					  <td class="title" colspan="2" rowspan="1">복구작업결과서</td>
					  <td class="title" colspan="4" rowspan="1">정보시스템복구요청서</td>
					  <td class="title" colspan="3" rowspan="1">이상발생시</td>
					</tr>
					<tr>
					  <td class="title">일자</td>
					  <td class="title">작업자</td>
					  <td class="title">복구요청자</td>
					  <td class="title">복구요청일</td>
					  <td class="title">복구요청사유</td>
					  <td class="title">복구유무</td>
					  <td class="title">원인</td>
					  <td class="title">추후 조치 계획</td>
					  <td class="title">조치 완료 여부</td>
					</tr>
					<%if( vt.size() == 0){%>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='10' name='value1' class='text' value=""></td>
					  <td align='center'><input type='text' size='10' name='value2' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value3' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value4' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value5' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value6' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value7' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value8' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value9' class='text' value=""></td>
					</tr>
					<%}%>
					<%}%>
					<%if( vt.size() > 0){%>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='10' name='value1' class='text' value="<%=ht.get("VALUE1")%>"></td>
					  <td align='center'><input type='text' size='10' name='value2' class='text' value="<%=ht.get("VALUE2")%>"></td>
					  <td align='center'><input type='text' size='15' name='value3' class='text' value="<%=ht.get("VALUE3")%>"></td>
					  <td align='center'><input type='text' size='15' name='value4' class='text' value="<%=ht.get("VALUE4")%>"></td>
					  <td align='center'><input type='text' size='15' name='value5' class='text' value="<%=ht.get("VALUE5")%>"></td>
					  <td align='center'><input type='text' size='15' name='value6' class='text' value="<%=ht.get("VALUE6")%>"></td>
					  <td align='center'><input type='text' size='15' name='value7' class='text' value="<%=ht.get("VALUE7")%>"></td>
					  <td align='center'><input type='text' size='15' name='value8' class='text' value="<%=ht.get("VALUE8")%>"></td>
					  <td align='center'><input type='text' size='15' name='value9' class='text' value="<%=ht.get("VALUE9")%>"></td>
					</tr>
					<%}%>
					<%}%>
			</table>
