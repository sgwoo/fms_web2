...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ic4_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
	...
	<input type='hidden' name='acct_st' value='ic4_c1'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제마감 > 전산관리Cycle > <span class=style5>주기적백업및문서화</span></span></td>
		...
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
					<tr>
					  ...
					  <td class="title" colspan="1" rowspan="2">영업일</td>
					  <td class="title" colspan="6" rowspan="1">일일작업일지</td>
					</tr>
					<tr>
					  <td class="title">작업결과</td>
					  <td class="title">백업담당자</td>
					  <td class="title">백업결과<br>(이상유무)</td>
					  <td class="title">이상이 발생한 경우<br> 그 원인</td>
