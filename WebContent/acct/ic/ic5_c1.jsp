...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ic5_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ic5_c1'>
  <input type='hidden' name='value_size' value='9'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제마감 > 전산관리Cycle > <span class=style5>장애관리대장작성</span></span></td>
		...
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
					<tr>
					  ...
					  <td class="title" colspan="3" rowspan="1">장애관리대장</td>
					  <td class="title" colspan="6" rowspan="1">장애관리대장</td>
					</tr>
					<tr>
					  ...
					  <td class="title">정보지원부서장 주기적 검토여부<br>(검토후 확인날인 여부)</td>
					</tr>
					<%if( vt.size() == 0){%>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='10' name='value3' class='text' value=""></td>
					  <td align='center'><input type='text' size='10' name='value4' class='text' value=""></td>
					  <td align='center'><input type='text' size='10' name='value5' class='text' value=""></td>
					  <td align='center'><input type='text' size='10' name='value6' class='text' value=""></td>
					  <td align='center'><input type='text' size='15' name='value7' class='text' value=""></td>
					  <td align='center'><input type='text' size='20' name='value8' class='text' value=""></td>
					  <td align='center'><input type='text' size='35' name='value9' class='text' value=""></td>
					</tr>
					<%}%>
					<%}%>
					<%if( vt.size() > 0){%>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='10' name='value3' class='text' value="<%=ht.get("VALUE3")%>"></td>
					  <td align='center'><input type='text' size='10' name='value4' class='text' value="<%=ht.get("VALUE4")%>"></td>
					  <td align='center'><input type='text' size='10' name='value5' class='text' value="<%=ht.get("VALUE5")%>"></td>
					  <td align='center'><input type='text' size='10' name='value6' class='text' value="<%=ht.get("VALUE6")%>"></td>
					  <td align='center'><input type='text' size='15' name='value7' class='text' value="<%=ht.get("VALUE7")%>"></td>
					  <td align='center'><input type='text' size='20' name='value8' class='text' value="<%=ht.get("VALUE8")%>"></td>
					  <td align='center'><input type='text' size='35' name='value9' class='text' value="<%=ht.get("VALUE9")%>"></td>
					</tr>					
					<%}%>
					<%}%>
			</table>
