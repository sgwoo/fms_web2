...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ic6_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ic6_c1'>
  <input type='hidden' name='value_size' value='5'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제마감 > 전산관리Cycle > <span class=style5>시스템보안정책수립검토</span></span></td>
		...
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
					<tr>
					  ...
					  <td class="title">문서화된 보안<br>정책 징구여부	</td>
					  <td class="title">보안정책 경영진<br> 승인여부</td>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='25' name='value1' class='text' value=""></td>
					  <td align='center'><input type='text' size='25' name='value2' class='text' value=""></td>
					  <td align='center'><input type='text' size='25' name='value3' class='text' value=""></td>
					  <td align='center'><input type='text' size='25' name='value4' class='text' value=""></td>
					  <td align='center'><input type='text' size='25' name='value5' class='text' value=""></td>
					</tr>
					<%}%>
					<%}%>
					<%if( vt.size() > 0){%>
					...
					<tr>
					  <td align='center'><%=i+1%></td>
					  <td align='center'><input type='text' size='25' name='value1' class='text' value="<%=ht.get("VALUE1")%>"></td>
					  <td align='center'><input type='text' size='25' name='value2' class='text' value="<%=ht.get("VALUE2")%>"></td>
					  <td align='center'><input type='text' size='25' name='value3' class='text' value="<%=ht.get("VALUE3")%>"></td>
					  <td align='center'><input type='text' size='25' name='value4' class='text' value="<%=ht.get("VALUE4")%>"></td>
					  <td align='center'><input type='text' size='25' name='value5' class='text' value="<%=ht.get("VALUE5")%>"></td>
					</tr>	
					<%}%>
					<%}%>
			</table>
