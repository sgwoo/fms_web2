...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getPc2C2List(st_dt, end_dt, s_cnt, "2");
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='pc2_c2'>
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 사후관리Cycle > <span class=style5>중도해지 입금전표  승인</span></span></td>
	...
	<td class='line'>
		<table border="0" cellspacing="1" cellpadding="0" width="100%">
			...
			%>
			  ...
			  <input type='hidden' name="value2" 	value="<%=ht.get("CLS_DT")%>">
			  ...
			  <input type='hidden' name="value7" 	value="<%=ht.get("FIRM_NM")%>">	
		<!--	  <input type='hidden' name="value8" 	value=""> -->
			  ...
			  <tr>
			   ...
			   <td align='center'><%=ht.get("RENT_L_CD")%>&nbsp; &nbsp;&nbsp;<%=ht.get("CLS_DT")%></td>         
			   <td align='center'><%=ht.get("FIRM_NM")%></td>	   
		            <td align='center'><input type='text' size='30' name='value8' class='text'></td>	    
