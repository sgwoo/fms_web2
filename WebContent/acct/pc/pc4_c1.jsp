...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getPc4C1List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='pc4_c1'>
  <input type='hidden' name='value_size' value='8'>
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 사후관리Cycle > <span class=style5>채권회수 입금전표  승인</span></span></td>
	...
	<td class='line'>
		<table border="0" cellspacing="1" cellpadding="0" width="100%">
			...
			%>
			  ...
			  <input type='hidden' name="value2" 	value="<%=ht.get("INCOM_DT")%>">
			  <input type='hidden' name="value3" 	value="<%=ht.get("FIRM_NM")%>">
			  <input type='hidden' name="value4" 	value="<%=ht.get("ROW_ID")%>">
		<!--	  <input type='hidden' name="value5" 	value=""> -->
			  ...
			  <tr>
			   ...
			   <td align='center'><%=ht.get("RENT_L_CD")%>&nbsp; &nbsp;&nbsp;<%=ht.get("INCOM_DT")%></td>         
			   <td align='center'><%=ht.get("FIRM_NM")%></td>	   
		       <td align='center'><%=ht.get("ROW_ID")%></td>	    
		            <td align='center'><input type='text' size='20' name='value5' class='text'></td>     		                 
			    <td align='center'> </td>
			  </tr>
			  <%	}%>
		</table>
   ...
   <tr>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td width="80%">&nbsp;
	      채권회수입금전표를 샘플추출하여 정당한 인사총무팀장의 승인여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
