...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getPc5C1List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='pc5_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 사후관리Cycle > <span class=style5>고소장승인</span></span></td>
      ...
      <td>
        <table border=0 cellspacing=1>
	      ...
	      <input type='text' size='12' name='st_dt' class='text' value='<%=AddUtil.ChangeDate2(st_dt)%>' onBlur='javscript:this.value = ChangeDate(this.value);'>
              ...
              <!--검색버튼-->
              &nbsp;&nbsp;&nbsp;&nbsp;
              <a id="submitLink"  href="javascript:Search();"><img src=/acct/images/center/button_search.gif align=absmiddle border=0></a>
              <!--출력버튼-->
              <%if(vt_size>0){%>
              &nbsp;&nbsp;&nbsp;&nbsp;
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="65%">계약자</td>	    
	  ...
	  <%	for(int i = 0 ; i < vt_size ; i++){
			...
			if(String.valueOf(ht.get("USER_NM3")).equals("")){
			//	exception_cnt++;
			}
			
			%>
          <input type='hidden' name="seq" 	value="<%=i+1%>">
	  <input type='hidden' name="value1" 	value="<%=ht.get("FIRM_NM")%>">
	  <input type='hidden' name="value2" 	value="<%=ht.get("USER_NM3")%>">
	  <input type='hidden' name="value3" 	value="<%=ht.get("USER_DT3")%>">
	  ...
	  <tr>
	    ...
	    <td align='center'><%=ht.get("FIRM_NM")%></td>            
            ...
            <td align='center'><%=ht.get("USER_DT3")%></td>     
	      <!--
	    <td align='center'>
	      <select name="result">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      당기중 고소장을 샘플링하여 전결권자의 승인여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
