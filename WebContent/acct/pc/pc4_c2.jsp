...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getPc4C2List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='pc4_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 사후관리Cycle > <span class=style5>대손품의서승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <input type='hidden' name="value3" 	value="<%=ht.get("CAR_NO")%>">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      당기 채권 상각내역 중 Sampling하여 대손품의서 상에 전결권자의 승인이 있는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
