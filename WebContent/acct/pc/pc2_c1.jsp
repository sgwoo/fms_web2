      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 사후관리Cycle > <span class=style5>중도해지 승인품의서 승인</span></span></td>
   ...
   <tr>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td width="80%">&nbsp;
	      C1/중도해지 승인품의서에 대한 승인</td>	    
	  </tr>     
	  <tr>
	    <td class="title" width="20%">테스트 절차</td>
	    <td width="80%">&nbsp;
	      평가기간 중 중도해지 계약건을 샘플링하여 해당건의 중도해지 승인품의서에 대하여 승인품의서에 대하여 전결권자가 승인하였는지 여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
