...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getPc1C4List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='pc1_c4'>
  <input type='hidden' name='value_size' value='3'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 사후관리Cycle > <span class=style5>청구수납전표승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="20%">계산서작성일자</td>
	    <td class="title" width="45%">공급받는자</td>	    
	    <td class="title" width="30%">전표번호</td>	
	  ...
	  <input type='hidden' name="value1" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("TAX_DT")))%>">
	  <input type='hidden' name="value2" 	value="<%=ht.get("RECCONAME")%>">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      대여료 청구후 발생하는 미수금 전표중 Sampling하여 전결권자(부서장)의 승인을 득하였는지 여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
