...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getPc2C2List(st_dt, end_dt, s_cnt, "1");
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='pc3_c2'>
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 사후관리Cycle > <span class=style5> 계약의만료 입금전표 승인</span></span></td>
	...
	<td class='line'>
		<table border="0" cellspacing="1" cellpadding="0" width="100%">
			...
			%>
			  ...
			  <input type='hidden' name="value7" 	value="<%=ht.get("CLS_DT")%>">			
   ...
   <tr>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td width="80%">&nbsp;
	      해당기간 중 대여계약이 만료된 건 중 1건을 샘플링하여 매각품의서에 전결권자가 승인하였는지 여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
