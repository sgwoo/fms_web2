...
%>
    <tr> 
	  ...
	  <td align="right">
    	...
    	<%}%>
		<span class="b"><a href="javascript:MM_openBrWindow('list/010103_s4.jsp','popwin_in','scrollbars=yes,status=yes,resizable=yes,width=520,height=400,left=50, top=50')">&nbsp;매각결정&nbsp;</a></span>
		<span class="b"><a href="javascript:MM_openBrWindow('list/010103_s4.jsp','popwin_in','scrollbars=yes,status=yes,resizable=yes,width=520,height=400,left=50, top=50')">&nbsp;재리스결정&nbsp;</a></span>		
		<span class="b"><a href="javascript:MM_openBrWindow('list/010103_s4.jsp','popwin_in','scrollbars=yes,status=yes,resizable=yes,width=520,height=400,left=50, top=50')">&nbsp;기타결정&nbsp;</a></span> </td>
    </tr>
<%if(print_yn.equals("Y")){%>	
