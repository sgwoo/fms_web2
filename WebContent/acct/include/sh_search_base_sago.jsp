...
//-->
  ...
  <form name="form1" method="post" action="">
    ...
    <td <%if(!colspan.equals("")){%>colspan='<%=colspan%>'<%}%>> 과실구분: 
      <select name="s_gubun">
          <option value="1">피해</option>
          <option value="2">가해</option>
		  <option value="3">단독</option>
        </select>
      과실율: 
      <select name="s_gubun2">	  
        <option value="0">선택</option>
		<option value="1">일방</option>
        <option value="2">쌍방</option>
      </select>
      검색: 
      <select name="s_kd">
