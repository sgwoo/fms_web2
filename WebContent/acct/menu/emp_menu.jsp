...
<link rel=stylesheet type="text/css" href="/acct/include/index.css">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr> 
                <td valign="top" align=right> 
                    <table width=162 cellspacing=0 cellpadding=0 border=0 height=100% background=/acct/images/sub_m_bg.gif>
                        <tr>
                            <td>
                                <table width=162 cellspacing=0 cellpadding=0 border=0 background=/acct/images/sub_m_img1.gif>
                                    <tr>
                                        <td height=2></td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td>
                                <table width=162 cellspacing=0 cellpadding=0 border=0  background=/acct/images/sub_m_img3.gif>
                                    <tr>
                                        <td height=2></td>
                                    </tr>
                                    <tr>
                        ...
                        <tr> 
                          <td height=1 align=center><img src=/acct/images/sub_m_line.gif height=1></td>
                        </tr>
                        <%	}%>
                        <tr>
                            <td height=10></td>
                        ...
                        <tr> 
                          <td><img src=/acct/images/sub_m_img4.gif></td>
                        </tr>
                    </table>
                </td>
            </tr> 
