...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getRc1C1List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='rc1_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 영업Cycle > <span class=style5>외부신용정보검토</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="30%">계약자</td>
	    <td class="title" width="20%">외부신용정보조회기관</td>
	    <td class="title" width="15%">조회일자</td>
	    <!--<td class="title" width="10%">평가</td>-->
	  </tr>
	  <%	for(int i = 0 ; i < vt_size ; i++){
			Hashtable ht = (Hashtable)vt.elementAt(i);	
			
			if(String.valueOf(ht.get("EVAL_OFF_NM")).equals("")){
			//	exception_cnt++;
			}
	  ...
	  <input type='hidden' name="value4" 	value="<%=ht.get("EVAL_OFF_NM")%>">
	  <input type='hidden' name="value5" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("EVAL_S_DT")))%>">
	  ...
	  <tr>
	    ...
	    <td align='center'><%=ht.get("RENT_L_CD")%></td>            
            ...
            <td align='center'><%=ht.get("EVAL_OFF_NM")%></td>
            <td align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("EVAL_S_DT")))%></td>
	      <!--
	    <td align='center'>
	      <select name="result">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      신규 대여의 경우 외부신용정보조회를 수행하는지 관찰한다.</td>	    
	  </tr>     
	</table>
      </td>
    </tr>	       
