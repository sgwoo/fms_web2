...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getRc1C2List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='rc1_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 영업Cycle > <span class=style5>대여요청마감승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="15%">적용심사등급</td>
	  ...
	  <%	for(int i = 0 ; i < vt_size ; i++){
			...
			if(!String.valueOf(ht.get("USER_ID")).equals(nm_db.getWorkAuthUser("본사영업팀장"))){
			//	exception_cnt++;
			}
	  ...
	  <input type='hidden' name="value4" 	value="<%=ht.get("DEC_GR_NM")%>">
	  <input type='hidden' name="value5" 	value="<%=ht.get("DEC_F_ID_NM")%>">
	  <input type='hidden' name="value6" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("DEC_F_DT")))%>">
	  ...
	  <tr>
	    ...
	    <td align='center'><%=ht.get("RENT_L_CD")%></td>            
            ...
            <td align='center'><%=ht.get("DEC_GR_NM")%></td>
            <td align='center'><%=ht.get("DEC_F_ID_NM")%></td>            
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      사전신용조사를 거친 대여요청건에 대해 일마감승인된 품의서를 징구하여 전결권자의 승인을 얻었는지 문서검사를 한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
