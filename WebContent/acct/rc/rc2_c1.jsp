...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getRc2C1List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='rc2_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 영업Cycle > <span class=style5>대여계약체결승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="35%">계약자</td>
	  ...
	  <%	for(int i = 0 ; i < vt_size ; i++){
			...
			if(String.valueOf(ht.get("SANCTION_DATE")).equals("")){
			//	exception_cnt++;
			}
	  ...
	  <input type='hidden' name="value2" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("RENT_DT")))%>">
	  <input type='hidden' name="value3" 	value="<%=ht.get("FIRM_NM")%>">
	  <input type='hidden' name="value4" 	value="<%=ht.get("SANCTION_ID_NM")%>">
	  <input type='hidden' name="value5" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("SANCTION_DATE")))%>">
	  ...
	  <tr>
	    ...
	    <td align='center'><%=ht.get("RENT_L_CD")%></td>            
            ...
            <td align='center'><%=ht.get("SANCTION_ID_NM")%></td>            
            <td align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("SANCTION_DATE")))%></td>
	      <!--
	    <td align='center'>
	      <select name="result">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      당기 계약 실행 건 중 1건을 샘플링하여 동 건과 관련된 계약체결(FMS) 전결권자의 승인이 있는지 검토한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
