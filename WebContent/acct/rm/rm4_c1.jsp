...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getRm4C1List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='rm4_c1'>
  <input type='hidden' name='value_size' value='2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 대여차량관리Cycle > <span class=style5>차량출고실사확인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="25%">문서번호</td>
	    <td class="title" width="70%">승인유무</td>
	  ...
	  <%	for(int i = 0 ; i < vt_size ; i++){
          ...
          <input type='hidden' name="value1" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("IO_DT")))%>"> 		  	  
	  ...
	  <tr>
	    ...
	    <td align="center"><%=AddUtil.ChangeDate2(String.valueOf(ht.get("IO_DT")))%></td>            
	    <td>&nbsp;<input type='text' size='100' name='value2' class='text' value=""></td>            
	      <!--
	    <td align='center'>
	      <select name="result">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      총무팀담당자가 매일 업무시간 종료전 FMS상 주차장현황과 실제주차차량을 실사하여 일치하는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
