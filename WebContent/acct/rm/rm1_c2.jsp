...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getRm1C2List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='rm1_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 대여차량관리Cycle > <span class=style5>차량구매전표승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <input type='hidden' name="value5" 	value="<%=ht.get("AUTODOCU_WRITE_DATE")%>(<%=ht.get("AUTODOCU_DATA_NO")%>)">
	  <input type='hidden' name="value6" 	value="<%=ht.get("USER_NM2")%>">
	  <input type='hidden' name="value7" 	value="<%=ht.get("USER_DT2")%>">			
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      대여차량 구매 전표를 샘플링하여 정당한 전결권자의 승인여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
