...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='rm5_c3'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 대여차량관리Cycle > <span class=style5>매각입금전표승인</span></span></td>
  ...
  <tr>
		...
		<td class='line'>
			...
			%>
			   ...
			   <tr>
			      ...
			      <td>&nbsp;<input type='text' size='50' name='value1' class='text' value=""></td>  
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	       처분 입금전표를 샘플추출하여 정당한 총무팀장의 승인여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
