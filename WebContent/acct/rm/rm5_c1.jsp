...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getRm5C1List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='rm5_c1'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 대여차량관리Cycle > <span class=style5>경매출품승인</span></span></td>
   ...
   <tr>
    ...
    <tr>
		<td class='line'>
			...
			%>
			          ...
			          <input type='hidden' name="value1" 	value="<%=String.valueOf(ht.get("CAR_NO"))%>"> 	  
			          <input type='hidden' name="value2" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("ACTN_DT")))%>"> 	  
			    ...
			    <td align="center"><%=i+1%></td>
			     <td align="center"><%=String.valueOf(ht.get("CAR_NO"))%></td>       
			    <td align="center"><%=AddUtil.ChangeDate2(String.valueOf(ht.get("ACTN_DT")))%></td>            
			    <td>&nbsp;<input type='text' size='50' name='value3' class='text' value=""></td>            
			    <td>&nbsp;<input type='text' size='50' name='value4' class='text' value=""></td>            
			  </tr>
	  <%	}%>
	</table>
      </td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      C2/탁송신청서, 출품신청서, 인수증의 승인 </td> 
	  </tr>     
	  <tr>
	    <td class="title">테스트 절차</td>
	    <td>&nbsp;
	       차량처분건을 선택 후 자산 처분의 탁송신청서, 출품신청서, 인수증을 검토하여 전결권자의 승인여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
