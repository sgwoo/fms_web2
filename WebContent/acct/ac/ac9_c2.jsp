...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac9_c2");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac9_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>원천세신고납부승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" colspan="2">원천징수 전자신고서</td>
	    <td class="title" colspan="2">원천징수전표</td>	    
	    <td class="title" rowspan="2" width="21%">일치여부</td>
	    <!--<td class="title" width="10%">평가</td>-->	    
	  </tr>
	  <tr>
	    <td class="title" width="18%">일자</td>	    
	    <td class="title" width="18%">금액</td>
	    <td class="title" width="18%">금액</td>
	    <td class="title" width="20%">승인여부</td>
	  </tr>
	  <%if( vt.size() == 0){%>					
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      원천세신고납부 전표를 샘플추출하여 인사총무팀장의 승인여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
