...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac7_c2");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac7_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>법인세신고납부승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="20%">법인세관련<br>전표번호</td>
	    <td class="title" width="15%">법인세관련<br>납부일자</td>
	    <td class="title" width="15%">법인세납부<br>전표의 금액</td>
	    <td class="title" width="15%">법인세신고<br>확인증의 금액</td>
	    <td class="title" width="15%">일치여부</td>	
	    <td class="title" width="15%">전결권자의<br>승인여부</td>	
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      세금관련 신고서 및 품의서에 대하여 전결권자의 승인을 받았는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
