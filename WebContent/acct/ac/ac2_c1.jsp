...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac2_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac2_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>전표입력정확성증빙확인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" colspan="3">전표집계표</td>
	    <td class="title" rowspan="2" width="20%">ERP상 전표개수(B)</td>
	    <td class="title" rowspan="2" width="20%">현업부서장 승인여부</td>
	    <td class="title" rowspan="2" width="20%">일치여부(A)=(B)</td>
	    <!--<td class="title" width="10%">평가</td>-->	    
	  </tr>
	  <tr>
	    <td class="title" width="10%">일자</td>
	    <td class="title" width="10%">발행부서</td>
	    <td class="title" width="15%">전표개수(A)</td>
	  </tr>
	   <%if( vt.size() == 0){%>					
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      C1/전표입력의 정확성 및 증빙 확인</td> 
	  </tr>     
	  <tr>
	    <td class="title">테스트 절차</td>
	    <td>&nbsp;
	      평가대상 기간의 전표 승인일을 모집단으로 정의한다. 전표 승인일을 표본크기에 따라 임의로 샘플링한다.<br>
	      &nbsp;
	      증빙과 전표금액의 일치여부를 확인하고, 승인처리가 이루어진 건이 총무팀장에 의해 검토되었으며, 수정 처리건에 대해 총무팀장의 확인이 이루어진 후에 <br>
	      &nbsp;
	      승인처리 되었는지 확인한다. 	      
	    </td>	    
	  </tr>     
