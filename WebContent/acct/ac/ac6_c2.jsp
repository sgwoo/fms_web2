...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac6_c2");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac6_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>감가상각비정확성검토</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      FMS상 등록된 감가상각자산에 대하여 취득일자, 취득가액에 대하여 Random sampling을 수행한다.<br>
	      &nbsp;
	      선택된 Sample에 대하여 차량등록증, 매입세금계산서를 대사하여 관련 내용이 정확히 등록되어 있는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
