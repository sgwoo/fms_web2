...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac4_c2");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac4_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>퇴직연금적정성확인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="20%">전표금액(A)</td>
	    <td class="title" width="20%">퇴직급여충당금집계표금액(B)</td>
	    <td class="title" width="15%">일치여부(A)=(B)</td>
	    <td class="title" width="10%">승인여부</td>	
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      C2/퇴직연금 납부대상자의 완전성 및 납부액 계산의 적정성 및 승인
	    </td> 
	  </tr>     
	  <tr>
	    <td class="title">테스트 절차</td>
	    <td>&nbsp;
	      평가대상기간동안의 은행제출자료를 징구하여 해당건의 월(月)을 샘플링한다.<br>
	      &nbsp;
	      해당 은행제출자료와 급여프로그램상의 연봉액을 비교대사하여 적정성을 확인한다. <br>
	      &nbsp;
	      은행제출자료에 대한 전결권자의 승인이 이루어졌는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
