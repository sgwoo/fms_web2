...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac3_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac3_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>결산보정항목계산정확성</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" colspan="3">전표</td>
	    <td class="title" colspan="2">관련증빙</td>
	    <td class="title" rowspan="2" width="15%">일치여부(A)=(B)</td>
	    <td class="title" rowspan="2" width="10%">승인여부</td>	    
	    <!--<td class="title" width="10%">평가</td>-->	    
	  </tr>
	  <tr>
	    <td class="title" width="10%">해당월 or 분기</td>
	    <td class="title" width="21%">계정</td>
	    <td class="title" width="12%">금액(A)</td>
	    <td class="title" width="20%">계정</td>
	    <td class="title" width="12%">금액(B)</td>
	  </tr>
	    <%if( vt.size() == 0){%>					
			...
			<tr>
			  ...
			  <td align='center'><input type='text' size='20' name='value7' class='text' value=""></td>
			</tr>
	<%}%>
	<%}%>
	<%if( vt.size() > 0){%>
	...
	<tr>
	  ...
	  <td align='center'><input type='text' size='20' name='value7' class='text' value="<%=ht.get("VALUE7")%>"></td>
	</tr>
	<%}%>
	<%}%>
	</table>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      C1,C2/결산보정항목 계산의 정확성
	    </td> 
	  </tr>     
	  <tr>
	    <td class="title">테스트 절차</td>
	    <td>&nbsp;
	      평가대상기간 중의 월별 FMS 계산금액을 산출한다. 월별 결산 보정 계산금액과 부가세신고서, 보험료고지서, 자동차세고지서와 대사한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
