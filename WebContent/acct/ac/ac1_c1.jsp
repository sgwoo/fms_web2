...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac1_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac1_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>계정과목변경신천서승인</span></span></td>
    ...
    <tr>
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
				<tr>
					<td class="title" colspan="1" rowspan="2" width="5%">No.</td>
					<td class="title" colspan="6" rowspan="1">회계정책/계정과목 신설/변경신청서</td>
				<!--<td class="title" width="10%">평가</td>-->	    
				</tr>
				<tr>
				<td class="title" width="10%">일자</td>
				<td class="title" width="19%">계정과목 신설<br>/변경신청서 존재여부</td>
				<td class="title" width="17%">변경전<br>회계정책/계정과목</td>
				<td class="title" width="17%">변경후<br>회계정책/계정과목</td>
				<td class="title" width="17%">변경 사유</td>
				<td class="title" width="15%">전결권자 승인여부</td>
				</tr>
					  <%if( vt.size() == 0){%>					
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td width="85%">&nbsp;
	      회계규정 및 계정과목 신설 및 개정</td>	    
	  </tr>     
	  <tr>
	    <td class="title">통제활동번호/명</td>
	    <td>&nbsp;
	      C1/회계정책/계정과목 변경신청서 승인</td> 
	  </tr>     
	  <tr>
	    <td class="title">테스트 절차</td>
	    <td>&nbsp;
	      평가대상 기간 동안에 회계정책/계정과목의 변경이 있는지 확인하기 위해 전산상의 계정과목 변경 이력을 징구한다.<br>
	      &nbsp;
	      표본크기에 따라 모집단에서 샘플을 임의추출한다.<br>
	      &nbsp;
	      샘플 추출한 변경건에 대해 계정과목 신설/변경 내용 정리문서가 작성되었고, 변경의 타당성이 기술되어 있는지 확인하고, 유선이나 구두상 이루어진 내용은<br>
	      &nbsp;
	      해당 담당자 및 승인자가 동 내용을 알고 있는지 질문한다. 계정과목 신설/변경신청서에 총무팀장의 승인 유무를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
