...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "ac5_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='ac5_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 회계Cycle > <span class=style5>결산재무제표분석적검토</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="45%">결산보고서(대상기간)</td>
	    <td class="title" width="50%">전결권자 승인여부</td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      C1/결산 재무제표에 대한 분석적 검토
	    </td> 
	  </tr>     
	  <tr>
	    <td class="title">테스트 절차</td>
	    <td>&nbsp;
	      평가대상기간 중 결산재무제표를 징구한다. 표본크기에 따라 결산재무제표를 샘플링한다.<br>
	      &nbsp;
	      결산재무제표에 대한 분석적 검토 절차가 수행되어 차이 원이에 대한 검토결과가 문서화되어 있는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
