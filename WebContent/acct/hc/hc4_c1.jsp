...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "hc4_c1");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='hc4_c1'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제마감 > 인사/급여Cycle > <span class=style5>복리후생비지급승인</span></span></td>
			...
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
				...
				<%if( vt.size() == 0){%>					
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='30' name='value1' class='text' value=""></td>
					  <td align='center'><input type='text' size='30' name='value2' class='text' value=""></td>
					  <td align='center'><input type='text' size='30' name='value3' class='text' value=""></td>
					  <td align='center'><input type='text' size='30' name='value4' class='text' value=""></td>
					</tr>
					<%}%>
					<%}%>
					<%if( vt.size() > 0){%>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='30' name='value1' class='text' value="<%=ht.get("VALUE1")%>"></td>
					  <td align='center'><input type='text' size='30' name='value2' class='text' value="<%=ht.get("VALUE2")%>"></td>
					  <td align='center'><input type='text' size='30' name='value3' class='text' value="<%=ht.get("VALUE3")%>"></td>
					  <td align='center'><input type='text' size='30' name='value4' class='text' value="<%=ht.get("VALUE4")%>"></td>
					</tr>
					<%}%>
					<%}%>
			</table>
