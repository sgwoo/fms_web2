...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='hc1_c1'>
        ...
        <td>
        	<table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제마감 > 인사/급여Cycle > <span class=style5>인사정보변경품의서승인</span></span></td>
		...
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width="100%">
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='80' name='value1' class='text' value=""></td>
					  <td align='center'><input type='text' size='80' name='value2' class='text' value=""></td>
					</tr>
					<%}%>
					<%}%>
					<%if( vt.size() > 0){%>
					...
					<tr>
					  ...
					  <td align='center'><input type='text' size='80' name='value1' class='text' value="<%=ht.get("VALUE1")%>"></td>
					  <td align='center'><input type='text' size='80' name='value2' class='text' value="<%=ht.get("VALUE2")%>"></td>
					</tr>
					<%}%>
					<%}%>
			</table>
