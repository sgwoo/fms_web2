...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getAcct_in_search(st_dt, end_dt, s_cnt, "fc3_c2");
		vt_size = vt.size();
		chk_size = vt.size();	
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='fc3_c2'>
  <input type='hidden' name='value_size' value='1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 자금Cycle > <span class=style5>출금집행이원화확인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="95%">접근통제여부</td>
	  ...
	  <%if( vt.size() == 0){%>					
				...
				<tr>
					  ...
					  <td align=''><input type='text' size='150' name='value1' class='text' value=""></td>
				</tr>
					<%}%>
					<%}%>
					<%if( vt.size() > 0){%>
				...
				<tr>
					  ...
					  <td align=''><input type='text' size='150' name='value1' class='text' value="<%=ht.get("VALUE1")%>"></td>
				</tr>
					<%}%>
					<%}%>
	</table>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      자금집행자가 승인권자의 승인이 없이 자금집행을 위한 통제장치(공인인증서 이체 비밀번호, 통장 및 도장에 대한 물리적 접근 포함)에 접근이 가능한지, <br>
	      &nbsp;
	      승인권자가 직접 자금집행이 가능한지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
