...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getFc3C1List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='fc3_c1'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 자금Cycle > <span class=style5>출금전표교차승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="25%">현업부서장</td>	
	    <td class="title" width="25%">총무팀장</td>    	    	    
	  ...
	  <input type='hidden' name="value3" 	value="<%=ht.get("DOC_USER_NM2")%> <%=ht.get("DOC_USER_DT2")%>">
	  <input type='hidden' name="value4" 	value="<%=ht.get("ACT_USER_NM2")%> <%=ht.get("DOC_USER_DT2")%>">
	  ...
	  <tr>
	    ...
	    <td align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("P_PAY_DT")))%></td>            
            ...
            <td align='center'><%=ht.get("DOC_USER_NM2")%> <%=ht.get("DOC_USER_DT2")%></td>            
            <td align='center'><%=ht.get("ACT_USER_NM2")%> <%=ht.get("DOC_USER_DT2")%></td>
	      <!--
	    <td align='center'>
	      <select name="result">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      C1/출금전표에 대한 교차 승인</td> 
	  </tr>     
	  <tr>
	    <td class="title">테스트 절차</td>
	    <td>&nbsp;
	      출금전표를 샘플링하여 정당한 현업부서장과 총무팀장의 승인을 득하였는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
