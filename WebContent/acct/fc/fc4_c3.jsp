...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getFc4C3List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='fc4_c3'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 자금Cycle > <span class=style5>법인카드입력완전성체크</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="30%">거래처</td>
	    <td class="title" width="25%">거래금액</td>	
	    <td class="title" width="25%">전표확인자</td>
	  ...
	  <input type='hidden' name="value1" 	value="<%=AddUtil.ChangeDate2(String.valueOf(ht.get("BUY_DT")))%>">
	  <input type='hidden' name="value2" 	value="<%=ht.get("VEN_NAME")%>">
	  <input type='hidden' name="value3" 	value="<%=Util.parseDecimal(String.valueOf(ht.get("BUY_AMT")))%>">
	  <input type='hidden' name="value4" 	value="<%=ht.get("CD_REG_ID_NM")%>">
	  ...
	  <tr>
	    ...
	    <td align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("BUY_DT")))%></td>            
            ...
            <td align='center'><%=ht.get("CD_REG_ID_NM")%></td>
	      <!--
	    <td align='center'>
	      <select name="result">
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      법인카드 이용내역서를 매월 징구했는지 샘플링하여 확인한다. 특정월을 샘플링하여 법인카드 사용으로 전표에 기입된 금액과 <br>
	      &nbsp;
	      월이용내역서상 금액이 일치하는지 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
