...
<%	
	...
	if(st_dt.equals("") && end_dt.equals("") && s_cnt.equals("")){	
		...
		vt = at_db.getFc2C2List(st_dt, end_dt, s_cnt);
		vt_size = vt.size();
	}
...
<form name="form1" method="post" action="">
  ...
  <input type='hidden' name='acct_st' 	value='fc2_c2'>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제 > 자금Cycle > <span class=style5>원리금상환전표승인</span></span></td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  <tr>
	    ...
	    <td class="title" width="15%">출금일자</td>
	    <td class="title" width="30%">지출처</td>
	...
	<table border="0" cellspacing="1" cellpadding="0" width="100%">
	  ...
	  <tr>
	    ...
	    <td>&nbsp;
	      원리금상환 거래에 대해 샘플링한다. 해당 거래의 전표를 요청한다. 해당 전표에 정당한 승인권자의 승인여부를 확인한다.
	    </td>	    
	  </tr>     
	</table>
      </td>
