...
<%
	...
	//마감자
	Vector users = at_db.getAcctAppIDList();
      ...
      <td>
        <table width=100% border=0 cellpadding=0 cellspacing=0>
          <tr>
            ...
            <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acct/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>내부통제평가 > <span class=style5>평가심사관리</span></span></td>
