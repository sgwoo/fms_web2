...
<%@ page import="java.util.*, acar.util.*, acar.cont.*,acar.car_register.*, acar.user_mng.*,acar.common.*, acar.client.*"%>
    	...
    	<td colspan="2">
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 계약관리 > <span class=style5>스캔관리</span></span></td>
...
//						ContCarBean fee_etcs = a_db.getContFeeEtc(m_id, l_cd, Integer.toString(i));%>
    ...
    <%
	//file_path = "";
	//theURL    = "https://fms3.amazoncar.co.kr/data/carReg/";	
	//file_ext  = ".pdf";	
    %>    
    <tr>
        <td colspan="2" class=line2></td>
