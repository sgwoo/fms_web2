...
<!--
	...
	function view_sh_res_h(){
		var SUBWIN="/agent/secondhand/reserveCarHistory.jsp?car_mng_id=<%=c_id%>";  	
	...
	{
		window.open("/agent/park_home/parking_check_frame.jsp?car_mng_id="+car_mng_id+"&io_gubun="+io_gubun+"&st="+st, "PARKING_CAR", "left=100, top=20, width=1000, height=900, scrollbars=auto");
	}	
//-->
</script>
</head>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 예약조회 > <span class=style5>차량별 예약/대여 리스트</span></span></td>
