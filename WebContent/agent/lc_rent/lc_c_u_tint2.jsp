...
<!--
	...
	function cng_input(){		  
		...
		if(fm.tint_yn[1].checked == true){
			...
			if('<%=tint.getTint_no()%>' == ''){
				...
				<%}else if(user_bean.getBr_id().equals("G1")){%>					fm.off_id.value = '010255스마일TS';				
	...
	function update(){
		...
		if(fm.tint_yn[0].checked == true){
			...
			//if(fm.com_nm.value == '')		{ alert('제조사명을 입력하십시오.');		fm.com_nm.focus(); 	return;}
	...
	<td align='right' class="line">
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td>&nbsp;
                        <input type='text' size='10' maxlength='10' name='tint_amt' class='defaultnum' value='<%=AddUtil.parseDecimal(tint.getTint_amt())%>'  onBlur='javascript:this.value=parseDecimal(this.value);'>원</td></td>
                </tr>          
                <tr> 
                    ...
                    <td>&nbsp;
                    	...
                    	<%if(base.getBus_id().equals(user_id) || base.getBus_id2().equals(user_id) || nm_db.getWorkAuthUser("보험업무", user_id) || nm_db.getWorkAuthUser("전산팀", user_id)){%>
