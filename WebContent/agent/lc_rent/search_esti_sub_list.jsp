    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <%if(idx.equals("1")){%>차종<%}else if(idx.equals("2")){%>옵션<%}else if(idx.equals("3")){%>색상<%}else if(idx.equals("5")){%>연비<%}%></span></span></td>
        ...
        <td class=line>
            <table border=0 cellspacing=1 cellpadding=0 width=100%>
                <tr> 
                    ...
                    <td class="title" width="40%"><%if(idx.equals("1")){%>차종<%}else if(idx.equals("2")){%>옵션<%}else if(idx.equals("3")){%>색상<%}else if(idx.equals("5")){%>엔진<%}%></td>
                    <%if(idx.equals("1")){%>
                    <td class="title" width="5%">연식</td>			
                    <td class="title" width="15%">가격</td>
                    <td class="title" width="10%">기준일자</td>	
                    <%}else if(idx.equals("5")){%>
                    <td class="title" width="15%">복합연비</td>
                    <%}else{%>
                    <td class="title" width="15%">가격</td>
