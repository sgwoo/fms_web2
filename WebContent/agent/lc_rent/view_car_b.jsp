...
function open_car_b(car_id, car_seq, car_name){
	window.open('view_car_b.jsp?car_id='+car_id+'&car_seq='+car_seq+'&car_name='+car_name+'&v_left=<%=v_left%>&v_top=<%=v_top%>', "car_b_<%=v_left%>", "left=<%=v_left%>, top=<%=v_top%>, width=450, height=400, scrollbars=yes"); 
}
//-->
</script>
</head>
