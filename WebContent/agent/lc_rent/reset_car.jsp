...
<%@ page import="acar.cont.*, acar.client.*, acar.car_office.*, acar.car_mst.*, acar.car_register.*"%> 
...
<!--
	...
	function sub_list(idx){
		...
		window.open(SUBWIN, "SubList", "left=100, top=100, width=860, height=400, scrollbars=yes, status=yes");
	}
            ...
            <td>
			  <table width="100%" border="0" cellpadding="0">
                <tr>
				  ...
				  <input type='hidden' name='opt_v_amt' value='<%=AddUtil.parseDecimal(car.getOpt_cv_amt())%>'></td>
                </tr>
              </table>
            </td>
            <td align="center">
          ...
          <tr> 
            ...
            <td><table width="100%" border="0" cellpadding="0">
                <tr>
				  ...
				  <input type='hidden' name='col_v_amt' value='<%=AddUtil.parseDecimal(car.getClr_cv_amt())%>'></td>
                </tr>
              </table>
            </td>
		...
		<td class='line'>
			<table border="0" cellspacing="1" cellpadding="0" width=100%>
				<tr>
					...
					<td width="110" class='title'>대여료반영여부</td>
