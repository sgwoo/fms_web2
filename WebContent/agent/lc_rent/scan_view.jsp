...
<%@ page import="java.util.*, acar.util.*, acar.common.*, acar.cont.*, acar.car_register.*, acar.client.*"%>
...
<table border="0" cellspacing="0" cellpadding="0" width=670>
			...
			<%}else{%><%=AddUtil.parseInt(rent_st)-1%>차연장<%}%>
                    ...
                    <td align="center">
                        <%if(file_st.equals("1")||file_st.equals("2")||file_st.equals("4")||file_st.equals("9")||file_st.equals("17")||file_st.equals("18")){ //주요스캔을 제외하고 스캔자가 삭제할수 있다.%>
                        	<%if((base.getBus_id().equals(user_id) && delete_yn.equals("Y")) || (String.valueOf(ht.get("REG_USERSEQ")).equals(user_id) && delete_yn.equals("Y"))){%>
    	    	            	<a href="https://fms3.amazoncar.co.kr/fms2/attach/delete.jsp?SEQ=<%=ht.get("SEQ")%>" target='_blank'><img src="/acar/images/center/button_in_delete.gif" align="absmiddle" border="0"></a>
        	            	<%}%>
                        <%}else{ %>
                    		<%if(base.getBus_id().equals(user_id)){%><a href="https://fms3.amazoncar.co.kr/fms2/attach/delete.jsp?SEQ=<%=ht.get("SEQ")%>" target='_blank'><img src="/acar/images/center/button_in_delete.gif" align="absmiddle" border="0"></a><%}%>
                    	<%} %>	
                    </td>
                </tr>
                <% 		}
    ...
    <%}%>
    <tr>
        <td colspan="2" align="right"><%if(base.getBus_id().equals(user_id)){%><a href='javascript:save()' onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_reg.gif align=absmiddle border=0></a><%}%>&nbsp;&nbsp;<a href='javascript:window.close()' onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_close.gif align=absmiddle border=0></a></td>
    </tr>
    <tr>
        <td colspan="2"></td>
    </tr>
