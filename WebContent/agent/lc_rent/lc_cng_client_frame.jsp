...
<frameset rows="<%=height%>, *" border=1 name=ex>
  <frame src="lc_cng_client_h.jsp<%=valus%>" name="c_body" marginwidth=10 marginheight=10 scrolling='no' noresize>
  <frame src="lc_cng_client_c.jsp<%=valus%>" name="c_foot" marginwidth=10 marginheight=10 scrolling='yes' noresize>
</frameset>
</HTML>
