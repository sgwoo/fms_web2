...
<%
		...
		if(!car_st.equals("2")){
			...
			//if(fee.getFee_s_amt()>0 && !fee.getFee_chk().equals("1") && !fee.getPp_chk().equals("0")  ){
				...
				//일자계산이면서 변경후 1회차납부일자가 변경전 1회차납부일자 이후일 경우 팀장결재 필요
			...
			if(!rent_l_cd.equals("S214KK7R00045") && !base.getBus_id2().equals("000026") && !base.getBus_id2().equals("000005") && !base.getBus_id2().equals("000144")){//관리팀장,영업팀장,채권담당
				...
				if(!s_destphone.equals("")){	
					...
					String contract_s_date= String.valueOf(cont_view.get("RENT_START_DT"));	// 계약 시작일
					String manager_name 	= target_bean.getUser_nm();												// 담당자 이름
					String manager_phone 	= target_bean.getUser_m_tel();										// 담당자 전화
					...
					String customer_name2 = String.valueOf(cont_view.get("FIRM_NM"));				// 고객이름
					String insurance_name2= ins_name + " (" + ins_tel + ")";								// 보험사 이름
					String manager_name2 	= target_bean.getUser_nm();	                // 담당자 이름
					String manager_phone2 	= "("+ target_bean.getUser_m_tel() + ")";	// 담당자 연락처
				...
				if(rs_cont_size+rs_cont_size2>0){
					...
					String cont2 	= "["+firm_nm+" "+rent_l_cd+"]  &lt;br&gt; &lt;br&gt; 신차개시 및 스케줄생성을 요청하였습니다.  &lt;br&gt; &lt;br&gt; 지연대차 미반차가 있으니 확인하십시오.";
					
					if(base.getBus_st().equals("7")){
						cont2 	= "["+firm_nm+" "+rent_l_cd+"]  &lt;br&gt; &lt;br&gt; 신차개시 및 스케줄생성을 요청하였습니다.  &lt;br&gt; &lt;br&gt; 에이전트계약 지연대차 미반차가 있으니 확인하십시오.";
					}
