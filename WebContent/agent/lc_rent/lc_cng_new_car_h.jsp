...
<!--
	...
	function SearchopenBrWindow() { //v2.0
		...
		fm.action = "/agent/tax/pop_search/s_cont_car_cng.jsp";		
...
<form action='lc_cng_new_car_c.jsp' name="form1" method='post'>
  ...
  <input type="hidden" name="go_url" value="/agent/lc_rent/lc_cng_new_car_c.jsp">      
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 해지관리 > <span class=style5>대여개시전차종변경등록</span></span></td>
