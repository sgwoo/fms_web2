        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
		        ...
		        <tr>
		            <td class=title>&nbsp;&nbsp;
					(
		            	<input type='text' name='c_ba_year_s' size='11' class='text' maxlength='10' value='<%=c_fin.getC_ba_year_s()%>' onBlur='javascript:this.value=ChangeDate(this.value)' >~<input type='text' name='c_ba_year' size='10' class='text' maxlength='10' value='<%=c_fin.getC_ba_year()%>' onBlur='javascript:this.value=ChangeDate(this.value)' > )</td>
		     
		            <td class='title'>&nbsp;&nbsp;
					(
		            	<input type='text' name='f_ba_year_s' size='11' class='text' maxlength='10' value='<%=c_fin.getF_ba_year_s()%>' onBlur='javascript:this.value=ChangeDate(this.value)' >~<input type='text' name='f_ba_year' size='10' class='text' maxlength='10' value='<%=c_fin.getF_ba_year()%>' onBlur='javascript:this.value=ChangeDate(this.value)' > )</td>
        ...
        <td class=line> 
        	...
        	<%  		eval5 = a_db.getContEvalOff(base.getClient_id(), client.getFirm_nm(), "2");	
                ...
                <tr>
        		  ...
        		  <%	
        		  		if(cont_etc.getClient_share_st().equals("1")){ //공동임차인 // 개인, 개인사업자도 대표 공동임차 사용 20210308   
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr id=tr_dec_firm style="display:<%if(client.getClient_st().equals("1")){%>''<%}else{%>none<%}%>">
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval1.getAss1_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> <input type='text' name='t_addr' size='25' class='text' value='<%=eval1.getAss1_addr()%>'></td>
        			<% zip_cnt++;%>
                    <td align="center">
                      <select name='ass2_type'>
                          <option value="">선택</option>
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval1.getAss2_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> <input type='text' name='t_addr' size='25' class='text' value='<%=eval1.getAss2_addr()%>'></td>
                </tr>
        		  <%	if(!cont_etc.getClient_guar_st().equals("2")){%>
                <tr>
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval2.getAss1_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> <input type='text' name='t_addr' size='25' class='text' value='<%=eval2.getAss1_addr()%>'></td>
        			<% zip_cnt++;%>
                    <td align="center">
                      <select name='ass2_type'>
                          <option value="">선택</option>
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval2.getAss2_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> <input type='text' name='t_addr' size='25' class='text' value='<%=eval2.getAss2_addr()%>'></td>
                </tr>
                <input type='hidden' name="ass1_type"			value="">  
                <input type='hidden' name="t_zip"			value="">  
                <input type='hidden' name="t_addr"			value="">  
                ...
                <tr>
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval7.getAss1_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> 
                        <input type='text' name='t_addr' size='25' class='text' value='<%=eval7.getAss1_addr()%>'></td>
        			<% zip_cnt++;%>
                    <td align="center">
                      <select name='ass2_type'>
                          <option value="">선택</option>
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval7.getAss2_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> 
                        <input type='text' name='t_addr' size='25' class='text' value='<%=eval7.getAss2_addr()%>'></td>
                </tr>
                <input type='hidden' name="ass1_type"			value="">  
                <input type='hidden' name="t_zip"			value="">  
                <input type='hidden' name="t_addr"			value="">  
                ...
                <tr>
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval4.getAss1_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> <input type='text' name='t_addr' size='25' class='text' value='<%=eval4.getAss1_addr()%>'></td>
        			<% zip_cnt++;%>            
        			<td align="center">
                      <select name='ass2_type'>
                          <option value="">선택</option>
                    ...
                    <td align="center"><input type='text' name="t_zip" value='<%=eval4.getAss2_zip()%>' size="7" class='text' readonly onClick="javascript:search_zip('<%=zip_cnt%>')"> <input type='text' name='t_addr' size='25' class='text' value='<%=eval4.getAss2_addr()%>'></td>
                </tr>
        		  <%	}
        		  	}%>		
