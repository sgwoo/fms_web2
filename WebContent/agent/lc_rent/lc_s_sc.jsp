...
<!--
	...
	{
		window.open("/agent/car_register/car_view.jsp?rent_mng_id="+m_id+"&rent_l_cd="+l_cd+"&car_mng_id="+c_id+"&cmd=ud", "VIEW_CAR", "left=10, top=10, width=850, height=700, scrollbars=yes");
	}	
		
	//스캔관리 보기
	function view_scan(m_id, l_cd)
	{
		window.open("view_scan.jsp?m_id="+m_id+"&l_cd="+l_cd, "VIEW_SCAN", "left=100, top=100, width=720, height=800, scrollbars=yes");				
	}
...
<form name='form1' method='post'>
  ...
  <input type='hidden' name='from_page' value='/agent/lc_rent/lc_s_frame.jsp'>
