...
<%
	...
	from_page = "/agent/lc_rent/lc_c_c_gur.jsp";
...
<table border='0' cellspacing='0' cellpadding='0' width='100%'>
    ...
    <tr>
  	...
  	<tr>
	    <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>대표 연대보증&nbsp;<%if(base.getBus_id().equals(user_id)){%><a href="javascript:update('client_guar')" title="관리자모드"><img src=/acar/images/center/button_modify_ss.gif align=absmiddle border=0></a><%}%><font color="#CCCCCC"> ( 관리자 : 대표이사보증유무, 면제조건, 결재자 수정 )</font></span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>	
    <%-- <tr id=tr_client_guar_st style="display:<%if(client.getClient_st().equals("1")){%>''<%}else{%>none<%}%>"> --%> 
    <tr id='tr_client_guar_st'> 
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    <td width='13%' class='title'>보증유무</td>
                    <td colspan="3" align='left'>&nbsp;<%if(cont_etc.getClient_guar_st().equals("1")){%>가입<%}else if(cont_etc.getClient_guar_st().equals("2")){%>면제<%}%></td>
                </tr>
    ...
    <tr>
  	...
  	<tr>
	    <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2>연대보증인 (대표이사외)&nbsp;<%if(base.getBus_id().equals(user_id)){%><a href="javascript:update('guar')" title="관리자모드"><img src=/acar/images/center/button_modify_ss.gif align=absmiddle border=0></a><%}%><font color="#CCCCCC"> ( 관리자 : 연대보증인유무, 신상정보 수정 )</font></span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>		
                    ...
                    <td height="26" colspan="4" class=line>
    			        <table border="0" cellspacing="1" cellpadding="0" width=100%>
                            ...
                            <tr>
                                ...
                                <td align="center"><%=gur.get("GUR_SSN")%></td>
	...
	<tr>
        <td><img src=/acar/images/center/icon_arrow.gif align=absmiddle> <span class=style2><%if(f >1){%><%=f%>차 연장 <%}%>보증보험 <%if(f==1 && (user_id.equals("000000") || base.getBus_id().equals(user_id))){%><a href="javascript:update('gi')"><img src=/acar/images/center/button_modify_ss.gif align=absmiddle border=0></a><font color="#CCCCCC"> ( 계출담당 : 가입여부, 발행지점, 가입금액, 보험료 수정 )</font><%}%></span></td>
    </tr>
    <tr>
        <td class=line2></td>
    </tr>	
