    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 계약관리 > <span class=style5>계약관리</span></span></td>
	    ...
	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
			...
			<input type="text" name="end_dt" size="11" value="<%=end_dt%>" class="text">
                ...
                <tr>
		            ...
		            <option value='19' 	<%if(s_kd.equals("19")){%>selected<%}%>>사업자/생년월일</option>
                            ...
                            <option value='9' 	<%if(s_kd.equals("9")){%>selected<%}%>>영업대리인 </option>
