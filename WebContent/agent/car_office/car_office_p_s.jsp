...
function go_page(arg){
	if(arg=="i"){
		document.location.href = "./car_office_p_i.jsp?user_id=<%= user_id %>&br_id=<%= br_id %>&gubun1=<%= gubun1 %>&gubun2=<%= gubun2 %>&gubun3=<%= gubun3 %>&gubun4=<%= gubun4 %>&st_dt=<%= st_dt %>&end_dt=<%= end_dt %>";
	}else if(arg=="u"){
		document.location.href = "./car_office_p_u.jsp?user_id=<%= user_id %>&br_id=<%= br_id %>&emp_id=<%= emp_id %>&gubun=<%= gubun %>&gu_nm=<%= gu_nm %>&cng_rsn=<%=cng_rsn%>&gubun1=<%= gubun1 %>&gubun2=<%= gubun2 %>&gubun3=<%= gubun3 %>&gubun4=<%= gubun4 %>&st_dt=<%= st_dt %>&end_dt=<%= end_dt %>";
	}else if(arg=="b"){
		document.location.href = "./car_office_p_frame.jsp?user_id=<%= user_id %>&br_id=<%= br_id %>&gubun=<%= gubun %>&gu_nm=<%= gu_nm %>&cng_rsn=<%=cng_rsn%>&gubun1=<%= gubun1 %>&gubun2=<%= gubun2 %>&gubun3=<%= gubun3 %>&gubun4=<%= gubun4 %>&st_dt=<%= st_dt %>&end_dt=<%= end_dt %>";	
	}else{
		alert("잘못 선택되었습니다.");
	}
}
...
function sms_list(arg){
	var SUBWIN="/agent/sms_gate/sms_result_sc2.jsp?dest_gubun=1&rslt_dt=0&dest_nm="+arg;
...
function damdang_list(){
	...
	function scan_reg(file_st){
		window.open("reg_scan.jsp?user_id=<%=user_id%>&br_id=<%=br_id%>&emp_id=<%=emp_id%>&from_page=/acar/car_office/car_office_p_s.jsp&file_st="+file_st, "SCAN", "left=10, top=10, width=620, height=250, scrollbars=yes, status=yes, resizable=yes");
	}
	//스캔삭제
	...
	function BankAccMng(){
		...
		window.open(SUBWIN, "OfficeBank", "left=100, top=100, width=920, height=500, scrollbars=no");
	}	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;Agent > 영업사원관리 > <span class=style1><span class=style5>영업사원조회</span></span></td>
    ...
    <tr>
        <td><div align="right">
	    <%if(cmd.equals("")){%>
        <a href="javascript:go_page('i')"> <img src=/acar/images/center/button_reg_new.gif align=absmiddle border=0></a> <a href="javascript:go_page('u')"> <img src=/acar/images/center/button_modify.gif align=absmiddle border=0></a>
        <a href="javascript:go_page('b')"> <img src=/acar/images/center/button_list.gif align=absmiddle border=0></a></div>
	    <%}%>
	    </td>		
    </tr>
                                            ...
                                            <td width="85%">&nbsp; 
											  <%if(acc_vt_size>0){
													...
													<% if(acc_vt_size>1) out.print("외 "+acc_vt_size+"건"); %>&nbsp;&nbsp;
	                                              	<% if(acc_vt_size>0){ %>
                                       <!--       		<a href="javascript:BankAccMng()" onMouseOver="window.status=''; return true"><span title="클릭하시면 내용을 볼 수 있습니다."><img src=/acar/images/center/button_in_search.gif align=absmiddle border=0></span></a> -->
                                              		<% }else{ %>
                                            		&nbsp;
                                            		<% } %>											   
											  <%}else{%>											  
                        ...
                        <table width=100% border=0 cellspacing=0 cellpadding=0>
                            <tr>
                                ...
                                <td align=right><% if(coev_r.length>1){ %>
                                  <a href="javascript:view_memo('all')"><img src=/acar/images/center/button_see_all.gif align=absmiddle border=0></a>&nbsp; <a href="javascript:view_memo('last')"><img src=/acar/images/center/button_cancel.gif align=absmiddle border=0></a>
                                  <% } %>
                                </td>
                            </tr>
                        </table>
                                ...
                                <td class="line">
                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="85%">&nbsp;
                                              <textarea name="vis_cont" rows="2" cols="100"></textarea> <a href="javascript:VisReg()"><span title="내용을 입력하시고 클릭하면, 추가됩니다"><img src=/acar/images/center/button_in_plus.gif align=absmiddle border=0></span></a></td>
                                    ...
                                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="85%">&nbsp; <%= firm_nm %>
                                              ...
                                              <% if(commis.size()>0){ %>
                       <!--                       <a href="javascript:open_commi('<%= emp_id %>')"><span title="클릭하시면 내용을 볼 수 있습니다."><img src=/acar/images/center/button_in_search.gif align=absmiddle border=0></span></a> -->
                                              <% }else{ %>
                                            &nbsp;
                                            <% } %>
                                            </td>
