    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 영업사원관리 > <span class=style5>실수령인관리</span></span></td>
            	...
            	<tr>
					...
					<td align=center>
    						...
    						<%if(emp_file1_yn.equals("")){%>
                                                <a href="javascript:scan_reg('1', '<%=ht.get("SEQ")%>')"><img src=/acar/images/center/button_in_reg.gif align=absmiddle border=0></a>
                                                <%}%>
					...
					<td align=center>
    						...
    						<%if(emp_file2_yn.equals("")){%>
                                                <a href="javascript:scan_reg('2', '<%=ht.get("SEQ")%>')"><img src=/acar/images/center/button_in_reg.gif align=absmiddle border=0></a>
                                                <%}%>
