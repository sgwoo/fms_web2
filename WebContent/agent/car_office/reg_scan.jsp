...
<%
	...
	String acc_seq		= request.getParameter("acc_seq")==null?"":request.getParameter("acc_seq");
%>
...
<!--
	...
	function save(){
		...
		fm.action = "https://fms3.amazoncar.co.kr/fms2/attach/fileuploadact.jsp?<%=Webconst.Common.contentCodeName%>=<%=UploadInfoEnum.CAR_OFF_EMP%>";		
		fm.submit();
	}	
//-->
</script>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > <span class=style5>스캔등록</span></span></td>
	    ...
	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    ...
                    <td >&nbsp;
                        ...
                        <input type="hidden" name="<%=Webconst.Common.contentSeqName%>" value='<%=emp_id%><%=file_st%>'>
                        <input type='hidden' name='<%=Webconst.Common.contentCodeName%>' value='<%=UploadInfoEnum.CAR_OFF_EMP%>'>        			
                    </td>
                </tr>
            </table>
        </td>
