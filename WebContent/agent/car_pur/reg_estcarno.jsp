        ...
        <td class='line'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td>&nbsp;<input type='text' size='15' name='est_car_no' class='text' value='<%=pur.getEst_car_no()%>'>
    			    <font color="#CCCCCC">(한글10자)</font>
    			    </td>
                </tr>
                <tr> 
                    <td class='title'>차대번호</td>
                    <td>&nbsp;<input type='text' size='30' name='est_car_num' class='text' value='<%=pur.getCar_num()%>'>
    			    </td>
                </tr>
            </table>
        </td>
