	  ...
	  <td class=line>
	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
		  ...
		  <tr>
		    ...
		    <td colspan="2" align="center"><input type='text' size='11' name='dt1' maxlength='12' class='whitetext' value='<%=AddUtil.getDate()%>' onBlur='javscript:this.value = ChangeDate(this.value);'></td>
	      </tr>
		  <tr>
		    ...
		    <td colspan="2" align="center"><input type='text' size='11' name='dt2' maxlength='12' class='whitetext' value='<%=AddUtil.getDate()%>' onBlur='javscript:this.value = ChangeDate(this.value);'></td>
	      </tr>
		  <tr>
		  ...
		  <tr>
		    <td colspan="7">
			  <table border="0" cellspacing="0" cellpadding='0' width=100%>
			    ...
			    <tr>
				  <td align="right"><%=AddUtil.getDate3()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>				  
				</tr>
			  </table>
			</td>
	      </tr>
		  <%if(user_bean.getBr_id().equals("S1")){%>
		  <tr>
