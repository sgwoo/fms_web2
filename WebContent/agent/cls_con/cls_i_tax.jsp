...
*/
		...
		//폐차는 아마존카 보유차에서만 할 수 있슴. 고객폐차인 경우 차종변경 처리후 폐차 처리 -20081210
		if(fm.cls_st.value == '9') {
    	...
    	<td colspan="2">
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;Agent > 계약관리 > <span class=style1><span class=style5>계약조건변경</span></span></td>
            ...
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                   ...
                   <!--     <option value="2">중도해약</option> -->
                    ...
                    <td width="12%">&nbsp;<input type='text' name='cls_dt' value='<%=base.get("CLS_DT")%>' size='12' class='text' onBlur='javascript: this.value = ChangeDate(this.value); set_day();'> 
                    </td>
                    ...
                    <td colspan="2" class='line'> 
                        <table border="0" cellspacing="1" cellpadding="0" width=100%>
                            ...
                            <tr> 
                              ...
                              <td width="30%"> 
                                <input type='text' name='cls_est_dt' size='12' class='text' onBlur='javascript: this.value = ChangeDate(this.value)'>
                              </td>
                              <td class='title' width="20%"> 세금계산서발행일</td>
                              <td width="30%"> 
                                <input type='text' name='ext_dt' size='12' class='text' onBlur='javascript: this.value = ChangeDate(this.value)'>
                                <select name='ext_id'>
                ...
                <td class='line'> 
                  <table border="0" cellspacing="1" cellpadding="0" width=100%>
                    <tr> 
                      ...
                      <td width="40%">
                        <input type='text' name='trf_dt' size='12' class='text' onBlur='javascript: this.value = ChangeDate(this.value)'>
                      </td>
                    </tr>
                  </table>
                </td>
                ...
                <td class='line'> 
                  <table border="0" cellspacing="1" cellpadding="0" width=100%>
                    <tr> 
                      ...
                      <td width="15%">
                        <input type='text' name='opt_dt' size='12' class='text' onBlur='javascript: this.value = ChangeDate(this.value)'>
                      </td>
