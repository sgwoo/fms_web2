...
<%			}else{														//성공
				...
				if(cls.getCls_st().equals("9")){	//폐차
					...
					if(cr_bean.getCar_use().equals("1")){//cr_bean.getCar_no().length() > 8 && 
						String car_ext = "";
						if(cr_bean.getCar_ext().equals("1")) car_ext = "서울";
						if(cr_bean.getCar_ext().equals("2")) car_ext = "파주";
						if(cr_bean.getCar_ext().equals("3")) car_ext = "부산";
						if(cr_bean.getCar_ext().equals("4")) car_ext = "김해";
						if(cr_bean.getCar_ext().equals("5")) car_ext = "대전";
						if(cr_bean.getCar_ext().equals("6")) car_ext = "포천";
						if(cr_bean.getCar_ext().equals("7")) car_ext = "인천";
						if(cr_bean.getCar_ext().equals("8")) car_ext = "제주";
					...
					if(!String.valueOf(end_car.get("RENT_L_CD")).equals("")){
						...
						String sub2 		= "폐차처리 안내";
						String cont2 		= "[ "+cls.getRent_l_cd()+" "+cr_bean.getCar_no()+" ] 폐차처리되었습니다. 개별소비세 폐차 면제신청하십시오.";
