      ...
      <td class=line>
        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          <tr>
            ...
            <td colspan="8" class='title'>계약기간</td>
          ...
          <tr>
            ...
            <td class='title' width="120">합계</td>
            <td class='title' width="260">월대여료</td>
            <td class='title' width="260">총대여료</td>
          </tr>
          <tr>
    ...
    <tr>
      <td class=line>
        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
          <tr>
            <td colspan="2" rowspan="2" class='title'>구분</td>
            <td colspan="6" class='title'>자력영업</td>
            <td colspan="4" class='title'>영업사원</td>
            <td width="180" rowspan="2" class='title'>합계</td>
          </tr>
          <tr>
            <td class='title' width="126">기존업체</td>
            <td class='title' width="126">업체소개</td>
            <td class='title' width="126">인터넷</td>
            <td class='title' width="126">전화상담</td>
            <td class='title' width="126">기타</td>
            <td class='title' width="126">소계</td>
            <td class='title' width="126">신규</td>
            <td class='title' width="126">증차</td>
            <td class='title' width="126">대차</td>
            <td class='title' width="126">소계</td>
          </tr>
		  <%
		  		String r_bus71 = String.valueOf(AddUtil.parseInt(String.valueOf(ht1.get("RB_CONT")))-AddUtil.parseInt(String.valueOf(ht1.get("R_BUS6"))));
				String r_bus72 = String.valueOf(AddUtil.parseInt(String.valueOf(ht2.get("RB_CONT")))-AddUtil.parseInt(String.valueOf(ht2.get("R_BUS6"))));
				String r_bus73 = String.valueOf(AddUtil.parseInt(String.valueOf(ht3.get("RB_CONT")))-AddUtil.parseInt(String.valueOf(ht3.get("R_BUS6"))));
		  		String l_bus71 = String.valueOf(AddUtil.parseInt(String.valueOf(ht1.get("LB_CONT")))-AddUtil.parseInt(String.valueOf(ht1.get("L_BUS6"))));
				String l_bus72 = String.valueOf(AddUtil.parseInt(String.valueOf(ht2.get("LB_CONT")))-AddUtil.parseInt(String.valueOf(ht2.get("L_BUS6"))));
				String l_bus73 = String.valueOf(AddUtil.parseInt(String.valueOf(ht3.get("LB_CONT")))-AddUtil.parseInt(String.valueOf(ht3.get("L_BUS6"))));
		  		String t_bus71 = String.valueOf(AddUtil.parseInt(String.valueOf(ht1.get("TB_CONT")))-AddUtil.parseInt(String.valueOf(ht1.get("T_BUS6"))));
				String t_bus72 = String.valueOf(AddUtil.parseInt(String.valueOf(ht2.get("TB_CONT")))-AddUtil.parseInt(String.valueOf(ht2.get("T_BUS6"))));
				String t_bus73 = String.valueOf(AddUtil.parseInt(String.valueOf(ht3.get("TB_CONT")))-AddUtil.parseInt(String.valueOf(ht3.get("T_BUS6"))));
		  %>
          <tr>
            <td width='40' rowspan="3" class='title'>렌트</td>
            <td width='150' class='title'><%=b_dt1%>실적</td>
