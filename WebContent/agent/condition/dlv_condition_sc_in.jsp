...
<%
	...
	Vector stats = a_db.getAgentDlvStats(s_kd, t_wd, dt, t_st_dt, t_end_dt, user_id);
				...
				<td style="width: 1500px;">
					<div style="width: 1500px;">
						<table class="inner_top_table table_layout" style="height: 60px;">			
							<tr>
			            		<td class='title title_border' width='7%'>차량번호</td>
			            		<td class='title title_border' width='11%'>차대번호</td>					
		...
		<table class="tb">
			<tr>
				...
				%>            	
			            		...
			            		<td class='left content_border' width='24%'>&nbsp;<span title='<%=stat.get("CAR_NM")%>'><%=Util.subData(String.valueOf(stat.get("CAR_NM")), 5)%></span></td>            		            		
			            	</tr>
			           	 <%		}%>
			                <tr>              
			   	...
			   	<td style="width: 1500px;">
					...
					%>            				
							 <tr style="height: 25px;"> 		            		
			                    <td class='center content_border' width='7%'><%=stat.get("CAR_NO")%></td>
			                    <td class='center content_border' width='11%'><%=stat.get("CAR_NUM")%></td>		              		
								...
								<td class='center content_border' width='8%'><%=stat.get("NM1")%></td>					
			                    ...
			                    <td class='center content_border' width='7%'><%=stat.get("ONE_SELF")%></td>
			            	    ...
			            	    <td class='center content_border' width='14%'>&nbsp;<span title='<%=stat.get("CAR_NAME")%>'><%=Util.subData(String.valueOf(stat.get("CAR_NAME")), 15)%></span></td>
			...
			%>
							 <tr> 
			                	<td class="title content_border" colspan='11'>&nbsp;</td>           			
					...
					<%} else  {%>  
				           	<tr>
						        <td width="1500" colspan="13"  class='center content_border'>&nbsp;</td>
						    </tr>	              
				    <%}	%>
			            </table>
			        </div>
