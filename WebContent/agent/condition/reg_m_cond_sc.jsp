...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
  <tr> 
    <td><iframe src="./reg_m_cond_sc_in.jsp?gubun=<%=gubun%>&dt=<%=dt%>&ref_dt1=<%=ref_dt1%>&ref_dt2=<%=ref_dt2%>&fn_id=<%=fn_id%>&br_id=<%=br_id%>&user_id=<%=user_id%>" name="RegCondList" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" topmargin=0 marginwidth="0" border="0" frameborder="0"></iframe></td>
  </tr>
</table>
