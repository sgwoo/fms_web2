...
<%
	...
	Vector vt = ln_db.getAgentAlinkSendLCList(s_kd, t_wd, andor, gubun1, gubun2, gubun3, gubun4, gubun5, st_dt, end_dt, user_id);	
	int vt_size = vt.size();
%>
	...
	<td class='line' width='1280'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
        	...
        	<tr>
        	    ...
        	    <td width='80' class='title'>PDF파일</td>
        	    <td width='80' class='title'>JPG압축파일</td>
        	</tr>
	     </table>
	</td>
    </tr>
