...
<%
	...
	Vector vt = ln_db.getAlinkCancelList(s_kd, t_wd, andor, gubun1, gubun2, gubun3, gubun4, gubun5, st_dt, end_dt, ck_acar_id);	
	int vt_size = vt.size();
%>
...
<table border="0" cellspacing="0" cellpadding="0" width='1220'>
	...
	<td class='line' width='880'>
	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
        	    ...
        	    <td rowspan="2" width='80' class='title'>폐기일자</td>
	...
	<td class='line' width='880'>
		...
		%>
       		<tr>
        	    ...
        	    <td <%=td_color%> width='80' align='center'><%=AddUtil.ChangeDate2(String.valueOf(ht.get("REG_DT")))%></td>
                    <td <%=td_color%> width='100' align='center'><%=ht.get("DOC_STAT")%></td>        	    
        	</tr>
		<%	}%>
	    </table>
	</td>
