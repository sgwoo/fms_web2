...
<%
	...
	String values	= 	"?auth_rw="+auth_rw+"&user_id="+user_id+"&br_id="+br_id+
					...
					"&gubun1="+gubun1+"&gubun2="+gubun2+"&gubun3="+gubun3+
		...
		<tr>
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width=100%>
					<tr>
						<td>
							<iframe src="alink_s2_sc_in.jsp<%=values%>" name="inner" width="100%" height="<%=height%>" cellpadding="0" cellspacing="0" border="0" frameborder="0" noresize scrolling=yes, marginwidth=0, marginheight=0 >
							</iframe>
						</td>
					</tr>
				</table>
