...
<!--
	...
	url = url + "&est_st=<%=est_st%>&fee_opt_amt=<%=fee_opt_amt%>&fee_rent_st=<%=fee_rent_st%>&est_id=<%=est_id%>&spe_seq=<%=spe_seq%>&est_table=<%=est_table%>&list_from_page=<%=list_from_page%>";
	...
	{
		parent.detail_body.location.href = "/agent/off_lease/off_lease_car_his.jsp"+url;
	}

	//정비기록표
	function open_car_mng()
	{
		parent.detail_body.location.href = "/agent/off_lease/off_lease_car_mng.jsp"+url;
	}

	//사고이력표
	function open_accident()
	{
		parent.detail_body.location.href = "/agent/off_lease/off_lease_accident.jsp"+url;
	}
...
<table border=0 cellspacing=0 cellpadding=0 width=100%>
    ...
    <tr>
        <td align=right><a href='javascript:list()'><img src=/acar/images/center/button_list.gif border=0 align=absmiddle></a></td> 
    </tr>    
    <tr> 
        <td class=line2></td>
    </tr>
	    ...
	    <td class=line>
		    <table border=0 cellspacing=1 cellpadding=0 width=100%>
			    <tr>  
                    ...
                    <td width="34%">&nbsp;&nbsp;&nbsp;<b><%= c_db.getNameById(car_mng_id, "CAR_NO") %></b></td>
					<td class=title width="16%" style='height:28'>차량명</td>
                    <td width="34%">&nbsp;&nbsp;&nbsp;<b><%= c_db.getNameById(car_mng_id, "CAR_NM2") %></b></td>
        	   </tr>
            </table>
        </td> 
    </tr>    
