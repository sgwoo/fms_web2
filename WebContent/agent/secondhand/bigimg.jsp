...
<table width="620" border="0" cellspacing="0" cellpadding="0">
    <tr> 
        <td colspan="3"><img src="/acar/images/res/v_pop01.gif" width="620"></td>
    </tr>
    <tr> 
        <td valign=top><img src="/acar/images/res/v_pop02.gif" width="10" height="395"></td>
    	...
    	<%}else{%>																				
    	  <img src="/acar/images/res/no_photo.gif" width="524" height=390 name="f">    									
    	<%}%>		
    	</td>
        <td valign=top><img src="/acar/images/res/v_pop03.gif" width="10" height="395"></td>
    </tr>
    <tr> 
        <td valign=top><img src="/acar/images/res/v_pop05.gif" width="10" height="102"></td>
        <td valign=top>
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="14%"><img src="/acar/images/res/v_pop06.gif" width="83" height="102"></td>
                  <td width="12%"><a href="javascript:showLargePic(4);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','/acar/images/res/v_pop01_1.gif',1)"><img src="/acar/images/res/v_pop07.gif" width="72" height="102" border="0" name="Image1"></a></td>
                  <td width="11%"><a href="javascript:showLargePic(2);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','/acar/images/res/v_pop01_2.gif',1)"><img src="/acar/images/res/v_pop08.gif" width="68" height="102" border="0" name="Image2"></a></td>
                  <td width="12%"><a href="javascript:showLargePic(3);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','/acar/images/res/v_pop01_3.gif',1)"><img src="/acar/images/res/v_pop09.gif" width="71" height="102" border="0" name="Image3"></a></td>
                  <td width="12%"><a href="javascript:showLargePic(0);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','/acar/images/res/v_pop01_4.gif',1)"><img src="/acar/images/res/v_pop10.gif" width="73" height="102" border="0" name="Image4"></a></td>
                  <td width="12%"><a href="javascript:showLargePic(1);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','/acar/images/res/v_pop01_5.gif',1)"><img src="/acar/images/res/v_pop11.gif" width="71" height="102" border="0" name="Image5"></a></td>
                  <td width="12%"><a href="javascript:startSlideShow(0)"><img src="/acar/images/res/v_pop12.gif" width="93" height="102" border="0"></a></td>
                  <td width="15%"><a href="javascript:stopSlideShow()"><img src="/acar/images/res/v_pop13.gif" width="30" height="102" border="0"></a></td>
                  <td width="0%"><a href="javascript:self.close()"><img src="/acar/images/res/v_pop14.gif" border="0"></a></td>
                </tr>
            </table>
        </td>
        <td valign=top><img src="/acar/images/res/v_pop15.gif" width="10" height="102"></td>
    </tr>
    <tr> 
        <td colspan="3" background="/acar/images/res/v_pop06.gif" style='height:10'></td>
    </tr>  
    <tr>
        <td class=h></td>
    </tr>
