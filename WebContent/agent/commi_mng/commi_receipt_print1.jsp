...
<%
	...
	Vector commis = acm_db.getCommiList("", "9", "4", "2", "", st_dt, end_dt, "", "", "9", "0" , ck_acar_id, emp_id );
				                ...
				                <td align=right>
				                	<TABLE border="0" cellspacing="0" cellpadding="0" style='border-collapse:collapse;border:none;'>
					                    <TR>
					                        ...
					                        <TD colspan="2" width="105" align="center" class=style2><img src=/agent/images/receipt_img.gif></TD>
					                    </TR>
					                    <TR>
			    ...
			    <tr>
			        <td>
			        	<table width="700" border="0" cellspacing="0" cellpadding="0">
							...
							<TR>
								<TD height="28" class=style3>&nbsp;9.&nbsp;성&nbsp;&nbsp;&nbsp;&nbsp;명</TD>
							...
							<TR>
								<TD height="28" class=style3>&nbsp;11.주&nbsp;&nbsp;&nbsp;&nbsp;소</TD>
...
<%	} %>							
							...
							<TR>
								<TD height="23" class=style5>&nbsp;</TD>
								<TD class=style5>&nbsp;</TD>
								<TD class=style5>&nbsp;</TD>
								<TD class=style5>&nbsp;</TD>
								<TD class=style5>&nbsp;</TD>
								<TD colspan="2"  class=style5 align=right>&nbsp;</TD>
...
<table width="700" border="0" cellspacing="2" cellpadding="0" bgcolor="#000000">
	<tr>
		<td bgcolor="#FFFFFF">
		 ...
		 <% 	for(int i = 12+(p*40) ; i <12+(k*40) +(p*list_size1)  ; i++){
				Hashtable commi = (Hashtable)commis.elementAt(i);  						
				%>													
			...
			<% } 
			for(int i = 0 ; i <40 - (k*40) + (p*list_size1) ; i++){		%>					
						<TR>
										<TD height="23" class=style3>&nbsp;</TD>
										<TD class=style3>&nbsp;</TD>
										<TD class=style3>&nbsp;</TD>
...
<table width="700" border="0" cellspacing="2" cellpadding="0" bgcolor="#000000">
	<tr>
		<td bgcolor="#FFFFFF">
		  ...
		  <% for(int i = 12+(page_size1*40) ; i <12+(page_size1*40) +(page_size1*list_size1)  ; i++){
				Hashtable commi = (Hashtable)commis.elementAt(i);  						
				%>													
