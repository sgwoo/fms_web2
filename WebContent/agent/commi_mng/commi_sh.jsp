...
<!--
	function search(){
		...
		fm.action='/agent/commi_mng/commi_sc.jsp';
		fm.target='c_foot';		
		fm.submit()
	}	
	function enter(){
...
<body leftmargin="15">
<form name='form1'  target='inner' method='post'>
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 수당관리 > <span class=style5>수당지급현황</span></span></td>
		...
		<td>			
            <table border="0" cellspacing="0" cellpadding="0" width=100%>
                <tr> 
                    ...
                    <td width='12%'><img src=/acar/images/center/arrow_ssjh.gif align=absmiddle>&nbsp;
            ...
            <!--                <option value='8' <%if(s_kd.equals("8")){%> selected <%}%>>영업담당자</option>  -->
                    ...
                    <td><img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>&nbsp;
                        <select name='sort_gubun' onChange='javascript:search()'>
                            ...
                            <option value='6' <%if(sort_gubun.equals("6")){%> selected <%}%>>만료일자</option>
