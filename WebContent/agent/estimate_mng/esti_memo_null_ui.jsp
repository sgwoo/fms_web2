...
<%
	...
	//숫자인 경우 문자로
   	if ( note.equals("03") )        { 	note = "나그네";       
   	} else if ( note.equals("04") ) {   	note = "담당자미확인";     
   	} else if ( note.equals("05") ) {   	note = "영업사원"; 
   	} else if ( note.equals("06") ) {   	note = "기존업체"; 
   	} else if ( note.equals("07") ) {   	note = "단기대여"; 
   	} else if ( note.equals("08") ) {   	note = "비교견적中"; 
   	} else if ( note.equals("09") ) {   	note = "오프리스조회"; 
   	} else if ( note.equals("10") ) {   	note = "진행업체견적검토用"; 
   	} else if ( note.equals("11") ) {   	note = "타사렌트(리스)로계약함"; 
   	} else if ( note.equals("12") ) {   	note = "할부구매함"; 
   	} else if ( note.equals("13") ) {       note = "장기간보류"; 
   	} else if ( note.equals("14") ) {   	note = "미리검토함"; 
   	} else if ( note.equals("15") ) {   	note = "검토중임"; 
   	} else if ( note.equals("16") ) {   	note = "계약체결"; 
   	} else if ( note.equals("17") ) {   	note = "무관심"; 
   	} else if ( note.equals("18") ) {   	note = "기타"; 
   	} else if ( note.equals("19") ) {   	note = "부재중문자발송"; 
   	} 	   	   
