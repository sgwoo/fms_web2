...
<%
	...
	EstimateBean [] e_r = e_db.getEstimateList2(gubun1, gubun2, gubun3, gubun4, gubun5, gubun6, s_dt, e_dt, s_kd, t_wd, esti_m, esti_m_dt, esti_m_s_dt, esti_m_e_dt);
	int size = e_r.length;
%>
<html>
<head>
...
<form action="esti_mng_u.jsp" name="form1" method="POST">
	...
	<input type="hidden" name="from_page" value="/agent/estimate_mng/esti_mng2_sc_in.jsp">
