    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;
                    <!-- <img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 견적시스템 > 신차견적서관리 > <span class=style5>통화내역</span></span> -->
                    <%if (from_page.equals("esti_mng_sc_in.jsp")) {%>
                   		<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 견적시스템 > 신차견적관리 > <span class=style5>통화내역</span></span>
                   	<%} else if (from_page.equals("esti_sh_sc_in.jsp")) {%>
                   		<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 견적시스템 > 지연대차견적관리 > <span class=style5>통화내역</span></span>
                   	<%} else if (from_page.equals("esti_ext_sc_in.jsp")) {%>
                   		<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 견적시스템 > 연장견적관리 > <span class=style5>통화내역</span></span>
                   	<%} else {%>
                   		<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>영업지원 > 견적시스템 > 신차견적관리 > <span class=style5>통화내역</span></span>
                   	<%}%>
                    </td>
	...
	<tr>
	  ...
	  <%if(e_bean.getEst_ssn().length() < 13){%>
                ...
                <tr>
                    ...
                    <td width=36%>&nbsp;<%=AddUtil.ChangeEnpH(e_bean.getEst_ssn())%></td>
                </tr>
                <tr>
 ...
 <input type="hidden" name="from_page" value="<%=from_page%>">
    ...
    <tr>
        <td class=line>
            <table border="0" cellspacing="1" cellpadding=0 width=100%>			
                <tr>
                    <td class=title width=14%><span title="01:부재중 02:결번 03:나그네 04:담당자미확인 05:영업사원 06:기존업체 07:단기대여 08:비교견적中 09:오프리스조회 10:진행업체견적검토用 11:타사렌트(리스)로계약함 12:할부구매함 13:장기간보류 14:미리검토함 15:검토중임 16:계약체결 17:무관심 18:기타">통화내용</span></td>
                    <td>&nbsp;<textarea class=default name="note" cols=77 rows=5 onBlur="javascript:change(this.value);"></textarea></td>
                </tr>
