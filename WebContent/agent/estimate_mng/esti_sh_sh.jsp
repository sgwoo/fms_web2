    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 견적시스템 > <span class=style5>지연대차견적관리</span></span></td>
            ...
            <table border=0 cellpadding=0 cellspacing=1 width="100%">
                <tr> 
                    <td width="18%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_g_gj.gif align=absmiddle>&nbsp;
                        <select name="gubun1">
                            <option value="7" <%if(gubun1.equals("7"))%>selected<%%>>지연대차</option>                            
                        </select> 
                    </td>
                    ...
                    <td width="16%">담당자 : 
                    	<select name="gubun5">
                            ...
                            <option value='<%=user.get("USER_ID")%>' <%if(gubun5.equals(user.get("USER_ID"))) out.println("selected");%>><%=user.get("USER_NM")%></option>
                            <%		}
                            	}%>
                        </select>                     
                    </td>                                 
                    <td width=28%>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                                ...
                                <td id='esti' style='display:<%if(!gubun4.equals("3")){%>none<%}else{%>block<%}%>'><input type="text" name="s_dt" size="11" value="<%=AddUtil.ChangeDate2(s_dt)%>" class=text onBlur='javscript:this.value = ChangeDate(this.value);'>
                                ~ 
                   ...
                   <td>상담자 : 
                    	<select name="gubun6">
                            ...
                            <%	if(user_size > 0){
                            		for (int i = 0 ; i < user_size ; i++){
                            			Hashtable user = (Hashtable)users.elementAt(i);	%>
                            <option value='<%=user.get("USER_ID")%>' <%if(gubun6.equals(user.get("USER_ID"))) out.println("selected");%>><%=user.get("USER_NM")%></option>
                            <%		}
                            	}%>
                        </select>                             
                    </td>                          
