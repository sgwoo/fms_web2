...
<%
	...
	//0001~0005 국산차
	//0006~     수입차
	Vector vt1 = oad.getEstiBbsList("1", car_comp_id, code, car_comp_nm2, car_nm, car_nm2, refer_nm, s_day, ck_acar_id);		
	int vt1_size = vt1.size();
	
	//제조사
	Vector vt2 = oad.getEstiBbsList("2", car_comp_id, code, car_comp_nm2, car_nm, car_nm2, refer_nm, s_day, ck_acar_id);		
	int vt2_size = vt2.size();
	
	//차종
	Vector vt3 = oad.getEstiBbsList("3", car_comp_id, code, car_comp_nm2, car_nm, car_nm2, refer_nm, s_day, ck_acar_id);		
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>			
                ...
                <tr>                     
                    ...
                    <td <%=td_color%> align=center><%=ht.get("BBS_ST")%> <%//=ht.get("P_VIEW")%></td>
