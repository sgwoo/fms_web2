    	  ...
    	  <table border="0" cellspacing="1" cellpadding="0" width=700>
		          ...
		          <tr>
		            ...
		            <td>&nbsp;
						...
						&nbsp;<input type="text" name="t_addr" id="t_addr" size="32" value='<%=c_assest.getC_ass1_addr()%>'>
		            <td>&nbsp;
		            <td align="center">&nbsp;
		            ...
		            <td>&nbsp;
						...
						&nbsp;<input type="text" name="t_addr" id="t_addr1" size="32" value='<%=c_assest.getC_ass2_addr()%>'>
		            </td>
		          </tr>
		          ...
		          <tr>
		            ...
		            <td>&nbsp;
						...
						&nbsp;<input type="text" name="t_addr" id="t_addr2" size="32" value='<%=c_assest.getR_ass1_addr()%>'>
		            </td>
		            <td align="center">&nbsp;
		            ...
		            <td>&nbsp;
						...
						&nbsp;<input type="text" name="t_addr" id="t_addr3" size="32" value='<%=c_assest.getR_ass2_addr()%>'>
		            </td>
		          </tr>
		        </table>
	</td>
