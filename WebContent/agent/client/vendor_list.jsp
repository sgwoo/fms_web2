...
<%@ page import="acar.util.*, agent.bill_mng.*, acar.common.*"%>
...
<table border="0" cellspacing="0" cellpadding="0" width=100%>
        ...
        <td class='line'> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td>&nbsp;<a href="javascript:setVendor('<%= ven.getCode()%>','<%= ven.getNm()%>');">[<%= ven.getCode()%>]<%= ven.getNm()%>(<%= ven.getApp_st()%>)</a></td>            
                </tr>
                <%	}
				}%>		  
            </table>
    ...
    <tr> 
        <td colspan='6' align='right'> <a href='javascript:window.close()'><img src=/acar/images/center/button_close.gif align=absmiddle border=0></a> 
        </td>
    </tr>
  </table>
</form>
