...
//		f_req_id = req_id[0]==null?"":req_id[0];
	...
	if(mode.equals("offid_cng")){
		...
		if(off_id.equals("009217")) off_user_id = "000223";//아마존탁송
		if(off_id.equals("002371")) off_user_id = "000094";//코리아탁송
		if(off_id.equals("009217")) off_user_id = "000223";//코리아탁송
		...
		if(off_id.equals("010255")) off_user_id = "000263";//스마일탁송 -> 스마일TS
...
//				cons.setSeq				(AddUtil.parseInt(seq[i]));
	...
	//	String url 		= "/fms2/consignment/cons_reg_step4.jsp?cons_no="+cons_no;
