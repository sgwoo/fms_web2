    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 탁송관리 > <span class=style5>탁송미수신현황</span></span></td>
                ...
                <tr>
                    ...
                    <td width=40%>&nbsp;
        		      <select name='gubun1'>
                        ...
                        <option value='코리아탁송' 		 <%if(gubun1.equals("코리아탁송")){%>selected<%}%>>코리아탁송</option>
						<%}else if(user_id.equals("000223")){%>			  
                        <option value='(주)아마존탁송'       		 <%if(gubun1.equals("(주)아마존탁송")){%>selected<%}%>>(주)아마존탁송</option>	
        			    <%}else if(user_id.equals("000095")){%>			  
                        <option value='전국'       		 <%if(gubun1.equals("전국")){%>selected<%}%>>      전국</option>			  
                        ...
                        <option value='코리아탁송(부산)' <%if(gubun1.equals("코리아탁송(부산)")){%>selected<%}%>>코리아탁송(부산)</option>
