...
<%
	...
	long total_amt11	= 0;  //외부탁송료
	long total_amt12	= 0;  //외부탁송료
	long total_amt13	= 0;  //외부탁송료
%>
...
<table border="0" cellspacing="0" cellpadding="0" width='2220'>
	...
	<tr id='tr_title' style='position:relative;z-index:1'>
		<td class='line' width='18%' id='td_title' style='position:relative;'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				<tr>
		          ...
		          <td width="35%" class='title'>차량번호</td>
				</tr>
			</table>
		</td>
		<td class='line' width='82%'>
			<table border="0" cellspacing="1" cellpadding="0" width='100%'>
				<tr>
		          <td width="50" rowspan="3" class='title'>구분</td>				
		          <td width="90" rowspan="3" class='title'>청구일자</td>
				  ...
				  <td width='50' rowspan="3" class='title'>지불<br>구분</td>
				  <td width='60' rowspan="3" class='title'>비용<br>구분</td>
				  <td width='70' rowspan="3" class='title'>고객탁송료</td>				  
				  <td colspan="9" class='title'>청구금액</td>
				  <td width='60' rowspan="3" class='title'>운전자</td>
				  <td width='60' rowspan="3" class='title'>의뢰자</td>
				</tr>
				<tr>
				  <td width='110' rowspan="2" class='title'>장소</td>
			      <td width='130' rowspan="2" class='title'>시간</td>
			      <td width='110' rowspan="2" class='title'>장소</td>
			      <td width='130' rowspan="3" class='title'>시간</td>
			      <td width='70' rowspan="3" class='title'>탁송료</td>			
			      <td width='60' rowspan="3" class='title'>유류비</td>
			      <td width='60' rowspan="3" class='title'>세차비</td>
			      <td width='60' rowspan="3" class='title'>세차<br>수수료</td>					  
			      <td colspan=4 class='title'>기타</td>
			      <td width='80' rowspan="3" class='title'>소계</td>
			  </tr>
			  <tr>
				   <td width='60' class='title'>외부<br>탁송료</td>				  
				   <td width='60' class='title'>주차비</td>
				   <td width='60' class='title'>보증수리<br/>대행</td>
				   <td width='60' class='title'>검사대행</td>		
			  </tr>
			</table>
		</td>
	</tr>
