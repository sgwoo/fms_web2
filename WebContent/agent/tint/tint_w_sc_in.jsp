...
%>
				<tr>
					...
					<td <%if(!String.valueOf(ht.get("INIT_REG_DT")).equals("")){%>class='is'<%}%> width='50' align='center'><%=ht.get("REG_NM")%></td>					
				</tr>
<%
		}
%>
