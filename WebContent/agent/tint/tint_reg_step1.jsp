...
<!--
	...
	function search_off()
	{
		...
		window.open("/agent/cus0601/cus0603_frame.jsp?from_page=/agent/tint/tint_reg_step1.jsp&t_wd="+fm.off_nm.value, "SERV_OFF", "left=10, top=10, width=900, height=600, scrollbars=yes, status=yes, resizable=yes");
	}		
	...
	function view_off()
	{
		...
		window.open("/agent/cus0601/cus0603_d_frame.jsp?from_page=/agent/consignment/cons_i_c.jsp&off_id="+fm.off_id.value, "SERV_OFF", "left=10, top=10, width=900, height=260, scrollbars=yes, status=yes, resizable=yes");
	}		
	...
	{
		var fm = document.form1;
		window.open("/agent/tax/pop_search/s_car.jsp?go_url=/agent/tint/tint_reg_step1.jsp&s_kd=2&t_wd="+fm.car_no.value, "CAR", "left=10, top=10, width=900, height=600, scrollbars=yes, status=yes, resizable=yes");
	}		
	...
	function view_car()
	{
		...
		window.open("/agent/car_register/car_view.jsp?rent_mng_id="+fm.rent_mng_id.value+"&rent_l_cd="+fm.rent_l_cd.value+"&car_mng_id="+fm.car_mng_id.value+"&cmd=ud", "VIEW_CAR", "left=10, top=10, width=850, height=700, scrollbars=yes");
	}			
    	...
    	<td colspan=10>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 용품관리 ><span class=style5>용품의뢰등록</span></span></td>
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
                    ...
                    <td colspan="3">&nbsp;
        			  <input type='text' size='11' name='sup_est_dt' maxlength='11' class='default' value='' onBlur='javscript:this.value = ChangeDate(this.value);'>
