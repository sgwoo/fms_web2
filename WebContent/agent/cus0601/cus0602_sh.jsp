...
function serv_off_reg(){
	var SUBWIN="cus0602_d_cont_i.jsp?from_page=<%= from_page %>?off_type=2";
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 업체정보관리 > <span class=style5>탁송업체관리</span></span></td>
