...
function search_zip()
{
	window.open("/agent/car_rent/zip_s.jsp", "우편번호검색", "left=200, top=100, height=500, width=400, scrollbars=yes");
}
...
<input type="hidden" name="reg_id" value="<%=user_id%>">
	...
	<tr> 
        <td align="right"><a href='javascript:ServOffReg()' onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_reg.gif border=0 align=absmiddle></a> 
        <a href='javascript:self.close();window.close();' onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_close.gif border=0 align=absmiddle></a> 
        </td>
    </tr>
  </form>
</table>
