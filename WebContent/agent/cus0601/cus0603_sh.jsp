...
function serv_off_reg(){
	var SUBWIN="cus0603_d_cont_i.jsp?from_page=<%= from_page %>?off_type=2";
	window.open(SUBWIN, "ServOffReg", "left=100, top=120, width=820, height=200, scrollbars=no");
}
//-->
</script>
</head>
        ...
        <td>
            <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 용품관리 > <span class=style5>납품업체관리</span></span></td>
    ...
    <tr> 
        <td>
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr> 
                    <td width="173">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_gsjg.gif align=absmiddle>
                      &nbsp;<select name='s_kd'>
                    ...
                    <td width="160">&nbsp;&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/arrow_jrjg.gif align=absmiddle>
                    ...
                    <td width="165"> <input type='radio' name='sort' value='asc' <% if(sort.equals("asc")||sort.equals("")){ %>checked<% } %> onClick='javascript:search()'>
                      ...
                      내림차순 </td>
                    <td width="145" align='left'><img src=/acar/images/center/arrow_yus.gif align=absmiddle>
        			<select name='br_id'>
                    ...
                    <td align='right'><a href='javascript:search()' onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_search.gif align=absmiddle border=0></a>
                      <a href='javascript:serv_off_reg()' onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_reg.gif align=absmiddle border=0></a>&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
            </table>
        </td>
