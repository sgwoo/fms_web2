...
<table border="0" cellspacing="0" cellpadding="0" width='1290'>
	...
	<td class='line' width='1030'>
		...
		<tr>
		    ...
		    <td colspan="8" class='title'>용품청구</td>				  
	...
	<td class='line' width='260' id='td_con' style='position:relative;'>
		...
		<tr>
		    ...
		    <td width='70' align='center'><span title='<%=ht.get("OFF_NM")%>'><%=Util.subData(String.valueOf(ht.get("OFF_NM")), 4)%></span></td>
	...
	<td class='line' width='1030'>
		...
		<tr>
		    ...
		    <td width='100' align='center'><%=Util.subData(String.valueOf(ht.get("FIRM_NM")), 6)%><span title='<%=ht.get("FIRM_NM")%>'></span></td>					
		</tr>
		<%	
			...
			total_amt6 	= total_amt6 + AddUtil.parseLong(String.valueOf(ht.get("TOT_AMT")));
