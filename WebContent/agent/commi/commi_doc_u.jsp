...
<%
	...
	Vector commis = a_db.getCommis(emp1.getEmp_id(), ck_acar_id );
	...
	function save(mode){
		...
		if(mode == 'guar'){
			...
			if(fm.serial_no.value == '' || fm.serial_no.value.length < 5){
				alert('블랙박스 일련번호가 없습니다. 먼저 계약관리-용품에서 일련번호를 입력하십시오.');
				return;
			}
			<%}%>
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr> 
        			...
        			<%if(doc.getUser_id8().equals(user_id) || doc.getUser_id7().equals(user_id) || doc.getUser_id2().equals(user_id)){%>
    	    ...
    	    <table border="0" cellspacing="1" cellpadding="0" width=100%>
                ...
                <tr> 
                    ...
                    <td colspan='3'>&nbsp;
                        ...
                        <font color='red'>※ 블랙박스 일련번호가 없거나 7자리 미만으로 정상번호가 아닙니다. 계약관리-용품에서 먼저 입력하십시오. 미처리시 영업수당 기안수정이 안됩니다.</font>
                        <%} %>  
                    </td>
                </tr>    
                <tr> 
            ...
            <td colspan='5'>&nbsp;
              <%if(String.valueOf(alink_lc_rent.get("RENT_L_CD")).equals(rent_l_cd)){%>[전자계약서]<%}%>
                ...
                <tr> 
                    ...
                    <td>&nbsp;<%String pur_bus_st = pur.getPur_bus_st();%><%if(pur_bus_st.equals("1")){%>자체영업<%}else if(pur_bus_st.equals("2")){%>영업사원영업<%}else if(pur_bus_st.equals("3")){%>실적이관영업사원영업<%}else if(pur_bus_st.equals("4")){%>에이전트<%}%></td>
                ...
                <tr> 
                    ...
                    <td>&nbsp;<input type='text' name="comm_r_rt" value='<%=emp1.getComm_r_rt()%>' size="4" class='whitenum' readonly>%</td>
    		    </tr>	
                <tr> 
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
                    ...
                    <td align="center"><input type='text' name='agent_commi' maxlength='8' value='<%=Util.parseDecimal(emp1.getAgent_commi())%>' <%if(String.valueOf(alink_lc_rent.get("RENT_L_CD")).equals(rent_l_cd)){%>readonly<%}%> class='num' size='10' onBlur='javascript:this.value=parseDecimal(this.value); set_amt();'></td>
                  <td align="center">&nbsp;</td>
                    <td align="center">&nbsp;-</td>        		
                    <td align="center">-</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td align="center"><input type='text' name='e_amt' maxlength='8' value='' class='num' size='10' onBlur='javascript:this.value=parseDecimal(this.value);'></td>
                    <td colspan="5">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="center"><input type='text' name='d_amt' maxlength='8' value='' class='num' size='10' onBlur='javascript:this.value=parseDecimal(this.value);'>
                    </td>
