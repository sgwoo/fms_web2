...
<!--
	...
	
	{
		...
		if(idx != "")
		{
			...
			if(idx == 'h'){//사용자정보 수정페이지 실거주지주소 조회.
			window.opener.form1.h_zip.value 	= zip_str;
			window.opener.form1.h_addr.value 	= addr_str;
			}else{
			window.opener.form1.t_zip[idx].value 	= zip_str;
			window.opener.form1.t_addr[idx].value 	= addr_str;
			}
		}
		else if(str == "r")
		{
		...
		else
		{
			...
			window.opener.form1.t_addr.focus();			
			window.opener.form1.t_zip.value 	= zip_str;
			window.opener.form1.t_addr.value 	= addr_str;
...
<body onload="javascript:document.form1.swd.focus();" align=center>
<p>
			...
			<table border="0" cellspacing="1" cellpadding="0" width=350>
				<tr>
					...
					<td>&nbsp;
						...
						(예:공덕1)
						<a href='javascript:save()' onMouseOver="window.status=''; return true"><img src=/acar/images/center/button_in_search1.gif border=0 align=absmiddle></a>
					</td>
				</tr>
