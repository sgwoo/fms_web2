...
<%
	...
	if(auth_rw.equals(""))	auth_rw = rs_db.getAuthRw(user_id, "22", "02", "08");
    	...
    	<td>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>특판계출관리 > <span class=style5>배정현황</span></span></td>
        ...
        <td class=line>
    	    <table border="0" cellspacing="1" cellpadding='0' width=100%>
                ...
                <tr>
                    ...
                    <td width=33%>&nbsp;
            		<select name='gubun1'>                            
                            <option value='2' <%if(gubun1.equals("2")){%>selected<%}%>> 배정일자 </option>
                        </select>
                        &nbsp;
                        <select name='gubun2'>                          
                  ...
                  <td>&nbsp;
        	      <select name='sort'>
                          <option value='2' <%if(sort.equals("2")){%>selected<%}%>> 배정일자 </option>                          
                      </select>
        	  </td>						
                </tr>
    	    </table>
