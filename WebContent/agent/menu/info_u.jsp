            ...
            <table border="0" cellspacing="1" width=450>
				...
				<tr>
				 ...
				 <tr>
		            ...
		            <td colspan=3>&nbsp;<input type="text" name="user_pos" value="<%=user_pos%>" size="15" class=text readonly="readonly">
		          		  ※직위는 수정 불가능합니다.
		            </td>
           	    </tr>
				<tr>
				...
				<script>
           	    ...
           	    <tr>
		            ...
		            <td colspan=3>&nbsp;
						...
						&nbsp;<input type="text" name="t_addr" id="t_addr" size="65" value="<%=user_bean.getAddr()%>">
                    </td>
           	    </tr>
           	    <tr>
