...
<%@ page import="acar.car_office.*, acar.cls.*, acar.con_tax.*, acar.insur.*"%>
        ...
        <td class='line'>
	        <table border="0" cellspacing="1" cellpadding="0" width=100%>
    		    ...
    		    <tr>
        		    ...
        		    <td colspan="3">&nbsp;<%=client.getSsn1()%>-<%if(client.getClient_st().equals("1")){%><%=client.getSsn1()%><%}else{%><%if(client.getSsn2().length() > 1){%><%=client.getSsn2().substring(0,1)%><%}%><%}%></td>
		        </tr>
		        <tr>
		        ...
		        <tr>
        		    ...
        		    <td colspan="3">&nbsp;<%=client.getSsn1()%>-<%if(client.getSsn2().length() > 1){%><%=client.getSsn2().substring(0,1)%><%}%>******<%//=client.getSsn2()%></td>
                ...
                <tr>
                    <td class='title' style="font-size : 8pt;">면책금청구여부</td>
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding='0' width=100%>
                <tr>
                    ...
                    <td width='15%' align='left' style="font-size : 8pt;">&nbsp;</td>			
                </tr>		  
            </table>
        </td>
    </tr>	
        ...
        <td class=line> 
            <table border="0" cellspacing="1" cellpadding="0" width=100%>
        	    ...
        	    <td width='15%' class=title style="font-size : 8pt;">회사</td>
                    ...
                    <td width='15%' class=title style="font-size : 8pt;">전화번호</td>
                    <td width='15%' class=title style="font-size : 8pt;">휴대폰</td>
                    <td width='15%' class=title style="font-size : 8pt;">FAX</td>
                </tr>
                ...
                <tr> 
                    ...
                    <td align='center'><%=AddUtil.phoneFormat(String.valueOf(mgr_bus.get("O_TEL")))%> </td>
                    <td align='center'><%=AddUtil.phoneFormat(String.valueOf(mgr_bus.get("TEL")))%> </td>
                    <td align='center'><%=AddUtil.phoneFormat(String.valueOf(mgr_bus.get("FAX")))%> </td>
                </tr>		  
        		  <%}%>
                ...
                <tr> 
                    ...
                    <td align='center'><%=AddUtil.phoneFormat(String.valueOf(mgr_dlv.get("O_TEL")))%> </td>
                    <td align='center'><%=AddUtil.phoneFormat(String.valueOf(mgr_dlv.get("TEL")))%> </td>
                    <td align='center'><%=AddUtil.phoneFormat(String.valueOf(mgr_dlv.get("FAX")))%> </td>
                </tr>
		        <%}%>
            </table>
        </td>
        ...
        <td class='line'> 			
		    ...
		    <%if(!cr_bean.getCar_no().equals("")){%>
                ...
                <tr>
                    ...
                    <td colspan="3">&nbsp;<%=cm_bean.getCar_name()%></td>
                </tr>
                <tr>
        ...
        <td class=line>
	        <table border="0" cellspacing="1" cellpadding="0" width=100%>
                <tr>
                    ...
                    <td width="40%">&nbsp;<%=gins.getGi_jijum()%></td>
                </tr>
            </table>
	    </td>
    </tr>    
