...
<frameset rows="140,*" border=1>
  <frame src="credit_memo_sh.jsp?m_id=<%=m_id%>&l_cd=<%=l_cd%>&r_st=<%=r_st%>&fee_tm=<%=fee_tm%>&tm_st1=<%=tm_st1%>&bus_id2=<%=bus_id2%>&mode=<%=mode%>&memo_st=<%=memo_st%>" name="cm_head" marginwidth=10 marginheight=10 scrolling="auto" noresize>
  <frame src="credit_memo_sc.jsp?m_id=<%=m_id%>&l_cd=<%=l_cd%>&r_st=<%=r_st%>&fee_tm=<%=fee_tm%>&tm_st1=<%=tm_st1%>&bus_id2=<%=bus_id2%>&mode=<%=mode%>&memo_st=<%=memo_st%>" name="cm_foot" marginwidth=10 marginheight=10 scrolling="auto">
</frameset>
</HTML>