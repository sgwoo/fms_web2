    	...
    	<td colspan=2>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>견적사후관리 > <span class=style5>사후관리리포트</span></span></td>
			...
			<select name='gubun1'>
                    ...
                    <td width="40%">&nbsp;
                        <select name='gubun3'>
                            ...
                            <option value="2" <%if(gubun3.equals("2"))%>selected<%%>>견적</option>                            
                        </select>
                    </td>
                </tr>
                <tr>    
