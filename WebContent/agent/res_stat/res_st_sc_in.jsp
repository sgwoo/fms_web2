    ...
    <tr>
		...
		<%	for(int i = 0 ; i < cont_size ; i++){
                ...
                <tr> 
                    ...
                    <td width='50' align='center'>
        		    <%if(String.valueOf(reserv.get("BUS_ID")).equals(user_id) || (!String.valueOf(reserv.get("RENT_ST")).equals("예약대기") && !String.valueOf(reserv.get("RENT_ST")).equals("장기대기") && (auth_rw.equals("2") || auth_rw.equals("4") || auth_rw.equals("6")))){%>
                    ...
                    <td width='120'>&nbsp;<font color="#808080"><span title='<%=reserv.get("CUST_NM")%>'><%=AddUtil.substringbdot(String.valueOf(reserv.get("CUST_NM")), 17)%></span></font></td>		  
					<td width='50' align='center'>
