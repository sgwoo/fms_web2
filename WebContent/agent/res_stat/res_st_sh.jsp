...
<body leftmargin="15">
<form name='form1' method='post' action='res_st_sc.jsp' target='c_foot'>
    	...
    	<td colspan=5>
    	    <table width=100% border=0 cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td class=bar>&nbsp;&nbsp;&nbsp;<img src=/acar/images/center/menu_bar_dot.gif width=4 height=5 align=absmiddle>&nbsp;<span class=style1>Agent > 계출관리 > <span class=style5>대차배차등록</span></span></td>
    ...
    <tr> 
        ...
        <td id='td_input' align='left' style="display:''"><img src=/acar/images/center/arrow_jrjg.gif  align=absmiddle>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
            <select name='sort_gubun' onChange='javascript:search()'>
              <option value='d.car_no' <%if(sort_gubun.equals("d.car_no")){%> selected <%}%>>차량번호</option>
              <option value='d.car_nm' <%if(sort_gubun.equals("d.car_nm")){%> selected <%}%>>차명</option>
...
<form action="/acar/res_search/car_mst_nodisplay.jsp" name="form2" method="post">
