...
<%
	...
	String memo_st = request.getParameter("memo_st")==null?"":request.getParameter("memo_st");
     ...
     //    	 if ( !dept_nm.equals("에이전트")  ) {
       // 	 	 user_id = "";
         	//  }
         	  
         	  //신차만 나오도록???
	Vector accids = ClientMngDb.getCarCngRentListSearchA(s_br, s_kd, t_wd, user_id);
        ...
        <td class=line> 
          ...
          <%for (int i = 0 ; i < accid_size ; i++){
                ...
                <tr align="center"> 
                    ...
                    <td>
						<%if(go_url.equals("/agent/lc_rent/lc_cng_new_car_c.jsp") && !String.valueOf(accid.get("CAR_MNG_ID")).equals("")){%>
						<%=accid.get("RENT_L_CD")%>
						<%}else{%>
