...
<%
	...
	his = olyD.getCarHisList(car_mng_id);
...
<table border="0" cellspacing="0" cellpadding="0" width='100%'>
	...
	<!--
	<tr> 
	    <td align="right"><a href="javascript:pop_excel();"><img src=/acar/images/center/button_excel.gif border=0 align=absmiddle></a></td>
	</tr>
	-->
	<tr>
        ...
        <td colspan=2 class='line' width='100%' id='td_title' style='position:relative;'> 
	  	    <table border="0" cellspacing="1" cellpadding="0" width='100%'>
                <tr> 
                    ...
                    <td width=18% class='title'>대여기간</td>
        ...
        <td class='line' width='100%' id='td_con' style='position:relative;' colspan=2>
	        <table border="0" cellspacing="1" cellpadding="0" width='100%'>
              <%		for(int i = 0 ; i < his_size ; i++){
    			...
    			//if(s_kd.equals("2") && t_wd.equals(AddUtil.getDate().substring(0,7)) && cont.getCar_st().equals("2") && !cont.getInit_reg_dt().equals("")) continue;
    			count++;
    %>
                <tr> 
        			...
        			<td width=15% align='center'><%if(ch.getCls_st().equals("1")){%>계약만료
