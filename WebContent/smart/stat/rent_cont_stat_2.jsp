...
<div id="wrap">
    ...
    <div id="contents">
    	<div class="text01"><img src="/smart/images/arrow.png"> <b>대여기간별현황 : <%if(mode.equals("1")){%>신차<%}else if(mode.equals("2")){%>재리스<%}else if(mode.equals("3")){%>연장<%}%></b></div>
	<div id="dj_list">	
		...
		<!--비율-->							
       		<tr> 
       			<th class="c" style="text-align:center;">비율</th>  
