...
/* 레이아웃 큰박스 속성 */
#wrap {float:left; margin:0 auto; width:100%; background-color:#2c371a;}
...
<div id="wrap">
    ...
    <div id="contents">
        <div id="gnb_menu">
            <ul>
            	<li><a href="bbs_list.jsp<%=hidden_value%>"><img src="/smart/images/bbs_menu01.gif" alt="menu1" /><br />공지사항</a></li>
            	<li><a href="prop_list.jsp<%=hidden_value%>"><img src="/smart/images/bbs_menu02.gif" alt="menu2" /><br />제안함</a></li>            	
                <li><a href="unconfirm_list.jsp"><img src="/smart/images/bbs_menu03.gif" alt="menu3" /><br />미확인입금</a></li>
                <li><a href="demand_inside_list.jsp<%=hidden_value%>"><img src="/smart/images/bbs_menu04.gif" alt="menu4" /><br />입금조회</a></li> 
                <li><a href="knowhow_list.jsp"><img src="/smart/images/bbs_menu05.gif" alt="menu5" /><br />지식IN</a></li>
            </ul>
        </div>
    </div>
    <div id="footer"></div>
