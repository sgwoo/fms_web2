...
<div id="wrap">
    ...
    <div id="contents">
        <div id="gnb_menu">
            <ul>
            	<li><a href="client_vst_reg.jsp<%=hidden_value%>"><img src="/smart/images/nreg_menu01.gif" alt="menu1" /><br />거래처방문등록</a></li>
            	<li><a href="car_dist_reg.jsp<%=hidden_value%>"><img src="/smart/images/nreg_menu02.gif" alt="menu2" /><br />주행거리등록</a></li>
            	<!--<li><a href="rent_start_reg.jsp<%=hidden_value%>"><img src="/smart/images/nreg_menu03.gif" alt="menu1" /><br />대여개시등록</a></li>-->
            	<!--<li><a href="car_deli_reg.jsp<%=hidden_value%>"><img src="/smart/images/nreg_menu04.gif" alt="menu2" /><br />보유차배차등록</a></li>
            	<li><a href="car_ret_reg.jsp<%=hidden_value%>"><img src="/smart/images/nreg_menu05.gif" alt="menu2" /><br />보유차반차등록</a></li>-->
            </ul>
        </div>
    </div>
    <div id="footer"></div>
