	    	...
	    	<div class="roundedBox" id="type4" style="margin:0 auto;">
			    ...
			    <div class="contents_box">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
				    	...
				    	<tr>
				    		<th width="70">배차일시</th>
				    		<td><%=AddUtil.ChangeDate2(rc_bean.getDeli_dt_d())%> <%=rc_bean.getDeli_dt_h()%>시 <%=rc_bean.getDeli_dt_s()%>분</td>
				    	</tr>	
						<tr>
							<th>배차위치</th>
						...
						<tr>
							<th>반차예정일시</th>
				    		<td><%=AddUtil.ChangeDate2(rc_bean.getRet_plan_dt_d())%> <%=rc_bean.getRet_plan_dt_h()%>시 <%=rc_bean.getRet_plan_dt_s()%>분</td>							
						</tr>											
				    </table>
			    </div>
			    <div class="corner bottomLeft"></div>
