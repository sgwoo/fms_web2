...
<%
	...
	vt = rs_db.getResStatList_New(s_kd, t_wd, self_st, user_id);
...
//		if(fm.t_wd.value == ''){ alert('검색어를 입력하십시오.'); fm.t_wd.focus(); return; }	
		...
		fm.action = 'search_deli_car_list.jsp';
		fm.target = '_self';
		fm.submit();
	}
	function enter() {
...
<form name='form1' action='search_deli_car_list.jsp' method='post'>
...
<div id="wrap">
    <div id="header">
        <div id="gnb_box">        	
			<div id="gnb_login">배차대기차량 조회</div>
			<div id="gnb_home"></div>
