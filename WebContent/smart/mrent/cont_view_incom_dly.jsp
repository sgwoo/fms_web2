...
<%
	...
	if(gubun3.equals("2")) vt_size2 = 0;
	if(gubun3.equals("1")) vt_size 	= 0;
%> 
...
<body>
<form name='form1' method='post' action='cont_view_incom_dly.jsp'>
...
<!--//ui object -->
		...
		<br>
		 ...
		 <%for (int i = 0 ; i < vt_size ; i++){
			...
			<ul class="lst_type">
				<li>
					<span><h3><%=Util.parseDecimal(String.valueOf(ht.get("DLY_AMT")))%>원 <em>미수금</em></h3></span>					
					<br>
				</li>
			</ul>
          <%}%>
		 ...
		 <%for (int i = 0 ; i < vt_size2 ; i++){
			...
			<ul class="lst_type">
				<li>
					<span><h3><%=AddUtil.ChangeDate2(String.valueOf(ht.get("PAY_DT")))%> 입금 <%=Util.parseDecimal(String.valueOf(ht.get("PAY_AMT")))%>원 </h3></span>					
					<br>
				</li>
			</ul>
          <%}%>
		  
		  <%if(gubun3.equals("2") && vt_size==0){%>
			<ul class="lst_type">
		  ...
		  <%if(gubun3.equals("0") && (vt_size+vt_size2)==0){%>
			<ul class="lst_type">
				<li><span>데이타가 없습니다.</span>
				</li>
			</ul>		  
