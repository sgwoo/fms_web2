...
<div id="wrap">
    ...
    <div id="contents">
    	<div id="gnb_menu">
            <ul>
            	<li><a href="mrent_list.jsp?s_kd=1"><img src="/smart/images/fms_menu01.gif" alt="menu1" /><br />상호</a></li>
            	<li><a href="mrent_list.jsp?s_kd=2"><img src="/smart/images/fms_menu02.gif" alt="menu2" /><br />차량번호</a></li>            	
            </ul>
			<ul>
            	<li><a href="mrent_list3.jsp?s_kd=3"><img src="/smart/images/fms_menu02.gif" alt="menu3" /><br />대기차량검색</a></li>            	
            </ul>
        </div>
    <div id="footer"></div>
</div>
