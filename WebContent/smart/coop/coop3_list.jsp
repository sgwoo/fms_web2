...
<%
	...
	Vector vt = cp_db.CooperationPList(s_year, s_mon, "", s_kd, t_wd, gubun1, gubun2, gubun3, gubun4);
	int vt_size = vt.size();
...
<form name="form1" method="post"   action='coop3_list.jsp'>
...
<div id="wrap">
	<div id="header">
        <div id="gnb_box">
            ...
            <div id="gnb_login">고객방문협조(주차장)</div>
