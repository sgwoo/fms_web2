...
<%
	...
	Vector vt = cp_db.CooperationList(s_year, s_mon, "", s_kd, t_wd, gubun1, gubun2, gubun3, gubun4);
	int vt_size = vt.size();
...
<form name="form1" method="post"   action='coop1_list.jsp'>
	...
	<div id="contents">    
		...
		<tbody>            
            ...
            <ul class="List">
				<li>
					<span>
						<font color="#7f7f7f"><%= AddUtil.ChangeDate2((String)ht.get("IN_DT")) %>&nbsp;<font color="#aeaeae"> | </font>&nbsp;<%=ht.get("USER_NM")%></font>
					</span>
					<br />
		    		<span>
