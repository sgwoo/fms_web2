...
<div id="wrap">
    ...
    <div id="contents">
        <div id="gnb_menu">
            <ul>
            	<li><a href="/smart/insa/sch_reg_1.jsp"><img src="/smart/images/new_menu01.gif" alt="menu1" /><br />현지출근등록</a></li>
            	<li><a href="/smart/insa/sch_reg_2.jsp"><img src="/smart/images/new_menu02.gif" alt="menu2" /><br />업무일지등록</a></li>
            	<!-- <li><a href="/smart/insa/sch_reg_3.jsp"><img src="/smart/images/new_menu03.gif" alt="menu3" /><br />휴가등록</a></li> -->
            	<li><a href="/smart/insa/watch_main.jsp"><img src="/smart/images/new_menu04.gif" alt="menu4" /><br />당직표</a></li>
            	<li><a href="/smart/insa/sch_stat_4.jsp"><img src="/smart/images/new_menu05.gif" alt="menu5" /><br />휴가자현황</a></li>            	
            </ul>
        </div>
    </div>
    <div id="footer"></div>
