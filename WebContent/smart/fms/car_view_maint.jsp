	    	...
	    	<div class="roundedBox" id="type4" style="margin:0 auto;">				
			    ...
			    <div class="contents_box">					
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
				    		<th>비용</th>
				    		<td><%=AddUtil.parseDecimal(String.valueOf(ht.get("CHE_AMT")))%>원</td>
				    	</tr>
						<tr>
				    		<th>주행거리</th>
	    	...
	    	<div class="roundedBox" id="type4" style="margin:0 auto;">				
			    ...
			    <div class="contents_box">					
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
				    		<td>검사유효기간 : <%=cr_bean.getMaint_st_dt()%> ~ <%=cr_bean.getMaint_end_dt()%></td>
				    	</tr>
						<tr>
				    		<td>점검유효기간 : <%=cr_bean.getTest_st_dt()%> ~ <%=cr_bean.getTest_end_dt()%></td>
				    	</tr>
				    </table>
