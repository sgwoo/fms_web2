...
#contents {float:left; width:100%; height:350px;}
...
<%@ include file="/include/search_hidden.jsp" %>
	...
	<input type='hidden' name='from_page'	value='cont_menu.jsp'>		
...
<div id="wrap">
    ...
    <div id="contents">
		<a href="cont_main.jsp<%=hidden_value%>&st=1">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_ssub_m2.gif" alt="menu1" /></div>
            <div id="menu_tt">계약내용</div>
            <div id="menu_mrg"><img src="/acar./images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="car_main.jsp<%=hidden_value%>&st=2">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/cl_smain_m2.gif" alt="menu2" /></div>
            <div id="menu_tt">자동차</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="cms_view.jsp<%=hidden_value%>&st=5">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_smain_m6.gif" alt="menu2" /></div>
            <div id="menu_tt">CMS정보</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="tax_view.jsp<%=hidden_value%>&st=3">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_smain_m7.gif" alt="menu2" /></div>
            <div id="menu_tt">세금계산서</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="settle_list.jsp<%=hidden_value%>&st=4">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_smain_m5.gif" alt="menu2" /></div>
            <div id="menu_tt">미수금조회</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
    </div>
