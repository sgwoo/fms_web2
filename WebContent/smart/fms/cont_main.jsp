...
<!--
	function view_info(st)
	{
		...
		if(st == '1'){
			fm.action = "cont_view_base.jsp";		
		}else if(st == '2'){
			fm.action = "cont_view_etc.jsp";		
		}else if(st == '3'){
			fm.action = "cont_view_janga.jsp";		
		}else if(st == '4'){
			fm.action = "cont_view_grt.jsp";		
		}else if(st == '5'){
			fm.action = "cont_view_fee.jsp";		
		}else if(st == '6'){
			fm.action = "cont_view_incom.jsp";		
		}else if(st == '7'){
			fm.action = "cont_view_emp.jsp";		
		}
...
<div id="wrap">
    <div id="header">
        <div id="gnb_box">        	
			<div id="gnb_login"><%if(car_no.equals("미등록")){%><%//=rent_l_cd%><%=car_nm%><%}else{%><%=car_no%><%}%></div>
			<div id="gnb_home">				
				...
				<!--<a href="javascript:view_client()" onMouseOver="window.status=''; return true" title='고객'><img src=/smart/images/btn_cus.gif align=absmiddle /></a>-->
				<a href='/smart/main.jsp' title='홈'><img src=/smart/images/btn_home.gif align=absmiddle /></a>
			</div>
        </div>
    </div>
    <div id="contents">
		<a href="cont_view_base.jsp<%=hidden_value%>&st=1">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/sl_m2.gif" alt="menu1" /></div>
            <div id="menu_tt">기본사항</div>
            <div id="menu_mrg"><img src="/acar./images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="cont_view_etc.jsp<%=hidden_value%>&st=2">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_ssub_m3.gif" alt="menu2" /></div>
            <div id="menu_tt">특약사항</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="cont_view_janga.jsp<%=hidden_value%>&st=3">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_ssub_m6.gif" alt="menu2" /></div>
            <div id="menu_tt">잔가</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="cont_view_grt.jsp<%=hidden_value%>&st=4">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_ssub_m5.gif" alt="menu2" /></div>
            <div id="menu_tt">선수금</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="cont_view_fee.jsp<%=hidden_value%>&st=5">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/sl_m6.gif" alt="menu2" /></div>
            <div id="menu_tt">대여료</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="cont_view_incom.jsp<%=hidden_value%>&st=6">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_ssub_m4.gif" alt="menu2" /></div>
            <div id="menu_tt">수금현황</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
		<a href="cont_view_emp.jsp<%=hidden_value%>&st=7">
        <div id="gnb_menu">
			<div id="menu_mn"><img src="/smart/images/fms_ssub_m7.gif" alt="menu2" /></div>
            <div id="menu_tt">영업사원</div>
            <div id="menu_mrg"><img src="/smart/images/cl_smain_mrg.gif" alt="mrg" /></div>
        </div>
		</a>
    </div>
