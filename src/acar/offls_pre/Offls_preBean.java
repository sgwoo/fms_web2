...
*/	private String damdang_id;	//담당자id
	...
	private String car_doc_no; 						//차량관리번호
	private String gps;
	private String park;
	private String cons_dt;   //탁송일
	private int  a_cnt;   //수해유무
    
	private String car_out_dt; //경매장출고 일자.
	
	private String actn_id; //경매장

    // CONSTRCTOR            
    public Offls_preBean() {
