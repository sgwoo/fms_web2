...
public class InsurBean
{
	...
	private int    vins_cacdt_me_amt;		//임의보혐_자기차량손해_(최대)자기부담금
	...
	private String ins_kd;
	private String reg_cau;
	private String exp_st;
	private String ins_est_dt;
	private String r_ins_est_dt;
	private String auto_yn;
	private String abs_yn;
	private String ins_rent_dt;
	private int    vins_cacdt_memin_amt;		//임의보혐_자기차량손해_최소자기부담금(물적사고할증기준*10%)
	private int    vins_cacdt_mebase_amt;		//임의보혐_자기차량손해_물적사고할증기준
	private String blackbox_yn;
	private int    vins_share_extra_amt;		//렌트카조합-분담금할증한정
	private int    vins_blackbox_amt;			//블랙박스할인특약
	private String vins_blackbox_per;			//블랙박스할인율
	private String com_emp_yn;					//임직원운전자한정특약
	private String firm_emp_nm;					//임직원운전자한정특약 임차인
	private String long_emp_yn;					//장기_단기 구분
	private String blackbox_nm;					//블랙박스 제품명
	private int    blackbox_amt;				//블랙박스 구입금액(공급가)
	private String blackbox_no;					//블랙박스 시리얼번호
	private String blackbox_dt;					//블랙박스 설치일자
	private String enp_no;						//사업자번호
	private String lkas_yn;						//차선이탈제어형 적용유뮤
	private String ldws_yn;						//차선이탈경고형 적용유뮤
	private String aeb_yn;						//긴급제동제어형 적용유뮤
	private String fcw_yn;						//긴급제동경고형 적용유뮤
	private String ev_yn;						//전기자동차 적용유뮤
	private String others;						//계약 비고
	private String others_device;				//기타장치
	private String com_emp_start_dt;			//임직원 시작일
	private String com_emp_exp_dt;				//임직원 종료일
	private String hook_yn;						//견인고리장착여부
	private String legal_yn;					//법룰비용지원금(고급형)
	...
	public InsurBean()
	{
		...
		update_id				= "";
		update_dt				= "";
		vins_canoisr_amt		= 0;				//임의보험_무보험차상해_가격
		vins_cacdt_car_amt		= 0;				//임의보험_자기차량손해_차량_가격
		vins_cacdt_me_amt		= 0;				//임의보혐_자기차량손해_자기부담금
		vins_cacdt_cm_amt		= 0;				//임의보험_자기차량손해_보험가격(차량+자기부담금)
		change_dt1				= "";
		change_dt2				= "";
		change_dt3				= "";
		change_dt4				= "";
		...
		abs_yn					= "";
		ins_rent_dt				= "";
		vins_cacdt_memin_amt	= 0;
		vins_cacdt_mebase_amt	= 0;
		blackbox_yn				= "";
		vins_share_extra_amt	= 0;
		vins_blackbox_amt		= 0;
		vins_blackbox_per		= "";
		com_emp_yn				= "";
		firm_emp_nm				= "";		//임직원운전자한정특약 임차인
	    long_emp_yn				= "";       //장기_단기 구분
		blackbox_nm				= "";
		blackbox_amt			= 0;
		blackbox_no				= "";
		blackbox_dt				= "";
	...
	public void setVins_canoisr_amt		(int i)			{	vins_canoisr_amt		= i;	}	
	public void setVins_cacdt_car_amt	(int i)			{	vins_cacdt_car_amt		= i;	}
	public void setVins_cacdt_me_amt	(int i)			{	vins_cacdt_me_amt		= i;	}
	public void setVins_cacdt_cm_amt	(int i)			{	vins_cacdt_cm_amt		= i;	}
	...
	public void setIns_kd				(String str)	{	ins_kd					= str;	}
	public void setReg_cau				(String str)	{	reg_cau					= str;	}
	...
	public void setAuto_yn				(String str)	{	auto_yn					= str;	}
	public void setAbs_yn				(String str)	{	abs_yn					= str;	}
	public void setIns_rent_dt			(String str)	{	ins_rent_dt				= str;	}
	public void setVins_cacdt_memin_amt	(int i)			{	vins_cacdt_memin_amt	= i;	}
	public void setVins_cacdt_mebase_amt(int i)			{	vins_cacdt_mebase_amt	= i;	}
	public void setBlackbox_yn			(String str)	{	blackbox_yn				= str;	}
	public void setVins_share_extra_amt (int i)			{	vins_share_extra_amt	= i;	}
	public void setVins_blackbox_amt	(int i)			{	vins_blackbox_amt		= i;	}
	public void setVins_blackbox_per	(String str)	{	vins_blackbox_per		= str;	}
	public void setCom_emp_yn			(String str)	{	com_emp_yn				= str;	}
	public void setFirm_emp_nm			(String str)	{	firm_emp_nm				= str;	}
	public void setLong_emp_yn			(String str)	{	long_emp_yn				= str;	}
	public void setBlackbox_nm			(String str)	{	blackbox_nm				= str;	}
	public void setBlackbox_amt			(int i)			{	blackbox_amt			= i;	}
	public void setBlackbox_no			(String str)	{	blackbox_no				= str;	}
	public void setBlackbox_dt			(String str)	{	blackbox_dt				= str;	}
	public void setEnp_no				(String str)	{	enp_no					= str;	}
	public void setLkas_yn				(String str)	{	lkas_yn					= str;	}
	public void setLdws_yn				(String str)	{	ldws_yn					= str;	}
	public void setAeb_yn				(String str)	{	aeb_yn					= str;	}
	public void setFcw_yn				(String str)	{	fcw_yn					= str;	}
	public void setEv_yn				(String str)	{	ev_yn					= str;	}
	public void setOthers				(String str)	{	others					= str;	}
	public void setOthers_device		(String str)	{	others_device			= str;	}
	public void setCom_emp_start_dt		(String str)	{	com_emp_start_dt		= str;	}
	public void setCom_emp_exp_dt		(String str)	{	com_emp_exp_dt			= str;	}
	public void setHook_yn				(String str)	{	hook_yn					= str;	}
	public void setLegal_yn				(String str)	{	legal_yn					= str;	}
	...
	public String getIns_kd					()			{	return ins_kd;					}
	public String getReg_cau				()			{	return reg_cau;					}
	...
	public String getIns_rent_dt			()			{	return ins_rent_dt;				}
	public int    getVins_cacdt_memin_amt	()			{	return vins_cacdt_memin_amt;	}
	public int    getVins_cacdt_mebase_amt	()			{	return vins_cacdt_mebase_amt;	}
	public String getBlackbox_yn			()			{	return blackbox_yn;				}
	public int    getVins_share_extra_amt	()			{	return vins_share_extra_amt;	}
	public int    getVins_blackbox_amt		()			{	return vins_blackbox_amt;		}
	public String getVins_blackbox_per		()			{	return vins_blackbox_per;		}
	public String getCom_emp_yn				()			{	return com_emp_yn;				}
	public String getFirm_emp_nm			()			{	return firm_emp_nm;				}
	public String getLong_emp_yn			()			{	return long_emp_yn;				}	
	public String getBlackbox_nm			()			{	return blackbox_nm;				}
	public int    getBlackbox_amt			()			{	return blackbox_amt;			}
	public String getBlackbox_no			()			{	return blackbox_no;				}
	public String getBlackbox_dt			()			{	return blackbox_dt;				}
	...
	public String getCom_emp_start_dt		()			{	return com_emp_start_dt;	 	}
	public String getCom_emp_exp_dt			()			{	return com_emp_exp_dt;			}
