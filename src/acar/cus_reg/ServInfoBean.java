...
public class ServInfoBean {
	...
	private int sh_amt;  			//재리스공제금액
	private String call_t_nm;
	private String call_t_tel;
	private String sac_yn;
	private String bus_id2;  //비용담당자
   	private String file_path;  //비용담당자
   	private String settle_st;  //사고 종료 1:종결     	
	...
	public void setEstimate_num(String val){	if(val==null) val="";   this.estimate_num = val;}
	...
	public void setSh_amt(int val){				this.sh_amt = val;	} 
	
	public void setCall_t_nm(String val){ if(val==null) val=""; this.call_t_nm = val; }
	public void setCall_t_tel(String val){ if(val==null) val=""; this.call_t_tel = val; }
	public void setSac_yn(String val){ if(val==null) val=""; this.sac_yn = val; }
	...
	public String getEstimate_num(){	return estimate_num;}
