...
*/	private String damdang_id;	//담당자id
	...
	private int comm_tot;

	private int o_s_amt;

	private int out_amt;

	private int hp_s_cha_amt;
	private int hp_accid_amt;
	private String park_nm;			//위치
    private int  a_cnt;				//수해유무
	private String car_old_mons;	//차령
	private String actn_jum;		//경매장평점
	private String in_col;			//내장색상
	private String jg_code;			//차종코드
	private String req_dt;			//보험료청구일자
	
	private String cont_dt;			//계약일
	private String jan_pr_dt;			//입금일 
	
	private String sss;			//자산양수차량 여부  
	    
    // CONSTRCTOR            
    public Offls_cmpltBean() {
...
*/	public void setDamdang_id(String val){ if(val==null) val=""; this.damdang_id = val; }
	...
	public void setComm_tot(int val){ this.comm_tot = val;}

	public void setO_s_amt(int val){ this.o_s_amt = val;}

	public void setOut_amt(int val){ this.out_amt = val;}

	public void setHp_s_cha_amt(int val){ this.hp_s_cha_amt = val;}
	public void setHp_accid_amt(int val){ this.hp_accid_amt = val;}
	public void setPark_nm(String val){ if(val==null) val=""; this.park_nm = val; }
	public void setA_cnt(int val){ this.a_cnt = val; }
	public void setCar_old_mons	(String val){if(val==null) val="";	this.car_old_mons	= val;}
	...
	public void setSss		(String val){if(val==null) val="";	this.sss			= val;}
...
*/	public String getDamdang_id(){ return damdang_id; }
	...
	public int getComm_tot(){ return comm_tot; }

	public int getO_s_amt(){ return o_s_amt; }

	public int getOut_amt(){ return out_amt; }

	public int getHp_s_cha_amt(){ return hp_s_cha_amt; }
	public int getHp_accid_amt(){ return hp_accid_amt; }
	public String getPark_nm(){ return park_nm; }
	public int getA_cnt(){ return a_cnt; }
	public String getCar_old_mons	(){		return car_old_mons;	}
