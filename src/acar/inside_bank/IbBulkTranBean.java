...
public class IbBulkTranBean {

    //Table : IB_BULK_TRAN 대량이체
	private String	tran_dt;			//이체일자
	private String	tran_dt_seq;		//이체일자별일련번호
	...
	public void setTran_dt_seq			(String str){	tran_dt_seq			= str;	}
	public void setGroup_nm				(String str){	group_nm        	= str;	}
	...
	public String getTran_dt_seq		(){				return tran_dt_seq;			}
