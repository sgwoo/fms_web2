 ...
 * @ last modify date : - 2004.02.13.금. car_jnm 차종명 추가.
 */
...
public class ConditionBean {
    ...
    private String out_car_off_fax;			//<--출고영업소 팩스번호 추가(2017.12.07)
    private String bus_st;    
    private String emp_nm;    
    private String pur_pay_dt;				//차량대금결재일
    private String car_ext;    
    private int scan_cnt;						//스캔건수
    private int scan_cnt2;						//스캔건수
    ...
    public ConditionBean() {  
	    ...
	    this.out_car_off_fax = "";			// <-- 출고영업소 팩스번호 추가(2017.12.07)
	    this.bus_st = "";					//영업구분
	    this.emp_nm = "";						//영업사원
	    this.pur_pay_dt = "";	
	    this.car_ext = "";		
		...
		this.car_off_name1 = ""; //미출고등록 영업사원 소속사
		this.car_off_name2 = ""; //미출고등록 출고사원 메이커
		this.engine_nm = "";
	...
	public void setOut_car_off_fax(String val){		//<--출고영업소 팩스번호 추가(2017.12.07)
		if(val==null) val="";
	...
	public String getOut_car_off_fax(){		//<--출고영업소 팩스번호 추가(2017.12.07)
