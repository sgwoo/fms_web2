...
public class ClsEtcBean
{
	...
	private int    ex_di_amt;	//과부족대여료 공급가
	...
	private int    rifee_v_amt;	//개시대여료잔액금액 부가세 - 202204 추가 
    ...
    //확정금액, 상각금액    	
   	private String  d_saction_id;             //확정금액 결제자    
	private String  d_reason;                 //확정금액 사유   
	...
	private int		dfee_v_amt_1;      //과부족+미납대여료   부가세 - 2022-04 추가 
    ...
    private String  upd_id;       //수정자    
   	...
   	private String  dly_reason;       //연체료 감액등의 사유
   	private String  dft_reason;       //해지위약금 감액등의 사유  
   	private String  dly_saction_id;   //연체료감액 결제자    
   	private String  dft_saction_id;   //해지위약금 감액 결제자    
   	
   	private String dft_int_1;			//위약금적용율    
   	private int	   fdft_amt3;		    // 차량매각시 고객 납입금액     
   	
    private String  opt_ip_dt1;     //매입옵션 입금일 1  
  	private int		opt_ip_amt1;    // 입금액 
    private String  opt_ip_bank1;      //입금은행    
    private String  opt_ip_bank_no1;     //입금구좌  
    
    
    private String  opt_ip_dt2;     //매입옵션 입금일 2    
  	private int		opt_ip_amt2;    //추가입금액 
    private String  opt_ip_bank2;      //입금은행    
    private String  opt_ip_bank_no2;       //입금구좌  
    
    private String  re_bank;      //환불은행    
    private String  re_acc_no;       //환불 계좌번호  
    private String  re_acc_nm;      //환불 예금주명    
       
    private String  dft_saction_dt;     //중도해지 위약금 결재일  
    private String  tax_reg_gu;      //세금계산서 통합발행
    
    private int		tot_dist;    //주행거리 
    private int		b_tot_dist;    //추가할 주행거리  
    private String  cms_chk;      //해지정산금 cms 인출의뢰
    private String  ext_st;      //매입옵션시 환불여부
    
    private String  r_tax_dt;      //해지일이 아닌 계산서 발행일
    
    private String  sb_saction_id;      //촐고전해지(신차), 개시전해지(재리스)인 경우 결재 담당자
    private String  sb_saction_dt;      //촐고전해지(신차), 개시전해지(재리스)인 경우 결재일
    ...
    private String	 serv_st;    //예비차 사용가능
     ...
     private int		over_v_amt;            //초과운행 예정     부가세 - 2022-04 추가       
     private int	          over_amt_1;            //초과운행 확정   
     private int	          over_v_amt_1;            //초과운행 확정   부가세 -2022-04 추가 
     private int	          over_amt_s;            //초과운행 공급가   
     private int	          over_amt_v;            //초과운행 부가세   
     
      private String	 match;    //만기매칭
      
      private String	 ext_saction_id;    //후불처리결재
      private String	 ext_reason;    //후불처리사유
      
     private int	         m_o_amt;            //매입옵션
     private String	 serv_gubun;    //예비차 적용형태
     
     private int	         cls_eff_amt;            //영업효율 경감금액
     private String	 input_id;    //실제 데이타 입력자 
	...
	/*	sui_st		= "";	  
    	...
    	dly_reason = "";       //회계처리여부(정산시점)   	
    	dft_reason = "";       //회계처리여부(정산시점)   
    	dly_saction_id = "";
    	dft_saction_id = "";
    	dft_int_1		= "";    
    	...
    	opt_ip_dt1 = "";     //매입옵션 입금일 1   
  		opt_ip_amt1 = 0;    //추가입금액 
    	opt_ip_bank1 = "";       //입금은행    
    	opt_ip_bank_no1 = "";       //입금구좌 
    	
    	opt_ip_dt2 = "";     //매입옵션 입금일  2
  		opt_ip_amt2 = 0;    //추가입금액 
    	opt_ip_bank2 = "";       //입금은행    
    	opt_ip_bank_no2 = "";       //입금구좌 
	...
	public void setDfee_v_amt_1(int i)		{	dfee_v_amt_1		= i; 	}	 //2022-04 추가 
	...
	public void setOver_v_amt(int i)		{	over_v_amt		= i; 	}	//2022-04 추가 
	public void setOver_amt_1(int i)		{	over_amt_1		= i; 	}
	public void setOver_v_amt_1(int i)		{	over_v_amt_1		= i; 	} //2022-04 추가 
...
//	public int    getDfee_s_amt()	{	return dfee_s_amt;     	}   
	...
	public int    getRifee_v_amt()	{	return rifee_v_amt;    	}  //개시대여료 잔액 부가세 2022-04 추가 
	...
	public int	  getDfee_v_amt_1()	{	return  dfee_v_amt_1;      }  //과부족+미납대여료 - 2022-04 추가 
