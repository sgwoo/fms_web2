...
public class AccidentBean {
	...
	private String memo;
	private String car_in_dt;	//정비입고일자
	private String car_out_dt;	//정비출고일자
	private String ins_end_dt;	//보험보상완료일
	//추가 2004.07.07
	private String rent_s_cd;		//단기계약번호
	private String accid_type;		//사고유형
	private String accid_type_sub;	//사고유형-세부
	private String speed;		//사고당시속도
	private String road_stat;	//사고당시도로면상태
	private String road_stat2;	//사고당시도로면상태
	private String weather;		//사고당시날씨
	private String hum_end_dt;	//대인보험보상완료일
	private String mat_end_dt;	//대물보험보상완료일
	private String one_end_dt;	//자손보험보상완료일
	private String my_end_dt;	//자차보험보상완료일
	private String settle_st;	//처리상태
	private String settle_dt;	//처리완료일자
	private String settle_id;	//완료결정자
	private String settle_cont;	//처리내용
	private String settle_note;	//사고수리부위 추가 : 2010-11-24
	//추가 2004.08.17
	private String settle_st1;	//처리상태
	private String settle_dt1;	//처리완료일자
	private String settle_id1;	//완료결정자
	private String settle_st2;	//처리상태
	private String settle_dt2;	//처리완료일자
	private String settle_id2;	//완료결정자
	private String settle_st3;	//처리상태
	private String settle_dt3;	//처리완료일자
	private String settle_id3;	//완료결정자
	private String settle_st4;	//처리상태
	private String settle_dt4;	//처리완료일자
	private String settle_id4;	//완료결정자
	private String settle_st5;	//처리상태
	private String settle_dt5;	//처리완료일자
	private String settle_id5;	//완료결정자
	private String dam_type1;	//사고규모-대인
	private String dam_type2;	//사고규모-대물
	private String dam_type3;	//사고규모-자손
	private String dam_type4;	//사고규모-자차
	private String settle_st6;	//처리상태
	private String settle_dt6;	//처리완료일자
	private String settle_id6;	//완료결정자
	private int    amor_amt;	//경락손해 입금액
	private String amor_nm;		//경락손해 담당자
	private String amor_tel;	//경락손해 연락처
	private String amor_end_dt;	//경락손해 보상완료일
	private int    amor_req_amt;	//경락손해 청구금액
	private String amor_req_dt;		//경락손해 청구일자
	
	private String bus_id2;		//사고시점 담당자
...
/*	public String getUse_yn_nm(){
	...
	public String getAccid_st_nm(){
		if(accid_st.equals("1"))		accid_st_nm = "피해";
		else if(accid_st.equals("2"))	accid_st_nm = "가해";
	...
	public String getSettle_note(){ return settle_note; } //사고 수리부위 추가 2010-11-24
	...
	public String getAsset_st(){			return asset_st;		}  //폐차여부	
