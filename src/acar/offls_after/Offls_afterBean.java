...
public class Offls_afterBean {
	...
	private String actn_dt;		//매각일자
		//Table : SUI 수의계약
	private String sui_nm;		//수의계약자명
	private int mm_pr;		//매매가
	private String cont_dt;		//계약일자
	private String ass_ed_dt_actn;	//보증서작성자(보증첨부여부위해)-경매에서 매각된것
	private String ass_ed_dt_sui;	//보증서만료일 수의계약해서 매각한것
	//Table : INSUR 보험
	private String ins_com_nm;	//보험회사명
	private String ins_exp_dt;	//보험만료일
	//table : car_tax 특소세
	private String cls_man_st;	//특소세면제납부여부
	private String tax_st;		//
	private String req_dt;		//보험해지 청구일
