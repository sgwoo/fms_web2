...
public class DBConnectionManager {
    ...
    public void freeConnection(String name, Connection con) {
       ...
       //     System.out.println("after freeConnection client = " + clients);
        }
    }
   ...
   //     System.out.println("after release client = " + clients);
    }
    ...
    private void loadDrivers(Properties props) {
        ...
        //    	System.out.println(driverClassName);
         //   	System.out.println("step db 1");
                Driver driver = (Driver)Class.forName(driverClassName).newInstance();
                System.out.println(driver);
         //     System.out.println("step db 2");
                DriverManager.registerDriver(driver);
       //       System.out.println("step db 3");
                drivers.addElement(driver);
        //      System.out.println("step db 4");
    ...
    class DBConnectionPool {
      ...
      //      System.out.println("user = " + user);
        ...
        public synchronized void freeConnection(Connection con) {
            ...
            checkedOut--;
            notifyAll();
         //   System.out.println("after freeConnection checkOut = " + checkedOut);
         //   System.out.println("after freeConnection freeConnections.size = " + freeConnections.size());
        }
        ...
        private boolean isConnectionOK(Connection con) {
        	Statement testStmt = null;
        	try {
        		if(!con.isClosed()) {
        			testStmt = con.createStatement();
